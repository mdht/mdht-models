...
public class ReferralSummaryOperations extends MedicalSummaryOperations {
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MEDICAL_SUMMARY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(referralSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MedicalSummaryTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(referralSummary, context) }),
