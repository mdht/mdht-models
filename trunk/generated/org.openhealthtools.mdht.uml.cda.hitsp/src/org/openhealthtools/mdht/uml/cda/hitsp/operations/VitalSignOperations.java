...
public class VitalSignOperations extends VitalSignObservationOperations {
	 ...
	 * @generated
	 */
	public static boolean validateResultObservationCode(VitalSign vitalSign, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSign)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					HITSPPlugin.INSTANCE.getString("ResultObservationCode"), new Object[] { vitalSign }));
			}
			return false;
		}
		return true;
