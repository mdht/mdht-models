...
public class ConditionEntryOperations extends ProblemEntryOperations {
  ...
  public static  boolean validateConditionEntryCodeP(ConditionEntry conditionEntry, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HITSPPlugin.INSTANCE.getString("ConditionEntryCodeP"),
             new Object [] { conditionEntry }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '404684003' or value.code = '409586006' or value.code = '282291009' or value.code = '64572001' or value.code = '248536006' or value.code = '418799008' or value.code = '55607006'))";
   ...
   */
    ...
    Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.hitsp.ConditionEntryCodeP");
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HITSPPackage.Literals.CONDITION_ENTRY, HITSPPackage.Literals.CONDITION_ENTRY.getEAllOperations().get(90));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HITSPPackage.Literals.CONDITION_ENTRY, HITSPPackage.Literals.CONDITION_ENTRY.getEAllOperations().get(91));
      try
      {
   ...
   * @ordered
   */
	protected static final String GET_CAUSE_OF_DEATH_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(ccd::CauseOfDeathObservation))->asSequence()->any(true).oclAsType(ccd::CauseOfDeathObservation)";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HITSPPackage.Literals.CONDITION_ENTRY, HITSPPackage.Literals.CONDITION_ENTRY.getEAllOperations().get(92));
      try
      {
