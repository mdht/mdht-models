...
public class HITSPSwitch<T> {
   ...
   */
    ...
    switch (classifierID)
    {
      ...
      case HITSPPackage.ADVANCE_DIRECTIVE:
      {
        ...
        if (result == null) result = caseIHE_AdvanceDirectiveObservation(advanceDirective);
        if (result == null) result = caseAdvanceDirectiveObservation(advanceDirective);
        if (result == null) result = caseSimpleObservation(advanceDirective);
      ...
      case HITSPPackage.PLAN_OF_CARE_SECTION:
      {
        ...
        if (result == null) result = caseCDT_AssessmentAndPlanSection(planOfCareSection);
      ...
      case HITSPPackage.HISTORY_OF_PAST_ILLNESS_SECTION:
      {
        ...
        if (result == null) result = casePastMedicalHistorySection(historyOfPastIllnessSection);
      ...
      case HITSPPackage.CHIEF_COMPLAINT_SECTION:
      {
        ...
        if (result == null) result = caseCDT_ChiefComplaintSection(chiefComplaintSection);
      ...
      case HITSPPackage.REASON_FOR_REFERRAL_SECTION:
      {
        ...
        if (result == null) result = caseCodedReasonForReferralSection(reasonForReferralSection);
        if (result == null) result = caseCDT_ReasonForReferralSection(reasonForReferralSection);
      ...
      case HITSPPackage.PHYSICAL_EXAM_SECTION:
      {
        ...
        if (result == null) result = casePhysicalExaminationSection(physicalExamSection);
      ...
      case HITSPPackage.REVIEW_OF_SYSTEMS_SECTION:
      {
        ...
        if (result == null) result = caseCDT_ReviewOfSystemsSection(reviewOfSystemsSection);
      ...
      case HITSPPackage.ASSESSMENT_AND_PLAN_SECTION:
      {
        ...
        if (result == null) result = caseCDT_AssessmentAndPlanSection(assessmentAndPlanSection);
      ...
      case HITSPPackage.FAMILY_HISTORY:
      {
        ...
        if (result == null) result = caseIHE_FamilyHistoryOrganizer(familyHistory);
        if (result == null) result = caseFamilyHistoryOrganizer(familyHistory);
      ...
      case HITSPPackage.SOCIAL_HISTORY:
      {
        ...
        if (result == null) result = caseIHE_SocialHistoryObservation(socialHistory);
        if (result == null) result = caseSimpleObservation(socialHistory);
        if (result == null) result = caseSocialHistoryObservation(socialHistory);
      ...
      case HITSPPackage.UNSTRUCTURED_OR_SCANNED_DOCUMENT:
      {
        ...
        if (result == null) result = caseCDT_UnstructuredDocument(unstructuredOrScannedDocument);
        if (result == null) result = caseUnstructuredDocument(unstructuredOrScannedDocument);
        if (result == null) result = caseMedicalDocument(unstructuredOrScannedDocument);
        if (result == null) result = caseScannedDocument(unstructuredOrScannedDocument);
      ...
      case HITSPPackage.REFERRAL_SUMMARY:
      {
        ...
        if (result == null) result = caseMedicalSummary(referralSummary);
        if (result == null) result = caseMedicalDocument(referralSummary);
      ...
      case HITSPPackage.PLANNED_PROCEDURE:
      {
        ...
        if (result == null) result = caseProcedure(plannedProcedure);
        if (result == null) result = caseProcedureEntryPlanOfCareActivityProcedure(plannedProcedure);
        if (result == null) result = caseProcedureEntry(plannedProcedure);
        if (result == null) result = casePlanOfCareActivityProcedure(plannedProcedure);
        if (result == null) result = caseCDA_Procedure(plannedProcedure);
        if (result == null) result = casePlanOfCareActivity(plannedProcedure);
        if (result == null) result = caseClinicalStatement(plannedProcedure);
        if (result == null) result = caseAct(plannedProcedure);
        if (result == null) result = caseInfrastructureRoot(plannedProcedure);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case HITSPPackage.PAST_PROCEDURE:
      {
        ...
        if (result == null) result = caseProcedure(pastProcedure);
        if (result == null) result = caseProcedureEntryProcedureActivityProcedure(pastProcedure);
        if (result == null) result = caseProcedureEntry(pastProcedure);
        if (result == null) result = caseProcedureActivityProcedure(pastProcedure);
        if (result == null) result = caseCDA_Procedure(pastProcedure);
        if (result == null) result = caseProcedureActivity(pastProcedure);
        if (result == null) result = caseClinicalStatement(pastProcedure);
        if (result == null) result = caseAct(pastProcedure);
        if (result == null) result = caseInfrastructureRoot(pastProcedure);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
	public T caseCDT_ReasonForReferralSection(org.openhealthtools.mdht.uml.cda.cdt.ReasonForReferralSection object) {
    return null;
  }
   ...
   * @generated
   */
	public T caseIHE_HospitalAdmissionDiagnosisSection(
   ...
   * @generated
   */
	public T caseIHE_AdmissionMedicationHistorySection(
   ...
   * @generated
   */
	public T caseIHE_HospitalDischargeMedicationsSection(
   ...
   * @generated
   */
	public T caseIHE_MedicationsAdministeredSection(
   ...
   * @generated
   */
	public T caseCDT_UnstructuredDocument(org.openhealthtools.mdht.uml.cda.cdt.UnstructuredDocument object) {
    return null;
  }
