...
public class PlanOfCareSectionOperations extends AssessmentAndPlanSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_MEDICATION__EOCL_EXP = "self.getSubstanceAdministrations()->select(substanceAdministration : cda::SubstanceAdministration | not substanceAdministration.oclIsUndefined() and substanceAdministration.oclIsKindOf(hitsp::Medication))->asSequence()->first().oclAsType(hitsp::Medication)";
	 ...
	 * @ordered
	 */
	protected static final String GET_IMMUNIZATION__EOCL_EXP = "self.getSubstanceAdministrations()->select(substanceAdministration : cda::SubstanceAdministration | not substanceAdministration.oclIsUndefined() and substanceAdministration.oclIsKindOf(hitsp::Immunization))->asSequence()->first().oclAsType(hitsp::Immunization)";
	 ...
	 * @ordered
	 */
	protected static final String GET_ENCOUNTER__EOCL_EXP = "self.getEncounters()->select(encounter : cda::Encounter | not encounter.oclIsUndefined() and encounter.oclIsKindOf(hitsp::Encounter))->asSequence()->first().oclAsType(hitsp::Encounter)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PROCEDURE__EOCL_EXP = "self.getProcedures()->select(procedure : cda::Procedure | not procedure.oclIsUndefined() and procedure.oclIsKindOf(hitsp::Procedure))->asSequence()->first().oclAsType(hitsp::Procedure)";
