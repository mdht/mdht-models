 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.23.18' constraints.validation.error='VisitTemplateId VisitClassCode VisitCode VisitMoodCode VisitId' constraints.validation.warning='VisitEffectiveTime' classCode='ENC' constraints.validation.info='VisitText VisitHuman Clinical Adverse Event VisitHuman Clinical Vital Sign VisitPlanned Study Day VisitConcommitantMedicationAssociation VisitECG Test Result VisitInclusion or Exclusion Criteria Not Met VisitLaboratory Test Result VisitPhysical Examination VisitSubstanceUseAssociation VisitMicrobiology Specimen VisitMicrobiology Susceptibility VisitPharmacokinetic Concentration Finding VisitFinding About VisitDrug Accountability VisitStudy Day Period' moodCode='EVN'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmVisitconcommitantMedicationAssociation constraints.validation.error='concommitantMedicationAssociationTypeCode concommitantMedicationAssociationHuman Clinical Concomitant Medication' typeCode='COMP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmVisitsubstanceUseAssociation constraints.validation.error='substanceUseAssociationTypeCode' typeCode='COMP'"
 * @generated
 */
public interface Visit extends Encounter
{
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(sdtm::Planned Study Day))->asSequence()->first().oclAsType(sdtm::Planned Study Day)'"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(sdtm::Microbiology Specimen Finding))->asSequence()->first().oclAsType(sdtm::Microbiology Specimen Finding)'"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(sdtm::Microbiology Susceptibility))->asSequence()->first().oclAsType(sdtm::Microbiology Susceptibility)'"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(sdtm::Pharmacokinetic Concentration Finding))->asSequence()->first().oclAsType(sdtm::Pharmacokinetic Concentration Finding)'"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(sdtm::Finding About))->asSequence()->first().oclAsType(sdtm::Finding About)'"
   * @generated
   */
   ...
   * <!-- end-model-doc -->
   * @model kind="operation" required="true" ordered="false"
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(sdtm::Drug Accountability))->asSequence()->first().oclAsType(sdtm::Drug Accountability)'"
   * @generated
   */
