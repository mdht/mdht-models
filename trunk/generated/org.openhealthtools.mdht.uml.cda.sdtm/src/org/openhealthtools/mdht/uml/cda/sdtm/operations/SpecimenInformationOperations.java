...
"value.codeSystem = '2.16.840.1.113883.3.26.1.1'))";
  ...
  public static  EventStudyDay getEventStudyDay(SpecimenInformation specimenInformation)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(SdtmPackage.Literals.SPECIMEN_INFORMATION, SdtmPackage.Literals.SPECIMEN_INFORMATION.getEAllOperations().get(89));
      try
      {
  ...
  public static  TimingReference getTimingReference(SpecimenInformation specimenInformation)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(SdtmPackage.Literals.SPECIMEN_INFORMATION, SdtmPackage.Literals.SPECIMEN_INFORMATION.getEAllOperations().get(90));
      try
      {
