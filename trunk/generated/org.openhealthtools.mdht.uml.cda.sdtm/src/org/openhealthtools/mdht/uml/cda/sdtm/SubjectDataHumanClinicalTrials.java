 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Subject Data Human Clinical TrialsTemplateId Subject Data Human Clinical TrialsClassCode Subject Data Human Clinical TrialsCode Subject Data Human Clinical TrialsCodeP Subject Data Human Clinical TrialsConfidentialityCode Subject Data Human Clinical TrialsEffectiveTime Subject Data Human Clinical TrialsId Subject Data Human Clinical TrialsMoodCode Subject Data Human Clinical TrialsSetId Subject Data Human Clinical TrialsVersionNumber Subject Data Human Clinical TrialsHuman Clinical Subject Data Document Body Subject Data Human Clinical TrialsAuthorParticipation Subject Data Human Clinical TrialsStudyRelationship Subject Data Human Clinical TrialsSubjectParticipation' templateId.root='2.16.840.1.113883.10.20.23.11' classCode='DOCCLIN' code.code='TBD' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsAuthorParticipation typeCode='AUT' constraints.validation.error='AuthorParticipationTypeCode AuthorParticipationAssignedAuthor'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsAuthorParticipationAssignedAuthor classCode='ASSIGNED' constraints.validation.error='AssignedAuthorClassCode AssignedAuthorId AssignedAuthorAuthorPerson AssignedAuthorStudySite'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsAuthorParticipationAssignedAuthorAuthorPerson classCode='PSN' constraints.validation.error='AuthorPersonClassCode AuthorPersonDeterminerCode AuthorPersonName' determinerCode='INSTANCE'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsAuthorParticipationAssignedAuthorStudySite classCode='ORG' constraints.validation.error='StudySiteClassCode StudySiteDeterminerCode StudySiteId StudySiteAddr' determinerCode='INSTANCE'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsStudyRelationship typeCode='DOC' constraints.validation.error='StudyRelationshipTypeCode StudyRelationshipStudy'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsStudyRelationshipStudy classCode='CLNTRL' constraints.validation.error='StudyClassCode StudyCode StudyId StudyMoodCode StudyEffectiveTime' moodCode='EVN'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsSubjectParticipation typeCode='RCT' constraints.validation.error='SubjectParticipationTypeCode SubjectParticipationStudySubjectRole'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsSubjectParticipationStudySubjectRole classCode='PAT' constraints.validation.error='StudySubjectRoleClassCode StudySubjectRoleId StudySubjectRoleStudySubject'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmSubjectDataHumanClinicalTrialsSubjectParticipationStudySubjectRoleStudySubject administrativeGenderCode.codeSystem='2.16.840.1.113883.3.26.1.1' administrativeGenderCode.codeSystemName='NCI Thesaurus' constraints.validation.error='StudySubjectAdministrativeGenderCode StudySubjectAdministrativeGenderCodeP StudySubjectClassCode StudySubjectDeterminerCode' constraints.validation.info='StudySubjectBirthTime' classCode='PSN' determinerCode='INSTANCE' constraints.validation.warning='StudySubjectEthnicGroupCode StudySubjectRaceCode'"
 * @generated
 */
public interface SubjectDataHumanClinicalTrials extends ClinicalDocument
{
   ...
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(sdtm::Human Clinical Subject Data Document Body))->asSequence()->any(true).oclAsType(sdtm::Human Clinical Subject Data Document Body)'"
   * @generated
   */
