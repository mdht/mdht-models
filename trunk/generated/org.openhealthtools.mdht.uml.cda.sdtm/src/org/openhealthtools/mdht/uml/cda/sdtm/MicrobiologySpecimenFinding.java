 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.23.38' constraints.validation.error='Microbiology Specimen FindingTemplateId Microbiology Specimen FindingClassCode Microbiology Specimen FindingCode Microbiology Specimen FindingId Microbiology Specimen FindingMoodCode Microbiology Specimen FindingNonPerformanceReason Microbiology Specimen FindingmicrobiologySpecimenFindingCategoryAssociationTypeCode Microbiology Specimen FindingmicrobiologySpecimenFindingSubCategoryAssociationTypeCode Microbiology Specimen FindingmicrobiologyResultCategoryAssociationTypeCode' constraints.validation.warning='Microbiology Specimen FindingMethodCode Microbiology Specimen FindingValue Microbiology Specimen FindingGroup Identifier' classCode='OBS' constraints.validation.query='Microbiology Specimen FindingmicrobiologySpecimenFindingCategoryAssociationTypeCode Microbiology Specimen FindingmicrobiologySpecimenFindingSubCategoryAssociationTypeCode Microbiology Specimen FindingmicrobiologyResultCategoryAssociationTypeCode' constraints.validation.info='Microbiology Specimen FindingStatusCode Microbiology Specimen FindingMicrobiologySpecimenResultCategoryAssociation Microbiology Specimen FindingMicrobiologySpecimenResultSubCategoryAssociation Microbiology Specimen FindingSpecimen Information Microbiology Specimen FindingBaseline Indicator Microbiology Specimen FindingDerived Data Indicator' moodCode='EVN'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmMicrobiologySpecimenFindingmicrobiologySpecimenFindingCategoryAssociation constraints.validation.error='microbiologySpecimenFindingCategoryAssociationTypeCode' typeCode='COMP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmMicrobiologySpecimenFindingmicrobiologySpecimenFindingCategoryAssociationmicrobiologySpecimenFindingCategory constraints.validation.error='microbiologySpecimenFindingCategoryClassCode microbiologySpecimenFindingCategoryCode microbiologySpecimenFindingCategoryMoodCode microbiologySpecimenFindingCategoryValue' classCode='OBS' moodCode='EVN'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmMicrobiologySpecimenFindingmicrobiologySpecimenFindingSubCategoryAssociation constraints.validation.error='microbiologySpecimenFindingSubCategoryAssociationTypeCode' typeCode='COMP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmMicrobiologySpecimenFindingmicrobiologySpecimenFindingSubCategoryAssociationmicrobiologySpecimenFindingSubCategory constraints.validation.error='microbiologySpecimenFindingSubCategoryClassCode microbiologySpecimenFindingSubCategoryCode microbiologySpecimenFindingSubCategoryMoodCode microbiologySpecimenFindingSubCategoryValue' classCode='OBS' moodCode='EVN'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmMicrobiologySpecimenFindingmicrobiologyResultCategoryAssociation constraints.validation.error='microbiologyResultCategoryAssociationTypeCode' typeCode='COMP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmMicrobiologySpecimenFindingmicrobiologyResultCategoryAssociationmicrobiologyResultCategory constraints.validation.error='microbiologyResultCategoryClassCode microbiologyResultCategoryCode microbiologyResultCategoryMoodCode microbiologyResultCategoryValue' classCode='OBS' moodCode='EVN'"
 * @generated
 */
public interface MicrobiologySpecimenFinding extends Observation
{
   ...
   * @generated
   */
  boolean validateMicrobiologySpecimenFindingBaselineIndicator(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
  boolean validateMicrobiologySpecimenFindingDerivedDataIndicator(DiagnosticChain diagnostics, Map<Object, Object> context);
