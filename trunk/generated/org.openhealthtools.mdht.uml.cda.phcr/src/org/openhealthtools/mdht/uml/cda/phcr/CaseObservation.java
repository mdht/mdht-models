 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.dependOn.ProblemObservationCode='CaseObservationCode' constraints.validation.dependOn.ProblemObservationStatusCode='CaseObservationStatusCode' moodCode='EVN' classCode='OBS' code.codeSystemName='HL7ActCode' constraints.validation.info='CaseObservationId' templateId.root='2.16.840.1.113883.10.20.15.3.54' constraints.validation.error='CaseObservationTemplateId CaseObservationClassCode CaseObservationMoodCode ProblemObservationCode CaseObservationCode ProblemObservationStatusCode CaseObservationStatusCode CaseObservationValue' statusCode.code='completed' code.codeSystem='2.16.840.1.113883.5.4' code.code='ASSERTION' constraints.validation.warning='CaseObservationEffectiveTimeLow CaseObservationAuthor CaseObservationAuthorAssignedAuthor CaseObservationEffectiveTime CaseObservationProblemStatusObservation CaseObservationSignsAndSymptomsObservation'"
 * @generated
 */
public interface CaseObservation extends ProblemObservation {
	 ...
	 * @generated
	 */
	boolean validateCaseObservationCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateCaseObservationStatusCode(DiagnosticChain diagnostics, Map<Object, Object> context);
