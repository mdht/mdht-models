        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ChestWallSectionTemplateId"),
...
"value.code = '11392-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ChestWallSectionCode"),
             new Object [] { chestWallSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("ChestWallSectionProblemEntry"),
             new Object [] { chestWallSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.CHEST_WALL_SECTION, IHEPackage.Literals.CHEST_WALL_SECTION.getEAllOperations().get(58));
      try
      {
