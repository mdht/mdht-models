...
public class IHEFactoryImpl extends EFactoryImpl implements IHEFactory {
   ...
   */
    ...
    switch (eClass.getClassifierID())
    {
      ...
      case IHEPackage.ADVANCE_DIRECTIVE_OBSERVATION: return createAdvanceDirectiveObservation();
      ...
      case IHEPackage.GENERAL_APPEARANCE_SECTION: return createGeneralAppearanceSection();
      case IHEPackage.VISIBLE_IMPLANTED_MEDICAL_DEVICES_SECTION: return createVisibleImplantedMedicalDevicesSection();
      case IHEPackage.INTEGUMENTARY_SYSTEM_SECTION: return createIntegumentarySystemSection();
      case IHEPackage.HEAD_SECTION: return createHeadSection();
      case IHEPackage.EYES_SECTION: return createEyesSection();
      case IHEPackage.EARS_NOSE_MOUTH_THROAT_SECTION: return createEarsNoseMouthThroatSection();
      case IHEPackage.EARS_SECTION: return createEarsSection();
      case IHEPackage.NOSE_SECTION: return createNoseSection();
      case IHEPackage.MOUTH_THROAT_TEETH_SECTION: return createMouthThroatTeethSection();
      case IHEPackage.NECK_SECTION: return createNeckSection();
      case IHEPackage.ENDOCRINE_SYSTEM_SECTION: return createEndocrineSystemSection();
      case IHEPackage.THORAX_LUNGS_SECTION: return createThoraxLungsSection();
      case IHEPackage.CHEST_WALL_SECTION: return createChestWallSection();
      case IHEPackage.BREAST_SECTION: return createBreastSection();
      case IHEPackage.HEART_SECTION: return createHeartSection();
      case IHEPackage.RESPIRATORY_SYSTEM_SECTION: return createRespiratorySystemSection();
      case IHEPackage.ABDOMEN_SECTION: return createAbdomenSection();
      case IHEPackage.LYMPHATIC_SECTION: return createLymphaticSection();
      case IHEPackage.VESSELS_SECTION: return createVesselsSection();
      case IHEPackage.MUSCULOSKELETAL_SYSTEM_SECTION: return createMusculoskeletalSystemSection();
      case IHEPackage.NEUROLOGIC_SYSTEM_SECTION: return createNeurologicSystemSection();
      case IHEPackage.GENITALIA_SECTION: return createGenitaliaSection();
      case IHEPackage.RECTUM_SECTION: return createRectumSection();
      case IHEPackage.EXTREMITIES_SECTION: return createExtremitiesSection();
      ...
      case IHEPackage.DISCHARGE_DIET: return createDischargeDiet();
      case IHEPackage.HOSPITAL_DISCHARGE_PHYSICAL: return createHospitalDischargePhysical();
      case IHEPackage.CODED_FAMILY_MEDICAL_HISTORY_SECTION: return createCodedFamilyMedicalHistorySection();
      case IHEPackage.FAMILY_HISTORY_ORGANIZER: return createFamilyHistoryOrganizer();
      case IHEPackage.FAMILY_HISTORY_OBSERVATION: return createFamilyHistoryObservation();
      case IHEPackage.SOCIAL_HISTORY_OBSERVATION: return createSocialHistoryObservation();
      case IHEPackage.CODED_REASON_FOR_REFERRAL_SECTION: return createCodedReasonForReferralSection();
