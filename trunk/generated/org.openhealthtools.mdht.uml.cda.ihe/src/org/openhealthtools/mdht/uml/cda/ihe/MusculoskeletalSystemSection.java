 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='MusculoskeletalSystemSectionTemplateId MusculoskeletalSystemSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.34' code.code='11410-8' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='MUSCULOSKELETAL SYSTEM' constraints.validation.info='MusculoskeletalSystemSectionProblemEntry'"
 * @generated
 */
public interface MusculoskeletalSystemSection extends Section {
	...
	* <!-- end-model-doc -->
	* @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'1.3.6.1.4.1.19376.1.5.3.1.1.9.34\')'"
	* @generated
	*/
	boolean validateMusculoskeletalSystemSectionTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
