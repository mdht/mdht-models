        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("EarsSectionTemplateId"),
...
"value.code = '10195-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
      ...
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             IHEValidator.DIAGNOSTIC_SOURCE,
             IHEValidator.EARS_SECTION__EARS_SECTION_CODE,
             IHEPlugin.INSTANCE.getString("EarsSectionCode"),
             new Object [] { earsSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("EarsSectionProblemEntry"),
             new Object [] { earsSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.EARS_SECTION, IHEPackage.Literals.EARS_SECTION.getEAllOperations().get(58));
      try
      {
