 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='VesselsSectionTemplateId VesselsSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.33' code.codeSystemName='LOINC' code.displayName='VESSELS' code.codeSystem='2.16.840.1.113883.6.1' code.code='10208-7' constraints.validation.info='VesselsSectionProblemEntry'"
 * @generated
 */
