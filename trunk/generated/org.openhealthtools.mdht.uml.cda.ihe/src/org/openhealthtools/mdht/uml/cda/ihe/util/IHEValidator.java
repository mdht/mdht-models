...
public class IHEValidator extends EObjectValidator {
   ...
   */
    ...
    switch (classifierID)
    {
      ...
      case IHEPackage.CODED_FAMILY_MEDICAL_HISTORY_SECTION:
        return validateCodedFamilyMedicalHistorySection((CodedFamilyMedicalHistorySection)value, diagnostics, context);
      ...
      case IHEPackage.CODED_REASON_FOR_REFERRAL_SECTION:
        return validateCodedReasonForReferralSection((CodedReasonForReferralSection)value, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryHasRelatedObservations(concernEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryRelatedObservationsTypeCode(concernEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryHasRelatedReferencesTypeCode(concernEntry, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateClassCode(medicalDocument, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateMoodCode(medicalDocument, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsIdRootFormat(medicalDocument, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsLanguageCodeForm(medicalDocument, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(activeProblemsSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(activeProblemsSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryHasRelatedObservations(problemConcernEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryRelatedObservationsTypeCode(problemConcernEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryHasRelatedReferencesTypeCode(problemConcernEntry, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryCodeP(problemEntry, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateSeverityObservation_validateSeverityObservationValue(severity, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationTargetOfEntryRelationship(problemStatusObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationNoAdditionalRelationships(problemStatusObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationValue(problemStatusObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateProblemStatusObservation_validateIHEProblemStatusObservationValue(problemStatusObservation, diagnostics, context);
    return result;
  }
   ...
   * @generated
   */
  public boolean validateProblemStatusObservation_validateIHEProblemStatusObservationValue(ProblemStatusObservation problemStatusObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationTargetOfEntryRelationship(healthStatusObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationNoAdditionalRelationships(healthStatusObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationCode(healthStatusObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateStatusObservation_validateStatusObservationValue(healthStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemHealthStatusObservation_validateProblemHealthStatusObservationCode(healthStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateComment_validateIHECommentEffectiveTimeWhenAuthorPresent(comment, diagnostics, context);
    if (result || diagnostics != null) result &= validateComment_validateIHECommentHasAuthorId(comment, diagnostics, context);
    if (result || diagnostics != null) result &= validateComment_validateIHECommentHasAuthorOrganization(comment, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateComment_validateIHECommentAuthor(comment, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validatePatientInstruction_validatePatientInstructionTemplateId(patientMedicalInstructions, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validatePatientInstruction_validatePatientInstructionMoodCode(patientMedicalInstructions, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validatePatientMedicalInstructions_validatePatientMedicalInstructionsCodeP(patientMedicalInstructions, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSupply_validateClassCode(supplyEntry, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateSupplyActivity_validateSupplyActivityHasProduct(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSupplyActivity_validateSupplyActivityTemplateId(supplyEntry, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateSupplyActivity_validateSupplyActivityProductInstance(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasIntentAuthor(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasAuthorTime(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasAssignedAuthor(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasAssignedAuthorID(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasAssignedAuthorPersonOrOrg(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasPerformerTimeEvent(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasPerformerTimeIntent(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasPerformerAssignedEntity(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasPerformerAssignedEntityID(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryHasPerformerEntityPersonOrOrg(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryQuantityHasValue(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryTemplateId(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryQuantity(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryRepeatNumber(supplyEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateSupplyEntry_validateSupplyEntryMedicationFullfillmentInstructions(supplyEntry, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateFulfillmentInstruction_validateFulfillmentInstructionTemplateId(medicationFullfillmentInstructions, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFulfillmentInstruction_validateFulfillmentInstructionMoodCode(medicationFullfillmentInstructions, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateMedicationFullfillmentInstructions_validateMedicationFullfillmentInstructionsCodeP(medicationFullfillmentInstructions, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryHasRelatedObservations(allergyIntoleranceConcern, diagnostics, context);
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryRelatedObservationsTypeCode(allergyIntoleranceConcern, diagnostics, context);
    if (result || diagnostics != null) result &= validateConcernEntry_validateConcernEntryHasRelatedReferencesTypeCode(allergyIntoleranceConcern, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateAllergyIntoleranceConcern_validateAllergyIntoleranceConcernAllergyIntolerance(allergyIntoleranceConcern, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryCodeP(allergyIntolerance, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateAllergyIntolerance_validateAllergyIntoleranceCodeP(allergyIntolerance, diagnostics, context);
   ...
   * @generated
   */
  public boolean validateAllergyIntolerance_validateAllergyIntoleranceCodeP(AllergyIntolerance allergyIntolerance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationInformationSource(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationContainsPatientAwareness(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationTemplateId(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationMoodCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationStatusCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationEffectiveTime(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationProblemStatus(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationProblemHealthStatus(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationAgeObservation(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryHasTextReference(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryCommentInversionInd(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryTemplateId(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryCodeP(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryEffectiveTime(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryId(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryText(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryValue(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntrySeverity(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryProblemStatusObservation(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryHealthStatusObservation(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= validateProblemEntry_validateProblemEntryComment(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationHasReactionIntervention(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationReactionInterventionTypeCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationReactionInterventionType(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationTemplateId(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationClassCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationMoodCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationStatusCode(problemEntryReactionObservationContainer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateReactionObservation_validateReactionObservationSeverityObservation(problemEntryReactionObservationContainer, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateAllergiesReactionsSection_validateAllergiesReactionsSectionAllergyIntoleranceConcern(allergiesReactionsSection, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateAllergiesReactionsSection_validateAllergiesReactionsSectionAllergyIntoleranceConcern(
			AllergiesReactionsSection allergiesReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return allergiesReactionsSection.validateAllergiesReactionsSectionAllergyIntoleranceConcern(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSubstanceAdministration_validateClassCode(normalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityHasProduct(normalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityDoseQuantity(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityRateQuantity(normalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityPerformer(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityReactionObservation(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityProductInstance(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDosing(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationDosingRelationship(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDescriptionNoMedNotKnown(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationReasonClassMood(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasProductEntry(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasIntructionsInversion(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductStrength(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductName(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationPreconditionReference(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasSupplyEntryInversion(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasFillNumber(normalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateMedication_validateMedicationCode(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationStatusCode(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationEffectiveTime(normalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateNormalDose_validateNormalDoseNoSubordinateSubstanceAdministration(normalDose, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSubstanceAdministration_validateClassCode(taperedDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityHasProduct(taperedDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityDoseQuantity(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityRateQuantity(taperedDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityPerformer(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityReactionObservation(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityProductInstance(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDosing(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationDosingRelationship(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDescriptionNoMedNotKnown(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationReasonClassMood(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasProductEntry(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasIntructionsInversion(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductStrength(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductName(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationPreconditionReference(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasSupplyEntryInversion(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasFillNumber(taperedDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateMedication_validateMedicationCode(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationStatusCode(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationEffectiveTime(taperedDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateTaperedDose_validateTaperedDoseTaperedDosingSubstanceAdministration(taperedDose, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSubstanceAdministration_validateClassCode(splitDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityHasProduct(splitDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityDoseQuantity(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityRateQuantity(splitDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityPerformer(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityReactionObservation(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityProductInstance(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDosing(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationDosingRelationship(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDescriptionNoMedNotKnown(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationReasonClassMood(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasProductEntry(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasIntructionsInversion(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductStrength(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductName(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationPreconditionReference(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasSupplyEntryInversion(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasFillNumber(splitDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateMedication_validateMedicationCode(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationStatusCode(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationEffectiveTime(splitDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateSplitDose_validateSplitDoseSplitDosingSubstanceAdministration(splitDose, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSubstanceAdministration_validateClassCode(conditionalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityHasProduct(conditionalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityDoseQuantity(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityRateQuantity(conditionalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityPerformer(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityReactionObservation(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityProductInstance(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDosing(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationDosingRelationship(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDescriptionNoMedNotKnown(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationReasonClassMood(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasProductEntry(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasIntructionsInversion(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductStrength(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductName(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationPreconditionReference(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasSupplyEntryInversion(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasFillNumber(conditionalDose, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateMedication_validateMedicationCode(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationStatusCode(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationEffectiveTime(conditionalDose, diagnostics, context);
    if (result || diagnostics != null) result &= validateConditionalDose_validateConditionalDoseConditionalDosingSubstanceAdministration(conditionalDose, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSubstanceAdministration_validateClassCode(combinationMedication, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityHasProduct(combinationMedication, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityDoseQuantity(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityRateQuantity(combinationMedication, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityPerformer(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityReactionObservation(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicationActivity_validateMedicationActivityProductInstance(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDosing(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationDosingRelationship(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasDescriptionNoMedNotKnown(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationReasonClassMood(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasProductEntry(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasIntructionsInversion(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductStrength(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationProductName(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationPreconditionReference(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasSupplyEntryInversion(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationHasFillNumber(combinationMedication, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateMedication_validateMedicationCode(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationStatusCode(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateMedication_validateMedicationEffectiveTime(combinationMedication, diagnostics, context);
    if (result || diagnostics != null) result &= validateCombinationMedication_validateCombinationMedicationSubstanceAdministration(combinationMedication, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(codedVitalSignsSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(codedVitalSignsSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateVitalSignsOrganizer_validateIHEVitalSignsOrganizerRequireResultsOrganizerTemplateID(vitalSignsOrganizer, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateVitalSignsOrganizer_validateIHEVitalSignsOrganizerId(vitalSignsOrganizer, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateVitalSignsOrganizer_validateIHEVitalSignsOrganizerAuthor(vitalSignsOrganizer, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateResultObservation_validateResultObservationCodeValue(vitalSignObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateCoverageEntry_validateCoverageEntryPayerEntry(coverageEntry, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validatePolicyActivity_validatePolicyActivitySubscriber(payerEntry, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(codedSurgeriesSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(codedSurgeriesSection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProceduresSection_validateProceduresSectionHasProcedureActivity(codedSurgeriesSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateProceduresSection_validateProceduresSectionText(codedSurgeriesSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateCodedSurgeriesSection_validateCodedSurgeriesSectionExternalReference(codedSurgeriesSection, diagnostics, context);
    if (result || diagnostics != null) result &= validateCodedSurgeriesSection_validateCodedSurgeriesSectionProcedureEntryProcedureActivityProcedure(codedSurgeriesSection, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateCodedSurgeriesSection_validateCodedSurgeriesSectionProcedureEntryProcedureActivityProcedure(
			CodedSurgeriesSection codedSurgeriesSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return codedSurgeriesSection.validateCodedSurgeriesSectionProcedureEntryProcedureActivityProcedure(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureMoodCode(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureCode(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureEffectiveTime(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureId(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureSpecimen(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureEncounterLocation(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedurePerformer2(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureProblemObservation(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureProblemAct(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureAgeObservation(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedureMedicationActivity(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProcedureActivityProcedure_validateProcedureActivityProcedurePatientInstruction(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryMoodCode(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryHasTextReference(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryPriorityCode(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryHasInversionIndForEncounter(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryTemplateId(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryClassCode(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryText(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryApproachSiteCode(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryInternalReference(procedureEntryProcedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryInternalReferenceReason(procedureEntryProcedureActivityProcedure, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateProcedureEntry(ProcedureEntry procedureEntry, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    if (!validate_NoCircularContainment(procedureEntry, diagnostics, context)) return false;
    boolean result = validate_EveryMultiplicityConforms(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryDataValueConforms(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryProxyResolves(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validate_UniqueID(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryKeyUnique(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryMoodCode(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryHasTextReference(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryPriorityCode(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryHasInversionIndForEncounter(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryTemplateId(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryClassCode(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryText(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryApproachSiteCode(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryInternalReference(procedureEntry, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryInternalReferenceReason(procedureEntry, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateHospitalAdmissionDiagnosisSection_validateHospitalAdmissionDiagnosisSectionProblemConcernEntry(hospitalAdmissionDiagnosisSection, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateHospitalAdmissionDiagnosisSection_validateHospitalAdmissionDiagnosisSectionProblemConcernEntry(
			HospitalAdmissionDiagnosisSection hospitalAdmissionDiagnosisSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return hospitalAdmissionDiagnosisSection.validateHospitalAdmissionDiagnosisSectionProblemConcernEntry(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateDischargeDiagnosisSection_validateDischargeDiagnosisSectionProblemConcernEntry(dischargeDiagnosisSection, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(codedAdvanceDirectivesSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(codedAdvanceDirectivesSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectivesSection_validateAdvanceDirectivesSectionText(codedAdvanceDirectivesSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateCodedAdvanceDirectivesSection_validateCodedAdvanceDirectivesSectionAdvanceDirectivesObservation(codedAdvanceDirectivesSection, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateCodedAdvanceDirectivesSection_validateCodedAdvanceDirectivesSectionAdvanceDirectivesObservation(
			CodedAdvanceDirectivesSection codedAdvanceDirectivesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return codedAdvanceDirectivesSection.validateCodedAdvanceDirectivesSectionAdvanceDirectivesObservation(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvDirectiveCodeValueSet(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvDirectiveCodeCodeSystem(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationTemplateId(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationClassCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationMoodCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationId(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationStatusCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationEffectiveTime(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveVerification(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveStatusObservation(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveReference(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationTemplateId(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationId(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationStatusCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationHasExternalReference(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationTemplateId(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationRepeatNumber(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationInterpretationCode(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationTargetSiteCode(advanceDirectiveObservation, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationHasExternalReference(
			...
			Map<Object, Object> context) {
    return advanceDirectiveObservation.validateIHEAdvanceDirectiveObservationHasExternalReference(diagnostics, context);
  }
   ...
   * @generated
   */
  public boolean validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationCode(AdvanceDirectiveObservation advanceDirectiveObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return advanceDirectiveObservation.validateIHEAdvanceDirectiveObservationCode(diagnostics, context);
  }
   ...
   */
	public boolean validateAdvanceDirectiveObservation_validateIHEAdvanceDirectiveObservationInterpretationCode(
			AdvanceDirectiveObservation advanceDirectiveObservation, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return advanceDirectiveObservation.validateIHEAdvanceDirectiveObservationInterpretationCode(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(physicalExamNarrativeSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(physicalExamNarrativeSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(codedResultsSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(codedResultsSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateCodedResultsSection_validateCodedResultsSectionProcedureEntry(codedResultsSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(carePlanSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(carePlanSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(familyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(familyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionFamilyHistoryObsOrgs(familyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionNoSubject(familyMedicalHistorySection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionText(familyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionFamilyHistoryOrganizer(familyMedicalHistorySection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(encounterHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(encounterHistorySection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersSection_validateEncountersSectionText(encounterHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersSection_validateEncountersSectionEncountersActivity(encounterHistorySection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateEncounterEntry_validateEncounterEntryCodeP(encounterEntry, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(medicalDevicesSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(medicalDevicesSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateMedicalEquipmentSection_validateMedicalEquipmentSectionText(medicalDevicesSection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicalEquipmentSection_validateMedicalEquipmentSectionSupplyActivity(medicalDevicesSection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateMedicalEquipmentSection_validateMedicalEquipmentSectionMedicationActivity(medicalDevicesSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateClassCode(medicalSummary, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateMoodCode(medicalSummary, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsIdRootFormat(medicalSummary, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsLanguageCodeForm(medicalSummary, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateManufacturedProduct_validateClassCode(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductHasMaterial(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductHasMaterialCode(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductHasMaterialCodeVocab(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductHasMaterialCodeOriginalText(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductHasMaterialName(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductMayHaveMaterialManufacturer(productEntry, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductShouldHaveMaterialManufacturer(productEntry, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateProduct_validateProductId(productEntry, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryMoodCode(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryHasTextReference(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryPriorityCode(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryHasInversionIndForEncounter(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryTemplateId(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryClassCode(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryText(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryApproachSiteCode(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryInternalReference(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntry_validateProcedureEntryInternalReferenceReason(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureEntryPlanOfCareActivityProcedure_validateProcedureEntryPlanOfCareActivityProcedureMoodCode(procedureEntryPlanOfCareActivityProcedure, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateProcedureEntryPlanOfCareActivityProcedure_validateProcedureEntryPlanOfCareActivityProcedureMoodCode(
			ProcedureEntryPlanOfCareActivityProcedure procedureEntryPlanOfCareActivityProcedure,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
    return procedureEntryPlanOfCareActivityProcedure.validateProcedureEntryPlanOfCareActivityProcedureMoodCode(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateClassCode(phrExtract, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateMoodCode(phrExtract, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsIdRootFormat(phrExtract, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsLanguageCodeForm(phrExtract, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateClassCode(phrUpdate, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateMoodCode(phrUpdate, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsIdRootFormat(phrUpdate, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= cdtValidator.validateGeneralHeaderConstraints_validateGeneralHeaderConstraintsLanguageCodeForm(phrUpdate, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateEncounterEntry_validateEncounterEntryCodeP(encounterActivity, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersActivity_validateEncountersActivityHasIndications(encounterActivity, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersActivity_validateEncountersActivityHasPractitioners(encounterActivity, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersActivity_validateEncountersActivityPractitionerRole(encounterActivity, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersActivity_validateEncountersActivityPatientInstruction(encounterActivity, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersActivity_validateEncountersActivityAgeObservation(encounterActivity, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateEncountersActivity_validateEncountersActivityEncounterLocation(encounterActivity, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateEncounterEntry_validateEncounterEntryCodeP(encounterPlanOfCare, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(intakeOutputSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(intakeOutputSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateGuardian_validateClassCode(patientContactGuardian, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateParticipant1_validateContextControlCode(patientContactParticipant, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateClassCode(scannedDocument, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateClinicalDocument_validateMoodCode(scannedDocument, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateScannedDocument_validateScannedDocumentScanOriginalAuthor(scannedDocument, diagnostics, context);
    if (result || diagnostics != null) result &= validateScannedDocument_validateScannedDocumentScanningDevice(scannedDocument, diagnostics, context);
    if (result || diagnostics != null) result &= validateScannedDocument_validateScannedDocumentScanDataEnterer(scannedDocument, diagnostics, context);
    if (result || diagnostics != null) result &= validateScannedDocument_validateScannedDocumentLegalAuthenticator(scannedDocument, diagnostics, context);
    if (result || diagnostics != null) result &= validateScannedDocument_validateScannedDocumentDocumentationOf(scannedDocument, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateHospitalDischargePhysical(HospitalDischargePhysical hospitalDischargePhysical,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
    if (!validate_NoCircularContainment(hospitalDischargePhysical, diagnostics, context)) return false;
    boolean result = validate_EveryMultiplicityConforms(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryDataValueConforms(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryProxyResolves(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validate_UniqueID(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryKeyUnique(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validateHospitalDischargePhysical_validateHospitalDischargePhysicalTemplateId(hospitalDischargePhysical, diagnostics, context);
    if (result || diagnostics != null) result &= validateHospitalDischargePhysical_validateHospitalDischargePhysicalCode(hospitalDischargePhysical, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateCodedFamilyMedicalHistorySection(
			...
			Map<Object, Object> context) {
    if (!validate_NoCircularContainment(codedFamilyMedicalHistorySection, diagnostics, context)) return false;
    boolean result = validate_EveryMultiplicityConforms(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryDataValueConforms(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryProxyResolves(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_UniqueID(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryKeyUnique(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionFamilyHistoryObsOrgs(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionNoSubject(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionTemplateId(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionCode(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionTitle(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionText(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistorySection_validateFamilyHistorySectionFamilyHistoryOrganizer(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyMedicalHistorySection_validateFamilyMedicalHistorySectionTemplateId(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validateCodedFamilyMedicalHistorySection_validateCodedFamilyMedicalHistorySectionTemplateId(codedFamilyMedicalHistorySection, diagnostics, context);
    if (result || diagnostics != null) result &= validateCodedFamilyMedicalHistorySection_validateCodedFamilyMedicalHistorySectionFamilyHistoryOrganizer(codedFamilyMedicalHistorySection, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateCodedFamilyMedicalHistorySection_validateCodedFamilyMedicalHistorySectionTemplateId(
			CodedFamilyMedicalHistorySection codedFamilyMedicalHistorySection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return codedFamilyMedicalHistorySection.validateCodedFamilyMedicalHistorySectionTemplateId(diagnostics, context);
  }
   ...
   */
	public boolean validateCodedFamilyMedicalHistorySection_validateCodedFamilyMedicalHistorySectionFamilyHistoryOrganizer(
			CodedFamilyMedicalHistorySection codedFamilyMedicalHistorySection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return codedFamilyMedicalHistorySection.validateCodedFamilyMedicalHistorySectionFamilyHistoryOrganizer(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasComponent(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasFamilyHistoryObservation(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasSubject(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasSubjectPatientRelationship(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerRelationshipValueCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasRelatedSubjectCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerRelatedSubjectCodeValueSet(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasRelatedSubjectSubject(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasGenderCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerRelatedSubjectBirthTime(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerTemplateId(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerStatusCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerClassCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerMoodCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerFamilyHistoryObservation(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerHasParticipant(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerHasParticipantParticipantRole(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerHasParticipantRoleCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerHasParticipantRolePlayingEntity(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerTemplateId(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerFamilyHistoryObservation(familyHistoryOrganizer, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerHasParticipantParticipantRole(
			FamilyHistoryOrganizer familyHistoryOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return familyHistoryOrganizer.validateIHEFamilyHistoryOrganizerHasParticipantParticipantRole(diagnostics, context);
  }
   ...
   */
	public boolean validateFamilyHistoryOrganizer_validateIHEFamilyHistoryOrganizerHasParticipantRolePlayingEntity(
			FamilyHistoryOrganizer familyHistoryOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return familyHistoryOrganizer.validateIHEFamilyHistoryOrganizerHasParticipantRolePlayingEntity(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationHasSubjectPatientRelationship(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationRelationshipValueCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationHasRelatedSubjectCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationRelatedSubjectCodeValueSet(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationHasRelatedSubjectSubject(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationHasGenderCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationRelatedSubjectBirthTime(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationTemplateId(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationId(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationStatusCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationEffectiveTime(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationMoodCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationAgeObservation(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateFamilyHistoryObservation_validateFamilyHistoryObservationProblemStatusObservation(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateSimpleObservationTemplateId(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationId(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationStatusCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateIHEFamilyHistoryObservationCode(familyHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateIHEFamilyHistoryObservationValue(familyHistoryObservation, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationTemplateId(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationId(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSimpleObservation_validateSimpleObservationStatusCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationCodeValueSet(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationTemplateId(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationClassCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationId(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationMoodCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationStatusCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationSocialHistoryStatusObservation(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistoryObservation_validateSocialHistoryObservationEpisodeObservation(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateIHESocialHistoryObservationNoRepeatNumber(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateIHESocialHistoryObservationNoInterpretationCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateIHESocialHistoryObservationNoMethodCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateIHESocialHistoryObservationNoTargetSiteCode(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateIHESocialHistoryObservationTemplateId(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateIHESocialHistoryObservationValue(socialHistoryObservation, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateCodedReasonForReferralSection(CodedReasonForReferralSection codedReasonForReferralSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
    if (!validate_NoCircularContainment(codedReasonForReferralSection, diagnostics, context)) return false;
    boolean result = validate_EveryMultiplicityConforms(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryDataValueConforms(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryProxyResolves(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_UniqueID(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryKeyUnique(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateClassCode(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= cdaValidator.validateSection_validateMoodCode(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validateReasonForReferralSection_validateReasonForReferralSectionTemplateId(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validateReasonForReferralSection_validateReasonForReferralSectionCode(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validateCodedReasonForReferralSection_validateCodedReasonForReferralSectionTemplateId(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validateCodedReasonForReferralSection_validateCodedReasonForReferralSectionSimpleObservation(codedReasonForReferralSection, diagnostics, context);
    if (result || diagnostics != null) result &= validateCodedReasonForReferralSection_validateCodedReasonForReferralSectionProblemEntry(codedReasonForReferralSection, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateCodedReasonForReferralSection_validateCodedReasonForReferralSectionSimpleObservation(
			CodedReasonForReferralSection codedReasonForReferralSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return codedReasonForReferralSection.validateCodedReasonForReferralSectionSimpleObservation(diagnostics, context);
  }
