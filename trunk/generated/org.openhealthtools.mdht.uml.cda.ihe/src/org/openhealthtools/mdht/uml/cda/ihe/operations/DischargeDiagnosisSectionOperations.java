...
"value.code = '11535-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_DISCHARGE_DIAGNOSIS_SECTION_PROBLEM_CONCERN_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dischargeDiagnosisSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.DISCHARGE_DIAGNOSIS_SECTION, IHEPackage.Literals.DISCHARGE_DIAGNOSIS_SECTION.getEAllOperations().get(58));
      try
      {
