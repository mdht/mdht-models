        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             IHEPlugin.INSTANCE.getString("ProblemEntryCodeP"),
             new Object [] { problemEntry }));
      }
...
"not value.codeSystem.oclIsUndefined() or not value.codeSystemName.oclIsUndefined())";
   ...
   */
    ...
    Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.ihe.ProblemEntryCodeP");
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.PROBLEM_ENTRY, IHEPackage.Literals.PROBLEM_ENTRY.getEAllOperations().get(76));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.PROBLEM_ENTRY, IHEPackage.Literals.PROBLEM_ENTRY.getEAllOperations().get(77));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.PROBLEM_ENTRY, IHEPackage.Literals.PROBLEM_ENTRY.getEAllOperations().get(78));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.PROBLEM_ENTRY, IHEPackage.Literals.PROBLEM_ENTRY.getEAllOperations().get(79));
      try
      {
