 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ProblemEntryTemplateId ProblemEntryHasTextReference ProblemEntryCommentInversionInd ProblemEntryId ProblemEntryText ProblemEntryValue' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.4.5' code.codeSystem='2.16.840.1.113883.6.96' code.codeSystemName='SNOMEDCT' constraints.validation.info='ProblemEntryCode ProblemEntrySeverity ProblemEntryProblemStatusObservation ProblemEntryHealthStatusObservation ProblemEntryComment' constraints.validation.warning='ProblemEntryCodeP ProblemEntryEffectiveTime' constraints.validation.dependOn.ProblemEntryCode='ProblemEntryCodeP'"
 * @generated
 */
public interface ProblemEntry extends ProblemObservation {
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(ihe::HealthStatusObservation))->asSequence()->any(true).oclAsType(ihe::HealthStatusObservation)'"
	 * @generated
	 */
