 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.info='AbdomenSectionProblemEntry' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.31' constraints.validation.error='AbdomenSectionTemplateId AbdomenSectionCode' code.displayName='ABDOMEN' code.codeSystem='2.16.840.1.113883.6.1' code.code='10191-5'"
 * @generated
 */
