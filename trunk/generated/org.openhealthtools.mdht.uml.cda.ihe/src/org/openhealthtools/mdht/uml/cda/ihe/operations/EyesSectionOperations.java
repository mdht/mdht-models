        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("EyesSectionTemplateId"),
...
"value.code = '10197-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
      ...
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             IHEValidator.DIAGNOSTIC_SOURCE,
             IHEValidator.EYES_SECTION__EYES_SECTION_CODE,
             IHEPlugin.INSTANCE.getString("EyesSectionCode"),
             new Object [] { eyesSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.EYES_SECTION, IHEPackage.Literals.EYES_SECTION.getEAllOperations().get(58));
      try
      {
