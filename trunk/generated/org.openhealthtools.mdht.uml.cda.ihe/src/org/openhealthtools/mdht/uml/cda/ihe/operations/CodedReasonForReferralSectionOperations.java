...
public class CodedReasonForReferralSectionOperations extends ReasonForReferralSectionOperations {
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_CODED_REASON_FOR_REFERRAL_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(codedReasonForReferralSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_CODED_REASON_FOR_REFERRAL_SECTION_SIMPLE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(codedReasonForReferralSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_CODED_REASON_FOR_REFERRAL_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(codedReasonForReferralSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.CODED_REASON_FOR_REFERRAL_SECTION, IHEPackage.Literals.CODED_REASON_FOR_REFERRAL_SECTION.getEAllOperations().get(60));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.CODED_REASON_FOR_REFERRAL_SECTION, IHEPackage.Literals.CODED_REASON_FOR_REFERRAL_SECTION.getEAllOperations().get(61));
      try
      {
