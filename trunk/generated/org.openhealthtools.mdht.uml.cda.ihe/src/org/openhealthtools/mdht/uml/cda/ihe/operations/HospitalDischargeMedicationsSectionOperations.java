...
"value.code = '10183-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.HOSPITAL_DISCHARGE_MEDICATIONS_SECTION, IHEPackage.Literals.HOSPITAL_DISCHARGE_MEDICATIONS_SECTION.getEAllOperations().get(58));
      try
      {
