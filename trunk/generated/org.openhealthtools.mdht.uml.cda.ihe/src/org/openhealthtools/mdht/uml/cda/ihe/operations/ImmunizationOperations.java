        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ImmunizationComments", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(immunization, context) }),
      ...
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             IHEValidator.DIAGNOSTIC_SOURCE,
             IHEValidator.IMMUNIZATION__IMMUNIZATION_CODE,
             IHEPlugin.INSTANCE.getString("ImmunizationCode"),
             new Object [] { immunization }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ImmunizationStatusCode"),
             new Object [] { immunization }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ImmunizationMoodCode"),
             new Object [] { immunization }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ImmunizationEffectiveTime"),
             new Object [] { immunization }));
      }
