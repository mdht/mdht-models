...
public class AllergyIntoleranceOperations extends ProblemEntryOperations {
	...
	* <!-- end-user-doc -->
	...
	public static boolean validateAllergyIntoleranceCodeP(AllergyIntolerance allergyIntolerance,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_INTOLERANCE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyIntolerance)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, IHEValidator.DIAGNOSTIC_SOURCE,
					IHEValidator.ALLERGY_INTOLERANCE__ALLERGY_INTOLERANCE_CODE_P,
					IHEPlugin.INSTANCE.getString("AllergyIntoleranceCodeP"), new Object[] { allergyIntolerance }));
			}
	...
	public static boolean validateAllergyIntoleranceCode(AllergyIntolerance allergyIntolerance,
		...
		Object passToken = (context == null)
				? null
				: context.get("org.openhealthtools.mdht.uml.cda.ihe.AllergyIntoleranceCodeP");
	...
	public static EList<Comment> getIHEComments(AllergyIntolerance allergyIntolerance) {
		if (GET_IHE_COMMENTS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IHEPackage.Literals.ALLERGY_INTOLERANCE,
				IHEPackage.Literals.ALLERGY_INTOLERANCE.getEAllOperations().get(101));
			try {
