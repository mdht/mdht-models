 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.PlanOfCareActivitySupplyImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlanOfCareActivitySupplyImpl extends PlanOfCareActivityImpl implements IPlanOfCareActivitySupply {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getPlanOfCareActivitySupply();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPlanOfCareActivitySupply(), IDomainPackage.eINSTANCE.getPlanOfCareActivitySupply().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IPlanOfCareActivitySupply addId(II value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.PLAN_OF_CARE_ACTIVITY_SUPPLY__CDA_TYPE:
