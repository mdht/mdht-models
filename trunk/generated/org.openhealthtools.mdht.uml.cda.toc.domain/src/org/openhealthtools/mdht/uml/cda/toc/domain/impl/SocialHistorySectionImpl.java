 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.SocialHistorySectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SocialHistorySectionImpl extends EObjectImpl implements ISocialHistorySection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getSocialHistorySection();
	}
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSocialHistorySection(), IDomainPackage.eINSTANCE.getSocialHistorySection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public ISocialHistorySection setTitle(ST value) {
		this.getCDAType().setTitle(value);
		return this;
	}
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSocialHistorySection(), IDomainPackage.eINSTANCE.getSocialHistorySection().getEAllOperations().get(3));
			try {
	...
	public EList<ISocialHistory> getSocialHistories() {
		if (GET_SOCIAL_HISTORIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSocialHistorySection(), IDomainPackage.eINSTANCE.getSocialHistorySection().getEAllOperations().get(6));
			try {
