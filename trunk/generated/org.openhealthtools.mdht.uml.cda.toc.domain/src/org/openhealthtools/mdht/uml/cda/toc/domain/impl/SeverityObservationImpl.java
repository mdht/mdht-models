 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.SeverityObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SeverityObservationImpl extends EObjectImpl implements ISeverityObservation {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getSeverityObservation();
	}
	...
	public ANY getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSeverityObservation(), IDomainPackage.eINSTANCE.getSeverityObservation().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public ISeverityObservation setValue(ANY value) {
		this.getCDAType().getValues().add(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.SEVERITY_OBSERVATION__CDA_TYPE:
