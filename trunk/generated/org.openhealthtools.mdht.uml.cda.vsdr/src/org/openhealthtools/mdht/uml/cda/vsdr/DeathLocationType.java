 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Death LocationTypeTemplateId Death LocationTypeClassCode Death LocationTypeMoodCode Death LocationTypeCode Death LocationTypeCodeP Death LocationTypeValue Death LocationTypeValueP' templateId.root='2.16.840.1.113883.10.20.26.1.8' classCode='OBS' moodCode='EVN' code.code='58332-8' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Location of Death'"
 * @generated
 */
public interface DeathLocationType extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.26.1.8\')'"
	 * @generated
	 */
