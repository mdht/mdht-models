 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='DeathLocationTypeTemplateId DeathLocationTypeClassCode DeathLocationTypeCode DeathLocationTypeCodeP DeathLocationTypeMoodCode DeathLocationTypeValue DeathLocationTypeValueP' templateId.root='2.16.840.1.113883.10.20.26.1.8' classCode='OBS' code.code='LOINC TBD' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' constraints.validation.dependOn.DeathLocationTypeCode='DeathLocationTypeCodeP' moodCode='EVN' value.codeSystem='OID TBD' value.codeSystemName='Death Location Types'"
 * @generated
 */
