 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Tobacco UseTemplateId Tobacco UseClassCode Tobacco UseMoodCode Tobacco UseCode Tobacco UseValue' templateId.root='2.16.840.1.113883.10.20.26.1.14' classCode='OBS' moodCode='EVN' code.code='69443-0' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Tobacco Use'"
 * @generated
 */
public interface TobaccoUse extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.26.1.14\')'"
	 * @generated
	 */
