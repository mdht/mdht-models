        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsTypeIdExtension"),
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsSetIdAndVersionNumber"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsSetIdAndIdAreUnique"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsCopyTimeNotPresent"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasRecordTargetPatientRole"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasPatientBirthTime"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasAdministrativeGenderCode"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasProviderOrganization"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasAuthorTime"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasAssignedAuthorId"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasAssignedAuthorPersonOrDevice"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasDataEntererAssignedPerson"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasDataEntererTime"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasInformant"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsHasInformantAssignedPersonOrRelatedPerson"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsLegalAuthenticatorHasAssignedPerson"),
             new Object [] { generalHeaderConstraints }));
      }
...
"   not entity.assignedPerson.oclIsUndefined()))";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsAuthenticatorHasAssignedPerson"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsTemplateId"),
             new Object [] { generalHeaderConstraints }));
      }
  ...
  public static  boolean validateGeneralHeaderConstraintsCodeP(GeneralHeaderConstraints generalHeaderConstraints, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_GENERAL_HEADER_CONSTRAINTS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(generalHeaderConstraints))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsCodeP"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsCode"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsConfidentialityCode"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsEffectiveTime"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsId"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsLanguageCode"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsTitle"),
             new Object [] { generalHeaderConstraints }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("GeneralHeaderConstraintsTypeId"),
             new Object [] { generalHeaderConstraints }));
      }
