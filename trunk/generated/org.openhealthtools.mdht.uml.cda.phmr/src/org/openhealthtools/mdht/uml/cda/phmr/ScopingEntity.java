 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='null' constraints.validation.error='ScopingEntityTemplateId ScopingEntityDesc'"
 * @generated
 */
public interface ScopingEntity extends Entity {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * (self.desc.oclIsUndefined() or self.desc.isNullFlavorUndefined()) implies (not self.desc.oclIsUndefined())
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
