...
public class DeviceMeasurementRangeObservationOperations extends ClinicalStatementOperations {
  ...
  protected static Constraint VALIDATE_DEVICE_MEASUREMENT_RANGE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateDeviceMeasurementRangeObservationCodeP(DeviceMeasurementRangeObservation deviceMeasurementRangeObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_DEVICE_MEASUREMENT_RANGE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(PhmrPackage.Literals.DEVICE_MEASUREMENT_RANGE_OBSERVATION);
      try
      {
        VALIDATE_DEVICE_MEASUREMENT_RANGE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_DEVICE_MEASUREMENT_RANGE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_DEVICE_MEASUREMENT_RANGE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(deviceMeasurementRangeObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("DeviceMeasurementRangeObservationCodeP"),
             new Object [] { deviceMeasurementRangeObservation }));
      }
