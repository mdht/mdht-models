...
public class WaveformSeriesObservationOperations extends ClinicalStatementOperations {
  ...
  protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateWaveformSeriesObservationCodeP(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
      try
      {
        VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationCodeP"),
             new Object [] { waveformSeriesObservation }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96')";
  ...
  protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_PHMR_PRODUCT_INSTANCE_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateWaveformSeriesObservationPHMRProductInstanceReference(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_PHMR_PRODUCT_INSTANCE_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
      try
      {
        VALIDATE_WAVEFORM_SERIES_OBSERVATION_PHMR_PRODUCT_INSTANCE_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_PHMR_PRODUCT_INSTANCE_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_PHMR_PRODUCT_INSTANCE_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationPHMRProductInstanceReference"),
             new Object [] { waveformSeriesObservation }));
      }
