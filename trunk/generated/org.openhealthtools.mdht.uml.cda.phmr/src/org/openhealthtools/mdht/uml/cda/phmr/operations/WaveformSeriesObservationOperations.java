 ...
 * @generated
 */
public class WaveformSeriesObservationOperations extends ClinicalStatementOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.9.12')
	...
	public static  boolean validateWaveformSeriesObservationTemplateId(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationTemplateId"),
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.classCode=vocab::ActClassObservation::OBSSER
	 * @param waveformSeriesObservation The receiving '<em><b>Waveform Series Observation</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	...
	public static  boolean validateWaveformSeriesObservationClassCode(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationClassCode"),
						 new Object [] { waveformSeriesObservation }));
			}
			return false;
		}
...
"value.codeSystem = '2.16.840.1.113883.6.96'))";
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateWaveformSeriesObservationCode(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationCode"),
						 new Object [] { waveformSeriesObservation }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateWaveformSeriesObservationEffectiveTime(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationEffectiveTime"),
						 new Object [] { waveformSeriesObservation }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateWaveformSeriesObservationMoodCode(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationMoodCode"),
						 new Object [] { waveformSeriesObservation }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_MEDIA_JPG__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.observationMedia.oclIsUndefined() and entryRelationship.observationMedia.oclIsKindOf(cda::ObservationMedia))
	 * @param waveformSeriesObservation The receiving '<em><b>Waveform Series Observation</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	...
	public static  boolean validateWaveformSeriesObservationObservationMediaJPG(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_MEDIA_JPG__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_MEDIA_JPG__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_MEDIA_JPG__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_MEDIA_JPG__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationObservationMediaJPG"),
						 new Object [] { waveformSeriesObservation }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static Constraint VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateWaveformSeriesObservationObservationNullFlavor(WaveformSeriesObservation waveformSeriesObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_WAVEFORM_SERIES_OBSERVATION_OBSERVATION_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(waveformSeriesObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformSeriesObservationObservationNullFlavor"),
						 new Object [] { waveformSeriesObservation }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static final String GET_OBSERVATION_MEDIA_JPG__EOCL_EXP = "self.getObservationMedia()->select(observationMedia : cda::ObservationMedia | not observationMedia.oclIsUndefined() and observationMedia.oclIsKindOf(cda::ObservationMedia))->asSequence()->first().oclAsType(cda::ObservationMedia)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getObservationMedia()->select(observationMedia : cda::ObservationMedia | not observationMedia.oclIsUndefined() and observationMedia.oclIsKindOf(cda::ObservationMedia))->asSequence()->first().oclAsType(cda::ObservationMedia)
	 * @param waveformSeriesObservation The receiving '<em><b>Waveform Series Observation</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
	public static  ObservationMedia getObservationMediaJPG(WaveformSeriesObservation waveformSeriesObservation) {
		if (GET_OBSERVATION_MEDIA_JPG__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION, PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION.getEAllOperations().get(56));
			try {
		...
		OCL.Query query = EOCL_ENV.createQuery(GET_OBSERVATION_MEDIA_JPG__EOCL_QRY);
		return (ObservationMedia) query.evaluate(waveformSeriesObservation);
	}
	 ...
	 * @ordered
	 */
	protected static final String GET_OBSERVATION_NULL_FLAVOR__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(cda::Observation))->asSequence()->first().oclAsType(cda::Observation)";
	 ...
	 * @generated
	 */
	public static  Observation getObservationNullFlavor(WaveformSeriesObservation waveformSeriesObservation) {
		if (GET_OBSERVATION_NULL_FLAVOR__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION, PhmrPackage.Literals.WAVEFORM_SERIES_OBSERVATION.getEAllOperations().get(57));
			try {
		...
		OCL.Query query = EOCL_ENV.createQuery(GET_OBSERVATION_NULL_FLAVOR__EOCL_QRY);
		return (Observation) query.evaluate(waveformSeriesObservation);
	}
