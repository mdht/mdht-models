...
public class ProcedureActivityActOperations extends ClinicalStatementOperations {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             CCDPlugin.INSTANCE.getString("ProcedureActivityActMoodCode"),
             new Object [] { procedureActivityAct }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             CCDPlugin.INSTANCE.getString("ProcedureActivityActCode"),
             new Object [] { procedureActivityAct }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             CCDPlugin.INSTANCE.getString("ProcedureActivityActId"),
             new Object [] { procedureActivityAct }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_ENCOUNTER_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_PERFORMER2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_PROBLEM_ACT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_AGE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_PATIENT_INSTRUCTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT, CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT.getEAllOperations().get(63));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT, CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT.getEAllOperations().get(64));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT, CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT.getEAllOperations().get(65));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT, CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT.getEAllOperations().get(66));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT, CCDPackage.Literals.PROCEDURE_ACTIVITY_ACT.getEAllOperations().get(67));
      try
      {
