 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ProcedureActivityObservationTemplateId ProcedureActivityObservationMoodCode ProcedureActivityObservationCode ProcedureActivityObservationId ProcedureActivityObservationStatusCode' contextDependent='true' templateId.root='2.16.840.1.113883.10.20.1.29' moodCode='EVN' constraints.validation.warning='ProcedureActivityObservationEffectiveTime' constraints.validation.info='ProcedureActivityObservationEncounterLocation ProcedureActivityObservationPerformer2 ProcedureActivityObservationProblemObservation ProcedureActivityObservationAgeObservation ProcedureActivityObservationMedicationActivity ProcedureActivityObservationPatientInstruction ProcedureActivityObservationProblemAct'"
 * @generated
 */
public interface ProcedureActivityObservation extends Observation, ProcedureActivity {
	 ...
	 * @generated
	 */
	boolean validateProcedureActivityObservationProblemObservation(DiagnosticChain diagnostics,
			Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProcedureActivityObservationAgeObservation(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProcedureActivityObservationPatientInstruction(DiagnosticChain diagnostics,
			Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateProcedureActivityObservationProblemAct(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(ccd::ProblemObservation))->asSequence()->first().oclAsType(ccd::ProblemObservation)'"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(ccd::ProblemAct))->asSequence()->first().oclAsType(ccd::ProblemAct)'"
	 * @generated
	 */
