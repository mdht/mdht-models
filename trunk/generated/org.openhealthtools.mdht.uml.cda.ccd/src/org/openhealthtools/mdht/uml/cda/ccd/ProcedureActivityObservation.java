 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation contextDependent='true' moodCode='EVN' constraints.validation.info='ProcedureActivityObservationEncounterLocation ProcedureActivityObservationPerformer2 ProcedureActivityObservationProblemObservation ProcedureActivityObservationAgeObservation ProcedureActivityObservationMedicationActivity ProcedureActivityObservationPatientInstruction ProcedureActivityObservationProblemAct' templateId.root='2.16.840.1.113883.10.20.1.29' constraints.validation.error='ProcedureActivityObservationTemplateId ProcedureActivityObservationMoodCode ProcedureActivityObservationCode ProcedureActivityObservationId ProcedureActivityObservationStatusCode' constraints.validation.warning='ProcedureActivityObservationEffectiveTime'"
 * @generated
 */
