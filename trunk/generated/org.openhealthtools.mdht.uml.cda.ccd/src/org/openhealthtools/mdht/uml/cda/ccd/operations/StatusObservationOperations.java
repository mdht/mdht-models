...
public class StatusObservationOperations extends ClinicalStatementOperations {
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_STATUS_OBSERVATION_TARGET_OF_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(statusObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_STATUS_OBSERVATION_NO_ADDITIONAL_RELATIONSHIPS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(statusObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
