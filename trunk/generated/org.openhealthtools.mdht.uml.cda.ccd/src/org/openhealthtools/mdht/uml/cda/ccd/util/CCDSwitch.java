   ...
   */
    ...
    switch (classifierID)
    {
      ...
      case CCDPackage.FAMILY_HISTORY_CAUSE_OF_DEATH_OBSERVATION:
      {
        ...
        if (result == null) result = caseFamilyHistoryObservation(familyHistoryCauseOfDeathObservation);
        if (result == null) result = caseObservation(familyHistoryCauseOfDeathObservation);
        if (result == null) result = caseClinicalStatement(familyHistoryCauseOfDeathObservation);
        if (result == null) result = caseAct(familyHistoryCauseOfDeathObservation);
        if (result == null) result = caseInfrastructureRoot(familyHistoryCauseOfDeathObservation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
