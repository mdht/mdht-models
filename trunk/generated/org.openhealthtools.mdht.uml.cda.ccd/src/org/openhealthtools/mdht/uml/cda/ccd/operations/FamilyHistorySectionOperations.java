...
"value.code = '10157-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             CCDPlugin.INSTANCE.getString("FamilyHistorySectionText"),
             new Object [] { familyHistorySection }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FAMILY_HISTORY_SECTION_FAMILY_HISTORY_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(familyHistorySection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.FAMILY_HISTORY_SECTION, CCDPackage.Literals.FAMILY_HISTORY_SECTION.getEAllOperations().get(62));
      try
      {
