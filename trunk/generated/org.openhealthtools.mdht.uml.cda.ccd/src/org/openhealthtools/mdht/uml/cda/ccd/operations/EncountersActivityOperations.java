...
public class EncountersActivityOperations extends ClinicalStatementOperations {
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_ENCOUNTERS_ACTIVITY_ENCOUNTER_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encountersActivity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.ENCOUNTERS_ACTIVITY, CCDPackage.Literals.ENCOUNTERS_ACTIVITY.getEAllOperations().get(62));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.ENCOUNTERS_ACTIVITY, CCDPackage.Literals.ENCOUNTERS_ACTIVITY.getEAllOperations().get(63));
      try
      {
