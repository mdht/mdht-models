...
public class CCDValidator extends EObjectValidator {
   ...
   */
    ...
    switch (classifierID)
    {
      ...
      case CCDPackage.FAMILY_HISTORY_CAUSE_OF_DEATH_OBSERVATION:
        return validateFamilyHistoryCauseOfDeathObservation((FamilyHistoryCauseOfDeathObservation)value, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateContinuityOfCareDocument_validateContinuityOfCareDocumentLanguageCodeFormat(continuityOfCareDocument, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateContinuityOfCareDocument_validateContinuityOfCareDocumentHasEffectiveTimeSeconds(continuityOfCareDocument, diagnostics, context);
    if (result || diagnostics != null) result &= validateContinuityOfCareDocument_validateContinuityOfCareDocumentHasEffectiveTimeZone(continuityOfCareDocument, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(problemStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(statusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(problemHealthStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateFamilyHistorySection_validateFamilyHistorySectionFamilyHistoryOrganizer(familyHistorySection, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasComponent(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasFamilyHistoryObservation(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasSubject(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasSubjectPatientRelationship(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerRelationshipValueCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasRelatedSubjectCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerRelatedSubjectCodeValueSet(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasRelatedSubjectSubject(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerHasGenderCode(familyHistoryOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryOrganizer_validateFamilyHistoryOrganizerRelatedSubjectBirthTime(familyHistoryOrganizer, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateResultOrganizer_validateResultOrganizerSpecimen(resultOrganizer, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateSocialHistoryObservationCodeValueSet(socialHistoryObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateSocialHistoryObservationSocialHistoryStatusObservation(socialHistoryObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryObservation_validateSocialHistoryObservationEpisodeObservation(socialHistoryObservation, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateSocialHistoryObservation_validateSocialHistoryObservationSocialHistoryStatusObservation(
			SocialHistoryObservation socialHistoryObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return socialHistoryObservation.validateSocialHistoryObservationSocialHistoryStatusObservation(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationTargetOfEntryRelationship(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalParticipants(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateSocialHistoryStatusObservation_validateStatusObservationTemplateId(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationClassCode(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationMoodCode(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationCode(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationStatusCode(socialHistoryStatusObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationValue(socialHistoryStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateEncountersActivity_validateEncountersActivityEncounterLocation(encountersActivity, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateReactionObservation_validateReactionObservationHasReactionIntervention(reactionObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(alertStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasSubjectPatientRelationship(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationRelationshipValueCode(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasRelatedSubjectCode(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationRelatedSubjectCodeValueSet(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasRelatedSubjectSubject(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasGenderCode(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationRelatedSubjectBirthTime(causeOfDeathObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationEffectiveTime(causeOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationMoodCode(causeOfDeathObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationProblemStatusObservation(causeOfDeathObservation, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(medicationStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateResultOrganizer_validateResultOrganizerSpecimen(vitalSignsOrganizer, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvDirectiveCodeValueSet(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvDirectiveCodeCodeSystem(advanceDirectiveObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveStatusObservation(advanceDirectiveObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveReference(advanceDirectiveObservation, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvDirectiveCodeValueSet(
			...
			Map<Object, Object> context) {
    return advanceDirectiveObservation.validateAdvanceDirectiveObservationAdvDirectiveCodeValueSet(diagnostics, context);
  }
   ...
   */
	public boolean validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvDirectiveCodeCodeSystem(
			AdvanceDirectiveObservation advanceDirectiveObservation, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return advanceDirectiveObservation.validateAdvanceDirectiveObservationAdvDirectiveCodeCodeSystem(diagnostics, context);
  }
   ...
   */
	public boolean validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveStatusObservation(
			AdvanceDirectiveObservation advanceDirectiveObservation, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return advanceDirectiveObservation.validateAdvanceDirectiveObservationAdvanceDirectiveStatusObservation(diagnostics, context);
  }
   ...
   */
	public boolean validateAdvanceDirectiveObservation_validateAdvanceDirectiveObservationAdvanceDirectiveReference(
			AdvanceDirectiveObservation advanceDirectiveObservation, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return advanceDirectiveObservation.validateAdvanceDirectiveObservationAdvanceDirectiveReference(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(advanceDirectiveStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateAuthorizationActivity_validateAuthorizationActivityEntryRelationshipTypeCode(authorizationActivity, diagnostics, context);
    if (result || diagnostics != null) result &= validateAuthorizationActivity_validateAuthorizationActivityEntryRelationshipTarget(authorizationActivity, diagnostics, context);
    if (result || diagnostics != null) result &= validateAuthorizationActivity_validateAuthorizationActivityHasPerformers(authorizationActivity, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateAuthorizationActivity_validateAuthorizationActivityEntryRelationship(authorizationActivity, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateStatusObservation_validateStatusObservationNoAdditionalRelationships(functionalStatusObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActMoodCode(procedureActivityAct, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActEncounterLocation(procedureActivityAct, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActPerformer2(procedureActivityAct, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActProblemAct(procedureActivityAct, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActProblemObservation(procedureActivityAct, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActAgeObservation(procedureActivityAct, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityAct_validateProcedureActivityActPatientInstruction(procedureActivityAct, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationMoodCode(procedureActivityObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationEncounterLocation(procedureActivityObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationPerformer2(procedureActivityObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationProblemObservation(procedureActivityObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationAgeObservation(procedureActivityObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationPatientInstruction(procedureActivityObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityObservation_validateProcedureActivityObservationProblemAct(procedureActivityObservation, diagnostics, context);
    return result;
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityProcedure_validateProcedureActivityProcedureMoodCode(procedureActivityProcedure, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateProcedureActivityProcedure_validateProcedureActivityProcedureEncounterLocation(procedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityProcedure_validateProcedureActivityProcedurePerformer2(procedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityProcedure_validateProcedureActivityProcedureProblemObservation(procedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityProcedure_validateProcedureActivityProcedureProblemAct(procedureActivityProcedure, diagnostics, context);
    if (result || diagnostics != null) result &= validateProcedureActivityProcedure_validateProcedureActivityProcedureAgeObservation(procedureActivityProcedure, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= validateAdvanceDirectiveReference_validateAdvanceDirectiveReferenceExternalDocument(advanceDirectiveReference, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateFamilyHistoryCauseOfDeathObservation(
			...
			Map<Object, Object> context) {
    if (!validate_NoCircularContainment(familyHistoryCauseOfDeathObservation, diagnostics, context)) return false;
    boolean result = validate_EveryMultiplicityConforms(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryDataValueConforms(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryProxyResolves(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validate_UniqueID(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryKeyUnique(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasSubjectPatientRelationship(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationRelationshipValueCode(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasRelatedSubjectCode(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationRelatedSubjectCodeValueSet(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasRelatedSubjectSubject(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationHasGenderCode(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationRelatedSubjectBirthTime(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryCauseOfDeathObservation_validateFamilyHistoryObservationTemplateId(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationId(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationStatusCode(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationEffectiveTime(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationMoodCode(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationAgeObservation(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryObservation_validateFamilyHistoryObservationProblemStatusObservation(familyHistoryCauseOfDeathObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateFamilyHistoryCauseOfDeathObservation_validateFamilyHistoryCauseOfDeathObservationCauseOfDeathObservation(familyHistoryCauseOfDeathObservation, diagnostics, context);
    return result;
  }
   ...
   */
	public boolean validateFamilyHistoryCauseOfDeathObservation_validateFamilyHistoryCauseOfDeathObservationCauseOfDeathObservation(
			FamilyHistoryCauseOfDeathObservation familyHistoryCauseOfDeathObservation, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    return familyHistoryCauseOfDeathObservation.validateFamilyHistoryCauseOfDeathObservationCauseOfDeathObservation(diagnostics, context);
  }
