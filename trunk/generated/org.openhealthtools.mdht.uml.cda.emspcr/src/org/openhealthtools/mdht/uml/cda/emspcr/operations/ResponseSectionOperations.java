...
public class ResponseSectionOperations extends SectionOperations {
	...
	public static  boolean validateResponseSectionTemplateId(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ResponseSectionTemplateId"),
...
"value.code = '67664-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateResponseSectionCode(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ResponseSectionCode"),
						 new Object [] { responseSection }));
			}
	...
	public static  boolean validateResponseSectionCodeP(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ResponseSectionCodeP"),
						 new Object [] { responseSection }));
			}
	...
	public static  boolean validateResponseSectionTitle(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ResponseSectionTitle"),
						 new Object [] { responseSection }));
			}
	...
	public static  boolean validateResponseSectionText(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ResponseSectionText"),
						 new Object [] { responseSection }));
			}
	...
	public static  boolean validateResponseSectionDelayOrganizer(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_DELAY_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ResponseSectionDelayOrganizer"),
						 new Object [] { responseSection }));
			}
	...
	public static  boolean validateResponseSectionDispatchLocationOrganizer(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_DISPATCH_LOCATION_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateResponseSectionResponseOdometerReadingOrganizer(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_RESPONSE_ODOMETER_READING_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateResponseSectionResponseModeToScene(ResponseSection responseSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSE_SECTION_RESPONSE_MODE_TO_SCENE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(responseSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  DelayOrganizer getDelayOrganizer(ResponseSection responseSection) {
		if (GET_DELAY_ORGANIZER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.RESPONSE_SECTION, EmspcrPackage.Literals.RESPONSE_SECTION.getEAllOperations().get(64));
			try {
	...
	public static  DispatchLocationOrganizer getDispatchLocationOrganizer(ResponseSection responseSection) {
		if (GET_DISPATCH_LOCATION_ORGANIZER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.RESPONSE_SECTION, EmspcrPackage.Literals.RESPONSE_SECTION.getEAllOperations().get(65));
			try {
	...
	public static  ResponseOdometerReadingOrganizer getResponseOdometerReadingOrganizer(ResponseSection responseSection) {
		if (GET_RESPONSE_ODOMETER_READING_ORGANIZER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.RESPONSE_SECTION, EmspcrPackage.Literals.RESPONSE_SECTION.getEAllOperations().get(66));
			try {
	...
	public static  ResponseModeToScene getResponseModeToScene(ResponseSection responseSection) {
		if (GET_RESPONSE_MODE_TO_SCENE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.RESPONSE_SECTION, EmspcrPackage.Literals.RESPONSE_SECTION.getEAllOperations().get(67));
			try {
