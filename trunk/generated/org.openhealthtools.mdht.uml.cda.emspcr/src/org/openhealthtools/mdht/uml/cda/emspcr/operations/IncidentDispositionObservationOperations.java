...
public class IncidentDispositionObservationOperations extends ClinicalStatementOperations {
	...
	public static boolean validateIncidentDispositionObservationTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INCIDENT_DISPOSITION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateIncidentDispositionObservationCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INCIDENT_DISPOSITION_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			incidentDispositionObservation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
			...
			if (context != null) {
				...
				if (passToken == null) {
					...
					context.put(
						"org.openhealthtools.mdht.uml.cda.emspcr.IncidentDispositionObservationCodeP", passToken);
				}
	...
	public static boolean validateIncidentDispositionObservationCode(
		...
		Object passToken = (context == null)
				? null
				: context.get("org.openhealthtools.mdht.uml.cda.emspcr.IncidentDispositionObservationCodeP");
		if ((passToken instanceof Collection<?>) &&
				((Collection<?>) passToken).contains(incidentDispositionObservation)) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INCIDENT_DISPOSITION_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			incidentDispositionObservation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateIncidentDispositionObservationValue(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INCIDENT_DISPOSITION_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			incidentDispositionObservation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateIncidentDispositionObservationValueP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INCIDENT_DISPOSITION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			incidentDispositionObservation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateIncidentDispositionObservationMoodCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INCIDENT_DISPOSITION_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			incidentDispositionObservation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
