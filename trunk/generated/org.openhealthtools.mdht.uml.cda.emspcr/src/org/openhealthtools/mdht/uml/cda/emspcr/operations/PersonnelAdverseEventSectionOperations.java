...
public class PersonnelAdverseEventSectionOperations extends SectionOperations {
	...
	public static boolean validatePersonnelAdverseEventSectionTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validatePersonnelAdverseEventSectionCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			personnelAdverseEventSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePersonnelAdverseEventSectionCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			personnelAdverseEventSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePersonnelAdverseEventSectionTitle(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			personnelAdverseEventSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePersonnelAdverseEventSectionText(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			personnelAdverseEventSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePersonnelAdverseEventSectionAdverseEventIndicator(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_ADVERSE_EVENT_INDICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			personnelAdverseEventSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validatePersonnelAdverseEventSectionAdverseEventTypeObservation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PERSONNEL_ADVERSE_EVENT_SECTION_ADVERSE_EVENT_TYPE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			personnelAdverseEventSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static AdverseEventIndicator getAdverseEventIndicator(
		...
		if (GET_ADVERSE_EVENT_INDICATOR__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				EmspcrPackage.Literals.PERSONNEL_ADVERSE_EVENT_SECTION,
				EmspcrPackage.Literals.PERSONNEL_ADVERSE_EVENT_SECTION.getEAllOperations().get(62));
			try {
	...
	public static AdverseEventTypeObservation getAdverseEventTypeObservation(
		...
		if (GET_ADVERSE_EVENT_TYPE_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				EmspcrPackage.Literals.PERSONNEL_ADVERSE_EVENT_SECTION,
				EmspcrPackage.Literals.PERSONNEL_ADVERSE_EVENT_SECTION.getEAllOperations().get(63));
			try {
