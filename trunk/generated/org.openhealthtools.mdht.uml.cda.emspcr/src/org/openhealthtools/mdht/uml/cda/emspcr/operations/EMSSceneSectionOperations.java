 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSSceneSection#getEntry1() <em>Get Entry1</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSSceneSection#getEntry3() <em>Get Entry3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67665-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_SCENE_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSSceneSection::EMSFirstUnitEntry))";
   ...
   */
	...
	public static boolean validateEMSSceneSectionEntry1(EMSSceneSection emsSceneSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_SCENE_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSSceneSection::EMSScenePatientCountEntry))";
   ...
   */
	...
	public static boolean validateEMSSceneSectionEntry3(EMSSceneSection emsSceneSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry1(EMSSceneSection) <em>Get Entry1</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSSceneSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY1__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSSceneSection::EMSFirstUnitEntry))->asSequence()->first().oclAsType(emspcr::EMSSceneSection::EMSFirstUnitEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry1(EMSSceneSection) <em>Get Entry1</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSSceneSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry1(EMSSceneSection emsSceneSection)
  {
    if (GET_ENTRY1__EOCL_QRY == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(EmspcrPackage.Literals.EMS_SCENE_SECTION, EmspcrPackage.Literals.EMS_SCENE_SECTION.getEAllOperations().get(61));
      try
      {
    ...
    return (void) query.evaluate(emsSceneSection);
  }

  /**
   * The cached OCL expression body for the '{@link #getEntry3(EMSSceneSection) <em>Get Entry3</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry3(EMSSceneSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY3__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSSceneSection::EMSScenePatientCountEntry))->asSequence()->first().oclAsType(emspcr::EMSSceneSection::EMSScenePatientCountEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry3(EMSSceneSection) <em>Get Entry3</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry3(EMSSceneSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry3(EMSSceneSection emsSceneSection)
  {
    if (GET_ENTRY3__EOCL_QRY == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(EmspcrPackage.Literals.EMS_SCENE_SECTION, EmspcrPackage.Literals.EMS_SCENE_SECTION.getEAllOperations().get(62));
      try
      {
