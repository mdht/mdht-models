...
public class CardiacArrestEventSectionOperations extends SectionOperations {
	...
	public static  boolean validateCardiacArrestEventSectionTemplateId(CardiacArrestEventSection cardiacArrestEventSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EVENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestEventSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '67799-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateCardiacArrestEventSectionCode(CardiacArrestEventSection cardiacArrestEventSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EVENT_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestEventSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCardiacArrestEventSectionTitle(CardiacArrestEventSection cardiacArrestEventSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EVENT_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestEventSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCardiacArrestEventSectionText(CardiacArrestEventSection cardiacArrestEventSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EVENT_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestEventSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCardiacArrestEventSectionCardiacArrestExistence(CardiacArrestEventSection cardiacArrestEventSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EVENT_SECTION_CARDIAC_ARREST_EXISTENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestEventSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  CardiacArrestExistence getCardiacArrestExistence(CardiacArrestEventSection cardiacArrestEventSection) {
		if (GET_CARDIAC_ARREST_EXISTENCE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.CARDIAC_ARREST_EVENT_SECTION, EmspcrPackage.Literals.CARDIAC_ARREST_EVENT_SECTION.getEAllOperations().get(60));
			try {
