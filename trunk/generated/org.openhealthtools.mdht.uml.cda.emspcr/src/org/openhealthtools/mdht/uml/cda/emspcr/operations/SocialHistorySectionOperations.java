...
"value.code = '67843-3' and value.codeSystem = '2.16.840.1.113883.6.1'";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SocialHistorySectionCode"),
						 new Object [] { socialHistorySection }));
			}
	...
	public static  boolean validateSocialHistorySectionCodeP(SocialHistorySection socialHistorySection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SocialHistorySectionCodeP"),
						 new Object [] { socialHistorySection }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SocialHistorySectionTitle"),
						 new Object [] { socialHistorySection }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SocialHistorySectionText"),
						 new Object [] { socialHistorySection }));
			}
	...
	public static  boolean validateSocialHistorySectionExistenceOfDrugUseIndication(SocialHistorySection socialHistorySection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SOCIAL_HISTORY_SECTION_EXISTENCE_OF_DRUG_USE_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(socialHistorySection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateSocialHistorySectionDrugUseIndication(SocialHistorySection socialHistorySection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SOCIAL_HISTORY_SECTION_DRUG_USE_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(socialHistorySection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  ExistenceOfDrugUseIndication getExistenceOfDrugUseIndication(SocialHistorySection socialHistorySection) {
		if (GET_EXISTENCE_OF_DRUG_USE_INDICATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SOCIAL_HISTORY_SECTION, EmspcrPackage.Literals.SOCIAL_HISTORY_SECTION.getEAllOperations().get(62));
			try {
	...
	public static  DrugUseIndication getDrugUseIndication(SocialHistorySection socialHistorySection) {
		if (GET_DRUG_USE_INDICATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SOCIAL_HISTORY_SECTION, EmspcrPackage.Literals.SOCIAL_HISTORY_SECTION.getEAllOperations().get(63));
			try {
