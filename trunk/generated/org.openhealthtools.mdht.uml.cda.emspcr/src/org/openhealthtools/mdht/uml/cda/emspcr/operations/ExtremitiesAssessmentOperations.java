...
public class ExtremitiesAssessmentOperations extends ClinicalStatementOperations {
	...
	public static boolean validateExtremitiesAssessmentTemplateId(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateExtremitiesAssessmentCodeP(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExtremitiesAssessmentCode(ExtremitiesAssessment extremitiesAssessment,
		...
		Object passToken = (context == null)
				? null
				: context.get("org.openhealthtools.mdht.uml.cda.emspcr.ExtremitiesAssessmentCodeP");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExtremitiesAssessmentTargetSiteCode(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExtremitiesAssessmentTargetSiteCodeP(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	...
	public static boolean validateExtremitiesAssessmentValue(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExtremitiesAssessmentEffectiveTime(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExtremitiesAssessmentMoodCode(ExtremitiesAssessment extremitiesAssessment,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
