 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='EMSDispositionSectionTemplateId EMSDispositionSectionCode EMSDispositionSectionCodeP EMSDispositionSectionTitle EMSDispositionSectionText' templateId.root='2.16.840.1.113883.17.3.10.1.4' code.code='67796-3' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='EMS Disposition Section' title.mixed='EMS Disposition' constraints.validation.info='EMSDispositionSectionEntry1 EMSDispositionSectionEntry2 EMSDispositionSectionEntry3 EMSDispositionSectionEntry5 EMSDispositionSectionEntry7 EMSDispositionSectionEntry6 EMSDispositionSectionEntry4'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/emspcrEMSDispositionSectionTransportModeEntryEMSTransportModeObservation code.code='67550-4' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='EMS transport mode' constraints.validation.error='EMSTransportModeObservationCode EMSTransportModeObservationCodeP EMSTransportModeObservationValue EMSTransportModeObservationMoodCode' constraints.validation.dependOn.EMSTransportModeObservationCode='EMSTransportModeObservationCodeP' moodCode='EVN'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/emspcrEMSDispositionSectionDestinationChoiceReasonEntryEMSReasonForChoosingDestinationObservation code.code='67552-0' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='EMS reason for choosing destination' constraints.validation.error='EMSReasonForChoosingDestinationObservationCode EMSReasonForChoosingDestinationObservationCodeP EMSReasonForChoosingDestinationObservationValue EMSReasonForChoosingDestinationObservationValueP EMSReasonForChoosingDestinationObservationMoodCode' constraints.validation.dependOn.EMSReasonForChoosingDestinationObservationCode='EMSReasonForChoosingDestinationObservationCodeP' value.codeSystem='2.16.840.1.113883.6.1' value.codeSystemName='LOINC' moodCode='EVN'"
