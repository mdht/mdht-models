...
public class DerivedEntryOperations extends EntryOperations
{
  ...
  public static  boolean validateDerivedEntryTemplateId(DerivedEntry derivedEntry, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_DERIVED_ENTRY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(derivedEntry))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("DerivedEntryTemplateId"),
             new Object [] { derivedEntry }));
      }
  ...
  public static  boolean validateDerivedEntryTypeCode(DerivedEntry derivedEntry, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("DerivedEntryTypeCode"),
             new Object [] { derivedEntry }));
      }
