...
public class NumberOfPatientsObservationOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateNumberOfPatientsObservationTemplateId(NumberOfPatientsObservation numberOfPatientsObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBER_OF_PATIENTS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberOfPatientsObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateNumberOfPatientsObservationCodeP(NumberOfPatientsObservation numberOfPatientsObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBER_OF_PATIENTS_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberOfPatientsObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '67547-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateNumberOfPatientsObservationCode(NumberOfPatientsObservation numberOfPatientsObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.NumberOfPatientsObservationCodeP");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBER_OF_PATIENTS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberOfPatientsObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateNumberOfPatientsObservationValue(NumberOfPatientsObservation numberOfPatientsObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBER_OF_PATIENTS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberOfPatientsObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateNumberOfPatientsObservationMoodCode(NumberOfPatientsObservation numberOfPatientsObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBER_OF_PATIENTS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberOfPatientsObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
