				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ComplaintOrganSystemCodeP"),
						 new Object [] { complaintOrganSystem }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ComplaintOrganSystemCode"),
						 new Object [] { complaintOrganSystem }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ComplaintOrganSystemValue"),
						 new Object [] { complaintOrganSystem }));
			}
