...
public class SystolicBloodPressureOperations extends VitalSignObservationOperations {
	...
	public static boolean validateSystolicBloodPressureEffectiveTime(SystolicBloodPressure systolicBloodPressure,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SYSTOLIC_BLOOD_PRESSURE_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			systolicBloodPressure)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						...
						new Object[] {
								...
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									systolicBloodPressure, context) }), new Object[] { systolicBloodPressure }));
			}
