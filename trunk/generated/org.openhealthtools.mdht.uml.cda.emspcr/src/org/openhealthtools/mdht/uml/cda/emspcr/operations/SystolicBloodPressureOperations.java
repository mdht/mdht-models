 ...
 * @generated
 */
public class SystolicBloodPressureOperations extends VitalSignObservationOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SystolicBloodPressureEffectiveTime"),
						 new Object [] { systolicBloodPressure }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignObservationTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(systolicBloodPressure, context) }),
						 new Object [] { systolicBloodPressure }));
			}
