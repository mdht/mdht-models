...
public class EMSInjuryIncidentDescriptionSectionOperations extends SectionOperations {
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry3(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry4(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry5(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY5__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry6(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY6__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry7(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY7__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry8(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY8__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry9(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY9__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry10(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY10__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry11(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY11__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	*/
	...
	public static boolean validateEMSInjuryIncidentDescriptionSectionEntry12(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EMS_INJURY_INCIDENT_DESCRIPTION_SECTION_ENTRY12__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsInjuryIncidentDescriptionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
