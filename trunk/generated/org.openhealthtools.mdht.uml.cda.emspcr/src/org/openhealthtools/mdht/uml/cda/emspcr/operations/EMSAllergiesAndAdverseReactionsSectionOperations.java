...
"value.code = '48765-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateEMSAllergiesAndAdverseReactionsSectionObservation(EMSAllergiesAndAdverseReactionsSection emsAllergiesAndAdverseReactionsSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsAllergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateEMSAllergiesAndAdverseReactionsSectionDrugAllergyProblemAct(EMSAllergiesAndAdverseReactionsSection emsAllergiesAndAdverseReactionsSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_DRUG_ALLERGY_PROBLEM_ACT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsAllergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  ExistenceOfDrugAllergyObservation getObservation(EMSAllergiesAndAdverseReactionsSection emsAllergiesAndAdverseReactionsSection) {
	...
	public static  DrugAllergy getDrugAllergyProblemAct(EMSAllergiesAndAdverseReactionsSection emsAllergiesAndAdverseReactionsSection) {
	...
	public static  NonDrugAllergyOrganizer getEnvironmentalAllergies(EMSAllergiesAndAdverseReactionsSection emsAllergiesAndAdverseReactionsSection) {
		if (GET_ENVIRONMENTAL_ALLERGIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION, EmspcrPackage.Literals.EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION.getEAllOperations().get(64));
			try {
