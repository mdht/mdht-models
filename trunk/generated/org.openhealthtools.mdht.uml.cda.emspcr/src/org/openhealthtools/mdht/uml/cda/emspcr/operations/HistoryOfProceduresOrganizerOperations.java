...
public class HistoryOfProceduresOrganizerOperations extends OrganizerOperations {
	...
	public static boolean validateHistoryOfProceduresOrganizerExistenceOfHistoryOfProcedureComponent(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_HISTORY_OF_PROCEDURES_ORGANIZER_EXISTENCE_OF_HISTORY_OF_PROCEDURE_COMPONENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateHistoryOfProceduresOrganizerHistoryOfProceduresComponent(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_HISTORY_OF_PROCEDURES_ORGANIZER_HISTORY_OF_PROCEDURES_COMPONENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			historyOfProceduresOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	public static boolean validateHistoryOfProceduresOrganizerTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_HISTORY_OF_PROCEDURES_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			historyOfProceduresOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
