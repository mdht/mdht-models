 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSMedicationsAdministeredSection#getEntry1() <em>Get Entry1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67849-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_MEDICATIONS_ADMINISTERED_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSMedicationsAdministeredSection::MedicationAdministeredEntry))";
   ...
   */
	...
	public static boolean validateEMSMedicationsAdministeredSectionEntry1(
			EMSMedicationsAdministeredSection emsMedicationsAdministeredSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry1(EMSMedicationsAdministeredSection) <em>Get Entry1</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSMedicationsAdministeredSection)
   * @generated
   * @ordered
   */
  ...
  /**
   * The cached OCL query for the '{@link #getEntry1(EMSMedicationsAdministeredSection) <em>Get Entry1</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSMedicationsAdministeredSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry1(EMSMedicationsAdministeredSection emsMedicationsAdministeredSection)
  {
    ...
    return (void) query.evaluate(emsMedicationsAdministeredSection);
  }
