...
public class PhysicalAssessmentSectionOperations extends PhysicalExamSectionOperations {
	...
	public static  boolean validatePhysicalAssessmentSectionCodeP(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '29545-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validatePhysicalAssessmentSectionCode(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.PhysicalAssessmentSectionCodeP");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionTitle(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionText(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionPhysicalAssessmentOrganizer(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_PHYSICAL_ASSESSMENT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionPatientPregnancy(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_PATIENT_PREGNANCY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionLastOralIntake(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_LAST_ORAL_INTAKE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionPatientAge(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_PATIENT_AGE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionThrombolyticContraindications(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_THROMBOLYTIC_CONTRAINDICATIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validatePhysicalAssessmentSectionBarriersToPatientCare(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_ASSESSMENT_SECTION_BARRIERS_TO_PATIENT_CARE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  PhysicalAssessmentOrganizer getPhysicalAssessmentOrganizer(PhysicalAssessmentSection physicalAssessmentSection) {
		if (GET_PHYSICAL_ASSESSMENT_ORGANIZER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION, EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION.getEAllOperations().get(76));
			try {
	...
	public static  PatientPregnancy getPatientPregnancy(PhysicalAssessmentSection physicalAssessmentSection) {
		if (GET_PATIENT_PREGNANCY__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION, EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION.getEAllOperations().get(77));
			try {
	...
	public static  LastOralIntake getLastOralIntake(PhysicalAssessmentSection physicalAssessmentSection) {
		if (GET_LAST_ORAL_INTAKE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION, EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION.getEAllOperations().get(78));
			try {
	...
	public static  PatientAge getPatientAge(PhysicalAssessmentSection physicalAssessmentSection) {
		if (GET_PATIENT_AGE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION, EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION.getEAllOperations().get(79));
			try {
	...
	public static  ThrombolyticContraindications getThrombolyticContraindications(PhysicalAssessmentSection physicalAssessmentSection) {
		if (GET_THROMBOLYTIC_CONTRAINDICATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION, EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION.getEAllOperations().get(80));
			try {
	...
	public static  BarriersToPatientCare getBarriersToPatientCare(PhysicalAssessmentSection physicalAssessmentSection) {
		if (GET_BARRIERS_TO_PATIENT_CARE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION, EmspcrPackage.Literals.PHYSICAL_ASSESSMENT_SECTION.getEAllOperations().get(81));
			try {
	...
	public static  boolean validatePhysicalExamSectionTemplateId(PhysicalAssessmentSection physicalAssessmentSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PHYSICAL_EXAM_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(physicalAssessmentSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PhysicalExamSectionTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(physicalAssessmentSection, context) }),
						 new Object [] { physicalAssessmentSection }));
			}
