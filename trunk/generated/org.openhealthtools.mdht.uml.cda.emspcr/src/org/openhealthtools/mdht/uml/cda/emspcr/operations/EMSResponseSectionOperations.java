 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSResponseSection#getEntry1() <em>Get Entry1</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSResponseSection#getEntry2() <em>Get Entry2</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSResponseSection#getEntry3() <em>Get Entry3</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSResponseSection#getEntry4() <em>Get Entry4</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67664-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionCode"),
             new Object [] { emsResponseSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionCodeP"),
             new Object [] { emsResponseSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionText"),
             new Object [] { emsResponseSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionTitle"),
             new Object [] { emsResponseSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_RESPONSE_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSDelayEntry))";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_RESPONSE_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsResponseSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionEntry1"),
             new Object [] { emsResponseSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_RESPONSE_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSDispatchLocationEntry))";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_RESPONSE_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsResponseSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionEntry2"),
             new Object [] { emsResponseSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_RESPONSE_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSOdometerReadingEntry))";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_RESPONSE_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsResponseSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionEntry3"),
             new Object [] { emsResponseSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_RESPONSE_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSResponseModeEntry))";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_RESPONSE_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsResponseSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSResponseSectionEntry4"),
             new Object [] { emsResponseSection }));
      }
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry1(EMSResponseSection) <em>Get Entry1</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSResponseSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY1__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSDelayEntry))->asSequence()->first().oclAsType(emspcr::EMSResponseSection::EMSDelayEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry1(EMSResponseSection) <em>Get Entry1</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSResponseSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry1(EMSResponseSection emsResponseSection)
  {
    if (GET_ENTRY1__EOCL_QRY == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(EmspcrPackage.Literals.EMS_RESPONSE_SECTION, EmspcrPackage.Literals.EMS_RESPONSE_SECTION.getEAllOperations().get(64));
      try
      {
    ...
    return (void) query.evaluate(emsResponseSection);
  }

  /**
   * The cached OCL expression body for the '{@link #getEntry2(EMSResponseSection) <em>Get Entry2</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry2(EMSResponseSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY2__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSDispatchLocationEntry))->asSequence()->first().oclAsType(emspcr::EMSResponseSection::EMSDispatchLocationEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry2(EMSResponseSection) <em>Get Entry2</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry2(EMSResponseSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry2(EMSResponseSection emsResponseSection)
  {
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry3(EMSResponseSection) <em>Get Entry3</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry3(EMSResponseSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY3__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSOdometerReadingEntry))->asSequence()->first().oclAsType(emspcr::EMSResponseSection::EMSOdometerReadingEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry3(EMSResponseSection) <em>Get Entry3</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry3(EMSResponseSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry3(EMSResponseSection emsResponseSection)
  {
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry4(EMSResponseSection) <em>Get Entry4</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry4(EMSResponseSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY4__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSResponseSection::EMSResponseModeEntry))->asSequence()->first().oclAsType(emspcr::EMSResponseSection::EMSResponseModeEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry4(EMSResponseSection) <em>Get Entry4</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry4(EMSResponseSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry4(EMSResponseSection emsResponseSection)
  {
