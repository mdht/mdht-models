 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSProceduresPerformedSection#validateProcedureDescriptionSectionTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Description Section Template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EMSProceduresPerformedSectionOperations extends ProcedureDescriptionSectionOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public static  boolean validateEMSProceduresPerformedSectionCodeP(EMSProceduresPerformedSection emsProceduresPerformedSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_PROCEDURES_PERFORMED_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsProceduresPerformedSection)) {
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.emspcr.EMSProceduresPerformedSectionCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.emspcr.EMSProceduresPerformedSectionCodeP", passToken);
				}
				passToken.add(emsProceduresPerformedSection);
			}
...
"value.code = '29554-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateEMSProceduresPerformedSectionCode(EMSProceduresPerformedSection emsProceduresPerformedSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.EMSProceduresPerformedSectionCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(emsProceduresPerformedSection)) {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_PROCEDURES_PERFORMED_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.title.oclIsUndefined() or self.title.isNullFlavorUndefined()) implies (self.title.getText() = 'EMS Procedures Performed')";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_PROCEDURES_PERFORMED_SECTION_PROCEDURE_ACTIVITY_PROCEDURE1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->exists(entry : cda::Entry | not entry.procedure.oclIsUndefined() and entry.procedure.oclIsKindOf(emspcr::Procedure))";
	...
	public static  EList<Procedure> getProcedureActivityProcedure1s(EMSProceduresPerformedSection emsProceduresPerformedSection) {
		if (GET_PROCEDURE_ACTIVITY_PROCEDURE1S__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.EMS_PROCEDURES_PERFORMED_SECTION, EmspcrPackage.Literals.EMS_PROCEDURES_PERFORMED_SECTION.getEAllOperations().get(65));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProcedureDescriptionSectionTemplateId(EMSProceduresPerformedSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Description Section Template Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProcedureDescriptionSectionTemplateId(EMSProceduresPerformedSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateProcedureDescriptionSectionTemplateId(EMSProceduresPerformedSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Procedure Description Section Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProcedureDescriptionSectionTemplateId(EMSProceduresPerformedSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateProcedureDescriptionSectionTemplateId(EMSProceduresPerformedSection emsProceduresPerformedSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_DESCRIPTION_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsProceduresPerformedSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.EMS_PROCEDURES_PERFORMED_SECTION__PROCEDURE_DESCRIPTION_SECTION_TEMPLATE_ID,
						 EmspcrPlugin.INSTANCE.getString("ProcedureDescriptionSectionTemplateId"),
						 new Object [] { emsProceduresPerformedSection }));
			}
