...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Patient Condition Change At Destination Observation</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.emspcr.EmspcrPackage#getPatientConditionChangeAtDestinationObservation()
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='PatientConditionChangeAtDestinationObservationTemplateId PatientConditionChangeAtDestinationObservationCode PatientConditionChangeAtDestinationObservationCodeP PatientConditionChangeAtDestinationObservationValue PatientConditionChangeAtDestinationObservationValueP PatientConditionChangeAtDestinationObservationMoodCode' templateId.root='2.16.840.1.1133883.17.3.10.1.37' code.code='67551-2' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='EMS patient condition change at destination' constraints.validation.dependOn.PatientConditionChangeAtDestinationObservationCode='PatientConditionChangeAtDestinationObservationCodeP' value.codeSystem='2.16.840.1.113883.6.1' value.codeSystemName='LOINC' moodCode='EVN'"
 * @generated
 */
public interface PatientConditionChangeAtDestinationObservation extends Observation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
