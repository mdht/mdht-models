 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/emspcrEMSCurrentMedicationSectionOnAnticoagulantsEntryPatientOnAnticoagulants code.code='69749-0' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Patient on anticoagulants' constraints.validation.error='PatientOnAnticoagulantsCode PatientOnAnticoagulantsValue PatientOnAnticoagulantsMoodCode' moodCode='EVN'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/emspcrEMSCurrentMedicationSectionCurrentMedicationEntryEMSCurrentMedication constraints.validation.warning='EMSCurrentMedicationDoseQuantity EMSCurrentMedicationRouteCodeP' routeCode.codeSystem='2.16.840.1.113883.3.26.1.1.1' routeCode.codeSystemName='FDA Route of Administration' constraints.validation.error='EMSCurrentMedicationRouteCode EMSCurrentMedicationEMSCurrentMedicationConsumable' constraints.validation.dependOn.EMSCurrentMedicationRouteCode='EMSCurrentMedicationRouteCodeP' constraints.validation.info='EMSCurrentMedicationNegationInd EMSCurrentMedicationNullFlavor'"
