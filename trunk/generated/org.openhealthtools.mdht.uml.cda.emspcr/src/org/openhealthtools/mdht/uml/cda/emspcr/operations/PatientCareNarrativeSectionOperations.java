...
public class PatientCareNarrativeSectionOperations extends SectionOperations {
	...
	public static boolean validatePatientCareNarrativeSectionTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_NARRATIVE_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validatePatientCareNarrativeSectionCode(
			PatientCareNarrativeSection patientCareNarrativeSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_NARRATIVE_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareNarrativeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePatientCareNarrativeSectionCodeP(
			PatientCareNarrativeSection patientCareNarrativeSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_NARRATIVE_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareNarrativeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePatientCareNarrativeSectionTitle(
			PatientCareNarrativeSection patientCareNarrativeSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_NARRATIVE_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareNarrativeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validatePatientCareNarrativeSectionText(
			PatientCareNarrativeSection patientCareNarrativeSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_NARRATIVE_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareNarrativeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
