...
public class EMSAllergiesAndAdverseReactionsSectionImpl extends SectionImpl implements
	...
	public ExistenceOfDrugAllergyObservation getObservation() {
		return EMSAllergiesAndAdverseReactionsSectionOperations.getObservation(this);
	}
	 ...
	 * @generated
	 */
	public DrugAllergy getDrugAllergyProblemAct() {
		return EMSAllergiesAndAdverseReactionsSectionOperations.getDrugAllergyProblemAct(this);
	}
