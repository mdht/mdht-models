	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmspcrPackage.BILLING_SECTION: {
				...
				if (result == null) result = caseSection(billingSection);
				if (result == null) result = caseAct(billingSection);
				if (result == null) result = caseInfrastructureRoot(billingSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.CURRENT_MEDICATION_SECTION: {
				...
				if (result == null) result = caseMedicationsSection(currentMedicationSection);
				if (result == null) result = caseMedicationsSectionEntriesOptional(currentMedicationSection);
				if (result == null) result = caseSection(currentMedicationSection);
				if (result == null) result = caseAct(currentMedicationSection);
				if (result == null) result = caseInfrastructureRoot(currentMedicationSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.CARDIAC_ARREST_EVENT_SECTION: {
				...
				if (result == null) result = caseSection(cardiacArrestEventSection);
				if (result == null) result = caseAct(cardiacArrestEventSection);
				if (result == null) result = caseInfrastructureRoot(cardiacArrestEventSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.CARDIAC_ARREST_EXISTENCE: {
				...
				if (result == null) result = caseObservation(cardiacArrestExistence);
				if (result == null) result = caseClinicalStatement(cardiacArrestExistence);
				if (result == null) result = caseAct(cardiacArrestExistence);
				if (result == null) result = caseInfrastructureRoot(cardiacArrestExistence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.ADVANCED_DIRECTIVE_OBSERVATION: {
				...
				if (result == null) result = caseObservation(advancedDirectiveObservation);
				if (result == null) result = caseClinicalStatement(advancedDirectiveObservation);
				if (result == null) result = caseAct(advancedDirectiveObservation);
				if (result == null) result = caseInfrastructureRoot(advancedDirectiveObservation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION: {
				...
				if (result == null) result = caseSection(allergiesAndAdverseReactionsSection);
				if (result == null) result = caseAct(allergiesAndAdverseReactionsSection);
				if (result == null) result = caseInfrastructureRoot(allergiesAndAdverseReactionsSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.DRUG_ALLERGY_PROBLEM_ACT: {
				...
				if (result == null) result = caseAllergyProblemAct(drugAllergyProblemAct);
				if (result == null) result = caseCDA_Act(drugAllergyProblemAct);
				if (result == null) result = caseClinicalStatement(drugAllergyProblemAct);
				if (result == null) result = caseAct(drugAllergyProblemAct);
				if (result == null) result = caseInfrastructureRoot(drugAllergyProblemAct);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.ENVIRONMENTAL_ALLERGIES: {
				...
				if (result == null) result = caseOrganizer(environmentalAllergies);
				if (result == null) result = caseClinicalStatement(environmentalAllergies);
				if (result == null) result = caseAct(environmentalAllergies);
				if (result == null) result = caseInfrastructureRoot(environmentalAllergies);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.EXISTENCE_OF_ENVIRONMENTAL_ALLERGY: {
				...
				if (result == null) result = caseObservation(existenceOfEnvironmentalAllergy);
				if (result == null) result = caseClinicalStatement(existenceOfEnvironmentalAllergy);
				if (result == null) result = caseAct(existenceOfEnvironmentalAllergy);
				if (result == null) result = caseInfrastructureRoot(existenceOfEnvironmentalAllergy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.ENVIRONMENTAL_ALLERGY: {
				...
				if (result == null) result = caseObservation(environmentalAllergy);
				if (result == null) result = caseClinicalStatement(environmentalAllergy);
				if (result == null) result = caseAct(environmentalAllergy);
				if (result == null) result = caseInfrastructureRoot(environmentalAllergy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.HISTORY_OF_PROCEDURES_ORGANIZER: {
				...
				if (result == null) result = caseOrganizer(historyOfProceduresOrganizer);
				if (result == null) result = caseClinicalStatement(historyOfProceduresOrganizer);
				if (result == null) result = caseAct(historyOfProceduresOrganizer);
				if (result == null) result = caseInfrastructureRoot(historyOfProceduresOrganizer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.PHYSICAL_ASSESSMENT_SECTION: {
				...
				if (result == null) result = casePhysicalExamSection(physicalAssessmentSection);
				if (result == null) result = caseSection(physicalAssessmentSection);
				if (result == null) result = caseAct(physicalAssessmentSection);
				if (result == null) result = caseInfrastructureRoot(physicalAssessmentSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.PROCEDURES_PERFORMED_SECTION: {
				...
				if (result == null) result = caseProcedureDescriptionSection(proceduresPerformedSection);
				if (result == null) result = caseSection(proceduresPerformedSection);
				if (result == null) result = caseAct(proceduresPerformedSection);
				if (result == null) result = caseInfrastructureRoot(proceduresPerformedSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.PATIENT_CARE_NARRATIVE_SECTION: {
				...
				if (result == null) result = caseSection(patientCareNarrativeSection);
				if (result == null) result = caseAct(patientCareNarrativeSection);
				if (result == null) result = caseInfrastructureRoot(patientCareNarrativeSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.SCENE_SECTION: {
				...
				if (result == null) result = caseSection(sceneSection);
				if (result == null) result = caseAct(sceneSection);
				if (result == null) result = caseInfrastructureRoot(sceneSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.DISPATCH_SECTION: {
				...
				if (result == null) result = caseSection(dispatchSection);
				if (result == null) result = caseAct(dispatchSection);
				if (result == null) result = caseInfrastructureRoot(dispatchSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.DISPOSITION_SECTION: {
				...
				if (result == null) result = caseSection(dispositionSection);
				if (result == null) result = caseAct(dispositionSection);
				if (result == null) result = caseInfrastructureRoot(dispositionSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.NUMBER_OF_PATIENTS_OBSERVATION: {
				...
				if (result == null) result = caseObservation(numberOfPatientsObservation);
				if (result == null) result = caseClinicalStatement(numberOfPatientsObservation);
				if (result == null) result = caseAct(numberOfPatientsObservation);
				if (result == null) result = caseInfrastructureRoot(numberOfPatientsObservation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.PERSONNEL_ADVERSE_EVENT_SECTION: {
				...
				if (result == null) result = caseSection(personnelAdverseEventSection);
				if (result == null) result = caseAct(personnelAdverseEventSection);
				if (result == null) result = caseInfrastructureRoot(personnelAdverseEventSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.PROTOCOL_SECTION: {
				...
				if (result == null) result = caseSection(protocolSection);
				if (result == null) result = caseAct(protocolSection);
				if (result == null) result = caseInfrastructureRoot(protocolSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.RESPONSE_SECTION: {
				...
				if (result == null) result = caseSection(responseSection);
				if (result == null) result = caseAct(responseSection);
				if (result == null) result = caseInfrastructureRoot(responseSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.SITUATION_SECTION: {
				...
				if (result == null) result = caseSection(situationSection);
				if (result == null) result = caseAct(situationSection);
				if (result == null) result = caseInfrastructureRoot(situationSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.UNIT_AT_PATIENTT_TIME: {
				...
				if (result == null) result = caseObservation(unitAtPatienttTime);
				if (result == null) result = caseClinicalStatement(unitAtPatienttTime);
				if (result == null) result = caseAct(unitAtPatienttTime);
				if (result == null) result = caseInfrastructureRoot(unitAtPatienttTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.VITAL_SIGNS_SECTION: {
				...
				if (result == null) result = caseConsol_VitalSignsSection(vitalSignsSection);
			...
			case EmspcrPackage.INJURY_INCIDENT_DESCRIPTION_SECTION: {
				...
				if (result == null) result = caseSection(injuryIncidentDescriptionSection);
				if (result == null) result = caseAct(injuryIncidentDescriptionSection);
				if (result == null) result = caseInfrastructureRoot(injuryIncidentDescriptionSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.EXISTENCE_OF_HISTORY_OF_PROCEDURES: {
				...
				if (result == null) result = caseObservation(existenceOfHistoryOfProcedures);
				if (result == null) result = caseClinicalStatement(existenceOfHistoryOfProcedures);
				if (result == null) result = caseAct(existenceOfHistoryOfProcedures);
				if (result == null) result = caseInfrastructureRoot(existenceOfHistoryOfProcedures);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
