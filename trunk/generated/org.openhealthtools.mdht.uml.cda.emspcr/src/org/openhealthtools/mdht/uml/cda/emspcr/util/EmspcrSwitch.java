...
public class EmspcrSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmspcrPackage.BILLING_SECTION: {
				BillingSection billingSection = (BillingSection) theEObject;
				T result = caseBillingSection(billingSection);
				if (result == null) {
					result = caseSection(billingSection);
				}
				if (result == null) {
					result = caseAct(billingSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(billingSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.BILLING_CONDITION: {
				...
				if (result == null) {
					result = caseObservation(billingCondition);
				}
				if (result == null) {
					result = caseClinicalStatement(billingCondition);
				}
				if (result == null) {
					result = caseAct(billingCondition);
				}
				if (result == null) {
					result = caseInfrastructureRoot(billingCondition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.LEVEL_OF_SERVICE_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(levelOfServiceObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(levelOfServiceObservation);
				}
				if (result == null) {
					result = caseAct(levelOfServiceObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(levelOfServiceObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CURRENT_MEDICATION_SECTION: {
				CurrentMedicationSection currentMedicationSection = (CurrentMedicationSection) theEObject;
				T result = caseCurrentMedicationSection(currentMedicationSection);
				if (result == null) {
					result = caseMedicationsSection(currentMedicationSection);
				}
				if (result == null) {
					result = caseMedicationsSectionEntriesOptional(currentMedicationSection);
				}
				if (result == null) {
					result = caseSection(currentMedicationSection);
				}
				if (result == null) {
					result = caseAct(currentMedicationSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(currentMedicationSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CURRENTLY_ON_MEDICATION: {
				...
				if (result == null) {
					result = caseObservation(currentlyOnMedication);
				}
				if (result == null) {
					result = caseClinicalStatement(currentlyOnMedication);
				}
				if (result == null) {
					result = caseAct(currentlyOnMedication);
				}
				if (result == null) {
					result = caseInfrastructureRoot(currentlyOnMedication);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_ON_ANTICOAGULANTS: {
				...
				if (result == null) {
					result = caseObservation(patientOnAnticoagulants);
				}
				if (result == null) {
					result = caseClinicalStatement(patientOnAnticoagulants);
				}
				if (result == null) {
					result = caseAct(patientOnAnticoagulants);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientOnAnticoagulants);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CURRENT_MEDICATION: {
				...
				if (result == null) {
					result = caseMedicationActivity(currentMedication);
				}
				if (result == null) {
					result = caseSubstanceAdministration(currentMedication);
				}
				if (result == null) {
					result = caseClinicalStatement(currentMedication);
				}
				if (result == null) {
					result = caseAct(currentMedication);
				}
				if (result == null) {
					result = caseInfrastructureRoot(currentMedication);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARDIAC_ARREST_EVENT_SECTION: {
				CardiacArrestEventSection cardiacArrestEventSection = (CardiacArrestEventSection) theEObject;
				T result = caseCardiacArrestEventSection(cardiacArrestEventSection);
				if (result == null) {
					result = caseSection(cardiacArrestEventSection);
				}
				if (result == null) {
					result = caseAct(cardiacArrestEventSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacArrestEventSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARDIAC_ARREST_EXISTENCE: {
				CardiacArrestExistence cardiacArrestExistence = (CardiacArrestExistence) theEObject;
				T result = caseCardiacArrestExistence(cardiacArrestExistence);
				if (result == null) {
					result = caseObservation(cardiacArrestExistence);
				}
				if (result == null) {
					result = caseClinicalStatement(cardiacArrestExistence);
				}
				if (result == null) {
					result = caseAct(cardiacArrestExistence);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacArrestExistence);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ADVANCED_DIRECTIVE_OBSERVATION: {
				AdvancedDirectiveObservation advancedDirectiveObservation = (AdvancedDirectiveObservation) theEObject;
				T result = caseAdvancedDirectiveObservation(advancedDirectiveObservation);
				if (result == null) {
					result = caseObservation(advancedDirectiveObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(advancedDirectiveObservation);
				}
				if (result == null) {
					result = caseAct(advancedDirectiveObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(advancedDirectiveObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION: {
				AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection = (AllergiesAndAdverseReactionsSection) theEObject;
				T result = caseAllergiesAndAdverseReactionsSection(allergiesAndAdverseReactionsSection);
				if (result == null) {
					result = caseSection(allergiesAndAdverseReactionsSection);
				}
				if (result == null) {
					result = caseAct(allergiesAndAdverseReactionsSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(allergiesAndAdverseReactionsSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXISTENCE_OF_DRUG_ALLERGY_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(existenceOfDrugAllergyObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(existenceOfDrugAllergyObservation);
				}
				if (result == null) {
					result = caseAct(existenceOfDrugAllergyObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(existenceOfDrugAllergyObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DRUG_ALLERGY_PROBLEM_ACT: {
				DrugAllergyProblemAct drugAllergyProblemAct = (DrugAllergyProblemAct) theEObject;
				T result = caseDrugAllergyProblemAct(drugAllergyProblemAct);
				if (result == null) {
					result = caseAllergyProblemAct(drugAllergyProblemAct);
				}
				if (result == null) {
					result = caseCDA_Act(drugAllergyProblemAct);
				}
				if (result == null) {
					result = caseClinicalStatement(drugAllergyProblemAct);
				}
				if (result == null) {
					result = caseAct(drugAllergyProblemAct);
				}
				if (result == null) {
					result = caseInfrastructureRoot(drugAllergyProblemAct);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ENVIRONMENTAL_ALLERGIES: {
				EnvironmentalAllergies environmentalAllergies = (EnvironmentalAllergies) theEObject;
				T result = caseEnvironmentalAllergies(environmentalAllergies);
				if (result == null) {
					result = caseOrganizer(environmentalAllergies);
				}
				if (result == null) {
					result = caseClinicalStatement(environmentalAllergies);
				}
				if (result == null) {
					result = caseAct(environmentalAllergies);
				}
				if (result == null) {
					result = caseInfrastructureRoot(environmentalAllergies);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXISTENCE_OF_ENVIRONMENTAL_ALLERGY: {
				ExistenceOfEnvironmentalAllergy existenceOfEnvironmentalAllergy = (ExistenceOfEnvironmentalAllergy) theEObject;
				T result = caseExistenceOfEnvironmentalAllergy(existenceOfEnvironmentalAllergy);
				if (result == null) {
					result = caseObservation(existenceOfEnvironmentalAllergy);
				}
				if (result == null) {
					result = caseClinicalStatement(existenceOfEnvironmentalAllergy);
				}
				if (result == null) {
					result = caseAct(existenceOfEnvironmentalAllergy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(existenceOfEnvironmentalAllergy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ENVIRONMENTAL_ALLERGY: {
				EnvironmentalAllergy environmentalAllergy = (EnvironmentalAllergy) theEObject;
				T result = caseEnvironmentalAllergy(environmentalAllergy);
				if (result == null) {
					result = caseObservation(environmentalAllergy);
				}
				if (result == null) {
					result = caseClinicalStatement(environmentalAllergy);
				}
				if (result == null) {
					result = caseAct(environmentalAllergy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(environmentalAllergy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXISTENCE_OF_HISTORY_OF_CONDITION: {
				...
				if (result == null) {
					result = caseObservation(existenceOfHistoryOfCondition);
				}
				if (result == null) {
					result = caseClinicalStatement(existenceOfHistoryOfCondition);
				}
				if (result == null) {
					result = caseAct(existenceOfHistoryOfCondition);
				}
				if (result == null) {
					result = caseInfrastructureRoot(existenceOfHistoryOfCondition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.HISTORY_OF_CONDITION: {
				...
				if (result == null) {
					result = caseObservation(historyOfCondition);
				}
				if (result == null) {
					result = caseClinicalStatement(historyOfCondition);
				}
				if (result == null) {
					result = caseAct(historyOfCondition);
				}
				if (result == null) {
					result = caseInfrastructureRoot(historyOfCondition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXISTENCE_OF_DRUG_USE_INDICATION: {
				...
				if (result == null) {
					result = caseObservation(existenceOfDrugUseIndication);
				}
				if (result == null) {
					result = caseClinicalStatement(existenceOfDrugUseIndication);
				}
				if (result == null) {
					result = caseAct(existenceOfDrugUseIndication);
				}
				if (result == null) {
					result = caseInfrastructureRoot(existenceOfDrugUseIndication);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DRUG_USE_INDICATION: {
				...
				if (result == null) {
					result = caseObservation(drugUseIndication);
				}
				if (result == null) {
					result = caseClinicalStatement(drugUseIndication);
				}
				if (result == null) {
					result = caseAct(drugUseIndication);
				}
				if (result == null) {
					result = caseInfrastructureRoot(drugUseIndication);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PHYSICAL_ASSESSMENT_SECTION: {
				PhysicalAssessmentSection physicalAssessmentSection = (PhysicalAssessmentSection) theEObject;
				T result = casePhysicalAssessmentSection(physicalAssessmentSection);
				if (result == null) {
					result = casePhysicalExamSection(physicalAssessmentSection);
				}
				if (result == null) {
					result = caseSection(physicalAssessmentSection);
				}
				if (result == null) {
					result = caseAct(physicalAssessmentSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(physicalAssessmentSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PHYSICAL_ASSESSMENT_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(physicalAssessmentOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(physicalAssessmentOrganizer);
				}
				if (result == null) {
					result = caseAct(physicalAssessmentOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(physicalAssessmentOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.SKIN_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(skinAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(skinAssessment);
				}
				if (result == null) {
					result = caseAct(skinAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(skinAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_PREGNANCY: {
				...
				if (result == null) {
					result = caseObservation(patientPregnancy);
				}
				if (result == null) {
					result = caseClinicalStatement(patientPregnancy);
				}
				if (result == null) {
					result = caseAct(patientPregnancy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientPregnancy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.LAST_ORAL_INTAKE: {
				...
				if (result == null) {
					result = caseObservation(lastOralIntake);
				}
				if (result == null) {
					result = caseClinicalStatement(lastOralIntake);
				}
				if (result == null) {
					result = caseAct(lastOralIntake);
				}
				if (result == null) {
					result = caseInfrastructureRoot(lastOralIntake);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_AGE: {
				...
				if (result == null) {
					result = caseObservation(patientAge);
				}
				if (result == null) {
					result = caseClinicalStatement(patientAge);
				}
				if (result == null) {
					result = caseAct(patientAge);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientAge);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.THROMBOLYTIC_CONTRAINDICATIONS: {
				...
				if (result == null) {
					result = caseObservation(thrombolyticContraindications);
				}
				if (result == null) {
					result = caseClinicalStatement(thrombolyticContraindications);
				}
				if (result == null) {
					result = caseAct(thrombolyticContraindications);
				}
				if (result == null) {
					result = caseInfrastructureRoot(thrombolyticContraindications);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.BARRIERS_TO_PATIENT_CARE: {
				...
				if (result == null) {
					result = caseObservation(barriersToPatientCare);
				}
				if (result == null) {
					result = caseClinicalStatement(barriersToPatientCare);
				}
				if (result == null) {
					result = caseAct(barriersToPatientCare);
				}
				if (result == null) {
					result = caseInfrastructureRoot(barriersToPatientCare);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.MEDICATION_ADMINISTERED: {
				...
				if (result == null) {
					result = caseMedicationActivity(medicationAdministered);
				}
				if (result == null) {
					result = caseSubstanceAdministration(medicationAdministered);
				}
				if (result == null) {
					result = caseClinicalStatement(medicationAdministered);
				}
				if (result == null) {
					result = caseAct(medicationAdministered);
				}
				if (result == null) {
					result = caseInfrastructureRoot(medicationAdministered);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROCEDURES_PERFORMED_SECTION: {
				ProceduresPerformedSection proceduresPerformedSection = (ProceduresPerformedSection) theEObject;
				T result = caseProceduresPerformedSection(proceduresPerformedSection);
				if (result == null) {
					result = caseProcedureDescriptionSection(proceduresPerformedSection);
				}
				if (result == null) {
					result = caseSection(proceduresPerformedSection);
				}
				if (result == null) {
					result = caseAct(proceduresPerformedSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(proceduresPerformedSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_CARE_NARRATIVE_SECTION: {
				PatientCareNarrativeSection patientCareNarrativeSection = (PatientCareNarrativeSection) theEObject;
				T result = casePatientCareNarrativeSection(patientCareNarrativeSection);
				if (result == null) {
					result = caseSection(patientCareNarrativeSection);
				}
				if (result == null) {
					result = caseAct(patientCareNarrativeSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientCareNarrativeSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.SCENE_SECTION: {
				SceneSection sceneSection = (SceneSection) theEObject;
				T result = caseSceneSection(sceneSection);
				if (result == null) {
					result = caseSection(sceneSection);
				}
				if (result == null) {
					result = caseAct(sceneSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(sceneSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.FIRST_UNIT_INDICATOR: {
				...
				if (result == null) {
					result = caseObservation(firstUnitIndicator);
				}
				if (result == null) {
					result = caseClinicalStatement(firstUnitIndicator);
				}
				if (result == null) {
					result = caseAct(firstUnitIndicator);
				}
				if (result == null) {
					result = caseInfrastructureRoot(firstUnitIndicator);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.FIRST_UNIT_ON_SCENE: {
				...
				if (result == null) {
					result = caseObservation(firstUnitOnScene);
				}
				if (result == null) {
					result = caseClinicalStatement(firstUnitOnScene);
				}
				if (result == null) {
					result = caseAct(firstUnitOnScene);
				}
				if (result == null) {
					result = caseInfrastructureRoot(firstUnitOnScene);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.SCENE_PATIENT_COUNT: {
				...
				if (result == null) {
					result = caseObservation(scenePatientCount);
				}
				if (result == null) {
					result = caseClinicalStatement(scenePatientCount);
				}
				if (result == null) {
					result = caseAct(scenePatientCount);
				}
				if (result == null) {
					result = caseInfrastructureRoot(scenePatientCount);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.MASS_CASUALTY_INDICATOR: {
				...
				if (result == null) {
					result = caseObservation(massCasualtyIndicator);
				}
				if (result == null) {
					result = caseClinicalStatement(massCasualtyIndicator);
				}
				if (result == null) {
					result = caseAct(massCasualtyIndicator);
				}
				if (result == null) {
					result = caseInfrastructureRoot(massCasualtyIndicator);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.LOCATION_TYPE_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(locationTypeObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(locationTypeObservation);
				}
				if (result == null) {
					result = caseAct(locationTypeObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(locationTypeObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_SECTION: {
				DispatchSection dispatchSection = (DispatchSection) theEObject;
				T result = caseDispatchSection(dispatchSection);
				if (result == null) {
					result = caseSection(dispatchSection);
				}
				if (result == null) {
					result = caseAct(dispatchSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EMERGENCY_MEDICAL_DISPATCH_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(emergencyMedicalDispatchObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(emergencyMedicalDispatchObservation);
				}
				if (result == null) {
					result = caseAct(emergencyMedicalDispatchObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(emergencyMedicalDispatchObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.COMPLAINT_REPORTED_BY_DISPATCH: {
				...
				if (result == null) {
					result = caseObservation(complaintReportedByDispatch);
				}
				if (result == null) {
					result = caseClinicalStatement(complaintReportedByDispatch);
				}
				if (result == null) {
					result = caseAct(complaintReportedByDispatch);
				}
				if (result == null) {
					result = caseInfrastructureRoot(complaintReportedByDispatch);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPOSITION_SECTION: {
				DispositionSection dispositionSection = (DispositionSection) theEObject;
				T result = caseDispositionSection(dispositionSection);
				if (result == null) {
					result = caseSection(dispositionSection);
				}
				if (result == null) {
					result = caseAct(dispositionSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispositionSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.TRANSPORT_METHOD_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(transportMethodObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(transportMethodObservation);
				}
				if (result == null) {
					result = caseAct(transportMethodObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(transportMethodObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NUMBER_OF_PATIENTS_OBSERVATION: {
				NumberOfPatientsObservation numberOfPatientsObservation = (NumberOfPatientsObservation) theEObject;
				T result = caseNumberOfPatientsObservation(numberOfPatientsObservation);
				if (result == null) {
					result = caseObservation(numberOfPatientsObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(numberOfPatientsObservation);
				}
				if (result == null) {
					result = caseAct(numberOfPatientsObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(numberOfPatientsObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.INCIDENT_DISPOSITION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(incidentDispositionObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(incidentDispositionObservation);
				}
				if (result == null) {
					result = caseAct(incidentDispositionObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(incidentDispositionObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.TRANSPORT_MODE_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(transportModeObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(transportModeObservation);
				}
				if (result == null) {
					result = caseAct(transportModeObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(transportModeObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.REASON_FOR_CHOOSING_DESTINATION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(reasonForChoosingDestinationObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(reasonForChoosingDestinationObservation);
				}
				if (result == null) {
					result = caseAct(reasonForChoosingDestinationObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(reasonForChoosingDestinationObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PREARRIVAL_ACTIVATION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(prearrivalActivationObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(prearrivalActivationObservation);
				}
				if (result == null) {
					result = caseAct(prearrivalActivationObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(prearrivalActivationObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(patientConditionChangeAtDestinationObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(patientConditionChangeAtDestinationObservation);
				}
				if (result == null) {
					result = caseAct(patientConditionChangeAtDestinationObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientConditionChangeAtDestinationObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PERSONNEL_ADVERSE_EVENT_SECTION: {
				PersonnelAdverseEventSection personnelAdverseEventSection = (PersonnelAdverseEventSection) theEObject;
				T result = casePersonnelAdverseEventSection(personnelAdverseEventSection);
				if (result == null) {
					result = caseSection(personnelAdverseEventSection);
				}
				if (result == null) {
					result = caseAct(personnelAdverseEventSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(personnelAdverseEventSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ADVERSE_EVENT_INDICATOR: {
				...
				if (result == null) {
					result = caseObservation(adverseEventIndicator);
				}
				if (result == null) {
					result = caseClinicalStatement(adverseEventIndicator);
				}
				if (result == null) {
					result = caseAct(adverseEventIndicator);
				}
				if (result == null) {
					result = caseInfrastructureRoot(adverseEventIndicator);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ADVERSE_EVENT_TYPE_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(adverseEventTypeObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(adverseEventTypeObservation);
				}
				if (result == null) {
					result = caseAct(adverseEventTypeObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(adverseEventTypeObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROTOCOL_SECTION: {
				ProtocolSection protocolSection = (ProtocolSection) theEObject;
				T result = caseProtocolSection(protocolSection);
				if (result == null) {
					result = caseSection(protocolSection);
				}
				if (result == null) {
					result = caseAct(protocolSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(protocolSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROTOCOL_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(protocolObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(protocolObservation);
				}
				if (result == null) {
					result = caseAct(protocolObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(protocolObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CANDIDATE_PATIENT_REGISTRY_TYPE: {
				...
				if (result == null) {
					result = caseObservation(candidatePatientRegistryType);
				}
				if (result == null) {
					result = caseClinicalStatement(candidatePatientRegistryType);
				}
				if (result == null) {
					result = caseAct(candidatePatientRegistryType);
				}
				if (result == null) {
					result = caseInfrastructureRoot(candidatePatientRegistryType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_SECTION: {
				ResponseSection responseSection = (ResponseSection) theEObject;
				T result = caseResponseSection(responseSection);
				if (result == null) {
					result = caseSection(responseSection);
				}
				if (result == null) {
					result = caseAct(responseSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DELAY_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(delayOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(delayOrganizer);
				}
				if (result == null) {
					result = caseAct(delayOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(delayOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_LOCATION_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(dispatchLocationOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(dispatchLocationOrganizer);
				}
				if (result == null) {
					result = caseAct(dispatchLocationOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchLocationOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_ODOMETER_READING_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(responseOdometerReadingOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(responseOdometerReadingOrganizer);
				}
				if (result == null) {
					result = caseAct(responseOdometerReadingOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseOdometerReadingOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_MODE_TO_SCENE: {
				...
				if (result == null) {
					result = caseObservation(responseModeToScene);
				}
				if (result == null) {
					result = caseClinicalStatement(responseModeToScene);
				}
				if (result == null) {
					result = caseAct(responseModeToScene);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseModeToScene);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.SITUATION_SECTION: {
				SituationSection situationSection = (SituationSection) theEObject;
				T result = caseSituationSection(situationSection);
				if (result == null) {
					result = caseSection(situationSection);
				}
				if (result == null) {
					result = caseAct(situationSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(situationSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.COMPLAINT: {
				...
				if (result == null) {
					result = caseObservation(complaint);
				}
				if (result == null) {
					result = caseClinicalStatement(complaint);
				}
				if (result == null) {
					result = caseAct(complaint);
				}
				if (result == null) {
					result = caseInfrastructureRoot(complaint);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.POSSIBLE_INJURY: {
				...
				if (result == null) {
					result = caseObservation(possibleInjury);
				}
				if (result == null) {
					result = caseClinicalStatement(possibleInjury);
				}
				if (result == null) {
					result = caseAct(possibleInjury);
				}
				if (result == null) {
					result = caseInfrastructureRoot(possibleInjury);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROVIDER_PRIMARY_IMPRESSION: {
				...
				if (result == null) {
					result = caseObservation(providerPrimaryImpression);
				}
				if (result == null) {
					result = caseClinicalStatement(providerPrimaryImpression);
				}
				if (result == null) {
					result = caseAct(providerPrimaryImpression);
				}
				if (result == null) {
					result = caseInfrastructureRoot(providerPrimaryImpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PRIMARY_SYMPTOM: {
				...
				if (result == null) {
					result = caseObservation(primarySymptom);
				}
				if (result == null) {
					result = caseClinicalStatement(primarySymptom);
				}
				if (result == null) {
					result = caseAct(primarySymptom);
				}
				if (result == null) {
					result = caseInfrastructureRoot(primarySymptom);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.OTHER_SYMPTOMS: {
				...
				if (result == null) {
					result = caseObservation(otherSymptoms);
				}
				if (result == null) {
					result = caseClinicalStatement(otherSymptoms);
				}
				if (result == null) {
					result = caseAct(otherSymptoms);
				}
				if (result == null) {
					result = caseInfrastructureRoot(otherSymptoms);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROVIDER_SECONDARY_IMPRESSIONS: {
				...
				if (result == null) {
					result = caseObservation(providerSecondaryImpressions);
				}
				if (result == null) {
					result = caseClinicalStatement(providerSecondaryImpressions);
				}
				if (result == null) {
					result = caseAct(providerSecondaryImpressions);
				}
				if (result == null) {
					result = caseInfrastructureRoot(providerSecondaryImpressions);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.INITIAL_PATIENT_ACUITY: {
				...
				if (result == null) {
					result = caseObservation(initialPatientAcuity);
				}
				if (result == null) {
					result = caseClinicalStatement(initialPatientAcuity);
				}
				if (result == null) {
					result = caseAct(initialPatientAcuity);
				}
				if (result == null) {
					result = caseInfrastructureRoot(initialPatientAcuity);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.TIMES_SECTION: {
				...
				if (result == null) {
					result = caseSection(timesSection);
				}
				if (result == null) {
					result = caseAct(timesSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(timesSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CALL_TIME: {
				...
				if (result == null) {
					result = caseObservation(callTime);
				}
				if (result == null) {
					result = caseClinicalStatement(callTime);
				}
				if (result == null) {
					result = caseAct(callTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(callTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_NOTIFIED_TIME: {
				...
				if (result == null) {
					result = caseObservation(unitNotifiedTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitNotifiedTime);
				}
				if (result == null) {
					result = caseAct(unitNotifiedTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitNotifiedTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_EN_ROUTE_TIME: {
				...
				if (result == null) {
					result = caseObservation(unitEnRouteTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitEnRouteTime);
				}
				if (result == null) {
					result = caseAct(unitEnRouteTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitEnRouteTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_ON_SCENE_TIME: {
				...
				if (result == null) {
					result = caseObservation(unitOnSceneTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitOnSceneTime);
				}
				if (result == null) {
					result = caseAct(unitOnSceneTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitOnSceneTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_AT_PATIENTT_TIME: {
				UnitAtPatienttTime unitAtPatienttTime = (UnitAtPatienttTime) theEObject;
				T result = caseUnitAtPatienttTime(unitAtPatienttTime);
				if (result == null) {
					result = caseObservation(unitAtPatienttTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitAtPatienttTime);
				}
				if (result == null) {
					result = caseAct(unitAtPatienttTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitAtPatienttTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_LEFT_SCENE_TIME: {
				...
				if (result == null) {
					result = caseObservation(unitLeftSceneTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitLeftSceneTime);
				}
				if (result == null) {
					result = caseAct(unitLeftSceneTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitLeftSceneTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_ARRIVED_AT_DESTINATION_TIME: {
				...
				if (result == null) {
					result = caseObservation(patientArrivedAtDestinationTime);
				}
				if (result == null) {
					result = caseClinicalStatement(patientArrivedAtDestinationTime);
				}
				if (result == null) {
					result = caseAct(patientArrivedAtDestinationTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientArrivedAtDestinationTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_BACK_IN_SERVICE_TIME: {
				...
				if (result == null) {
					result = caseObservation(unitBackInServiceTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitBackInServiceTime);
				}
				if (result == null) {
					result = caseAct(unitBackInServiceTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitBackInServiceTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_NOTIFIED_TIME: {
				...
				if (result == null) {
					result = caseObservation(dispatchNotifiedTime);
				}
				if (result == null) {
					result = caseClinicalStatement(dispatchNotifiedTime);
				}
				if (result == null) {
					result = caseAct(dispatchNotifiedTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchNotifiedTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.VITAL_SIGNS_SECTION: {
				...
				if (result == null) {
					result = caseConsol_VitalSignsSection(vitalSignsSection);
				}
				if (result == null) {
			...
			case EmspcrPackage.VITAL_SIGNS_ORGANIZER: {
				...
				if (result == null) {
					result = caseConsol_VitalSignsOrganizer(vitalSignsOrganizer);
				}
				if (result == null) {
			...
			case EmspcrPackage.PRIOR_AID_VITALS: {
				...
				if (result == null) {
					result = caseObservation(priorAidVitals);
				}
				if (result == null) {
					result = caseClinicalStatement(priorAidVitals);
				}
				if (result == null) {
					result = caseAct(priorAidVitals);
				}
				if (result == null) {
					result = caseInfrastructureRoot(priorAidVitals);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ADDITIONAL_VITAL_SIGNS_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(additionalVitalSignsOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(additionalVitalSignsOrganizer);
				}
				if (result == null) {
					result = caseAct(additionalVitalSignsOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(additionalVitalSignsOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.STROKE_SCORE: {
				...
				if (result == null) {
					result = caseObservation(strokeScore);
				}
				if (result == null) {
					result = caseClinicalStatement(strokeScore);
				}
				if (result == null) {
					result = caseAct(strokeScore);
				}
				if (result == null) {
					result = caseInfrastructureRoot(strokeScore);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PAIN_SCORE: {
				...
				if (result == null) {
					result = caseObservation(painScore);
				}
				if (result == null) {
					result = caseClinicalStatement(painScore);
				}
				if (result == null) {
					result = caseAct(painScore);
				}
				if (result == null) {
					result = caseInfrastructureRoot(painScore);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.LEVEL_OF_RESPONSIVENESS: {
				...
				if (result == null) {
					result = caseObservation(levelOfResponsiveness);
				}
				if (result == null) {
					result = caseClinicalStatement(levelOfResponsiveness);
				}
				if (result == null) {
					result = caseAct(levelOfResponsiveness);
				}
				if (result == null) {
					result = caseInfrastructureRoot(levelOfResponsiveness);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.BLOOD_GLUCOSE: {
				...
				if (result == null) {
					result = caseObservation(bloodGlucose);
				}
				if (result == null) {
					result = caseClinicalStatement(bloodGlucose);
				}
				if (result == null) {
					result = caseAct(bloodGlucose);
				}
				if (result == null) {
					result = caseInfrastructureRoot(bloodGlucose);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARBON_MONOXIDE: {
				...
				if (result == null) {
					result = caseObservation(carbonMonoxide);
				}
				if (result == null) {
					result = caseClinicalStatement(carbonMonoxide);
				}
				if (result == null) {
					result = caseAct(carbonMonoxide);
				}
				if (result == null) {
					result = caseInfrastructureRoot(carbonMonoxide);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARBON_DIOXIDE: {
				...
				if (result == null) {
					result = caseObservation(carbonDioxide);
				}
				if (result == null) {
					result = caseClinicalStatement(carbonDioxide);
				}
				if (result == null) {
					result = caseAct(carbonDioxide);
				}
				if (result == null) {
					result = caseInfrastructureRoot(carbonDioxide);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARDIAC_RHYTHM: {
				...
				if (result == null) {
					result = caseObservation(cardiacRhythm);
				}
				if (result == null) {
					result = caseClinicalStatement(cardiacRhythm);
				}
				if (result == null) {
					result = caseAct(cardiacRhythm);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacRhythm);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.GLASGOW_COMA_SCORE_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(glasgowComaScoreOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(glasgowComaScoreOrganizer);
				}
				if (result == null) {
					result = caseAct(glasgowComaScoreOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(glasgowComaScoreOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.GLASGOW_EYE: {
				...
				if (result == null) {
					result = caseObservation(glasgowEye);
				}
				if (result == null) {
					result = caseClinicalStatement(glasgowEye);
				}
				if (result == null) {
					result = caseAct(glasgowEye);
				}
				if (result == null) {
					result = caseInfrastructureRoot(glasgowEye);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.GLASGOW_MOTOR: {
				...
				if (result == null) {
					result = caseObservation(glasgowMotor);
				}
				if (result == null) {
					result = caseClinicalStatement(glasgowMotor);
				}
				if (result == null) {
					result = caseAct(glasgowMotor);
				}
				if (result == null) {
					result = caseInfrastructureRoot(glasgowMotor);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.GLASGOW_QUALIFIER: {
				...
				if (result == null) {
					result = caseObservation(glasgowQualifier);
				}
				if (result == null) {
					result = caseClinicalStatement(glasgowQualifier);
				}
				if (result == null) {
					result = caseAct(glasgowQualifier);
				}
				if (result == null) {
					result = caseInfrastructureRoot(glasgowQualifier);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.GLASGOW_TOTAL: {
				...
				if (result == null) {
					result = caseObservation(glasgowTotal);
				}
				if (result == null) {
					result = caseClinicalStatement(glasgowTotal);
				}
				if (result == null) {
					result = caseAct(glasgowTotal);
				}
				if (result == null) {
					result = caseInfrastructureRoot(glasgowTotal);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.GLASGOW_VERBAL: {
				...
				if (result == null) {
					result = caseObservation(glasgowVerbal);
				}
				if (result == null) {
					result = caseClinicalStatement(glasgowVerbal);
				}
				if (result == null) {
					result = caseAct(glasgowVerbal);
				}
				if (result == null) {
					result = caseInfrastructureRoot(glasgowVerbal);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.INJURY_INCIDENT_DESCRIPTION_SECTION: {
				InjuryIncidentDescriptionSection injuryIncidentDescriptionSection = (InjuryIncidentDescriptionSection) theEObject;
				T result = caseInjuryIncidentDescriptionSection(injuryIncidentDescriptionSection);
				if (result == null) {
					result = caseSection(injuryIncidentDescriptionSection);
				}
				if (result == null) {
					result = caseAct(injuryIncidentDescriptionSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(injuryIncidentDescriptionSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.INJURY_CAUSE_CATEGORY: {
				...
				if (result == null) {
					result = caseObservation(injuryCauseCategory);
				}
				if (result == null) {
					result = caseClinicalStatement(injuryCauseCategory);
				}
				if (result == null) {
					result = caseAct(injuryCauseCategory);
				}
				if (result == null) {
					result = caseInfrastructureRoot(injuryCauseCategory);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.INJURY_MECHANISM: {
				...
				if (result == null) {
					result = caseObservation(injuryMechanism);
				}
				if (result == null) {
					result = caseClinicalStatement(injuryMechanism);
				}
				if (result == null) {
					result = caseAct(injuryMechanism);
				}
				if (result == null) {
					result = caseInfrastructureRoot(injuryMechanism);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.TRAUMA_CENTER_CRITERIA: {
				...
				if (result == null) {
					result = caseObservation(traumaCenterCriteria);
				}
				if (result == null) {
					result = caseClinicalStatement(traumaCenterCriteria);
				}
				if (result == null) {
					result = caseAct(traumaCenterCriteria);
				}
				if (result == null) {
					result = caseInfrastructureRoot(traumaCenterCriteria);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.INJURY_RISK_FACTOR: {
				...
				if (result == null) {
					result = caseObservation(injuryRiskFactor);
				}
				if (result == null) {
					result = caseClinicalStatement(injuryRiskFactor);
				}
				if (result == null) {
					result = caseAct(injuryRiskFactor);
				}
				if (result == null) {
					result = caseInfrastructureRoot(injuryRiskFactor);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.VEHICLE_IMPACT_AREA: {
				...
				if (result == null) {
					result = caseObservation(vehicleImpactArea);
				}
				if (result == null) {
					result = caseClinicalStatement(vehicleImpactArea);
				}
				if (result == null) {
					result = caseAct(vehicleImpactArea);
				}
				if (result == null) {
					result = caseInfrastructureRoot(vehicleImpactArea);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_LOCATION_IN_VEHICLE: {
				...
				if (result == null) {
					result = caseObservation(patientLocationInVehicle);
				}
				if (result == null) {
					result = caseClinicalStatement(patientLocationInVehicle);
				}
				if (result == null) {
					result = caseAct(patientLocationInVehicle);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientLocationInVehicle);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.VEHICLE_OCCUPANT_SAFETY_EQUIPMENT: {
				...
				if (result == null) {
					result = caseObservation(vehicleOccupantSafetyEquipment);
				}
				if (result == null) {
					result = caseClinicalStatement(vehicleOccupantSafetyEquipment);
				}
				if (result == null) {
					result = caseAct(vehicleOccupantSafetyEquipment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(vehicleOccupantSafetyEquipment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.AIRBAG_DEPLOYMENT_STATUS: {
				...
				if (result == null) {
					result = caseObservation(airbagDeploymentStatus);
				}
				if (result == null) {
					result = caseClinicalStatement(airbagDeploymentStatus);
				}
				if (result == null) {
					result = caseAct(airbagDeploymentStatus);
				}
				if (result == null) {
					result = caseInfrastructureRoot(airbagDeploymentStatus);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.HEIGHT_OF_FALL: {
				...
				if (result == null) {
					result = caseObservation(heightOfFall);
				}
				if (result == null) {
					result = caseClinicalStatement(heightOfFall);
				}
				if (result == null) {
					result = caseAct(heightOfFall);
				}
				if (result == null) {
					result = caseInfrastructureRoot(heightOfFall);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISASTER_TYPE: {
				...
				if (result == null) {
					result = caseObservation(disasterType);
				}
				if (result == null) {
					result = caseClinicalStatement(disasterType);
				}
				if (result == null) {
					result = caseAct(disasterType);
				}
				if (result == null) {
			...
			case EmspcrPackage.MEDICATION_NOT_ADMINISTERED_REASON_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(medicationNotAdministeredReasonObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(medicationNotAdministeredReasonObservation);
				}
				if (result == null) {
					result = caseAct(medicationNotAdministeredReasonObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(medicationNotAdministeredReasonObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.MEDICATION_RESPONSE_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(medicationResponseObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(medicationResponseObservation);
				}
				if (result == null) {
					result = caseAct(medicationResponseObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(medicationResponseObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.MEDICATION_COMPLICATION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(medicationComplicationObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(medicationComplicationObservation);
				}
				if (result == null) {
					result = caseAct(medicationComplicationObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(medicationComplicationObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.MEDICATION_PRIOR_ADMINISTRATION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(medicationPriorAdministrationObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(medicationPriorAdministrationObservation);
				}
				if (result == null) {
					result = caseAct(medicationPriorAdministrationObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(medicationPriorAdministrationObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PATIENT_BODY_WEIGHT: {
				...
				if (result == null) {
					result = caseObservation(patientBodyWeight);
				}
				if (result == null) {
					result = caseClinicalStatement(patientBodyWeight);
				}
				if (result == null) {
					result = caseAct(patientBodyWeight);
				}
				if (result == null) {
					result = caseInfrastructureRoot(patientBodyWeight);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.LENGTH_BASED_PATIENT_BODY_WEIGHT_CLASS: {
				...
				if (result == null) {
					result = caseObservation(lengthBasedPatientBodyWeightClass);
				}
				if (result == null) {
					result = caseClinicalStatement(lengthBasedPatientBodyWeightClass);
				}
				if (result == null) {
					result = caseAct(lengthBasedPatientBodyWeightClass);
				}
				if (result == null) {
					result = caseInfrastructureRoot(lengthBasedPatientBodyWeightClass);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.FACE_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(faceAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(faceAssessment);
				}
				if (result == null) {
					result = caseAct(faceAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(faceAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.HEAD_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(headAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(headAssessment);
				}
				if (result == null) {
					result = caseAct(headAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(headAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NECK_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(neckAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(neckAssessment);
				}
				if (result == null) {
					result = caseAct(neckAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(neckAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CHEST_AND_LUNGS_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(chestAndLungsAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(chestAndLungsAssessment);
				}
				if (result == null) {
					result = caseAct(chestAndLungsAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(chestAndLungsAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.HEART_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(heartAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(heartAssessment);
				}
				if (result == null) {
					result = caseAct(heartAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(heartAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ABDOMEN_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(abdomenAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(abdomenAssessment);
				}
				if (result == null) {
					result = caseAct(abdomenAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(abdomenAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PELVIC_AND_GENITOURINARY_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(pelvicAndGenitourinaryAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(pelvicAndGenitourinaryAssessment);
				}
				if (result == null) {
					result = caseAct(pelvicAndGenitourinaryAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(pelvicAndGenitourinaryAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.BACK_AND_SPINE_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(backAndSpineAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(backAndSpineAssessment);
				}
				if (result == null) {
					result = caseAct(backAndSpineAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(backAndSpineAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXTREMITIES_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(extremitiesAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(extremitiesAssessment);
				}
				if (result == null) {
					result = caseAct(extremitiesAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(extremitiesAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EYE_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(eyeAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(eyeAssessment);
				}
				if (result == null) {
					result = caseAct(eyeAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(eyeAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.MENTAL_STATUS_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(mentalStatusAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(mentalStatusAssessment);
				}
				if (result == null) {
					result = caseAct(mentalStatusAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(mentalStatusAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARDIAC_ARREST_TIMING: {
				...
				if (result == null) {
					result = caseObservation(cardiacArrestTiming);
				}
				if (result == null) {
					result = caseClinicalStatement(cardiacArrestTiming);
				}
				if (result == null) {
					result = caseAct(cardiacArrestTiming);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacArrestTiming);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARDIAC_ARREST_CAUSE: {
				...
				if (result == null) {
					result = caseObservation(cardiacArrestCause);
				}
				if (result == null) {
					result = caseClinicalStatement(cardiacArrestCause);
				}
				if (result == null) {
					result = caseAct(cardiacArrestCause);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacArrestCause);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PRIOR_CPR: {
				...
				if (result == null) {
					result = caseObservation(priorCPR);
				}
				if (result == null) {
					result = caseClinicalStatement(priorCPR);
				}
				if (result == null) {
					result = caseAct(priorCPR);
				}
				if (result == null) {
					result = caseInfrastructureRoot(priorCPR);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PRIOR_AED_USE: {
				...
				if (result == null) {
					result = caseObservation(priorAEDUse);
				}
				if (result == null) {
					result = caseClinicalStatement(priorAEDUse);
				}
				if (result == null) {
					result = caseAct(priorAEDUse);
				}
				if (result == null) {
					result = caseInfrastructureRoot(priorAEDUse);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ARREST_RHYTHM: {
				...
				if (result == null) {
					result = caseObservation(arrestRhythm);
				}
				if (result == null) {
					result = caseClinicalStatement(arrestRhythm);
				}
				if (result == null) {
					result = caseAct(arrestRhythm);
				}
				if (result == null) {
					result = caseInfrastructureRoot(arrestRhythm);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RETURN_OF_SPONTANEOUS_CIRCULATION: {
				...
				if (result == null) {
					result = caseObservation(returnOfSpontaneousCirculation);
				}
				if (result == null) {
					result = caseClinicalStatement(returnOfSpontaneousCirculation);
				}
				if (result == null) {
					result = caseAct(returnOfSpontaneousCirculation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(returnOfSpontaneousCirculation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DESTINATION_RHYTHM: {
				...
				if (result == null) {
					result = caseObservation(destinationRhythm);
				}
				if (result == null) {
					result = caseClinicalStatement(destinationRhythm);
				}
				if (result == null) {
					result = caseAct(destinationRhythm);
				}
				if (result == null) {
					result = caseInfrastructureRoot(destinationRhythm);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.ABANDONED_PROCEDURE_REASON_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(abandonedProcedureReasonObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(abandonedProcedureReasonObservation);
				}
				if (result == null) {
					result = caseAct(abandonedProcedureReasonObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(abandonedProcedureReasonObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROCEDURE_PRIOR_INDICATOR: {
				...
				if (result == null) {
					result = caseObservation(procedurePriorIndicator);
				}
				if (result == null) {
					result = caseClinicalStatement(procedurePriorIndicator);
				}
				if (result == null) {
					result = caseAct(procedurePriorIndicator);
				}
				if (result == null) {
					result = caseInfrastructureRoot(procedurePriorIndicator);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROCEDURE_NUMBER_OF_ATTEMPTS_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(procedureNumberOfAttemptsObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(procedureNumberOfAttemptsObservation);
				}
				if (result == null) {
					result = caseAct(procedureNumberOfAttemptsObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(procedureNumberOfAttemptsObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROCEDURE_SUCCESSFUL_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(procedureSuccessfulObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(procedureSuccessfulObservation);
				}
				if (result == null) {
					result = caseAct(procedureSuccessfulObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(procedureSuccessfulObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROCEDURE_COMPLICATIONS_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(procedureComplicationsObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(procedureComplicationsObservation);
				}
				if (result == null) {
					result = caseAct(procedureComplicationsObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(procedureComplicationsObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROCEDURE_PATIENT_RESPONSE_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(procedurePatientResponseObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(procedurePatientResponseObservation);
				}
				if (result == null) {
					result = caseAct(procedurePatientResponseObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(procedurePatientResponseObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.AIRWAY_CONFIRMATION_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(airwayConfirmationObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(airwayConfirmationObservation);
				}
				if (result == null) {
					result = caseAct(airwayConfirmationObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(airwayConfirmationObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.REASON_PROCEDURE_NOT_ATTEMPTED_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(reasonProcedureNotAttemptedObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(reasonProcedureNotAttemptedObservation);
				}
				if (result == null) {
					result = caseAct(reasonProcedureNotAttemptedObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(reasonProcedureNotAttemptedObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.COMPLAINT_TYPE: {
				...
				if (result == null) {
					result = caseObservation(complaintType);
				}
				if (result == null) {
					result = caseClinicalStatement(complaintType);
				}
				if (result == null) {
					result = caseAct(complaintType);
				}
				if (result == null) {
					result = caseInfrastructureRoot(complaintType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.COMPLAINT_DURATION: {
				...
				if (result == null) {
					result = caseObservation(complaintDuration);
				}
				if (result == null) {
					result = caseClinicalStatement(complaintDuration);
				}
				if (result == null) {
					result = caseAct(complaintDuration);
				}
				if (result == null) {
					result = caseInfrastructureRoot(complaintDuration);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.COMPLAINT_ORGAN_SYSTEM: {
				...
				if (result == null) {
					result = caseObservation(complaintOrganSystem);
				}
				if (result == null) {
					result = caseClinicalStatement(complaintOrganSystem);
				}
				if (result == null) {
					result = caseAct(complaintOrganSystem);
				}
				if (result == null) {
					result = caseInfrastructureRoot(complaintOrganSystem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NEUROLOGICAL_ASSESSMENT: {
				...
				if (result == null) {
					result = caseObservation(neurologicalAssessment);
				}
				if (result == null) {
					result = caseClinicalStatement(neurologicalAssessment);
				}
				if (result == null) {
					result = caseAct(neurologicalAssessment);
				}
				if (result == null) {
					result = caseInfrastructureRoot(neurologicalAssessment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXISTENCE_OF_HISTORY_OF_PROCEDURES: {
				ExistenceOfHistoryOfProcedures existenceOfHistoryOfProcedures = (ExistenceOfHistoryOfProcedures) theEObject;
				T result = caseExistenceOfHistoryOfProcedures(existenceOfHistoryOfProcedures);
				if (result == null) {
					result = caseObservation(existenceOfHistoryOfProcedures);
				}
				if (result == null) {
					result = caseClinicalStatement(existenceOfHistoryOfProcedures);
				}
				if (result == null) {
					result = caseAct(existenceOfHistoryOfProcedures);
				}
				if (result == null) {
					result = caseInfrastructureRoot(existenceOfHistoryOfProcedures);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.SYSTOLIC_BLOOD_PRESSURE: {
				...
				if (result == null) {
					result = caseVitalSignObservation(systolicBloodPressure);
				}
				if (result == null) {
					result = caseObservation(systolicBloodPressure);
				}
				if (result == null) {
					result = caseClinicalStatement(systolicBloodPressure);
				}
				if (result == null) {
					result = caseAct(systolicBloodPressure);
				}
				if (result == null) {
					result = caseInfrastructureRoot(systolicBloodPressure);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DIASTOLIC_BLOOD_PRESSURE: {
				...
				if (result == null) {
					result = caseVitalSignObservation(diastolicBloodPressure);
				}
				if (result == null) {
					result = caseObservation(diastolicBloodPressure);
				}
				if (result == null) {
					result = caseClinicalStatement(diastolicBloodPressure);
				}
				if (result == null) {
					result = caseAct(diastolicBloodPressure);
				}
				if (result == null) {
					result = caseInfrastructureRoot(diastolicBloodPressure);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.HEART_RATE: {
				...
				if (result == null) {
					result = caseVitalSignObservation(heartRate);
				}
				if (result == null) {
					result = caseObservation(heartRate);
				}
				if (result == null) {
					result = caseClinicalStatement(heartRate);
				}
				if (result == null) {
					result = caseAct(heartRate);
				}
				if (result == null) {
					result = caseInfrastructureRoot(heartRate);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPIRATORY_RATE: {
				...
				if (result == null) {
					result = caseVitalSignObservation(respiratoryRate);
				}
				if (result == null) {
					result = caseObservation(respiratoryRate);
				}
				if (result == null) {
					result = caseClinicalStatement(respiratoryRate);
				}
				if (result == null) {
					result = caseAct(respiratoryRate);
				}
				if (result == null) {
					result = caseInfrastructureRoot(respiratoryRate);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.BODY_TEMPERATURE: {
				...
				if (result == null) {
					result = caseVitalSignObservation(bodyTemperature);
				}
				if (result == null) {
					result = caseObservation(bodyTemperature);
				}
				if (result == null) {
					result = caseClinicalStatement(bodyTemperature);
				}
				if (result == null) {
					result = caseAct(bodyTemperature);
				}
				if (result == null) {
					result = caseInfrastructureRoot(bodyTemperature);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.OXYGEN_SATURATION: {
				...
				if (result == null) {
					result = caseObservation(oxygenSaturation);
				}
				if (result == null) {
					result = caseClinicalStatement(oxygenSaturation);
				}
				if (result == null) {
					result = caseAct(oxygenSaturation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(oxygenSaturation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.PROTOCOL_AGE_CATEGORY: {
				...
				if (result == null) {
					result = caseObservation(protocolAgeCategory);
				}
				if (result == null) {
					result = caseClinicalStatement(protocolAgeCategory);
				}
				if (result == null) {
					result = caseAct(protocolAgeCategory);
				}
				if (result == null) {
					result = caseInfrastructureRoot(protocolAgeCategory);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_LOCATION_NAME: {
				...
				if (result == null) {
					result = caseObservation(dispatchLocationName);
				}
				if (result == null) {
					result = caseClinicalStatement(dispatchLocationName);
				}
				if (result == null) {
					result = caseAct(dispatchLocationName);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchLocationName);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_LOCATION_LATITUDE: {
				...
				if (result == null) {
					result = caseObservation(dispatchLocationLatitude);
				}
				if (result == null) {
					result = caseClinicalStatement(dispatchLocationLatitude);
				}
				if (result == null) {
					result = caseAct(dispatchLocationLatitude);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchLocationLatitude);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_LOCATION_LONGITUDE: {
				...
				if (result == null) {
					result = caseObservation(dispatchLocationLongitude);
				}
				if (result == null) {
					result = caseClinicalStatement(dispatchLocationLongitude);
				}
				if (result == null) {
					result = caseAct(dispatchLocationLongitude);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchLocationLongitude);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.DISPATCH_DELAY: {
				...
				if (result == null) {
					result = caseObservation(dispatchDelay);
				}
				if (result == null) {
					result = caseClinicalStatement(dispatchDelay);
				}
				if (result == null) {
					result = caseAct(dispatchDelay);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dispatchDelay);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_DELAY: {
				...
				if (result == null) {
					result = caseObservation(responseDelay);
				}
				if (result == null) {
					result = caseClinicalStatement(responseDelay);
				}
				if (result == null) {
					result = caseAct(responseDelay);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseDelay);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.SCENE_DELAY: {
				...
				if (result == null) {
					result = caseObservation(sceneDelay);
				}
				if (result == null) {
					result = caseClinicalStatement(sceneDelay);
				}
				if (result == null) {
					result = caseAct(sceneDelay);
				}
				if (result == null) {
					result = caseInfrastructureRoot(sceneDelay);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.TRANSPORT_DELAY: {
				...
				if (result == null) {
					result = caseObservation(transportDelay);
				}
				if (result == null) {
					result = caseClinicalStatement(transportDelay);
				}
				if (result == null) {
					result = caseAct(transportDelay);
				}
				if (result == null) {
					result = caseInfrastructureRoot(transportDelay);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.TURNAROUND_DELAY: {
				...
				if (result == null) {
					result = caseObservation(turnaroundDelay);
				}
				if (result == null) {
					result = caseClinicalStatement(turnaroundDelay);
				}
				if (result == null) {
					result = caseAct(turnaroundDelay);
				}
				if (result == null) {
					result = caseInfrastructureRoot(turnaroundDelay);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_BEGINNING_ODOMETER_READING: {
				...
				if (result == null) {
					result = caseObservation(responseBeginningOdometerReading);
				}
				if (result == null) {
					result = caseClinicalStatement(responseBeginningOdometerReading);
				}
				if (result == null) {
					result = caseAct(responseBeginningOdometerReading);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseBeginningOdometerReading);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_ON_SCENE_ODOMETER_READING: {
				...
				if (result == null) {
					result = caseObservation(responseOnSceneOdometerReading);
				}
				if (result == null) {
					result = caseClinicalStatement(responseOnSceneOdometerReading);
				}
				if (result == null) {
					result = caseAct(responseOnSceneOdometerReading);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseOnSceneOdometerReading);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_DESTINATION_ODOMETER_READING: {
				...
				if (result == null) {
					result = caseObservation(responseDestinationOdometerReading);
				}
				if (result == null) {
					result = caseClinicalStatement(responseDestinationOdometerReading);
				}
				if (result == null) {
					result = caseAct(responseDestinationOdometerReading);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseDestinationOdometerReading);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.RESPONSE_ENDING_ODOMETER_READING: {
				...
				if (result == null) {
					result = caseObservation(responseEndingOdometerReading);
				}
				if (result == null) {
					result = caseClinicalStatement(responseEndingOdometerReading);
				}
				if (result == null) {
					result = caseAct(responseEndingOdometerReading);
				}
				if (result == null) {
					result = caseInfrastructureRoot(responseEndingOdometerReading);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Billing Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Billing Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseBillingSection(BillingSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Current Medication Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Current Medication Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseCurrentMedicationSection(CurrentMedicationSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Cardiac Arrest Event Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Cardiac Arrest Event Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseCardiacArrestEventSection(CardiacArrestEventSection object) {
		return null;
	}

	/**
	* Returns the result of interpreting the object as an instance of '<em>Cardiac Arrest Existence</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Cardiac Arrest Existence</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseCardiacArrestExistence(CardiacArrestExistence object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Advanced Directive Observation</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Advanced Directive Observation</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseAdvancedDirectiveObservation(AdvancedDirectiveObservation object) {
		return null;
	}

	/**
	* Returns the result of interpreting the object as an instance of '<em>Allergies And Adverse Reactions Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Allergies And Adverse Reactions Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseAllergiesAndAdverseReactionsSection(AllergiesAndAdverseReactionsSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Drug Allergy Problem Act</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Drug Allergy Problem Act</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseDrugAllergyProblemAct(DrugAllergyProblemAct object) {
		return null;
	}

	/**
	* Returns the result of interpreting the object as an instance of '<em>Environmental Allergies</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Environmental Allergies</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseEnvironmentalAllergies(EnvironmentalAllergies object) {
		return null;
	}

	/**
	* Returns the result of interpreting the object as an instance of '<em>Existence Of Environmental Allergy</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Existence Of Environmental Allergy</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseExistenceOfEnvironmentalAllergy(ExistenceOfEnvironmentalAllergy object) {
		return null;
	}

	/**
	* Returns the result of interpreting the object as an instance of '<em>Environmental Allergy</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Environmental Allergy</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseEnvironmentalAllergy(EnvironmentalAllergy object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>History Of Procedures Organizer</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>History Of Procedures Organizer</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseHistoryOfProceduresOrganizer(HistoryOfProceduresOrganizer object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Physical Assessment Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Physical Assessment Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T casePhysicalAssessmentSection(PhysicalAssessmentSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Procedures Performed Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Procedures Performed Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseProceduresPerformedSection(ProceduresPerformedSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Patient Care Narrative Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Patient Care Narrative Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T casePatientCareNarrativeSection(PatientCareNarrativeSection object) {
		return null;
	}

	/**
	* Returns the result of interpreting the object as an instance of '<em>Scene Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Scene Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseSceneSection(SceneSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Dispatch Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Dispatch Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseDispatchSection(DispatchSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Disposition Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Disposition Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseDispositionSection(DispositionSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Number Of Patients Observation</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Number Of Patients Observation</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseNumberOfPatientsObservation(NumberOfPatientsObservation object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Personnel Adverse Event Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Personnel Adverse Event Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T casePersonnelAdverseEventSection(PersonnelAdverseEventSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Protocol Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Protocol Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseProtocolSection(ProtocolSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Response Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Response Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseResponseSection(ResponseSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Situation Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Situation Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseSituationSection(SituationSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Unit At Patientt Time</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Unit At Patientt Time</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseUnitAtPatienttTime(UnitAtPatienttTime object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Injury Incident Description Section</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Injury Incident Description Section</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseInjuryIncidentDescriptionSection(InjuryIncidentDescriptionSection object) {
		return null;
	}
	...
	*/
	...
	/**
	* Returns the result of interpreting the object as an instance of '<em>Existence Of History Of Procedures</em>'.
	* <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	* @param object the target of the switch.
	* @return the result of interpreting the object as an instance of '<em>Existence Of History Of Procedures</em>'.
	* @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	* @generated
	*/
	public T caseExistenceOfHistoryOfProcedures(ExistenceOfHistoryOfProcedures object) {
		return null;
	}
	...
	* @generated
	*/
	public T caseConsol_VitalSignsSection(org.openhealthtools.mdht.uml.cda.consol.VitalSignsSection object) {
		return null;
	}
