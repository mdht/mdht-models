...
public class EmspcrSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmspcrPackage.CARDIAC_ARREST: {
				...
				if (result == null) {
					result = caseObservation(cardiacArrest);
				}
				if (result == null) {
					result = caseClinicalStatement(cardiacArrest);
				}
				if (result == null) {
					result = caseAct(cardiacArrest);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacArrest);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NON_DRUG_ALLERGY_ORGANIZER: {
				...
				if (result == null) {
					result = caseOrganizer(nonDrugAllergyOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(nonDrugAllergyOrganizer);
				}
				if (result == null) {
					result = caseAct(nonDrugAllergyOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(nonDrugAllergyOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EXISTENCE_OF_NON_DRUG_ALLERGY: {
				...
				if (result == null) {
					result = caseObservation(existenceOfNonDrugAllergy);
				}
				if (result == null) {
					result = caseClinicalStatement(existenceOfNonDrugAllergy);
				}
				if (result == null) {
					result = caseAct(existenceOfNonDrugAllergy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(existenceOfNonDrugAllergy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NON_DRUG_ALLERGY: {
				...
				if (result == null) {
					result = caseObservation(nonDrugAllergy);
				}
				if (result == null) {
					result = caseClinicalStatement(nonDrugAllergy);
				}
				if (result == null) {
					result = caseAct(nonDrugAllergy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(nonDrugAllergy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NUMBER_OF_PATIENTS_TRANSPORTED_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(numberOfPatientsTransportedObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(numberOfPatientsTransportedObservation);
				}
				if (result == null) {
					result = caseAct(numberOfPatientsTransportedObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(numberOfPatientsTransportedObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.UNIT_AT_PATIENT_TIME: {
				...
				if (result == null) {
					result = caseObservation(unitAtPatientTime);
				}
				if (result == null) {
					result = caseClinicalStatement(unitAtPatientTime);
				}
				if (result == null) {
					result = caseAct(unitAtPatientTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(unitAtPatientTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EMS_DRUG_ALLERGY: {
				EMSDrugAllergy emsDrugAllergy = (EMSDrugAllergy) theEObject;
				T result = caseEMSDrugAllergy(emsDrugAllergy);
				if (result == null) {
					result = caseCDA_Act(emsDrugAllergy);
				}
				if (result == null) {
					result = caseClinicalStatement(emsDrugAllergy);
				}
				if (result == null) {
					result = caseAct(emsDrugAllergy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(emsDrugAllergy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.CARDIAC_ARREST_WITH_TIMING: {
				...
				if (result == null) {
					result = caseObservation(cardiacArrestWithTiming);
				}
				if (result == null) {
					result = caseClinicalStatement(cardiacArrestWithTiming);
				}
				if (result == null) {
					result = caseAct(cardiacArrestWithTiming);
				}
				if (result == null) {
					result = caseInfrastructureRoot(cardiacArrestWithTiming);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.NON_DRUG_ALLERGY_ORGANIZER_ACTUALLY_DREG: {
				NonDrugAllergyOrganizerActuallyDreg nonDrugAllergyOrganizerActuallyDreg = (NonDrugAllergyOrganizerActuallyDreg) theEObject;
				T result = caseNonDrugAllergyOrganizerActuallyDreg(nonDrugAllergyOrganizerActuallyDreg);
				if (result == null) {
					result = caseOrganizer(nonDrugAllergyOrganizerActuallyDreg);
				}
				if (result == null) {
					result = caseClinicalStatement(nonDrugAllergyOrganizerActuallyDreg);
				}
				if (result == null) {
					result = caseAct(nonDrugAllergyOrganizerActuallyDreg);
				}
				if (result == null) {
					result = caseInfrastructureRoot(nonDrugAllergyOrganizerActuallyDreg);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EMS_DRUG_ALLERGY_ORGANIZER: {
				EMSDrugAllergyOrganizer emsDrugAllergyOrganizer = (EMSDrugAllergyOrganizer) theEObject;
				T result = caseEMSDrugAllergyOrganizer(emsDrugAllergyOrganizer);
				if (result == null) {
					result = caseOrganizer(emsDrugAllergyOrganizer);
				}
				if (result == null) {
					result = caseClinicalStatement(emsDrugAllergyOrganizer);
				}
				if (result == null) {
					result = caseAct(emsDrugAllergyOrganizer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(emsDrugAllergyOrganizer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EMS Drug Allergy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EMS Drug Allergy</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEMSDrugAllergy(EMSDrugAllergy object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Non Drug Allergy Organizer Actually Dreg</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Non Drug Allergy Organizer Actually Dreg</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNonDrugAllergyOrganizerActuallyDreg(NonDrugAllergyOrganizerActuallyDreg object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>EMS Drug Allergy Organizer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EMS Drug Allergy Organizer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEMSDrugAllergyOrganizer(EMSDrugAllergyOrganizer object) {
		return null;
	}
