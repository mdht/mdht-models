...
public class CardiacArrestExistenceOperations extends ClinicalStatementOperations {
	...
	public static boolean validateCardiacArrestExistenceCardiacArrestCauseRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_CARDIAC_ARREST_CAUSE_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateCardiacArrestExistenceCardiacArrestInformantParticipation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_CARDIAC_ARREST_INFORMANT_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	public static boolean validateCardiacArrestExistencePriorCPRRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_PRIOR_CPR_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	...
	public static boolean validateCardiacArrestExistencePriorAEDRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_PRIOR_AED_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCardiacArrestExistenceSpontaneousCirculationRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_SPONTANEOUS_CIRCULATION_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	public static boolean validateCardiacArrestExistenceDestinationRhythmRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_DESTINATION_RHYTHM_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCardiacArrestExistenceArrestRhythmRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_CARDIAC_ARREST_EXISTENCE_ARREST_RHYTHM_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCardiacArrestExistenceTemplateId(CardiacArrestExistence cardiacArrestExistence,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EXISTENCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	...
	public static boolean validateCardiacArrestExistenceCode(CardiacArrestExistence cardiacArrestExistence,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EXISTENCE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCardiacArrestExistenceEffectiveTime(CardiacArrestExistence cardiacArrestExistence,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EXISTENCE_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	...
	public static boolean validateCardiacArrestExistenceValue(CardiacArrestExistence cardiacArrestExistence,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EXISTENCE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCardiacArrestExistenceNegationInd(CardiacArrestExistence cardiacArrestExistence,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EXISTENCE_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.WARNING, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCardiacArrestExistenceMoodCode(CardiacArrestExistence cardiacArrestExistence,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_EXISTENCE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			cardiacArrestExistence)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
