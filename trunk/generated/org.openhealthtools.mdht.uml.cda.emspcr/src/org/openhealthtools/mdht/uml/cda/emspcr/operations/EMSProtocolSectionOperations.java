...
"value.code = '67537-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSProtocolSectionCode"),
             new Object [] { emsProtocolSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSProtocolSectionTitle"),
             new Object [] { emsProtocolSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSProtocolSectionText"),
             new Object [] { emsProtocolSection }));
      }
   ...
   * @ordered
   */
  protected static final String VALIDATE_EMS_PROTOCOL_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSProtocolSection::DerivedEntry))";
  ...
  public static  boolean validateEMSProtocolSectionEntry1(EMSProtocolSection emsProtocolSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_PROTOCOL_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsProtocolSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSProtocolSectionEntry1"),
             new Object [] { emsProtocolSection }));
      }
  ...
  /**
   * The cached OCL expression body for the '{@link #validateEMSProtocolSectionEntry2(EMSProtocolSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Protocol Section Entry2</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateEMSProtocolSectionEntry2(EMSProtocolSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_EMS_PROTOCOL_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSProtocolSection::DerivedEntry))";

  /**
   * The cached OCL invariant for the '{@link #validateEMSProtocolSectionEntry2(EMSProtocolSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate EMS Protocol Section Entry2</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateEMSProtocolSectionEntry2(EMSProtocolSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_EMS_PROTOCOL_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateEMSProtocolSectionEntry2(EMSProtocolSection emsProtocolSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_EMS_PROTOCOL_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(EmspcrPackage.Literals.EMS_PROTOCOL_SECTION);
      try
      {
        VALIDATE_EMS_PROTOCOL_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_EMS_PROTOCOL_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_PROTOCOL_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsProtocolSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             EmspcrValidator.DIAGNOSTIC_SOURCE,
             EmspcrValidator.EMS_PROTOCOL_SECTION__EMS_PROTOCOL_SECTION_ENTRY2,
             EmspcrPlugin.INSTANCE.getString("EMSProtocolSectionEntry2"),
             new Object [] { emsProtocolSection }));
      }
   ...
   * @ordered
   */
  protected static final String VALIDATE_EMS_PROTOCOL_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSProtocolSection::DerivedEntry))";
  ...
  public static  boolean validateEMSProtocolSectionEntry3(EMSProtocolSection emsProtocolSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_PROTOCOL_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsProtocolSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             EmspcrPlugin.INSTANCE.getString("EMSProtocolSectionEntry3"),
             new Object [] { emsProtocolSection }));
      }
