...
public class EmspcrFactoryImpl extends EFactoryImpl implements EmspcrFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EmspcrPackage.BILLING_SECTION: return createBillingSection();
			...
			case EmspcrPackage.CURRENT_MEDICATION_SECTION: return createCurrentMedicationSection();
			...
			case EmspcrPackage.CARDIAC_ARREST_EVENT_SECTION: return createCardiacArrestEventSection();
			case EmspcrPackage.CARDIAC_ARREST_EXISTENCE: return createCardiacArrestExistence();
			case EmspcrPackage.ADVANCE_DIRECTIVES_SECTION: return createAdvanceDirectivesSection();
			case EmspcrPackage.ADVANCED_DIRECTIVE_OBSERVATION: return createAdvancedDirectiveObservation();
			case EmspcrPackage.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION: return createAllergiesAndAdverseReactionsSection();
			case EmspcrPackage.EXISTENCE_OF_DRUG_ALLERGY_OBSERVATION: return createExistenceOfDrugAllergyObservation();
			case EmspcrPackage.DRUG_ALLERGY_PROBLEM_ACT: return createDrugAllergyProblemAct();
			case EmspcrPackage.ENVIRONMENTAL_ALLERGIES: return createEnvironmentalAllergies();
			case EmspcrPackage.EXISTENCE_OF_ENVIRONMENTAL_ALLERGY: return createExistenceOfEnvironmentalAllergy();
			case EmspcrPackage.ENVIRONMENTAL_ALLERGY: return createEnvironmentalAllergy();
			case EmspcrPackage.PAST_MEDICAL_HISTORY_SECTION: return createPastMedicalHistorySection();
			...
			case EmspcrPackage.HISTORY_OF_PROCEDURES_ORGANIZER: return createHistoryOfProceduresOrganizer();
			case EmspcrPackage.SOCIAL_HISTORY_SECTION: return createSocialHistorySection();
			...
			case EmspcrPackage.PHYSICAL_ASSESSMENT_SECTION: return createPhysicalAssessmentSection();
			...
			case EmspcrPackage.MEDICATIONS_ADMINISTERED_SECTION: return createMedicationsAdministeredSection();
			case EmspcrPackage.MEDICATION_ADMINISTERED: return createMedicationAdministered();
			case EmspcrPackage.PROCEDURES_PERFORMED_SECTION: return createProceduresPerformedSection();
			case EmspcrPackage.PROCEDURE: return createProcedure();
			case EmspcrPackage.PATIENT_CARE_NARRATIVE_SECTION: return createPatientCareNarrativeSection();
			case EmspcrPackage.SCENE_SECTION: return createSceneSection();
			...
			case EmspcrPackage.DISPATCH_SECTION: return createDispatchSection();
			...
			case EmspcrPackage.DISPOSITION_SECTION: return createDispositionSection();
			case EmspcrPackage.TRANSPORT_METHOD_OBSERVATION: return createTransportMethodObservation();
			case EmspcrPackage.NUMBER_OF_PATIENTS_OBSERVATION: return createNumberOfPatientsObservation();
			...
			case EmspcrPackage.PERSONNEL_ADVERSE_EVENT_SECTION: return createPersonnelAdverseEventSection();
			...
			case EmspcrPackage.PROTOCOL_SECTION: return createProtocolSection();
			...
			case EmspcrPackage.RESPONSE_SECTION: return createResponseSection();
			...
			case EmspcrPackage.SITUATION_SECTION: return createSituationSection();
			...
			case EmspcrPackage.UNIT_AT_PATIENTT_TIME: return createUnitAtPatienttTime();
			...
			case EmspcrPackage.VITAL_SIGNS_SECTION: return createVitalSignsSection();
			...
			case EmspcrPackage.INJURY_INCIDENT_DESCRIPTION_SECTION: return createInjuryIncidentDescriptionSection();
			...
			case EmspcrPackage.EXISTENCE_OF_HISTORY_OF_PROCEDURES: return createExistenceOfHistoryOfProcedures();
