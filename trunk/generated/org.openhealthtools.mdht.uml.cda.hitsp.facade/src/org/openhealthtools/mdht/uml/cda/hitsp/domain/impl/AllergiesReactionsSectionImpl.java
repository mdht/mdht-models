 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.AllergiesReactionsSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AllergiesReactionsSectionImpl extends EObjectImpl implements IAllergiesReactionsSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getAllergiesReactionsSection();
	}
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getAllergiesReactionsSection(), IDomainPackage.eINSTANCE.getAllergiesReactionsSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IAllergiesReactionsSection setTitle(ST value) {
		this.getCDAType().setTitle(value);
		return this;
	}
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getAllergiesReactionsSection(), IDomainPackage.eINSTANCE.getAllergiesReactionsSection().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IAllergiesReactionsSection setText(StrucDocText value) {
		this.getCDAType().setText(value);
		return this;
	}

	/**
	 * The cached OCL expression body for the '{@link #getAllergyDrugSensitivities() <em>Get Allergy Drug Sensitivities</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllergyDrugSensitivities()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_ALLERGY_DRUG_SENSITIVITIES__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(domain::AllergyDrugSensitivity)).oclAsType(domain::AllergyDrugSensitivity)";

	/**
	 * The cached OCL query for the '{@link #getAllergyDrugSensitivities() <em>Get Allergy Drug Sensitivities</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllergyDrugSensitivities()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<IAllergyDrugSensitivity> getAllergyDrugSensitivities() {
		if (GET_ALLERGY_DRUG_SENSITIVITIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getAllergiesReactionsSection(), IDomainPackage.eINSTANCE.getAllergiesReactionsSection().getEAllOperations().get(6));
			try {
		...
		Collection<IAllergyDrugSensitivity> result = (Collection<IAllergyDrugSensitivity>) query.evaluate(this);
		return new BasicEList.UnmodifiableEList<IAllergyDrugSensitivity>(result.size(), result.toArray());
	}
	 ...
	 * @generated
	 */
	public IAllergyDrugSensitivity addAllergyDrugSensitivity() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("AllergyDrugSensitivity");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
		...
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("AllergyDrugSensitivity");
		IAllergyDrugSensitivity value = (IAllergyDrugSensitivity)domainFactory.create(domainEClass);
	 ...
	 * @generated
	 */
	public IAllergiesReactionsSection addAllergyDrugSensitivity(IAllergyDrugSensitivity value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.ALLERGIES_REACTIONS_SECTION__CDA_TYPE:
