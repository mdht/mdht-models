 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.SeverityImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SeverityImpl extends EObjectImpl implements ISeverity {
	...
	public ED getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSeverity(),
				IDomainPackage.eINSTANCE.getSeverity().getEAllOperations().get(0));
			try {
	...
	public CD getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSeverity(),
				IDomainPackage.eINSTANCE.getSeverity().getEAllOperations().get(3));
			try {
