 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.ReviewOfSystemsSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReviewOfSystemsSectionImpl extends EObjectImpl implements IReviewOfSystemsSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getReviewOfSystemsSection();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.REVIEW_OF_SYSTEMS_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
