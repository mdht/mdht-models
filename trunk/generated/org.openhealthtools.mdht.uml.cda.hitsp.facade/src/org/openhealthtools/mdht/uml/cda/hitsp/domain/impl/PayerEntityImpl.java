...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.IPayerEntity;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.PayerEntityImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PayerEntityImpl extends EObjectImpl implements IPayerEntity {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getPayerEntity();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPayerEntity(),
				IDomainPackage.eINSTANCE.getPayerEntity().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IPayerEntity addId(II value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.PAYER_ENTITY__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
