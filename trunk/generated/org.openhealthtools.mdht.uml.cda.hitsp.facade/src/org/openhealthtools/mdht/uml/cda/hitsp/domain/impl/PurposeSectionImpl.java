...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.IPurposeActivity;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.PurposeSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PurposeSectionImpl extends EObjectImpl implements IPurposeSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getPurposeSection();
	}
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPurposeSection(),
				IDomainPackage.eINSTANCE.getPurposeSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IPurposeSection setTitle(ST value) {
		this.getCDAType().setTitle(value);
		return this;
	}
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPurposeSection(),
				IDomainPackage.eINSTANCE.getPurposeSection().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IPurposeSection setText(StrucDocText value) {
		this.getCDAType().setText(value);
		return this;
	}

	/**
	 * The cached OCL expression body for the '{@link #getPurposeActivities() <em>Get Purpose Activities</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPurposeActivities()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_PURPOSE_ACTIVITIES__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(domain::PurposeActivity)).oclAsType(domain::PurposeActivity)";

	/**
	 * The cached OCL query for the '{@link #getPurposeActivities() <em>Get Purpose Activities</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPurposeActivities()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<IPurposeActivity> getPurposeActivities() {
		if (GET_PURPOSE_ACTIVITIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPurposeSection(),
				IDomainPackage.eINSTANCE.getPurposeSection().getEAllOperations().get(6));
			try {
		...
		Collection<IPurposeActivity> result = (Collection<IPurposeActivity>) query.evaluate(this);
		return new BasicEList.UnmodifiableEList<IPurposeActivity>(result.size(), result.toArray());
	}
	 ...
	 * @generated
	 */
	public IPurposeActivity addPurposeActivity() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("PurposeActivity");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
		...
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("PurposeActivity");
		IPurposeActivity value = (IPurposeActivity) domainFactory.create(domainEClass);
	 ...
	 * @generated
	 */
	public IPurposeSection addPurposeActivity(IPurposeActivity value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.PURPOSE_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
