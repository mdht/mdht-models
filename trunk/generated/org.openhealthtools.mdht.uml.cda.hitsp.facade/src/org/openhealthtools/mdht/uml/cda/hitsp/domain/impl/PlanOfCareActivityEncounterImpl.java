 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.PlanOfCareActivityEncounterImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPlanOfCareActivityEncounter(),
				IDomainPackage.eINSTANCE.getPlanOfCareActivityEncounter().getEAllOperations().get(0));
			try {
