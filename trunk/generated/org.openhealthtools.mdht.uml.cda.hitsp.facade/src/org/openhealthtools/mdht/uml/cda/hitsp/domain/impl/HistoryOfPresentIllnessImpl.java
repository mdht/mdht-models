 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.HistoryOfPresentIllnessImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HistoryOfPresentIllnessImpl extends EObjectImpl implements IHistoryOfPresentIllness {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getHistoryOfPresentIllness();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.HISTORY_OF_PRESENT_ILLNESS__CDA_TYPE:
