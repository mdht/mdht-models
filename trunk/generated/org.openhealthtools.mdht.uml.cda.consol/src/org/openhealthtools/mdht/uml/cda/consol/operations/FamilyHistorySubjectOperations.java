...
public class FamilyHistorySubjectOperations extends SubjectOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_FAMILY_HISTORY_SUBJECT_RELATED_SUBJECT_SUBJECT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.relatedSubject.subject.sDTCId->size() > 0";
	...
	public static  boolean validateFamilyHistorySubjectRelatedSubjectSubjectId(FamilyHistorySubject familyHistorySubject, DiagnosticChain diagnostics, Map<Object, Object> context) {
