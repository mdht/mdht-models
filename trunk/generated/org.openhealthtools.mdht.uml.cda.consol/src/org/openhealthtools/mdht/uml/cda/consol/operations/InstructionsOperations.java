...
public class InstructionsOperations extends ClinicalStatementOperations {
	...
	public static boolean validateInstructionsTextReference(Instructions instructions, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_TEXT_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(instructions)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsTextReference"),
	...
	* <!-- end-user-doc -->
	...
	public static boolean validateInstructionsReferenceValue(Instructions instructions, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_REFERENCE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(instructions)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsReferenceValue"),
						 new Object [] { instructions }));
			}
	...
	public static boolean validateInstructionsTextReferenceValue(Instructions instructions,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_TEXT_REFERENCE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(instructions)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsTextReferenceValue"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsTemplateId"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsClassCode"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsMoodCode"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsCodeP"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsCode"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsText"),
						 new Object [] { instructions }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("InstructionsStatusCode"),
						 new Object [] { instructions }));
			}
