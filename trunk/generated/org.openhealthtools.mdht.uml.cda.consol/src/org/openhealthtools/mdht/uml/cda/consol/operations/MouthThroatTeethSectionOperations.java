...
public class MouthThroatTeethSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MOUTH_THROAT_TEETH_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::AllergyIntolerance))";
	 ...
	 * @generated
	 */
	public static AllergyIntolerance getProblemEntry(MouthThroatTeethSection mouthThroatTeethSection) {
		...
		return (AllergyIntolerance) query.evaluate(mouthThroatTeethSection);
	}
