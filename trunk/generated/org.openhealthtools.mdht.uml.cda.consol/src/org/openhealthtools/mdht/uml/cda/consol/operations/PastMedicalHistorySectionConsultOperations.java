 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.PastMedicalHistorySectionConsult#validatePastMedicalHistorySectionConsultTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Past Medical History Section Consult Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.PastMedicalHistorySectionConsult#validatePastMedicalHistorySectionConsultCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Past Medical History Section Consult Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.PastMedicalHistorySectionConsult#validatePastMedicalHistorySectionConsultText(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Past Medical History Section Consult Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PastMedicalHistorySectionConsultOperations extends SectionOperations {
	...
	public static boolean validatePastMedicalHistorySectionConsultTemplateId(
		...
		if (VALIDATE_PAST_MEDICAL_HISTORY_SECTION_CONSULT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.PAST_MEDICAL_HISTORY_SECTION_CONSULT);
			try {
		...
		if (!EOCL_ENV.createQuery(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.PAST_MEDICAL_HISTORY_SECTION_CONSULT__PAST_MEDICAL_HISTORY_SECTION_CONSULT_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("PastMedicalHistorySectionConsultTemplateId"),
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PAST_MEDICAL_HISTORY_SECTION_CONSULT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.PAST_MEDICAL_HISTORY_SECTION_CONSULT__PAST_MEDICAL_HISTORY_SECTION_CONSULT_CODE,
					ConsolPlugin.INSTANCE.getString("PastMedicalHistorySectionConsultCode"),
					new Object[] { pastMedicalHistorySectionConsult }));
			}
			return false;
		}
	...
	public static boolean validatePastMedicalHistorySectionConsultText(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PAST_MEDICAL_HISTORY_SECTION_CONSULT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PAST_MEDICAL_HISTORY_SECTION_CONSULT__PAST_MEDICAL_HISTORY_SECTION_CONSULT_TEXT,
					ConsolPlugin.INSTANCE.getString("PastMedicalHistorySectionConsultText"),
					new Object[] { pastMedicalHistorySectionConsult }));
			}
			return false;
		}
