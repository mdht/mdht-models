...
public class PurposeSectionOperations extends SectionOperations {
	...
	public static boolean validatePurposeSectionTemplateId(PurposeSection purposeSection, DiagnosticChain diagnostics,
		...
		if (VALIDATE_PURPOSE_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.PURPOSE_SECTION);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PURPOSE_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.PURPOSE_SECTION__PURPOSE_SECTION_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("PurposeSectionTemplateId"), new Object[] { purposeSection }));
			}
			return false;
		}
		return true;
	...
	public static boolean validatePurposeSectionCode(PurposeSection purposeSection, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PURPOSE_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(purposeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PURPOSE_SECTION__PURPOSE_SECTION_CODE,
					ConsolPlugin.INSTANCE.getString("PurposeSectionCode"), new Object[] { purposeSection }));
			}
			return false;
		}
		return true;
	...
	public static boolean validatePurposeSectionTitle(PurposeSection purposeSection, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PURPOSE_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(purposeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PURPOSE_SECTION__PURPOSE_SECTION_TITLE,
					ConsolPlugin.INSTANCE.getString("PurposeSectionTitle"), new Object[] { purposeSection }));
			}
			return false;
		}
		return true;
	...
	public static boolean validatePurposeSectionText(PurposeSection purposeSection, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PURPOSE_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(purposeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PURPOSE_SECTION__PURPOSE_SECTION_TEXT,
					ConsolPlugin.INSTANCE.getString("PurposeSectionText"), new Object[] { purposeSection }));
			}
			return false;
		}
		return true;
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PURPOSE_SECTION_PURPOSE_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->exists(entry : cda::Entry | not entry.act.oclIsUndefined() and entry.act.oclIsKindOf(consol::PurposeActivity))";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.entry->exists(entry : cda::Entry | not entry.act.oclIsUndefined() and entry.act.oclIsKindOf(consol::PurposeActivity))
	 * @param purposeSection The receiving '<em><b>Purpose Section</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PURPOSE_SECTION_PURPOSE_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.PURPOSE_SECTION__PURPOSE_SECTION_PURPOSE_ACTIVITY,
					ConsolPlugin.INSTANCE.getString("PurposeSectionPurposeActivity"), new Object[] { purposeSection }));
			}
			return false;
		}
		return true;
	 ...
	 * @ordered
	 */
	protected static final String GET_PURPOSE_ACTIVITIES__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PurposeActivity)).oclAsType(consol::PurposeActivity)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PurposeActivity)).oclAsType(consol::PurposeActivity)
	 * @param purposeSection The receiving '<em><b>Purpose Section</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
	public static EList<PurposeActivity> getPurposeActivities(PurposeSection purposeSection) {
		if (GET_PURPOSE_ACTIVITIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PURPOSE_SECTION,
				ConsolPackage.Literals.PURPOSE_SECTION.getEAllOperations().get(60));
			try {
