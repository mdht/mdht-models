...
public class PreoperativeDiagnosisOperations extends ClinicalStatementOperations {
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREOPERATIVE_DIAGNOSIS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(preoperativeDiagnosis))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREOPERATIVE_DIAGNOSIS_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(preoperativeDiagnosis))
    {
      if (diagnostics != null)
      {
        diagnostics.add
...
"value.code = '10219-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREOPERATIVE_DIAGNOSIS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(preoperativeDiagnosis))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREOPERATIVE_DIAGNOSIS_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(preoperativeDiagnosis))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * self.entryRelationship->one(entryRelationship : cda::EntryRelationship | not entryRelationship.observation.oclIsUndefined() and entryRelationship.observation.oclIsKindOf(consol::ProblemObservation) and entryRelationship.typeCode = vocab::x_ActRelationshipEntryRelationship::SUBJ)
   * @param preoperativeDiagnosis The receiving '<em><b>Preoperative Diagnosis</b></em>' model object.
   * @param diagnostics The chain of diagnostics to which problems are to be appended.
   * @param context The cache of context-specific information.
   * <!-- end-model-doc -->
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREOPERATIVE_DIAGNOSIS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(preoperativeDiagnosis))
    {
      if (diagnostics != null)
      {
        diagnostics.add
	...
	/**
   * The cached OCL expression body for the '{@link #getProblemObservation(PreoperativeDiagnosis) <em>Get Problem Observation</em>}' operation.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #getProblemObservation(PreoperativeDiagnosis)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL query for the '{@link #getProblemObservation(PreoperativeDiagnosis) <em>Get Problem Observation</em>}' query operation.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #getProblemObservation(PreoperativeDiagnosis)
   * @generated
   ...
   * @generated
   */
	public static ProblemObservation getProblemObservation(PreoperativeDiagnosis preoperativeDiagnosis) {
    if (GET_PROBLEM_OBSERVATION__EOCL_QRY == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(ConsolPackage.Literals.PREOPERATIVE_DIAGNOSIS, ConsolPackage.Literals.PREOPERATIVE_DIAGNOSIS.getEAllOperations().get(56));
      try
      {
    ...
    return (ProblemObservation) query.evaluate(preoperativeDiagnosis);
  }
