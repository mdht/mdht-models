 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='PostprocedureDiagnosisSectionTemplateId PostprocedureDiagnosisSectionCode PostprocedureDiagnosisSectionText PostprocedureDiagnosisSectionTitle' templateId.root='2.16.840.1.113883.10.20.22.2.36' code.codeSystem='2.16.840.1.113883.6.1' code.displayName='Postprocedure Diagnosis' code.codeSystemName='LOINC' code.code='59769-0' constraints.validation.warning='PostprocedureDiagnosisSectionPostprocedureDiagnosis'"
 * @generated
 */
public interface PostprocedureDiagnosisSection extends Section {
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PostprocedureDiagnosis))->asSequence()->first().oclAsType(consol::PostprocedureDiagnosis)'"
	 * @generated
	 */
