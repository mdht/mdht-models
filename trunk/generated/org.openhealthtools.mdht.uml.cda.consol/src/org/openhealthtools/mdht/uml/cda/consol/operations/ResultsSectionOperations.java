				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("ResultsSectionCodeP"),
...
"value.code = '30954-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateResultsSectionCode(ResultsSection resultsSection, DiagnosticChain diagnostics,
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.consol.ResultsSectionCodeP");
	...
	public static EList<ResultOrganizer> getConsolResultOrganizers(ResultsSection resultsSection) {
		if (GET_CONSOL_RESULT_ORGANIZERS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.RESULTS_SECTION, ConsolPackage.Literals.RESULTS_SECTION.getEAllOperations().get(67));
			try {
