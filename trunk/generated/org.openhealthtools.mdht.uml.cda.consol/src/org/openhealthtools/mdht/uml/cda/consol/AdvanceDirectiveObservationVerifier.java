 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='i. 2.16.840.1.113883.10.20.1.58' constraints.validation.error='AdvanceDirectiveObservationVerifierParticipantRole AdvanceDirectiveObservationVerifierTemplateId AdvanceDirectiveObservationVerifierTime AdvanceDirectiveObservationVerifierTypeCode' typeCode='VRF'"
 * @generated
 */
public interface AdvanceDirectiveObservationVerifier extends Participant2 {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'i. 2.16.840.1.113883.10.20.1.58\')'"
	 * @generated
	 */
