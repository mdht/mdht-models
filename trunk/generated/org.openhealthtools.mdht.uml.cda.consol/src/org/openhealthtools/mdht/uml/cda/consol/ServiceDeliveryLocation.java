 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation classCode='SDLOC' code.codeSystemName='LOINC' constraints.validation.info='ServiceDeliveryLocationHasPlayingEntity' templateId.root='2.16.840.1.113883.10.20.22.4.32' constraints.validation.error='ServiceDeliveryLocationTemplateId ServiceDeliveryLocationHasPlayingEntityClassCode ServiceDeliveryLocationClassCode ServiceDeliveryLocationCode' code.codeSystem='2.16.840.1.113883.6.1' constraints.validation.warning='ServiceDeliveryLocationAddr ServiceDeliveryLocationTelecom'"
 * @generated
 */
public interface ServiceDeliveryLocation extends ParticipantRole {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.playingEntity->size() > 0'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='not self.classCode.oclIsUndefined() and self.classCode.oclIsKindOf(vocab::RoleClassRoot)'"
	 * @generated
	 */
