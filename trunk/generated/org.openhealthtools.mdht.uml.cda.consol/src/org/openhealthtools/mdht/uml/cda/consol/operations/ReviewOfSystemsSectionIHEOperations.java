 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ReviewOfSystemsSectionIHE#validateReviewOfSystemsSectionIHETemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Review Of Systems Section IHE Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ReviewOfSystemsSectionIHE#validateReviewOfSystemsSectionIHECode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Review Of Systems Section IHE Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReviewOfSystemsSectionIHEOperations extends SectionOperations {
	 ...
	 * @generated
	 */
	public static boolean validateReviewOfSystemsSectionIHETemplateId(
		...
		if (VALIDATE_REVIEW_OF_SYSTEMS_SECTION_IHE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.REVIEW_OF_SYSTEMS_SECTION_IHE);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_REVIEW_OF_SYSTEMS_SECTION_IHE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.REVIEW_OF_SYSTEMS_SECTION_IHE__REVIEW_OF_SYSTEMS_SECTION_IHE_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("ReviewOfSystemsSectionIHETemplateId"),
	...
	public static boolean validateReviewOfSystemsSectionIHECode(ReviewOfSystemsSectionIHE reviewOfSystemsSectionIHE,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_REVIEW_OF_SYSTEMS_SECTION_IHE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.REVIEW_OF_SYSTEMS_SECTION_IHE__REVIEW_OF_SYSTEMS_SECTION_IHE_CODE,
					ConsolPlugin.INSTANCE.getString("ReviewOfSystemsSectionIHECode"),
					new Object[] { reviewOfSystemsSectionIHE }));
			}
			return false;
		}
