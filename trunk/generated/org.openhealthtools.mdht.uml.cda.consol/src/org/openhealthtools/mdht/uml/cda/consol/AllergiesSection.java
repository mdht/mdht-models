 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystem='2.16.840.1.113883.6.1' code.displayName='Allergies, adverse reactions, alerts' templateId.root='2.16.840.1.113883.10.20.22.2.6.1' constraints.validation.error='AllergiesSectionTemplateId AllergiesSectionCode AllergiesSectionTitle AllergiesSectionText AllergiesSectionAllergyDrugSensitivity' code.codeSystemName='LOINC' code.code='48765-2'"
 * @generated
 */
public interface AllergiesSection extends AllergiesSectionEntriesOptional {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.2.6.1\')'"
	 * @generated
	 */
	boolean validateAllergiesSectionTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	EList<AllergyProblemAct> getnullAllergyDrugSensitivities();
