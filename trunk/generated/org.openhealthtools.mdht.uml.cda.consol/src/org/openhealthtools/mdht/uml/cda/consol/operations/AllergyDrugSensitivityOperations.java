 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.AllergyDrugSensitivity#validateAllergyDrugSensitivityAdvereEventDate(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Allergy Drug Sensitivity Advere Event Date</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.AllergyDrugSensitivity#validateAllergyDrugSensitivityAdvereEventType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Allergy Drug Sensitivity Advere Event Type</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.AllergyDrugSensitivity#validateAllergyDrugSensitivityAdvereEventTypeVocab(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Allergy Drug Sensitivity Advere Event Type Vocab</em>}</li>
...
public class AllergyDrugSensitivityOperations extends ClinicalStatementOperations {
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityEntryRelationshipRequired(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_ENTRY_RELATIONSHIP_REQUIRED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivitySubjectOfTarget(AllergyDrugSensitivity allergyDrugSensitivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_SUBJECT_OF_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityContainsProblemObservation(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_CONTAINS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.WARNING, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityContainsAlertObservation(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_CONTAINS_ALERT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.WARNING, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityContainsPatientAwareness(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_CONTAINS_PATIENT_AWARENESS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityEffectiveTimeLowHigh(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityHasRelatedObservations(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_HAS_RELATED_OBSERVATIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityRelatedObservationsTypeCode(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_RELATED_OBSERVATIONS_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityHasRelatedReferencesTypeCode(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGY_DRUG_SENSITIVITY_HAS_RELATED_REFERENCES_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAllergyDrugSensitivityAdvereEventDate(AllergyDrugSensitivity allergyDrugSensitivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_ADVERE_EVENT_DATE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.WARNING, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ALLERGY_DRUG_SENSITIVITY__ALLERGY_DRUG_SENSITIVITY_ADVERE_EVENT_DATE,
					ConsolPlugin.INSTANCE.getString("AllergyDrugSensitivityAdvereEventDate"),
					new Object[] { allergyDrugSensitivity }));
			}
			return false;
		}
	...
	public static boolean validateAllergyDrugSensitivityAdvereEventType(AllergyDrugSensitivity allergyDrugSensitivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_ADVERE_EVENT_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ALLERGY_DRUG_SENSITIVITY__ALLERGY_DRUG_SENSITIVITY_ADVERE_EVENT_TYPE,
					ConsolPlugin.INSTANCE.getString("AllergyDrugSensitivityAdvereEventType"),
					new Object[] { allergyDrugSensitivity }));
			}
			return false;
		}
	...
	public static boolean validateAllergyDrugSensitivityAdvereEventTypeVocab(
		...
		if (!EOCL_ENV.createQuery(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ALLERGY_DRUG_SENSITIVITY__ALLERGY_DRUG_SENSITIVITY_ADVERE_EVENT_TYPE_VOCAB,
					ConsolPlugin.INSTANCE.getString("AllergyDrugSensitivityAdvereEventTypeVocab"),
					new Object[] { allergyDrugSensitivity }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityClassCode(AllergyDrugSensitivity allergyDrugSensitivity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityMoodCode(AllergyDrugSensitivity allergyDrugSensitivity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityId(AllergyDrugSensitivity allergyDrugSensitivity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityCodeNullFlavor(AllergyDrugSensitivity allergyDrugSensitivity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_CODE_NULL_FLAVOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityEffectiveTime(AllergyDrugSensitivity allergyDrugSensitivity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityEpisodeObservation(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_EPISODE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAllergyDrugSensitivityAllergyIntolerance(
			AllergyDrugSensitivity allergyDrugSensitivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_DRUG_SENSITIVITY_ALLERGY_INTOLERANCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergyDrugSensitivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	...
	public static EpisodeObservation getEpisodeObservation(AllergyDrugSensitivity allergyDrugSensitivity) {
		if (GET_EPISODE_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.ALLERGY_DRUG_SENSITIVITY,
				ConsolPackage.Literals.ALLERGY_DRUG_SENSITIVITY.getEAllOperations().get(86));
			try {
	...
	public static EList<AllergyIntolerance> getAllergyIntolerances(AllergyDrugSensitivity allergyDrugSensitivity) {
		if (GET_ALLERGY_INTOLERANCES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.ALLERGY_DRUG_SENSITIVITY,
				ConsolPackage.Literals.ALLERGY_DRUG_SENSITIVITY.getEAllOperations().get(87));
			try {
