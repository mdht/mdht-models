 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ReasonForVisitSectionConsult#validateReasonForVisitSectionConsultTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Reason For Visit Section Consult Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ReasonForVisitSectionConsult#validateReasonForVisitSectionConsultCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Reason For Visit Section Consult Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReasonForVisitSectionConsultOperations extends SectionOperations {
	...
	public static boolean validateReasonForVisitSectionConsultTemplateId(
		...
		if (VALIDATE_REASON_FOR_VISIT_SECTION_CONSULT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.REASON_FOR_VISIT_SECTION_CONSULT);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_REASON_FOR_VISIT_SECTION_CONSULT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			reasonForVisitSectionConsult)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.REASON_FOR_VISIT_SECTION_CONSULT__REASON_FOR_VISIT_SECTION_CONSULT_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("ReasonForVisitSectionConsultTemplateId"),
	...
	public static boolean validateReasonForVisitSectionConsultCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_REASON_FOR_VISIT_SECTION_CONSULT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			reasonForVisitSectionConsult)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.REASON_FOR_VISIT_SECTION_CONSULT__REASON_FOR_VISIT_SECTION_CONSULT_CODE,
					ConsolPlugin.INSTANCE.getString("ReasonForVisitSectionConsultCode"),
					new Object[] { reasonForVisitSectionConsult }));
			}
			return false;
		}
