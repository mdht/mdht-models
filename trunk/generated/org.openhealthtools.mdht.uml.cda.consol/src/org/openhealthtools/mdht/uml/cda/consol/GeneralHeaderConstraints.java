 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatient raceCode.codeSystem='2.16.840.1.113883.6.238' raceCode.codeSystemName='Race and Ethnicity - CDC' administrativeGenderCode.codeSystemName='AdministrativeGenderCode' religiousAffiliationCode.codeSystem='2.16.840.1.113883.5.1076' maritalStatusCode.codeSystemName='MaritalStatus' constraints.validation.error='PatientBirthTimePreciseToYear PatientAdministrativeGenderCode PatientBirthTime PatientMaritalStatusCode PatientName PatientRaceCode PatientReligiousAffiliationCode' constraints.validation.warning='PatientBirthTimePreciseToDay PatientLanguageCommunication' administrativeGenderCode.codeSystem='2.16.840.1.113883.5.1' maritalStatusCode.codeSystem='2.16.840.1.113883.5.2' religiousAffiliationCode.codeSystemName='ReligiousAffiliation' constraints.validation.info='PatientEthnicGroupCode PatientEthnicGroupCodeP PatientGuardian PatientBirthplace'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientGuardian code.codeSystem='2.16.840.1.113883.5.111' constraints.validation.error='GuardianGuardianPerson' code.codeSystemName='RoleCode' constraints.validation.warning='GuardianAddr GuardianCode GuardianCodeP' constraints.validation.info='GuardianTelecom'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication proficiencyLevelCode.codeSystem='2.16.840.1.113883.5.61' constraints.validation.error='LanguageCommunicationLanguageCode' constraints.validation.warning='LanguageCommunicationProficiencyLevelCode LanguageCommunicationProficiencyLevelCodeP' proficiencyLevelCode.codeSystemName='LanguageAbilityProficiency' constraints.validation.info='LanguageCommunicationPreferenceInd LanguageCommunicationModeCode LanguageCommunicationModeCodeP'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsDataEntererAssignedEntity constraints.validation.error='AssignedEntityAddr AssignedEntityId AssignedEntityTelecom AssignedEntityAssignedPerson' constraints.validation.warning='AssignedEntityHasNationalProviderIdentifier' constraints.validation.info='AssignedEntityCode AssignedEntityCodeP'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsInformantAssignedEntity constraints.validation.error='AssignedEntityHasNationalProviderIdentifier AssignedEntityPerson' constraints.validation.warning='AssignedEntityAddr AssignedEntityId' constraints.validation.info='AssignedEntityCode AssignedEntityCodeP'"
