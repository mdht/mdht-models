 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatient administrativeGenderCode.codeSystemName='AdministrativeGenderCode' ethnicGroupCode.codeSystemName='Race and Ethnicity - CDC' maritalStatusCode.codeSystemName='MaritalStatus' constraints.validation.error='PatientBirthTimePreciseToYear PatientAdministrativeGenderCode PatientBirthTime PatientEthnicGroupCode PatientName' constraints.validation.warning='PatientBirthTimePreciseToDay PatientMaritalStatusCode PatientLanguageCommunication' ethnicGroupCode.codeSystem='2.16.840.1.113883.6.238' administrativeGenderCode.codeSystem='2.16.840.1.113883.5.1' maritalStatusCode.codeSystem='2.16.840.1.113883.5.2' constraints.validation.info='PatientEthnicGroupCodeP PatientRaceCode PatientReligiousAffiliationCode PatientGuardian PatientBirthplace'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientGuardian code.codeSystem='2.16.840.1.113883.5.111' constraints.validation.error='GuardianCode GuardianGuardianPerson' code.codeSystemName='RoleCode' constraints.validation.warning='GuardianAddr GuardianCodeP' constraints.validation.info='GuardianTelecom'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication proficiencyLevelCode.codeSystem='2.16.840.1.113883.5.61' constraints.validation.error='LanguageCommunicationLanguageCode LanguageCommunicationProficiencyLevelCode LanguageCommunicationModeCode' modeCode.codeSystem='2.16.840.1.113883.5.60' constraints.validation.warning='LanguageCommunicationProficiencyLevelCodeP' proficiencyLevelCode.codeSystemName='LanguageAbilityProficiency' constraints.validation.info='LanguageCommunicationPreferenceInd LanguageCommunicationModeCodeP' modeCode.codeSystemName='LanguageAbilityMode'"
