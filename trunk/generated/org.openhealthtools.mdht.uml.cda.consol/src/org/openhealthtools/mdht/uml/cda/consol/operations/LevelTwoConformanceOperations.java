 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.LevelTwoConformance#validateLevelOneConformanceTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Level One Conformance Template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LevelTwoConformanceOperations extends LevelOneConformanceOperations {
	 ...
	 * @generated
	 */
	public static boolean validateLevelOneConformanceTemplateId(LevelTwoConformance levelTwoConformance,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_LEVEL_ONE_CONFORMANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.LEVEL_TWO_CONFORMANCE);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LEVEL_ONE_CONFORMANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.LEVEL_TWO_CONFORMANCE__LEVEL_ONE_CONFORMANCE_TEMPLATE_ID,
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LevelOneConformanceTemplateId",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(levelTwoConformance, context) }),
