...
public class AdvanceDirectiveOperations extends ClinicalStatementOperations {
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveAdvDirectiveCodeValueSet(AdvanceDirective advanceDirective,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ADVANCE_DIRECTIVE_ADV_DIRECTIVE_CODE_VALUE_SET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveAdvDirectiveCodeCodeSystem(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ADVANCE_DIRECTIVE_ADV_DIRECTIVE_CODE_CODE_SYSTEM__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveHasExternalReference(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_HAS_EXTERNAL_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, ConsolValidator.DIAGNOSTIC_SOURCE,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_HAS_ENDING_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveHasEndingTime"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_HAS_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveHasCustodian"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_HAS_ADDRESS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveHasAddress"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_HAS_TELECOM__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveHasTelecom"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveTemplateId"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveClassCode(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ADVANCE_DIRECTIVE__ADVANCE_DIRECTIVE_CLASS_CODE,
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveClassCode"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveMoodCode(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ADVANCE_DIRECTIVE__ADVANCE_DIRECTIVE_MOOD_CODE,
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveMoodCode"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveId(AdvanceDirective advanceDirective, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveId"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveCode(AdvanceDirective advanceDirective, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ADVANCE_DIRECTIVE__ADVANCE_DIRECTIVE_CODE,
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveCode"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveStatusCode(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ADVANCE_DIRECTIVE__ADVANCE_DIRECTIVE_STATUS_CODE,
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveStatusCode"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveEffectiveTime"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveRepeatNumber(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_REPEAT_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.ADVANCE_DIRECTIVE__ADVANCE_DIRECTIVE_REPEAT_NUMBER,
					ConsolPlugin.INSTANCE.getString("AdvanceDirectiveRepeatNumber"), new Object[] { advanceDirective }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveInterpretationCode(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_INTERPRETATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveTargetSiteCode(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ADVANCE_DIRECTIVE_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validateAdvanceDirectiveAdvanceDirectiveStatusObservation(AdvanceDirective advanceDirective,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ADVANCE_DIRECTIVE_ADVANCE_DIRECTIVE_STATUS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			advanceDirective)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	...
	public static AdvanceDirectiveStatusObservation getAdvanceDirectiveStatusObservation(
		...
		if (GET_ADVANCE_DIRECTIVE_STATUS_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.ADVANCE_DIRECTIVE,
				ConsolPackage.Literals.ADVANCE_DIRECTIVE.getEAllOperations().get(71));
			try {
