...
public class LegalAuthenticator_AssignedEntityOperations extends AssignedEntityOperations {
	...
	public static boolean validateAssignedEntityHasNationalProviderIdentifier(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSIGNED_ENTITY_HAS_NATIONAL_PROVIDER_IDENTIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(legalAuthenticator_AssignedEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAssignedEntityAddr(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSIGNED_ENTITY_ADDR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(legalAuthenticator_AssignedEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.101'))";
	...
	public static boolean validateAssignedEntityCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSIGNED_ENTITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(legalAuthenticator_AssignedEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateAssignedEntityId(LegalAuthenticator_AssignedEntity legalAuthenticator_AssignedEntity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSIGNED_ENTITY_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(legalAuthenticator_AssignedEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAssignedEntityTelecom(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSIGNED_ENTITY_TELECOM__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(legalAuthenticator_AssignedEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAssignedEntityAssignedPerson(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSIGNED_ENTITY_ASSIGNED_PERSON__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(legalAuthenticator_AssignedEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
