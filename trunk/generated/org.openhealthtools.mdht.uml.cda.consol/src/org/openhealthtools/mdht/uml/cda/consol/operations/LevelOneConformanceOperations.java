...
import org.openhealthtools.mdht.uml.cda.consol.LevelOneConformance;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.LevelOneConformance#validateLevelOneConformanceTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Level One Conformance Template Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LevelOneConformanceOperations extends ClinicalDocumentOperations {
	...
	public static boolean validateLevelOneConformanceTemplateId(LevelOneConformance levelOneConformance,
		...
		if (VALIDATE_LEVEL_ONE_CONFORMANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.LEVEL_ONE_CONFORMANCE);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LEVEL_ONE_CONFORMANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.LEVEL_ONE_CONFORMANCE__LEVEL_ONE_CONFORMANCE_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("LevelOneConformanceTemplateId"),
