...
public class ConsolAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConsolSwitch<Adapter> modelSwitch = new ConsolSwitch<Adapter>() {
			...
			@Override
			public Adapter casePolicyActivity_Coverage(PolicyActivity_Coverage object) {
				return createPolicyActivity_CoverageAdapter();
			}
			@Override
			public Adapter caseCoverage_CoverageRole(Coverage_CoverageRole object) {
				return createCoverage_CoverageRoleAdapter();
			}
			@Override
			public Adapter caseCoverageRole_CoveragePlayingEntity(CoverageRole_CoveragePlayingEntity object) {
				return createCoverageRole_CoveragePlayingEntityAdapter();
			}
			@Override
			public Adapter casePolicyActivity_Holder(PolicyActivity_Holder object) {
				return createPolicyActivity_HolderAdapter();
			}
			@Override
			public Adapter caseHolder_HolderRole(Holder_HolderRole object) {
				return createHolder_HolderRoleAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.consol.PolicyActivity_Coverage <em>Policy Activity Coverage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.openhealthtools.mdht.uml.cda.consol.PolicyActivity_Coverage
	 * @generated
	 */
	public Adapter createPolicyActivity_CoverageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.consol.Coverage_CoverageRole <em>Coverage Coverage Role</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.openhealthtools.mdht.uml.cda.consol.Coverage_CoverageRole
	 * @generated
	 */
	public Adapter createCoverage_CoverageRoleAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.consol.CoverageRole_CoveragePlayingEntity <em>Coverage Role Coverage Playing Entity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.openhealthtools.mdht.uml.cda.consol.CoverageRole_CoveragePlayingEntity
	 * @generated
	 */
	public Adapter createCoverageRole_CoveragePlayingEntityAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.consol.PolicyActivity_Holder <em>Policy Activity Holder</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.openhealthtools.mdht.uml.cda.consol.PolicyActivity_Holder
	 * @generated
	 */
	public Adapter createPolicyActivity_HolderAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.consol.Holder_HolderRole <em>Holder Holder Role</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.openhealthtools.mdht.uml.cda.consol.Holder_HolderRole
	 * @generated
	 */
	public Adapter createHolder_HolderRoleAdapter() {
		return null;
	}
