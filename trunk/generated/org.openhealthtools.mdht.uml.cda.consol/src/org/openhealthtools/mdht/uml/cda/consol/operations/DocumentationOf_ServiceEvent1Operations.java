...
public class DocumentationOf_ServiceEvent1Operations extends ServiceEventOperations {
	...
	public static boolean validateServiceEvent1ProcedureCodes(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_PROCEDURE_CODES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent1EffectiveTimeHasLow(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_EFFECTIVE_TIME_HAS_LOW__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent1EffectiveTimeHasHighWhenNoWidth(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_EFFECTIVE_TIME_HAS_HIGH_WHEN_NO_WIDTH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent1EffectiveTimeNoHighIfWidth(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_EFFECTIVE_TIME_NO_HIGH_IF_WIDTH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent1AnyAssistantsAsSecondary(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_ANY_ASSISTANTS_AS_SECONDARY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent1Code(DocumentationOf_ServiceEvent1 documentationOf_ServiceEvent1,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent1EffectiveTime(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT1_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
