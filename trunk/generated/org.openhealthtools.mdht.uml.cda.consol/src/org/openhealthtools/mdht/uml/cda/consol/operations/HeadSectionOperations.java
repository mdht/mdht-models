...
public class HeadSectionOperations extends SectionOperations {
	 ...
	 * @generated
	 */
	public static  boolean validateHeadSectionTemplateId(HeadSection headSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("HeadSectionTemplateId"),
...
"value.code = '10199-8' and value.codeSystem = '2.16.840.1.113883.6.1'))";
	 ...
	 * @generated
	 */
	public static  boolean validateHeadSectionCode(HeadSection headSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("HeadSectionCode"),
						 new Object [] { headSection }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_HEAD_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::AllergyIntolerance))";
	 ...
	 * @generated
	 */
	public static  boolean validateHeadSectionProblemEntry(HeadSection headSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_HEAD_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(headSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 ConsolPlugin.INSTANCE.getString("HeadSectionProblemEntry"),
						 new Object [] { headSection }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public static  AllergyIntolerance getProblemEntry(HeadSection headSection) {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HEAD_SECTION, ConsolPackage.Literals.HEAD_SECTION.getEAllOperations().get(58));
			try {
		...
		return (AllergyIntolerance) query.evaluate(headSection);
	}
