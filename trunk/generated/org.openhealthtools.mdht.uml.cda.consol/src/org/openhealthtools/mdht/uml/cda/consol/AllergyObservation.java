 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='AllergyObservationTemplateId AllergyObservationAllergyStatusInversionIndicator AllergyObservationReactionInversionIndicator AllergyObservationSeverityInversionIndicator AllergyObservationClassCode AllergyObservationMoodCode AllergyObservationId AllergyObservationCode AllergyObservationStatusCode AllergyObservationEffectiveTime AllergyObservationValue AllergyObservationSeverity' templateId.root='2.16.840.1.113883.10.20.22.4.7' classCode='OBS' moodCode='EVN' code.codeSystem='2.16.840.1.113883.5.4' code.codeSystemName='HL7ActCode' code.code='ASSERTION' statusCode.code='completed' value.codeSystemName='SNOMEDCT' value.codeSystem='2.16.840.1.113883.6.96' constraints.validation.warning='AllergyObservationProblemEntryReactionObservationContainer AllergyObservationParticipant' constraints.validation.info='AllergyObservationAllergyStatusObservation'"
