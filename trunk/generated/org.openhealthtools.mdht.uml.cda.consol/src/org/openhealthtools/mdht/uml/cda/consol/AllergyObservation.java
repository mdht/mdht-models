...
public interface AllergyObservation extends Observation {
	...
	* <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * if (self.value->forAll(value | value.oclAsType(datatypes::CD).code = '419511003' or value.oclAsType(datatypes::CD).code = '416098002' or value.oclAsType(datatypes::CD).code = '59037007')) then self.participant->excluding(null).participantRole->excluding(null).playingEntity->excluding(null)->reject(code.codeSystem = '2.16.840.1.113883.6.88' or code.codeSystem='2.16.840.1.113883.3.26.1.5')
	 * else self.participant->excluding(null).participantRole->excluding(null).playingEntity->excluding(null)->reject(code.codeSystem = '2.16.840.1.113883.4.9') endif
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='if (self.value->forAll(value | value.oclAsType(datatypes::CD).code = \'419511003\' or value.oclAsType(datatypes::CD).code = \'416098002\' or value.oclAsType(datatypes::CD).code = \'59037007\')) then self.participant->excluding(null).participantRole->excluding(null).playingEntity->excluding(null)->reject(code.codeSystem = \'2.16.840.1.113883.6.88\' or code.codeSystem=\'2.16.840.1.113883.3.26.1.5\')\r\nelse self.participant->excluding(null).participantRole->excluding(null).playingEntity->excluding(null)->reject(code.codeSystem = \'2.16.840.1.113883.4.9\') endif'"
	 * @generated
	 */
