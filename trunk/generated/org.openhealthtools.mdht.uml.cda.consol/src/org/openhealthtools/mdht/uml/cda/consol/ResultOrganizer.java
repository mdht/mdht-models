...
public interface ResultOrganizer extends Organizer {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.component->exists(component : cda::Component4 | not component.observation.oclIsUndefined() and component.observation.oclIsKindOf(consol::Result))'"
	 * @generated
	 */
	boolean validateResultOrganizerResult(DiagnosticChain diagnostics, Map<Object, Object> context);
