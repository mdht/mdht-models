 ...
 * @generated
 */
public class EncompassingEncounter4_EncounterParticipantOperations extends ParticipationOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected EncompassingEncounter4_EncounterParticipantOperations() {
		super();
	}

	/**
	 * The cached OCL expression body for the '{@link #validateEncounterParticipantAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Participant Assigned Entity Has Person Or Organization</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterParticipantAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateEncounterParticipantAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Participant Assigned Entity Has Person Or Organization</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterParticipantAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 ...
	 * @param encompassingEncounter4_EncounterParticipant The receiving '<em><b>Encompassing Encounter4 Encounter Participant</b></em>' model object.
	...
	/**
	 * The cached OCL expression body for the '{@link #validateEncounterParticipantAssignedEntity(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Participant Assigned Entity</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterParticipantAssignedEntity(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateEncounterParticipantAssignedEntity(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Encounter Participant Assigned Entity</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateEncounterParticipantAssignedEntity(EncompassingEncounter4_EncounterParticipant, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
