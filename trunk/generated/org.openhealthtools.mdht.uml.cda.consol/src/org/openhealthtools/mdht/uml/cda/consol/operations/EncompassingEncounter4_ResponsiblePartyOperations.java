 ...
 * @generated
 */
public class EncompassingEncounter4_ResponsiblePartyOperations extends ResponsiblePartyOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected EncompassingEncounter4_ResponsiblePartyOperations() {
		super();
	}

	/**
	 * The cached OCL expression body for the '{@link #validateResponsiblePartyAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Responsible Party Assigned Entity Has Person Or Organization</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResponsiblePartyAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateResponsiblePartyAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Responsible Party Assigned Entity Has Person Or Organization</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResponsiblePartyAssignedEntityHasPersonOrOrganization(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 ...
	 * @param encompassingEncounter4_ResponsibleParty The receiving '<em><b>Encompassing Encounter4 Responsible Party</b></em>' model object.
	...
	public static boolean validateResponsiblePartyAssignedEntityHasPersonOrOrganization(
		...
		if (VALIDATE_RESPONSIBLE_PARTY_ASSIGNED_ENTITY_HAS_PERSON_OR_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.ENCOMPASSING_ENCOUNTER4_RESPONSIBLE_PARTY);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSIBLE_PARTY_ASSIGNED_ENTITY_HAS_PERSON_OR_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encompassingEncounter4_ResponsibleParty)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOMPASSING_ENCOUNTER4_RESPONSIBLE_PARTY__RESPONSIBLE_PARTY_ASSIGNED_ENTITY_HAS_PERSON_OR_ORGANIZATION,
						 ConsolPlugin.INSTANCE.getString("ResponsiblePartyAssignedEntityHasPersonOrOrganization"),
						 new Object [] { encompassingEncounter4_ResponsibleParty }));
			}
			return false;
		}
		return true;
	...
	/**
	 * The cached OCL expression body for the '{@link #validateResponsiblePartyAssignedEntity(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Responsible Party Assigned Entity</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResponsiblePartyAssignedEntity(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateResponsiblePartyAssignedEntity(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Responsible Party Assigned Entity</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResponsiblePartyAssignedEntity(EncompassingEncounter4_ResponsibleParty, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static boolean validateResponsiblePartyAssignedEntity(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESPONSIBLE_PARTY_ASSIGNED_ENTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(encompassingEncounter4_ResponsibleParty)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.ENCOMPASSING_ENCOUNTER4_RESPONSIBLE_PARTY__RESPONSIBLE_PARTY_ASSIGNED_ENTITY,
