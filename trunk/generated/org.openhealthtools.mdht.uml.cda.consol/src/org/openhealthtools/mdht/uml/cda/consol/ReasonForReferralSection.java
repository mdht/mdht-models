 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystem='2.16.840.1.113883.6.1' code.displayName='REASON FOR REFERRAL' templateId.root='2.16.840.1.113883.3.88.11.83.106' constraints.validation.error='ReasonForReferralSectionTemplateId ReasonForReferralSectionCode ReasonForReferralSectionProblemEntry' code.codeSystemName='LOINC' code.code='42349-1' constraints.validation.info='ReasonForReferralSectionCondition ReasonForReferralSectionResult'"
 * @generated
 */
public interface ReasonForReferralSection extends Section {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->exists(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::Result))'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->exists(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::AllergyIntolerance))'"
	 * @generated
	 */
	 ...
	 * @generated
	 */
	EList<AllergyIntolerance> getProblemEntries();
