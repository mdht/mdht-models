...
public class CommentActivityOperations extends ClinicalStatementOperations {
	...
	public static boolean validateCommentActivityHasTextReference(CommentActivity commentActivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMMENT_ACTIVITY_HAS_TEXT_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			commentActivity)) {
			if (diagnostics != null) {
	...
	public static boolean validateCommentActivityEffectiveTimeWhenAuthorPresent(CommentActivity commentActivity,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_COMMENT_ACTIVITY_EFFECTIVE_TIME_WHEN_AUTHOR_PRESENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			commentActivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCommentActivityHasAuthorId(CommentActivity commentActivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMMENT_ACTIVITY_HAS_AUTHOR_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			commentActivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.COMMENT_ACTIVITY__COMMENT_ACTIVITY_HAS_AUTHOR_ID,
					ConsolPlugin.INSTANCE.getString("CommentActivityHasAuthorId"), new Object[] { commentActivity }));
			}
			return false;
		}
		return true;
	...
	public static boolean validateCommentActivityHasAuthorOrganization(CommentActivity commentActivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMMENT_ACTIVITY_HAS_AUTHOR_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			commentActivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateCommentActivityStatusCode(CommentActivity commentActivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMMENT_ACTIVITY_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			commentActivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.COMMENT_ACTIVITY__COMMENT_ACTIVITY_STATUS_CODE,
					ConsolPlugin.INSTANCE.getString("CommentActivityStatusCode"), new Object[] { commentActivity }));
			}
			return false;
		}
		return true;
