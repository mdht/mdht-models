				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("CommentActivityTextReference"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("CommentActivityReferenceValue"),
						 new Object [] { commentActivity }));
			}
			...
			if (diagnostics != null) {
				...
				if (context != null) {
					...
					if (passToken == null) {
						...
						context.put("org.openhealthtools.mdht.uml.cda.consol.CommentActivityAuthorAssignedAuthorUSRealmAddressUseP", passToken);
					}
...
"value = vocab::PostalAddressUse::BAD or value = vocab::PostalAddressUse::DIR or value = vocab::PostalAddressUse::H or value = vocab::PostalAddressUse::HP or value = vocab::PostalAddressUse::HV or value = vocab::PostalAddressUse::PHYS or value = vocab::PostalAddressUse::PST or value = vocab::PostalAddressUse::PUB or value = vocab::PostalAddressUse::TMP or value = vocab::PostalAddressUse::WP) )))";
	...
	public static boolean validateCommentActivityAuthorAssignedAuthorUSRealmAddressUse(CommentActivity commentActivity,
		...
		if (oclResult != null && oclResult instanceof Collection) {
			...
			Object passFilter = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.consol.CommentActivityAuthorAssignedAuthorUSRealmAddressUseP");
