...
import org.openhealthtools.mdht.uml.cda.consol.ReasonForVisitAndChiefComplaintSection;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ReasonForVisitAndChiefComplaintSection#validateReasonForVisitAndChiefComplaintSectionTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Reason For Visit And Chief Complaint Section Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ReasonForVisitAndChiefComplaintSection#validateReasonForVisitAndChiefComplaintSectionCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Reason For Visit And Chief Complaint Section Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReasonForVisitAndChiefComplaintSectionOperations extends SectionOperations {
	...
	public static boolean validateReasonForVisitAndChiefComplaintSectionTemplateId(
		...
		if (VALIDATE_REASON_FOR_VISIT_AND_CHIEF_COMPLAINT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.REASON_FOR_VISIT_AND_CHIEF_COMPLAINT_SECTION);
			try {
		...
		if (!EOCL_ENV.createQuery(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.REASON_FOR_VISIT_AND_CHIEF_COMPLAINT_SECTION__REASON_FOR_VISIT_AND_CHIEF_COMPLAINT_SECTION_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("ReasonForVisitAndChiefComplaintSectionTemplateId"),
		...
		if (!EOCL_ENV.createQuery(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
					ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.REASON_FOR_VISIT_AND_CHIEF_COMPLAINT_SECTION__REASON_FOR_VISIT_AND_CHIEF_COMPLAINT_SECTION_CODE,
					ConsolPlugin.INSTANCE.getString("ReasonForVisitAndChiefComplaintSectionCode"),
					new Object[] { reasonForVisitAndChiefComplaintSection }));
			}
			return false;
		}
