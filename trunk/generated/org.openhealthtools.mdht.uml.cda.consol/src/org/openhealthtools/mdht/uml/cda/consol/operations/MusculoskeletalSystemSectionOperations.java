...
"value.code = '11410-8' and value.codeSystem = '2.16.840.1.113883.6.1'))";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MUSCULOSKELETAL_SYSTEM_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::AllergyObservation))";
	...
	public static  AllergyObservation getProblemEntry(MusculoskeletalSystemSection musculoskeletalSystemSection) {
		...
		return (AllergyObservation) query.evaluate(musculoskeletalSystemSection);
	}
