...
public class QuantityMeasurementObservationOperations extends ClinicalStatementOperations {
	...
	* <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.code.isNullFlavorDefined() or self.code.codeSystem = '2.16.840.1.113883.6.96'
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.code.isNullFlavorDefined() or self.code.codeSystem='1.2.840.10008.2.16.4'
	 * @param quantityMeasurementObservation The receiving '<em><b>Quantity Measurement Observation</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
