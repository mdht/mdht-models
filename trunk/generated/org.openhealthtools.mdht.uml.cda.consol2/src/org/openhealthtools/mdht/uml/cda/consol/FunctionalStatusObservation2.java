 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ResultObservationTemplateId ResultObservationCode ResultObservationCodeP FunctionalStatusObservation2ReferenceRangeObservationRangeNoCode' templateId.root='2.16.840.1.113883.10.20.22.4.67.2' code.code='364644000' code.codeSystem='2.16.840.1.113883.6.96' code.codeSystemName='SNOMEDCT' code.displayName='functional observable' constraints.validation.dependOn.ResultObservationCode='ResultObservationCodeP' constraints.validation.info='FunctionalStatusResultObservationReferenceRange' constraints.validation.warning='FunctionalStatusObservation2AuthorParticipation' constraints.validation.query='FunctionalStatusObservation2ReferenceRangeObservationRangeNoCode'"
 * @generated
 */
