...
public class TBResultObservationOperations extends ResultObservationOperations {
	 ...
	 * @generated
	 */
	public static boolean validateTBResultObservationClassCode(TBResultObservation tbResultObservation,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_TB_RESULT_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			tbResultObservation)) {
			if (diagnostics != null) {
	 ...
	 * @generated
	 */
	public static boolean validateResultObservationTemplateId(TBResultObservation tbResultObservation,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add(new BasicDiagnostic(
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						...
						new Object[] {
								...
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(tbResultObservation, context) }),
					new Object[] { tbResultObservation }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public static boolean validateResultObservationCode(TBResultObservation tbResultObservation,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					PilotPlugin.INSTANCE.getString("ResultObservationCode"), new Object[] { tbResultObservation }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validateResultObservationStatusCode(TBResultObservation tbResultObservation,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					PilotPlugin.INSTANCE.getString("ResultObservationStatusCode"), new Object[] { tbResultObservation }));
			}
			return false;
		}
		return true;
