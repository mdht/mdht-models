...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IProblem List Section</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.IProblemListSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IProblemListSectionImpl extends EObjectImpl implements IProblemListSection {
	/**
	 ...
	 * @generated
	 */
	protected IProblemListSectionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.IPROBLEM_LIST_SECTION;
	}
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				DomainPackage.Literals.IPROBLEM_LIST_SECTION.getEAllOperations().get(0));
			try {
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				DomainPackage.Literals.IPROBLEM_LIST_SECTION,
				DomainPackage.Literals.IPROBLEM_LIST_SECTION.getEAllOperations().get(3));
			try {
	...
	public EList<ICondition> getConditions() {
		if (GET_CONDITIONS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				DomainPackage.Literals.IPROBLEM_LIST_SECTION,
				DomainPackage.Literals.IPROBLEM_LIST_SECTION.getEAllOperations().get(6));
			try {
	...
	public ICondition addCondition() {
		...
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("ICondition");
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.IPROBLEM_LIST_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
