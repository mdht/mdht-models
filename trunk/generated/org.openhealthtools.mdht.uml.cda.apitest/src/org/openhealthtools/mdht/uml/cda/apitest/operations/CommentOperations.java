				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 APITestPlugin.INSTANCE.getString("CommentHasTextReference"),
						 new Object [] { comment }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 APITestPlugin.INSTANCE.getString("CommentEffectiveTimeWhenAuthorPresent"),
						 new Object [] { comment }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 APITestPlugin.INSTANCE.getString("CommentTemplateId"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 APITestValidator.DIAGNOSTIC_SOURCE,
						 APITestValidator.COMMENT__COMMENT_CLASS_CODE,
						 APITestPlugin.INSTANCE.getString("CommentClassCode"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 APITestValidator.DIAGNOSTIC_SOURCE,
						 APITestValidator.COMMENT__COMMENT_MOOD_CODE,
						 APITestPlugin.INSTANCE.getString("CommentMoodCode"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 APITestValidator.DIAGNOSTIC_SOURCE,
						 APITestValidator.COMMENT__COMMENT_CODE,
						 APITestPlugin.INSTANCE.getString("CommentCode"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 APITestValidator.DIAGNOSTIC_SOURCE,
						 APITestValidator.COMMENT__COMMENT_TEXT,
						 APITestPlugin.INSTANCE.getString("CommentText"),
						 new Object [] { comment }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 APITestPlugin.INSTANCE.getString("CommentStatusCode"),
						 new Object [] { comment }));
			}
			return false;
		}
