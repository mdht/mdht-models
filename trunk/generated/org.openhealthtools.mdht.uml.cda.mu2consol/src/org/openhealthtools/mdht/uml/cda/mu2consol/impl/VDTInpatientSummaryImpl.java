...
public class VDTInpatientSummaryImpl extends ViewDownloadTransmitSummaryImpl
	...
	public boolean validateVDTInpatientSummaryEffectiveTime(
		...
		return VDTInpatientSummaryOperations
				.validateVDTInpatientSummaryEffectiveTime(this, diagnostics,
						context);
	}
	...
	public boolean validateVDTInpatientSummaryLocation(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return VDTInpatientSummaryOperations
				.validateVDTInpatientSummaryLocation(this, diagnostics, context);
	}
	...
	public boolean validateVDTInpatientSummaryPreoperativeDiagnosisEntry(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return VDTInpatientSummaryOperations
				.validateVDTInpatientSummaryPreoperativeDiagnosisEntry(this,
						diagnostics, context);
	}
	...
	public boolean validateVDTInpatientSummaryChiefComplaintSection(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return VDTInpatientSummaryOperations
				.validateVDTInpatientSummaryChiefComplaintSection(this,
						diagnostics, context);
	}
	...
	public boolean validateVDTInpatientSummaryReasonForVisitSection(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return VDTInpatientSummaryOperations
				.validateVDTInpatientSummaryReasonForVisitSection(this,
						diagnostics, context);
	}
	...
	public boolean validateVDTInpatientSummaryPreoperativeDiagnosisSection(
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return VDTInpatientSummaryOperations
				.validateVDTInpatientSummaryPreoperativeDiagnosisSection(this,
						diagnostics, context);
	}
