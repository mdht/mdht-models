...
public class Mu2consolFactoryImpl extends EFactoryImpl implements
	...
	public static Mu2consolFactory init() {
		try {
			Mu2consolFactory theMu2consolFactory = (Mu2consolFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/mu2consol");
	...
	public EObject create(EClass eClass) {
		...
		case Mu2consolPackage.VDT_AMBULATORY_PATIENT_INFO:
			return createVDTAmbulatoryPatientInfo();
		case Mu2consolPackage.CREATE_TRANSMIT_SUMMARY_OF_CARE_RECORD:
			return createCreateTransmitSummaryOfCareRecord();
		case Mu2consolPackage.VDT_INPATIENT_PATIENT_INFO:
			return createVDTInpatientPatientInfo();
		...
		case Mu2consolPackage.ASSESSMENT_AND_PLAN_FOR_CARE_PLANNING:
			return createAssessmentAndPlanForCarePlanning();
		case Mu2consolPackage.ASSESSMENT_AND_PLAN_FOR_CONDITION_OR_CONCERN:
			return createAssessmentAndPlanForConditionOrConcern();
		default:
