...
public class ResultsSectionOperations
	 ...
	 * {@link #validateMu2consolResultsSectionResultOrganizer(ResultsSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Results Section Result Organizer</em>}' operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolResultsSectionResultOrganizer(ResultsSection,
	 ...
	 * {@link #validateMu2consolResultsSectionResultOrganizer(ResultsSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Results Section Result Organizer</em>}' invariant
	...
	public static boolean validateMu2consolResultsSectionResultOrganizer(
		...
		if (VALIDATE_MU2CONSOL_RESULTS_SECTION_RESULT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_RESULTS_SECTION_RESULT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_RESULTS_SECTION_RESULT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_RESULTS_SECTION_RESULT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				...
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("Mu2consolResultsSectionResultOrganizer"),
