...
public class VDTAmbulatorySummaryOperations extends
	 ...
	 * {@link #validateVDTAmbulatorySummaryResponsibleParty(VDTAmbulatorySummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Ambulatory Summary Responsible Party</em>}' operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTAmbulatorySummaryResponsibleParty(VDTAmbulatorySummary,
	 ...
	 * {@link #validateVDTAmbulatorySummaryResponsibleParty(VDTAmbulatorySummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Ambulatory Summary Responsible Party</em>}' invariant
	...
	public static boolean validateVDTAmbulatorySummaryResponsibleParty(
		...
		try {
			OCLExpression<EClassifier> oclExpression = helper
					.createQuery(VALIDATE_VDT_AMBULATORY_SUMMARY_RESPONSIBLE_PARTY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			VALIDATE_VDT_AMBULATORY_SUMMARY_RESPONSIBLE_PARTY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
					.createQuery(oclExpression);
		} catch (ParserException pe) {
			throw new UnsupportedOperationException(pe.getLocalizedMessage());
		}

		Object oclResult = VALIDATE_VDT_AMBULATORY_SUMMARY_RESPONSIBLE_PARTY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.evaluate(vdtAmbulatorySummary);
					...
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("VDTAmbulatorySummaryResponsibleParty"),
									new Object[] { eObject }));
				}
