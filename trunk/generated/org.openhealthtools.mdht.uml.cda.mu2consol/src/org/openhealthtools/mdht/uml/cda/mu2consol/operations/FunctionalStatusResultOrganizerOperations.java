...
public class FunctionalStatusResultOrganizerOperations extends org.openhealthtools.mdht.uml.cda.consol.operations.FunctionalStatusResultOrganizerOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(Mu2consolPackage.Literals.FUNCTIONAL_STATUS_RESULT_ORGANIZER, Mu2consolPackage.Literals.FUNCTIONAL_STATUS_RESULT_ORGANIZER.getEAllOperations().get(74));
      try
      {
