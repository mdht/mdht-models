...
public class VDTInpatientPatientInfoOperations extends
	 ...
	 * {@link #validateVDTInpatientPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection(VDTInpatientPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Inpatient Patient Info Cannot Have Chief Complaint And Reason For Visit With Chief Complaint Section Or Reason Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTInpatientPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection(VDTInpatientPatientInfo,
	...
	public static boolean validateVDTInpatientPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection(
		...
		if (VALIDATE_VDT_INPATIENT_PATIENT_INFO_CANNOT_HAVE_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_WITH_CHIEF_COMPLAINT_SECTION_OR_REASON_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_VDT_INPATIENT_PATIENT_INFO_CANNOT_HAVE_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_WITH_CHIEF_COMPLAINT_SECTION_OR_REASON_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_INPATIENT_PATIENT_INFO_CANNOT_HAVE_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_WITH_CHIEF_COMPLAINT_SECTION_OR_REASON_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				...
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTInpatientPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection"),
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateVDTInpatientPatientInfoMu2EncounterDiagnosesRequirements(VDTInpatientPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Inpatient Patient Info Mu2 Encounter Diagnoses Requirements</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTInpatientPatientInfoMu2EncounterDiagnosesRequirements(VDTInpatientPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateVDTInpatientPatientInfoMu2EncounterDiagnosesRequirements(
			VDTInpatientPatientInfo vdtInpatientPatientInfo,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_VDT_INPATIENT_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.VDT_INPATIENT_PATIENT_INFO);
			try {
				VALIDATE_VDT_INPATIENT_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_INPATIENT_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_VDT_INPATIENT_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(vdtInpatientPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTInpatientPatientInfoMu2EncounterDiagnosesRequirements"),
								new Object[] { vdtInpatientPatientInfo }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateVDTInpatientPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection(VDTInpatientPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Inpatient Patient Info Can Have Either Required Or Optional Vital Signs Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTInpatientPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection(VDTInpatientPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateVDTInpatientPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection(
			VDTInpatientPatientInfo vdtInpatientPatientInfo,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_VDT_INPATIENT_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.VDT_INPATIENT_PATIENT_INFO);
			try {
				VALIDATE_VDT_INPATIENT_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_INPATIENT_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_VDT_INPATIENT_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(vdtInpatientPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTInpatientPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection"),
								new Object[] { vdtInpatientPatientInfo }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateVDTInpatientPatientInfoMedicationListConstraint(VDTInpatientPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Inpatient Patient Info Medication List Constraint</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTInpatientPatientInfoMedicationListConstraint(VDTInpatientPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateVDTInpatientPatientInfoMedicationListConstraint(
			VDTInpatientPatientInfo vdtInpatientPatientInfo,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_VDT_INPATIENT_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.VDT_INPATIENT_PATIENT_INFO);
			try {
				VALIDATE_VDT_INPATIENT_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_INPATIENT_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_VDT_INPATIENT_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(vdtInpatientPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTInpatientPatientInfoMedicationListConstraint"),
								new Object[] { vdtInpatientPatientInfo }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateGeneralHeaderConstraintsTemplateId(VDTInpatientPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Template Id</em>}' operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateGeneralHeaderConstraintsTemplateId(VDTInpatientPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	 ...
	 * '2.16.840.1.113883.11.11.11.1.4')
	 * 
	 * @param vdtInpatientPatientInfo
	 *            The receiving '<em><b>VDT Inpatient Patient Info</b></em>'
	 *            model object.
