...
public class MedicationsAdministeredSectionOperations
	 ...
	 * {@link #validateMu2consolMedicationsAdministeredSectionMedicationActivity(MedicationsAdministeredSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Medications Administered Section Medication Activity</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolMedicationsAdministeredSectionMedicationActivity(MedicationsAdministeredSection,
	...
	public static boolean validateMu2consolMedicationsAdministeredSectionMedicationActivity(
		...
		if (VALIDATE_MU2CONSOL_MEDICATIONS_ADMINISTERED_SECTION_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_MEDICATIONS_ADMINISTERED_SECTION_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_MEDICATIONS_ADMINISTERED_SECTION_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_MEDICATIONS_ADMINISTERED_SECTION_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
	...
	public static EList<MedicationActivity> getmu2consolMedicationActivities(
		...
		if (GETMU2CONSOL_MEDICATION_ACTIVITIES__EOCL_QRY == null) {
			...
			try {
				GETMU2CONSOL_MEDICATION_ACTIVITIES__EOCL_QRY = helper
						.createQuery(GETMU2CONSOL_MEDICATION_ACTIVITIES__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		OCL.Query query = EOCL_ENV
				.createQuery(GETMU2CONSOL_MEDICATION_ACTIVITIES__EOCL_QRY);
