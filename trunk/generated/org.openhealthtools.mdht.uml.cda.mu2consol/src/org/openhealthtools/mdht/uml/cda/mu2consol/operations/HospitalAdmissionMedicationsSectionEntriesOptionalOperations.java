...
public class HospitalAdmissionMedicationsSectionEntriesOptionalOperations
	 ...
	 * {@link #validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalAdmissionMedication(HospitalAdmissionMedicationsSectionEntriesOptional, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Hospital Admission Medications Section Entries Optional Admission Medication</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalAdmissionMedication(HospitalAdmissionMedicationsSectionEntriesOptional,
	...
	public static boolean validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalAdmissionMedication(
		...
		if (VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_ADMISSION_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_ADMISSION_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_ADMISSION_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_ADMISSION_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(hospitalAdmissionMedicationsSectionEntriesOptional)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE
										.getString(
												...
												new Object[] {
														"Mu2consolHospitalAdmissionMedicationsSectionEntriesOptionalAdmissionMedication",
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity(HospitalAdmissionMedicationsSectionEntriesOptional, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Hospital Admission Medications Section Entries Optional Medication Activity</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity(HospitalAdmissionMedicationsSectionEntriesOptional,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.substanceAdministration.oclIsUndefined() and entry.substanceAdministration.oclIsKindOf(consol::MedicationActivity))";
	...
	protected static Constraint VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static boolean validateMu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity(
			HospitalAdmissionMedicationsSectionEntriesOptional hospitalAdmissionMedicationsSectionEntriesOptional,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		if (VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(Mu2consolPackage.Literals.HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL);
			try {
				VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(hospitalAdmissionMedicationsSectionEntriesOptional)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								Diagnostic.ERROR,
								Mu2consolValidator.DIAGNOSTIC_SOURCE,
								Mu2consolValidator.HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL__MU2CONSOL_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_MEDICATION_ACTIVITY,
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE
										.getString(
												"_UI_GenericInvariant_diagnostic",
												new Object[] {
														"Mu2consolHospitalAdmissionMedicationsSectionEntriesOptionalMedicationActivity",
														org.eclipse.emf.ecore.util.EObjectValidator
																.getObjectLabel(
																		hospitalAdmissionMedicationsSectionEntriesOptional,
																		context) }),
	...
	public static EList<AdmissionMedication> getmu2consolAdmissionMedications(
		...
		if (GETMU2CONSOL_ADMISSION_MEDICATIONS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
					Mu2consolPackage.Literals.HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL,
					Mu2consolPackage.Literals.HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL
							.getEAllOperations().get(63));
			try {
				GETMU2CONSOL_ADMISSION_MEDICATIONS__EOCL_QRY = helper
						.createQuery(GETMU2CONSOL_ADMISSION_MEDICATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		OCL.Query query = EOCL_ENV
				.createQuery(GETMU2CONSOL_ADMISSION_MEDICATIONS__EOCL_QRY);
		@SuppressWarnings("unchecked")
		Collection<AdmissionMedication> result = (Collection<AdmissionMedication>) query
				.evaluate(hospitalAdmissionMedicationsSectionEntriesOptional);
		return new BasicEList.UnmodifiableEList<AdmissionMedication>(
				result.size(), result.toArray());
	}

	/**
	 * The cached OCL expression body for the '
	 * {@link #getMedicationActivity(HospitalAdmissionMedicationsSectionEntriesOptional)
	 * <em>Get Medication Activity</em>}' operation. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getMedicationActivity(HospitalAdmissionMedicationsSectionEntriesOptional)
	 * @generated
	 * @ordered
	 */
