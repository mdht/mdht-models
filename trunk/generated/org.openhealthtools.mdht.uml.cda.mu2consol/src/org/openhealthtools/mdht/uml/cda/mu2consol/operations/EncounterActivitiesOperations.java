...
public class EncounterActivitiesOperations
	 ...
	 * {@link #validateMu2consolEncounterActivitiesCodeValue(EncounterActivities, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Encounter Activities Code Value</em>}' operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolEncounterActivitiesCodeValue(EncounterActivities,
	 ...
	 * {@link #validateMu2consolEncounterActivitiesCodeValue(EncounterActivities, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Encounter Activities Code Value</em>}' invariant
	...
	public static boolean validateMu2consolEncounterActivitiesCodeValue(
		...
		if (VALIDATE_MU2CONSOL_ENCOUNTER_ACTIVITIES_CODE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_ENCOUNTER_ACTIVITIES_CODE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_ENCOUNTER_ACTIVITIES_CODE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_ENCOUNTER_ACTIVITIES_CODE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(encounterActivities)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("Mu2consolEncounterActivitiesCodeValue"),
	 ...
	 * The cached OCL invariant for the '
	 * {@link #validateEncounterActivitiesTemplateId(EncounterActivities, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Encounter Activities Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateEncounterActivitiesTemplateId(EncounterActivities,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	...
	public static boolean validateEncounterActivitiesTemplateId(
		...
		if (VALIDATE_ENCOUNTER_ACTIVITIES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.ENCOUNTER_ACTIVITIES);
			try {
				VALIDATE_ENCOUNTER_ACTIVITIES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_ENCOUNTER_ACTIVITIES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_ENCOUNTER_ACTIVITIES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(encounterActivities)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
