				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryAdmissionDate"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryDischargeDate"),
						 new Object [] { vdtInpatientSummary }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryAdmissionDischargeLocation"),
						 new Object [] { vdtInpatientSummary }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryMedications"),
						 new Object [] { vdtInpatientSummary }));
			}
...
"self.getAllSections()->one(s : cda::Section | not s.oclIsUndefined() and s.oclIsTypeOf(consol::PreoperativeDiagnosisSection))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryReasonforHospitalization"),
						 new Object [] { vdtInpatientSummary }));
			}
	...
	public static HospitalDischargeInstructionsSection getHospitalDischargeInstructionsSection(
		...
		if (GET_HOSPITAL_DISCHARGE_INSTRUCTIONS_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY, Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY.getEAllOperations().get(314));
			try {
