 ...
 * </em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ClinicalOfficeVisitSummary#validateClinicalOfficeVisitSummaryReasonForVisitSection(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Clinical Office Visit Summary Reason For Visit Section</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ClinicalOfficeVisitSummary#validateClinicalOfficeVisitSummaryChiefComplaintSection(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Clinical Office Visit Summary Chief Complaint Section</em>}</li>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.ClinicalOfficeVisitSummary#validateClinicalOfficeVisitSummaryChiefComplaintAndReasonForVisitSection(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Clinical Office Visit Summary Chief Complaint And Reason For
 * Visit Section</em>}</li>
 * <li>
...
public class ClinicalOfficeVisitSummaryOperations extends
	...
	public static boolean validateClinicalOfficeVisitSummaryResponsibleParty(
		...
		try {
			OCLExpression<EClassifier> oclExpression = helper
					.createQuery(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_RESPONSIBLE_PARTY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_RESPONSIBLE_PARTY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
					.createQuery(oclExpression);
		} catch (ParserException pe) {
			throw new UnsupportedOperationException(pe.getLocalizedMessage());
		}

		Object oclResult = VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_RESPONSIBLE_PARTY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
					...
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("ClinicalOfficeVisitSummaryResponsibleParty"),
									new Object[] { eObject }));
				}
	 ...
	 * {@link #validateClinicalOfficeVisitSummaryResponsibleParty(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Responsible Party</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryResponsibleParty(ClinicalOfficeVisitSummary,
	...
	public static boolean validateClinicalOfficeVisitSummaryLocation(
		...
		try {
			OCLExpression<EClassifier> oclExpression = helper
					.createQuery(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
					.createQuery(oclExpression);
		} catch (ParserException pe) {
			throw new UnsupportedOperationException(pe.getLocalizedMessage());
		}

		Object oclResult = VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.evaluate(clinicalOfficeVisitSummary);
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
				...
				for (EObject eObject : oclResultSet) {
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("ClinicalOfficeVisitSummaryLocation"),
									new Object[] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryReasonForOfficeVisit(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Reason For Office Visit</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryReasonForOfficeVisit(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryReasonForOfficeVisit(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_OFFICE_VISIT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_OFFICE_VISIT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_OFFICE_VISIT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_OFFICE_VISIT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryReasonForOfficeVisit"),
	...
	public static boolean validateClinicalOfficeVisitSummaryCarePlanning(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CARE_PLANNING__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CARE_PLANNING__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CARE_PLANNING__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryCarePlanning"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryEffectiveTime(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Effective Time</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryEffectiveTime(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryLocation(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Location</em>}' operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryLocation(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	 ...
	 * The cached OCL invariant for the '
	 * {@link #validateClinicalOfficeVisitSummaryLocation(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Location</em>}' invariant
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryLocation(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	...
	public static boolean validateClinicalOfficeVisitSummaryEffectiveTime(
		...
		try {
			OCLExpression<EClassifier> oclExpression = helper
					.createQuery(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
					.createQuery(oclExpression);
		} catch (ParserException pe) {
			throw new UnsupportedOperationException(pe.getLocalizedMessage());
		}

		Object oclResult = VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.evaluate(clinicalOfficeVisitSummary);
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
				...
				for (EObject eObject : oclResultSet) {
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("ClinicalOfficeVisitSummaryEffectiveTime"),
									new Object[] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryInstructionsEntry(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Instructions Entry</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryInstructionsEntry(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryInstructionsEntry(
		...
		try {
			OCLExpression<EClassifier> oclExpression = helper
					.createQuery(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_INSTRUCTIONS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_INSTRUCTIONS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
					.createQuery(oclExpression);
		} catch (ParserException pe) {
			throw new UnsupportedOperationException(pe.getLocalizedMessage());
		}

		Object oclResult = VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_INSTRUCTIONS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.evaluate(clinicalOfficeVisitSummary);
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
				...
				for (EObject eObject : oclResultSet) {
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("ClinicalOfficeVisitSummaryInstructionsEntry"),
									new Object[] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryMedicationsAdministeredEntry(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Medications Administered Entry</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryMedicationsAdministeredEntry(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryMedicationsAdministeredEntry(
		...
		try {
			OCLExpression<EClassifier> oclExpression = helper
					.createQuery(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
					.createQuery(oclExpression);
		} catch (ParserException pe) {
			throw new UnsupportedOperationException(pe.getLocalizedMessage());
		}

		Object oclResult = VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.evaluate(clinicalOfficeVisitSummary);
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
				...
				for (EObject eObject : oclResultSet) {
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("ClinicalOfficeVisitSummaryMedicationsAdministeredEntry"),
									new Object[] { eObject }));
				}
	...
	public static boolean validateClinicalOfficeVisitSummarySocialHistorySection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_SOCIAL_HISTORY_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_SOCIAL_HISTORY_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_SOCIAL_HISTORY_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummarySocialHistorySection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static boolean validateClinicalOfficeVisitSummaryProblemSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PROBLEM_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PROBLEM_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PROBLEM_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryProblemSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryMedicationsSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Medications Section</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryMedicationsSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryMedicationsSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryMedicationsSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static boolean validateClinicalOfficeVisitSummaryAllergiesSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ALLERGIES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ALLERGIES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ALLERGIES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryAllergiesSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static boolean validateClinicalOfficeVisitSummaryResultsSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_RESULTS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_RESULTS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_RESULTS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryResultsSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryVitalSignsSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Vital Signs Section</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryVitalSignsSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryVitalSignsSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryVitalSignsSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryPlanOfCareSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Plan Of Care Section</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryPlanOfCareSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryPlanOfCareSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryPlanOfCareSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static boolean validateClinicalOfficeVisitSummaryProceduresSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PROCEDURES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PROCEDURES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_PROCEDURES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryProceduresSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static boolean validateClinicalOfficeVisitSummaryImmunizationsSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_IMMUNIZATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_IMMUNIZATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_IMMUNIZATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryImmunizationsSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryMedicationsAdministeredSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Medications Administered Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryMedicationsAdministeredSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryMedicationsAdministeredSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_MEDICATIONS_ADMINISTERED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryMedicationsAdministeredSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryReasonForVisitSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Reason For Visit Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryReasonForVisitSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryReasonForVisitSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryReasonForVisitSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryChiefComplaintSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Chief Complaint Section</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryChiefComplaintSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryChiefComplaintSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryChiefComplaintSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryChiefComplaintAndReasonForVisitSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Chief Complaint And Reason For Visit Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryChiefComplaintAndReasonForVisitSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryChiefComplaintAndReasonForVisitSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryChiefComplaintAndReasonForVisitSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateClinicalOfficeVisitSummaryAssessmentAndPlanSection(ClinicalOfficeVisitSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Clinical Office Visit Summary Assessment And Plan Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateClinicalOfficeVisitSummaryAssessmentAndPlanSection(ClinicalOfficeVisitSummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateClinicalOfficeVisitSummaryAssessmentAndPlanSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ASSESSMENT_AND_PLAN_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ASSESSMENT_AND_PLAN_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ASSESSMENT_AND_PLAN_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_ASSESSMENT_AND_PLAN_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(clinicalOfficeVisitSummary)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryAssessmentAndPlanSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static boolean validateClinicalOfficeVisitSummaryInstructionsSection(
		...
		if (VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_INSTRUCTIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.CLINICAL_OFFICE_VISIT_SUMMARY);
			try {
				VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_INSTRUCTIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_CLINICAL_OFFICE_VISIT_SUMMARY_INSTRUCTIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
			...
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("ClinicalOfficeVisitSummaryInstructionsSection"),
								new Object[] { clinicalOfficeVisitSummary }));
			}
	...
	public static PlanOfCareSection retrievePlanOfCareSection(
		...
		OCL.Query query = EOCL_ENV
				.createQuery(RETRIEVE_PLAN_OF_CARE_SECTION__EOCL_QRY);
	...
	public static InstructionsSection retrieveInstructionsSection(
		...
		OCL.Query query = EOCL_ENV
				.createQuery(RETRIEVE_INSTRUCTIONS_SECTION__EOCL_QRY);
	...
	public static MedicationsAdministeredSection retrieveMedicationsAdministeredSection(
		...
		OCL.Query query = EOCL_ENV
				.createQuery(RETRIEVE_MEDICATIONS_ADMINISTERED_SECTION__EOCL_QRY);
	 ...
	 * <em>Retrieve Plan Of Care Section</em>}' operation. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getProblemSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getMedicationsSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getAllergiesSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getResultsSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getVitalSignsSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getPlanOfCareSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getProceduresSection(ClinicalOfficeVisitSummary)
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getImmunizationsSection(ClinicalOfficeVisitSummary)
	...
	public static ImmunizationsSection getImmunizationsSection(
		...
		return (ImmunizationsSection) query
				.evaluate(clinicalOfficeVisitSummary);
	}
	...
	public static ReasonForVisitSection getReasonForVisitSection(
		...
		return (ReasonForVisitSection) query
				.evaluate(clinicalOfficeVisitSummary);
	}
	...
	public static ChiefComplaintSection getChiefComplaintSection(
		...
		return (ChiefComplaintSection) query
				.evaluate(clinicalOfficeVisitSummary);
	}

	/**
	 * The cached OCL expression body for the '
	 * {@link #getChiefComplaintAndReasonForVisitSection(ClinicalOfficeVisitSummary)
	...
	public static AssessmentAndPlanSection getAssessmentAndPlanSection(
		...
		return (AssessmentAndPlanSection) query
				.evaluate(clinicalOfficeVisitSummary);
	}

	/**
	 * The cached OCL expression body for the '
	 * {@link #getInstructionsSection(ClinicalOfficeVisitSummary)
