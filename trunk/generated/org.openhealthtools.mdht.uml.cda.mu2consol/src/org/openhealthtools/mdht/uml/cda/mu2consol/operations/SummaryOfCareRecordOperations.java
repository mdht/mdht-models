...
"self.getAllSections()->one(s : cda::Section | not s.oclIsUndefined() and s.oclIsTypeOf(mu2consol::AllergiesSectionEntriesOptional)))";
   ...
   */
	...
	public static  boolean validateSummaryOfCareRecordCanHaveEitherAllergyRequiredOrOptionalEntry(SummaryOfCareRecord summaryOfCareRecord, DiagnosticChain diagnostics, Map<Object, Object> context) {
