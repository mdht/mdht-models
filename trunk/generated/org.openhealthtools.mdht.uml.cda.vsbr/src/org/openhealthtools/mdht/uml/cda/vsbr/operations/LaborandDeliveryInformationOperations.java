...
public class LaborandDeliveryInformationOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateLaborandDeliveryInformationCodeP(LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
...
"value.code = '57074-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateLaborandDeliveryInformationHomeBirthPlan(LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLaborandDeliveryInformationMaternalTransfer(LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLaborandDeliveryInformationParticipatingLocation(LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLaborandDeliveryInformationRiskFactors(LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLaborandDeliveryInformationCertifierParticipation(LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(laborandDeliveryInformation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "LaborandDeliveryInformationCertifierParticipation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(laborandDeliveryInformation, context) }),
             new Object [] { laborandDeliveryInformation }));
      }
  ...
  public static  EList<CharacteristicofLaborandDelivery> getCharacteristicsofLaborandDeliveries(LaborandDeliveryInformation laborandDeliveryInformation)
  {
  ...
  public static  EList<MaternalMorbidity> getMaternalMorbiditiess(LaborandDeliveryInformation laborandDeliveryInformation)
  {
  ...
  public static  EList<PregnancyRiskFactor> getRiskFactorss(LaborandDeliveryInformation laborandDeliveryInformation)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION, VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION.getEAllOperations().get(69));
      try
      {
