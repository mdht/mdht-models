...
public class InfantTransferOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateInfantTransferTemplateId(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_TRANSFER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             VsbrPlugin.INSTANCE.getString("InfantTransferTemplateId"),
  ...
  public static  boolean validateInfantTransferClassCode(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_TRANSFER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             VsbrPlugin.INSTANCE.getString("InfantTransferClassCode"),
             new Object [] { infantTransfer }));
      }
  ...
  public static  boolean validateInfantTransferMoodCode(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_TRANSFER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             VsbrPlugin.INSTANCE.getString("InfantTransferMoodCode"),
             new Object [] { infantTransfer }));
      }
  ...
  public static  boolean validateInfantTransferCodeP(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
...
"value.code = '73758-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateInfantTransferCode(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.vsbr.InfantTransferCodeP");
  ...
  public static  boolean validateInfantTransferValue(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             VsbrPlugin.INSTANCE.getString("InfantTransferValue"),
             new Object [] { infantTransfer }));
      }
  ...
  public static  boolean validateInfantTransferParticipant(InfantTransfer infantTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_TRANSFER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
