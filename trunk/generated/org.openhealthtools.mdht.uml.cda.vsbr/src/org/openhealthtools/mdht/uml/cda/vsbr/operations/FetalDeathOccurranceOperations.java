...
public class FetalDeathOccurranceOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateFetalDeathOccurranceTemplateId(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
  ...
  public static  boolean validateFetalDeathOccurranceClassCode(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
             new Object [] { fetalDeathOccurrance }));
      }
  ...
  public static  boolean validateFetalDeathOccurranceMoodCode(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
             new Object [] { fetalDeathOccurrance }));
      }
  ...
  public static  boolean validateFetalDeathOccurranceCodeP(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
             new Object [] { fetalDeathOccurrance }));
      }
...
"value.code = '73811-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateFetalDeathOccurranceCode(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
             new Object [] { fetalDeathOccurrance }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '634751000124116' or value.code = '634741000124118' or value.code = '634661000124111' or value.code = '261665006')))";
  ...
  public static  boolean validateFetalDeathOccurranceValue(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
             new Object [] { fetalDeathOccurrance }));
      }
  ...
  public static  boolean validateFetalDeathOccurranceValueP(FetalDeathOccurrance fetalDeathOccurrance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DEATH_OCCURRANCE_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeathOccurrance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeathOccurranceValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeathOccurrance, context) }),
             new Object [] { fetalDeathOccurrance }));
      }
