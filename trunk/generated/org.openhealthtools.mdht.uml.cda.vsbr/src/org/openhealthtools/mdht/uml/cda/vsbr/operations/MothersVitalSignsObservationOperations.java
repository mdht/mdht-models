...
public class MothersVitalSignsObservationOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateMothersVitalSignsObservationTemplateId(MothersVitalSignsObservation mothersVitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsObservationTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsObservation, context) }),
  ...
  public static  boolean validateMothersVitalSignsObservationClassCode(MothersVitalSignsObservation mothersVitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsObservationClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsObservation, context) }),
             new Object [] { mothersVitalSignsObservation }));
      }
  ...
  public static  boolean validateMothersVitalSignsObservationMoodCode(MothersVitalSignsObservation mothersVitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsObservationMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsObservation, context) }),
             new Object [] { mothersVitalSignsObservation }));
      }
  ...
  public static  boolean validateMothersVitalSignsObservationCodeP(MothersVitalSignsObservation mothersVitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsObservation, context) }),
             new Object [] { mothersVitalSignsObservation }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = '69461-2' or value.code = '56077-1' or value.code = '3137-7'))";
  ...
  public static  boolean validateMothersVitalSignsObservationCode(MothersVitalSignsObservation mothersVitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsObservationCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsObservation, context) }),
             new Object [] { mothersVitalSignsObservation }));
      }
  ...
  public static  boolean validateMothersVitalSignsObservationValue(MothersVitalSignsObservation mothersVitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsObservationValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsObservation, context) }),
             new Object [] { mothersVitalSignsObservation }));
      }
