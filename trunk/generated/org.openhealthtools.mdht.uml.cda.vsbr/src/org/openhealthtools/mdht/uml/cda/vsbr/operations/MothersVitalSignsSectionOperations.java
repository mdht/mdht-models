...
"value.code = '8716-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateMothersVitalSignsSectionMothersVitalSignsObservation(MothersVitalSignsSection mothersVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MOTHERS_VITAL_SIGNS_SECTION_MOTHERS_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mothersVitalSignsSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MothersVitalSignsSectionMothersVitalSignsObservation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(mothersVitalSignsSection, context) }),
             new Object [] { mothersVitalSignsSection }));
      }
  ...
  public static  EList<MothersVitalSignsObservation> getMothersVitalSignsObservations(MothersVitalSignsSection mothersVitalSignsSection)
  {
