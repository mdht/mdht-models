...
public class NewbornsVitalSignsSectionOperations extends SectionOperations {
	...
	public static boolean validateNewbornsVitalSignsSectionVitalSignsObservation(
			NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			newbornsVitalSignsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"NewbornsVitalSignsSectionVitalSignsObservation",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									newbornsVitalSignsSection, context) }), new Object[] { newbornsVitalSignsSection }));
			}
	...
	public static EList<VitalSignsObservation> getVitalSignsObservations(
