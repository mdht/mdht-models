...
public class AssessmentsSectionOperations extends SectionOperations {
	...
	public static boolean validateAssessmentsSectionTemplateId(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						...
						new Object[] {
								"AssessmentsSectionTemplateId",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(assessmentsSection, context) }),
	...
	public static boolean validateAssessmentsSectionClassCode(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAssessmentsSectionMoodCode(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAssessmentsSectionCode(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAssessmentsSectionCodeP(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAssessmentsSectionText(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAssessmentsSectionAssessmentObservation(AssessmentsSection assessmentsSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ASSESSMENTS_SECTION_ASSESSMENT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			assessmentsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"AssessmentsSectionAssessmentObservation",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(assessmentsSection, context) }),
					new Object[] { assessmentsSection }));
			}
	...
	public static EList<AssessmentObservation> getAssessmentObservations(AssessmentsSection assessmentsSection) {
		if (GET_ASSESSMENT_OBSERVATIONS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				VsbrPackage.Literals.ASSESSMENTS_SECTION.getEAllOperations().get(62));
			try {
