...
public class ReportingBirthInformationfromaclinicalsettingtovitalrecordsOperations extends ClinicalDocumentOperations {
	...
	public static boolean validateReportingBirthInformationfromaclinicalsettingtovitalrecordsAntenatalTestingandSurveillance(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_REPORTING_BIRTH_INFORMATIONFROMACLINICALSETTINGTOVITALRECORDS_ANTENATAL_TESTINGAND_SURVEILLANCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			reportingBirthInformationfromaclinicalsettingtovitalrecords)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"ReportingBirthInformationfromaclinicalsettingtovitalrecordsAntenatalTestingandSurveillance",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									reportingBirthInformationfromaclinicalsettingtovitalrecords, context) }),
					new Object[] { reportingBirthInformationfromaclinicalsettingtovitalrecords }));
			}
	...
	public static boolean validateReportingBirthInformationfromaclinicalsettingtovitalrecordsHistoryofInfection(
			ReportingBirthInformationfromaclinicalsettingtovitalrecords reportingBirthInformationfromaclinicalsettingtovitalrecords,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_REPORTING_BIRTH_INFORMATIONFROMACLINICALSETTINGTOVITALRECORDS_HISTORYOF_INFECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			reportingBirthInformationfromaclinicalsettingtovitalrecords)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"ReportingBirthInformationfromaclinicalsettingtovitalrecordsHistoryofInfection",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									reportingBirthInformationfromaclinicalsettingtovitalrecords, context) }),
					new Object[] { reportingBirthInformationfromaclinicalsettingtovitalrecords }));
			}
	...
	public static boolean validateReportingBirthInformationfromaclinicalsettingtovitalrecordsLaborandDeliverySection(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_REPORTING_BIRTH_INFORMATIONFROMACLINICALSETTINGTOVITALRECORDS_LABORAND_DELIVERY_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			reportingBirthInformationfromaclinicalsettingtovitalrecords)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static HistoryofInfectionSection getHistoryofInfection(
			ReportingBirthInformationfromaclinicalsettingtovitalrecords reportingBirthInformationfromaclinicalsettingtovitalrecords) {
