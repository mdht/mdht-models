...
public class PregnancyRiskFactorOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validatePregnancyRiskFactorTemplateId(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
  ...
  public static  boolean validatePregnancyRiskFactorClassCode(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
  ...
  public static  boolean validatePregnancyRiskFactorMoodCode(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
  ...
  public static  boolean validatePregnancyRiskFactorCodeP(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
...
"value.code = '7377-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validatePregnancyRiskFactorCode(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '73211009' or value.code = '11687002' or value.code = '38341003' or value.code = '48194001' or value.code = '15938005' or value.code = '161765003' or value.code = '271903000' or value.code = '65046005' or value.code = '58533008' or value.code = '63487001' or value.code = '200144004' or value.code = '260413007'))";
  ...
  public static  boolean validatePregnancyRiskFactorCodeVS(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorCodeVS", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '73211009' or value.code = '11687002' or value.code = '38341003' or value.code = '48194001' or value.code = '15938005' or value.code = '161765003' or value.code = '271903000' or value.code = '65046005' or value.code = '58533008' or value.code = '63487001' or value.code = '200144004' or value.code = '260413007')))";
  ...
  public static  boolean validatePregnancyRiskFactorValue(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
  ...
  public static  boolean validatePregnancyRiskFactorValueP(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
   ...
   * @ordered
   */
  protected static final String VALIDATE_PREGNANCY_RISK_FACTOR_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entryRelationship->exists(entryRelationship : cda::EntryRelationship | not entryRelationship.oclIsUndefined() and entryRelationship.oclIsKindOf(cda::EntryRelationship))";
  ...
  public static  boolean validatePregnancyRiskFactorEntryRelationship(PregnancyRiskFactor pregnancyRiskFactor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_PREGNANCY_RISK_FACTOR_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pregnancyRiskFactor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PregnancyRiskFactorEntryRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(pregnancyRiskFactor, context) }),
             new Object [] { pregnancyRiskFactor }));
      }
