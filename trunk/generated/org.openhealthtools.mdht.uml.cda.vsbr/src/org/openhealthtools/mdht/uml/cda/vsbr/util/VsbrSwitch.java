...
public class VsbrSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VsbrPackage.REPORTING_BIRTH_INFORMATIONFROMACLINICALSETTINGTOVITALRECORDS: {
				...
				if (result == null) {
					result = caseAct(reportingBirthInformationfromaclinicalsettingtovitalrecords);
				}
				if (result == null) {
					result = caseInfrastructureRoot(reportingBirthInformationfromaclinicalsettingtovitalrecords);
				}
				if (result == null) {
			...
			case VsbrPackage.ANTENATAL_TESTINGAND_SURVEILLANCE_SECTION: {
				AntenatalTestingandSurveillanceSection antenatalTestingandSurveillanceSection = (AntenatalTestingandSurveillanceSection) theEObject;
				T result = caseAntenatalTestingandSurveillanceSection(antenatalTestingandSurveillanceSection);
				if (result == null) {
					result = caseSection(antenatalTestingandSurveillanceSection);
				}
				if (result == null) {
					result = caseAct(antenatalTestingandSurveillanceSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(antenatalTestingandSurveillanceSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.PRENATAL_CARE: {
				...
				if (result == null) {
					result = caseCDA_Act(prenatalCare);
				}
				if (result == null) {
					result = caseClinicalStatement(prenatalCare);
				}
				if (result == null) {
					result = caseAct(prenatalCare);
				}
				if (result == null) {
					result = caseInfrastructureRoot(prenatalCare);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.PRIOR_PREGNANCY_HISTORY_SECTION: {
				...
				if (result == null) {
					result = caseSection(priorPregnancyHistorySection);
				}
				if (result == null) {
					result = caseAct(priorPregnancyHistorySection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(priorPregnancyHistorySection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.DATEOF_LAST_LIVE_BIRTH: {
				...
				if (result == null) {
					result = caseObservation(dateofLastLiveBirth);
				}
				if (result == null) {
					result = caseClinicalStatement(dateofLastLiveBirth);
				}
				if (result == null) {
					result = caseAct(dateofLastLiveBirth);
				}
				if (result == null) {
					result = caseInfrastructureRoot(dateofLastLiveBirth);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.LAST_MENSTRUAL_PERIOD_DATE: {
				...
				if (result == null) {
					result = caseObservation(lastMenstrualPeriodDate);
				}
				if (result == null) {
					result = caseClinicalStatement(lastMenstrualPeriodDate);
				}
				if (result == null) {
					result = caseAct(lastMenstrualPeriodDate);
				}
				if (result == null) {
					result = caseInfrastructureRoot(lastMenstrualPeriodDate);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.NUMBEROF_BIRTHS_NOW_LIVING: {
				...
				if (result == null) {
					result = caseObservation(numberofBirthsNowLiving);
				}
				if (result == null) {
					result = caseClinicalStatement(numberofBirthsNowLiving);
				}
				if (result == null) {
					result = caseAct(numberofBirthsNowLiving);
				}
				if (result == null) {
					result = caseInfrastructureRoot(numberofBirthsNowLiving);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.NUMBEROF_LIVE_BIRTHSNOW_DEAD: {
				...
				if (result == null) {
					result = caseObservation(numberofLiveBirthsnowDead);
				}
				if (result == null) {
					result = caseClinicalStatement(numberofLiveBirthsnowDead);
				}
				if (result == null) {
					result = caseAct(numberofLiveBirthsnowDead);
				}
				if (result == null) {
					result = caseInfrastructureRoot(numberofLiveBirthsnowDead);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.OTHER_PREGNANCY_OUTCOME: {
				...
				if (result == null) {
					result = caseObservation(otherPregnancyOutcome);
				}
				if (result == null) {
					result = caseClinicalStatement(otherPregnancyOutcome);
				}
				if (result == null) {
					result = caseAct(otherPregnancyOutcome);
				}
				if (result == null) {
					result = caseInfrastructureRoot(otherPregnancyOutcome);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.ESTIMATEOF_GESTATION: {
				...
				if (result == null) {
					result = caseObservation(estimateofGestation);
				}
				if (result == null) {
					result = caseClinicalStatement(estimateofGestation);
				}
				if (result == null) {
					result = caseAct(estimateofGestation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(estimateofGestation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.HISTORYOF_INFECTION_SECTION: {
				HistoryofInfectionSection historyofInfectionSection = (HistoryofInfectionSection) theEObject;
				T result = caseHistoryofInfectionSection(historyofInfectionSection);
				if (result == null) {
					result = caseSection(historyofInfectionSection);
				}
				if (result == null) {
					result = caseAct(historyofInfectionSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(historyofInfectionSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.INFECTION_PRESENT: {
				InfectionPresent infectionPresent = (InfectionPresent) theEObject;
				T result = caseInfectionPresent(infectionPresent);
				if (result == null) {
					result = caseObservation(infectionPresent);
				}
				if (result == null) {
					result = caseClinicalStatement(infectionPresent);
				}
				if (result == null) {
					result = caseAct(infectionPresent);
				}
				if (result == null) {
					result = caseInfrastructureRoot(infectionPresent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.NEWBORN_DELIVERY_SECTION: {
				...
				if (result == null) {
					result = caseSection(newbornDeliverySection);
				}
				if (result == null) {
					result = caseAct(newbornDeliverySection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(newbornDeliverySection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.BIRTH_ORDER: {
				...
				if (result == null) {
					result = caseObservation(birthOrder);
				}
				if (result == null) {
					result = caseClinicalStatement(birthOrder);
				}
				if (result == null) {
					result = caseAct(birthOrder);
				}
				if (result == null) {
					result = caseInfrastructureRoot(birthOrder);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.NUMBEROF_INFANTS_BORN_ALIVE: {
				...
				if (result == null) {
					result = caseObservation(numberofInfantsBornAlive);
				}
				if (result == null) {
					result = caseClinicalStatement(numberofInfantsBornAlive);
				}
				if (result == null) {
					result = caseAct(numberofInfantsBornAlive);
				}
				if (result == null) {
					result = caseInfrastructureRoot(numberofInfantsBornAlive);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.CONGENITAL_ANOMALY: {
				...
				if (result == null) {
					result = caseObservation(congenitalAnomaly);
				}
				if (result == null) {
					result = caseClinicalStatement(congenitalAnomaly);
				}
				if (result == null) {
					result = caseAct(congenitalAnomaly);
				}
				if (result == null) {
					result = caseInfrastructureRoot(congenitalAnomaly);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.NEWBORNS_VITAL_SIGNS_SECTION: {
				...
				if (result == null) {
					result = caseSection(newbornsVitalSignsSection);
				}
				if (result == null) {
					result = caseAct(newbornsVitalSignsSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(newbornsVitalSignsSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.VITAL_SIGNS_OBSERVATION: {
				VitalSignsObservation vitalSignsObservation = (VitalSignsObservation) theEObject;
				T result = caseVitalSignsObservation(vitalSignsObservation);
				if (result == null) {
					result = caseObservation(vitalSignsObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(vitalSignsObservation);
				}
				if (result == null) {
					result = caseAct(vitalSignsObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(vitalSignsObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.ABNORMAL_CONDITIONOFTHE_NEWBORN: {
				...
				if (result == null) {
					result = caseObservation(abnormalConditionoftheNewborn);
				}
				if (result == null) {
					result = caseClinicalStatement(abnormalConditionoftheNewborn);
				}
				if (result == null) {
					result = caseAct(abnormalConditionoftheNewborn);
				}
				if (result == null) {
					result = caseInfrastructureRoot(abnormalConditionoftheNewborn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.INFANT_LIVING: {
				...
				if (result == null) {
					result = caseObservation(infantLiving);
				}
				if (result == null) {
					result = caseClinicalStatement(infantLiving);
				}
				if (result == null) {
					result = caseAct(infantLiving);
				}
				if (result == null) {
					result = caseInfrastructureRoot(infantLiving);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.INFANT_BREASTFED: {
				...
				if (result == null) {
					result = caseObservation(infantBreastfed);
				}
				if (result == null) {
					result = caseClinicalStatement(infantBreastfed);
				}
				if (result == null) {
					result = caseAct(infantBreastfed);
				}
				if (result == null) {
					result = caseInfrastructureRoot(infantBreastfed);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.INFANT_TRANSFER: {
				...
				if (result == null) {
					result = caseObservation(infantTransfer);
				}
				if (result == null) {
					result = caseClinicalStatement(infantTransfer);
				}
				if (result == null) {
					result = caseAct(infantTransfer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(infantTransfer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.PLURALITY: {
				...
				if (result == null) {
					result = caseObservation(plurality);
				}
				if (result == null) {
					result = caseClinicalStatement(plurality);
				}
				if (result == null) {
					result = caseAct(plurality);
				}
				if (result == null) {
					result = caseInfrastructureRoot(plurality);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.LABORAND_DELIVERY_SECTION: {
				...
				if (result == null) {
					result = caseSection(laborandDeliverySection);
				}
				if (result == null) {
					result = caseAct(laborandDeliverySection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(laborandDeliverySection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.LABORAND_DELIVERY_INFORMATION: {
				...
				if (result == null) {
					result = caseCDA_Act(laborandDeliveryInformation);
				}
				if (result == null) {
					result = caseClinicalStatement(laborandDeliveryInformation);
				}
				if (result == null) {
					result = caseAct(laborandDeliveryInformation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(laborandDeliveryInformation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.CHARACTERISTICOF_LABORAND_DELIVERY: {
				...
				if (result == null) {
					result = caseObservation(characteristicofLaborandDelivery);
				}
				if (result == null) {
					result = caseClinicalStatement(characteristicofLaborandDelivery);
				}
				if (result == null) {
					result = caseAct(characteristicofLaborandDelivery);
				}
				if (result == null) {
					result = caseInfrastructureRoot(characteristicofLaborandDelivery);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.PLANNED_HOME_BIRTH: {
				...
				if (result == null) {
					result = caseObservation(plannedHomeBirth);
				}
				if (result == null) {
					result = caseClinicalStatement(plannedHomeBirth);
				}
				if (result == null) {
					result = caseAct(plannedHomeBirth);
				}
				if (result == null) {
					result = caseInfrastructureRoot(plannedHomeBirth);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.MATERNAL_TRANSFER: {
				...
				if (result == null) {
					result = caseObservation(maternalTransfer);
				}
				if (result == null) {
					result = caseClinicalStatement(maternalTransfer);
				}
				if (result == null) {
					result = caseAct(maternalTransfer);
				}
				if (result == null) {
					result = caseInfrastructureRoot(maternalTransfer);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.MATERNAL_MORBIDITY: {
				...
				if (result == null) {
					result = caseObservation(maternalMorbidity);
				}
				if (result == null) {
					result = caseClinicalStatement(maternalMorbidity);
				}
				if (result == null) {
					result = caseAct(maternalMorbidity);
				}
				if (result == null) {
					result = caseInfrastructureRoot(maternalMorbidity);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.PREGNANCY_RISK_FACTOR: {
				...
				if (result == null) {
					result = caseObservation(pregnancyRiskFactor);
				}
				if (result == null) {
					result = caseClinicalStatement(pregnancyRiskFactor);
				}
				if (result == null) {
					result = caseAct(pregnancyRiskFactor);
				}
				if (result == null) {
					result = caseInfrastructureRoot(pregnancyRiskFactor);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.MOTHERS_VITAL_SIGNS_SECTION: {
				...
				if (result == null) {
					result = caseSection(mothersVitalSignsSection);
				}
				if (result == null) {
					result = caseAct(mothersVitalSignsSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(mothersVitalSignsSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.LABORAND_DELIVERY_PROCEDURE_SECTION: {
				...
				if (result == null) {
					result = caseSection(laborandDeliveryProcedureSection);
				}
				if (result == null) {
					result = caseAct(laborandDeliveryProcedureSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(laborandDeliveryProcedureSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.OBSTETRIC_PROCEDURE: {
				...
				if (result == null) {
					result = caseProcedure(obstetricProcedure);
				}
				if (result == null) {
					result = caseClinicalStatement(obstetricProcedure);
				}
				if (result == null) {
					result = caseAct(obstetricProcedure);
				}
				if (result == null) {
					result = caseInfrastructureRoot(obstetricProcedure);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.METHODOF_DELIVERY: {
				...
				if (result == null) {
					result = caseProcedure(methodofDelivery);
				}
				if (result == null) {
					result = caseClinicalStatement(methodofDelivery);
				}
				if (result == null) {
					result = caseAct(methodofDelivery);
				}
				if (result == null) {
					result = caseInfrastructureRoot(methodofDelivery);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.ONSETOF_LABOR: {
				...
				if (result == null) {
					result = caseObservation(onsetofLabor);
				}
				if (result == null) {
					result = caseClinicalStatement(onsetofLabor);
				}
				if (result == null) {
					result = caseAct(onsetofLabor);
				}
				if (result == null) {
					result = caseInfrastructureRoot(onsetofLabor);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.FETAL_DELIVERY_SECTION: {
				...
				if (result == null) {
					result = caseSection(fetalDeliverySection);
				}
				if (result == null) {
					result = caseAct(fetalDeliverySection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(fetalDeliverySection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.AUTOPSY_PERFORMANCE: {
				...
				if (result == null) {
					result = caseObservation(autopsyPerformance);
				}
				if (result == null) {
					result = caseClinicalStatement(autopsyPerformance);
				}
				if (result == null) {
					result = caseAct(autopsyPerformance);
				}
				if (result == null) {
					result = caseInfrastructureRoot(autopsyPerformance);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.FETAL_DEATH_OCCURRANCE: {
				...
				if (result == null) {
					result = caseObservation(fetalDeathOccurrance);
				}
				if (result == null) {
					result = caseClinicalStatement(fetalDeathOccurrance);
				}
				if (result == null) {
					result = caseAct(fetalDeathOccurrance);
				}
				if (result == null) {
					result = caseInfrastructureRoot(fetalDeathOccurrance);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.FETAL_DELIVERY_TIME: {
				...
				if (result == null) {
					result = caseObservation(fetalDeliveryTime);
				}
				if (result == null) {
					result = caseClinicalStatement(fetalDeliveryTime);
				}
				if (result == null) {
					result = caseAct(fetalDeliveryTime);
				}
				if (result == null) {
					result = caseInfrastructureRoot(fetalDeliveryTime);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.REPORTING_FETAL_DEATH_INFORMATIONFROMACLINICALSETTINGTOVITALRECORDS: {
				...
				if (result == null) {
					result = caseAct(reportingFetalDeathInformationfromaclinicalsettingtovitalrecords);
				}
				if (result == null) {
					result = caseInfrastructureRoot(reportingFetalDeathInformationfromaclinicalsettingtovitalrecords);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Antenatal Testingand Surveillance Section</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Antenatal Testingand Surveillance Section</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAntenatalTestingandSurveillanceSection(AntenatalTestingandSurveillanceSection object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Historyof Infection Section</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Historyof Infection Section</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHistoryofInfectionSection(HistoryofInfectionSection object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Infection Present</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Infection Present</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInfectionPresent(InfectionPresent object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Vital Signs Observation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Vital Signs Observation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVitalSignsObservation(VitalSignsObservation object) {
		return null;
	}
