...
public class InfectionPresentFetalDeathOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateInfectionPresentFetalDeathTemplateId(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
  ...
  public static  boolean validateInfectionPresentFetalDeathClassCode(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
  ...
  public static  boolean validateInfectionPresentFetalDeathMoodCode(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
  ...
  public static  boolean validateInfectionPresentFetalDeathCodeP(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
...
"value.code = '73769-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateInfectionPresentFetalDeathCode(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '1562800' or value.code = '76272004' or value.code = '105629000' or value.code = '4241002' or value.code = '426933007' or value.code = '28944009' or value.code = '186748004' or value.code = '187192000' or value.code = '394841004' or value.code = '260413007'))";
  ...
  public static  boolean validateInfectionPresentFetalDeathCodeVS(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathCodeVS", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '1562800' or value.code = '76272004' or value.code = '105629000' or value.code = '4241002' or value.code = '426933007' or value.code = '28944009' or value.code = '186748004' or value.code = '187192000' or value.code = '394841004' or value.code = '260413007')))";
  ...
  public static  boolean validateInfectionPresentFetalDeathValue(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
  ...
  public static  boolean validateInfectionPresentFetalDeathValueP(InfectionPresentFetalDeath infectionPresentFetalDeath, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentFetalDeath))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentFetalDeathValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentFetalDeath, context) }),
             new Object [] { infectionPresentFetalDeath }));
      }
