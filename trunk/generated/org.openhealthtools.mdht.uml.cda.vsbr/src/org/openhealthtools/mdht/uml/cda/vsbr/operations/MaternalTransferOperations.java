...
public class MaternalTransferOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateMaternalTransferTemplateId(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
  ...
  public static  boolean validateMaternalTransferClassCode(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
             new Object [] { maternalTransfer }));
      }
  ...
  public static  boolean validateMaternalTransferMoodCode(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
             new Object [] { maternalTransfer }));
      }
  ...
  public static  boolean validateMaternalTransferCodeP(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
             new Object [] { maternalTransfer }));
      }
...
"value.code = '73763-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateMaternalTransferCode(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
             new Object [] { maternalTransfer }));
      }
  ...
  public static  boolean validateMaternalTransferValue(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
             new Object [] { maternalTransfer }));
      }
  ...
  public static  boolean validateMaternalTransferParticipant(MaternalTransfer maternalTransfer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_TRANSFER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalTransfer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalTransferParticipant", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalTransfer, context) }),
             new Object [] { maternalTransfer }));
      }
