...
public class PluralityOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validatePluralityCodeP(Plurality plurality, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
      ...
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             VsbrValidator.DIAGNOSTIC_SOURCE,
             VsbrValidator.PLURALITY__PLURALITY_CODE_P,
             VsbrPlugin.INSTANCE.getString("PluralityCodeP"),
             new Object [] { plurality }));
      }
...
"value.code = '57722-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validatePluralityCode(Plurality plurality, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.vsbr.PluralityCodeP");
