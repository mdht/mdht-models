...
public class InfantLivingOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateInfantLivingTemplateId(InfantLiving infantLiving, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_LIVING_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantLiving))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantLivingTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantLiving, context) }),
  ...
  public static  boolean validateInfantLivingClassCode(InfantLiving infantLiving, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantLivingClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantLiving, context) }),
             new Object [] { infantLiving }));
      }
  ...
  public static  boolean validateInfantLivingMoodCode(InfantLiving infantLiving, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantLivingMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantLiving, context) }),
             new Object [] { infantLiving }));
      }
  ...
  public static  boolean validateInfantLivingCodeP(InfantLiving infantLiving, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantLivingCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantLiving, context) }),
             new Object [] { infantLiving }));
      }
...
"value.code = '73757-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateInfantLivingCode(InfantLiving infantLiving, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantLivingCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantLiving, context) }),
             new Object [] { infantLiving }));
      }
  ...
  public static  boolean validateInfantLivingValue(InfantLiving infantLiving, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantLivingValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantLiving, context) }),
             new Object [] { infantLiving }));
      }
