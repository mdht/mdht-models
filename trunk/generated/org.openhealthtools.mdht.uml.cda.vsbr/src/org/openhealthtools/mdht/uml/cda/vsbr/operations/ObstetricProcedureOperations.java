...
public class ObstetricProcedureOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateObstetricProcedureTemplateId(ObstetricProcedure obstetricProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_OBSTETRIC_PROCEDURE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obstetricProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ObstetricProcedureTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(obstetricProcedure, context) }),
  ...
  public static  boolean validateObstetricProcedureClassCode(ObstetricProcedure obstetricProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_OBSTETRIC_PROCEDURE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obstetricProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ObstetricProcedureClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(obstetricProcedure, context) }),
             new Object [] { obstetricProcedure }));
      }
  ...
  public static  boolean validateObstetricProcedureMoodCode(ObstetricProcedure obstetricProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_OBSTETRIC_PROCEDURE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obstetricProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ObstetricProcedureMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(obstetricProcedure, context) }),
             new Object [] { obstetricProcedure }));
      }
  ...
  public static  boolean validateObstetricProcedureNegationInd(ObstetricProcedure obstetricProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_OBSTETRIC_PROCEDURE_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obstetricProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ObstetricProcedureNegationInd", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(obstetricProcedure, context) }),
             new Object [] { obstetricProcedure }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '265636007' or value.code = '103747003' or value.code = '240278000' or value.code = '260413007'))";
  ...
  public static  boolean validateObstetricProcedureCode(ObstetricProcedure obstetricProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_OBSTETRIC_PROCEDURE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obstetricProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ObstetricProcedureCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(obstetricProcedure, context) }),
             new Object [] { obstetricProcedure }));
      }
  ...
  public static  boolean validateObstetricProcedureCodeP(ObstetricProcedure obstetricProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_OBSTETRIC_PROCEDURE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obstetricProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ObstetricProcedureCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(obstetricProcedure, context) }),
             new Object [] { obstetricProcedure }));
      }
