...
public class VsbrFactoryImpl extends EFactoryImpl implements VsbrFactory {
	...
	public static VsbrFactory init() {
		try {
			VsbrFactory theVsbrFactory = (VsbrFactory) EPackage.Registry.INSTANCE.getEFactory(VsbrPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case VsbrPackage.PRENATAL_TESTINGAND_SURVEILLANCE_SECTION:
				return createPrenatalTestingandSurveillanceSection();
			...
			case VsbrPackage.NEWBORNS_VITAL_SIGNS_OBSERVATION:
				return createNewbornsVitalSignsObservation();
			...
			case VsbrPackage.MOTHERS_VITAL_SIGNS_OBSERVATION:
				return createMothersVitalSignsObservation();
			case VsbrPackage.HISTORYOF_INFECTION_LIVE_BIRTH_SECTION:
				return createHistoryofInfectionLiveBirthSection();
			case VsbrPackage.INFECTION_PRESENT_LIVE_BIRTH:
				return createInfectionPresentLiveBirth();
			...
			case VsbrPackage.HISTORYOF_INFECTION_FETAL_DEATH_SECTION:
				return createHistoryofInfectionFetalDeathSection();
			case VsbrPackage.INFECTION_PRESENT_FETAL_DEATH:
				return createInfectionPresentFetalDeath();
			default:
