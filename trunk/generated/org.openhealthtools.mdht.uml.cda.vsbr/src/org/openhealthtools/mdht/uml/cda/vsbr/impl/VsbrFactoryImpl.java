...
public class VsbrFactoryImpl extends EFactoryImpl implements VsbrFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case VsbrPackage.ANTENATAL_TESTINGAND_SURVEILLANCE_SECTION: return createAntenatalTestingandSurveillanceSection();
      ...
      case VsbrPackage.HISTORYOF_INFECTION_SECTION: return createHistoryofInfectionSection();
      case VsbrPackage.INFECTION_PRESENT: return createInfectionPresent();
      ...
      case VsbrPackage.VITAL_SIGNS_OBSERVATION: return createVitalSignsObservation();
