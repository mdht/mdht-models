...
public class VsbrFactoryImpl extends EFactoryImpl implements VsbrFactory {
	 ...
	 * @generated
	 */
	public AntenatalTestingandSurveillanceSection createAntenatalTestingandSurveillanceSection() {
		AntenatalTestingandSurveillanceSectionImpl antenatalTestingandSurveillanceSection = new AntenatalTestingandSurveillanceSectionImpl();
		return antenatalTestingandSurveillanceSection;
	}
	 ...
	 * @generated
	 */
	public HistoryofInfectionSection createHistoryofInfectionSection() {
		HistoryofInfectionSectionImpl historyofInfectionSection = new HistoryofInfectionSectionImpl();
		return historyofInfectionSection;
	}
	 ...
	 * @generated
	 */
	public InfectionPresent createInfectionPresent() {
		InfectionPresentImpl infectionPresent = new InfectionPresentImpl();
	...
	public VitalSignsObservation createVitalSignsObservation() {
		VitalSignsObservationImpl vitalSignsObservation = new VitalSignsObservationImpl();
