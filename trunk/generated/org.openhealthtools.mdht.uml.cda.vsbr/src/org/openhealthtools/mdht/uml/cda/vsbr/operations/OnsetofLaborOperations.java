...
public class OnsetofLaborOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateOnsetofLaborTemplateId(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_ONSETOF_LABOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(onsetofLabor))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
  ...
  public static  boolean validateOnsetofLaborClassCode(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
  ...
  public static  boolean validateOnsetofLaborMoodCode(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
  ...
  public static  boolean validateOnsetofLaborCodeP(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
...
"value.code = '73774-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateOnsetofLaborCode(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
...
"let value : datatypes::CD = self.code.oclAsType(datatypes::CD) in "+
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '44223004' or value.code = '51920004' or value.code = '53443007' or value.code = '60413007'))";
  ...
  public static  boolean validateOnsetofLaborCodeVS(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborCodeVS", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '44223004' or value.code = '51920004' or value.code = '53443007' or value.code = '60413007')))";
  ...
  public static  boolean validateOnsetofLaborValue(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
  ...
  public static  boolean validateOnsetofLaborValueP(OnsetofLabor onsetofLabor, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "OnsetofLaborValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(onsetofLabor, context) }),
             new Object [] { onsetofLabor }));
      }
