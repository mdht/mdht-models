...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ITreating Provider</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.ITreatingProviderImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ITreatingProviderImpl extends EObjectImpl implements ITreatingProvider {
	/**
	 ...
	 * @ordered
	 */
	protected AssignedEntity cDAType;
	 ...
	 * @generated
	 */
	protected ITreatingProviderImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ITREATING_PROVIDER;
	}
	 ...
	 * @generated
	 */
	public AssignedEntity getCDAType() {
		if (cDAType != null && cDAType.eIsProxy()) {
			InternalEObject oldCDAType = (InternalEObject) cDAType;
			cDAType = (AssignedEntity) eResolveProxy(oldCDAType);
	 ...
	 * @generated
	 */
	public AssignedEntity basicGetCDAType() {
		return cDAType;
	}
	 ...
	 * @generated
	 */
	public void setCDAType(AssignedEntity newCDAType) {
		cDAType = newCDAType;
	}

	/**
	 * The cached OCL expression body for the '{@link #getTreatingProviderIDs() <em>Get Treating Provider IDs</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTreatingProviderIDs()
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL query for the '{@link #getTreatingProviderIDs() <em>Get Treating Provider IDs</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTreatingProviderIDs()
	 * @generated
	...
	public EList<II> getTreatingProviderIDs() {
		if (GET_TREATING_PROVIDER_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				DomainPackage.Literals.ITREATING_PROVIDER.getEAllOperations().get(0));
			try {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.ITREATING_PROVIDER__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DomainPackage.ITREATING_PROVIDER__CDA_TYPE:
				setCDAType((AssignedEntity) newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case DomainPackage.ITREATING_PROVIDER__CDA_TYPE:
				setCDAType((AssignedEntity) null);
				return;
		}
