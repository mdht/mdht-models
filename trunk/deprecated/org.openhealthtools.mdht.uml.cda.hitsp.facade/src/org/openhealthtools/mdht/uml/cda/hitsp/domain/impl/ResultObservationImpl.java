 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.ResultObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResultObservationImpl extends EObjectImpl implements IResultObservation {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getResultObservation();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation addId(II value) {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}
	...
	public CS getStatusCode() {
		if (GET_STATUS_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(6));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation setStatusCode(CS value) {
		this.getCDAType().setStatusCode(value);
		return this;
	}
	...
	public IVL_TS getEffectiveTime() {
		if (GET_EFFECTIVE_TIME__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(9));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation setEffectiveTime(IVL_TS value) {
		this.getCDAType().setEffectiveTime(value);
		return this;
	}
	...
	public ANY getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(12));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation setValue(ANY value) {
		this.getCDAType().getValues().add(value);
		return this;
	}
	...
	public EList<CE> getInterpretationCodes() {
		if (GET_INTERPRETATION_CODES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(15));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation addInterpretationCode(CE value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public CE getMethodCode() {
		if (GET_METHOD_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultObservation(),
				IDomainPackage.eINSTANCE.getResultObservation().getEAllOperations().get(18));
			try {
	 ...
	 * @generated
	 */
	public IResultObservation setMethodCode(CE value) {
		this.getCDAType().getMethodCodes().add(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.RESULT_OBSERVATION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
