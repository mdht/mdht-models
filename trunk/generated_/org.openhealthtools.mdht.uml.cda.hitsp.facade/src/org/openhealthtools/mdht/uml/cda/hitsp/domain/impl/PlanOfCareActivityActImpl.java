 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.PlanOfCareActivityActImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlanOfCareActivityActImpl extends PlanOfCareActivityImpl implements IPlanOfCareActivityAct {
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPlanOfCareActivityAct(),
				IDomainPackage.eINSTANCE.getPlanOfCareActivityAct().getEAllOperations().get(0));
			try {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPlanOfCareActivityAct(),
				IDomainPackage.eINSTANCE.getPlanOfCareActivityAct().getEAllOperations().get(3));
			try {
