...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.ISocialHistoryStatusObservation;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.SocialHistoryObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SocialHistoryObservationImpl extends EObjectImpl implements ISocialHistoryObservation {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getSocialHistoryObservation();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSocialHistoryObservation(),
				IDomainPackage.eINSTANCE.getSocialHistoryObservation().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public ISocialHistoryObservation addId(II value) {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSocialHistoryObservation(),
				IDomainPackage.eINSTANCE.getSocialHistoryObservation().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public ISocialHistoryObservation setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}

	/**
	 * The cached OCL expression body for the '{@link #getSocialHistoryStatusObservation() <em>Get Social History Status Observation</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSocialHistoryStatusObservation()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_SOCIAL_HISTORY_STATUS_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(domain::SocialHistoryStatusObservation))->asSequence()->first().oclAsType(domain::SocialHistoryStatusObservation)";

	/**
	 * The cached OCL query for the '{@link #getSocialHistoryStatusObservation() <em>Get Social History Status Observation</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSocialHistoryStatusObservation()
	 * @generated
	...
	public ISocialHistoryStatusObservation getSocialHistoryStatusObservation() {
		if (GET_SOCIAL_HISTORY_STATUS_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSocialHistoryObservation(),
				IDomainPackage.eINSTANCE.getSocialHistoryObservation().getEAllOperations().get(6));
			try {
		...
		return (ISocialHistoryStatusObservation) query.evaluate(this);
	}
	 ...
	 * @generated
	 */
	public ISocialHistoryStatusObservation withSocialHistoryStatusObservation() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("SocialHistoryStatusObservation");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
	 ...
	 * @generated
	 */
	public ISocialHistoryObservation setSocialHistoryStatusObservation(ISocialHistoryStatusObservation value) {
	...
	public IEpisodeObservation getEpisodeObservation() {
		if (GET_EPISODE_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSocialHistoryObservation(),
				IDomainPackage.eINSTANCE.getSocialHistoryObservation().getEAllOperations().get(9));
			try {
	 ...
	 * @generated
	 */
	public ISocialHistoryObservation setEpisodeObservation(IEpisodeObservation value) {
		this.getCDAType().addObservation((org.openhealthtools.mdht.uml.cda.Observation) value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.SOCIAL_HISTORY_OBSERVATION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
