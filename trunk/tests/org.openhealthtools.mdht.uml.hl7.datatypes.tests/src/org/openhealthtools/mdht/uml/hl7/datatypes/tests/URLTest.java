...
public class URLTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateURL() {
		OperationsTestCase<URL> validateURLTestCase = new OperationsTestCase<URL>(
			...
			@Override
			protected void updateToFail(URL target) {

			}

			@Override
			protected void updateToPass(URL target) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return URLOperations.validateURL((URL) objectToTest, diagnostician, map);
			}

		};

		validateURLTestCase.doValidationTest();
	}
	...
	* @generated
	*/
	private static class OperationsForOCL extends URLOperations {
	...
	* @generated
	*/
	private static class ObjectFactory implements TestObjectFactory<URL> {
	...
	* @generated
	*/
	private static class ConstructorTestClass extends URLOperations {
	};
