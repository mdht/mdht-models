...
public class UnstructuredDocumentTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateGeneralHeaderConstraintsCustodian() {
		OperationsTestCase<UnstructuredDocument> validateGeneralHeaderConstraintsCustodianTestCase = new OperationsTestCase<UnstructuredDocument>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return UnstructuredDocumentOperations.validateGeneralHeaderConstraintsCustodian(
					(UnstructuredDocument) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateGeneralHeaderConstraintsEffectiveTime() {
		OperationsTestCase<UnstructuredDocument> validateGeneralHeaderConstraintsEffectiveTimeTestCase = new OperationsTestCase<UnstructuredDocument>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return UnstructuredDocumentOperations.validateGeneralHeaderConstraintsEffectiveTime(
					(UnstructuredDocument) objectToTest, diagnostician, map);
			}
