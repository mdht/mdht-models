...
public class SalmonellosisPHCRRelevantDxTestsSectionOperations extends PhcrRelevantDxTestsSectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(SalmonellosisPackage.Literals.SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION, SalmonellosisPackage.Literals.SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION.getEAllOperations().get(71));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(SalmonellosisPackage.Literals.SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION, SalmonellosisPackage.Literals.SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION.getEAllOperations().get(72));
      try
      {
