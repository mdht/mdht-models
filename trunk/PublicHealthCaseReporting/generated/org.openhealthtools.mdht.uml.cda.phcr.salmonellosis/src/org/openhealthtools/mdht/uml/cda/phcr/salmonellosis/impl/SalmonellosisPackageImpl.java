   ...
   */
    ...
    addAnnotation
      (salmonellosisPossibleExposureLocationAndTypeActEClass, 
       ...
       "constraints.validation.error", "SalmonellosisPossibleExposureLocationAndTypeActTemplateId SalmonellosisPossibleExposureLocationAndTypeActCode SalmonellosisPossibleExposureLocationAndTypeActStatusCode SalmonellosisPossibleExposureLocationAndTypeActClassCode",
    ...
    addAnnotation
      (hivStatusObservationEClass, 
       ...
       "constraints.validation.error", "HIVStatusObservationTemplateId HIVStatusObservationCode HIVStatusObservationStatusCode HIVStatusObservationClassCode HIVStatusObservationMoodCode",
    ...
    addAnnotation
      (salmonellosisResultOrganizerEClass, 
       ...
       "constraints.validation.error", "SalmonellosisResultOrganizerTemplateId SalmonellosisResultOrganizerSalmonellosisResultObservation"
       });									
    addAnnotation
      (salmonellosisResultObservationEClass, 
       ...
       "constraints.validation.error", "SalmonellosisResultObservationTemplateId"
       });			
    addAnnotation
    ...
    addAnnotation
      (salmonellosisCaseObservationEClass, 
       ...
       "constraints.validation.error", "SalmonellosisCaseObservationTemplateId",
       "constraints.validation.warning", "SalmonellosisCaseObservationSalmonellosisSignsAndSymptomsObservation"
       });									
    addAnnotation
      (salmonellosisSignsAndSymptomsObservationEClass, 
       ...
       "constraints.validation.error", "SalmonellosisSignsAndSymptomsObservationTemplateId"
       });	
  }
