...
public interface SalmonellosisCaseObservation extends CaseObservation {
   ...
   * @param context The cache of context-specific information.
   * <!-- end-model-doc -->
   * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entryRelationship->exists(entryRelationship : cda::EntryRelationship | not entryRelationship.observation.oclIsUndefined() and entryRelationship.observation.oclIsKindOf(salmonellosis::SalmonellosisSignsAndSymptomsObservation))'"
   * @generated
   */
	boolean validateSalmonellosisCaseObservationSalmonellosisSignsAndSymptomsObservation(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
	EList<SalmonellosisSignsAndSymptomsObservation> getSalmonellosisSignsAndSymptomsObservations();
