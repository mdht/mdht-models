 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.tuberculosis.TuberculosisResultOrganizer#validateResultOrganizerCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Organizer Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TuberculosisResultOrganizerOperations extends ResultOrganizerOperations {
	...
	public static  EList<TuberculosisResultObservation> getTuberculosisResultObservations(TuberculosisResultOrganizer tuberculosisResultOrganizer) {
		if (GET_TUBERCULOSIS_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(TuberculosisPackage.Literals.TUBERCULOSIS_RESULT_ORGANIZER, TuberculosisPackage.Literals.TUBERCULOSIS_RESULT_ORGANIZER.getEAllOperations().get(74));
			try {
  ...
  /**
	 * The cached OCL expression body for the '{@link #validateResultOrganizerCode(TuberculosisResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Organizer Code</em>}' operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #validateResultOrganizerCode(TuberculosisResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.codeSystem = '2.16.840.1.113883.6.1' and not value.code.oclIsUndefined()))";
  ...
  /**
	 * The cached OCL invariant for the '{@link #validateResultOrganizerCode(TuberculosisResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Organizer Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #validateResultOrganizerCode(TuberculosisResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
  ...
  public static  boolean validateResultOrganizerCode(TuberculosisResultOrganizer tuberculosisResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(tuberculosisResultOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TuberculosisValidator.DIAGNOSTIC_SOURCE,
						 TuberculosisValidator.TUBERCULOSIS_RESULT_ORGANIZER__RESULT_ORGANIZER_CODE,
						 TuberculosisPlugin.INSTANCE.getString("ResultOrganizerCode"),
						 new Object [] { tuberculosisResultOrganizer }));
			}
