...
public class TuberculosisPHCRSocialHistorySectionOperations extends PhcrSocialHistorySectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(TuberculosisPackage.Literals.TUBERCULOSIS_PHCR_SOCIAL_HISTORY_SECTION, TuberculosisPackage.Literals.TUBERCULOSIS_PHCR_SOCIAL_HISTORY_SECTION.getEAllOperations().get(88));
      try
      {
