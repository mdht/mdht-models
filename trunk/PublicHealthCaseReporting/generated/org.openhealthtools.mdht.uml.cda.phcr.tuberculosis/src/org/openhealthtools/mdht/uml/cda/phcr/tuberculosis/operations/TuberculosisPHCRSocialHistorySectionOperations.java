...
public class TuberculosisPHCRSocialHistorySectionOperations extends PhcrSocialHistorySectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_HIV_STATUS_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(tuberculosis::HIVStatusObservation))->asSequence()->any(true).oclAsType(tuberculosis::HIVStatusObservation)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(tuberculosis::HIVStatusObservation))->asSequence()->any(true).oclAsType(tuberculosis::HIVStatusObservation)
	 * @param tuberculosisPHCRSocialHistorySection The receiving '<em><b>PHCR Social History Section</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
