...
public class TuberculosisCDAValidate {
	...
	public static TuberculosisFactory Tuberculosis = TuberculosisFactory.eINSTANCE;
	...
	public static void main(String[] args) throws Exception {
		...
		TuberculosisCaseReport document = (TuberculosisCaseReport) CDAUtil.load(inputStream, result);
		inputStream.close();
