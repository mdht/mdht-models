 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation statusCode.code='completed' code.codeSystem='2.16.840.1.113883.6.96' templateId.root='2.16.840.1.113883.10.20.15.3.31' constraints.validation.error='AcuteHepatitisBRiskAssociatedProcedureTemplateId AcuteHepatitisBRiskAssociatedProcedureClassCode AcuteHepatitisBRiskAssociatedProcedureCode AcuteHepatitisBRiskAssociatedProcedureMoodCode AcuteHepatitisBRiskAssociatedProcedureStatusCode' code.codeSystemName='SNOMEDCT' constraints.validation.warning='AcuteHepatitisBRiskAssociatedProcedureEffectiveTime' classCode='PROC' moodCode='EVN'"
 * @generated
 */
