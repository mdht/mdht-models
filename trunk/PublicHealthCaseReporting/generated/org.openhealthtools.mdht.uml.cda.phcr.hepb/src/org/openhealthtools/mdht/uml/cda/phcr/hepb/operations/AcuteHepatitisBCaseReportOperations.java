...
public class AcuteHepatitisBCaseReportOperations extends PublicHealthCaseReportOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_ACUTE_HEPATITIS_BSOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(hepb::AcuteHepatitisBSocialHistorySection))->asSequence()->first().oclAsType(hepb::AcuteHepatitisBSocialHistorySection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_ACUTE_HEPATITIS_BPHCR_CLINICAL_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(hepb::AcuteHepatitisBPHCRClinicalInformationSection))->asSequence()->first().oclAsType(hepb::AcuteHepatitisBPHCRClinicalInformationSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_ACUTE_HEPATITIS_BIMMUNIZATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(hepb::AcuteHepatitisBImmunizationSection))->asSequence()->first().oclAsType(hepb::AcuteHepatitisBImmunizationSection)";
