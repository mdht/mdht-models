...
public class AcuteHepatitisBCaseReportOperations extends PublicHealthCaseReportOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HepbPackage.Literals.ACUTE_HEPATITIS_BCASE_REPORT, HepbPackage.Literals.ACUTE_HEPATITIS_BCASE_REPORT.getEAllOperations().get(70));
      try
      {
