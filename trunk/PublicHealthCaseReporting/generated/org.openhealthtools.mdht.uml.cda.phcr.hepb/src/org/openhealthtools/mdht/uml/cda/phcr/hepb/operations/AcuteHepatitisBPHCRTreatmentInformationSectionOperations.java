...
public class AcuteHepatitisBPHCRTreatmentInformationSectionOperations extends PhcrTreatmentInformationSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_ACUTE_HEPATITIS_BTHERAPEUTIC_REGIMEN_ACT__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(hepb::AcuteHepatitisBTherapeuticRegimenAct))->asSequence()->first().oclAsType(hepb::AcuteHepatitisBTherapeuticRegimenAct)";
	...
	public static  AcuteHepatitisBTherapeuticRegimenAct getAcuteHepatitisBTherapeuticRegimenAct(AcuteHepatitisBPHCRTreatmentInformationSection acuteHepatitisBPHCRTreatmentInformationSection) {
		if (GET_ACUTE_HEPATITIS_BTHERAPEUTIC_REGIMEN_ACT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(HepbPackage.Literals.ACUTE_HEPATITIS_BPHCR_TREATMENT_INFORMATION_SECTION, HepbPackage.Literals.ACUTE_HEPATITIS_BPHCR_TREATMENT_INFORMATION_SECTION.getEAllOperations().get(62));
			try {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.15.2.10')
	 * @param acuteHepatitisBPHCRTreatmentInformationSection The receiving '<em><b>Acute Hepatitis BPHCR Treatment Information Section</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
