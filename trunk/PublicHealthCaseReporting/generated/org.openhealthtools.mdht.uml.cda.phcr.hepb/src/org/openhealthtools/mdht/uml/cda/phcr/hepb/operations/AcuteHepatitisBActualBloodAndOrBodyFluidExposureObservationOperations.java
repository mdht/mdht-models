 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.hepb.AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation#validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BActual Blood And Or Body Fluid Exposure Observation Code P</em>}</li>
 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.hepb.AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation#validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BActual Blood And Or Body Fluid Exposure Observation Status Code P</em>}</li>
...
public class AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationOperations extends ClinicalStatementOperations {
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BActual Blood And Or Body Fluid Exposure Observation Code P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

  /**
   * The cached OCL invariant for the '{@link #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BActual Blood And Or Body Fluid Exposure Observation Code P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HepbPackage.Literals.ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION);
      try
      {
        VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             HepbValidator.DIAGNOSTIC_SOURCE,
             HepbValidator.ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION__ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_CODE_P,
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, context) }),
             new Object [] { acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation }));
      }
...
"value.code = 'completed')";
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BActual Blood And Or Body Fluid Exposure Observation Status Code P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.oclIsUndefined() or self.statusCode.isNullFlavorUndefined()) implies (not self.statusCode.oclIsUndefined())";

  /**
   * The cached OCL invariant for the '{@link #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BActual Blood And Or Body Fluid Exposure Observation Status Code P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateAcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP(AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservation acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HepbPackage.Literals.ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION);
      try
      {
        VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             HepbValidator.DIAGNOSTIC_SOURCE,
             HepbValidator.ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION__ACUTE_HEPATITIS_BACTUAL_BLOOD_AND_OR_BODY_FLUID_EXPOSURE_OBSERVATION_STATUS_CODE_P,
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "AcuteHepatitisBActualBloodAndOrBodyFluidExposureObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation, context) }),
             new Object [] { acuteHepatitisBActualBloodAndOrBodyFluidExposureObservation }));
      }
