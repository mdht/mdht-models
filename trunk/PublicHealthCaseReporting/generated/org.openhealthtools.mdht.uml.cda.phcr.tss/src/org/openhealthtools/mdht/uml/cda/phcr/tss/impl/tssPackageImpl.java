		...
		addAnnotation
		  (tssCaseObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "TssCaseObservationTemplateId CaseObservationValue",
		...
		addAnnotation
		  (tssSignsAndSymptomsObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "TssSignsAndSymptomsObservationTemplateId"
		   });			
		addAnnotation
		...
		addAnnotation
		  (tssResultOrganizerEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "TssResultOrganizerTemplateId ResultOrganizerCode TssResultOrganizerTssResultObservation",
			 "code.codeSystemName", ""
		   });									
		addAnnotation
		  (tssResultObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "TssResultObservationTemplateId ResultObservationCode",
			 "code.codeSystemName", ""
		   });	
	}
