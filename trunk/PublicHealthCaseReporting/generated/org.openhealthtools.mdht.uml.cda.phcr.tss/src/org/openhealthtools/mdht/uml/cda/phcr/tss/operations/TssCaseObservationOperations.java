 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.tss.TssCaseObservation#validateCaseObservationValue(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TssCaseObservationOperations extends CaseObservationOperations {
	...
	public static  EList<TssSignsAndSymptomsObservation> getTssSignsAndSymptomsObservations(TssCaseObservation tssCaseObservation) {
		if (GET_TSS_SIGNS_AND_SYMPTOMS_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(tssPackage.Literals.TSS_CASE_OBSERVATION, tssPackage.Literals.TSS_CASE_OBSERVATION.getEAllOperations().get(77));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateCaseObservationValue(TssCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Value</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCaseObservationValue(TssCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.code = '240450004' and value.codeSystem = '2.16.840.1.113883.6.96'))";
	...
	/**
	 * The cached OCL invariant for the '{@link #validateCaseObservationValue(TssCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Value</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCaseObservationValue(TssCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateCaseObservationValue(TssCaseObservation tssCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(tssCaseObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 tssValidator.DIAGNOSTIC_SOURCE,
						 tssValidator.TSS_CASE_OBSERVATION__CASE_OBSERVATION_VALUE,
						 TssPlugin.INSTANCE.getString("CaseObservationValue"),
						 new Object [] { tssCaseObservation }));
			}
