 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.tss.TssResultOrganizer#validateResultOrganizerCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Organizer Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TssResultOrganizerOperations extends ResultOrganizerOperations {
	...
	public static  EList<TssResultObservation> getTssResultObservations(TssResultOrganizer tssResultOrganizer) {
		if (GET_TSS_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(tssPackage.Literals.TSS_RESULT_ORGANIZER, tssPackage.Literals.TSS_RESULT_ORGANIZER.getEAllOperations().get(73));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateResultOrganizerCode(TssResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Organizer Code</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResultOrganizerCode(TssResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.code = '23934-3' or value.code = '44880-3' or value.code = '25822-8' or value.code = '25823-6' or value.code = '23933-5' or value.code = '41855-8' or value.code = '25824-4' or value.code = '25825-1' or value.code = '51856-3' or value.code = '51863-9' or value.code = '23936-8' or value.code = '23935-0' or value.code = '50683-2' or value.code = '44881-1')))";
	...
	/**
	 * The cached OCL invariant for the '{@link #validateResultOrganizerCode(TssResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Organizer Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResultOrganizerCode(TssResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateResultOrganizerCode(TssResultOrganizer tssResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(tssResultOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 tssValidator.DIAGNOSTIC_SOURCE,
						 tssValidator.TSS_RESULT_ORGANIZER__RESULT_ORGANIZER_CODE,
						 TssPlugin.INSTANCE.getString("ResultOrganizerCode"),
						 new Object [] { tssResultOrganizer }));
			}
