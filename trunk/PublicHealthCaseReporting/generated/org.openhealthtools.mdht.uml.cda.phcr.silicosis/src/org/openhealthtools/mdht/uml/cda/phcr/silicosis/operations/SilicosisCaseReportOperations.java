...
public class SilicosisCaseReportOperations extends PublicHealthCaseReportOperations {
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String GET_SILICOSIS_PHCR_SOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRSocialHistorySection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRSocialHistorySection)";
	...
	public static  SilicosisPHCRSocialHistorySection getSilicosisPHCRSocialHistorySection(SilicosisCaseReport silicosisCaseReport) {
		if (GET_SILICOSIS_PHCR_SOCIAL_HISTORY_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(SilicosisPackage.Literals.SILICOSIS_CASE_REPORT, SilicosisPackage.Literals.SILICOSIS_CASE_REPORT.getEAllOperations().get(63));
			try {
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final String GET_SILICOSIS_PHCR_RELEVANT_DX_TESTS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRRelevantDxTestsSection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRRelevantDxTestsSection)";
  ...
  /**
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.15.1.8')
	 * @param silicosisCaseReport The receiving '<em><b>Case Report</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
