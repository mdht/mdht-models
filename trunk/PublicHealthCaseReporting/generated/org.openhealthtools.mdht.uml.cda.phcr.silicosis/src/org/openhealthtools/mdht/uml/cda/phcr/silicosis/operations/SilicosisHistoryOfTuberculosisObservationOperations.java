...
public class SilicosisHistoryOfTuberculosisObservationOperations extends ProblemObservationOperations
{
   ...
   * @ordered
   */
  protected static final String VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | not element.oclIsUndefined() and element.oclIsKindOf(datatypes::CD) and "+
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
  ...
  /**
   * The cached OCL expression body for the '{@link #validateSilicosisHistoryOfTuberculosisObservationValueP(SilicosisHistoryOfTuberculosisObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Silicosis History Of Tuberculosis Observation Value P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateSilicosisHistoryOfTuberculosisObservationValueP(SilicosisHistoryOfTuberculosisObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";

  /**
   * The cached OCL invariant for the '{@link #validateSilicosisHistoryOfTuberculosisObservationValueP(SilicosisHistoryOfTuberculosisObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Silicosis History Of Tuberculosis Observation Value P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateSilicosisHistoryOfTuberculosisObservationValueP(SilicosisHistoryOfTuberculosisObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateSilicosisHistoryOfTuberculosisObservationValueP(SilicosisHistoryOfTuberculosisObservation silicosisHistoryOfTuberculosisObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(silicosisHistoryOfTuberculosisObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
