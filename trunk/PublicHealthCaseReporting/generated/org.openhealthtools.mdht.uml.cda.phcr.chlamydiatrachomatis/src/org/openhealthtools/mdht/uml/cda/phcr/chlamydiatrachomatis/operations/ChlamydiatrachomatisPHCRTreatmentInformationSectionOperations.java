...
public class ChlamydiatrachomatisPHCRTreatmentInformationSectionOperations extends PhcrTreatmentInformationSectionOperations {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ChlamydiatrachomatisPlugin.INSTANCE.getString("ChlamydiatrachomatisPHCRTreatmentInformationSectionChlamydiatrachomatisTherapeuticRegimenAct"),
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(chlamydiatrachomatis::ChlamydiatrachomatisTherapeuticRegimenAct))->asSequence()->first().oclAsType(chlamydiatrachomatis::ChlamydiatrachomatisTherapeuticRegimenAct)
	 * @param chlamydiatrachomatisPHCRTreatmentInformationSection The receiving '<em><b>PHCR Treatment Information Section</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
	...
	public static  ChlamydiatrachomatisTherapeuticRegimenAct getChlamydiatrachomatisTherapeuticRegimenAct(ChlamydiatrachomatisPHCRTreatmentInformationSection chlamydiatrachomatisPHCRTreatmentInformationSection) {
		if (GET_CHLAMYDIATRACHOMATIS_THERAPEUTIC_REGIMEN_ACT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ChlamydiatrachomatisPackage.Literals.CHLAMYDIATRACHOMATIS_PHCR_TREATMENT_INFORMATION_SECTION, ChlamydiatrachomatisPackage.Literals.CHLAMYDIATRACHOMATIS_PHCR_TREATMENT_INFORMATION_SECTION.getEAllOperations().get(62));
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PhcrTreatmentInformationSectionTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(chlamydiatrachomatisPHCRTreatmentInformationSection, context) }),
						 new Object [] { chlamydiatrachomatisPHCRTreatmentInformationSection }));
			}
