		...
		addAnnotation
		  (chlamydiatrachomatisCaseObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "ChlamydiatrachomatisCaseObservationTemplateId CaseObservationValue",
		...
		addAnnotation
		  (chlamydiatrachomatisResultObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "ChlamydiatrachomatisResultObservationTemplateId"
		   });			
		addAnnotation
		  (chlamydiatrachomatisResultOrganizerEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "chlamydiatrachomatisResultOrganizerTemplateId"
		   });				
		addAnnotation
