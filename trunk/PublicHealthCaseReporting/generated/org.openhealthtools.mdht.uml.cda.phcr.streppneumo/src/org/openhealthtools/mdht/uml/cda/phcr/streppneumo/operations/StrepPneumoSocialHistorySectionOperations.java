...
public class StrepPneumoSocialHistorySectionOperations extends PhcrSocialHistorySectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_SOCIAL_HISTORY_SECTION, StrepPneumoPackage.Literals.STREP_PNEUMO_SOCIAL_HISTORY_SECTION.getEAllOperations().get(82));
      try
      {
