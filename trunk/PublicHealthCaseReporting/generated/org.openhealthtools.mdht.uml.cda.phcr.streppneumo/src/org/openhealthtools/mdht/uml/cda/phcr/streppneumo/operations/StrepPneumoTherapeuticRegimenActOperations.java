...
public class StrepPneumoTherapeuticRegimenActOperations extends TherapeuticRegimenActOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_THERAPEUTIC_REGIMEN_ACT, StrepPneumoPackage.Literals.STREP_PNEUMO_THERAPEUTIC_REGIMEN_ACT.getEAllOperations().get(65));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_THERAPEUTIC_REGIMEN_ACT, StrepPneumoPackage.Literals.STREP_PNEUMO_THERAPEUTIC_REGIMEN_ACT.getEAllOperations().get(66));
      try
      {
