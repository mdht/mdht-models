...
public class StrepPneumoPHCRTreatmentInformationSectionOperations extends PhcrTreatmentInformationSectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_PHCR_TREATMENT_INFORMATION_SECTION, StrepPneumoPackage.Literals.STREP_PNEUMO_PHCR_TREATMENT_INFORMATION_SECTION.getEAllOperations().get(63));
      try
      {
