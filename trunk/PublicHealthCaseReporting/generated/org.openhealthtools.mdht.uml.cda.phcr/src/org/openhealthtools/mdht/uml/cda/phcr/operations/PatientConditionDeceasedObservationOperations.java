				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PatientConditionDeceasedObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(patientConditionDeceasedObservation, context) }),
						 new Object [] { patientConditionDeceasedObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PatientConditionDeceasedObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(patientConditionDeceasedObservation, context) }),
						 new Object [] { patientConditionDeceasedObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PatientConditionDeceasedObservationValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(patientConditionDeceasedObservation, context) }),
						 new Object [] { patientConditionDeceasedObservation }));
			}
