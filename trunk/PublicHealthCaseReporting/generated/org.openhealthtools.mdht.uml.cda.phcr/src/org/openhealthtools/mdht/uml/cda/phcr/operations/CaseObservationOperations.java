 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.CaseObservation#validateCaseObservationCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Code P</em>}</li>
 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.CaseObservation#validateCaseObservationStatusCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Status Code P</em>}</li>
  ...
  public static  boolean validateCaseObservationCodeP(CaseObservation caseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(caseObservation)) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "CaseObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
						 new Object [] { caseObservation }));
			}
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.phcr.CaseObservationCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.phcr.CaseObservationCodeP", passToken);
				}
...
"value.code = 'ASSERTION' and value.codeSystem = '2.16.840.1.113883.5.4')";
	...
	public static  boolean validateCaseObservationCode(CaseObservation caseObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.phcr.CaseObservationCodeP");
  ...
  public static  boolean validateCaseObservationStatusCodeP(CaseObservation caseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(caseObservation)) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "CaseObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
						 new Object [] { caseObservation }));
			}
			...
			if (context != null) {
				// generate a pass token for my dependent constraints to short-circuit or filter results
				@SuppressWarnings("unchecked")
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.phcr.CaseObservationStatusCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.phcr.CaseObservationStatusCodeP", passToken);
				}
				passToken.add(caseObservation);
			}
...
"value.code = 'completed')";
	...
	public static  boolean validateCaseObservationStatusCode(CaseObservation caseObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.phcr.CaseObservationStatusCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(caseObservation)) {
			// I have a free pass to short-circuit
			return true;
		}
	...
	public static  EList<SignsAndSymptomsObservation> getSignsAndSymptomsObservations(CaseObservation caseObservation) {
		if (GET_SIGNS_AND_SYMPTOMS_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PhcrPackage.Literals.CASE_OBSERVATION, PhcrPackage.Literals.CASE_OBSERVATION.getEAllOperations().get(78));
			try {
