...
"value.code = '77386006' and value.codeSystem = '2.16.840.1.113883.6.96'))";
   ...
   * @ordered
   */
	protected static final String GET_ESTIMATED_DATE_OF_DELIVERY_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phcr::EstimatedDateOfDeliveryObservation))->asSequence()->any(true).oclAsType(phcr::EstimatedDateOfDeliveryObservation)";
