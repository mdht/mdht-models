...
public interface PregnancyObservation extends Observation {
   ...
   *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phcr::EstimatedDateOfDeliveryObservation))->asSequence()->any(true).oclAsType(phcr::EstimatedDateOfDeliveryObservation)'"
   * @generated
   */
