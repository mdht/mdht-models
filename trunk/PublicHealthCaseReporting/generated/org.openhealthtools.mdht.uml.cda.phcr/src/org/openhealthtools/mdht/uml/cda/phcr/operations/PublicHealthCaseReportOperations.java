				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PublicHealthCaseReportCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(publicHealthCaseReport, context) }),
						 new Object [] { publicHealthCaseReport }));
			}
...
"value.code = '55751-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
	 ...
	 * @ordered
	 */
	protected static final String GET_PHCR_SOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(phcr::PhcrSocialHistorySection))->asSequence()->any(true).oclAsType(phcr::PhcrSocialHistorySection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PHCR_CLINICAL_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(phcr::PhcrClinicalInformationSection))->asSequence()->any(true).oclAsType(phcr::PhcrClinicalInformationSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PHCR_TREATMENT_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(phcr::PhcrTreatmentInformationSection))->asSequence()->any(true).oclAsType(phcr::PhcrTreatmentInformationSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PHCR_ENCOUNTERS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(phcr::PhcrEncountersSection))->asSequence()->any(true).oclAsType(phcr::PhcrEncountersSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PHCR_RELEVANT_DX_TESTS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(phcr::PhcrRelevantDxTestsSection))->asSequence()->any(true).oclAsType(phcr::PhcrRelevantDxTestsSection)";
