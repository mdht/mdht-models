...
"value.code = '55752-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
	 ...
	 * @ordered
	 */
	protected static final String GET_CASE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phcr::CaseObservation))->asSequence()->first().oclAsType(phcr::CaseObservation)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PATIENT_CONDITION_ALIVE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phcr::PatientConditionAliveObservation))->asSequence()->first().oclAsType(phcr::PatientConditionAliveObservation)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PATIENT_CONDITION_DECEASED_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phcr::PatientConditionDeceasedObservation))->asSequence()->first().oclAsType(phcr::PatientConditionDeceasedObservation)";
