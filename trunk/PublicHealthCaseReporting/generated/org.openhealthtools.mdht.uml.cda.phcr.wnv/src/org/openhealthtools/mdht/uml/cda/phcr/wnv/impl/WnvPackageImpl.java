...
public class WnvPackageImpl extends EPackageImpl implements WnvPackage
{
  ...
  public static WnvPackage init()
  {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.phcr.wnv", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(theWnvPackage);
