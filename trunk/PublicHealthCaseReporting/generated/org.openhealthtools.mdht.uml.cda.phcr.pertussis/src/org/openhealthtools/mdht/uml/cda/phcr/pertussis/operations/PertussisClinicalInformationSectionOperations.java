...
public class PertussisClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
   ...
   * @ordered
   */
	protected static final String GET_PERTUSSIS_CASE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(pertussis::PertussisCaseObservation))->asSequence()->any(true).oclAsType(pertussis::PertussisCaseObservation)";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_CLINICAL_INFORMATION_SECTION, PertussisPackage.Literals.PERTUSSIS_CLINICAL_INFORMATION_SECTION.getEAllOperations().get(70));
      try
      {
