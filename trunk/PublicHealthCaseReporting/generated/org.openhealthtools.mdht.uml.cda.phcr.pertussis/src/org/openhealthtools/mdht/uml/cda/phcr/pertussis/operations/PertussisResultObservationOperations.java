 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.pertussis.PertussisResultObservation#validateResultObservationCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Observation Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PertussisResultObservationOperations extends ResultObservationOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateResultObservationCode(PertussisResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Observation Code</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResultObservationCode(PertussisResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.codeSystem = '2.16.840.1.113883.6.1' and not value.code.oclIsUndefined()))";
	...
	/**
	 * The cached OCL invariant for the '{@link #validateResultObservationCode(PertussisResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Observation Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResultObservationCode(PertussisResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateResultObservationCode(PertussisResultObservation pertussisResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(pertussisResultObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 PertussisValidator.DIAGNOSTIC_SOURCE,
						 PertussisValidator.PERTUSSIS_RESULT_OBSERVATION__RESULT_OBSERVATION_CODE,
						 PertussisPlugin.INSTANCE.getString("ResultObservationCode"),
						 new Object [] { pertussisResultObservation }));
			}
