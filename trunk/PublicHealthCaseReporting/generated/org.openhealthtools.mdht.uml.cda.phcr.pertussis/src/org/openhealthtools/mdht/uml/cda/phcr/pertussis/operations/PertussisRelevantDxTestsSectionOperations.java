...
public class PertussisRelevantDxTestsSectionOperations extends PhcrRelevantDxTestsSectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_RELEVANT_DX_TESTS_SECTION, PertussisPackage.Literals.PERTUSSIS_RELEVANT_DX_TESTS_SECTION.getEAllOperations().get(73));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_RELEVANT_DX_TESTS_SECTION, PertussisPackage.Literals.PERTUSSIS_RELEVANT_DX_TESTS_SECTION.getEAllOperations().get(74));
      try
      {
