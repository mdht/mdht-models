 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.15.2.26' constraints.validation.error='PertussisTreatmentInformationSectionTemplateId PertussisTreatmentInformationSectionPertussisTherapeuticRegimen'"
 * @generated
 */
public interface PertussisTreatmentInformationSection extends PhcrTreatmentInformationSection {
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(pertussis::PertussisTherapeuticRegimenAct))->asSequence()->first().oclAsType(pertussis::PertussisTherapeuticRegimenAct)'"
	 * @generated
	 */
