...
public class PertussisTreatmentInformationSectionOperations extends PhcrTreatmentInformationSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_PERTUSSIS_THERAPEUTIC_REGIMEN__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(pertussis::PertussisTherapeuticRegimenAct))->asSequence()->first().oclAsType(pertussis::PertussisTherapeuticRegimenAct)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(pertussis::PertussisTherapeuticRegimenAct))->asSequence()->first().oclAsType(pertussis::PertussisTherapeuticRegimenAct)
	 * @param pertussisTreatmentInformationSection The receiving '<em><b>Treatment Information Section</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
	...
	public static  PertussisTherapeuticRegimenAct getPertussisTherapeuticRegimen(PertussisTreatmentInformationSection pertussisTreatmentInformationSection) {
		if (GET_PERTUSSIS_THERAPEUTIC_REGIMEN__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_TREATMENT_INFORMATION_SECTION, PertussisPackage.Literals.PERTUSSIS_TREATMENT_INFORMATION_SECTION.getEAllOperations().get(62));
			try {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.15.2.26')
	 * @param pertussisTreatmentInformationSection The receiving '<em><b>Treatment Information Section</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
