...
public class PertussisResultOrganizerOperations extends ResultOrganizerOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_RESULT_ORGANIZER, PertussisPackage.Literals.PERTUSSIS_RESULT_ORGANIZER.getEAllOperations().get(76));
      try
      {
