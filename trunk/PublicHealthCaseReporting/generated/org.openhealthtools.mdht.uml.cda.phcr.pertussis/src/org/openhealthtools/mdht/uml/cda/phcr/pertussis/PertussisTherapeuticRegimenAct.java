 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.15.3.67' constraints.validation.error='PertussisTherapeuticRegimenActTemplateId' constraints.validation.warning='PertussisTherapeuticRegimenActPertussisTreatmentGivenSubstanceAdministration' constraints.validation.info='PertussisTherapeuticRegimenActPertussisTreatmentNotGivenSubstanceAdministration'"
 * @generated
 */
public interface PertussisTherapeuticRegimenAct extends TherapeuticRegimenAct {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getSubstanceAdministrations()->select(substanceAdministration : cda::SubstanceAdministration | not substanceAdministration.oclIsUndefined() and substanceAdministration.oclIsKindOf(pertussis::PertussisTreatmentGivenSubstanceAdministration)).oclAsType(pertussis::PertussisTreatmentGivenSubstanceAdministration)
	 * <!-- end-model-doc -->
