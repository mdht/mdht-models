...
public class PertussisSocialHistorySectionOperations extends PhcrSocialHistorySectionOperations
{
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_SOCIAL_HISTORY_SECTION, PertussisPackage.Literals.PERTUSSIS_SOCIAL_HISTORY_SECTION.getEAllOperations().get(83));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(PertussisPackage.Literals.PERTUSSIS_SOCIAL_HISTORY_SECTION, PertussisPackage.Literals.PERTUSSIS_SOCIAL_HISTORY_SECTION.getEAllOperations().get(84));
      try
      {
