...
public interface HibCaseObservation extends CaseObservation {
	 ...
	 * @generated
	 */
	boolean validateHibCaseObservationHibSignsAndSymptoms(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(hib::HibSignsAndSymptoms)).oclAsType(hib::HibSignsAndSymptoms)'"
	 * @generated
	 */
	EList<HibSignsAndSymptoms> getHibSignsAndSymptomss();
