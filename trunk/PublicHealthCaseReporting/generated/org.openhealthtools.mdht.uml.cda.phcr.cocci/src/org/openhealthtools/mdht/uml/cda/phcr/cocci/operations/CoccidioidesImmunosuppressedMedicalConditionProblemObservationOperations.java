...
public class CoccidioidesImmunosuppressedMedicalConditionProblemObservationOperations extends ProblemObservationOperations {
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateCoccidioidesImmunosuppressedMedicalConditionProblemObservationValue(CoccidioidesImmunosuppressedMedicalConditionProblemObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Immunosuppressed Medical Condition Problem Observation Value</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesImmunosuppressedMedicalConditionProblemObservationValue(CoccidioidesImmunosuppressedMedicalConditionProblemObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_COCCIDIOIDES_IMMUNOSUPPRESSED_MEDICAL_CONDITION_PROBLEM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";

  /**
   * The cached OCL invariant for the '{@link #validateCoccidioidesImmunosuppressedMedicalConditionProblemObservationValue(CoccidioidesImmunosuppressedMedicalConditionProblemObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Immunosuppressed Medical Condition Problem Observation Value</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesImmunosuppressedMedicalConditionProblemObservationValue(CoccidioidesImmunosuppressedMedicalConditionProblemObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_COCCIDIOIDES_IMMUNOSUPPRESSED_MEDICAL_CONDITION_PROBLEM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateCoccidioidesImmunosuppressedMedicalConditionProblemObservationValue(CoccidioidesImmunosuppressedMedicalConditionProblemObservation coccidioidesImmunosuppressedMedicalConditionProblemObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_COCCIDIOIDES_IMMUNOSUPPRESSED_MEDICAL_CONDITION_PROBLEM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_COCCIDIOIDES_IMMUNOSUPPRESSED_MEDICAL_CONDITION_PROBLEM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_COCCIDIOIDES_IMMUNOSUPPRESSED_MEDICAL_CONDITION_PROBLEM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_COCCIDIOIDES_IMMUNOSUPPRESSED_MEDICAL_CONDITION_PROBLEM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coccidioidesImmunosuppressedMedicalConditionProblemObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
