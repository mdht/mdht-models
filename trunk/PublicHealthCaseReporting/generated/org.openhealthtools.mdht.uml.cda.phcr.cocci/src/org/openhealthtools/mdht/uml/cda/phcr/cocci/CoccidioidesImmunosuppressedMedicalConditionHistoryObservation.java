 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.15.3.94' constraints.validation.error='CoccidioidesImmunosuppressedMedicalConditionHistoryObservationTemplateId' constraints.validation.warning='CoccidioidesImmunosuppressedMedicalConditionHistoryObservationCoccidioidesImmunosuppressedMedicalConditionProblemObservation'"
 * @generated
 */
public interface CoccidioidesImmunosuppressedMedicalConditionHistoryObservation extends PhcrRelevantMedicalConditionHistoryObservation {
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(cocci::CoccidioidesImmunosuppressedMedicalConditionProblemObservation))->asSequence()->first().oclAsType(cocci::CoccidioidesImmunosuppressedMedicalConditionProblemObservation)'"
	 * @generated
	 */
