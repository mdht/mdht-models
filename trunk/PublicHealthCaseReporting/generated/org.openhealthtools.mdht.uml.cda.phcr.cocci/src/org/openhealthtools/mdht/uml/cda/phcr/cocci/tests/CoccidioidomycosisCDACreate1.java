...
public class CoccidioidomycosisCDACreate1 {
	...
	public static String TIME_STAMP_REPORT = "20110810090000-0700";
	...
	public static String UUID = "b48d37ef-afd4-448f-8098-2ad4f6e7ab13";
...
//			}		
		...
		File fileOut = new File(filePathOut, "CoccidioidomycosisSampleCDA1.xml");
	...
	public static void setClinicalInformationSection(PublicHealthCaseReport document) throws Exception {
		...
		// Patient Condition (Alive) Observation (MAY) 0..1
		IVL_TS patientConditionTS = Datatypes.createIVL_TS(TIME_STAMP_ENCOUNTER2);		
		String patientConditionSectionText = "Patient is alive " + timeStampFormat(TIME_STAMP_ENCOUNTER2, TEST_DATE_FORMAT);
	...
	public static void setTreatmentInformationSection(PublicHealthCaseReport document) throws Exception {
		...
		if (hasTreatmentInformation) {
			...
			String treatmentNotGivenSectionText1 = "Not prescribed " + materialCode.getDisplayName() + " at this time";
				
			CoccidioidesTreatmentNotGivenSubstanceAdministration treatmentNotGivenSBADM = COCCI.createCoccidioidesTreatmentNotGivenSubstanceAdministration().init();
			treatmentNotGivenSBADM.setNegationInd(true);
	...
	public static void setDxTestsSection(PublicHealthCaseReport document) throws Exception {
		...
		timeStampFormat(TIME_STAMP_ENCOUNTER2, TEST_DATE_FORMAT) + " - radiologic infiltrate";
		
		File imageMediaFile = new File("samples/pneumonia1.jpg");
