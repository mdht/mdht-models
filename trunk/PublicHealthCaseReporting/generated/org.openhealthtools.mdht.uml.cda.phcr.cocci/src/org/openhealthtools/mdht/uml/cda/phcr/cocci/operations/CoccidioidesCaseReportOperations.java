...
public class CoccidioidesCaseReportOperations extends PublicHealthCaseReportOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_COCCIDIOIDES_PHCR_SOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(cocci::CoccidioidesPHCRSocialHistorySection))->asSequence()->first().oclAsType(cocci::CoccidioidesPHCRSocialHistorySection)";
	...
	public static  CoccidioidesPHCRSocialHistorySection getCoccidioidesPHCRSocialHistorySection(CoccidioidesCaseReport coccidioidesCaseReport) {
		if (GET_COCCIDIOIDES_PHCR_SOCIAL_HISTORY_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CocciPackage.Literals.COCCIDIOIDES_CASE_REPORT, CocciPackage.Literals.COCCIDIOIDES_CASE_REPORT.getEAllOperations().get(64));
			try {
	 ...
	 * @ordered
	 */
	protected static final String GET_COCCIDIOIDES_PHCR_TREATMENT_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(cocci::CoccidioidesPHCRTreatmentInformationSection))->asSequence()->first().oclAsType(cocci::CoccidioidesPHCRTreatmentInformationSection)";
