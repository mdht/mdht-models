...
public class CoccidioidesSignsAndSymptomsObservationOperations extends SignsAndSymptomsObservationOperations {
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateCoccidioidesSignsAndSymptomsObservationValue(CoccidioidesSignsAndSymptomsObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Signs And Symptoms Observation Value</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesSignsAndSymptomsObservationValue(CoccidioidesSignsAndSymptomsObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_COCCIDIOIDES_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (not self.value->isEmpty())";

  /**
   * The cached OCL invariant for the '{@link #validateCoccidioidesSignsAndSymptomsObservationValue(CoccidioidesSignsAndSymptomsObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Signs And Symptoms Observation Value</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesSignsAndSymptomsObservationValue(CoccidioidesSignsAndSymptomsObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_COCCIDIOIDES_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateCoccidioidesSignsAndSymptomsObservationValue(CoccidioidesSignsAndSymptomsObservation coccidioidesSignsAndSymptomsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (VALIDATE_COCCIDIOIDES_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
    {
      ...
      try
      {
        VALIDATE_COCCIDIOIDES_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_COCCIDIOIDES_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_COCCIDIOIDES_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coccidioidesSignsAndSymptomsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
