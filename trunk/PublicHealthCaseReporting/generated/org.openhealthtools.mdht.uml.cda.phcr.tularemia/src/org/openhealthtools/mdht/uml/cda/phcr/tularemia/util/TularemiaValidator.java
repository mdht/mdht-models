...
public class TularemiaValidator extends EObjectValidator {
   ...
   */
	...
	/**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Tularemia Result Organizer Code P' of 'Result Organizer'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int TULAREMIA_RESULT_ORGANIZER__TULAREMIA_RESULT_ORGANIZER_CODE_P = 46;
   ...
   * @generated
   */
	public static final int TULAREMIA_RESULT_ORGANIZER__TULAREMIA_RESULT_ORGANIZER_CODE = 47;
   ...
   * @generated
   */
	public static final int TULAREMIA_RESULT_ORGANIZER__TULAREMIA_RESULT_ORGANIZER_TULAREMIA_RESULT_OBSERVATION = 48;
   ...
   * @generated
   */
	public static final int TULAREMIA_RESULT_ORGANIZER__RESULT_ORGANIZER_TEMPLATE_ID = 49;

	/**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Tularemia Result Observation Code P' of 'Result Observation'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int TULAREMIA_RESULT_OBSERVATION__TULAREMIA_RESULT_OBSERVATION_CODE_P = 50;
   ...
   * @generated
   */
	public static final int TULAREMIA_RESULT_OBSERVATION__TULAREMIA_RESULT_OBSERVATION_CODE = 51;
   ...
   * @generated
   */
	public static final int TULAREMIA_RESULT_OBSERVATION__RESULT_OBSERVATION_TEMPLATE_ID = 52;
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateSocialHistorySection_validateSocialHistorySectionCode(tularemiaPHCRSocialHistorySection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrSocialHistorySection_validatePhcrSocialHistorySectionCodeP(tularemiaPHCRSocialHistorySection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationStatusCode(tularemiaCaseObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateCaseObservationCodeP(tularemiaCaseObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateCaseObservationStatusCodeP(tularemiaCaseObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateResultsSection_validateResultsSectionCode(tularemiaPHCRRelevantDxTestsSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrRelevantDxTestsSection_validatePhcrRelevantDxTestsSectionCodeP(tularemiaPHCRRelevantDxTestsSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateResultOrganizer_validateResultOrganizerCode(tularemiaResultOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateResultOrganizer_validateResultOrganizerStatusCode(tularemiaResultOrganizer, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateResultOrganizer_validatePHCRResultOrganizerStatusCodeP(tularemiaResultOrganizer, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateTularemiaResultOrganizer_validateTularemiaResultOrganizerCodeP(tularemiaResultOrganizer, diagnostics, context);
	...
	/**
   * Validates the validateTularemiaResultOrganizerCodeP constraint of '<em>Result Organizer</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateTularemiaResultOrganizer_validateTularemiaResultOrganizerCodeP(TularemiaResultOrganizer tularemiaResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return tularemiaResultOrganizer.validateTularemiaResultOrganizerCodeP(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateResultObservation_validateResultObservationStatusCode(tularemiaResultObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateResultObservation_validateResultObservationCode(tularemiaResultObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateResultObservation_validatePHCRResultObservationStatusCodeP(tularemiaResultObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateTularemiaResultObservation_validateTularemiaResultObservationCodeP(tularemiaResultObservation, diagnostics, context);
	...
	/**
   * Validates the validateTularemiaResultObservationCodeP constraint of '<em>Result Observation</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateTularemiaResultObservation_validateTularemiaResultObservationCodeP(TularemiaResultObservation tularemiaResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return tularemiaResultObservation.validateTularemiaResultObservationCodeP(diagnostics, context);
  }
