 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation statusCode.code='completed' code.codeSystem='2.16.840.1.113883.5.4' templateId.root='2.16.840.1.113883.10.20.15.3.44' constraints.validation.error='LocationOfLesionObservationTemplateId LocationOfLesionObservationClassCode LocationOfLesionObservationMoodCode LocationOfLesionObservationCode LocationOfLesionObservationCodeP LocationOfLesionObservationStatusCode LocationOfLesionObservationStatusCodeP LocationOfLesionObservationValue LocationOfLesionObservationTargetSiteCode' code.codeSystemName='HL7ActCode' constraints.validation.warning='LocationOfLesionObservationEffectiveTime' classCode='OBS' code.code='ASSERTION' moodCode='EVN' constraints.validation.dependOn.LocationOfLesionObservationCode='LocationOfLesionObservationCodeP'"
 * @generated
 */
public interface LocationOfLesionObservation extends Observation
{
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.15.3.44')
