...
"value.codeSystem = '2.16.840.1.113883.6.1' and not value.code.oclIsUndefined())";
  ...
  public static  EList<TularemiaResultObservation> getTularemiaResultObservations(TularemiaResultOrganizer tularemiaResultOrganizer)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(TularemiaPackage.Literals.TULAREMIA_RESULT_ORGANIZER, TularemiaPackage.Literals.TULAREMIA_RESULT_ORGANIZER.getEAllOperations().get(77));
      try
      {
