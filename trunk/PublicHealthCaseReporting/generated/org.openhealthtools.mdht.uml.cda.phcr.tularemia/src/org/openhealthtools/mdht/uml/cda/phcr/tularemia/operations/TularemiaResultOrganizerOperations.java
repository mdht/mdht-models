...
public class TularemiaResultOrganizerOperations extends ResultOrganizerOperations
{
  ...
  /**
	 * The cached OCL expression body for the '{@link #validateTularemiaResultOrganizerCodeP(TularemiaResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Tularemia Result Organizer Code P</em>}' operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #validateTularemiaResultOrganizerCodeP(TularemiaResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
  protected static final String VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

  /**
	 * The cached OCL invariant for the '{@link #validateTularemiaResultOrganizerCodeP(TularemiaResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Tularemia Result Organizer Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #validateTularemiaResultOrganizerCodeP(TularemiaResultOrganizer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
  ...
  protected static Constraint VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateTularemiaResultOrganizerCodeP(TularemiaResultOrganizer tularemiaResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
		if (VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(TularemiaPackage.Literals.TULAREMIA_RESULT_ORGANIZER);
			try {
				VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(tularemiaResultOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TularemiaValidator.DIAGNOSTIC_SOURCE,
						 TularemiaValidator.TULAREMIA_RESULT_ORGANIZER__TULAREMIA_RESULT_ORGANIZER_CODE_P,
						 TularemiaPlugin.INSTANCE.getString("TularemiaResultOrganizerCodeP"),
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultOrganizerCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultOrganizerCodeP", passToken);
				}
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TULAREMIA_RESULT_ORGANIZER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined() and self.code.oclIsKindOf(datatypes::CD) and "+
...
"value.codeSystem = '2.16.840.1.113883.6.1' and not value.code.oclIsUndefined())";
	...
	public static  boolean validateTularemiaResultOrganizerCode(TularemiaResultOrganizer tularemiaResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultOrganizerCodeP");
  ...
  public static  EList<TularemiaResultObservation> getTularemiaResultObservations(TularemiaResultOrganizer tularemiaResultOrganizer)
  {
		if (GET_TULAREMIA_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(TularemiaPackage.Literals.TULAREMIA_RESULT_ORGANIZER, TularemiaPackage.Literals.TULAREMIA_RESULT_ORGANIZER.getEAllOperations().get(76));
			try {
