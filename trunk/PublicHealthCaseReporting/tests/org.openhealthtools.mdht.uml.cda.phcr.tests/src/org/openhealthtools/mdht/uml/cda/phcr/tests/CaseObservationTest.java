...
public class CaseObservationTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateCaseObservationId() {
      ...
      operationsForOCL.getOCLValue("VALIDATE_CASE_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
      ,objectFactory) {
...
public void testValidateCaseObservationCodeP() {
      OperationsTestCase<CaseObservation> validateCaseObservationCodePTestCase = new OperationsTestCase<CaseObservation>(
      "validateCaseObservationCodeP",
      operationsForOCL.getOCLValue("VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
      ,objectFactory) {
      ...
      protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
        ...
        return CaseObservationOperations.validateCaseObservationCodeP(
          (CaseObservation) objectToTest, diagnostician, map);
      }

    };

    validateCaseObservationCodePTestCase.doValidationTest();
}
...
public void testValidateCaseObservationStatusCodeP() {
      OperationsTestCase<CaseObservation> validateCaseObservationStatusCodePTestCase = new OperationsTestCase<CaseObservation>(
      "validateCaseObservationStatusCodeP",
      operationsForOCL.getOCLValue("VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
      ,objectFactory) {
      ...
      protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
        ...
        return CaseObservationOperations.validateCaseObservationStatusCodeP(
          (CaseObservation) objectToTest, diagnostician, map);
      }

    };

    validateCaseObservationStatusCodePTestCase.doValidationTest();
}
