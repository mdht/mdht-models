 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.info='EarsSectionProblemEntry' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.21' constraints.validation.error='EarsSectionTemplateId EarsSectionCode' code.displayName='EAR' code.codeSystem='2.16.840.1.113883.6.1' code.code='10195-6'"
 * @generated
 */
