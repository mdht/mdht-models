...
public void testValidateMandatoryEntryAssignedAuthorTemplateId() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_ENTRY_ASSIGNED_AUTHOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryEntryAssignedAuthorAssignedAuthoringDevice() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_ENTRY_ASSIGNED_AUTHOR_ASSIGNED_AUTHORING_DEVICE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryEntryAssignedAuthorAssignedPerson() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_ENTRY_ASSIGNED_AUTHOR_ASSIGNED_PERSON__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryEntryAssignedAuthorRepresentedOrganization() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_ENTRY_ASSIGNED_AUTHOR_REPRESENTED_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
