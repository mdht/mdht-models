...
public class ConfidentialitySecurityObservationTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateConfidentialitySecurityObservationValueP() {
		OperationsTestCase<ConfidentialitySecurityObservation> validateConfidentialitySecurityObservationValuePTestCase = new OperationsTestCase<ConfidentialitySecurityObservation>(
			"validateConfidentialitySecurityObservationValueP",
		...
		validateConfidentialitySecurityObservationValuePTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateConfidentialitySecurityObservationValue() {
		OperationsTestCase<ConfidentialitySecurityObservation> validateConfidentialitySecurityObservationValueTestCase = new OperationsTestCase<ConfidentialitySecurityObservation>(
			"validateConfidentialitySecurityObservationValue", operationsForOCL.getOCLValue(
			...
			protected void updateToPass(ConfidentialitySecurityObservation target) {
				...
				CE value = DatatypesFactory.eINSTANCE.createCE("NORDSCLCD", "2.16.840.1.113883.5.25");
			...
			protected void setDependency(ConfidentialitySecurityObservation target) {
				...
				map.put("org.hl7.security.ds4p.contentprofile.ConfidentialitySecurityObservationValueP", passToken);
			}
		...
		validateConfidentialitySecurityObservationValueTestCase.doValidationTest();
	}
