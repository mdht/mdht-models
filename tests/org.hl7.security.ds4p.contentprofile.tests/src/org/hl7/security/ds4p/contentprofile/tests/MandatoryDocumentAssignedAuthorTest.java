...
public void testValidateMandatoryDocumentAssignedAuthorTemplateId() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_ASSIGNED_AUTHOR_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryDocumentAssignedAuthorTelecomEmail() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_ASSIGNED_AUTHOR_TELECOM_EMAIL__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryDocumentAssignedAuthorAssignedAuthoringDevice() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_ASSIGNED_AUTHOR_ASSIGNED_AUTHORING_DEVICE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryDocumentAssignedAuthorAssignedPerson() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_ASSIGNED_AUTHOR_ASSIGNED_PERSON__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryDocumentAssignedAuthorRepresentedOrganization() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_ASSIGNED_AUTHOR_REPRESENTED_ORGANIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
