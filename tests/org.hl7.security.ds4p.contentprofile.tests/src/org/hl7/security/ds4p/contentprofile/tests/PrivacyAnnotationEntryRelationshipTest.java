...
public void testValidatePrivacyAnnotationEntryRelationshipTemplateId() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_ANNOTATION_ENTRY_RELATIONSHIP_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidatePrivacyAnnotationEntryRelationshipOrganizer() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_ANNOTATION_ENTRY_RELATIONSHIP_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
