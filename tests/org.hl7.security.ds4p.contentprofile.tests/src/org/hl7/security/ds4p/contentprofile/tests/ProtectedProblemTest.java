...
public void testValidateProtectedProblemProblemProvenance() {
			...
			"validateProtectedProblemProblemProvenance",
			operationsForOCL.getOCLValue("VALIDATE_PROTECTED_PROBLEM_PROBLEM_PROVENANCE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateProtectedProblemPrivacyAnnotations() {
			...
			"validateProtectedProblemPrivacyAnnotations",
			operationsForOCL.getOCLValue("VALIDATE_PROTECTED_PROBLEM_PRIVACY_ANNOTATIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
