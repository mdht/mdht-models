...
public void testValidatePrivacySegmentedDocumentTemplateId() {
			...
			"validatePrivacySegmentedDocumentTemplateId",
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidatePrivacySegmentedDocumentSegmentedSection() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_SEGMENTED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected void updateToPass(PrivacySegmentedDocument target) {
				...
				/* SegmentedSection */ 
				SegmentedSection section =
				
				CONTENTPROFILEFactory.eINSTANCE.createSegmentedSection().init(); 
...
public void testValidatePrivacySegmentedDocumentPrivacyAndSecurityMarkingsSection() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_PRIVACY_AND_SECURITY_MARKINGS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected void updateToPass(PrivacySegmentedDocument target) {
				...
				PrivacyAndSecurityMarkingsSection section =
				
				CONTENTPROFILEFactory.eINSTANCE.createPrivacyAndSecurityMarkingsSection().init(); 
