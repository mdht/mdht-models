 ...
 */
 @RunWith(Suite.class)
@Suite.SuiteClasses({
  	PrivacySegmentedDocumentTest.class
  	,PrivacySegmentedSectionTest.class
  	,PrivacyMarkingsSectionTest.class
  	,ObligationPolicySecurityObservationTest.class
  	,MandatoryDocumentProvenanceTest.class
  	,MandatoryDocumentAssignedAuthorTest.class
  	,PrivacyAnnotationTest.class
  	...
  	,ProtectedProblemTest.class
  	,MandatoryEntryProvenanceTest.class
  	,MandatoryEntryAssignedAuthorTest.class
  	,PrivacyAnnotationEntryRelationshipTest.class
