...
public void testValidateMandatoryDocumentProvenanceTemplateId() {
			...
			"validateMandatoryDocumentProvenanceTemplateId",
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_PROVENANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryDocumentProvenanceAssignedAuthor() {
			...
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_DOCUMENT_PROVENANCE_ASSIGNED_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
