...
public void testValidatePrivacyAnnotationObligationPolicySecurityObservation() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_ANNOTATION_OBLIGATION_POLICY_SECURITY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidatePrivacyAnnotationRefrainPolicySecurityObservation() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_ANNOTATION_REFRAIN_POLICY_SECURITY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidatePrivacyAnnotationPurposeOfUseSecurityObservation() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_ANNOTATION_PURPOSE_OF_USE_SECURITY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidatePrivacyAnnotationConfidentialityCodeSecurityObservation() {
			...
			operationsForOCL.getOCLValue("VALIDATE_PRIVACY_ANNOTATION_CONFIDENTIALITY_CODE_SECURITY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
