...
public void testValidateMandatoryEntryProvenanceTemplateId() {
			...
			"validateMandatoryEntryProvenanceTemplateId",
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_ENTRY_PROVENANCE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
...
public void testValidateMandatoryEntryProvenanceAssignedAuthor() {
			...
			"validateMandatoryEntryProvenanceAssignedAuthor",
			operationsForOCL.getOCLValue("VALIDATE_MANDATORY_ENTRY_PROVENANCE_ASSIGNED_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
