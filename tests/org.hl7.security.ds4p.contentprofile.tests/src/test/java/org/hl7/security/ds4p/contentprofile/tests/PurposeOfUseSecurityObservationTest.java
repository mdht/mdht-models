...
public class PurposeOfUseSecurityObservationTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateSecurityObservationValueP() {
		OperationsTestCase<PurposeOfUseSecurityObservation> validateSecurityObservationValuePTestCase = new OperationsTestCase<PurposeOfUseSecurityObservation>(
