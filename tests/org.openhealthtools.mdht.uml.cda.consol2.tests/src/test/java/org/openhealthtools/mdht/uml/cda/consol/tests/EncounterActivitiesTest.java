...
public class EncounterActivitiesTest extends CDAValidationTest {
		...
		OperationsTestCase<EncounterActivities> validateEncounterActivitiesSdtcDDCFromNUBCOrDDTestCase = new OperationsTestCase<EncounterActivities>(
			...
			public void addFailTests() {
				...
				addFailTest(new FailTest() {
					@Override
					public void updateToFail(EncounterActivities target) {
			...
			public void addPassTests() {
				...
				addPassTest(new PassTest() {
					@Override
					public void updateToPass(EncounterActivities target) {
						target.init();
	...
	*/
	...
	public void testValidateEncounterActivitiesCodeP() {
		OperationsTestCase<EncounterActivities> validateEncounterActivitiesCodePTestCase = new OperationsTestCase<EncounterActivities>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EncounterActivitiesOperations.validateEncounterActivitiesCodeP(
					(EncounterActivities) objectToTest, diagnostician, map);
			}
