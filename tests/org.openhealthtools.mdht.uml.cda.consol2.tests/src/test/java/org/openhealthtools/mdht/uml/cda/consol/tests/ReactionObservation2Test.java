...
public class ReactionObservation2Test extends CDAValidationTest {
	...
	*/
	...
	public void testValidateReactionObservation2TemplateId() {
		OperationsTestCase<ReactionObservation2> validateReactionObservation2TemplateIdTestCase = new OperationsTestCase<ReactionObservation2>(
			"validateReactionObservation2TemplateId",
			operationsForOCL.getOCLValue("VALIDATE_REACTION_OBSERVATION2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ReactionObservation2Operations.validateReactionObservation2TemplateId(
					(ReactionObservation2) objectToTest, diagnostician, map);
			}

		};

		validateReactionObservation2TemplateIdTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateReactionObservationValueP() {
		OperationsTestCase<ReactionObservation2> validateReactionObservationValuePTestCase = new OperationsTestCase<ReactionObservation2>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ReactionObservation2Operations.validateReactionObservationValueP(
					(ReactionObservation2) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidateReactionObservationValue() {
		OperationsTestCase<ReactionObservation2> validateReactionObservationValueTestCase = new OperationsTestCase<ReactionObservation2>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ReactionObservation2Operations.validateReactionObservationValue(
					(ReactionObservation2) objectToTest, diagnostician, map);
			}
