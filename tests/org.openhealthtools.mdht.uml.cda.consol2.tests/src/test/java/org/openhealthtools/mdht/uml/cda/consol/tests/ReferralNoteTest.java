...
//import org.eclipse.mdht.uml.cda.operations.CDAValidationTest.OperationsTestCase.FailTest;
//import org.eclipse.mdht.uml.cda.operations.CDAValidationTest.OperationsTestCase.PassTest;
...
public class ReferralNoteTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUSRealmPersonNameMixedContent() {
		OperationsTestCase<ReferralNote> validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUSRealmPersonNameMixedContentTestCase = new OperationsTestCase<ReferralNote>(
			"validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUSRealmPersonNameMixedContent",
			operationsForOCL.getOCLValue(
		...
		validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUSRealmPersonNameMixedContentTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUse() {
		OperationsTestCase<ReferralNote> validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUseTestCase = new OperationsTestCase<ReferralNote>(
			"validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUse",
			operationsForOCL.getOCLValue(
			...
			@Override
			protected void updateToPass(ReferralNote target) {
				target.getParticipants().get(0).getAssociatedEntity().getAssociatedPerson().getNames().get(
					0).getUses().clear();
				target.getParticipants().get(0).getAssociatedEntity().getAssociatedPerson().getNames().get(
					0).getUses().add(EntityNameUse.C);
		...
		validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUseTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameFamily() {
		OperationsTestCase<ReferralNote> validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameFamilyTestCase = new OperationsTestCase<ReferralNote>(
			"validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameFamily",
			operationsForOCL.getOCLValue(
			...
			protected void updateToPass(ReferralNote target) {
				for (Participant1 one : target.getParticipants()) {
					one.getAssociatedEntity().getAssociatedPerson().getNames().get(0).getFamilies().clear();
				}
		...
		validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameFamilyTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameGiven() {
		OperationsTestCase<ReferralNote> validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameGivenTestCase = new OperationsTestCase<ReferralNote>(
			"validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameGiven",
			operationsForOCL.getOCLValue(
			...
			protected void updateToPass(ReferralNote target) {
				for (Participant1 one : target.getParticipants()) {
					one.getAssociatedEntity().getAssociatedPerson().getNames().get(0).getGivens().clear();
				}
		...
		validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameGivenTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNamePrefix() {
		OperationsTestCase<ReferralNote> validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNamePrefixTestCase = new OperationsTestCase<ReferralNote>(
			"validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNamePrefix",
			operationsForOCL.getOCLValue(
		...
		validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNamePrefixTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameSuffix() {
		OperationsTestCase<ReferralNote> validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameSuffixTestCase = new OperationsTestCase<ReferralNote>(
			"validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameSuffix",
			operationsForOCL.getOCLValue(
			...
			protected void updateToPass(ReferralNote target) {
				for (Participant1 one : target.getParticipants()) {
					one.getAssociatedEntity().getAssociatedPerson().getNames().get(0).getSuffixes().clear();
				}
		...
		validateReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameSuffixTestCase.doValidationTest();
	}
