...
public class SubstanceOrDeviceAllergyObservation2Test extends CDAValidationTest {
	...
	*/
	@Test
	public void testValidateSubstanceOrDeviceAllergyObservation2CriticalityInversionIndicator() {
		OperationsTestCase<SubstanceOrDeviceAllergyObservation2> validateSubstanceOrDeviceAllergyObservation2CriticalityInversionIndicatorTestCase = new OperationsTestCase<SubstanceOrDeviceAllergyObservation2>(
		...
		validateSubstanceOrDeviceAllergyObservation2CriticalityInversionIndicatorTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateSubstanceOrDeviceAllergyObservation2TemplateId() {
		OperationsTestCase<SubstanceOrDeviceAllergyObservation2> validateSubstanceOrDeviceAllergyObservation2TemplateIdTestCase = new OperationsTestCase<SubstanceOrDeviceAllergyObservation2>(
		...
		validateSubstanceOrDeviceAllergyObservation2TemplateIdTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidateSubstanceOrDeviceAllergyObservation2CriticalityObservation() {
		OperationsTestCase<SubstanceOrDeviceAllergyObservation2> validateSubstanceOrDeviceAllergyObservation2CriticalityObservationTestCase = new OperationsTestCase<SubstanceOrDeviceAllergyObservation2>(
		...
		validateSubstanceOrDeviceAllergyObservation2CriticalityObservationTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testGetConsolAllergyStatusObservation2() {

		SubstanceOrDeviceAllergyObservation2 target = objectFactory.create();
		target.getConsolAllergyStatusObservation2();
	...
	*/
	...
	public void testValidateSubstanceOrDeviceAllergyObservationAllergyStatusInversionIndicator() {
		OperationsTestCase<SubstanceOrDeviceAllergyObservation2> validateSubstanceOrDeviceAllergyObservationAllergyStatusInversionIndicatorTestCase = new OperationsTestCase<SubstanceOrDeviceAllergyObservation2>(
			...
			protected void updateToFail(SubstanceOrDeviceAllergyObservation2 target) {
				...
				EntryRelationship er = CDAFactory.eINSTANCE.createEntryRelationship();
				er.setTypeCode(x_ActRelationshipEntryRelationship.SUBJ);
				er.setObservation(ConsolFactory.eINSTANCE.createAllergyStatusObservation2().init());
				target.getEntryRelationships().add(er);
			}
	...
	*
	* @generated NOT
	* Note: Updated VALIDATE_SUBSTANCE_OR_DEVICE_ALLERGY_OBSERVATION_SEVERITY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP in operations as per errata 710
	*/
	@Test
	...
	*/
	...
	public void testValidateSubstanceOrDeviceAllergyObservationAllergyStatusObservation() {
		OperationsTestCase<SubstanceOrDeviceAllergyObservation2> validateSubstanceOrDeviceAllergyObservationAllergyStatusObservationTestCase = new OperationsTestCase<SubstanceOrDeviceAllergyObservation2>(
			...
			@Override
			protected void updateToPass(SubstanceOrDeviceAllergyObservation2 target) {
				target.getEntryRelationships().get(0).setObservation(
					ConsolFactory.eINSTANCE.createAllergyStatusObservation2().init());
			}
