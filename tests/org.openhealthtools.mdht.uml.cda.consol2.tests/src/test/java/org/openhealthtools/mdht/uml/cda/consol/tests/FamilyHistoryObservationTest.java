...
public class FamilyHistoryObservationTest extends CDAValidationTest {
	...
	*/
	@Test
	public void testValidateFamilyHistoryObservationValueP() {
		OperationsTestCase<FamilyHistoryObservation> validateFamilyHistoryObservationValuePTestCase = new OperationsTestCase<FamilyHistoryObservation>(
			"validateFamilyHistoryObservationValueP",
			operationsForOCL.getOCLValue("VALIDATE_FAMILY_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return FamilyHistoryObservationOperations.validateFamilyHistoryObservationValueP(
					(FamilyHistoryObservation) objectToTest, diagnostician, map);
			}

		};

		validateFamilyHistoryObservationValuePTestCase.doValidationTest();
	}
