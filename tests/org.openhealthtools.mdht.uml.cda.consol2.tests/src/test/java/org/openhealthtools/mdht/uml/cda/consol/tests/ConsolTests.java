...
@Suite.SuiteClasses({
		...
		DeceasedObservationTest.class, EntryReferenceTest.class, AdvanceDirectiveOrganizerTest.class,
		...
		GoalObservationTest.class, HandoffCommunicationParticipantsTest.class, HealthConcernActTest.class,
		InterventionActTest.class, MedicalEquipmentOrganizerTest.class, MentalStatusObservationTest.class,
		NutritionalStatusObservationTest.class, NutritionAssessmentTest.class, NutritionRecommendationTest.class,
		OutcomeObservationTest.class, PriorityPreferenceTest.class, PatientReferralActTest.class,
		PlannedCoverageTest.class, PlannedImmunizationActivityTest.class, PrognosisObservationTest.class,
		ProgressTowardGoalObservationTest.class, SelfCareActivitiesTest.class, SensoryStatusTest.class,
		SubstanceAdministeredActTest.class, WoundCharacteristicTest.class, WoundMeasurementObservationTest.class,
		LongitudinalCareWoundObservationTest.class, GoalsSectionTest.class, HealthConcernsSectionTest.class,
		HealthStatusEvaluationsAndOutcomesSectionTest.class, MentalStatusSectionTest.class, NutritionSectionTest.class,
		...
		ProcedureActivityAct2Test.class, ProcedureActivityObservation2Test.class,
