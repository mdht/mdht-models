...
public class ImmunizationActivityTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateImmunizationActivityPreconditionTypeCode() {
		OperationsTestCase<ImmunizationActivity> validateImmunizationActivityPreconditionTypeCodeTestCase = new OperationsTestCase<ImmunizationActivity>(
			...
			@Override
			protected void updateToPass(ImmunizationActivity target) {
				for (Precondition precon : target.getPreconditions()) {
					precon.setTypeCode(ActRelationshipType.PRCN);
				}
			}
	...
	*/
	...
	public void testValidateImmunizationActivityPreconditionPreconditionForSubstanceAdministration() {
		OperationsTestCase<ImmunizationActivity> validateImmunizationActivityPreconditionPreconditionForSubstanceAdministrationTestCase = new OperationsTestCase<ImmunizationActivity>(
			...
			@Override
			protected void updateToPass(ImmunizationActivity target) {
				PreconditionForSubstanceAdministration pfsa = ConsolFactory.eINSTANCE.createPreconditionForSubstanceAdministration().init();
				for (Precondition precon : target.getPreconditions()) {
					precon.setCriterion(pfsa);
				}
			}
	...
	*/
	@Test
	public void testValidateImmunizationActivityMoodCodeP() {
		OperationsTestCase<ImmunizationActivity> validateImmunizationActivityMoodCodePTestCase = new OperationsTestCase<ImmunizationActivity>(
			"validateImmunizationActivityMoodCodeP",
			operationsForOCL.getOCLValue("VALIDATE_IMMUNIZATION_ACTIVITY_MOOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return ImmunizationActivityOperations.validateImmunizationActivityMoodCodeP(
					(ImmunizationActivity) objectToTest, diagnostician, map);
			}

		};

		validateImmunizationActivityMoodCodePTestCase.doValidationTest();
	}
