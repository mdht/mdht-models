...
public class AnesthesiaSection2Test extends CDAValidationTest {
	...
	*/
	@Test
	public void testValidateAnesthesiaSectionProcedureActivityProcedure2() {
		OperationsTestCase<AnesthesiaSection2> validateAnesthesiaSectionProcedureActivityProcedure2TestCase = new OperationsTestCase<AnesthesiaSection2>(
			"validateAnesthesiaSectionProcedureActivityProcedure2",
			operationsForOCL.getOCLValue("VALIDATE_ANESTHESIA_SECTION_PROCEDURE_ACTIVITY_PROCEDURE2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
		...
		validateAnesthesiaSectionProcedureActivityProcedure2TestCase.doValidationTest();
	}
	...
	*/
	@Test
	public void testValidateAnesthesiaSectionMedicationActivity2() {
		OperationsTestCase<AnesthesiaSection2> validateAnesthesiaSectionMedicationActivity2TestCase = new OperationsTestCase<AnesthesiaSection2>(
			"validateAnesthesiaSectionMedicationActivity2",
			operationsForOCL.getOCLValue("VALIDATE_ANESTHESIA_SECTION_MEDICATION_ACTIVITY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return AnesthesiaSection2Operations.validateAnesthesiaSectionMedicationActivity2(
					(AnesthesiaSection2) objectToTest, diagnostician, map);
			}

		};

		validateAnesthesiaSectionMedicationActivity2TestCase.doValidationTest();
	}
