...
public class HospitalAdmissionDiagnosis2Test extends CDAValidationTest {
	...
	*/
	@Test
	public void testValidateHospitalAdmissionDiagnosisProblemObservation2() {
		OperationsTestCase<HospitalAdmissionDiagnosis2> validateHospitalAdmissionDiagnosisProblemObservation2TestCase = new OperationsTestCase<HospitalAdmissionDiagnosis2>(
			"validateHospitalAdmissionDiagnosisProblemObservation2",
			operationsForOCL.getOCLValue("VALIDATE_HOSPITAL_ADMISSION_DIAGNOSIS_PROBLEM_OBSERVATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return HospitalAdmissionDiagnosis2Operations.validateHospitalAdmissionDiagnosisProblemObservation2(
					(HospitalAdmissionDiagnosis2) objectToTest, diagnostician, map);
			}

		};

		validateHospitalAdmissionDiagnosisProblemObservation2TestCase.doValidationTest();
	}
