...
public class DiagnosticFindingsTest extends CDAValidationTest {
	...
	*/
	...
	public void testValidateResultsSectionTitle() {
		OperationsTestCase<DiagnosticFindings> validateResultsSectionTitleTestCase = new OperationsTestCase<DiagnosticFindings>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return DiagnosticFindingsOperations.validateResultsSectionTitle(
