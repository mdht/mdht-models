	...
	public void testValidatePluralityTemplateId() {
		OperationsTestCase<Plurality> validatePluralityTemplateIdTestCase = new OperationsTestCase<Plurality>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PluralityOperations.validatePluralityTemplateId((Plurality) objectToTest, diagnostician, map);
			}
	...
	public void testValidatePluralityClassCode() {
		OperationsTestCase<Plurality> validatePluralityClassCodeTestCase = new OperationsTestCase<Plurality>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PluralityOperations.validatePluralityClassCode((Plurality) objectToTest, diagnostician, map);
			}
	...
	public void testValidatePluralityMoodCode() {
		OperationsTestCase<Plurality> validatePluralityMoodCodeTestCase = new OperationsTestCase<Plurality>(
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PluralityOperations.validatePluralityMoodCode((Plurality) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidatePluralityCodeP() {
		OperationsTestCase<Plurality> validatePluralityCodePTestCase = new OperationsTestCase<Plurality>(
			...
			operationsForOCL.getOCLValue("VALIDATE_PLURALITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"), objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PluralityOperations.validatePluralityCodeP((Plurality) objectToTest, diagnostician, map);
			}

		};

		validatePluralityCodePTestCase.doValidationTest();
	}
	...
	*/
	...
	public void testValidatePluralityCode() {
		OperationsTestCase<Plurality> validatePluralityCodeTestCase = new OperationsTestCase<Plurality>(
			...
			operationsForOCL.getOCLValue("VALIDATE_PLURALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"), objectFactory) {
			...
			@Override
			protected void setDependency(Plurality target) {
				Collection<Object> passToken = new java.util.ArrayList<Object>(3);
				passToken.add(target);
				map.put("org.openhealthtools.mdht.uml.cda.vsbr.PluralityCodeP", passToken);
			}

			@Override
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {

				return PluralityOperations.validatePluralityCode((Plurality) objectToTest, diagnostician, map);
			}
	...
	*/
	...
	public void testValidatePluralityValue() {
		OperationsTestCase<Plurality> validatePluralityValueTestCase = new OperationsTestCase<Plurality>(
			...
			operationsForOCL.getOCLValue("VALIDATE_PLURALITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"), objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return PluralityOperations.validatePluralityValue((Plurality) objectToTest, diagnostician, map);
			}
