	...
	*/
	...
	public void testValidateEstimateofGestationCodeP() {
		OperationsTestCase<EstimateofGestation> validateEstimateofGestationCodePTestCase = new OperationsTestCase<EstimateofGestation>(
			...
			operationsForOCL.getOCLValue("VALIDATE_ESTIMATEOF_GESTATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP"),
			objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return EstimateofGestationOperations.validateEstimateofGestationCodeP(
					(EstimateofGestation) objectToTest, diagnostician, map);
			}

		};

		validateEstimateofGestationCodePTestCase.doValidationTest();
	}
