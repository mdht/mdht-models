 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.ResultsSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResultsSectionImpl extends EObjectImpl implements IResultsSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getResultsSection();
	}
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultsSection(),
				IDomainPackage.eINSTANCE.getResultsSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IResultsSection setTitle(ST value) {
		this.getCDAType().setTitle(value);
		return this;
	}
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultsSection(),
				IDomainPackage.eINSTANCE.getResultsSection().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IResultsSection setText(StrucDocText value) {
		this.getCDAType().setText(value);
		return this;
	}

	/**
	 * The cached OCL expression body for the '{@link #getResultOrganizers() <em>Get Result Organizers</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getResultOrganizers()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_RESULT_ORGANIZERS__EOCL_EXP = "self.getOrganizers()->select(organizer : cda::Organizer | not organizer.oclIsUndefined() and organizer.oclIsKindOf(domain::ResultOrganizer)).oclAsType(domain::ResultOrganizer)";

	/**
	 * The cached OCL query for the '{@link #getResultOrganizers() <em>Get Result Organizers</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getResultOrganizers()
	 * @generated
	...
	public EList<IResultOrganizer> getResultOrganizers() {
		if (GET_RESULT_ORGANIZERS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getResultsSection(),
				IDomainPackage.eINSTANCE.getResultsSection().getEAllOperations().get(6));
			try {
		...
		Collection<IResultOrganizer> result = (Collection<IResultOrganizer>) query.evaluate(this);
		return new BasicEList.UnmodifiableEList<IResultOrganizer>(result.size(), result.toArray());
	}
	 ...
	 * @generated
	 */
	public IResultOrganizer addResultOrganizer() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("ResultOrganizer");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
	 ...
	 * @generated
	 */
	public IResultsSection addResultOrganizer(IResultOrganizer value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.RESULTS_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
