 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.CoverageEntryImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoverageEntryImpl extends EObjectImpl implements ICoverageEntry {
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getCoverageEntry(),
				IDomainPackage.eINSTANCE.getCoverageEntry().getEAllOperations().get(0));
			try {
	...
	public EList<IPolicyActivity> getPolicyActivities() {
		if (GET_POLICY_ACTIVITIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getCoverageEntry(),
				IDomainPackage.eINSTANCE.getCoverageEntry().getEAllOperations().get(3));
			try {
