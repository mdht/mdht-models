...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.IProblemEntryReactionObservationContainer;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.AllergyIntoleranceImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AllergyIntoleranceImpl extends ProblemEntryImpl implements IAllergyIntolerance {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getAllergyIntolerance();
	}
	 ...
	 */
	@Override
	public IAllergyIntolerance addComment(IComment value) {
	 ...
	 */
	@Override
	public IAllergyIntolerance addId(II value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	 ...
	 */
	@Override
	public IAllergyIntolerance setCode(CD value) {
	 ...
	 */
	@Override
	public IAllergyIntolerance setText(ED value) {
	 ...
	 */
	@Override
	public IAllergyIntolerance setEffectiveTime(IVL_TS value) {
	 ...
	 */
	@Override
	public IAllergyIntolerance setValue(CD value) {
	...
	/**
	 * The cached OCL expression body for the '{@link #getProblemEntryReactionObservationContainers() <em>Get Problem Entry Reaction Observation Containers</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemEntryReactionObservationContainers()
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL query for the '{@link #getProblemEntryReactionObservationContainers() <em>Get Problem Entry Reaction Observation Containers</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemEntryReactionObservationContainers()
	 * @generated
	 ...
	 * @generated
	 */
	public IProblemEntryReactionObservationContainer addProblemEntryReactionObservationContainer() {
		org.eclipse.emf.ecore.EPackage ePackage = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage("http://www.openhealthtools.org/mdht/uml/cda/ihe");
		org.eclipse.emf.ecore.EFactory eFactory = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/ihe");
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("ProblemEntryReactionObservationContainer");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
			java.lang.reflect.Method initMethod = eObject.getClass().getMethod("init", new java.lang.Class[0]);
			initMethod.invoke(eObject, new Object[0]);
	 ...
	 * @generated
	 */
	public IAllergyIntolerance addProblemEntryReactionObservationContainer(
			IProblemEntryReactionObservationContainer value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAllergyIntolerance(),
				IDomainPackage.eINSTANCE.getAllergyIntolerance().getEAllOperations().get(39));
			try {
	...
	public ED getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAllergyIntolerance(),
				IDomainPackage.eINSTANCE.getAllergyIntolerance().getEAllOperations().get(42));
			try {
	...
	public CD getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAllergyIntolerance(),
				IDomainPackage.eINSTANCE.getAllergyIntolerance().getEAllOperations().get(45));
			try {
