...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.IFamilyHistory;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.FamilyHistorySectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FamilyHistorySectionImpl extends EObjectImpl implements IFamilyHistorySection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getFamilyHistorySection();
	}
	 ...
	 * @generated
	 */
	public IFamilyHistorySection setTitle(ST value) {
		this.getCDAType().setTitle(value);
		return this;
	}
	...
	/**
	 * The cached OCL expression body for the '{@link #getFamilyHistories() <em>Get Family Histories</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFamilyHistories()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_FAMILY_HISTORIES__EOCL_EXP = "self.getOrganizers()->select(organizer : cda::Organizer | not organizer.oclIsUndefined() and organizer.oclIsKindOf(domain::FamilyHistory)).oclAsType(domain::FamilyHistory)";

	/**
	 * The cached OCL query for the '{@link #getFamilyHistories() <em>Get Family Histories</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFamilyHistories()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<IFamilyHistory> getFamilyHistories() {
		if (GET_FAMILY_HISTORIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getFamilyHistorySection(),
				IDomainPackage.eINSTANCE.getFamilyHistorySection().getEAllOperations().get(6));
			try {
		...
		Collection<IFamilyHistory> result = (Collection<IFamilyHistory>) query.evaluate(this);
		return new BasicEList.UnmodifiableEList<IFamilyHistory>(result.size(), result.toArray());
	}
	 ...
	 * @generated
	 */
	public IFamilyHistory addFamilyHistory() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("FamilyHistory");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
		...
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("FamilyHistory");
		IFamilyHistory value = (IFamilyHistory) domainFactory.create(domainEClass);
	 ...
	 * @generated
	 */
	public IFamilyHistorySection addFamilyHistory(IFamilyHistory value) {
	...
	/**
	 * The cached OCL expression body for the '{@link #getFamilyHistoryOrganizers() <em>Get Family History Organizers</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFamilyHistoryOrganizers()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_FAMILY_HISTORY_ORGANIZERS__EOCL_EXP = "self.getOrganizers()->select(organizer : cda::Organizer | not organizer.oclIsUndefined() and organizer.oclIsKindOf(domain::FamilyHistoryOrganizer)).oclAsType(domain::FamilyHistoryOrganizer)";

	/**
	 * The cached OCL query for the '{@link #getFamilyHistoryOrganizers() <em>Get Family History Organizers</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFamilyHistoryOrganizers()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<IFamilyHistoryOrganizer> getFamilyHistoryOrganizers() {
		if (GET_FAMILY_HISTORY_ORGANIZERS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getFamilyHistorySection(),
				IDomainPackage.eINSTANCE.getFamilyHistorySection().getEAllOperations().get(9));
			try {
		...
		@SuppressWarnings("unchecked")
		Collection<IFamilyHistoryOrganizer> result = (Collection<IFamilyHistoryOrganizer>) query.evaluate(this);
		return new BasicEList.UnmodifiableEList<IFamilyHistoryOrganizer>(result.size(), result.toArray());
	}
	 ...
	 * @generated
	 */
	public IFamilyHistoryOrganizer addFamilyHistoryOrganizer() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("FamilyHistoryOrganizer");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
			java.lang.reflect.Method initMethod = eObject.getClass().getMethod("init", new java.lang.Class[0]);
			initMethod.invoke(eObject, new Object[0]);
		...
		org.eclipse.emf.ecore.EPackage domainPackage = this.eClass().getEPackage();
		org.eclipse.emf.ecore.EFactory domainFactory = domainPackage.getEFactoryInstance();
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("FamilyHistoryOrganizer");
		IFamilyHistoryOrganizer value = (IFamilyHistoryOrganizer) domainFactory.create(domainEClass);
		value.setCDAType((org.openhealthtools.mdht.uml.cda.Organizer) eObject);
		this.getCDAType().addOrganizer((org.openhealthtools.mdht.uml.cda.Organizer) eObject);
		return value;
	}
	 ...
	 * @generated
	 */
	public IFamilyHistorySection addFamilyHistoryOrganizer(IFamilyHistoryOrganizer value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
