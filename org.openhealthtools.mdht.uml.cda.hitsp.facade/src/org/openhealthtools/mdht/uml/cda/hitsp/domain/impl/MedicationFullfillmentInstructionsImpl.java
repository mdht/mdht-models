 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.MedicationFullfillmentInstructionsImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MedicationFullfillmentInstructionsImpl extends EObjectImpl implements IMedicationFullfillmentInstructions {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMedicationFullfillmentInstructions();
	}
	...
	public ED getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getMedicationFullfillmentInstructions(),
				IDomainPackage.eINSTANCE.getMedicationFullfillmentInstructions().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IMedicationFullfillmentInstructions setText(ED value) {
		this.getCDAType().setText(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MEDICATION_FULLFILLMENT_INSTRUCTIONS__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
