 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.MedicationsAdministeredSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MedicationsAdministeredSectionImpl extends EObjectImpl implements IMedicationsAdministeredSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMedicationsAdministeredSection();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MEDICATIONS_ADMINISTERED_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
