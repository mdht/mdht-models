...
public class AllergiesReactionsSectionImpl extends EObjectImpl implements IAllergiesReactionsSection {
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAllergiesReactionsSection(),
				IDomainPackage.eINSTANCE.getAllergiesReactionsSection().getEAllOperations().get(0));
			try {
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAllergiesReactionsSection(),
				IDomainPackage.eINSTANCE.getAllergiesReactionsSection().getEAllOperations().get(3));
			try {
	...
	public EList<IAllergyDrugSensitivity> getAllergyDrugSensitivities() {
		if (GET_ALLERGY_DRUG_SENSITIVITIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAllergiesReactionsSection(),
				IDomainPackage.eINSTANCE.getAllergiesReactionsSection().getEAllOperations().get(6));
			try {
