 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.ExtremitiesSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExtremitiesSectionImpl extends EObjectImpl implements IExtremitiesSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getExtremitiesSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getExtremitiesSection(),
				IDomainPackage.eINSTANCE.getExtremitiesSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IExtremitiesSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.EXTREMITIES_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
