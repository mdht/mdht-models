...
public class HospitalDischargeStudiesSummarySectionOperations extends SectionOperations {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.16.2.3')
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CDTPlugin.INSTANCE.getString("HospitalDischargeStudiesSummarySectionTemplateId"),
...
"value.code = '11493-4' and value.codeSystem = '2.16.840.1.113883.6.1'))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CDTPlugin.INSTANCE.getString("HospitalDischargeStudiesSummarySectionCode"),
						 new Object [] { hospitalDischargeStudiesSummarySection }));
			}
			return false;
		}
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * (self.title.oclIsUndefined() or self.title.isNullFlavorUndefined()) implies (not self.title.oclIsUndefined() and self.title.getText() = 'HOSPITAL DISCHARGE STUDIES SUMMARY')
	 * @param hospitalDischargeStudiesSummarySection The receiving '<em><b>Hospital Discharge Studies Summary Section</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CDTPlugin.INSTANCE.getString("HospitalDischargeStudiesSummarySectionTitle"),
						 new Object [] { hospitalDischargeStudiesSummarySection }));
			}
			return false;
		}
