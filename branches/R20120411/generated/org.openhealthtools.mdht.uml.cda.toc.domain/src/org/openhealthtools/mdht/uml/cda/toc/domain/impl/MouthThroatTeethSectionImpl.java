 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.MouthThroatTeethSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MouthThroatTeethSectionImpl extends EObjectImpl implements IMouthThroatTeethSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMouthThroatTeethSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getMouthThroatTeethSection(),
				IDomainPackage.eINSTANCE.getMouthThroatTeethSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IMouthThroatTeethSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MOUTH_THROAT_TEETH_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
