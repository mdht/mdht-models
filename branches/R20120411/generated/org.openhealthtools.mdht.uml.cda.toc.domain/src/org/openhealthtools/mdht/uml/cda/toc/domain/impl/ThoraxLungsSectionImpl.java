 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.ThoraxLungsSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ThoraxLungsSectionImpl extends EObjectImpl implements IThoraxLungsSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getThoraxLungsSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getThoraxLungsSection(),
				IDomainPackage.eINSTANCE.getThoraxLungsSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IThoraxLungsSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.THORAX_LUNGS_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	 ...
	 * @generated
	 */
	public IThoraxLungsSection init() {
		CDAUtil.init(this);
		return this;
	}
