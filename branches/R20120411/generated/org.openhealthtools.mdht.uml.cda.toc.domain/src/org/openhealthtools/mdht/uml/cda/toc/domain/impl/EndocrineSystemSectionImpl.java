 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.EndocrineSystemSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EndocrineSystemSectionImpl extends EObjectImpl implements IEndocrineSystemSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getEndocrineSystemSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getEndocrineSystemSection(),
				IDomainPackage.eINSTANCE.getEndocrineSystemSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IEndocrineSystemSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.ENDOCRINE_SYSTEM_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	 ...
	 * @generated
	 */
	public IEndocrineSystemSection init() {
		CDAUtil.init(this);
		return this;
	}
