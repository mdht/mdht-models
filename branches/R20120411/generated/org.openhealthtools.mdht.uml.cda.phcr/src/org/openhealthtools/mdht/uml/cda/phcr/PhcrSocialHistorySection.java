 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation title.mixed='Social History' code.codeSystem='2.16.840.1.113883.6.1' templateId.root='2.16.840.1.113883.10.20.15.2.22' code.displayName='Social History' constraints.validation.error='PhcrSocialHistorySectionTemplateId SocialHistorySectionCode PhcrSocialHistorySectionTitle PhcrSocialHistorySectionText' code.codeSystemName='LOINC' constraints.validation.warning='PhcrSocialHistorySectionGeotemporalHistoryObservation PhcrSocialHistorySectionMostRecentTimeArrivedInUSAObservation PhcrSocialHistorySectionRaceObservation PhcrSocialHistorySectionOccupationObservation' code.code='29762-2' constraints.validation.info='PhcrSocialHistorySectionPregnancyObservation'"
 * @generated
 */
