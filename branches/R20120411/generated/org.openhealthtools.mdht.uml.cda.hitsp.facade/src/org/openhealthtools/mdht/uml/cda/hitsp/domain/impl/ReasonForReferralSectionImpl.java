 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.ReasonForReferralSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReasonForReferralSectionImpl extends EObjectImpl implements IReasonForReferralSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getReasonForReferralSection();
	}
	 ...
	 * @ordered
	 */
	protected static final String GET_PROBLEM_ENTRIES__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(domain::ProblemEntry)).oclAsType(domain::ProblemEntry)";
	...
	public EList<IProblemEntry> getProblemEntries() {
		if (GET_PROBLEM_ENTRIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getReasonForReferralSection(),
				IDomainPackage.eINSTANCE.getReasonForReferralSection().getEAllOperations().get(0));
			try {
	...
	public IProblemEntry addProblemEntry() {
		...
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("ProblemEntry");
	 ...
	 * @generated
	 */
	public IReasonForReferralSection addProblemEntry(IProblemEntry value) {
	...
	public EList<ICondition> getConditions() {
		if (GET_CONDITIONS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getReasonForReferralSection(),
				IDomainPackage.eINSTANCE.getReasonForReferralSection().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IReasonForReferralSection addCondition(ICondition value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public EList<IResult> getResults() {
		if (GET_RESULTS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getReasonForReferralSection(),
				IDomainPackage.eINSTANCE.getReasonForReferralSection().getEAllOperations().get(6));
			try {
	 ...
	 * @generated
	 */
	public IReasonForReferralSection addResult(IResult value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.REASON_FOR_REFERRAL_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
