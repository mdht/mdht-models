...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ICondition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.IConditionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IConditionImpl extends EObjectImpl implements ICondition {
	/**
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ICONDITION;
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(0));
			try {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(3));
			try {
	...
	public CS getStatusCode() {
		if (GET_STATUS_CODE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(6));
			try {
	...
	public IVL_TS getEffectiveTime() {
		if (GET_EFFECTIVE_TIME__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(9));
			try {
	...
	public IEpisodeObservation getEpisodeObservation() {
		if (GET_EPISODE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(12));
			try {
	...
	public IEpisodeObservation withEpisodeObservation() {
		...
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("IEpisodeObservation");
	...
	/**
	 * The cached OCL expression body for the '{@link #getProblemEntries() <em>Get Problem Entries</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemEntries()
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL query for the '{@link #getProblemEntries() <em>Get Problem Entries</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemEntries()
	 * @generated
	...
	public EList<IProblemEntry> getProblemEntries() {
		if (GET_PROBLEM_ENTRIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(15));
			try {
		...
		@SuppressWarnings("unchecked")
		Collection<IProblemEntry> result = (Collection<IProblemEntry>) query.evaluate(this);
	...
	public IProblemEntry addProblemEntry() {
		...
		org.eclipse.emf.ecore.EPackage domainPackage = this.eClass().getEPackage();
		org.eclipse.emf.ecore.EFactory domainFactory = domainPackage.getEFactoryInstance();
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("IProblemEntry");
	...
	/**
	 * The cached OCL expression body for the '{@link #getTreatingProvider() <em>Get Treating Provider</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTreatingProvider()
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL query for the '{@link #getTreatingProvider() <em>Get Treating Provider</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTreatingProvider()
	 * @generated
	...
	public ITreatingProvider getTreatingProvider() {
		if (GET_TREATING_PROVIDER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICONDITION, DomainPackage.Literals.ICONDITION.getEAllOperations().get(18));
			try {
		...
		return (ITreatingProvider) query.evaluate(this);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.ICONDITION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
