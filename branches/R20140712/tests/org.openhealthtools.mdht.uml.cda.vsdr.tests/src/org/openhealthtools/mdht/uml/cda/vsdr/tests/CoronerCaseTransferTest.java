...
public class CoronerCaseTransferTest extends  CDAValidationTest {
...
public void testValidateCoronerCaseTransferTemplateId() {
			OperationsTestCase<CoronerCaseTransfer> validateCoronerCaseTransferTemplateIdTestCase = new OperationsTestCase<CoronerCaseTransfer>(
			"validateCoronerCaseTransferTemplateId",
			operationsForOCL.getOCLValue("VALIDATE_CORONER_CASE_TRANSFER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoronerCaseTransferOperations.validateCoronerCaseTransferTemplateId(
					(CoronerCaseTransfer) objectToTest, diagnostician, map);
			}

		};

		validateCoronerCaseTransferTemplateIdTestCase.doValidationTest();
}		
...
public void testValidateCoronerCaseTransferClassCode() {
			OperationsTestCase<CoronerCaseTransfer> validateCoronerCaseTransferClassCodeTestCase = new OperationsTestCase<CoronerCaseTransfer>(
			"validateCoronerCaseTransferClassCode",
			operationsForOCL.getOCLValue("VALIDATE_CORONER_CASE_TRANSFER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoronerCaseTransferOperations.validateCoronerCaseTransferClassCode(
					(CoronerCaseTransfer) objectToTest, diagnostician, map);
			}
...
public void testValidateCoronerCaseTransferCodeP() {
			OperationsTestCase<CoronerCaseTransfer> validateCoronerCaseTransferCodePTestCase = new OperationsTestCase<CoronerCaseTransfer>(
			"validateCoronerCaseTransferCodeP",
			operationsForOCL.getOCLValue("VALIDATE_CORONER_CASE_TRANSFER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoronerCaseTransferOperations.validateCoronerCaseTransferCodeP(
					(CoronerCaseTransfer) objectToTest, diagnostician, map);
			}

		};

		validateCoronerCaseTransferCodePTestCase.doValidationTest();
}		
...
public void testValidateCoronerCaseTransferCode() {
			OperationsTestCase<CoronerCaseTransfer> validateCoronerCaseTransferCodeTestCase = new OperationsTestCase<CoronerCaseTransfer>(
			"validateCoronerCaseTransferCode",
			operationsForOCL.getOCLValue("VALIDATE_CORONER_CASE_TRANSFER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoronerCaseTransferOperations.validateCoronerCaseTransferCode(
					(CoronerCaseTransfer) objectToTest, diagnostician, map);
			}
...
public void testValidateCoronerCaseTransferValue() {
			OperationsTestCase<CoronerCaseTransfer> validateCoronerCaseTransferValueTestCase = new OperationsTestCase<CoronerCaseTransfer>(
			"validateCoronerCaseTransferValue",
			operationsForOCL.getOCLValue("VALIDATE_CORONER_CASE_TRANSFER_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
			,objectFactory) {
			...
			protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
				...
				return CoronerCaseTransferOperations.validateCoronerCaseTransferValue(
					(CoronerCaseTransfer) objectToTest, diagnostician, map);
			}
...
* @generated
*/
	private static class OperationsForOCL extends CoronerCaseTransferOperations {
...
* @generated
*/	
	private static class ConstructorTestClass extends CoronerCaseTransferOperations {};
