 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.NeurologicSystemSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NeurologicSystemSectionImpl extends EObjectImpl implements INeurologicSystemSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getNeurologicSystemSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getNeurologicSystemSection(),
				IDomainPackage.eINSTANCE.getNeurologicSystemSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public INeurologicSystemSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.NEUROLOGIC_SYSTEM_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	 ...
	 * @generated
	 */
	public INeurologicSystemSection init() {
		CDAUtil.init(this);
		return this;
	}
