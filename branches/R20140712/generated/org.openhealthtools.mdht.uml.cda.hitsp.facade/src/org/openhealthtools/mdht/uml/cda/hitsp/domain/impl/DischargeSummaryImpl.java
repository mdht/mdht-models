 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.DischargeSummaryImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DischargeSummaryImpl extends EObjectImpl implements IDischargeSummary {
	...
	public EList<Author> getAuthors() {
		if (GET_AUTHORS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(24));
			try {
	...
	public Custodian getCustodian() {
		if (GET_CUSTODIAN__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(27));
			try {
	...
	public InfrastructureRootTypeId getTypeId() {
		if (GET_TYPE_ID__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(0));
			try {
	...
	public II getId() {
		if (GET_ID__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(3));
			try {
	...
	public CE getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(6));
			try {
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(9));
			try {
	...
	public TS getEffectiveTime() {
		if (GET_EFFECTIVE_TIME__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(12));
			try {
	...
	public CE getConfidentialityCode() {
		if (GET_CONFIDENTIALITY_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(15));
			try {
	...
	public CS getLanguageCode() {
		if (GET_LANGUAGE_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(18));
			try {
	...
	public EList<RecordTarget> getRecordTargets() {
		if (GET_RECORD_TARGETS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(21));
			try {
	...
	public Component2 getComponent() {
		if (GET_COMPONENT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(30));
			try {
	...
	public DataEnterer getDataEnterer() {
		if (GET_DATA_ENTERER__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(33));
			try {
	...
	public EList<InformationRecipient> getInformationRecipients() {
		if (GET_INFORMATION_RECIPIENTS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(36));
			try {
	...
	public LegalAuthenticator getLegalAuthenticator() {
		if (GET_LEGAL_AUTHENTICATOR__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(39));
			try {
	...
	public EList<Authenticator> getAuthenticators() {
		if (GET_AUTHENTICATORS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(42));
			try {
	...
	public IProblemListSection getActiveProblems() {
		if (GET_ACTIVE_PROBLEMS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(45));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #getAdmissionMedications() <em>Get Admission Medications</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAdmissionMedications()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_ADMISSION_MEDICATIONS__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(domain::AdmissionMedicationHistorySection))->asSequence()->first().oclAsType(domain::AdmissionMedicationHistorySection)";

	/**
	 * The cached OCL query for the '{@link #getAdmissionMedications() <em>Get Admission Medications</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAdmissionMedications()
	 * @generated
	 ...
	 * @generated
	 */
	public IAdmissionMedicationHistorySection getAdmissionMedications() {
		if (GET_ADMISSION_MEDICATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(48));
			try {
		...
		return (IAdmissionMedicationHistorySection) query.evaluate(this);
	}
	 ...
	 * @generated
	 */
	public IAdmissionMedicationHistorySection withAdmissionMedications() {
		org.eclipse.emf.ecore.EPackage ePackage = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EFactory eFactory = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("AdmissionMedicationHistorySection");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
			java.lang.reflect.Method initMethod = eObject.getClass().getMethod("init", new java.lang.Class[0]);
			initMethod.invoke(eObject, new Object[0]);
		...
		org.eclipse.emf.ecore.EPackage domainPackage = this.eClass().getEPackage();
		org.eclipse.emf.ecore.EFactory domainFactory = domainPackage.getEFactoryInstance();
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("AdmissionMedicationHistorySection");
		IAdmissionMedicationHistorySection value = (IAdmissionMedicationHistorySection) domainFactory.create(domainEClass);
		value.setCDAType((org.openhealthtools.mdht.uml.cda.Section) eObject);
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) eObject);
		return value;
	}
	 ...
	 * @generated
	 */
	public IDischargeSummary setAdmissionMedications(IAdmissionMedicationHistorySection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}

	/**
	 * The cached OCL expression body for the '{@link #getAdmittingDiagnosis() <em>Get Admitting Diagnosis</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String GET_ADMITTING_DIAGNOSIS__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(domain::HospitalAdmissionDiagnosisSection))->asSequence()->first().oclAsType(domain::HospitalAdmissionDiagnosisSection)";

	/**
	 * The cached OCL query for the '{@link #getAdmittingDiagnosis() <em>Get Admitting Diagnosis</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAdmittingDiagnosis()
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_ADMITTING_DIAGNOSIS__EOCL_QRY;
	 ...
	 * @generated
	 */
	public IHospitalAdmissionDiagnosisSection getAdmittingDiagnosis() {
		if (GET_ADMITTING_DIAGNOSIS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(51));
			try {
				GET_ADMITTING_DIAGNOSIS__EOCL_QRY = helper.createQuery(GET_ADMITTING_DIAGNOSIS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		OCL.Query query = EOCL_ENV.createQuery(GET_ADMITTING_DIAGNOSIS__EOCL_QRY);
		return (IHospitalAdmissionDiagnosisSection) query.evaluate(this);
	}
	 ...
	 * @generated
	 */
	public IHospitalAdmissionDiagnosisSection withAdmittingDiagnosis() {
		org.eclipse.emf.ecore.EPackage ePackage = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EFactory eFactory = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("HospitalAdmissionDiagnosisSection");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
			java.lang.reflect.Method initMethod = eObject.getClass().getMethod("init", new java.lang.Class[0]);
			initMethod.invoke(eObject, new Object[0]);
		...
		org.eclipse.emf.ecore.EPackage domainPackage = this.eClass().getEPackage();
		org.eclipse.emf.ecore.EFactory domainFactory = domainPackage.getEFactoryInstance();
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("HospitalAdmissionDiagnosisSection");
		IHospitalAdmissionDiagnosisSection value = (IHospitalAdmissionDiagnosisSection) domainFactory.create(domainEClass);
		value.setCDAType((org.openhealthtools.mdht.uml.cda.Section) eObject);
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) eObject);
		return value;
	}
	 ...
	 * @generated
	 */
	public IDischargeSummary setAdmittingDiagnosis(IHospitalAdmissionDiagnosisSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IAdvanceDirectivesSection getAdvanceDirectives() {
		if (GET_ADVANCE_DIRECTIVES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(54));
			try {
	 ...
	 * @generated
	 */
	public IDischargeSummary setAdvanceDirectives(IAdvanceDirectivesSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IAllergiesReactionsSection getAllergies() {
		if (GET_ALLERGIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(57));
			try {
	...
	public IDischargeDiagnosisSection getDischargeDiagnosis() {
		if (GET_DISCHARGE_DIAGNOSIS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(60));
			try {
	...
	public IDischargeDiet getDischargeDiet() {
		if (GET_DISCHARGE_DIET__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(63));
			try {
	...
	public IHospitalDischargeMedicationsSection getDischargeMeds() {
		if (GET_DISCHARGE_MEDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(66));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #getDischargeProceduresTestsAndReports() <em>Get Discharge Procedures Tests And Reports</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDischargeProceduresTestsAndReports()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_DISCHARGE_PROCEDURES_TESTS_AND_REPORTS__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(domain::DiagnosticResultsSection))->asSequence()->first().oclAsType(domain::DiagnosticResultsSection)";

	/**
	 * The cached OCL query for the '{@link #getDischargeProceduresTestsAndReports() <em>Get Discharge Procedures Tests And Reports</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDischargeProceduresTestsAndReports()
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_DISCHARGE_PROCEDURES_TESTS_AND_REPORTS__EOCL_QRY;
	 ...
	 * @generated
	 */
	public IDiagnosticResultsSection getDischargeProceduresTestsAndReports() {
		if (GET_DISCHARGE_PROCEDURES_TESTS_AND_REPORTS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(69));
			try {
				GET_DISCHARGE_PROCEDURES_TESTS_AND_REPORTS__EOCL_QRY = helper.createQuery(GET_DISCHARGE_PROCEDURES_TESTS_AND_REPORTS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		OCL.Query query = EOCL_ENV.createQuery(GET_DISCHARGE_PROCEDURES_TESTS_AND_REPORTS__EOCL_QRY);
	 ...
	 * @generated
	 */
	public IDiagnosticResultsSection withDischargeProceduresTestsAndReports() {
		org.eclipse.emf.ecore.EPackage ePackage = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EFactory eFactory = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
	 ...
	 * @generated
	 */
	public IDischargeSummary setDischargeProceduresTestsAndReports(IDiagnosticResultsSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IFunctionalStatusSection getFunctionalStatus() {
		if (GET_FUNCTIONAL_STATUS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(72));
			try {
	...
	public IHistoryOfPresentIllness getHistoryOfPresentIllness() {
		if (GET_HISTORY_OF_PRESENT_ILLNESS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(75));
			try {
	...
	public IHospitalCourseSection getHospitalCourse() {
		if (GET_HOSPITAL_COURSE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(78));
			try {
	...
	public IMedicalEquipmentSection getMedicalEquipment() {
		if (GET_MEDICAL_EQUIPMENT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(81));
			try {
	 ...
	 * @generated
	 */
	public IDischargeSummary setMedicalEquipment(IMedicalEquipmentSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IPhysicalExamSection getPhysicalExamination() {
		if (GET_PHYSICAL_EXAMINATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(84));
			try {
	 ...
	 * @generated
	 */
	public IDischargeSummary setPhysicalExamination(IPhysicalExamSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IPlanOfCareSection getPlanOfCare() {
		if (GET_PLAN_OF_CARE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(87));
			try {
	...
	public IHistoryOfPastIllnessSection getResolvedProblems() {
		if (GET_RESOLVED_PROBLEMS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(90));
			try {
	 ...
	 * @generated
	 */
	public IDischargeSummary setResolvedProblems(IHistoryOfPastIllnessSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IReviewOfSystemsSection getReviewOfSystems() {
		if (GET_REVIEW_OF_SYSTEMS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(93));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #getSelectedMedicationsAdministered() <em>Get Selected Medications Administered</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSelectedMedicationsAdministered()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_SELECTED_MEDICATIONS_ADMINISTERED__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(domain::MedicationsAdministeredSection))->asSequence()->first().oclAsType(domain::MedicationsAdministeredSection)";

	/**
	 * The cached OCL query for the '{@link #getSelectedMedicationsAdministered() <em>Get Selected Medications Administered</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSelectedMedicationsAdministered()
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_SELECTED_MEDICATIONS_ADMINISTERED__EOCL_QRY;
	 ...
	 * @generated
	 */
	public IMedicationsAdministeredSection getSelectedMedicationsAdministered() {
		if (GET_SELECTED_MEDICATIONS_ADMINISTERED__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(96));
			try {
				GET_SELECTED_MEDICATIONS_ADMINISTERED__EOCL_QRY = helper.createQuery(GET_SELECTED_MEDICATIONS_ADMINISTERED__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		OCL.Query query = EOCL_ENV.createQuery(GET_SELECTED_MEDICATIONS_ADMINISTERED__EOCL_QRY);
		return (IMedicationsAdministeredSection) query.evaluate(this);
	}
	 ...
	 * @generated
	 */
	public IMedicationsAdministeredSection withSelectedMedicationsAdministered() {
		org.eclipse.emf.ecore.EPackage ePackage = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EFactory eFactory = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/hitsp");
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("MedicationsAdministeredSection");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
			java.lang.reflect.Method initMethod = eObject.getClass().getMethod("init", new java.lang.Class[0]);
			initMethod.invoke(eObject, new Object[0]);
		...
		org.eclipse.emf.ecore.EPackage domainPackage = this.eClass().getEPackage();
		org.eclipse.emf.ecore.EFactory domainFactory = domainPackage.getEFactoryInstance();
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("MedicationsAdministeredSection");
		IMedicationsAdministeredSection value = (IMedicationsAdministeredSection) domainFactory.create(domainEClass);
		value.setCDAType((org.openhealthtools.mdht.uml.cda.Section) eObject);
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) eObject);
		return value;
	}
	 ...
	 * @generated
	 */
	public IDischargeSummary setSelectedMedicationsAdministered(IMedicationsAdministeredSection value) {
		this.getCDAType().addSection((org.openhealthtools.mdht.uml.cda.Section) value);
		return this;
	}
	...
	public IVitalSignsSection getVitalSigns() {
		if (GET_VITAL_SIGNS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getDischargeSummary(),
				IDomainPackage.eINSTANCE.getDischargeSummary().getEAllOperations().get(99));
			try {
