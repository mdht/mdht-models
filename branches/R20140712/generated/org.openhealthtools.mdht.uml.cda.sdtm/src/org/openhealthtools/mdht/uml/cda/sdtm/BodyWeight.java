 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Body WeightTemplateId Body WeightClassCode Body WeightCode Body WeightCodeP Body WeightId Body WeightMoodCode Body WeightfastingAssociationTypeCode' templateId.root='2.16.840.1.113883.10.20.23.43' classCode='OBS' code.codeSystem='2.16.840.1.113883.3.26.1.1' code.codeSystemName='NCI Thesaurus'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmBodyWeightfastingAssociation typeCode='COMP' constraints.validation.error='fastingAssociationTypeCode'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/sdtmBodyWeightfastingAssociationfastingStatus classCode='OBS' constraints.validation.error='fastingStatusClassCode fastingStatusCode fastingStatusCodeP fastingStatusMoodCode fastingStatusValue' code.codeSystem='2.16.840.1.113883.3.26.1.1' code.codeSystemName='NCI Thesaurus' constraints.validation.dependOn.fastingStatusCode='fastingStatusCodeP' moodCode='EVN'"
 * @generated
 */
public interface BodyWeight extends Observation
{
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.23.43\')'"
   * @generated
   */
   ...
   * @generated
   */
  boolean validateBodyWeightFastingAssociation(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
  boolean validateBodyWeightfastingAssociationTypeCode(DiagnosticChain diagnostics, Map<Object, Object> context);
