...
public class MassIdentificationOperations extends Participant2Operations
{
   ...
   * @ordered
   */
  protected static final String VALIDATE_MASS_IDENTIFICATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.23.75')";
