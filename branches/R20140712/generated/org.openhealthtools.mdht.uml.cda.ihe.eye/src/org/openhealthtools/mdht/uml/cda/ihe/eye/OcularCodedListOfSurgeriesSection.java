 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='OcularCodedListOfSurgeriesSectionTemplateId OcularCodedListOfSurgeriesSectionProcedureEntry' templateId.root='1.3.6.1.4.1.19376.1.12.1.2.2' constraints.validation.warning='OcularCodedListOfSurgeriesSectionExternalReference'"
 * @generated
 */
public interface OcularCodedListOfSurgeriesSection extends CodedSurgeriesSection {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->one(entry : cda::Entry | not entry.procedure.oclIsUndefined() and entry.procedure.oclIsKindOf(ihe::ProcedureEntry))'"
	 * @generated
	 */
