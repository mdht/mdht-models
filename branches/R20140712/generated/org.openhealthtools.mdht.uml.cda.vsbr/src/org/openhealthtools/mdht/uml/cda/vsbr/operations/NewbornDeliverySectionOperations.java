...
"value.code = '57075-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateNewbornDeliverySectionAssessmentsSection(NewbornDeliverySection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Newborn Delivery Section Assessments Section</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateNewbornDeliverySectionAssessmentsSection(NewbornDeliverySection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  ...
  public static  boolean validateNewbornDeliverySectionAssessmentsSection(NewbornDeliverySection newbornDeliverySection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NEWBORN_DELIVERY_SECTION_ASSESSMENTS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(newbornDeliverySection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NewbornDeliverySectionAssessmentsSection", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(newbornDeliverySection, context) }),
             new Object [] { newbornDeliverySection }));
      }
...
"value.code = 'CHILD' and value.codeSystem = '2.16.840.1.113883.5.111'))";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(VsbrPackage.Literals.NEWBORN_DELIVERY_SECTION, VsbrPackage.Literals.NEWBORN_DELIVERY_SECTION.getEAllOperations().get(91));
      try
      {
  ...
  /**
   * The cached OCL expression body for the '{@link #getAssessmentsSection(NewbornDeliverySection) <em>Get Assessments Section</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getAssessmentsSection(NewbornDeliverySection)
   * @generated
   * @ordered
   */
  ...
  public static  AssessmentsSection getAssessmentsSection(NewbornDeliverySection newbornDeliverySection)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(VsbrPackage.Literals.NEWBORN_DELIVERY_SECTION, VsbrPackage.Literals.NEWBORN_DELIVERY_SECTION.getEAllOperations().get(92));
      try
      {
        GET_ASSESSMENTS_SECTION__EOCL_QRY = helper.createQuery(GET_ASSESSMENTS_SECTION__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
