...
public class FetalDeliveryTimeOperations extends ClinicalStatementOperations {
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DELIVERY_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeliveryTime))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeliveryTimeTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeliveryTime, context) }),
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DELIVERY_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeliveryTime))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeliveryTimeMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeliveryTime, context) }),
             new Object [] { fetalDeliveryTime }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DELIVERY_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeliveryTime))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeliveryTimeCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeliveryTime, context) }),
             new Object [] { fetalDeliveryTime }));
      }
...
"value.code = '11778-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DELIVERY_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeliveryTime))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeliveryTimeCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeliveryTime, context) }),
             new Object [] { fetalDeliveryTime }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DELIVERY_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeliveryTime))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeliveryTimeValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeliveryTime, context) }),
             new Object [] { fetalDeliveryTime }));
      }
  ...
  /**
   * The cached OCL expression body for the '{@link #validateFetalDeliveryTimeParticipatingLocation(FetalDeliveryTime, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Fetal Delivery Time Participating Location</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateFetalDeliveryTimeParticipatingLocation(FetalDeliveryTime, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_FETAL_DELIVERY_TIME_PARTICIPATING_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.participant->one(participant : cda::Participant2 | not participant.oclIsUndefined() and participant.oclIsKindOf(cda::Participant2))";

  /**
   * The cached OCL invariant for the '{@link #validateFetalDeliveryTimeParticipatingLocation(FetalDeliveryTime, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Fetal Delivery Time Participating Location</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateFetalDeliveryTimeParticipatingLocation(FetalDeliveryTime, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  public static  boolean validateFetalDeliveryTimeParticipatingLocation(FetalDeliveryTime fetalDeliveryTime, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FETAL_DELIVERY_TIME_PARTICIPATING_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(fetalDeliveryTime))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FetalDeliveryTimeParticipatingLocation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(fetalDeliveryTime, context) }),
             new Object [] { fetalDeliveryTime }));
      }
