...
public class AcuteHepatitisBPHCRClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_ACUTE_HEPATITIS_BCASE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(hepb::AcuteHepatitisBCaseObservation))->asSequence()->any(true).oclAsType(hepb::AcuteHepatitisBCaseObservation)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(hepb::AcuteHepatitisBCaseObservation))->asSequence()->any(true).oclAsType(hepb::AcuteHepatitisBCaseObservation)
	 * @param acuteHepatitisBPHCRClinicalInformationSection The receiving '<em><b>Acute Hepatitis BPHCR Clinical Information Section</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
