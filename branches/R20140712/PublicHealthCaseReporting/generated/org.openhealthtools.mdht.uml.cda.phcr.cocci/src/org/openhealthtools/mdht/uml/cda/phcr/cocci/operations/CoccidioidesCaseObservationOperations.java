...
public class CoccidioidesCaseObservationOperations extends CaseObservationOperations {
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateCoccidioidesCaseObservationValueP(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Case Observation Value P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesCaseObservationValueP(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (not self.value->isEmpty())";

  /**
   * The cached OCL invariant for the '{@link #validateCoccidioidesCaseObservationValueP(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Case Observation Value P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesCaseObservationValueP(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateCoccidioidesCaseObservationValueP(CoccidioidesCaseObservation coccidioidesCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
    {
      ...
      try
      {
        VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coccidioidesCaseObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
  ...
  /**
   * The cached OCL expression body for the '{@link #validateCoccidioidesCaseObservationValue(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Case Observation Value</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesCaseObservationValue(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | not element.oclIsUndefined() and element.oclIsKindOf(datatypes::CD) and "+
"let value : datatypes::CD = element.oclAsType(datatypes::CD) in "+
"value.code = '60826002' and value.codeSystem = '2.16.840.1.113883.6.96'))";

  /**
   * The cached OCL invariant for the '{@link #validateCoccidioidesCaseObservationValue(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Coccidioides Case Observation Value</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCoccidioidesCaseObservationValue(CoccidioidesCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateCoccidioidesCaseObservationValue(CoccidioidesCaseObservation coccidioidesCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
    {
      ...
      try
      {
        VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_COCCIDIOIDES_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(coccidioidesCaseObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
