				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PhcrTreatmentInformationSectionCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(phcrTreatmentInformationSection, context) }),
						 new Object [] { phcrTreatmentInformationSection }));
			}
