				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EstimatedDateOfDeliveryObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(estimatedDateOfDeliveryObservation, context) }),
						 new Object [] { estimatedDateOfDeliveryObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EstimatedDateOfDeliveryObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(estimatedDateOfDeliveryObservation, context) }),
						 new Object [] { estimatedDateOfDeliveryObservation }));
			}
