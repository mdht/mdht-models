				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "GeotemporalHistoryObservationValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(geotemporalHistoryObservation, context) }),
						 new Object [] { geotemporalHistoryObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "GeotemporalHistoryObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(geotemporalHistoryObservation, context) }),
						 new Object [] { geotemporalHistoryObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "GeotemporalHistoryObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(geotemporalHistoryObservation, context) }),
						 new Object [] { geotemporalHistoryObservation }));
			}
