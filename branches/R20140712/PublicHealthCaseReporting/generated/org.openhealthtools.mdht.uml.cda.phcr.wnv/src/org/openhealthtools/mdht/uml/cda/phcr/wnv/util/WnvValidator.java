...
public class WnvValidator extends EObjectValidator
{
   ...
   */
	public static final int WNV_PHCR_CLINICAL_INFORMATION_SECTION__PHCR_CLINICAL_INFORMATION_SECTION_TEMPLATE_ID = 6;
		...
		/**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Wnv Case Observation Value' of 'Case Observation'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int WNV_CASE_OBSERVATION__WNV_CASE_OBSERVATION_VALUE = 7;
   ...
   * @generated
   */
	public static final int WNV_CASE_OBSERVATION__WNV_CASE_OBSERVATION_WNV_SIGNS_AND_SYMPTOMS_OBSERVATION = 8;
   ...
   * @generated
   */
	public static final int WNV_CASE_OBSERVATION__PROBLEM_OBSERVATION_TEMPLATE_ID = 9;

		/**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Wnv Signs And Symptoms Observation Value' of 'Signs And Symptoms Observation'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int WNV_SIGNS_AND_SYMPTOMS_OBSERVATION__WNV_SIGNS_AND_SYMPTOMS_OBSERVATION_VALUE = 10;
   ...
   * @generated
   */
	public static final int WNV_SIGNS_AND_SYMPTOMS_OBSERVATION__SIGNS_AND_SYMPTOMS_OBSERVATION_TEMPLATE_ID = 11;
   ...
   * @generated
   */
	public static final int WNV_PHCR_RELEVANT_DX_TESTS_SECTION__WNV_PHCR_RELEVANT_DX_TESTS_SECTION_WNV_RESULT_ORGANIZER = 13;
   ...
   * @generated
   */
	public static final int WNV_PHCR_RELEVANT_DX_TESTS_SECTION__WNV_PHCR_RELEVANT_DX_TESTS_SECTION_WNV_RESULT_OBSERVATION = 12;
   ...
   * @generated
   */
	public static final int WNV_PHCR_RELEVANT_DX_TESTS_SECTION__RESULTS_SECTION_TEMPLATE_ID = 14;

		/**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Wnv Result Observation Code P' of 'Result Observation'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int WNV_RESULT_OBSERVATION__WNV_RESULT_OBSERVATION_CODE_P = 15;

    /**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Wnv Result Observation Code' of 'Result Observation'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int WNV_RESULT_OBSERVATION__WNV_RESULT_OBSERVATION_CODE = 16;
   ...
   * @generated
   */
	public static final int WNV_RESULT_ORGANIZER__WNV_RESULT_ORGANIZER_WNV_RESULT_OBSERVATION = 20;
   ...
   * @generated
   */
	public static final int WNV_RESULT_ORGANIZER__RESULT_ORGANIZER_TEMPLATE_ID = 21;
   ...
   * @generated
   */
	public static final int WNV_RESULT_OBSERVATION__RESULT_OBSERVATION_TEMPLATE_ID = 17;

		/**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Wnv Result Organizer Code P' of 'Result Organizer'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int WNV_RESULT_ORGANIZER__WNV_RESULT_ORGANIZER_CODE_P = 18;

    /**
   * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Wnv Result Organizer Code' of 'Result Organizer'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final int WNV_RESULT_ORGANIZER__WNV_RESULT_ORGANIZER_CODE = 19;
  ...
  public boolean validateWestNileVirusCaseReport(WestNileVirusCaseReport westNileVirusCaseReport, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePublicHealthCaseReport_validatePublicHealthCaseReportCodeP(westNileVirusCaseReport, diagnostics, context);
  ...
  public boolean validateWnvPhcrClinicalInformationSection(WnvPhcrClinicalInformationSection wnvPhcrClinicalInformationSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrClinicalInformationSection_validatePhcrClinicalInformationSectionCodeP(wnvPhcrClinicalInformationSection, diagnostics, context);
  ...
  public boolean validateWnvCaseObservation(WnvCaseObservation wnvCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateProblemObservation_validateProblemObservationStatusCode(wnvCaseObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateCaseObservationCodeP(wnvCaseObservation, diagnostics, context);
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateCaseObservationCode(wnvCaseObservation, diagnostics, context);
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateCaseObservationStatusCodeP(wnvCaseObservation, diagnostics, context);
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateCaseObservationStatusCode(wnvCaseObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateWnvCaseObservation_validateWnvCaseObservationValue(wnvCaseObservation, diagnostics, context);
  ...
  /**
   * Validates the validateWnvCaseObservationValue constraint of '<em>Case Observation</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateWnvCaseObservation_validateWnvCaseObservationValue(WnvCaseObservation wnvCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return wnvCaseObservation.validateWnvCaseObservationValue(diagnostics, context);
  }
  ...
  public boolean validateWnvSignsAndSymptomsObservation(WnvSignsAndSymptomsObservation wnvSignsAndSymptomsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateSignsAndSymptomsObservation_validateSignsAndSymptomsObservationCodeP(wnvSignsAndSymptomsObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateSignsAndSymptomsObservation_validateSignsAndSymptomsObservationStatusCodeP(wnvSignsAndSymptomsObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateWnvSignsAndSymptomsObservation_validateWnvSignsAndSymptomsObservationValue(wnvSignsAndSymptomsObservation, diagnostics, context);
    return result;
  }

  /**
   * Validates the validateWnvSignsAndSymptomsObservationValue constraint of '<em>Signs And Symptoms Observation</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateWnvSignsAndSymptomsObservation_validateWnvSignsAndSymptomsObservationValue(WnvSignsAndSymptomsObservation wnvSignsAndSymptomsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return wnvSignsAndSymptomsObservation.validateWnvSignsAndSymptomsObservationValue(diagnostics, context);
  }
  ...
  public boolean validateWnvPhcrRelevantDxTestsSection(WnvPhcrRelevantDxTestsSection wnvPhcrRelevantDxTestsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateResultsSection_validateResultsSectionCode(wnvPhcrRelevantDxTestsSection, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrRelevantDxTestsSection_validatePhcrRelevantDxTestsSectionCodeP(wnvPhcrRelevantDxTestsSection, diagnostics, context);
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrRelevantDxTestsSection_validatePhcrRelevantDxTestsSectionCode(wnvPhcrRelevantDxTestsSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= ccdValidator.validateResultObservation_validateResultObservationStatusCode(wnvResultObservation, diagnostics, context);
    if (result || diagnostics != null) result &= ccdValidator.validateResultObservation_validateResultObservationCode(wnvResultObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateResultObservation_validatePHCRResultObservationStatusCodeP(wnvResultObservation, diagnostics, context);
    if (result || diagnostics != null) result &= phcrValidator.validateResultObservation_validatePHCRResultObservationStatusCode(wnvResultObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateWnvResultObservation_validateWnvResultObservationCodeP(wnvResultObservation, diagnostics, context);
    if (result || diagnostics != null) result &= validateWnvResultObservation_validateWnvResultObservationCode(wnvResultObservation, diagnostics, context);
    return result;
  }

		/**
   * Validates the validateWnvResultObservationCodeP constraint of '<em>Result Observation</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateWnvResultObservation_validateWnvResultObservationCodeP(WnvResultObservation wnvResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return wnvResultObservation.validateWnvResultObservationCodeP(diagnostics, context);
  }

    /**
   * Validates the validateWnvResultObservationCode constraint of '<em>Result Observation</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateWnvResultObservation_validateWnvResultObservationCode(WnvResultObservation wnvResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return wnvResultObservation.validateWnvResultObservationCode(diagnostics, context);
  }
   ...
   */
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateResultOrganizer_validatePHCRResultOrganizerStatusCodeP(wnvResultOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= phcrValidator.validateResultOrganizer_validatePHCRResultOrganizerStatusCode(wnvResultOrganizer, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= validateWnvResultOrganizer_validateWnvResultOrganizerCodeP(wnvResultOrganizer, diagnostics, context);
    if (result || diagnostics != null) result &= validateWnvResultOrganizer_validateWnvResultOrganizerCode(wnvResultOrganizer, diagnostics, context);
    ...
    return result;
		...
		/**
   * Validates the validateWnvResultOrganizerCodeP constraint of '<em>Result Organizer</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateWnvResultOrganizer_validateWnvResultOrganizerCodeP(WnvResultOrganizer wnvResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return wnvResultOrganizer.validateWnvResultOrganizerCodeP(diagnostics, context);
  }

    /**
   * Validates the validateWnvResultOrganizerCode constraint of '<em>Result Organizer</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateWnvResultOrganizer_validateWnvResultOrganizerCode(WnvResultOrganizer wnvResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    return wnvResultOrganizer.validateWnvResultOrganizerCode(diagnostics, context);
  }
