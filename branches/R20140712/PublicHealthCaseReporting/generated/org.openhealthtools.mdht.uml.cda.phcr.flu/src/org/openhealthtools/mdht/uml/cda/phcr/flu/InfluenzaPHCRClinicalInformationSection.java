...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Influenza PHCR Clinical Information Section</b></em>'.
 * <!-- end-user-doc -->
 *
 *
...
public interface InfluenzaPHCRClinicalInformationSection extends PhcrClinicalInformationSection {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(flu::InfluenzaCaseObservation) and entry.typeCode = vocab::x_ActRelationshipEntry::DRIV)'"
	 * @generated
	 */
	boolean validateInfluenzaPHCRClinicalInformationSectionInfluenzaCaseObservation(DiagnosticChain diagnostics, Map<Object, Object> context);
