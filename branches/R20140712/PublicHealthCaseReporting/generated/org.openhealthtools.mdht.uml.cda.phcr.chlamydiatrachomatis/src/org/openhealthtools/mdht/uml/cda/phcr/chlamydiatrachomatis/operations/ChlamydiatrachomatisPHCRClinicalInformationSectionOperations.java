...
public class ChlamydiatrachomatisPHCRClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(ChlamydiatrachomatisPackage.Literals.CHLAMYDIATRACHOMATIS_PHCR_CLINICAL_INFORMATION_SECTION, ChlamydiatrachomatisPackage.Literals.CHLAMYDIATRACHOMATIS_PHCR_CLINICAL_INFORMATION_SECTION.getEAllOperations().get(70));
      try
      {
