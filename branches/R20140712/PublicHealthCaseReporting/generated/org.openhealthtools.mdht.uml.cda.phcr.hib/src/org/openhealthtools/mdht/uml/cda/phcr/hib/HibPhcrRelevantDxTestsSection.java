...
public interface HibPhcrRelevantDxTestsSection extends PhcrRelevantDxTestsSection {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->exists(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(hib::HibResultObservation) and entry.typeCode = vocab::x_ActRelationshipEntry::DRIV)'"
	 * @generated
	 */
	boolean validateHibPhcrRelevantDxTestsSectionHibResultObservation(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->exists(entry : cda::Entry | not entry.organizer.oclIsUndefined() and entry.organizer.oclIsKindOf(hib::HibResultOrganizer) and entry.typeCode = vocab::x_ActRelationshipEntry::DRIV)'"
	 * @generated
	 */
	boolean validateHibPhcrRelevantDxTestsSectionHibResultOrganizer(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(hib::HibResultObservation)).oclAsType(hib::HibResultObservation)'"
	 * @generated
	 */
	EList<HibResultObservation> getHibResultObservations();
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getOrganizers()->select(organizer : cda::Organizer | not organizer.oclIsUndefined() and organizer.oclIsKindOf(hib::HibResultOrganizer)).oclAsType(hib::HibResultOrganizer)'"
	 * @generated
	 */
	EList<HibResultOrganizer> getHibResultOrganizers();
