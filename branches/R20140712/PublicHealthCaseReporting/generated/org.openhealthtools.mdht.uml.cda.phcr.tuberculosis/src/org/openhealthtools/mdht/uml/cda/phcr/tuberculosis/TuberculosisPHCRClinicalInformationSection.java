 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='TuberculosisPHCRClinicalInformationSectionTemplateId TuberculosisPHCRClinicalInformationSectionTuberculosisCaseObservation' templateId.root='2.16.840.1.113883.10.20.15.2.5' constraints.validation.warning='TuberculosisPHCRClinicalInformationSectionTuberculosisRelevantMedicalConditionHistoryObservation'"
 * @generated
 */
public interface TuberculosisPHCRClinicalInformationSection extends PhcrClinicalInformationSection {
  ...
  /**
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(tuberculosis::TuberculosisCaseObservation))->asSequence()->any(true).oclAsType(tuberculosis::TuberculosisCaseObservation)
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(tuberculosis::TuberculosisCaseObservation))->asSequence()->any(true).oclAsType(tuberculosis::TuberculosisCaseObservation)'"
	 * @generated
	 */
  ...
  /**
     ...
     * @generated
     */
    public TuberculosisPHCRClinicalInformationSection init(Iterable<? extends Initializer<? extends EObject>> initializers);
