 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.DischargeDietImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DischargeDietImpl extends EObjectImpl implements IDischargeDiet {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getDischargeDiet();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.DISCHARGE_DIET__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
