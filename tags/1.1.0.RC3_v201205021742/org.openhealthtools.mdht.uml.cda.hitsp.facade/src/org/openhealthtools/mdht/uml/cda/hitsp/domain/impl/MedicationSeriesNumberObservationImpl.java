 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.MedicationSeriesNumberObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MedicationSeriesNumberObservationImpl extends EObjectImpl implements IMedicationSeriesNumberObservation {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMedicationSeriesNumberObservation();
	}
	...
	public CS getStatusCode() {
		if (GET_STATUS_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getMedicationSeriesNumberObservation(),
				IDomainPackage.eINSTANCE.getMedicationSeriesNumberObservation().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IMedicationSeriesNumberObservation setStatusCode(CS value) {
		this.getCDAType().setStatusCode(value);
		return this;
	}
	 ...
	 * @ordered
	 */
	protected static final String GET_VALUE__EOCL_EXP = "self.value.oclAsType(datatypes::INT)";
	...
	public INT getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getMedicationSeriesNumberObservation(),
				IDomainPackage.eINSTANCE.getMedicationSeriesNumberObservation().getEAllOperations().get(3));
			try {
		...
		return (INT) query.evaluate(this);
	}
	...
	public INT withValue() {
		org.eclipse.emf.ecore.EPackage ePackage = org.openhealthtools.mdht.uml.hl7.datatypes.DatatypesPackage.eINSTANCE;
		org.eclipse.emf.ecore.EFactory eFactory = org.openhealthtools.mdht.uml.hl7.datatypes.DatatypesFactory.eINSTANCE;
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("INT");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		INT value = (INT) eObject;
	 ...
	 * @generated
	 */
	public IMedicationSeriesNumberObservation setValue(INT value) {
		this.getCDAType().getValues().add(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MEDICATION_SERIES_NUMBER_OBSERVATION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
