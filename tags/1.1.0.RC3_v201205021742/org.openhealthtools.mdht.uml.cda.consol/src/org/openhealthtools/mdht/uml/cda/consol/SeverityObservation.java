 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation interpretationCode.codeSystemName='ObservationInterpretation' moodCode='EVN' value.codeSystemName='SNOMEDCT' classCode='OBS' code.codeSystemName='HL7ActCode' constraints.validation.error='SeverityObservationTemplateId SeverityObservationReferenceValue SeverityObservationClassCode SeverityObservationMoodCode SeverityObservationCode SeverityObservationStatusCode SeverityObservationValue' code.displayName='Severity observation' code.code='SEV' interpretationCode.codeSystem='2.16.840.1.113883.5.83' value.codeSystem='2.16.840.1.113883.6.96' templateId.root='2.16.840.1.113883.10.20.22.4.8' statusCode.code='completed' code.codeSystem='2.16.840.1.113883.5.4' constraints.validation.warning='SeverityObservationTextReference SeverityObservationText SeverityObservationInterpretationCode'"
 * @generated
 */
public interface SeverityObservation extends Observation {
	 ...
	 * @generated
	 */
	boolean validateSeverityObservationTextReference(DiagnosticChain diagnostics, Map<Object, Object> context);
