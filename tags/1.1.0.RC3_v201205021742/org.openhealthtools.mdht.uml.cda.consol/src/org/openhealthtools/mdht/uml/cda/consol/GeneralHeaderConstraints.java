 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatient maritalStatusCode.codeSystemName='MaritalStatus' maritalStatusCode.codeSystem='2.16.840.1.113883.5.2' ethnicGroupCode.codeSystemName='Race and Ethnicity - CDC' administrativeGenderCode.codeSystemName='AdministrativeGenderCode' constraints.validation.error='PatientBirthTimePreciseToYear PatientAdministrativeGenderCode PatientBirthTime PatientEthnicGroupCode PatientName' constraints.validation.info='PatientEthnicGroupCodeP PatientRaceCode PatientReligiousAffiliationCode PatientGuardian PatientBirthplace' ethnicGroupCode.codeSystem='2.16.840.1.113883.6.238' administrativeGenderCode.codeSystem='2.16.840.1.113883.5.1' constraints.validation.dependOn.PatientEthnicGroupCode='PatientEthnicGroupCodeP' constraints.validation.warning='PatientBirthTimePreciseToDay PatientMaritalStatusCode PatientLanguageCommunication'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientGuardian constraints.validation.dependOn.GuardianCode='GuardianCodeP' code.codeSystemName='RoleCode' constraints.validation.error='GuardianCode GuardianGuardianPerson' constraints.validation.info='GuardianTelecom' code.codeSystem='2.16.840.1.113883.5.111' constraints.validation.warning='GuardianAddr GuardianCodeP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication constraints.validation.dependOn.LanguageCommunicationProficiencyLevelCode='LanguageCommunicationProficiencyLevelCodeP' modeCode.codeSystemName='LanguageAbilityMode' constraints.validation.dependOn.LanguageCommunicationModeCode='LanguageCommunicationModeCodeP' proficiencyLevelCode.codeSystemName='LanguageAbilityProficiency' modeCode.codeSystem='2.16.840.1.113883.5.60' constraints.validation.error='LanguageCommunicationLanguageCode LanguageCommunicationProficiencyLevelCode LanguageCommunicationModeCode' constraints.validation.info='LanguageCommunicationPreferenceInd LanguageCommunicationModeCodeP' proficiencyLevelCode.codeSystem='2.16.840.1.113883.5.61' constraints.validation.warning='LanguageCommunicationProficiencyLevelCodeP'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsAuthorAssignedAuthor code.codeSystemName='NUCC Health Care Provider Taxonomy' constraints.validation.error='AssignedAuthorHasAssignedPersonOrAssignedAuthoringDevice AssignedAuthorHasNationalProviderIdentifier AssignedAuthorAddr AssignedAuthorId AssignedAuthorTelecom' constraints.validation.dependOn.AssignedAuthorCode='AssignedAuthorCodeP' code.codeSystem='2.16.840.1.113883.6.101' constraints.validation.warning='AssignedAuthorCode AssignedAuthorCodeP'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsDataEntererAssignedEntity constraints.validation.dependOn.AssignedEntityCode='AssignedEntityCodeP' code.codeSystemName='NUCC Health Care Provider Taxonomy' constraints.validation.error='AssignedEntityAddr AssignedEntityId AssignedEntityTelecom AssignedEntityAssignedPerson' constraints.validation.info='AssignedEntityCodeP' code.codeSystem='2.16.840.1.113883.6.101' constraints.validation.warning='AssignedEntityHasNationalProviderIdentifier AssignedEntityCode'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsLegalAuthenticator signatureCode.code='S' constraints.validation.error='LegalAuthenticatorTime LegalAuthenticatorSignatureCode'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsLegalAuthenticatorAssignedEntity constraints.validation.dependOn.AssignedEntityCode='AssignedEntityCodeP' code.codeSystemName='NUCC Health Care Provider Taxonomy' constraints.validation.error='AssignedEntityHasNationalProviderIdentifier AssignedEntityAddr AssignedEntityId AssignedEntityTelecom AssignedEntityAssignedPerson' constraints.validation.info='AssignedEntityCodeP' code.codeSystem='2.16.840.1.113883.6.101' constraints.validation.warning='AssignedEntityCode'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsAuthenticator signatureCode.code='S' constraints.validation.error='AuthenticatorTime AuthenticatorSignatureCode AuthenticatorAssignedEntity'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsAuthenticatorAssignedEntity constraints.validation.dependOn.AssignedEntityCode='AssignedEntityCodeP' code.codeSystemName='NUCC Health Care Provider Taxonomy' constraints.validation.error='AssignedEntityHasNationalProviderIdentifier AssignedEntityAddr AssignedEntityId AssignedEntityTelecom' constraints.validation.info='AssignedEntityCodeP' code.codeSystem='2.16.840.1.113883.6.101' constraints.validation.warning='AssignedEntityCode'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsInformantAssignedEntity constraints.validation.dependOn.AssignedEntityCode='AssignedEntityCodeP' code.codeSystemName='NUCC Health Care Provider Taxonomy' constraints.validation.error='AssignedEntityHasNationalProviderIdentifier AssignedEntityPerson' constraints.validation.info='AssignedEntityCodeP' code.codeSystem='2.16.840.1.113883.6.101' constraints.validation.warning='AssignedEntityAddr AssignedEntityCode AssignedEntityId'"
