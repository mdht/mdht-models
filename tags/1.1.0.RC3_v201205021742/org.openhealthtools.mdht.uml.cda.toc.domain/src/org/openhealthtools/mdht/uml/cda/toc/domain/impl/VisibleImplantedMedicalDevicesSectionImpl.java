 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.VisibleImplantedMedicalDevicesSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VisibleImplantedMedicalDevicesSectionImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getVisibleImplantedMedicalDevicesSection();
	}
	...
	/**
	 * The cached OCL expression body for the '{@link #getProblemEntry() <em>Get Problem Entry</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemEntry()
	 * @generated
	 * @ordered
	 */
	protected static final String GET_PROBLEM_ENTRY__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(domain::ProblemEntry))->asSequence()->first().oclAsType(domain::ProblemEntry)";

	/**
	 * The cached OCL query for the '{@link #getProblemEntry() <em>Get Problem Entry</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemEntry()
	 * @generated
	 ...
	 * @generated
	 */
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getVisibleImplantedMedicalDevicesSection(),
				IDomainPackage.eINSTANCE.getVisibleImplantedMedicalDevicesSection().getEAllOperations().get(0));
			try {
		...
		return (IProblemEntry) query.evaluate(this);
	}
	 ...
	 * @generated
	 */
	public IProblemEntry withProblemEntry() {
	 ...
	 * @generated
	 */
	public IVisibleImplantedMedicalDevicesSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.VISIBLE_IMPLANTED_MEDICAL_DEVICES_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
