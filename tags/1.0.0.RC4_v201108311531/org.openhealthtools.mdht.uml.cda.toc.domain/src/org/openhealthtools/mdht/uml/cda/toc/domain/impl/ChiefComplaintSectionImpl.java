 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.ChiefComplaintSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ChiefComplaintSectionImpl extends EObjectImpl implements IChiefComplaintSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getChiefComplaintSection();
	}
	...
	public ICondition getCondition() {
		if (GET_CONDITION__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getChiefComplaintSection(), IDomainPackage.eINSTANCE.getChiefComplaintSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IChiefComplaintSection setCondition(ICondition value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.CHIEF_COMPLAINT_SECTION__CDA_TYPE:
