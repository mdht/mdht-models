 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.PayerEntityImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PayerEntityImpl extends EObjectImpl implements IPayerEntity {
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPayerEntity(), IDomainPackage.eINSTANCE.getPayerEntity().getEAllOperations().get(0));
			try {
