 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.FulfillmentInstructionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FulfillmentInstructionImpl extends EObjectImpl implements IFulfillmentInstruction {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getFulfillmentInstruction(), IDomainPackage.eINSTANCE.getFulfillmentInstruction().getEAllOperations().get(0));
			try {
