 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.StatusObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatusObservationImpl extends EObjectImpl implements IStatusObservation {
	...
	public CE getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getStatusObservation(), IDomainPackage.eINSTANCE.getStatusObservation().getEAllOperations().get(0));
			try {
