 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.FulfillmentInstructionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FulfillmentInstructionImpl extends EObjectImpl implements IFulfillmentInstruction {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getFulfillmentInstruction();
	}
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getFulfillmentInstruction(),
				IDomainPackage.eINSTANCE.getFulfillmentInstruction().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IFulfillmentInstruction setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.FULFILLMENT_INSTRUCTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
