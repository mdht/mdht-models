...
public class HearingScreeningCodedResultsSectionOperations extends CodedResultsSectionOperations
{
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '1.3.6.1.4.1.19376.1.7.3.1.1.15.3.2')
	 * @param hearingScreeningCodedResultsSection The receiving '<em><b>Hearing Screening Coded Results Section</b></em>' model object.
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "CodedResultsSectionTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(hearingScreeningCodedResultsSection, context) }),
