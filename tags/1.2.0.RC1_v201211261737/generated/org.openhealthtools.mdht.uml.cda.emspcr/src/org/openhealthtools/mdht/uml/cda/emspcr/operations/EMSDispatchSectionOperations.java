...
public class EMSDispatchSectionOperations extends SectionOperations {
	...
	public static boolean validateEMSDispatchSectionTemplateId(EMSDispatchSection emsDispatchSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_DISPATCH_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsDispatchSection)) {
			if (diagnostics != null) {
	...
	public static boolean validateEMSDispatchSectionCode(EMSDispatchSection emsDispatchSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_DISPATCH_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsDispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_DISPATCH_SECTION__EMS_DISPATCH_SECTION_CODE,
					EmspcrPlugin.INSTANCE.getString("EMSDispatchSectionCode"), new Object[] { emsDispatchSection }));
			}
	...
	public static boolean validateEMSDispatchSectionText(EMSDispatchSection emsDispatchSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_DISPATCH_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsDispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_DISPATCH_SECTION__EMS_DISPATCH_SECTION_TEXT,
					EmspcrPlugin.INSTANCE.getString("EMSDispatchSectionText"), new Object[] { emsDispatchSection }));
			}
	...
	public static boolean validateEMSDispatchSectionTitle(EMSDispatchSection emsDispatchSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_DISPATCH_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsDispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_DISPATCH_SECTION__EMS_DISPATCH_SECTION_TITLE,
					EmspcrPlugin.INSTANCE.getString("EMSDispatchSectionTitle"), new Object[] { emsDispatchSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_DISPATCH_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSDispatchSectionEntry1(EMSDispatchSection emsDispatchSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_DISPATCH_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsDispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_DISPATCH_SECTION__EMS_DISPATCH_SECTION_ENTRY1,
					EmspcrPlugin.INSTANCE.getString("EMSDispatchSectionEntry1"), new Object[] { emsDispatchSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_DISPATCH_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSDispatchSectionEntry2(EMSDispatchSection emsDispatchSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_DISPATCH_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsDispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_DISPATCH_SECTION__EMS_DISPATCH_SECTION_ENTRY2,
					EmspcrPlugin.INSTANCE.getString("EMSDispatchSectionEntry2"), new Object[] { emsDispatchSection }));
			}
