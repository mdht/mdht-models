...
public class PatientCareReportOperations extends GeneralHeaderConstraintsOperations {
	...
	public static boolean validatePatientCareReportAuthor(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.PATIENT_CARE_REPORT__PATIENT_CARE_REPORT_AUTHOR,
					EmspcrPlugin.INSTANCE.getString("PatientCareReportAuthor"), new Object[] { patientCareReport }));
			}
	...
	public static boolean validatePatientCareReportHumanAuthor(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_HUMAN_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.PATIENT_CARE_REPORT__PATIENT_CARE_REPORT_HUMAN_AUTHOR,
					EmspcrPlugin.INSTANCE.getString("PatientCareReportHumanAuthor"), new Object[] { patientCareReport }));
			}
	...
	public static boolean validatePatientCareReportEMSHumanAuthorParticipation(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_HUMAN_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.WARNING, EmspcrValidator.DIAGNOSTIC_SOURCE,
