...
public class EMSTimesSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry1(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY1,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry1"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry2(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY2,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry2"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry3(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY3,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry3"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry4(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY4,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry4"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY5__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry5(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY5__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY5,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry5"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY6__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry6(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY6__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY6,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry6"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY7__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry7(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY7__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY7,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry7"), new Object[] { emsTimesSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY8__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSTimesSectionEntry8(EMSTimesSection emsTimesSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_TIMES_SECTION_ENTRY8__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsTimesSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_TIMES_SECTION__EMS_TIMES_SECTION_ENTRY8,
					EmspcrPlugin.INSTANCE.getString("EMSTimesSectionEntry8"), new Object[] { emsTimesSection }));
			}
