 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.RectumSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RectumSectionImpl extends EObjectImpl implements IRectumSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getRectumSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getRectumSection(),
				IDomainPackage.eINSTANCE.getRectumSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IRectumSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.RECTUM_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
