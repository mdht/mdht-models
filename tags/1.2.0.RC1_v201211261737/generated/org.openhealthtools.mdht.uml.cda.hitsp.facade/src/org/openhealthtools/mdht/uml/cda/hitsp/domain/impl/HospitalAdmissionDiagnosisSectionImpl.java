...
public class HospitalAdmissionDiagnosisSectionImpl extends EObjectImpl implements IHospitalAdmissionDiagnosisSection {
	...
	public ICondition getCondition() {
		if (GET_CONDITION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getHospitalAdmissionDiagnosisSection(),
				IDomainPackage.eINSTANCE.getHospitalAdmissionDiagnosisSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IHospitalAdmissionDiagnosisSection setCondition(ICondition value) {
