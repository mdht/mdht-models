 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.ICommentImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ICommentImpl extends EObjectImpl implements IComment {
	/**
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ICOMMENT;
	}
	...
	public ED getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				DomainPackage.Literals.ICOMMENT, DomainPackage.Literals.ICOMMENT.getEAllOperations().get(0));
			try {
	...
	public Author getAuthor() {
		if (GET_AUTHOR__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ICOMMENT, DomainPackage.Literals.ICOMMENT.getEAllOperations().get(3));
			try {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.ICOMMENT__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
