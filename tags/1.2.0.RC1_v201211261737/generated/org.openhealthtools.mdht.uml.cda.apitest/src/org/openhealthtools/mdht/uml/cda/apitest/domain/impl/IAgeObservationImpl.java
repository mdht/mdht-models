...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IAge Observation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.IAgeObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IAgeObservationImpl extends EObjectImpl implements IAgeObservation {
	/**
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.IAGE_OBSERVATION;
	}
	...
	public ANY getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				DomainPackage.Literals.IAGE_OBSERVATION.getEAllOperations().get(0));
			try {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.IAGE_OBSERVATION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
