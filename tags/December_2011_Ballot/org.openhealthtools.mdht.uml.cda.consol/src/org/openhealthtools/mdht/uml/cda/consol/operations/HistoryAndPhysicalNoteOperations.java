...
public class HistoryAndPhysicalNoteOperations extends GeneralHeaderConstraintsOperations {
	...
	public static PhysicalExamSection getPhysicalExamSection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		if (GET_PHYSICAL_EXAM_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(217));
			try {
	...
	public static ReasonForVisitSection getReasonForVisitSection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		if (GET_REASON_FOR_VISIT_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(218));
			try {
	...
	public static ResultsSectionEntriesOptional getResultsSectionEntriesOptional(
		...
		if (GET_RESULTS_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(219));
			try {
	...
	public static ReviewOfSystemsSection getReviewOfSystemsSection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		if (GET_REVIEW_OF_SYSTEMS_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(220));
			try {
	...
	public static SocialHistorySection getSocialHistorySection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		if (GET_SOCIAL_HISTORY_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(221));
			try {
	...
	public static HistoryOfPresentIllnessSection getHistoryOfPresentIllnessSection(
		...
		if (GET_HISTORY_OF_PRESENT_ILLNESS_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(222));
			try {
	...
	public static ImmunizationsSectionEntriesOptional getImmunizationsSectionEntriesOptional(
		...
		if (GET_IMMUNIZATIONS_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(223));
			try {
	...
	public static ProblemSectionEntriesOptional getProblemSectionEntriesOptional(
		...
		if (GET_PROBLEM_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(224));
			try {
	...
	public static ProceduresSectionEntriesOptional getProceduresSectionEntriesOptional(
		...
		if (GET_PROCEDURES_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(225));
			try {
	...
	public static VitalSignsSectionEntriesOptional getVitalSignsSectionEntriesOptional(
		...
		if (GET_VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(226));
			try {
