...
public class MedicationImpl extends SubstanceAdministrationImpl implements Medication {
	 ...
	 * @generated
	 */
	public boolean validateMedicationReactionObservation(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return MedicationOperations.validateMedicationReactionObservation(this, diagnostics, context);
	}
	...
	public EList<ReactionObservation> getReactionObservations() {
		return MedicationOperations.getReactionObservations(this);
	}
