...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.IAdvanceDirectiveStatusObservation;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.AdvanceDirectiveStatusObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdvanceDirectiveStatusObservationImpl extends StatusObservationImpl implements
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getAdvanceDirectiveStatusObservation();
	}
	 ...
	 */
	@Override
	public IAdvanceDirectiveStatusObservation setValue(CE value) {
	...
	public CE getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAdvanceDirectiveStatusObservation(),
				IDomainPackage.eINSTANCE.getAdvanceDirectiveStatusObservation().getEAllOperations().get(0));
			try {
