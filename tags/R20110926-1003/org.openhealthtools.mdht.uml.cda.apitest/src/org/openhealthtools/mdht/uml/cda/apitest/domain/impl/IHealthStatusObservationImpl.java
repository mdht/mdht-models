...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IHealth Status Observation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.IHealthStatusObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IHealthStatusObservationImpl extends IStatusObservationImpl implements IHealthStatusObservation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected IHealthStatusObservationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.IHEALTH_STATUS_OBSERVATION;
	}
	 ...
	 */
	@Override
	public IHealthStatusObservation withValue(CE value) {
	...
	public CE getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				DomainPackage.Literals.IHEALTH_STATUS_OBSERVATION.getEAllOperations().get(6));
			try {
