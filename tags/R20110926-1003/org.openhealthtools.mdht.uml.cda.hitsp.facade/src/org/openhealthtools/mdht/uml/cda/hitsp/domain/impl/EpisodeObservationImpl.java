 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.EpisodeObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EpisodeObservationImpl extends EObjectImpl implements IEpisodeObservation {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getEpisodeObservation(),
				IDomainPackage.eINSTANCE.getEpisodeObservation().getEAllOperations().get(0));
			try {
	...
	public CD getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getEpisodeObservation(),
				IDomainPackage.eINSTANCE.getEpisodeObservation().getEAllOperations().get(3));
			try {
