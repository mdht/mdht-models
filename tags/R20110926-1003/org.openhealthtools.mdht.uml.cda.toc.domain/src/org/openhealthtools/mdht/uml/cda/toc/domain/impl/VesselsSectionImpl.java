 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.VesselsSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VesselsSectionImpl extends EObjectImpl implements IVesselsSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getVesselsSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getVesselsSection(),
				IDomainPackage.eINSTANCE.getVesselsSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IVesselsSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.VESSELS_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
