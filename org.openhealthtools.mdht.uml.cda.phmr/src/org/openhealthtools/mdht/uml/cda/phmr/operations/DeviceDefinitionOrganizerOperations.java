...
public class DeviceDefinitionOrganizerOperations extends OrganizerOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_SAMPLING_FREQUENCY_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phmr::SamplingFrequencyObservation))->asSequence()->first().oclAsType(phmr::SamplingFrequencyObservation)";
	...
	public static  SamplingFrequencyObservation getSamplingFrequencyObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		if (GET_SAMPLING_FREQUENCY_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER, PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER.getEAllOperations().get(58));
			try {
	 ...
	 * @ordered
	 */
	protected static final String GET_DEVICE_MEASUREMENT_RANGE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phmr::DeviceMeasurementRangeObservation))->asSequence()->first().oclAsType(phmr::DeviceMeasurementRangeObservation)";
	...
	public static  DeviceMeasurementRangeObservation getDeviceMeasurementRangeObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		if (GET_DEVICE_MEASUREMENT_RANGE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER, PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER.getEAllOperations().get(59));
			try {
	 ...
	 * @ordered
	 */
	protected static final String GET_DEVICE_RESOLUTION_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phmr::DeviceResolutionObservation))->asSequence()->first().oclAsType(phmr::DeviceResolutionObservation)";
	...
	public static  DeviceResolutionObservation getDeviceResolutionObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		if (GET_DEVICE_RESOLUTION_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER, PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER.getEAllOperations().get(60));
			try {
	 ...
	 * @ordered
	 */
	protected static final String GET_DEVICE_ACCURACY_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(phmr::DeviceAccuracyObservation))->asSequence()->first().oclAsType(phmr::DeviceAccuracyObservation)";
