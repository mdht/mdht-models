 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.NeckSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NeckSectionImpl extends EObjectImpl implements INeckSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getNeckSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getNeckSection(),
				IDomainPackage.eINSTANCE.getNeckSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public INeckSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.NECK_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
