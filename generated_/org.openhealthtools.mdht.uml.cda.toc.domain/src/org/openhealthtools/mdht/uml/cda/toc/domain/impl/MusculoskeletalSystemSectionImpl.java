 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.MusculoskeletalSystemSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MusculoskeletalSystemSectionImpl extends EObjectImpl implements IMusculoskeletalSystemSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMusculoskeletalSystemSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getMusculoskeletalSystemSection(),
				IDomainPackage.eINSTANCE.getMusculoskeletalSystemSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IMusculoskeletalSystemSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MUSCULOSKELETAL_SYSTEM_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
