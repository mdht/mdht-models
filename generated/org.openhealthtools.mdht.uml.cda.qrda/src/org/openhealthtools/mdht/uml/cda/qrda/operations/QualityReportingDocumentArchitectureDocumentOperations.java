 ...
 * @generated
 */
public class QualityReportingDocumentArchitectureDocumentOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalDocumentOperations {
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentTemplateId(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentTemplateId"),
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentCodeP(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentCodeP"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
...
"value.code = '55182-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentCode(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentCode"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentTitle(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentTitle"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentCustodian(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_CUSTODIAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentCustodian"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentLegalAuthenticator(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentLegalAuthenticator"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentRecordTarget(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentRecordTarget"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_MEASURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateQualityReportingDocumentArchitectureDocumentMeasureSection(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_MEASURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(QRDAPackage.Literals.QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT);
			try {
				VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_MEASURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_MEASURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_QUALITY_REPORTING_DOCUMENT_ARCHITECTURE_DOCUMENT_MEASURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(qualityReportingDocumentArchitectureDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 QrdaPlugin.INSTANCE.getString("QualityReportingDocumentArchitectureDocumentQualityReportingDocumentArchitectureDocumentMeasureSection"),
						 new Object [] { qualityReportingDocumentArchitectureDocument }));
			}
	...
	public static  MeasureSection getMeasureSection(QualityReportingDocumentArchitectureDocument qualityReportingDocumentArchitectureDocument) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_MEASURE_SECTION__EOCL_QRY);
