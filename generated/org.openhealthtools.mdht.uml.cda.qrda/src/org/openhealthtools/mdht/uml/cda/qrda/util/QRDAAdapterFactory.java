...
public class QRDAAdapterFactory extends AdapterFactoryImpl {
	...
	protected QRDASwitch<Adapter> modelSwitch =
		new QRDASwitch<Adapter>() {
			@Override
			public Adapter caseQualityMeasureReport(QualityMeasureReport object) {
				return createQualityMeasureReportAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openhealthtools.mdht.uml.cda.qrda.QualityMeasureReport <em>Quality Measure Report</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.openhealthtools.mdht.uml.cda.qrda.QualityMeasureReport
	 * @generated
	 */
	public Adapter createQualityMeasureReportAdapter() {
		return null;
	}
