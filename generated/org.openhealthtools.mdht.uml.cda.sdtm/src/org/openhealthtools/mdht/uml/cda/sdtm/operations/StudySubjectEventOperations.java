 ...
 * @generated
 */
public class StudySubjectEventOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventTemplateId(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventMoodCode(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventId(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventCodeP(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
...
"value.codeSystem = '2.16.840.1.113883.3.26.1.1' and (value.code = 'C78802' or value.code = 'C78800' or value.code = '78801' or value.code = '78727' or value.code = 'CXXXXX' or value.code = 'CXXXXX' or value.code = 'CXXXXX'))";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventCode(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventEffectiveTime(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventEffectiveTime", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventStatusCode(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventStatusCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventValue(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventTargetSiteCodeP(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventTargetSiteCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
...
"value.codeSystem = '2.16.840.1.113883.3.26.1.1' and not value.code.oclIsUndefined()))";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventTargetSiteCode(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventTargetSiteCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_GROUP_IDENTIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventGroupIdentifier(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_GROUP_IDENTIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_GROUP_IDENTIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_GROUP_IDENTIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_GROUP_IDENTIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventGroupIdentifier", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_EVENT_SEVERITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventEventSeverity(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_EVENT_SEVERITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_EVENT_SEVERITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_SEVERITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_SEVERITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventEventSeverity", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_PRE_SPECIFIED_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventPreSpecifiedEvent(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_PRE_SPECIFIED_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_PRE_SPECIFIED_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_PRE_SPECIFIED_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_PRE_SPECIFIED_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventPreSpecifiedEvent", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_STUDY_DAY_PERIOD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventStudyDayPeriod(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_STUDY_DAY_PERIOD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_STUDY_DAY_PERIOD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_STUDY_DAY_PERIOD__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_STUDY_DAY_PERIOD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventStudyDayPeriod", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_BODY_SYSTEMOR_ORGAN_CLASS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventBodySystemorOrganClass(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_BODY_SYSTEMOR_ORGAN_CLASS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_BODY_SYSTEMOR_ORGAN_CLASS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_BODY_SYSTEMOR_ORGAN_CLASS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_BODY_SYSTEMOR_ORGAN_CLASS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventBodySystemorOrganClass", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_COMMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventComment(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_COMMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_COMMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_COMMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_COMMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventComment", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_DOMAIN_ASSIGNMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventDomainAssignment(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_DOMAIN_ASSIGNMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_DOMAIN_ASSIGNMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_DOMAIN_ASSIGNMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_DOMAIN_ASSIGNMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventDomainAssignment", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_RELATED_RECORD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventRelatedRecord(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_RELATED_RECORD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_RELATED_RECORD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_RELATED_RECORD__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_RELATED_RECORD__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventRelatedRecord", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_SUPPLEMENTAL_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventSupplementalValue(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_SUPPLEMENTAL_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_SUPPLEMENTAL_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_SUPPLEMENTAL_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_SUPPLEMENTAL_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventSupplementalValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_DATA_COLLECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventDataCollection(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_DATA_COLLECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_DATA_COLLECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_DATA_COLLECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_DATA_COLLECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventDataCollection", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_NON_PERFORMANCE_REASON__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventNonPerformanceReason(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_NON_PERFORMANCE_REASON__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_NON_PERFORMANCE_REASON__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_NON_PERFORMANCE_REASON__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_NON_PERFORMANCE_REASON__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventNonPerformanceReason", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_SERIOUS_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventSeriousEvent(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_SERIOUS_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_SERIOUS_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_SERIOUS_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_SERIOUS_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventSeriousEvent", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventStudyTreatmentActionTaken(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventStudyTreatmentActionTaken", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_OTHER_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventOtherTreatmentActionTaken(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_OTHER_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_OTHER_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_OTHER_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_OTHER_TREATMENT_ACTION_TAKEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventOtherTreatmentActionTaken", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_CAUSALITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventStudyTreatmentCausality(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_CAUSALITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_CAUSALITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_CAUSALITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_STUDY_TREATMENT_CAUSALITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventStudyTreatmentCausality", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_NON_STUDY_TREATMENT_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventNonStudyTreatmentRelationship(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_NON_STUDY_TREATMENT_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_NON_STUDY_TREATMENT_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_NON_STUDY_TREATMENT_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_NON_STUDY_TREATMENT_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventNonStudyTreatmentRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_EVENT_PATTERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventEventPattern(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_EVENT_PATTERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_EVENT_PATTERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_PATTERN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_PATTERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventEventPattern", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_EVENT_OUTCOME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventEventOutcome(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_EVENT_OUTCOME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_EVENT_OUTCOME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_OUTCOME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_OUTCOME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventEventOutcome", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_CONCOMITANT_TREATMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventConcomitantTreatment(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_CONCOMITANT_TREATMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_CONCOMITANT_TREATMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_CONCOMITANT_TREATMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_CONCOMITANT_TREATMENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventConcomitantTreatment", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_TOXICITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventToxicity(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_TOXICITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_TOXICITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_TOXICITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_TOXICITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventToxicity", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventCategory(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventCategory", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_SUB_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventSubCategory(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_SUB_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_SUB_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_SUB_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_SUB_CATEGORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventSubCategory", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_FINDING_ABOUT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventFindingAbout(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_FINDING_ABOUT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_FINDING_ABOUT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_FINDING_ABOUT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_FINDING_ABOUT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventFindingAbout", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_STUDY_SUBJECT_EVENT_EVENT_DURATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateStudySubjectEventEventDuration(StudySubjectEvent studySubjectEvent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_STUDY_SUBJECT_EVENT_EVENT_DURATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(SdtmPackage.Literals.STUDY_SUBJECT_EVENT);
			try {
				VALIDATE_STUDY_SUBJECT_EVENT_EVENT_DURATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_DURATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_STUDY_SUBJECT_EVENT_EVENT_DURATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(studySubjectEvent)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "StudySubjectEventStudySubjectEventEventDuration", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(studySubjectEvent, context) }),
						 new Object [] { studySubjectEvent }));
			}
