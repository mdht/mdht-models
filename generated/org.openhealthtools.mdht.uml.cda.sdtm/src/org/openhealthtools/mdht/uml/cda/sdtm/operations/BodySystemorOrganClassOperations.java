 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.sdtm.BodySystemorOrganClass#validateBodySystemorOrganClassValueP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Body Systemor Organ Class Value P</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BodySystemorOrganClassOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BODY_SYSTEMOR_ORGAN_CLASS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.23.17')";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BODY_SYSTEMOR_ORGAN_CLASS_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.classCode=vocab::ActClassObservation::OBS";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BODY_SYSTEMOR_ORGAN_CLASS_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.moodCode=vocab::x_ActMoodDocumentObservation::EVN";
...
"value.code = 'C88026' and value.codeSystem = '2.16.840.1.113883.3.26.1.1')";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BODY_SYSTEMOR_ORGAN_CLASS_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | not element.oclIsUndefined() and element.oclIsKindOf(datatypes::CD) and "+
...
"value.codeSystem = '2.16.840.1.113883.3.26.1.1' and not value.code.oclIsUndefined()))";
	...
	/**
	 * The cached OCL expression body for the '{@link #validateBodySystemorOrganClassValueP(BodySystemorOrganClass, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Body Systemor Organ Class Value P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateBodySystemorOrganClassValueP(BodySystemorOrganClass, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_BODY_SYSTEMOR_ORGAN_CLASS_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";

	/**
	 * The cached OCL invariant for the '{@link #validateBodySystemorOrganClassValueP(BodySystemorOrganClass, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Body Systemor Organ Class Value P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateBodySystemorOrganClassValueP(BodySystemorOrganClass, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
