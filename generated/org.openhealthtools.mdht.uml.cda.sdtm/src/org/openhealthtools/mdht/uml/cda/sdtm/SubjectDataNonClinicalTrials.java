...
public interface SubjectDataNonClinicalTrials extends ClinicalDocument {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getAllSections()->exists(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(sdtm::NonhumanSubjectDataDocumentSection))'"
	 * @generated
	 */
