 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Organ MeasurementTemplateId Organ MeasurementClassCode Organ MeasurementMoodCode Organ MeasurementId Organ MeasurementCode Organ MeasurementCodeP Organ MeasurementInterpretationCode Organ MeasurementSpecimen Information' templateId.root='2.16.840.1.113883.10.20.23.62' classCode='OBS' moodCode='EVN' code.codeSystem='unknonw' code.codeSystemName='Organ Measurement Examination Type'"
 * @generated
 */
public interface OrganMeasurement extends Observation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
