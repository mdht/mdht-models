			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("AssessmentAndPlanSectionAssessmentAndPlanSectionTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("AssessmentAndPlanSectionAssessmentAndPlanSectionCode"),
						new Object[] { assessmentAndPlanSection }));
			}
