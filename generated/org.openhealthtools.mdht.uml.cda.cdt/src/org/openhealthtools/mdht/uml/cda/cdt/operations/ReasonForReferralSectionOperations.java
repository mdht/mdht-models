			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("ReasonForReferralSectionReasonForReferralSectionTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("ReasonForReferralSectionReasonForReferralSectionCode"),
						new Object[] { reasonForReferralSection }));
			}
