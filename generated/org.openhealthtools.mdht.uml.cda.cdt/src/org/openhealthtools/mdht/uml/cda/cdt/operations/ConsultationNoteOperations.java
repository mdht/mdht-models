...
"value.codeSystem = '2.16.840.1.113883.6.1' and not value.code.oclIsUndefined())";
  ...
  public static  boolean validateConsultationNoteCode(ConsultationNote consultationNote, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             CDTPlugin.INSTANCE.getString("ConsultationNoteCode"),
             new Object [] { consultationNote }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CDTPackage.Literals.CONSULTATION_NOTE, CDTPackage.Literals.CONSULTATION_NOTE.getEAllOperations().get(97));
      try
      {
