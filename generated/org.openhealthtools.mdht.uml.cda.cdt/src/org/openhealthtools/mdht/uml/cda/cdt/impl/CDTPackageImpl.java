		...
		addAnnotation
		  (consultationNoteEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "ConsultationNoteTemplateId ConsultationNoteReferralOrVisit GeneralHeaderConstraintsCode ConsultationNoteHistoryOfPresentIllness ConsultationNotePhysicalExamination",
			 "code.codeSystemName", "LOINC",
