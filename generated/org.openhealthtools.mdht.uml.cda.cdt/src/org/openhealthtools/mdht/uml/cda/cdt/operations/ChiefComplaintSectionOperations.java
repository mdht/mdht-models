			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("ChiefComplaintSectionChiefComplaintSectionTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("ChiefComplaintSectionChiefComplaintSectionCode"),
						new Object[] { chiefComplaintSection }));
			}
