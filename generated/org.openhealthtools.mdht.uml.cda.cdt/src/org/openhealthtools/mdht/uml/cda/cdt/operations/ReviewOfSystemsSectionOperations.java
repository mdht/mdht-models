			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("ReviewOfSystemsSectionReviewOfSystemsSectionTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CDTPlugin.INSTANCE.getString("ReviewOfSystemsSectionReviewOfSystemsSectionCode"),
						new Object[] { reviewOfSystemsSection }));
			}
