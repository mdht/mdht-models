 ...
 * @generated
 */
public class InfectionPresentFetalDeathOperations
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathTemplateId(
		...
		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				...
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							...
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathTemplateId",
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathClassCode(
		...
		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathClassCode",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathMoodCode(
		...
		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathMoodCode",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathCodeP(InfectionPresentFetalDeath infectionPresentFetalDeath,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathCodeP",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathCode(InfectionPresentFetalDeath infectionPresentFetalDeath,
		...
		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathCode",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathCodeVS(
		...
		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathCodeVS",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathValue(InfectionPresentFetalDeath infectionPresentFetalDeath,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathValue",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentFetalDeathValueP(
		...
		if (VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_FETAL_DEATH);
			try {
				VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_FETAL_DEATH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentFetalDeath)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentFetalDeathInfectionPresentFetalDeathValueP",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentFetalDeath, context) }),
						new Object[] { infectionPresentFetalDeath }));
			}
