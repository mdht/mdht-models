...
public class VitalSignsObservationOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateVitalSignsObservationTemplateId(VitalSignsObservation vitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VITAL_SIGNS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignsObservationTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(vitalSignsObservation, context) }),
             new Object [] { vitalSignsObservation }));
      }
  ...
  public static  boolean validateVitalSignsObservationClassCode(VitalSignsObservation vitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VITAL_SIGNS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignsObservationClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(vitalSignsObservation, context) }),
             new Object [] { vitalSignsObservation }));
      }
  ...
  public static  boolean validateVitalSignsObservationMoodCode(VitalSignsObservation vitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VITAL_SIGNS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignsObservationMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(vitalSignsObservation, context) }),
             new Object [] { vitalSignsObservation }));
      }
  ...
  public static  boolean validateVitalSignsObservationCodeP(VitalSignsObservation vitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VITAL_SIGNS_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignsObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(vitalSignsObservation, context) }),
             new Object [] { vitalSignsObservation }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateVitalSignsObservationCode(VitalSignsObservation vitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VITAL_SIGNS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignsObservationCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(vitalSignsObservation, context) }),
             new Object [] { vitalSignsObservation }));
      }
  ...
  public static  boolean validateVitalSignsObservationValue(VitalSignsObservation vitalSignsObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VITAL_SIGNS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vitalSignsObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "VitalSignsObservationValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(vitalSignsObservation, context) }),
             new Object [] { vitalSignsObservation }));
      }
