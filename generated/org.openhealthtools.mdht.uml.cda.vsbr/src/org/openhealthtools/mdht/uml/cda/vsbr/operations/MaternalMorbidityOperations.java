...
public class MaternalMorbidityOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateMaternalMorbidityTemplateId(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
  ...
  public static  boolean validateMaternalMorbidityClassCode(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
  ...
  public static  boolean validateMaternalMorbidityMoodCode(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
  ...
  public static  boolean validateMaternalMorbidityCodeP(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
...
"value.code = '73781-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateMaternalMorbidityCode(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '116859006' or value.code = '398019008' or value.code = '34430009' or value.code = '625654015' or value.code = '309904001' or value.code = '177217006' or value.code = '260413007'))";
  ...
  public static  boolean validateMaternalMorbidityCodeVS(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityCodeVS", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '116859006' or value.code = '398019008' or value.code = '34430009' or value.code = '625654015' or value.code = '309904001' or value.code = '177217006' or value.code = '260413007')))";
  ...
  public static  boolean validateMaternalMorbidityValue(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
  ...
  public static  boolean validateMaternalMorbidityValueP(MaternalMorbidity maternalMorbidity, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_MATERNAL_MORBIDITY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(maternalMorbidity))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MaternalMorbidityValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(maternalMorbidity, context) }),
             new Object [] { maternalMorbidity }));
      }
