...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '29240004' or value.code = '44551000009109' or value.code = '634711000124117')))";
  ...
  public static  boolean validateAutopsyPerformanceValueP(AutopsyPerformance autopsyPerformance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_AUTOPSY_PERFORMANCE_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(autopsyPerformance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "AutopsyPerformanceValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(autopsyPerformance, context) }),
             new Object [] { autopsyPerformance }));
      }
  ...
  public static  boolean validateAutopsyPerformanceHistologicalExamAssociation(AutopsyPerformance autopsyPerformance, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_AUTOPSY_PERFORMANCE_HISTOLOGICAL_EXAM_ASSOCIATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(autopsyPerformance))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "AutopsyPerformanceHistologicalExamAssociation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(autopsyPerformance, context) }),
             new Object [] { autopsyPerformance }));
      }
