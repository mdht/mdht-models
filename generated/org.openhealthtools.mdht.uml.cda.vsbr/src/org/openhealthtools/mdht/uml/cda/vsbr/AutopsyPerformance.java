 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Autopsy PerformanceTemplateId Autopsy PerformanceClassCode Autopsy PerformanceCode Autopsy PerformanceMoodCode Autopsy PerformanceValue' templateId.root='2.16.840.1.113883.10.20.26.15' classCode='OBS' moodCode='EVN' constraints.validation.warning='Autopsy PerformancePlanningAssociation' constraints.validation.info='Autopsy PerformanceUseAssociation'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/vsbrAutopsyPerformancePlanningAssociation constraints.validation.error='PlanningAssociationTypeCode PlanningAssociationObservation'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/vsbrAutopsyPerformancePlanningAssociationAutopsyPlan constraints.validation.error='AutopsyPlanCode AutopsyPlanValue'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/vsbrAutopsyPerformanceUseAssociationAutopsyUse constraints.validation.error='AutopsyUseCode AutopsyUseValue'"
 * @generated
 */
public interface AutopsyPerformance extends Observation
{
   ...
   * @generated
   */
  boolean validateAutopsyPerformancePlanningAssociation(DiagnosticChain diagnostics, Map<Object, Object> context);
