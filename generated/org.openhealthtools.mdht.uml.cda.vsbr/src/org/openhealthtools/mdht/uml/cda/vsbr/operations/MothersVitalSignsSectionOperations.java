...
public class MothersVitalSignsSectionOperations extends SectionOperations {
	...
	public static boolean validateMothersVitalSignsSectionVitalSignsObservation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_MOTHERS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			mothersVitalSignsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"MothersVitalSignsSectionVitalSignsObservation",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									mothersVitalSignsSection, context) }), new Object[] { mothersVitalSignsSection }));
			}
