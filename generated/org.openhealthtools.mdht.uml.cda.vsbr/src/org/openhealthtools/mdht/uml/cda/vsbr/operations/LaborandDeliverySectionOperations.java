...
"value.code = '34079-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateLaborandDeliverySectionMothersVitalSignsSection(LaborandDeliverySection laborandDeliverySection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_SECTION_MOTHERS_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(laborandDeliverySection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "LaborandDeliverySectionMothersVitalSignsSection", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(laborandDeliverySection, context) }),
             new Object [] { laborandDeliverySection }));
      }
  ...
  public static  boolean validateLaborandDeliverySectionLaborOnsets(LaborandDeliverySection laborandDeliverySection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_SECTION_LABOR_ONSETS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(laborandDeliverySection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "LaborandDeliverySectionLaborOnsets", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(laborandDeliverySection, context) }),
             new Object [] { laborandDeliverySection }));
      }
  ...
  public static  LaborandDeliveryProcedureSection getLaborandDeliveryProceduresSection(LaborandDeliverySection laborandDeliverySection)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(VsbrPackage.Literals.LABORAND_DELIVERY_SECTION, VsbrPackage.Literals.LABORAND_DELIVERY_SECTION.getEAllOperations().get(66));
      try
      {
  ...
  public static  EList<OnsetofLabor> getLaborOnsetss(LaborandDeliverySection laborandDeliverySection)
  {
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(VsbrPackage.Literals.LABORAND_DELIVERY_SECTION, VsbrPackage.Literals.LABORAND_DELIVERY_SECTION.getEAllOperations().get(67));
      try
      {
