...
public class LastMenstrualPeriodDateOperations extends ClinicalStatementOperations
{
   ...
   * @ordered
   */
  protected static final String VALIDATE_LAST_MENSTRUAL_PERIOD_DATE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.26.24')";
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.26.24')
  ...
  public static  boolean validateLastMenstrualPeriodDateTemplateId(LastMenstrualPeriodDate lastMenstrualPeriodDate, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLastMenstrualPeriodDateClassCode(LastMenstrualPeriodDate lastMenstrualPeriodDate, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @ordered
   */
  protected static final String VALIDATE_LAST_MENSTRUAL_PERIOD_DATE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";
  ...
  public static  boolean validateLastMenstrualPeriodDateCode(LastMenstrualPeriodDate lastMenstrualPeriodDate, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLastMenstrualPeriodDateMoodCode(LastMenstrualPeriodDate lastMenstrualPeriodDate, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateLastMenstrualPeriodDateValue(LastMenstrualPeriodDate lastMenstrualPeriodDate, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
