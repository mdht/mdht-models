...
public class NewbornsVitalSignsSectionOperations extends SectionOperations
{
  ...
  public static  boolean validateNewbornsVitalSignsSectionTemplateId(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateNewbornsVitalSignsSectionClassCode(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateNewbornsVitalSignsSectionMoodCode(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
...
"value.code = '8716-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateNewbornsVitalSignsSectionCode(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateNewbornsVitalSignsSectionCodeP(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateNewbornsVitalSignsSectionText(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  /**
   * The cached OCL expression body for the '{@link #validateNewbornsVitalSignsSectionVitalSignsObservation(NewbornsVitalSignsSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Newborns Vital Signs Section Vital Signs Observation</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateNewbornsVitalSignsSectionVitalSignsObservation(NewbornsVitalSignsSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "2..3->includes(self.entry->select(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(vsbr::VitalSignsObservation) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)->size())";

  /**
   * The cached OCL invariant for the '{@link #validateNewbornsVitalSignsSectionVitalSignsObservation(NewbornsVitalSignsSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Newborns Vital Signs Section Vital Signs Observation</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateNewbornsVitalSignsSectionVitalSignsObservation(NewbornsVitalSignsSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateNewbornsVitalSignsSectionVitalSignsObservation(NewbornsVitalSignsSection newbornsVitalSignsSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(VsbrPackage.Literals.NEWBORNS_VITAL_SIGNS_SECTION);
      try
      {
        VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(newbornsVitalSignsSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             VsbrValidator.DIAGNOSTIC_SOURCE,
             VsbrValidator.NEWBORNS_VITAL_SIGNS_SECTION__NEWBORNS_VITAL_SIGNS_SECTION_VITAL_SIGNS_OBSERVATION,
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NewbornsVitalSignsSectionVitalSignsObservation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(newbornsVitalSignsSection, context) }),
             new Object [] { newbornsVitalSignsSection }));
      }
  ...
  /**
   * The cached OCL expression body for the '{@link #getVitalSignsObservations(NewbornsVitalSignsSection) <em>Get Vital Signs Observations</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getVitalSignsObservations(NewbornsVitalSignsSection)
   * @generated
   * @ordered
   */
  ...
  /**
   * The cached OCL query for the '{@link #getVitalSignsObservations(NewbornsVitalSignsSection) <em>Get Vital Signs Observations</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getVitalSignsObservations(NewbornsVitalSignsSection)
   * @generated
  ...
  public static  EList<VitalSignsObservation> getVitalSignsObservations(NewbornsVitalSignsSection newbornsVitalSignsSection)
  {
    ...
    Collection<VitalSignsObservation> result = (Collection<VitalSignsObservation>) query.evaluate(newbornsVitalSignsSection);
