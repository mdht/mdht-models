...
public class NumberofLiveBirthsnowDeadOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateNumberofLiveBirthsnowDeadCodeP(NumberofLiveBirthsnowDead numberofLiveBirthsnowDead, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofLiveBirthsnowDead))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofLiveBirthsnowDeadCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofLiveBirthsnowDead, context) }),
             new Object [] { numberofLiveBirthsnowDead }));
      }
