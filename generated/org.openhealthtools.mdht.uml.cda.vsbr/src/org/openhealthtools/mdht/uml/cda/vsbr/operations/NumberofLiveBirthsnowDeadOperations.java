...
public class NumberofLiveBirthsnowDeadOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.26.38')";
	...
	public static boolean validateNumberofLiveBirthsnowDeadTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateNumberofLiveBirthsnowDeadClassCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			numberofLiveBirthsnowDead)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateNumberofLiveBirthsnowDeadMoodCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			numberofLiveBirthsnowDead)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
	...
	/**
	 * The cached OCL expression body for the '{@link #validateNumberofLiveBirthsnowDeadCodeP(NumberofLiveBirthsnowDead, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Numberof Live Birthsnow Dead Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateNumberofLiveBirthsnowDeadCodeP(NumberofLiveBirthsnowDead, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Numberof Live Birthsnow Dead Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateNumberofLiveBirthsnowDeadCodeP(NumberofLiveBirthsnowDead, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static boolean validateNumberofLiveBirthsnowDeadCodeP(NumberofLiveBirthsnowDead numberofLiveBirthsnowDead,
		...
		if (VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(VsbrPackage.Literals.NUMBEROF_LIVE_BIRTHSNOW_DEAD);
			try {
				VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			numberofLiveBirthsnowDead)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					VsbrValidator.NUMBEROF_LIVE_BIRTHSNOW_DEAD__NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE_P,
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined() and self.code.oclIsKindOf(datatypes::CD) and "
	...
	public static boolean validateNumberofLiveBirthsnowDeadCode(NumberofLiveBirthsnowDead numberofLiveBirthsnowDead,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			numberofLiveBirthsnowDead)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | element.oclIsTypeOf(datatypes::INT)))";
	...
	public static boolean validateNumberofLiveBirthsnowDeadValue(NumberofLiveBirthsnowDead numberofLiveBirthsnowDead,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_LIVE_BIRTHSNOW_DEAD_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			numberofLiveBirthsnowDead)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
