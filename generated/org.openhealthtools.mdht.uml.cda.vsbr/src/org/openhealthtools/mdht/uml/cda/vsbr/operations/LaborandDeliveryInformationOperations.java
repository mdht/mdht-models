...
public class LaborandDeliveryInformationOperations extends ClinicalStatementOperations {
	...
	public static boolean validateLaborandDeliveryInformationTemplateId(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						...
						new Object[] {
								"LaborandDeliveryInformationTemplateId",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
	...
	public static boolean validateLaborandDeliveryInformationClassCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationClassCode",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationMoodCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationMoodCode",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationCodeP",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationCode",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationAttendantParticipation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_ATTENDANT_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationAttendantParticipation",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationEntryRelationship(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationEntryRelationship",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationCharacteristicsofLaborandDelivery(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_CHARACTERISTICSOF_LABORAND_DELIVERY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationCharacteristicsofLaborandDelivery",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationHomeBirthPlan(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_HOME_BIRTH_PLAN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationHomeBirthPlan",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationMaternalTransfer(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_MATERNAL_TRANSFER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationMaternalTransfer",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationParticipatingLocation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_PARTICIPATING_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationParticipatingLocation",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationMaternalMorbidities(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_MATERNAL_MORBIDITIES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationMaternalMorbidities",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	public static boolean validateLaborandDeliveryInformationRiskFactors(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_LABORAND_DELIVERY_INFORMATION_RISK_FACTORS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationRiskFactors",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateLaborandDeliveryInformationCertifierParticipation(LaborandDeliveryInformation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Laborand Delivery Information Certifier Participation</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLaborandDeliveryInformationCertifierParticipation(LaborandDeliveryInformation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.participant->one(participant : cda::Participant2 | not participant.oclIsUndefined() and participant.oclIsKindOf(cda::Participant2))";

	/**
	 * The cached OCL invariant for the '{@link #validateLaborandDeliveryInformationCertifierParticipation(LaborandDeliveryInformation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Laborand Delivery Information Certifier Participation</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateLaborandDeliveryInformationCertifierParticipation(LaborandDeliveryInformation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static boolean validateLaborandDeliveryInformationCertifierParticipation(
			LaborandDeliveryInformation laborandDeliveryInformation, DiagnosticChain diagnostics,
			Map<Object, Object> context) {

		if (VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION);
			try {
				VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(
			VALIDATE_LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			laborandDeliveryInformation)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, VsbrValidator.DIAGNOSTIC_SOURCE,
					VsbrValidator.LABORAND_DELIVERY_INFORMATION__LABORAND_DELIVERY_INFORMATION_CERTIFIER_PARTICIPATION,
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						"_UI_GenericInvariant_diagnostic",
						new Object[] {
								"LaborandDeliveryInformationCertifierParticipation",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									laborandDeliveryInformation, context) }),
					new Object[] { laborandDeliveryInformation }));
			}
	 ...
	 * @ordered
	 */
	protected static final String GET_CHARACTERISTICSOF_LABORAND_DELIVERIES__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(vsbr::CharacteristicofLaborandDelivery)).oclAsType(vsbr::CharacteristicofLaborandDelivery)";
	...
	public static EList<CharacteristicofLaborandDelivery> getCharacteristicsofLaborandDeliveries(
		...
		if (GET_CHARACTERISTICSOF_LABORAND_DELIVERIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION,
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION.getEAllOperations().get(65));
			try {
	...
	public static PlannedHomeBirth getHomeBirthPlan(LaborandDeliveryInformation laborandDeliveryInformation) {
		if (GET_HOME_BIRTH_PLAN__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION,
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION.getEAllOperations().get(66));
			try {
	...
	public static MaternalTransfer getMaternalTransfer(LaborandDeliveryInformation laborandDeliveryInformation) {
		if (GET_MATERNAL_TRANSFER__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION,
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION.getEAllOperations().get(67));
			try {
	...
	public static EList<MaternalMorbidity> getMaternalMorbiditiess(
		...
		if (GET_MATERNAL_MORBIDITIESS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION,
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION.getEAllOperations().get(68));
			try {
	...
	public static EList<PregnancyRiskFactor> getRiskFactorss(LaborandDeliveryInformation laborandDeliveryInformation) {
		if (GET_RISK_FACTORSS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION,
				VsbrPackage.Literals.LABORAND_DELIVERY_INFORMATION.getEAllOperations().get(69));
			try {
