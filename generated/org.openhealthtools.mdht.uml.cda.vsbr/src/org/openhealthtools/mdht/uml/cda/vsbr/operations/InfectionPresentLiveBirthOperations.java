 ...
 * @generated
 */
public class InfectionPresentLiveBirthOperations
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthTemplateId(
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				...
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							...
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthTemplateId",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthClassCode(
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthClassCode",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthMoodCode(InfectionPresentLiveBirth infectionPresentLiveBirth,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthMoodCode",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthCodeP(InfectionPresentLiveBirth infectionPresentLiveBirth,
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthCodeP",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthCode(InfectionPresentLiveBirth infectionPresentLiveBirth,
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthCode",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthCodeVS(InfectionPresentLiveBirth infectionPresentLiveBirth,
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthCodeVS",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthValue(InfectionPresentLiveBirth infectionPresentLiveBirth,
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthValue",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateInfectionPresentLiveBirthValueP(InfectionPresentLiveBirth infectionPresentLiveBirth,
		...
		if (VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(VsbrPackage.Literals.INFECTION_PRESENT_LIVE_BIRTH);
			try {
				VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				infectionPresentLiveBirth)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
							"_UI_GenericInvariant_diagnostic",
							new Object[] {
									"InfectionPresentLiveBirthInfectionPresentLiveBirthValueP",
									org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
										infectionPresentLiveBirth, context) }),
						new Object[] { infectionPresentLiveBirth }));
			}
