...
public class InfectionPresentLiveBirthOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateInfectionPresentLiveBirthTemplateId(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
  ...
  public static  boolean validateInfectionPresentLiveBirthClassCode(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
  ...
  public static  boolean validateInfectionPresentLiveBirthMoodCode(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
  ...
  public static  boolean validateInfectionPresentLiveBirthCodeP(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
...
"value.code = '72519-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateInfectionPresentLiveBirthCode(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '1562800' or value.code = '76272004' or value.code = '105629000' or value.code = '66071002' or value.code = '50711007' or value.code = '260413007'))";
  ...
  public static  boolean validateInfectionPresentLiveBirthCodeVS(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_CODE_VS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthCodeVS", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '1562800' or value.code = '76272004' or value.code = '105629000' or value.code = '66071002' or value.code = '50711007' or value.code = '260413007')))";
  ...
  public static  boolean validateInfectionPresentLiveBirthValue(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
  ...
  public static  boolean validateInfectionPresentLiveBirthValueP(InfectionPresentLiveBirth infectionPresentLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_LIVE_BIRTH_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infectionPresentLiveBirth))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfectionPresentLiveBirthValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresentLiveBirth, context) }),
             new Object [] { infectionPresentLiveBirth }));
      }
