...
public class NumberofInfantsBornAliveOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateNumberofInfantsBornAliveTemplateId(NumberofInfantsBornAlive numberofInfantsBornAlive, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_INFANTS_BORN_ALIVE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofInfantsBornAlive))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofInfantsBornAliveTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofInfantsBornAlive, context) }),
             new Object [] { numberofInfantsBornAlive }));
      }
  ...
  public static  boolean validateNumberofInfantsBornAliveClassCode(NumberofInfantsBornAlive numberofInfantsBornAlive, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_INFANTS_BORN_ALIVE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofInfantsBornAlive))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofInfantsBornAliveClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofInfantsBornAlive, context) }),
             new Object [] { numberofInfantsBornAlive }));
      }
  ...
  public static  boolean validateNumberofInfantsBornAliveMoodCode(NumberofInfantsBornAlive numberofInfantsBornAlive, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_INFANTS_BORN_ALIVE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofInfantsBornAlive))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofInfantsBornAliveMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofInfantsBornAlive, context) }),
             new Object [] { numberofInfantsBornAlive }));
      }
  ...
  public static  boolean validateNumberofInfantsBornAliveCodeP(NumberofInfantsBornAlive numberofInfantsBornAlive, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_INFANTS_BORN_ALIVE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofInfantsBornAlive))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofInfantsBornAliveCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofInfantsBornAlive, context) }),
             new Object [] { numberofInfantsBornAlive }));
      }
...
"value.code = '73773-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateNumberofInfantsBornAliveCode(NumberofInfantsBornAlive numberofInfantsBornAlive, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_INFANTS_BORN_ALIVE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofInfantsBornAlive))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofInfantsBornAliveCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofInfantsBornAlive, context) }),
             new Object [] { numberofInfantsBornAlive }));
      }
  ...
  public static  boolean validateNumberofInfantsBornAliveValue(NumberofInfantsBornAlive numberofInfantsBornAlive, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_NUMBEROF_INFANTS_BORN_ALIVE_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(numberofInfantsBornAlive))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "NumberofInfantsBornAliveValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(numberofInfantsBornAlive, context) }),
             new Object [] { numberofInfantsBornAlive }));
      }
