...
public class VsbrPackageImpl extends EPackageImpl implements VsbrPackage
{
    ...
    public void initializePackageContents()
    {
        ...
        op = addEOperation(reportingBirthInformationfromaclinicalsettingtovitalrecordsEClass, ecorePackage.getEBoolean(), "validateReportingBirthInformationfromaclinicalsettingtovitalrecordsHistoryofInfection", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        addEOperation(reportingBirthInformationfromaclinicalsettingtovitalrecordsEClass, this.getAntenatalTestingandSurveillanceSection(), "getAntenatalTestingandSurveillance", 1, 1, IS_UNIQUE, !IS_ORDERED);
        ...
        addEOperation(reportingBirthInformationfromaclinicalsettingtovitalrecordsEClass, this.getHistoryofInfectionSection(), "getHistoryofInfection", 1, 1, IS_UNIQUE, !IS_ORDERED);
        ...
        initEClass(antenatalTestingandSurveillanceSectionEClass, AntenatalTestingandSurveillanceSection.class, "AntenatalTestingandSurveillanceSection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(antenatalTestingandSurveillanceSectionEClass, ecorePackage.getEBoolean(), "validateAntenatalTestingandSurveillanceSectionTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(antenatalTestingandSurveillanceSectionEClass, ecorePackage.getEBoolean(), "validateAntenatalTestingandSurveillanceSectionClassCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(antenatalTestingandSurveillanceSectionEClass, ecorePackage.getEBoolean(), "validateAntenatalTestingandSurveillanceSectionMoodCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(antenatalTestingandSurveillanceSectionEClass, ecorePackage.getEBoolean(), "validateAntenatalTestingandSurveillanceSectionCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(antenatalTestingandSurveillanceSectionEClass, ecorePackage.getEBoolean(), "validateAntenatalTestingandSurveillanceSectionText", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(antenatalTestingandSurveillanceSectionEClass, ecorePackage.getEBoolean(), "validateAntenatalTestingandSurveillanceSectionPreNatalCare", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        addEOperation(antenatalTestingandSurveillanceSectionEClass, this.getPrenatalCare(), "getPreNatalCare", 1, 1, IS_UNIQUE, !IS_ORDERED);
        ...
        initEClass(historyofInfectionSectionEClass, HistoryofInfectionSection.class, "HistoryofInfectionSection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(historyofInfectionSectionEClass, ecorePackage.getEBoolean(), "validateHistoryofInfectionSectionTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(historyofInfectionSectionEClass, ecorePackage.getEBoolean(), "validateHistoryofInfectionSectionText", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(historyofInfectionSectionEClass, ecorePackage.getEBoolean(), "validateHistoryofInfectionSectionInfectionsPresent", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        addEOperation(historyofInfectionSectionEClass, this.getInfectionPresent(), "getInfectionsPresents", 1, -1, IS_UNIQUE, !IS_ORDERED);

        initEClass(infectionPresentEClass, InfectionPresent.class, "InfectionPresent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(infectionPresentEClass, ecorePackage.getEBoolean(), "validateInfectionPresentTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(infectionPresentEClass, ecorePackage.getEBoolean(), "validateInfectionPresentClassCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(infectionPresentEClass, ecorePackage.getEBoolean(), "validateInfectionPresentMoodCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(infectionPresentEClass, ecorePackage.getEBoolean(), "validateInfectionPresentCodeP", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(infectionPresentEClass, ecorePackage.getEBoolean(), "validateInfectionPresentCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(infectionPresentEClass, ecorePackage.getEBoolean(), "validateInfectionPresentValue", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(newbornsVitalSignsSectionEClass, ecorePackage.getEBoolean(), "validateNewbornsVitalSignsSectionVitalSignsObservation", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        addEOperation(newbornsVitalSignsSectionEClass, this.getVitalSignsObservation(), "getVitalSignsObservations", 1, 3, IS_UNIQUE, !IS_ORDERED);

        initEClass(vitalSignsObservationEClass, VitalSignsObservation.class, "VitalSignsObservation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        op = addEOperation(vitalSignsObservationEClass, ecorePackage.getEBoolean(), "validateVitalSignsObservationTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(vitalSignsObservationEClass, ecorePackage.getEBoolean(), "validateVitalSignsObservationClassCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(vitalSignsObservationEClass, ecorePackage.getEBoolean(), "validateVitalSignsObservationMoodCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(vitalSignsObservationEClass, ecorePackage.getEBoolean(), "validateVitalSignsObservationCodeP", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(vitalSignsObservationEClass, ecorePackage.getEBoolean(), "validateVitalSignsObservationCode", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(vitalSignsObservationEClass, ecorePackage.getEBoolean(), "validateVitalSignsObservationValue", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(laborandDeliveryInformationEClass, ecorePackage.getEBoolean(), "validateLaborandDeliveryInformationCertifierParticipation", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(mothersVitalSignsSectionEClass, ecorePackage.getEBoolean(), "validateMothersVitalSignsSectionVitalSignsObservation", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        addEOperation(mothersVitalSignsSectionEClass, this.getVitalSignsObservation(), "getVitalSignsObservations", 1, 3, IS_UNIQUE, !IS_ORDERED);
        ...
        op = addEOperation(methodofDeliveryEClass, ecorePackage.getEBoolean(), "validateMethodofDeliveryForcepsAssociation", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(methodofDeliveryEClass, ecorePackage.getEBoolean(), "validateMethodofDeliveryVacuumExtractionAssociation", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(reportingFetalDeathInformationfromaclinicalsettingtovitalrecordsEClass, ecorePackage.getEBoolean(), "validateReportingFetalDeathInformationfromaclinicalsettingtovitalrecordsHistoryofInfection", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        addEOperation(reportingFetalDeathInformationfromaclinicalsettingtovitalrecordsEClass, this.getAntenatalTestingandSurveillanceSection(), "getAntenatalTestingandSurveillance", 1, 1, IS_UNIQUE, !IS_ORDERED);
        ...
        addEOperation(reportingFetalDeathInformationfromaclinicalsettingtovitalrecordsEClass, this.getHistoryofInfectionSection(), "getHistoryofInfections", 1, -1, IS_UNIQUE, !IS_ORDERED);
    ...
    protected void createAnnotationAnnotations()
    {
        ...
        addAnnotation
          (reportingBirthInformationfromaclinicalsettingtovitalrecordsEClass, 
           ...
           new String[] 
           {
             ...
             "code.displayName", "U.S. standard certificate of live birth"
           });                                                                                 
        addAnnotation
        ...
        addAnnotation
          (prenatalCareEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Prenatal CareTemplateId Prenatal CareClassCode Prenatal CareMoodCode Prenatal CareCode Prenatal CareCodeP",
             "templateId.root", "2.16.840.1.113883.10.20.26.42",
             "classCode", "ACT",
             "moodCode", "DEF",
             "constraints.validation.info", "Prenatal CareNegationInd",
             "code.code", "73776-7",
             "code.codeSystem", "2.16.840.1.113883.6.1",
             "code.codeSystemName", "LOINC",
        ...
        addAnnotation
          (historyofInfectionSectionEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "History of Infection SectionTemplateId History of Infection SectionText History of Infection SectionInfections Present",
        ...
        addAnnotation
          (infectionPresentEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Infection PresentTemplateId Infection PresentClassCode Infection PresentMoodCode Infection PresentCode Infection PresentCodeP Infection PresentValue",
        ...
        addAnnotation
          (newbornsVitalSignsSectionEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Newborn"
           });                           
        addAnnotation
          (vitalSignsObservationEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Vital Signs ObservationTemplateId Vital Signs ObservationClassCode Vital Signs ObservationMoodCode Vital Signs ObservationCode Vital Signs ObservationCodeP Vital Signs ObservationValue",
        ...
        addAnnotation
          (laborandDeliverySectionEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Labor and Delivery SectionTemplateId Labor and Delivery SectionClassCode Labor and Delivery SectionMoodCode Labor and Delivery SectionCode Labor and Delivery SectionText Labor and Delivery SectionLabor and Delivery Information Labor and Delivery SectionMother"
           });                                    
        addAnnotation
          (laborandDeliveryInformationEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Labor and Delivery InformationTemplateId Labor and Delivery InformationClassCode Labor and Delivery InformationMoodCode Labor and Delivery InformationCode Labor and Delivery InformationCodeP Labor and Delivery InformationAttendantParticipation Labor and Delivery InformationEntryRelationship Labor and Delivery InformationMaternalTransfer Labor and Delivery InformationParticipatingLocation Labor and Delivery InformationMaternal Morbidities Labor and Delivery InformationRisk Factors Labor and Delivery InformationCertifierParticipation",
        ...
        addAnnotation
          (mothersVitalSignsSectionEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Mother"
           });                           
        addAnnotation
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Method of DeliveryTemplateId Method of DeliveryClassCode Method of DeliveryMoodCode Method of DeliveryCode Method of DeliveryCodeP Method of DeliveryFinal Route and Method Method of DeliveryForcepsAssociation Method of DeliveryVacuumExtractionAssociation Method of DeliveryFetal Presentation",
             ...
             "constraints.validation.info", "Method of DeliveryHysterotomyHysterectomyAssociation"
           });                                             
        addAnnotation
          (onsetofLaborEClass, 
           source, 
        ...
        addAnnotation
          (autopsyPerformanceEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Autopsy PerformanceTemplateId Autopsy PerformanceClassCode Autopsy PerformanceMoodCode Autopsy PerformanceCode Autopsy PerformanceCodeP Autopsy PerformanceValue",
        ...
        addAnnotation
          (fetalDeliveryTimeEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Fetal Delivery TimeTemplateId Fetal Delivery TimeMoodCode Fetal Delivery TimeCode Fetal Delivery TimeCodeP Fetal Delivery TimeValue",
    ...
    protected void createVsbrLaborandDeliveryInformationattendantParticipationattendantRoleAnnotations()
    {
        ...
        addAnnotation
          (laborandDeliveryInformationEClass, 
           ...
           {
             "classCode", "ASSIGNED",
             "constraints.validation.error", "attendantRoleClassCode attendantRoleCode attendantRoleCodeP attendantRoleAssignedPerson",
    ...
    protected void createVsbrLaborandDeliveryInformationcertifierParticipationAnnotations()
    {
        ...
        addAnnotation
          (laborandDeliveryInformationEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "certifierParticipationTime certifierParticipationTypeCode certifierParticipationCertifierRole",
             "typeCode", "RESP"
           });                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
    }
    ...
    protected void createVsbrLaborandDeliveryInformationcertifierParticipationcertifierRoleAnnotations()
    {
        ...
        addAnnotation
          (laborandDeliveryInformationEClass, 
           ...
           {
             "classCode", "ASSIGNED",
             "constraints.validation.error", "certifierRoleClassCode certifierRoleCode certifierRoleCodeP certifierRolePlayingEntity",
             "code.codeSystem", "2.16.840.1.113883.6.96",
             "code.codeSystemName", "SNOMEDCT"
           });                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
    }
    ...
    protected void createVsbrLaborandDeliveryInformationcertifierParticipationcertifierRoleCertifierAnnotations()
    {
        ...
        addAnnotation
          (laborandDeliveryInformationEClass, 
           ...
           {
             "classCode", "PSN",
             "constraints.validation.error", "CertifierClassCode CertifierDeterminerCode CertifierName",
             "determinerCode", "INSTANCE"
           });                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
    }
    ...
    protected void createVsbrMethodofDeliveryFinalRouteandMethodAnnotations()
    {
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "Final Route and MethodTemplateId Final Route and MethodClassCode Final Route and MethodCode Final Route and MethodCodeP Final Route and MethodMoodCode Final Route and MethodValue Final Route and MethodValueP",
    ...
    protected void createVsbrMethodofDeliveryFinalRouteandMethodTrialOfLaborAssociationTrialOfLaborAnnotations()
    {
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           {
             "classCode", "OBS",
             "constraints.validation.error", "TrialOfLaborClassCode TrialOfLaborCode TrialOfLaborCodeP TrialOfLaborMoodCode TrialOfLaborValue",
             "code.code", "73760-1",
             "code.codeSystem", "2.16.840.1.113883.6.1",
             "code.codeSystemName", "LOINC",
    ...
    protected void createVsbrMethodofDeliveryforcepsAssociationAnnotations()
    {
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           {
             "typeCode", "COMP",
             "constraints.validation.error", "forcepsAssociationTypeCode forcepsAssociationForcepsDelivery"
           });                                                                                                                                                                                                                                                                                        
    }
    ...
    protected void createVsbrMethodofDeliveryforcepsAssociationForcepsDeliveryAnnotations()
    {
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           {
             "classCode", "OBS",
             "constraints.validation.error", "ForcepsDeliveryClassCode ForcepsDeliveryCode ForcepsDeliveryCodeP ForcepsDeliveryMoodCode ForcepsDeliveryValue",
             "code.code", "64646001",
             "code.codeSystem", "2.16.840.1.113883.6.96",
             "code.codeSystemName", "SNOMEDCT",
             "code.displayName", "Failed forceps delivery",
             "constraints.validation.dependOn.ForcepsDeliveryCode", "ForcepsDeliveryCodeP",
             "moodCode", "EVN"
           });                                                                                                                                                                                                                                                                                       
    }
    ...
    protected void createVsbrMethodofDeliveryvacuumExtractionAssociationAnnotations()
    {
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           {
             "typeCode", "COMP",
             "constraints.validation.error", "vacuumExtractionAssociationTypeCode vacuumExtractionAssociationVacuumExtraction"
           });                                                                                                                                                                                                                                                                                      
    }
    ...
    protected void createVsbrMethodofDeliveryvacuumExtractionAssociationVacuumExtractionAnnotations()
    {
        ...
        addAnnotation
          (methodofDeliveryEClass, 
           ...
           {
             "classCode", "OBS",
             "constraints.validation.error", "VacuumExtractionClassCode VacuumExtractionCode VacuumExtractionCodeP VacuumExtractionMoodCode VacuumExtractionValue",
             "code.code", "14331002",
             "code.codeSystem", "2.16.840.1.113883.6.96",
             "code.codeSystemName", "SNOMEDCT",
             "code.displayName", "Failed vacuum extraction delivery",
             "constraints.validation.dependOn.VacuumExtractionCode", "VacuumExtractionCodeP",
             "moodCode", "EVN"
           });                                                                                                                                                                                                                                                                                     
    }
