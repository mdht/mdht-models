...
public class InfectionPresentOperations extends ClinicalStatementOperations {
	...
	public static boolean validateInfectionPresentTemplateId(InfectionPresent infectionPresent,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			infectionPresent)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						...
						new Object[] {
								"InfectionPresentTemplateId",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infectionPresent, context) }),
	...
	public static boolean validateInfectionPresentClassCode(InfectionPresent infectionPresent,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			infectionPresent)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateInfectionPresentMoodCode(InfectionPresent infectionPresent,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			infectionPresent)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateInfectionPresentCodeP(InfectionPresent infectionPresent, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			infectionPresent)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateInfectionPresentCode(InfectionPresent infectionPresent, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			infectionPresent)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateInfectionPresentValue(InfectionPresent infectionPresent, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INFECTION_PRESENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			infectionPresent)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
