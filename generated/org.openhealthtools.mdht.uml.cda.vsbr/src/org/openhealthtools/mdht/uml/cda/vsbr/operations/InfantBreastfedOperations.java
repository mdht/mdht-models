...
public class InfantBreastfedOperations extends ClinicalStatementOperations
{
  ...
  public static  boolean validateInfantBreastfedTemplateId(InfantBreastfed infantBreastfed, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_BREASTFED_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantBreastfed))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantBreastfedTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantBreastfed, context) }),
  ...
  public static  boolean validateInfantBreastfedClassCode(InfantBreastfed infantBreastfed, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_BREASTFED_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantBreastfed))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantBreastfedClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantBreastfed, context) }),
             new Object [] { infantBreastfed }));
      }
  ...
  public static  boolean validateInfantBreastfedMoodCode(InfantBreastfed infantBreastfed, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_BREASTFED_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantBreastfed))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantBreastfedMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantBreastfed, context) }),
             new Object [] { infantBreastfed }));
      }
  ...
  public static  boolean validateInfantBreastfedCodeP(InfantBreastfed infantBreastfed, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_BREASTFED_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantBreastfed))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantBreastfedCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantBreastfed, context) }),
             new Object [] { infantBreastfed }));
      }
...
"value.code = '73756-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  public static  boolean validateInfantBreastfedCode(InfantBreastfed infantBreastfed, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantBreastfedCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantBreastfed, context) }),
             new Object [] { infantBreastfed }));
      }
  ...
  public static  boolean validateInfantBreastfedValue(InfantBreastfed infantBreastfed, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INFANT_BREASTFED_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(infantBreastfed))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "InfantBreastfedValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(infantBreastfed, context) }),
             new Object [] { infantBreastfed }));
      }
