 ...
 * @model annotation="http://www.eclipse.org/uml2/2.0.0/UML originalName='Maternal Transfer'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='Maternal TransferTemplateId Maternal TransferClassCode Maternal TransferMoodCode Maternal TransferCode Maternal TransferCodeP Maternal TransferValue' templateId.root='2.16.840.1.113883.10.20.26.35' classCode='OBS' moodCode='EVN' code.code='73763-5' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Mother was transferred for maternal medical or fetal indications for delivery'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/vsbrMaternalTransfertransferSource typeCode='ORG' constraints.validation.error='Maternal TransfertransferSourceTypeCode Maternal TransfertransferSourceParticipantRole'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/vsbrMaternalTransfertransferSourcetransferRole classCode='SDLOC' constraints.validation.error='Maternal TransfertransferSourcetransferRoleClassCode Maternal TransfertransferSourcetransferRoleScopingEntity'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/vsbrMaternalTransfertransferSourcetransferRoleFacility classCode='ORG' constraints.validation.error='Maternal TransfertransferSourcetransferRoleFacilityClassCode Maternal TransfertransferSourcetransferRoleFacilityDeterminerCode Maternal TransfertransferSourcetransferRoleFacilityName' determinerCode='INSTANCE'"
 * @generated
 */
