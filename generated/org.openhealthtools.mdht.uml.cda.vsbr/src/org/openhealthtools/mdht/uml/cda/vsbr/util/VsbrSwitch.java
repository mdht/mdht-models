 ...
 * @generated
 */
public class VsbrSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case VsbrPackage.PRENATAL_TESTINGAND_SURVEILLANCE_SECTION: {
				...
				if (result == null) {
					result = caseSection(prenatalTestingandSurveillanceSection);
				}
				if (result == null) {
					result = caseAct(prenatalTestingandSurveillanceSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(prenatalTestingandSurveillanceSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.NEWBORNS_VITAL_SIGNS_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(newbornsVitalSignsObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(newbornsVitalSignsObservation);
				}
				if (result == null) {
					result = caseAct(newbornsVitalSignsObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(newbornsVitalSignsObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.ASSESSMENTS_SECTION: {
				...
				if (result == null) {
					result = caseSection(assessmentsSection);
				}
				if (result == null) {
					result = caseAct(assessmentsSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(assessmentsSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.ASSESSMENT_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(assessmentObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(assessmentObservation);
				}
				if (result == null) {
					result = caseAct(assessmentObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(assessmentObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.LABORAND_DELIVERY_PROCESS: {
				...
				if (result == null) {
					result = caseCDA_Act(laborandDeliveryProcess);
				}
				if (result == null) {
					result = caseClinicalStatement(laborandDeliveryProcess);
				}
				if (result == null) {
					result = caseAct(laborandDeliveryProcess);
				}
				if (result == null) {
					result = caseInfrastructureRoot(laborandDeliveryProcess);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.MOTHERS_VITAL_SIGNS_OBSERVATION: {
				...
				if (result == null) {
					result = caseObservation(mothersVitalSignsObservation);
				}
				if (result == null) {
					result = caseClinicalStatement(mothersVitalSignsObservation);
				}
				if (result == null) {
					result = caseAct(mothersVitalSignsObservation);
				}
				if (result == null) {
					result = caseInfrastructureRoot(mothersVitalSignsObservation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.HISTORYOF_INFECTION_LIVE_BIRTH_SECTION: {
				...
				if (result == null) {
					result = caseSection(historyofInfectionLiveBirthSection);
				}
				if (result == null) {
					result = caseAct(historyofInfectionLiveBirthSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(historyofInfectionLiveBirthSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.INFECTION_PRESENT_LIVE_BIRTH: {
				...
				if (result == null) {
					result = caseObservation(infectionPresentLiveBirth);
				}
				if (result == null) {
					result = caseClinicalStatement(infectionPresentLiveBirth);
				}
				if (result == null) {
					result = caseAct(infectionPresentLiveBirth);
				}
				if (result == null) {
					result = caseInfrastructureRoot(infectionPresentLiveBirth);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.HISTORYOF_INFECTION_FETAL_DEATH_SECTION: {
				...
				if (result == null) {
					result = caseSection(historyofInfectionFetalDeathSection);
				}
				if (result == null) {
					result = caseAct(historyofInfectionFetalDeathSection);
				}
				if (result == null) {
					result = caseInfrastructureRoot(historyofInfectionFetalDeathSection);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case VsbrPackage.INFECTION_PRESENT_FETAL_DEATH: {
				...
				if (result == null) {
					result = caseObservation(infectionPresentFetalDeath);
				}
				if (result == null) {
					result = caseClinicalStatement(infectionPresentFetalDeath);
				}
				if (result == null) {
					result = caseAct(infectionPresentFetalDeath);
				}
				if (result == null) {
					result = caseInfrastructureRoot(infectionPresentFetalDeath);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
