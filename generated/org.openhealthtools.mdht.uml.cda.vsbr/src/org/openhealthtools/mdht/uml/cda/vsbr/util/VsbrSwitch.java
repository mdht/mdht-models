  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case VsbrPackage.ANTENATAL_TESTINGAND_SURVEILLANCE_SECTION:
      {
        ...
        if (result == null) result = caseSection(antenatalTestingandSurveillanceSection);
        if (result == null) result = caseAct(antenatalTestingandSurveillanceSection);
        if (result == null) result = caseInfrastructureRoot(antenatalTestingandSurveillanceSection);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case VsbrPackage.HISTORYOF_INFECTION_SECTION:
      {
        ...
        if (result == null) result = caseSection(historyofInfectionSection);
        if (result == null) result = caseAct(historyofInfectionSection);
        if (result == null) result = caseInfrastructureRoot(historyofInfectionSection);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case VsbrPackage.INFECTION_PRESENT:
      {
        ...
        if (result == null) result = caseObservation(infectionPresent);
        if (result == null) result = caseClinicalStatement(infectionPresent);
        if (result == null) result = caseAct(infectionPresent);
        if (result == null) result = caseInfrastructureRoot(infectionPresent);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case VsbrPackage.VITAL_SIGNS_OBSERVATION:
      {
        ...
        if (result == null) result = caseObservation(vitalSignsObservation);
        if (result == null) result = caseClinicalStatement(vitalSignsObservation);
        if (result == null) result = caseAct(vitalSignsObservation);
        if (result == null) result = caseInfrastructureRoot(vitalSignsObservation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
