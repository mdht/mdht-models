...
public class DateofLastLiveBirthOperations extends ClinicalStatementOperations
{
   ...
   * @ordered
   */
  protected static final String VALIDATE_DATEOF_LAST_LIVE_BIRTH_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.26.17')";
  ...
  public static  boolean validateDateofLastLiveBirthTemplateId(DateofLastLiveBirth dateofLastLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
   ...
   * @ordered
   */
  protected static final String VALIDATE_DATEOF_LAST_LIVE_BIRTH_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";
  ...
  public static  boolean validateDateofLastLiveBirthCode(DateofLastLiveBirth dateofLastLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateDateofLastLiveBirthMoodCode(DateofLastLiveBirth dateofLastLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  ...
  public static  boolean validateDateofLastLiveBirthValue(DateofLastLiveBirth dateofLastLiveBirth, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
