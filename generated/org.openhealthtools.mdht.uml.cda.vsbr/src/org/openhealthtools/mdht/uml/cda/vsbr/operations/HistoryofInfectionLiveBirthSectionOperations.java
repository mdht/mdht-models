...
public class HistoryofInfectionLiveBirthSectionOperations extends SectionOperations
{
  ...
  public static  boolean validateHistoryofInfectionLiveBirthSectionTemplateId(HistoryofInfectionLiveBirthSection historyofInfectionLiveBirthSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HISTORYOF_INFECTION_LIVE_BIRTH_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(historyofInfectionLiveBirthSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "HistoryofInfectionLiveBirthSectionTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(historyofInfectionLiveBirthSection, context) }),
...
"value.code = '71459-2' and value.codeSystemName = 'LOINC')";
  ...
  public static  boolean validateHistoryofInfectionLiveBirthSectionCode(HistoryofInfectionLiveBirthSection historyofInfectionLiveBirthSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HISTORYOF_INFECTION_LIVE_BIRTH_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(historyofInfectionLiveBirthSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "HistoryofInfectionLiveBirthSectionCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(historyofInfectionLiveBirthSection, context) }),
             new Object [] { historyofInfectionLiveBirthSection }));
      }
  ...
  public static  boolean validateHistoryofInfectionLiveBirthSectionText(HistoryofInfectionLiveBirthSection historyofInfectionLiveBirthSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HISTORYOF_INFECTION_LIVE_BIRTH_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(historyofInfectionLiveBirthSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "HistoryofInfectionLiveBirthSectionText", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(historyofInfectionLiveBirthSection, context) }),
             new Object [] { historyofInfectionLiveBirthSection }));
      }
  ...
  public static  boolean validateHistoryofInfectionLiveBirthSectionInfectionPresentLiveBirth(HistoryofInfectionLiveBirthSection historyofInfectionLiveBirthSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HISTORYOF_INFECTION_LIVE_BIRTH_SECTION_INFECTION_PRESENT_LIVE_BIRTH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(historyofInfectionLiveBirthSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "HistoryofInfectionLiveBirthSectionInfectionPresentLiveBirth", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(historyofInfectionLiveBirthSection, context) }),
             new Object [] { historyofInfectionLiveBirthSection }));
      }
  ...
  public static  EList<InfectionPresentLiveBirth> getInfectionPresentLiveBirths(HistoryofInfectionLiveBirthSection historyofInfectionLiveBirthSection)
  {
    if (GET_INFECTION_PRESENT_LIVE_BIRTHS__EOCL_QRY == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(VsbrPackage.Literals.HISTORYOF_INFECTION_LIVE_BIRTH_SECTION, VsbrPackage.Literals.HISTORYOF_INFECTION_LIVE_BIRTH_SECTION.getEAllOperations().get(59));
      try
      {
