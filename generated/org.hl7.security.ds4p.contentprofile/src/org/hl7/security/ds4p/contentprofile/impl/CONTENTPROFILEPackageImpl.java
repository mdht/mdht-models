...
public class CONTENTPROFILEPackageImpl extends EPackageImpl implements CONTENTPROFILEPackage {
	...
	public static CONTENTPROFILEPackage init() {
		if (isInited) {
			return (CONTENTPROFILEPackage) EPackage.Registry.INSTANCE.getEPackage(CONTENTPROFILEPackage.eNS_URI);
		}

		// Obtain or create and register package
		CONTENTPROFILEPackageImpl theCONTENTPROFILEPackage = (CONTENTPROFILEPackageImpl) (EPackage.Registry.INSTANCE.get(
			eNS_URI) instanceof CONTENTPROFILEPackageImpl
					? EPackage.Registry.INSTANCE.get(eNS_URI)
					: new CONTENTPROFILEPackageImpl());
		...
		EValidator.Registry.INSTANCE.put(theCONTENTPROFILEPackage, new EValidator.Descriptor() {
		...
		Initializer.Registry.INSTANCE.registerFactory(
			"org.hl7.security.ds4p.contentprofile", AnnotationBasedInitializer.FACTORY);
	...
	public void initializePackageContents() {
		...
		initEClass(
			privacySegmentedDocumentEClass, PrivacySegmentedDocument.class, "PrivacySegmentedDocument", !IS_ABSTRACT,
			!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		EOperation op = addEOperation(
			privacySegmentedDocumentEClass, ecorePackage.getEBoolean(), "validatePrivacySegmentedDocumentTemplateId", 0,
		...
		op = addEOperation(
			privacySegmentedDocumentEClass, ecorePackage.getEBoolean(), "validatePrivacySegmentedDocumentAuthor1", 0, 1,
		...
		op = addEOperation(
			privacySegmentedDocumentEClass, ecorePackage.getEBoolean(),
			"validatePrivacySegmentedDocumentSegmentedSection", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacySegmentedDocumentEClass, ecorePackage.getEBoolean(),
			"validatePrivacySegmentedDocumentPrivacyAndSecurityMarkingsSection", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(
			privacySegmentedSectionEClass, PrivacySegmentedSection.class, "PrivacySegmentedSection", !IS_ABSTRACT,
			!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(
			privacySegmentedSectionEClass, ecorePackage.getEBoolean(), "validatePrivacySegmentedSectionTemplateId", 0,
			1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacySegmentedSectionEClass, ecorePackage.getEBoolean(),
			"validatePrivacySegmentedSectionConfidentialityCode", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacySegmentedSectionEClass, ecorePackage.getEBoolean(),
			"validatePrivacySegmentedSectionConfidentialityCodeP", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacySegmentedSectionEClass, ecorePackage.getEBoolean(), "validatePrivacySegmentedSectionAuthor", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyMarkingsSectionEClass, ecorePackage.getEBoolean(), "validatePrivacyMarkingsSectionTemplateId", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyMarkingsSectionEClass, ecorePackage.getEBoolean(), "validatePrivacyMarkingsSectionCode", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyMarkingsSectionEClass, ecorePackage.getEBoolean(), "validatePrivacyMarkingsSectionCodeP", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyMarkingsSectionEClass, ecorePackage.getEBoolean(), "validatePrivacyMarkingsSectionText", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyMarkingsSectionEClass, ecorePackage.getEBoolean(), "validatePrivacyMarkingsSectionEntry1", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			mandatoryDocumentProvenanceEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentProvenanceTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryDocumentProvenanceEClass, ecorePackage.getEBoolean(), "validateMandatoryDocumentProvenanceTime", 0,
			1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			mandatoryDocumentProvenanceEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentProvenanceAssignedAuthor", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryDocumentAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentAssignedAuthorTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryDocumentAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentAssignedAuthorTelecomEmail", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryDocumentAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentAssignedAuthorAssignedAuthoringDevice", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryDocumentAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentAssignedAuthorAssignedPerson", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryDocumentAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryDocumentAssignedAuthorRepresentedOrganization", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(), "validatePrivacyAnnotationTemplateId", 0, 1, IS_UNIQUE,
			IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(), "validatePrivacyAnnotationClassCode", 0, 1, IS_UNIQUE,
			IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(), "validatePrivacyAnnotationMoodCode", 0, 1, IS_UNIQUE,
			IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(), "validatePrivacyAnnotationStatusCodeP", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(), "validatePrivacyAnnotationStatusCode", 0, 1, IS_UNIQUE,
			IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(),
			"validatePrivacyAnnotationObligationPolicySecurityObservation", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(),
			"validatePrivacyAnnotationRefrainPolicySecurityObservation", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(),
			"validatePrivacyAnnotationPurposeOfUseSecurityObservation", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyAnnotationEClass, ecorePackage.getEBoolean(),
			"validatePrivacyAnnotationConfidentialityCodeSecurityObservation", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		addEOperation(
			privacyAnnotationEClass, this.getRefrainPolicySecurityObservation(), "getRefrainPolicySecurityObservations",
			1, -1, IS_UNIQUE, !IS_ORDERED);

		addEOperation(
			privacyAnnotationEClass, this.getPurposeOfUseSecurityObservation(), "getPurposeOfUseSecurityObservations",
			1, -1, IS_UNIQUE, !IS_ORDERED);

		addEOperation(
			privacyAnnotationEClass, this.getConfidentialitySecurityObservation(),
			"getConfidentialityCodeSecurityObservation", 1, 1, IS_UNIQUE, !IS_ORDERED);
		...
		op = addEOperation(
			protectedProblemEClass, ecorePackage.getEBoolean(), "validateProtectedProblemProblemProvenance", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			protectedProblemEClass, ecorePackage.getEBoolean(), "validateProtectedProblemPrivacyAnnotations", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			mandatoryEntryProvenanceEClass, ecorePackage.getEBoolean(), "validateMandatoryEntryProvenanceTime", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		...
		op = addEOperation(
			mandatoryEntryProvenanceEClass, ecorePackage.getEBoolean(),
			"validateMandatoryEntryProvenanceAssignedAuthor", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			...
			"validateMandatoryEntryAssignedAuthorTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryEntryAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryEntryAssignedAuthorAssignedAuthoringDevice", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryEntryAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryEntryAssignedAuthorAssignedPerson", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			mandatoryEntryAssignedAuthorEClass, ecorePackage.getEBoolean(),
			"validateMandatoryEntryAssignedAuthorRepresentedOrganization", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyAnnotationEntryRelationshipEClass, ecorePackage.getEBoolean(),
			"validatePrivacyAnnotationEntryRelationshipTemplateId", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyAnnotationEntryRelationshipEClass, ecorePackage.getEBoolean(),
			"validatePrivacyAnnotationEntryRelationshipOrganizer", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(
			privacyMarkingsEntryEClass, ecorePackage.getEBoolean(), "validatePrivacyMarkingsEntryOrganizer", 0, 1,
			IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
	...
	protected void createUmlAnnotations() {
		...
		addAnnotation(this, source, new String[] { "initializers", "org.hl7.security.ds4p.contentprofile" });
	}
	...
	protected void createAnnotationAnnotations() {
		...
		addAnnotation(
			privacySegmentedDocumentEClass, source,
			new String[] {
					"constraints.validation.error",
					"PrivacySegmentedDocumentTemplateId PrivacySegmentedDocumentAuthor1", "templateId.root",
					"2.16.840.1.113883.3.3251.1.1", "constraints.validation.info",
					"PrivacySegmentedDocumentSegmentedSection", "constraints.validation.warning",
					"PrivacySegmentedDocumentPrivacyAndSecurityMarkingsSection" });
		addAnnotation(
			privacySegmentedSectionEClass, source,
			new String[] {
					"constraints.validation.error",
					"PrivacySegmentedSectionTemplateId PrivacySegmentedSectionConfidentialityCode", "templateId.root",
					"2.16.840.1.113883.3.3251.1.10", "confidentialityCode.codeSystemName", "",
					"constraints.validation.warning",
					"PrivacySegmentedSectionConfidentialityCodeP PrivacySegmentedSectionAuthor" });
		addAnnotation(
			privacyMarkingsSectionEClass, source,
			new String[] {
					"constraints.validation.error",
					"PrivacyMarkingsSectionTemplateId PrivacyMarkingsSectionCodeP PrivacyMarkingsSectionText",
					"templateId.root", "2.16.840.1.113883.3.3251.1.5", "code.code", "57017-6", "code.codeSystemName",
					"", "code.displayName", "Privacy Policy", "constraints.validation.warning",
					"PrivacyMarkingsSectionCode", "constraints.validation.info", "PrivacyMarkingsSectionEntry1" });
		addAnnotation(
			...
			new String[] {
					...
					"SecurityObservationCodeP", "value.codeSystemName", "", "constraints.validation.warning",
		...
		addAnnotation(
			...
			new String[] {
					"constraints.validation.error",
					"MandatoryDocumentProvenanceTemplateId MandatoryDocumentProvenanceTime MandatoryDocumentProvenanceAssignedAuthor",
					"templateId.root", "2.16.840.1.113883.3.3251.1.2" });
		addAnnotation(
			mandatoryDocumentAssignedAuthorEClass, source,
			new String[] {
					"constraints.validation.error",
					"MandatoryDocumentAssignedAuthorTemplateId MandatoryDocumentAssignedAuthorTelecomEmail",
					"templateId.root", "2.16.840.1.113883.3.3251.1.3", "constraints.validation.warning",
					"MandatoryDocumentAssignedAuthorAssignedAuthoringDevice MandatoryDocumentAssignedAuthorAssignedPerson MandatoryDocumentAssignedAuthorRepresentedOrganization" });
		addAnnotation(
			privacyAnnotationEClass, source,
			new String[] {
					"constraints.validation.error",
					"PrivacyAnnotationTemplateId PrivacyAnnotationClassCode PrivacyAnnotationMoodCode PrivacyAnnotationStatusCode PrivacyAnnotationStatusCodeP PrivacyAnnotationConfidentialityCodeSecurityObservation",
					"templateId.root", "2.16.840.1.113883.3.3251.1.4", "classCode", "CLUSTER", "moodCode", "EVN",
					"statusCode.code", "active", "constraints.validation.dependOn.PrivacyAnnotationStatusCode",
					"PrivacyAnnotationStatusCodeP", "constraints.validation.info",
					"PrivacyAnnotationObligationPolicySecurityObservation PrivacyAnnotationRefrainPolicySecurityObservation PrivacyAnnotationPurposeOfUseSecurityObservation" });
		addAnnotation(
			...
			new String[] {
					...
					"constraints.validation.dependOn.SecurityObservationCode", "SecurityObservationCodeP",
					"value.codeSystemName", "", "constraints.validation.dependOn.SecurityObservationValue",
					"SecurityObservationValueP" });
		addAnnotation(
		...
		addAnnotation(
			...
			new String[] {
					"constraints.validation.error",
					"ProblemObservationTemplateId ProtectedProblemProblemProvenance ProtectedProblemPrivacyAnnotations",
					"templateId.root", "2.16.840.1.113883.3.3251.1.8" });
		addAnnotation(
			mandatoryEntryProvenanceEClass, source,
			new String[] {
					"constraints.validation.error",
					"MandatoryEntryProvenanceTemplateId MandatoryEntryProvenanceTime MandatoryEntryProvenanceAssignedAuthor",
					"templateId.root", "2.16.840.1.113883.3.3251.1.6" });
		addAnnotation(
			mandatoryEntryAssignedAuthorEClass, source,
			new String[] {
					"constraints.validation.error",
					"MandatoryEntryAssignedAuthorTemplateId MandatoryEntryAssignedAuthorAssignedAuthoringDevice MandatoryEntryAssignedAuthorAssignedPerson MandatoryEntryAssignedAuthorRepresentedOrganization",
					"templateId.root", "2.16.840.1.113883.3.3251.1.7" });
		addAnnotation(
			privacyAnnotationEntryRelationshipEClass, source,
			new String[] {
					"constraints.validation.error",
					"PrivacyAnnotationEntryRelationshipTemplateId PrivacyAnnotationEntryRelationshipOrganizer",
					"templateId.root", "2.16.840.1.113883.3.3251.1.11" });
		addAnnotation(
			privacyMarkingsEntryEClass, source,
			new String[] {
