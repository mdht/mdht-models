...
public class PrivacySegmentedDocumentOperations extends GeneralHeaderConstraintsOperations {
	...
	protected static Constraint VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePrivacySegmentedDocumentTemplateId(PrivacySegmentedDocument privacySegmentedDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT);
			try {
				VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(privacySegmentedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static Constraint VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_AUTHOR1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePrivacySegmentedDocumentAuthor1(PrivacySegmentedDocument privacySegmentedDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_AUTHOR1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT);
			try {
				VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_AUTHOR1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_AUTHOR1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_AUTHOR1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(privacySegmentedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static Constraint VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_SEGMENTED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePrivacySegmentedDocumentSegmentedSection(PrivacySegmentedDocument privacySegmentedDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_SEGMENTED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT);
			try {
				VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_SEGMENTED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_SEGMENTED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_SEGMENTED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(privacySegmentedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	protected static Constraint VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_PRIVACY_AND_SECURITY_MARKINGS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validatePrivacySegmentedDocumentPrivacyAndSecurityMarkingsSection(PrivacySegmentedDocument privacySegmentedDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_PRIVACY_AND_SECURITY_MARKINGS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT);
			try {
				VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_PRIVACY_AND_SECURITY_MARKINGS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_PRIVACY_AND_SECURITY_MARKINGS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PRIVACY_SEGMENTED_DOCUMENT_PRIVACY_AND_SECURITY_MARKINGS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(privacySegmentedDocument)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static  EList<PrivacySegmentedSection> getSegmentedSections(PrivacySegmentedDocument privacySegmentedDocument) {
		if (GET_SEGMENTED_SECTIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT, CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT.getEAllOperations().get(296));
			try {
		...
		OCL.Query query = EOCL_ENV.createQuery(GET_SEGMENTED_SECTIONS__EOCL_QRY);
	...
	public static  EList<PrivacyMarkingsSection> getPrivacyAndSecurityMarkingsSections(PrivacySegmentedDocument privacySegmentedDocument) {
		if (GET_PRIVACY_AND_SECURITY_MARKINGS_SECTIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT, CONTENTPROFILEPackage.Literals.PRIVACY_SEGMENTED_DOCUMENT.getEAllOperations().get(297));
			try {
		...
		OCL.Query query = EOCL_ENV.createQuery(GET_PRIVACY_AND_SECURITY_MARKINGS_SECTIONS__EOCL_QRY);
		@SuppressWarnings("unchecked")
