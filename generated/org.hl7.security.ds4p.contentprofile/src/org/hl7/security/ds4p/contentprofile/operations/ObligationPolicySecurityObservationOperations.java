...
public class ObligationPolicySecurityObservationOperations extends SecurityObservationOperations {
	...
	protected static Constraint VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateObligationPolicySecurityObservationValueP(ObligationPolicySecurityObservation obligationPolicySecurityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(CONTENTPROFILEPackage.Literals.OBLIGATION_POLICY_SECURITY_OBSERVATION);
			try {
				VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obligationPolicySecurityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CONTENTPROFILEPlugin.INSTANCE.getString("ObligationPolicySecurityObservationObligationPolicySecurityObservationValueP"),
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.hl7.security.ds4p.contentprofile.ObligationPolicySecurityObservationValueP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.hl7.security.ds4p.contentprofile.ObligationPolicySecurityObservationValueP", passToken);
				}
...
"value.codeSystem = '2.16.840.1.113883.1.11.20471' and (value.code = 'CPLYCD' or value.code = 'ENCRYPT'))";
	...
	protected static Constraint VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateObligationPolicySecurityObservationValue(ObligationPolicySecurityObservation obligationPolicySecurityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		Object passToken = (context == null) ? null : context.get("org.hl7.security.ds4p.contentprofile.ObligationPolicySecurityObservationValueP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(obligationPolicySecurityObservation)) {
			// I have a free pass to short-circuit
			return true;
		}
  	  
		if (VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(CONTENTPROFILEPackage.Literals.OBLIGATION_POLICY_SECURITY_OBSERVATION);
			try {
				VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(obligationPolicySecurityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 CONTENTPROFILEPlugin.INSTANCE.getString("ObligationPolicySecurityObservationObligationPolicySecurityObservationValue"),
						 new Object [] { obligationPolicySecurityObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CONTENTPROFILEPlugin.INSTANCE.getString("ObligationPolicySecurityObservationSecurityObservationTemplateId"),
						 new Object [] { obligationPolicySecurityObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 CONTENTPROFILEPlugin.INSTANCE.getString("ObligationPolicySecurityObservationSecurityObservationCodeP"),
						 new Object [] { obligationPolicySecurityObservation }));
			}
