...
public class ObligationPolicySecurityObservationOperations extends SecurityObservationOperations {
	...
	public static  boolean validateObligationPolicySecurityObservationValueP(ObligationPolicySecurityObservation obligationPolicySecurityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			try {
				VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(obligationPolicySecurityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.1.11.20471' and (value.code = 'CPLYCD' or value.code = 'ENCRYPT'))";
	...
	public static  boolean validateObligationPolicySecurityObservationValue(ObligationPolicySecurityObservation obligationPolicySecurityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(CONTENTPROFILEPackage.Literals.OBLIGATION_POLICY_SECURITY_OBSERVATION);
			try {
				VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_OBLIGATION_POLICY_SECURITY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(obligationPolicySecurityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static  boolean validateSecurityObservationTemplateId(ObligationPolicySecurityObservation obligationPolicySecurityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SECURITY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(obligationPolicySecurityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = 'SECCONOBS' and value.codeSystem = '2.16.840.1.113883.1.11.20471'";
	...
	public static  boolean validateSecurityObservationCode(ObligationPolicySecurityObservation obligationPolicySecurityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SECURITY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(obligationPolicySecurityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
