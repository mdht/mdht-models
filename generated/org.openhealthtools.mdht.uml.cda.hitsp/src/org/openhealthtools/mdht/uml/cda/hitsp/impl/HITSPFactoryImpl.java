...
public class HITSPFactoryImpl extends EFactoryImpl implements HITSPFactory {
   ...
   */
    ...
    switch (eClass.getClassifierID())
    {
      ...
      case HITSPPackage.ADVANCE_DIRECTIVE: return createAdvanceDirective();
      ...
      case HITSPPackage.RESULT_ORGANIZER: return createResultOrganizer();
      ...
      case HITSPPackage.FAMILY_HISTORY: return createFamilyHistory();
      case HITSPPackage.SOCIAL_HISTORY_SECTION: return createSocialHistorySection();
      case HITSPPackage.SOCIAL_HISTORY: return createSocialHistory();
      ...
      case HITSPPackage.REFERRAL_SUMMARY: return createReferralSummary();
      case HITSPPackage.DISCHARGE_SUMMARY: return createDischargeSummary();
      case HITSPPackage.PLANNED_PROCEDURE: return createPlannedProcedure();
      case HITSPPackage.PAST_PROCEDURE: return createPastProcedure();
