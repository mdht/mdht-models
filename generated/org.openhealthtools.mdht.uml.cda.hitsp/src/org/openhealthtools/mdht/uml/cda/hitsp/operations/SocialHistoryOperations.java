        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("SocialHistoryTemplateId"),
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HITSPPlugin.INSTANCE.getString("SocialHistoryCodeP"),
             new Object [] { socialHistory }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '160573003' or value.code = '363908000' or value.code = '364703007' or value.code = '256235009' or value.code = '228272008' or value.code = '364393001' or value.code = '229819007' or value.code = '425400000'))";
   ...
   */
    ...
    Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.hitsp.SocialHistoryCodeP");
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("SocialHistoryCode"),
             new Object [] { socialHistory }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HITSPPlugin.INSTANCE.getString("SocialHistoryEffectiveTime"),
             new Object [] { socialHistory }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("SocialHistoryText"),
             new Object [] { socialHistory }));
      }
