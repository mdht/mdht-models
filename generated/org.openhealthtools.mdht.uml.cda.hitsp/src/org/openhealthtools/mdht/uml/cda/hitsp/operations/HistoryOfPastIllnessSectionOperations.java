...
public class HistoryOfPastIllnessSectionOperations extends
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HITSP_HISTORY_OF_PAST_ILLNESS_SECTION_CONDITION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(historyOfPastIllnessSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HITSPPackage.Literals.HISTORY_OF_PAST_ILLNESS_SECTION, HITSPPackage.Literals.HISTORY_OF_PAST_ILLNESS_SECTION.getEAllOperations().get(63));
      try
      {
