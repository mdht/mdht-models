...
public class TestPatientSummary {
	...
	public static void main(String[] args) throws Exception {
		...
		ClinicalDocument minimalSample = CDAUtil.load(
			new FileInputStream("samples/CCD_HITSP_C32v2.5_Minimal_WithEntries_Valid.xml"));
		validate(minimalSample);

		System.out.println("\n***** Validate complete NIST sample *****");
		ClinicalDocument completeSample = CDAUtil.load(
			new FileInputStream("samples/HITSP_C32v2.5_Rev6_16Sections_Entries_MinimalErrors.xml"));
