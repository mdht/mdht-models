...
public class SocialHistorySectionOperations extends
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HITSP_SOCIAL_HISTORY_SECTION_SOCIAL_HISTORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(socialHistorySection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HITSPPackage.Literals.SOCIAL_HISTORY_SECTION, HITSPPackage.Literals.SOCIAL_HISTORY_SECTION.getEAllOperations().get(70));
      try
      {
