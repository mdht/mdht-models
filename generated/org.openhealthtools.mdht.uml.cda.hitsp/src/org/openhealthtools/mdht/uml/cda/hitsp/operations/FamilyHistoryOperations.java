...
public class FamilyHistoryOperations extends FamilyHistoryOrganizerOperations {
   ...
   */
	...
	protected static Constraint VALIDATE_FAMILY_HISTORY_HAS_SDT_CID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
   ...
   */
    ...
    if (VALIDATE_FAMILY_HISTORY_HAS_SDT_CID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_FAMILY_HISTORY_HAS_SDT_CID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_FAMILY_HISTORY_HAS_SDT_CID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_FAMILY_HISTORY_HAS_SDT_CID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(familyHistory))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("FamilyHistoryHasSDTCid"),
             new Object [] { familyHistory }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HITSPPlugin.INSTANCE.getString("FamilyHistoryHasFamilyName"),
             new Object [] { familyHistory }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("FamilyHistoryHasGenderCode"),
             new Object [] { familyHistory }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("FamilyHistoryTemplateId"),
             new Object [] { familyHistory }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HITSPPackage.Literals.FAMILY_HISTORY, HITSPPackage.Literals.FAMILY_HISTORY.getEAllOperations().get(83));
      try
      {
