        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HITSPPlugin.INSTANCE.getString("InsuranceProviderPayerEntryID"),
             new Object [] { insuranceProvider }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("InsuranceProviderMemberId"),
             new Object [] { insuranceProvider }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HITSPPlugin.INSTANCE.getString("InsuranceProviderMemberIdRoot"),
             new Object [] { insuranceProvider }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("InsuranceProviderPatientName"),
             new Object [] { insuranceProvider }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("InsuranceProviderSubscriberId"),
             new Object [] { insuranceProvider }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HITSPPlugin.INSTANCE.getString("InsuranceProviderCode"),
             new Object [] { insuranceProvider }));
      }
