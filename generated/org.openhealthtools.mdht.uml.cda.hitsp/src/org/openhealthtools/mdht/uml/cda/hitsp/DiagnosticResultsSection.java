...
public interface DiagnosticResultsSection extends CodedResultsSection {
	 ...
	 * @generated
	 */
	boolean validateDiagnosticResultsSectionDiagnosticProcedure(DiagnosticChain diagnostics,
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.nullFlavor <> vocab::NullFlavor::NI implies entry->exists(entry : cda::Entry | not entry.organizer.oclIsUndefined() and entry.organizer.oclIsKindOf(hitsp::ResultOrganizer))'"
	 * @generated
	 */
