...
public class EMSSceneSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SCENE_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSSceneSectionEntry1(EMSSceneSection emsSceneSection, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_SCENE_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsSceneSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_SCENE_SECTION__EMS_SCENE_SECTION_ENTRY1,
					EmspcrPlugin.INSTANCE.getString("EMSSceneSectionEntry1"), new Object[] { emsSceneSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SCENE_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSSceneSectionEntry2(EMSSceneSection emsSceneSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_SCENE_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsSceneSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_SCENE_SECTION__EMS_SCENE_SECTION_ENTRY2,
					EmspcrPlugin.INSTANCE.getString("EMSSceneSectionEntry2"), new Object[] { emsSceneSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SCENE_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSSceneSectionEntry3(EMSSceneSection emsSceneSection, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_SCENE_SECTION_ENTRY3__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsSceneSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_SCENE_SECTION__EMS_SCENE_SECTION_ENTRY3,
					EmspcrPlugin.INSTANCE.getString("EMSSceneSectionEntry3"), new Object[] { emsSceneSection }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SCENE_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::DerivedEntry))";
	...
	public static boolean validateEMSSceneSectionEntry4(EMSSceneSection emsSceneSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMS_SCENE_SECTION_ENTRY4__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			emsSceneSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.EMS_SCENE_SECTION__EMS_SCENE_SECTION_ENTRY4,
					EmspcrPlugin.INSTANCE.getString("EMSSceneSectionEntry4"), new Object[] { emsSceneSection }));
			}
