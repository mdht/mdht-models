...
public class EnvironmentalAllergyOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateEnvironmentalAllergyTemplateId(EnvironmentalAllergy environmentalAllergy, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENVIRONMENTAL_ALLERGY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(environmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '69748-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateEnvironmentalAllergyCode(EnvironmentalAllergy environmentalAllergy, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENVIRONMENTAL_ALLERGY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(environmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("EnvironmentalAllergyCode"),
						 new Object [] { environmentalAllergy }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA137-2' or value.code = 'LA17059-9' or value.code = 'LA18356-8' or value.code = 'LA18357-6' or value.code = 'LA18358-4' or value.code = 'LA18359-2' or value.code = 'LA18360-0' or value.code = 'LA18361-8')))";
	...
	public static  boolean validateEnvironmentalAllergyValue(EnvironmentalAllergy environmentalAllergy, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENVIRONMENTAL_ALLERGY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(environmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("EnvironmentalAllergyValue"),
						 new Object [] { environmentalAllergy }));
			}
	...
	public static  boolean validateEnvironmentalAllergyMoodCode(EnvironmentalAllergy environmentalAllergy, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ENVIRONMENTAL_ALLERGY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(environmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
