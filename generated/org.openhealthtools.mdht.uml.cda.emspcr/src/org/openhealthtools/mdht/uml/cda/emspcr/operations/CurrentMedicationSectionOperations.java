...
public class CurrentMedicationSectionOperations extends MedicationsSectionOperations {
	...
	public static  boolean validateCurrentMedicationSectionTitle(CurrentMedicationSection currentMedicationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CURRENT_MEDICATION_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(currentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCurrentMedicationSectionText(CurrentMedicationSection currentMedicationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CURRENT_MEDICATION_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(currentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCurrentMedicationSectionCurrentlyOnMedication(CurrentMedicationSection currentMedicationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CURRENT_MEDICATION_SECTION_CURRENTLY_ON_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(currentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCurrentMedicationSectionPatientOnAnticoagulants(CurrentMedicationSection currentMedicationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CURRENT_MEDICATION_SECTION_PATIENT_ON_ANTICOAGULANTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(currentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateCurrentMedicationSectionCurrentMedication(CurrentMedicationSection currentMedicationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CURRENT_MEDICATION_SECTION_CURRENT_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(currentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  CurrentlyOnMedication getCurrentlyOnMedication(CurrentMedicationSection currentMedicationSection) {
		if (GET_CURRENTLY_ON_MEDICATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.CURRENT_MEDICATION_SECTION, EmspcrPackage.Literals.CURRENT_MEDICATION_SECTION.getEAllOperations().get(71));
			try {
	...
	public static  PatientOnAnticoagulants getPatientOnAnticoagulants(CurrentMedicationSection currentMedicationSection) {
		if (GET_PATIENT_ON_ANTICOAGULANTS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.CURRENT_MEDICATION_SECTION, EmspcrPackage.Literals.CURRENT_MEDICATION_SECTION.getEAllOperations().get(72));
			try {
	...
	public static  CurrentMedication getCurrentMedication(CurrentMedicationSection currentMedicationSection) {
		if (GET_CURRENT_MEDICATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.CURRENT_MEDICATION_SECTION, EmspcrPackage.Literals.CURRENT_MEDICATION_SECTION.getEAllOperations().get(73));
			try {
	...
	public static  boolean validateMedicationsSectionEntriesOptionalTemplateId(CurrentMedicationSection currentMedicationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATIONS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(currentMedicationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MedicationsSectionEntriesOptionalTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(currentMedicationSection, context) }),
						 new Object [] { currentMedicationSection }));
			}
