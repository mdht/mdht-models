 ...
 * @generated
 */
public class EMSAdvanceDirectivesSectionOperations extends org.eclipse.mdht.uml.cda.operations.SectionOperations {
...
"value.code = '67840-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static EList<AdvanceDirectiveObservation> getAdvancedDirectiveObservations(
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_ADVANCED_DIRECTIVE_OBSERVATIONS__EOCL_QRY);
