 ...
 * @generated
 */
public class UnitEnRouteTimeOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	...
	protected static ThreadLocal<  Constraint> VALIDATE_UNIT_EN_ROUTE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateUnitEnRouteTimeTemplateId(UnitEnRouteTime unitEnRouteTime,
		...
		if (VALIDATE_UNIT_EN_ROUTE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.UNIT_EN_ROUTE_TIME);
			try {
				VALIDATE_UNIT_EN_ROUTE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_UNIT_EN_ROUTE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_UNIT_EN_ROUTE_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(unitEnRouteTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static ThreadLocal<  Constraint> VALIDATE_UNIT_EN_ROUTE_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateUnitEnRouteTimeMoodCode(UnitEnRouteTime unitEnRouteTime, DiagnosticChain diagnostics,
		...
		if (VALIDATE_UNIT_EN_ROUTE_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.UNIT_EN_ROUTE_TIME);
			try {
				VALIDATE_UNIT_EN_ROUTE_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_UNIT_EN_ROUTE_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_UNIT_EN_ROUTE_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(unitEnRouteTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static ThreadLocal<  Constraint> VALIDATE_UNIT_EN_ROUTE_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateUnitEnRouteTimeCodeP(UnitEnRouteTime unitEnRouteTime, DiagnosticChain diagnostics,
		...
		if (VALIDATE_UNIT_EN_ROUTE_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.UNIT_EN_ROUTE_TIME);
			try {
				VALIDATE_UNIT_EN_ROUTE_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_UNIT_EN_ROUTE_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_UNIT_EN_ROUTE_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(unitEnRouteTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '69472-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_UNIT_EN_ROUTE_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateUnitEnRouteTimeCode(UnitEnRouteTime unitEnRouteTime, DiagnosticChain diagnostics,
		...
		if (VALIDATE_UNIT_EN_ROUTE_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.UNIT_EN_ROUTE_TIME);
			try {
				VALIDATE_UNIT_EN_ROUTE_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_UNIT_EN_ROUTE_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_UNIT_EN_ROUTE_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(unitEnRouteTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static ThreadLocal<  Constraint> VALIDATE_UNIT_EN_ROUTE_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateUnitEnRouteTimeValue(UnitEnRouteTime unitEnRouteTime, DiagnosticChain diagnostics,
		...
		if (VALIDATE_UNIT_EN_ROUTE_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.UNIT_EN_ROUTE_TIME);
			try {
				VALIDATE_UNIT_EN_ROUTE_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_UNIT_EN_ROUTE_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_UNIT_EN_ROUTE_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(unitEnRouteTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
