...
public class DispatchSectionOperations extends SectionOperations {
	...
	public static  boolean validateDispatchSectionTemplateId(DispatchSection dispatchSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPATCH_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("DispatchSectionTemplateId"),
...
"value.code = '67660-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateDispatchSectionCode(DispatchSection dispatchSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("DispatchSectionCode"),
						 new Object [] { dispatchSection }));
			}
	...
	public static  boolean validateDispatchSectionTitle(DispatchSection dispatchSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPATCH_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("DispatchSectionTitle"),
						 new Object [] { dispatchSection }));
			}
	...
	public static  boolean validateDispatchSectionText(DispatchSection dispatchSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("DispatchSectionText"),
						 new Object [] { dispatchSection }));
			}
	...
	public static  boolean validateDispatchSectionEmergencyMedicalDispatchObservation(DispatchSection dispatchSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPATCH_SECTION_EMERGENCY_MEDICAL_DISPATCH_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateDispatchSectionComplaintReportedByDispatch(DispatchSection dispatchSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPATCH_SECTION_COMPLAINT_REPORTED_BY_DISPATCH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(dispatchSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  EmergencyMedicalDispatchObservation getEmergencyMedicalDispatchObservation(DispatchSection dispatchSection) {
		if (GET_EMERGENCY_MEDICAL_DISPATCH_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.DISPATCH_SECTION, EmspcrPackage.Literals.DISPATCH_SECTION.getEAllOperations().get(61));
			try {
	...
	public static  ComplaintReportedByDispatch getComplaintReportedByDispatch(DispatchSection dispatchSection) {
		if (GET_COMPLAINT_REPORTED_BY_DISPATCH__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.DISPATCH_SECTION, EmspcrPackage.Literals.DISPATCH_SECTION.getEAllOperations().get(62));
			try {
