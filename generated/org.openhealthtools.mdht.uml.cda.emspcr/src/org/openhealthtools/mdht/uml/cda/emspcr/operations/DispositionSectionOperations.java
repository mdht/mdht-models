...
public class DispositionSectionOperations extends SectionOperations {
	...
	*/
	...
	public static boolean validateDispositionSectionTemplateId(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPOSITION_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
	...
	*/
	...
	public static boolean validateDispositionSectionCode(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPOSITION_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.DISPOSITION_SECTION__DISPOSITION_SECTION_CODE,
					EmspcrPlugin.INSTANCE.getString("DispositionSectionCode"), new Object[] { dispositionSection }));
			}
	...
	*/
	...
	public static boolean validateDispositionSectionCodeP(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPOSITION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.DISPOSITION_SECTION__DISPOSITION_SECTION_CODE_P,
					EmspcrPlugin.INSTANCE.getString("DispositionSectionCodeP"), new Object[] { dispositionSection }));
			}
	...
	*/
	...
	public static boolean validateDispositionSectionTitle(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPOSITION_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.DISPOSITION_SECTION__DISPOSITION_SECTION_TITLE,
					EmspcrPlugin.INSTANCE.getString("DispositionSectionTitle"), new Object[] { dispositionSection }));
			}
	...
	*/
	...
	public static boolean validateDispositionSectionText(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DISPOSITION_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.DISPOSITION_SECTION__DISPOSITION_SECTION_TEXT,
					EmspcrPlugin.INSTANCE.getString("DispositionSectionText"), new Object[] { dispositionSection }));
			}
	...
	*/
	...
	public static boolean validateDispositionSectionNumberOfPatientsObservation(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_NUMBER_OF_PATIENTS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateDispositionSectionIncidentDispositionObservation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_INCIDENT_DISPOSITION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateDispositionSectionTransportModeObservation(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_TRANSPORT_MODE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateDispositionSectionTransportMethodObservation(DispositionSection dispositionSection,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_TRANSPORT_METHOD_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateDispositionSectionReasonForChoosingDestinationObservation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_REASON_FOR_CHOOSING_DESTINATION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	*/
	...
	public static boolean validateDispositionSectionPrearrivalActivationObservation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_PREARRIVAL_ACTIVATION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateDispositionSectionPatientConditionChangeAtDestinationObservation(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_DISPOSITION_SECTION_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			dispositionSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
