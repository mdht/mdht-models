 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSTimesSection#getEntry9() <em>Get Entry9</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67667-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_TIMES_SECTION_ENTRY9__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSTimesSection::EMSTimesEntry))";
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry9(EMSTimesSection) <em>Get Entry9</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry9(EMSTimesSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY9__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSTimesSection::EMSTimesEntry))->asSequence()->first().oclAsType(emspcr::EMSTimesSection::EMSTimesEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry9(EMSTimesSection) <em>Get Entry9</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry9(EMSTimesSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry9(EMSTimesSection emsTimesSection)
  {
    if (GET_ENTRY9__EOCL_QRY == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(EmspcrPackage.Literals.EMS_TIMES_SECTION, EmspcrPackage.Literals.EMS_TIMES_SECTION.getEAllOperations().get(60));
      try
      {
    ...
    return (void) query.evaluate(emsTimesSection);
  }
