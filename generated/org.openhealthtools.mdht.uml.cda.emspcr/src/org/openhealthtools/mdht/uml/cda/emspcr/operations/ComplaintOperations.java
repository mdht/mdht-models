				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ComplaintDurationRelationship"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ComplaintTypeRelationship"),
						 new Object [] { complaint }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ComplaintOrganSystemRelationship"),
						 new Object [] { complaint }));
			}
