...
public class ProcedureOperations extends ProcedureActivityProcedureOperations {
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureAbandonedProcedureRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_ABANDONED_PROCEDURE_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureAbandonedProcedureRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureProcedurePriorRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_PROCEDURE_PRIOR_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureProcedurePriorRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureProcedureNumberOfAttemptsRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_PROCEDURE_NUMBER_OF_ATTEMPTS_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureProcedureNumberOfAttemptsRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureProcedureSuccessfulRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_PROCEDURE_SUCCESSFUL_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureProcedureSuccessfulRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureProcedureComplicationsRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_PROCEDURE_COMPLICATIONS_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureProcedureComplicationsRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureProcedurePatientResponseRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_PROCEDURE_PATIENT_RESPONSE_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureProcedurePatientResponseRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureProcedurePerformer(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_PROCEDURE_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureProcedurePerformer", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEmspcrProcedureAirwayConfirmationRelationship(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EMSPCR_PROCEDURE_AIRWAY_CONFIRMATION_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEmspcrProcedureAirwayConfirmationRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureCode(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureEffectiveTime(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureEffectiveTime", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureStatusCodeP(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
...
"value.code = 'Aborted')";
	...
	public static  boolean validateEmspcrProcedureStatusCode(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureStatusCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureApproachSiteCodeP(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_APPROACH_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureApproachSiteCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA18112-5' or value.code = 'LA18113-3' or value.code = 'LA18757-7' or value.code = 'LA18758-5' or value.code = 'LA18790-8' or value.code = 'LA18791-6' or value.code = 'LA18792-4' or value.code = 'LA18793-2' or value.code = 'LA18794-0' or value.code = 'LA18795-7' or value.code = 'LA18796-5' or value.code = 'LA18797-3' or value.code = 'LA18798-1' or value.code = 'LA18799-9' or value.code = 'LA18800-5' or value.code = 'LA18801-3' or value.code = 'LA18802-1' or value.code = 'LA18803-9' or value.code = 'LA18804-7' or value.code = 'LA18805-4' or value.code = 'LA18806-2' or value.code = 'LA18807-0' or value.code = 'LA18808-8' or value.code = 'LA18809-6' or value.code = 'LA18810-4' or value.code = 'LA18811-2' or value.code = 'LA18812-0' or value.code = 'LA18813-8' or value.code = 'LA18814-6' or value.code = 'LA18815-3' or value.code = 'LA18816-1' or value.code = 'LA18817-9' or value.code = 'LA18818-7')))";
	...
	public static  boolean validateEmspcrProcedureApproachSiteCode(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_APPROACH_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureApproachSiteCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateEmspcrProcedureNegationInd(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EMSPCR_PROCEDURE_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "EmspcrProcedureNegationInd", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
	...
	public static  boolean validateProcedureActivityProcedureTemplateId(Procedure procedure, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ProcedureActivityProcedureTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(procedure, context) }),
						 new Object [] { procedure }));
			}
