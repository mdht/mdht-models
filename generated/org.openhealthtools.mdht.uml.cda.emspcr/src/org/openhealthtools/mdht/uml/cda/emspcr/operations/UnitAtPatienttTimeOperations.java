...
public class UnitAtPatienttTimeOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateUnitAtPatienttTimeTemplateId(UnitAtPatienttTime unitAtPatienttTime, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_UNIT_AT_PATIENTT_TIME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(unitAtPatienttTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateUnitAtPatienttTimeCodeP(UnitAtPatienttTime unitAtPatienttTime, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_UNIT_AT_PATIENTT_TIME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(unitAtPatienttTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("UnitAtPatienttTimeCodeP"),
						 new Object [] { unitAtPatienttTime }));
			}
...
"value.code = '69474-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateUnitAtPatienttTimeCode(UnitAtPatienttTime unitAtPatienttTime, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.UnitAtPatienttTimeCodeP");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_UNIT_AT_PATIENTT_TIME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(unitAtPatienttTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("UnitAtPatienttTimeCode"),
						 new Object [] { unitAtPatienttTime }));
			}
	...
	public static  boolean validateUnitAtPatienttTimeValue(UnitAtPatienttTime unitAtPatienttTime, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_UNIT_AT_PATIENTT_TIME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(unitAtPatienttTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("UnitAtPatienttTimeValue"),
						 new Object [] { unitAtPatienttTime }));
			}
	...
	public static  boolean validateUnitAtPatienttTimeMoodCode(UnitAtPatienttTime unitAtPatienttTime, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_UNIT_AT_PATIENTT_TIME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(unitAtPatienttTime)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("UnitAtPatienttTimeMoodCode"),
						 new Object [] { unitAtPatienttTime }));
			}
