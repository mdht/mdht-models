	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmspcrPackage.EMS_CURRENT_MEDICATION_SECTION: {
				...
				if (result == null) {
					result = caseMedicationsSection(emsCurrentMedicationSection);
				}
				if (result == null) {
					result = caseMedicationsSectionEntriesOptional(emsCurrentMedicationSection);
				}
				if (result == null) {
			...
			case EmspcrPackage.DRUG_ALLERGY: {
				...
				if (result == null) {
					result = caseAllergyProblemAct(drugAllergy);
				}
				if (result == null) {
					result = caseCDA_Act(drugAllergy);
				}
				if (result == null) {
					result = caseClinicalStatement(drugAllergy);
				}
				if (result == null) {
					result = caseAct(drugAllergy);
				}
				if (result == null) {
					result = caseInfrastructureRoot(drugAllergy);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case EmspcrPackage.EMS_PHYSICAL_ASSESSMENT_SECTION: {
				...
				if (result == null) {
					result = casePhysicalExamSection(emsPhysicalAssessmentSection);
				}
				if (result == null) {
			...
			case EmspcrPackage.EMS_MEDICATIONS_ADMINISTERED_SECTION: {
				...
				if (result == null) {
					result = caseMedicationsAdministeredSection(emsMedicationsAdministeredSection);
				}
				if (result == null) {
			...
			case EmspcrPackage.EMS_PROCEDURES_PERFORMED_SECTION: {
				...
				if (result == null) {
					result = caseProcedureDescriptionSection(emsProceduresPerformedSection);
				}
				if (result == null) {
			...
			case EmspcrPackage.EMS_VITAL_SIGNS_SECTION: {
				...
				if (result == null) {
					result = caseVitalSignsSection(emsVitalSignsSection);
				}
				if (result == null) {
					result = caseVitalSignsSectionEntriesOptional(emsVitalSignsSection);
				}
				if (result == null) {
