	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmspcrPackage.EMS_DRUG_ALLERGY: {
				...
				if (result == null) result = caseCDA_Act(emsDrugAllergy);
				if (result == null) result = caseClinicalStatement(emsDrugAllergy);
				if (result == null) result = caseAct(emsDrugAllergy);
				if (result == null) result = caseInfrastructureRoot(emsDrugAllergy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EmspcrPackage.NON_DRUG_ALLERGY_ORGANIZER_ACTUALLY_DREG: {
				...
				if (result == null) result = caseOrganizer(nonDrugAllergyOrganizerActuallyDreg);
				if (result == null) result = caseClinicalStatement(nonDrugAllergyOrganizerActuallyDreg);
				if (result == null) result = caseAct(nonDrugAllergyOrganizerActuallyDreg);
				if (result == null) result = caseInfrastructureRoot(nonDrugAllergyOrganizerActuallyDreg);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmspcrPackage.EMS_DRUG_ALLERGY_ORGANIZER: {
				...
				if (result == null) result = caseOrganizer(emsDrugAllergyOrganizer);
				if (result == null) result = caseClinicalStatement(emsDrugAllergyOrganizer);
				if (result == null) result = caseAct(emsDrugAllergyOrganizer);
				if (result == null) result = caseInfrastructureRoot(emsDrugAllergyOrganizer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
