...
public class SituationSectionOperations extends SectionOperations {
	...
	public static  boolean validateSituationSectionTemplateId(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionTemplateId"),
...
"value.code = '67666-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateSituationSectionCode(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionCode"),
						 new Object [] { situationSection }));
			}
	...
	public static  boolean validateSituationSectionCodeP(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionCodeP"),
						 new Object [] { situationSection }));
			}
	...
	public static  boolean validateSituationSectionTitle(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionTitle"),
						 new Object [] { situationSection }));
			}
	...
	public static  boolean validateSituationSectionText(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionText"),
						 new Object [] { situationSection }));
			}
	...
	public static  boolean validateSituationSectionComplaint(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_COMPLAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionComplaint"),
						 new Object [] { situationSection }));
			}
	...
	public static  boolean validateSituationSectionPossibleInjury(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_POSSIBLE_INJURY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateSituationSectionProviderPrimaryImpression(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_PROVIDER_PRIMARY_IMPRESSION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateSituationSectionPrimarySymptom(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_PRIMARY_SYMPTOM__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateSituationSectionOtherSymptoms(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_OTHER_SYMPTOMS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SituationSectionOtherSymptoms"),
						 new Object [] { situationSection }));
			}
	...
	public static  boolean validateSituationSectionProviderSecondaryImpressions(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_PROVIDER_SECONDARY_IMPRESSIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateSituationSectionInitialPatientAcuity(SituationSection situationSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SITUATION_SECTION_INITIAL_PATIENT_ACUITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(situationSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  Complaint getComplaint(SituationSection situationSection) {
		if (GET_COMPLAINT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(67));
			try {
	...
	public static  PossibleInjury getPossibleInjury(SituationSection situationSection) {
		if (GET_POSSIBLE_INJURY__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(68));
			try {
	...
	public static  ProviderPrimaryImpression getProviderPrimaryImpression(SituationSection situationSection) {
		if (GET_PROVIDER_PRIMARY_IMPRESSION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(69));
			try {
	...
	public static  PrimarySymptom getPrimarySymptom(SituationSection situationSection) {
		if (GET_PRIMARY_SYMPTOM__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(70));
			try {
	...
	public static  OtherSymptoms getOtherSymptoms(SituationSection situationSection) {
		if (GET_OTHER_SYMPTOMS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(71));
			try {
	...
	public static  ProviderSecondaryImpressions getProviderSecondaryImpressions(SituationSection situationSection) {
		if (GET_PROVIDER_SECONDARY_IMPRESSIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(72));
			try {
	...
	public static  InitialPatientAcuity getInitialPatientAcuity(SituationSection situationSection) {
		if (GET_INITIAL_PATIENT_ACUITY__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SITUATION_SECTION, EmspcrPackage.Literals.SITUATION_SECTION.getEAllOperations().get(73));
			try {
