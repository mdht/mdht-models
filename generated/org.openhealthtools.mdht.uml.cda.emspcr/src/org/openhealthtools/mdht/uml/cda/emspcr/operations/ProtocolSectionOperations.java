...
public class ProtocolSectionOperations extends SectionOperations {
	...
	public static  boolean validateProtocolSectionTemplateId(ProtocolSection protocolSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROTOCOL_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(protocolSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ProtocolSectionTemplateId"),
...
"value.code = '67537-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateProtocolSectionCode(ProtocolSection protocolSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ProtocolSectionCode"),
						 new Object [] { protocolSection }));
			}
	...
	public static  boolean validateProtocolSectionTitle(ProtocolSection protocolSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROTOCOL_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(protocolSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ProtocolSectionTitle"),
						 new Object [] { protocolSection }));
			}
	...
	public static  boolean validateProtocolSectionText(ProtocolSection protocolSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ProtocolSectionText"),
						 new Object [] { protocolSection }));
			}
	...
	public static  boolean validateProtocolSectionProtocolObservation(ProtocolSection protocolSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROTOCOL_SECTION_PROTOCOL_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(protocolSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateProtocolSectionCandidatePatientRegistryType(ProtocolSection protocolSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROTOCOL_SECTION_CANDIDATE_PATIENT_REGISTRY_TYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(protocolSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  ProtocolObservation getProtocolObservation(ProtocolSection protocolSection) {
		if (GET_PROTOCOL_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PROTOCOL_SECTION, EmspcrPackage.Literals.PROTOCOL_SECTION.getEAllOperations().get(61));
			try {
	...
	public static  CandidatePatientRegistryType getCandidatePatientRegistryType(ProtocolSection protocolSection) {
		if (GET_CANDIDATE_PATIENT_REGISTRY_TYPE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PROTOCOL_SECTION, EmspcrPackage.Literals.PROTOCOL_SECTION.getEAllOperations().get(62));
			try {
