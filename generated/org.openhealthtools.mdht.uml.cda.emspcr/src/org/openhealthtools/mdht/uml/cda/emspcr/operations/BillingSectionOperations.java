...
public class BillingSectionOperations extends SectionOperations {
	...
	public static  boolean validateBillingSectionTemplateId(BillingSection billingSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_BILLING_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(billingSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BillingSectionTemplateId"),
...
"value.code = '67659-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateBillingSectionCode(BillingSection billingSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BillingSectionCode"),
						 new Object [] { billingSection }));
			}
	...
	public static  boolean validateBillingSectionTitle(BillingSection billingSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BillingSectionTitle"),
						 new Object [] { billingSection }));
			}
	...
	public static  boolean validateBillingSectionText(BillingSection billingSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BillingSectionText"),
						 new Object [] { billingSection }));
			}
	...
	public static  boolean validateBillingSectionBillingCondition(BillingSection billingSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_BILLING_SECTION_BILLING_CONDITION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(billingSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BillingSectionBillingCondition"),
						 new Object [] { billingSection }));
			}
	...
	public static  boolean validateBillingSectionLevelOfServiceObservation(BillingSection billingSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_BILLING_SECTION_LEVEL_OF_SERVICE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(billingSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  BillingCondition getBillingCondition(BillingSection billingSection) {
		if (GET_BILLING_CONDITION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.BILLING_SECTION, EmspcrPackage.Literals.BILLING_SECTION.getEAllOperations().get(61));
			try {
	...
	public static  LevelOfServiceObservation getLevelOfServiceObservation(BillingSection billingSection) {
		if (GET_LEVEL_OF_SERVICE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.BILLING_SECTION, EmspcrPackage.Literals.BILLING_SECTION.getEAllOperations().get(62));
			try {
