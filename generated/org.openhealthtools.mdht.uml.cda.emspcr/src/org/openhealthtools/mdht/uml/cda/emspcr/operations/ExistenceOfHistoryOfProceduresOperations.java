...
public class ExistenceOfHistoryOfProceduresOperations extends ClinicalStatementOperations {
	...
	public static boolean validateExistenceOfHistoryOfProceduresTemplateId(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EXISTENCE_OF_HISTORY_OF_PROCEDURES_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateExistenceOfHistoryOfProceduresCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXISTENCE_OF_HISTORY_OF_PROCEDURES_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			existenceOfHistoryOfProcedures)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExistenceOfHistoryOfProceduresValue(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXISTENCE_OF_HISTORY_OF_PROCEDURES_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			existenceOfHistoryOfProcedures)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExistenceOfHistoryOfProceduresMoodCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXISTENCE_OF_HISTORY_OF_PROCEDURES_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			existenceOfHistoryOfProcedures)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
