 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='EMSDispositionSectionTemplateId EMSDispositionSectionCode EMSDispositionSectionCodeP EMSDispositionSectionText EMSDispositionSectionTitle EMSDispositionSectionEntry1 EMSDispositionSectionEntry2 EMSDispositionSectionEntry3 EMSDispositionSectionEntry4 EMSDispositionSectionEntry5 EMSDispositionSectionEntry6 EMSDispositionSectionEntry7 EMSDispositionSectionEntry8' templateId.root='2.16.840.1.113883.17.3.10.1.4' code.code='67796?3' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='EMS Disposition' title.mixed='EMS Disposition'"
 ...
 * @generated
 */
public interface EMSDispositionSection extends DerivedCDASection
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @param context The cache of context-specific information.
   * <!-- end-model-doc -->
   * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSDispositionSection::DerivedEntry))'"
   * @generated
   */
   ...
   * @generated
   */
  boolean validateEMSDispositionSectionEntry8(DiagnosticChain diagnostics, Map<Object, Object> context);
