 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSProceduresPerformedSection#getEntry1() <em>Get Entry1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67802-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_PROCEDURES_PERFORMED_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSProceduresPerformedSection::ProceduresEntry))";
   ...
   */
	...
	public static boolean validateEMSProceduresPerformedSectionEntry1(
			EMSProceduresPerformedSection emsProceduresPerformedSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry1(EMSProceduresPerformedSection) <em>Get Entry1</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSProceduresPerformedSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY1__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSProceduresPerformedSection::ProceduresEntry))->asSequence()->first().oclAsType(emspcr::EMSProceduresPerformedSection::ProceduresEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry1(EMSProceduresPerformedSection) <em>Get Entry1</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSProceduresPerformedSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry1(EMSProceduresPerformedSection emsProceduresPerformedSection)
  {
    ...
    return (void) query.evaluate(emsProceduresPerformedSection);
  }
