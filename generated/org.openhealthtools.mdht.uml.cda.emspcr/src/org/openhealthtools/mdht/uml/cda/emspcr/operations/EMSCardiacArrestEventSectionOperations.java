 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSCardiacArrestEventSection#getEntry1() <em>Get Entry1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67799-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_CARDIAC_ARREST_EVENT_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSCardiacArrestEventSection::CardiacArrestEntry))";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_EMS_CARDIAC_ARREST_EVENT_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(emsCardiacArrestEventSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry1(EMSCardiacArrestEventSection) <em>Get Entry1</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSCardiacArrestEventSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY1__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSCardiacArrestEventSection::CardiacArrestEntry))->asSequence()->first().oclAsType(emspcr::EMSCardiacArrestEventSection::CardiacArrestEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry1(EMSCardiacArrestEventSection) <em>Get Entry1</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSCardiacArrestEventSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry1(EMSCardiacArrestEventSection emsCardiacArrestEventSection)
  {
    ...
    return (void) query.evaluate(emsCardiacArrestEventSection);
  }
