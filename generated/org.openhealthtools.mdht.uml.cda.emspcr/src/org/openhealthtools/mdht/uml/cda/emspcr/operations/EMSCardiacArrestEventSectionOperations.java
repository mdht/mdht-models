 ...
 * @generated
 */
public class EMSCardiacArrestEventSectionOperations extends DerivedCDASectionOperations
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
...
"value.code = '67799-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
  protected static final String VALIDATE_EMS_CARDIAC_ARREST_EVENT_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSCardiacArrestEventSection::DerivedEntry))";
  ...
  public static  boolean validateEMSCardiacArrestEventSectionEntry1(EMSCardiacArrestEventSection emsCardiacArrestEventSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
