 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSDispatchSection#getEntry1() <em>Get Entry1</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.EMSDispatchSection#getEntry2() <em>Get Entry2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
"value.code = '67660-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_DISPATCH_SECTION_ENTRY1__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSDispatchSection::EMDEntry))";
   ...
   */
	...
	public static boolean validateEMSDispatchSectionEntry1(EMSDispatchSection emsDispatchSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @ordered
   */
	protected static final String VALIDATE_EMS_DISPATCH_SECTION_ENTRY2__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSDispatchSection::DispatchComplaintEntry))";
   ...
   */
	...
	public static boolean validateEMSDispatchSectionEntry2(EMSDispatchSection emsDispatchSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  /**
   * The cached OCL expression body for the '{@link #getEntry1(EMSDispatchSection) <em>Get Entry1</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSDispatchSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY1__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSDispatchSection::EMDEntry))->asSequence()->first().oclAsType(emspcr::EMSDispatchSection::EMDEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry1(EMSDispatchSection) <em>Get Entry1</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry1(EMSDispatchSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry1(EMSDispatchSection emsDispatchSection)
  {
    ...
    return (void) query.evaluate(emsDispatchSection);
  }

  /**
   * The cached OCL expression body for the '{@link #getEntry2(EMSDispatchSection) <em>Get Entry2</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry2(EMSDispatchSection)
   * @generated
   * @ordered
   */
  protected static final String GET_ENTRY2__EOCL_EXP = "self.getEntries()->select(entry : cda::Entry | not entry.oclIsUndefined() and entry.oclIsKindOf(emspcr::EMSDispatchSection::DispatchComplaintEntry))->asSequence()->first().oclAsType(emspcr::EMSDispatchSection::DispatchComplaintEntry)";

  /**
   * The cached OCL query for the '{@link #getEntry2(EMSDispatchSection) <em>Get Entry2</em>}' query operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntry2(EMSDispatchSection)
   * @generated
   ...
   * @generated
   */
  public static  void getEntry2(EMSDispatchSection emsDispatchSection)
  {
