 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.PatientCareReport#validateGeneralHeaderConstraintsConfidentialityCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate General Header Constraints Confidentiality Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PatientCareReportOperations extends GeneralHeaderConstraintsOperations {
   ...
   */
	...
	public static boolean validatePatientCareReportSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSCurrentMedication(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSCardiacArrestEvent(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSAdvanceDirectives(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSAllergiesAndAdverseReactionsSection(
   ...
   */
	...
	public static boolean validatePatientCareReportEMSPastMedicalHistory(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSSocialHistory(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSPhysicalAssessmentSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSMedicationsAdministeredSection(
			PatientCareReport patientCareReport, DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSProceduresPerformedSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSPatientCareNarrative(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSSceneSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSDispatchSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSDispositionSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSPersonnelAdverseEventSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSProtocolSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSResponseSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSSituationSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSTimesSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSVitalSignsSection(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   */
	...
	public static boolean validatePatientCareReportEMSHumanAuthorParticipation(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @ordered
   */
	protected static final String VALIDATE_PATIENT_CARE_REPORT_EMS_HUMAN_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.author->one(author : cda::Author | not author.oclIsUndefined() and author.oclIsKindOf(consol::GeneralHeaderConstraints::Author))";
   ...
   * @ordered
   */
	protected static final String GET_BILLING__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSBillingSection))->asSequence()->first().oclAsType(emspcr::EMSBillingSection)";
   ...
   * @ordered
   */
	protected static final String GET_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSInjuryIncidentDescriptionSection))->asSequence()->first().oclAsType(emspcr::EMSInjuryIncidentDescriptionSection)";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT, EmspcrPackage.Literals.PATIENT_CARE_REPORT.getEAllOperations().get(195));
      try
      {
   ...
   * @ordered
   */
	protected static final String GET_EMS_CURRENT_MEDICATION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSCurrentMedicationSection))->asSequence()->first().oclAsType(emspcr::EMSCurrentMedicationSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_CARDIAC_ARREST_EVENT__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSCardiacArrestEventSection))->asSequence()->first().oclAsType(emspcr::EMSCardiacArrestEventSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_ADVANCE_DIRECTIVES__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSAdvanceDirectivesSection))->asSequence()->first().oclAsType(emspcr::EMSAdvanceDirectivesSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSAllergiesAndAdverseReactionsSection))->asSequence()->first().oclAsType(emspcr::EMSAllergiesAndAdverseReactionsSection)";
   ...
   */
	...
	public static EMSAllergiesAndAdverseReactionsSection getEMSAllergiesAndAdverseReactionsSection(
   ...
   * @ordered
   */
	protected static final String GET_EMS_PAST_MEDICAL_HISTORY__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSPastMedicalHistorySection))->asSequence()->first().oclAsType(emspcr::EMSPastMedicalHistorySection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_SOCIAL_HISTORY__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSSocialHistorySection))->asSequence()->first().oclAsType(emspcr::EMSSocialHistorySection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_PHYSICAL_ASSESSMENT_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSPhysicalAssessmentSection))->asSequence()->first().oclAsType(emspcr::EMSPhysicalAssessmentSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_MEDICATIONS_ADMINISTERED_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSMedicationsAdministeredSection))->asSequence()->first().oclAsType(emspcr::EMSMedicationsAdministeredSection)";
   ...
   */
	...
	public static EMSMedicationsAdministeredSection getEMSMedicationsAdministeredSection(
			PatientCareReport patientCareReport) {
   ...
   * @ordered
   */
	protected static final String GET_EMS_PROCEDURES_PERFORMED_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSProceduresPerformedSection))->asSequence()->first().oclAsType(emspcr::EMSProceduresPerformedSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_PATIENT_CARE_NARRATIVE__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSPatientCareNarrativeSection))->asSequence()->first().oclAsType(emspcr::EMSPatientCareNarrativeSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_SCENE_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSSceneSection))->asSequence()->first().oclAsType(emspcr::EMSSceneSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_DISPATCH_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSDispatchSection))->asSequence()->first().oclAsType(emspcr::EMSDispatchSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_DISPOSITION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSDispositionSection))->asSequence()->first().oclAsType(emspcr::EMSDispositionSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_PERSONNEL_ADVERSE_EVENT_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSPersonnelAdverseEventSection))->asSequence()->first().oclAsType(emspcr::EMSPersonnelAdverseEventSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_PROTOCOL_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSProtocolSection))->asSequence()->first().oclAsType(emspcr::EMSProtocolSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_RESPONSE_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSResponseSection))->asSequence()->first().oclAsType(emspcr::EMSResponseSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_SITUATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSSituationSection))->asSequence()->first().oclAsType(emspcr::EMSSituationSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_TIMES_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSTimesSection))->asSequence()->first().oclAsType(emspcr::EMSTimesSection)";
   ...
   * @ordered
   */
	protected static final String GET_EMS_VITAL_SIGNS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSVitalSignsSection))->asSequence()->first().oclAsType(emspcr::EMSVitalSignsSection)";
...
"value.code = '67796-3' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  /**
   * The cached OCL expression body for the '{@link #validateGeneralHeaderConstraintsConfidentialityCode(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate General Header Constraints Confidentiality Code</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateGeneralHeaderConstraintsConfidentialityCode(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
...
"value.codeSystem = '2.16.840.1.113883.5.25' and not value.code.oclIsUndefined())";
  ...
  /**
   * The cached OCL invariant for the '{@link #validateGeneralHeaderConstraintsConfidentialityCode(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate General Header Constraints Confidentiality Code</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateGeneralHeaderConstraintsConfidentialityCode(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   ...
   * @generated
   */
  public static  boolean validateGeneralHeaderConstraintsConfidentialityCode(PatientCareReport patientCareReport, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_GENERAL_HEADER_CONSTRAINTS_CONFIDENTIALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(patientCareReport))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             EmspcrValidator.DIAGNOSTIC_SOURCE,
             EmspcrValidator.PATIENT_CARE_REPORT__GENERAL_HEADER_CONSTRAINTS_CONFIDENTIALITY_CODE,
             EmspcrPlugin.INSTANCE.getString("GeneralHeaderConstraintsConfidentialityCode"),
             new Object [] { patientCareReport }));
      }
