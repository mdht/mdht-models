 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.PatientCareReport#validatePatientCareReportEMSAuthorParticipation(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Patient Care Report EMS Author Participation</em>}</li>
...
public class PatientCareReportOperations extends GeneralHeaderConstraintsOperations {
	...
	*/
	...
	public static boolean validatePatientCareReportSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.PATIENT_CARE_REPORT__PATIENT_CARE_REPORT_SECTION,
					EmspcrPlugin.INSTANCE.getString("PatientCareReportSection"), new Object[] { patientCareReport }));
			}
	...
	*/
	...
	public static boolean validatePatientCareReportEMSCurrentMedication(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_CURRENT_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSCardiacArrestEvent(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_CARDIAC_ARREST_EVENT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSAdvanceDirectives(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_ADVANCE_DIRECTIVES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
	...
	*/
	...
	public static boolean validatePatientCareReportEMSAllergiesAndAdverseReactionsSection(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSPastMedicalHistory(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_PAST_MEDICAL_HISTORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSSocialHistory(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_SOCIAL_HISTORY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSPhysicalAssessmentSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_PHYSICAL_ASSESSMENT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSMedicationsAdministeredSection(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_MEDICATIONS_ADMINISTERED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSProceduresPerformedSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_PROCEDURES_PERFORMED_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSPatientCareNarrative(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_PATIENT_CARE_NARRATIVE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSSceneSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_SCENE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSDispatchSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_DISPATCH_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSDispositionSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_DISPOSITION_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSPersonnelAdverseEventSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PATIENT_CARE_REPORT_EMS_PERSONNEL_ADVERSE_EVENT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSProtocolSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_PROTOCOL_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSResponseSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_RESPONSE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSSituationSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_SITUATION_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSTimesSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_TIMES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSVitalSignsSection(PatientCareReport patientCareReport,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validatePatientCareReportEMSAuthorParticipation(PatientCareReport patientCareReport,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		if (VALIDATE_PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT);
			try {
				VALIDATE_PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.WARNING, EmspcrValidator.DIAGNOSTIC_SOURCE,
					EmspcrValidator.PATIENT_CARE_REPORT__PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION,
					EmspcrPlugin.INSTANCE.getString("PatientCareReportEMSAuthorParticipation"),
					new Object[] { patientCareReport }));
			}
	...
	*/
	...
	/**
	* The cached OCL expression body for the '{@link #validatePatientCareReportEMSAuthorParticipation(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Patient Care Report EMS Author Participation</em>}' operation.
	* <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	* @see #validatePatientCareReportEMSAuthorParticipation(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	* @generated
	* @ordered
	*/
	protected static final String VALIDATE_PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.author->one(author : cda::Author | not author.oclIsUndefined() and author.oclIsKindOf(cda::Author))";

	/**
	* The cached OCL invariant for the '{@link #validatePatientCareReportEMSAuthorParticipation(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Patient Care Report EMS Author Participation</em>}' invariant operation.
	* <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	* @see #validatePatientCareReportEMSAuthorParticipation(PatientCareReport, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	* @generated
	...
	*/
	...
	protected static Constraint VALIDATE_PATIENT_CARE_REPORT_EMS_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
