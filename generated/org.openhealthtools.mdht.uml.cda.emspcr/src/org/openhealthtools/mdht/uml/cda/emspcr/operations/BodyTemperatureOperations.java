 ...
 * @generated
 */
public class BodyTemperatureOperations {
...
"value.code = '8310-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateVitalSignObservationTemplateId(BodyTemperature bodyTemperature,
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_VITAL_SIGN_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(bodyTemperature)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BodyTemperatureVitalSignObservationTemplateId"),
						 new Object [] { bodyTemperature }));
			}
