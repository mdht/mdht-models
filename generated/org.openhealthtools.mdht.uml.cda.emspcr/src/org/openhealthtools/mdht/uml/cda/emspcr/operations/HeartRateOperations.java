 ...
 * @generated
 */
public class HeartRateOperations {
...
"value.code = '8867-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateVitalSignObservationTemplateId(HeartRate heartRate, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_VITAL_SIGN_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(heartRate)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeartRateVitalSignObservationTemplateId"),
						 new Object [] { heartRate }));
			}
