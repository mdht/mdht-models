...
public class ExistenceOfEnvironmentalAllergyOperations extends ClinicalStatementOperations {
	...
	public static boolean validateExistenceOfEnvironmentalAllergyTemplateId(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_EXISTENCE_OF_ENVIRONMENTAL_ALLERGY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateExistenceOfEnvironmentalAllergyCode(
			ExistenceOfEnvironmentalAllergy existenceOfEnvironmentalAllergy, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXISTENCE_OF_ENVIRONMENTAL_ALLERGY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			existenceOfEnvironmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExistenceOfEnvironmentalAllergyValue(
			ExistenceOfEnvironmentalAllergy existenceOfEnvironmentalAllergy, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXISTENCE_OF_ENVIRONMENTAL_ALLERGY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			existenceOfEnvironmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateExistenceOfEnvironmentalAllergyMoodCode(
			ExistenceOfEnvironmentalAllergy existenceOfEnvironmentalAllergy, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXISTENCE_OF_ENVIRONMENTAL_ALLERGY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			existenceOfEnvironmentalAllergy)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
