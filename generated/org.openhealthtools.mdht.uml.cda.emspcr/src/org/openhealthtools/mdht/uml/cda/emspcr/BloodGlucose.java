 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='BloodGlucoseTemplateId BloodGlucoseCode BloodGlucoseCodeP BloodGlucoseValue BloodGlucoseMoodCode' templateId.root='2.16.840.1.1133883.17.3.10.1.166' code.code='2339-0' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Glucose' constraints.validation.dependOn.BloodGlucoseCode='BloodGlucoseCodeP' constraints.validation.info='BloodGlucoseEffectiveTime' moodCode='EVN'"
 * @generated
 */
