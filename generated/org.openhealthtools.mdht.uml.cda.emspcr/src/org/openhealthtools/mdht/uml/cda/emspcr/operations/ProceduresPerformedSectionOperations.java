...
public class ProceduresPerformedSectionOperations extends ProcedureDescriptionSectionOperations {
	...
	*/
	...
	public static boolean validateProceduresPerformedSectionCodeP(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURES_PERFORMED_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	*/
	...
	public static boolean validateProceduresPerformedSectionCode(ProceduresPerformedSection proceduresPerformedSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		Object passToken = (context == null)
				? null
				: context.get("org.openhealthtools.mdht.uml.cda.emspcr.ProceduresPerformedSectionCodeP");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURES_PERFORMED_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			proceduresPerformedSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateProceduresPerformedSectionTitle(
			ProceduresPerformedSection proceduresPerformedSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURES_PERFORMED_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			proceduresPerformedSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateProceduresPerformedSectionText(ProceduresPerformedSection proceduresPerformedSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURES_PERFORMED_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			proceduresPerformedSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, EmspcrValidator.DIAGNOSTIC_SOURCE,
	...
	*/
	...
	public static boolean validateProceduresPerformedSectionProcedureActivityProcedure1(
			ProceduresPerformedSection proceduresPerformedSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_PROCEDURES_PERFORMED_SECTION_PROCEDURE_ACTIVITY_PROCEDURE1__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			proceduresPerformedSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO,
	...
	public static EList<Procedure> getProcedureActivityProcedure1s(ProceduresPerformedSection proceduresPerformedSection) {
		if (GET_PROCEDURE_ACTIVITY_PROCEDURE1S__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				EmspcrPackage.Literals.PROCEDURES_PERFORMED_SECTION,
				EmspcrPackage.Literals.PROCEDURES_PERFORMED_SECTION.getEAllOperations().get(65));
			try {
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString(
						...
						new Object[] {
								"ProcedureDescriptionSectionTemplateId",
								org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(
									proceduresPerformedSection, context) }),
					new Object[] { proceduresPerformedSection }));
			}
