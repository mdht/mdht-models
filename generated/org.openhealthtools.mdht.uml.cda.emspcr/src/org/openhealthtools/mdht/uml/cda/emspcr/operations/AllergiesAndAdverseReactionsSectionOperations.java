...
public class AllergiesAndAdverseReactionsSectionOperations extends SectionOperations {
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionTemplateId(
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionCode(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionTitle(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionText(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionObservation(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionDrugAllergyProblemAct(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_DRUG_ALLERGY_PROBLEM_ACT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static boolean validateAllergiesAndAdverseReactionsSectionEnvironmentalAllergies(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(
			VALIDATE_ALLERGIES_AND_ADVERSE_REACTIONS_SECTION_ENVIRONMENTAL_ALLERGIES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			allergiesAndAdverseReactionsSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR,
	...
	public static ExistenceOfDrugAllergyObservation getObservation(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection) {
		if (GET_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				EmspcrPackage.Literals.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION,
				EmspcrPackage.Literals.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION.getEAllOperations().get(62));
			try {
	...
	public static DrugAllergyProblemAct getDrugAllergyProblemAct(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection) {
		if (GET_DRUG_ALLERGY_PROBLEM_ACT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				EmspcrPackage.Literals.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION,
				EmspcrPackage.Literals.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION.getEAllOperations().get(63));
			try {
	...
	public static EnvironmentalAllergies getEnvironmentalAllergies(
			AllergiesAndAdverseReactionsSection allergiesAndAdverseReactionsSection) {
		if (GET_ENVIRONMENTAL_ALLERGIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				EmspcrPackage.Literals.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION,
				EmspcrPackage.Literals.ALLERGIES_AND_ADVERSE_REACTIONS_SECTION.getEAllOperations().get(64));
			try {
