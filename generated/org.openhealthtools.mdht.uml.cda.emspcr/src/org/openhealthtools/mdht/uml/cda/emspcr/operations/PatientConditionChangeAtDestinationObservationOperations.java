 ...
 * @generated
 */
public class PatientConditionChangeAtDestinationObservationOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validatePatientConditionChangeAtDestinationObservationTemplateId(
		...
		if (VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION);
			try {
				VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientConditionChangeAtDestinationObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientConditionChangeAtDestinationObservationPatientConditionChangeAtDestinationObservationTemplateId"),
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validatePatientConditionChangeAtDestinationObservationMoodCode(
		...
		if (VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION);
			try {
				VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientConditionChangeAtDestinationObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientConditionChangeAtDestinationObservationPatientConditionChangeAtDestinationObservationMoodCode"),
						 new Object [] { patientConditionChangeAtDestinationObservation }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validatePatientConditionChangeAtDestinationObservationCodeP(
		...
		if (VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION);
			try {
				VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientConditionChangeAtDestinationObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientConditionChangeAtDestinationObservationPatientConditionChangeAtDestinationObservationCodeP"),
						 new Object [] { patientConditionChangeAtDestinationObservation }));
			}
...
"value.code = '67551-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validatePatientConditionChangeAtDestinationObservationCode(
		...
		if (VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION);
			try {
				VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientConditionChangeAtDestinationObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientConditionChangeAtDestinationObservationPatientConditionChangeAtDestinationObservationCode"),
						 new Object [] { patientConditionChangeAtDestinationObservation }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA11011-6' or value.code = 'LA17181-1' or value.code = 'LA65-8')))";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validatePatientConditionChangeAtDestinationObservationValue(
		...
		if (VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION);
			try {
				VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientConditionChangeAtDestinationObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientConditionChangeAtDestinationObservationPatientConditionChangeAtDestinationObservationValue"),
						 new Object [] { patientConditionChangeAtDestinationObservation }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validatePatientConditionChangeAtDestinationObservationValueP(
		...
		if (VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION);
			try {
				VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PATIENT_CONDITION_CHANGE_AT_DESTINATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(patientConditionChangeAtDestinationObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientConditionChangeAtDestinationObservationPatientConditionChangeAtDestinationObservationValueP"),
						 new Object [] { patientConditionChangeAtDestinationObservation }));
			}
