...
public class SceneSectionOperations extends SectionOperations {
	...
	public static  boolean validateSceneSectionTemplateId(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SCENE_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sceneSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionTemplateId"),
...
"value.code = '67665-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateSceneSectionCode(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionCode"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionTitle(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionTitle"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionText(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionText"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionFirstUnitIndicator(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SCENE_SECTION_FIRST_UNIT_INDICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sceneSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionFirstUnitIndicator"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionFirstUnitOnScene(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SCENE_SECTION_FIRST_UNIT_ON_SCENE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sceneSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionFirstUnitOnScene"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionScenePatientCount(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SCENE_SECTION_SCENE_PATIENT_COUNT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sceneSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionScenePatientCount"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionMassCasualtyIndicator(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SCENE_SECTION_MASS_CASUALTY_INDICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sceneSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("SceneSectionMassCasualtyIndicator"),
						 new Object [] { sceneSection }));
			}
	...
	public static  boolean validateSceneSectionLocationTypeObservation(SceneSection sceneSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SCENE_SECTION_LOCATION_TYPE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(sceneSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  FirstUnitIndicator getFirstUnitIndicator(SceneSection sceneSection) {
		if (GET_FIRST_UNIT_INDICATOR__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SCENE_SECTION, EmspcrPackage.Literals.SCENE_SECTION.getEAllOperations().get(64));
			try {
	...
	public static  FirstUnitOnScene getFirstUnitOnScene(SceneSection sceneSection) {
		if (GET_FIRST_UNIT_ON_SCENE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SCENE_SECTION, EmspcrPackage.Literals.SCENE_SECTION.getEAllOperations().get(65));
			try {
	...
	public static  ScenePatientCount getScenePatientCount(SceneSection sceneSection) {
		if (GET_SCENE_PATIENT_COUNT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SCENE_SECTION, EmspcrPackage.Literals.SCENE_SECTION.getEAllOperations().get(66));
			try {
	...
	public static  MassCasualtyIndicator getMassCasualtyIndicator(SceneSection sceneSection) {
		if (GET_MASS_CASUALTY_INDICATOR__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SCENE_SECTION, EmspcrPackage.Literals.SCENE_SECTION.getEAllOperations().get(67));
			try {
	...
	public static  LocationTypeObservation getLocationTypeObservation(SceneSection sceneSection) {
		if (GET_LOCATION_TYPE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.SCENE_SECTION, EmspcrPackage.Literals.SCENE_SECTION.getEAllOperations().get(68));
			try {
