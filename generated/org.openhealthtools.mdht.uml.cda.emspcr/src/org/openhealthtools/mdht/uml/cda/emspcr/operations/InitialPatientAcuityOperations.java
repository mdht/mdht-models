 ...
 * @generated
 */
public class InitialPatientAcuityOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	...
	protected static ThreadLocal<  Constraint> VALIDATE_INITIAL_PATIENT_ACUITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateInitialPatientAcuityTemplateId(InitialPatientAcuity initialPatientAcuity,
		...
		if (VALIDATE_INITIAL_PATIENT_ACUITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.INITIAL_PATIENT_ACUITY);
			try {
				VALIDATE_INITIAL_PATIENT_ACUITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_INITIAL_PATIENT_ACUITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_INITIAL_PATIENT_ACUITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(initialPatientAcuity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static ThreadLocal<  Constraint> VALIDATE_INITIAL_PATIENT_ACUITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateInitialPatientAcuityMoodCode(InitialPatientAcuity initialPatientAcuity,
		...
		if (VALIDATE_INITIAL_PATIENT_ACUITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.INITIAL_PATIENT_ACUITY);
			try {
				VALIDATE_INITIAL_PATIENT_ACUITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_INITIAL_PATIENT_ACUITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_INITIAL_PATIENT_ACUITY_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(initialPatientAcuity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static ThreadLocal<  Constraint> VALIDATE_INITIAL_PATIENT_ACUITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateInitialPatientAcuityCodeP(InitialPatientAcuity initialPatientAcuity,
		...
		if (VALIDATE_INITIAL_PATIENT_ACUITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.INITIAL_PATIENT_ACUITY);
			try {
				VALIDATE_INITIAL_PATIENT_ACUITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_INITIAL_PATIENT_ACUITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_INITIAL_PATIENT_ACUITY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(initialPatientAcuity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '67493-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_INITIAL_PATIENT_ACUITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateInitialPatientAcuityCode(InitialPatientAcuity initialPatientAcuity,
		...
		if (VALIDATE_INITIAL_PATIENT_ACUITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.INITIAL_PATIENT_ACUITY);
			try {
				VALIDATE_INITIAL_PATIENT_ACUITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_INITIAL_PATIENT_ACUITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_INITIAL_PATIENT_ACUITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(initialPatientAcuity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17694-3' or value.code = 'LA17695-0' or value.code = 'LA17696-8' or value.code = 'LA17697-6')))";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_INITIAL_PATIENT_ACUITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateInitialPatientAcuityValue(InitialPatientAcuity initialPatientAcuity,
		...
		if (VALIDATE_INITIAL_PATIENT_ACUITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.INITIAL_PATIENT_ACUITY);
			try {
				VALIDATE_INITIAL_PATIENT_ACUITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_INITIAL_PATIENT_ACUITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_INITIAL_PATIENT_ACUITY_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(initialPatientAcuity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static ThreadLocal<  Constraint> VALIDATE_INITIAL_PATIENT_ACUITY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateInitialPatientAcuityValueP(InitialPatientAcuity initialPatientAcuity,
		...
		if (VALIDATE_INITIAL_PATIENT_ACUITY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.INITIAL_PATIENT_ACUITY);
			try {
				VALIDATE_INITIAL_PATIENT_ACUITY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_INITIAL_PATIENT_ACUITY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_INITIAL_PATIENT_ACUITY_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(initialPatientAcuity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
