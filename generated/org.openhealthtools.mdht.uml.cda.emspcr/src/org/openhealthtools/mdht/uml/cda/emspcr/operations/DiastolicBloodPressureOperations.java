 ...
 * @generated
 */
public class DiastolicBloodPressureOperations {
...
"value.code = '8462-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static boolean validateVitalSignObservationTemplateId(DiastolicBloodPressure diastolicBloodPressure,
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_VITAL_SIGN_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(diastolicBloodPressure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("DiastolicBloodPressureVitalSignObservationTemplateId"),
						 new Object [] { diastolicBloodPressure }));
			}
