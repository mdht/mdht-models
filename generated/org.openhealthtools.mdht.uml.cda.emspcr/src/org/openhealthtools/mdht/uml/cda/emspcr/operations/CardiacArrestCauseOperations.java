				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestCauseCode"),
						 new Object [] { cardiacArrestCause }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestCauseValue"),
						 new Object [] { cardiacArrestCause }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestCauseMoodCode"),
						 new Object [] { cardiacArrestCause }));
			}
