        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("AbdomenSectionTemplateId"),
...
"value.code = '10191-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("AbdomenSectionCode"),
             new Object [] { abdomenSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("AbdomenSectionProblemEntry"),
             new Object [] { abdomenSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.ABDOMEN_SECTION, IHEPackage.Literals.ABDOMEN_SECTION.getEAllOperations().get(58));
      try
      {
