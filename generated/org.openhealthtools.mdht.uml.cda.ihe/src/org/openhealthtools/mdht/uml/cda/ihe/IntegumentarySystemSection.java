...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Integumentary System Section</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.ihe.IHEPackage#getIntegumentarySystemSection()
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='IntegumentarySystemSectionTemplateId IntegumentarySystemSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.17' code.code='29302-7' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='INTEGUMENTARY SYSTEM' constraints.validation.info='IntegumentarySystemSectionProblemEntry'"
 * @generated
 */
public interface IntegumentarySystemSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'1.3.6.1.4.1.19376.1.5.3.1.1.9.17\')'"
	 * @generated
	 */
	boolean validateIntegumentarySystemSectionTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateIntegumentarySystemSectionCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateIntegumentarySystemSectionProblemEntry(DiagnosticChain diagnostics, Map<Object, Object> context);
