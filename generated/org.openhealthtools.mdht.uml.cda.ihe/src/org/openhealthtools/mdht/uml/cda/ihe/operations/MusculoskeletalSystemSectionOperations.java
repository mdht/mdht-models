        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("MusculoskeletalSystemSectionTemplateId"),
...
"value.code = '11410-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("MusculoskeletalSystemSectionCode"),
             new Object [] { musculoskeletalSystemSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_MUSCULOSKELETAL_SYSTEM_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(ihe::ProblemEntry))";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("MusculoskeletalSystemSectionProblemEntry"),
             new Object [] { musculoskeletalSystemSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.MUSCULOSKELETAL_SYSTEM_SECTION, IHEPackage.Literals.MUSCULOSKELETAL_SYSTEM_SECTION.getEAllOperations().get(58));
      try
      {
