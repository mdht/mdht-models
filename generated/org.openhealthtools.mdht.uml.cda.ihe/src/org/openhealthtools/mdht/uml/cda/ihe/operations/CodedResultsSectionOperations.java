...
"value.code = '30954-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_CODED_RESULTS_SECTION_PROCEDURE_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(codedResultsSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.CODED_RESULTS_SECTION, IHEPackage.Literals.CODED_RESULTS_SECTION.getEAllOperations().get(61));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.CODED_RESULTS_SECTION, IHEPackage.Literals.CODED_RESULTS_SECTION.getEAllOperations().get(62));
      try
      {
