        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("HeadSectionTemplateId"),
...
"value.code = '10199-8' and value.codeSystem = '2.16.840.1.113883.6.1')";
      ...
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             IHEValidator.DIAGNOSTIC_SOURCE,
             IHEValidator.HEAD_SECTION__HEAD_SECTION_CODE,
             IHEPlugin.INSTANCE.getString("HeadSectionCode"),
             new Object [] { headSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_HEAD_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(ihe::ProblemEntry))";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("HeadSectionProblemEntry"),
             new Object [] { headSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.HEAD_SECTION, IHEPackage.Literals.HEAD_SECTION.getEAllOperations().get(58));
      try
      {
