 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ThoraxLungsSectionTemplateId ThoraxLungsSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.26' code.code='10207-9' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='THORAX+LUNGS' constraints.validation.info='ThoraxLungsSectionProblemEntry'"
 * @generated
 */
public interface ThoraxLungsSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'1.3.6.1.4.1.19376.1.5.3.1.1.9.26\')'"
	 * @generated
	 */
	boolean validateThoraxLungsSectionTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateThoraxLungsSectionProblemEntry(DiagnosticChain diagnostics, Map<Object, Object> context);
