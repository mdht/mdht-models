        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("NeckSectionTemplateId"),
...
"value.code = '11411-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
      ...
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             IHEValidator.DIAGNOSTIC_SOURCE,
             IHEValidator.NECK_SECTION__NECK_SECTION_CODE,
             IHEPlugin.INSTANCE.getString("NeckSectionCode"),
             new Object [] { neckSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("NeckSectionProblemEntry"),
             new Object [] { neckSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.NECK_SECTION, IHEPackage.Literals.NECK_SECTION.getEAllOperations().get(58));
      try
      {
