...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Coded Reason For Referral Section</b></em>'.
 * <!-- end-user-doc -->
 *
 *
...
public interface CodedReasonForReferralSection extends ReasonForReferralSection {
	...
	* <!-- end-model-doc -->
	* @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'1.3.6.1.4.1.19376.1.5.3.1.3.2\')'"
	* @generated
	*/
	boolean validateCodedReasonForReferralSectionTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	...
	* @param context The cache of context-specific information.
	* <!-- end-model-doc -->
	* @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.nullFlavor <> vocab::NullFlavor::NI implies entry->exists(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(ihe::SimpleObservation))'"
	* @generated
	*/
	boolean validateCodedReasonForReferralSectionSimpleObservation(DiagnosticChain diagnostics,
	...
	* @param context The cache of context-specific information.
	* <!-- end-model-doc -->
	* @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.nullFlavor <> vocab::NullFlavor::NI implies entry->exists(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(ihe::ProblemEntry))'"
	* @generated
	*/
	boolean validateCodedReasonForReferralSectionProblemEntry(DiagnosticChain diagnostics, Map<Object, Object> context);
