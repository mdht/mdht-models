 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.info='NeurologicSystemSectionProblemEntry' constraints.validation.error='NeurologicSystemSectionTemplateId NeurologicSystemSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.35' code.displayName='NEUROLOGIC SYSTEM' code.codeSystem='2.16.840.1.113883.6.1' code.code='10202-0'"
 * @generated
 */
