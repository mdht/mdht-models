        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("VesselsSectionTemplateId"),
...
"value.code = '10208-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("VesselsSectionCode"),
             new Object [] { vesselsSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("VesselsSectionProblemEntry"),
             new Object [] { vesselsSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.VESSELS_SECTION, IHEPackage.Literals.VESSELS_SECTION.getEAllOperations().get(58));
      try
      {
