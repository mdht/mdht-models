			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						IHEPlugin.INSTANCE.getString("HistoryOfPresentIllnessHistoryOfPresentIllnessTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						IHEPlugin.INSTANCE.getString("HistoryOfPresentIllnessHistoryOfPresentIllnessCode"),
						new Object[] { historyOfPresentIllness }));
			}
