        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MedicationHasDosing", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(medication, context) }),
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MedicationDosingRelationship", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(medication, context) }),
             new Object [] { medication }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("MedicationReasonClassMood"),
             new Object [] { medication }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96')";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.MEDICATION, IHEPackage.Literals.MEDICATION.getEAllOperations().get(97));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.MEDICATION, IHEPackage.Literals.MEDICATION.getEAllOperations().get(98));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.MEDICATION, IHEPackage.Literals.MEDICATION.getEAllOperations().get(99));
      try
      {
