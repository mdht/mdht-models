        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ThoraxLungsSectionTemplateId"),
...
"value.code = '10207-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ThoraxLungsSectionCode"),
             new Object [] { thoraxLungsSection }));
      }
   ...
   * @ordered
   */
	protected static final String VALIDATE_THORAX_LUNGS_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(ihe::ProblemEntry))";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("ThoraxLungsSectionProblemEntry"),
             new Object [] { thoraxLungsSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.THORAX_LUNGS_SECTION, IHEPackage.Literals.THORAX_LUNGS_SECTION.getEAllOperations().get(58));
      try
      {
