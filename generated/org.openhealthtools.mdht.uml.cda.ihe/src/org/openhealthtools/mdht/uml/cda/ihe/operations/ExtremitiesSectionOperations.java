        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ExtremitiesSectionTemplateId"),
...
"value.code = '10196-4' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ExtremitiesSectionCode"),
             new Object [] { extremitiesSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("ExtremitiesSectionProblemEntry"),
             new Object [] { extremitiesSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.EXTREMITIES_SECTION, IHEPackage.Literals.EXTREMITIES_SECTION.getEAllOperations().get(58));
      try
      {
