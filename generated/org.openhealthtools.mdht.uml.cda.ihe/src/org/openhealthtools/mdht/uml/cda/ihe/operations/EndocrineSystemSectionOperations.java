...
"value.code = '29307-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("EndocrineSystemSectionCode"),
             new Object [] { endocrineSystemSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.ENDOCRINE_SYSTEM_SECTION, IHEPackage.Literals.ENDOCRINE_SYSTEM_SECTION.getEAllOperations().get(58));
      try
      {
