			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						IHEPlugin.INSTANCE.getString("HospitalCourseSectionHospitalCourseSectionTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						IHEPlugin.INSTANCE.getString("HospitalCourseSectionHospitalCourseSectionCode"),
						new Object[] { hospitalCourseSection }));
			}
