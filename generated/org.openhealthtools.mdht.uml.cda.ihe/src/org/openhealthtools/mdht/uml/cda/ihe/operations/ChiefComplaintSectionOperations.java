			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						IHEPlugin.INSTANCE.getString("ChiefComplaintSectionChiefComplaintSectionTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						IHEPlugin.INSTANCE.getString("ChiefComplaintSectionChiefComplaintSectionCode"),
						new Object[] { chiefComplaintSection }));
			}
