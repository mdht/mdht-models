...
public interface ConcernEntry extends ProblemAct {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entryRelationship->select(er|er.typeCode <> vocab::ActRelationshipType::SUBJ)->isEmpty()'"
	 * @generated
	 */
