 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='LymphaticSectionTemplateId LymphaticSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.9.32' code.code='11447-0' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='HEMATOLOGIC+LYMPHATIC+IMMUNOLOGIC SYSTEM' constraints.validation.info='LymphaticSectionProblemEntry'"
 * @generated
 */
