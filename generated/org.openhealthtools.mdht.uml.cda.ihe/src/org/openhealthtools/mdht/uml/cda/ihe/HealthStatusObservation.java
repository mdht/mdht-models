 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='HealthStatusObservationTemplateId HealthStatusObservationHasTextReference HealthStatusObservationText ProblemHealthStatusObservationValue' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.4.1.2' value.codeSystem='2.16.840.1.113883.6.96' value.codeSystemName='SNOMEDCT'"
 * @generated
 */
public interface HealthStatusObservation extends ProblemHealthStatusObservation {
	...
	* @generated
	*/
	boolean validateProblemHealthStatusObservationValue(DiagnosticChain diagnostics, Map<Object, Object> context);
