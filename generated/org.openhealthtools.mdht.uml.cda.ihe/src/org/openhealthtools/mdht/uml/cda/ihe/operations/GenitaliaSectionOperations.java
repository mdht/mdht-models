        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("GenitaliaSectionTemplateId"),
...
"value.code = '11400-9' and value.codeSystem = '2.16.840.1.113883.6.1')";
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("GenitaliaSectionCode"),
             new Object [] { genitaliaSection }));
      }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("GenitaliaSectionProblemEntry"),
             new Object [] { genitaliaSection }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.GENITALIA_SECTION, IHEPackage.Literals.GENITALIA_SECTION.getEAllOperations().get(58));
      try
      {
