...
"value.code = '11393-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(IHEPackage.Literals.EARS_NOSE_MOUTH_THROAT_SECTION, IHEPackage.Literals.EARS_NOSE_MOUTH_THROAT_SECTION.getEAllOperations().get(58));
      try
      {
