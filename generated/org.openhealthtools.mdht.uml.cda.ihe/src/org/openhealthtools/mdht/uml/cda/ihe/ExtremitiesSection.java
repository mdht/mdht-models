 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.info='ExtremitiesSectionProblemEntry' constraints.validation.error='ExtremitiesSectionTemplateId ExtremitiesSectionCode' templateId.root='1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1' code.displayName='EXTREMITIES' code.codeSystem='2.16.840.1.113883.6.1' code.code='10196-4'"
 * @generated
 */
