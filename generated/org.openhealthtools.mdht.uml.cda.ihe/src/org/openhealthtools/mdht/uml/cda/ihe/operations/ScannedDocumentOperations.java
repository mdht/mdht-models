...
"      not ident.root.oclIsUndefined() and not ident.extension.oclIsUndefined()))";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_SCANNED_DOCUMENT_SCAN_ORIGINAL_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(scannedDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             IHEPlugin.INSTANCE.getString("ScannedDocumentScanOriginalAuthor"),
             new Object [] { scannedDocument }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_SCANNED_DOCUMENT_SCANNING_DEVICE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(scannedDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ScannedDocumentScanningDevice"),
             new Object [] { scannedDocument }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_SCANNED_DOCUMENT_SCAN_DATA_ENTERER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(scannedDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             IHEPlugin.INSTANCE.getString("ScannedDocumentScanDataEnterer"),
             new Object [] { scannedDocument }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_SCANNED_DOCUMENT_LEGAL_AUTHENTICATOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(scannedDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("ScannedDocumentLegalAuthenticator"),
             new Object [] { scannedDocument }));
      }
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_SCANNED_DOCUMENT_DOCUMENTATION_OF__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(scannedDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             IHEPlugin.INSTANCE.getString("ScannedDocumentDocumentationOf"),
             new Object [] { scannedDocument }));
      }
