...
public class CCDValidator extends EObjectValidator {
	...
	public boolean validateProblemObservation(ProblemObservation problemObservation, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null) {
			result &= validateProblemObservation_validateProblemObservationProblemStatusObservation(
				problemObservation, diagnostics, context);
		}
		if (result || diagnostics != null) {
			result &= validateProblemObservation_validateProblemObservationProblemHealthStatusObservation(
				problemObservation, diagnostics, context);
		}
		if (result || diagnostics != null) {
	 ...
	 * @generated
	 */
	public boolean validateProblemObservation_validateProblemObservationProblemStatusObservation(
			ProblemObservation problemObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateProblemObservation_validateProblemObservationProblemHealthStatusObservation(
			ProblemObservation problemObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
			...
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0, "_UI_GenericConstraint_diagnostic", new Object[] {
							"validateStatusObservationTemplateId", getObjectLabel(problemStatusObservation, context) },
			...
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					...
					new Object[] {
							...
							getObjectLabel(problemHealthStatusObservation, context) },
					new Object[] { problemHealthStatusObservation }, context));
			}
			return false;
		}
		return validateStatusObservation_validateStatusObservationTemplateId(
	...
	public boolean validateProblemHealthStatusObservation_validateStatusObservationCode(
		...
		if (false) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0, "_UI_GenericConstraint_diagnostic", new Object[] {
							"validateStatusObservationCode", getObjectLabel(problemHealthStatusObservation, context) },
					new Object[] { problemHealthStatusObservation }, context));
			}
			return false;
		}
		return validateStatusObservation_validateStatusObservationCode(
			problemHealthStatusObservation, diagnostics, context);
	}
	...
	public boolean validateImmunizationsSection(ImmunizationsSection immunizationsSection, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null) {
			result &= validateImmunizationsSection_validateImmunizationsSectionClinicalStatements(
	 ...
	 * @generated
	 */
	public boolean validateImmunizationsSection_validateImmunizationsSectionClinicalStatements(
	...
	public boolean validateAlertStatusObservation_validateStatusObservationTemplateId(
		...
		if (false) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0, "_UI_GenericConstraint_diagnostic", new Object[] {
							"validateStatusObservationTemplateId", getObjectLabel(alertStatusObservation, context) },
					new Object[] { alertStatusObservation }, context));
			}
			return false;
		}
		return validateStatusObservation_validateStatusObservationTemplateId(
			...
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					...
					new Object[] {
							...
							getObjectLabel(causeOfDeathObservation, context) },
					new Object[] { causeOfDeathObservation }, context));
			}
			return false;
		}
		...
		if (false) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					...
					"_UI_GenericConstraint_diagnostic",
					new Object[] {
							"validateStatusObservationTemplateId", getObjectLabel(medicationStatusObservation, context) },
					new Object[] { medicationStatusObservation }, context));
			}
			return false;
		}
		return validateStatusObservation_validateStatusObservationTemplateId(
	...
	public boolean validateVitalSignsOrganizer_validateResultOrganizerTemplateId(
		...
		if (false) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0, "_UI_GenericConstraint_diagnostic", new Object[] {
							"validateResultOrganizerTemplateId", getObjectLabel(vitalSignsOrganizer, context) },
		...
		if (false) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					...
					new Object[] {
							"validateStatusObservationTemplateId",
							getObjectLabel(advanceDirectiveStatusObservation, context) },
					new Object[] { advanceDirectiveStatusObservation }, context));
			}
			return false;
		}
		return validateStatusObservation_validateStatusObservationTemplateId(
	...
	public boolean validatePolicyActivity(PolicyActivity policyActivity, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null) {
			result &= validatePolicyActivity_validatePolicyActivityPolicySubscriber(
				policyActivity, diagnostics, context);
		}
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validatePolicyActivity_validatePolicyActivityPolicySubscriber(PolicyActivity policyActivity,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (false) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(
					...
					"_UI_GenericConstraint_diagnostic",
					new Object[] {
							"validateStatusObservationTemplateId", getObjectLabel(functionalStatusObservation, context) },
					new Object[] { functionalStatusObservation }, context));
			}
			return false;
		}
		return validateStatusObservation_validateStatusObservationTemplateId(
