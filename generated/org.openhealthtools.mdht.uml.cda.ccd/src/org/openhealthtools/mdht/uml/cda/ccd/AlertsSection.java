 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystem='2.16.840.1.113883.6.1' code.displayName='Allergies, adverse reactions, alerts' templateId.root='2.16.840.1.113883.10.20.1.2' constraints.validation.error='AlertsSectionTemplateId AlertsSectionCode AlertsSectionTitle AlertsSectionText' code.codeSystemName='LOINC' constraints.validation.warning='AlertsSectionTitleValue AlertsSectionProblemAct' code.code='48765-2'"
 * @generated
 */
public interface AlertsSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.title = \'alert\' or self.title=\'allergies and adverse reactions\''"
	 * @generated
	 */
	boolean validateAlertsSectionTitleValue(DiagnosticChain diagnostics, Map<Object, Object> context);
