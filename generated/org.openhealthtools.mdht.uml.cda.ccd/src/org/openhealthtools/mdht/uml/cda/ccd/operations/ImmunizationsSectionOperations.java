...
"value.code = '11369-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.IMMUNIZATIONS_SECTION, CCDPackage.Literals.IMMUNIZATIONS_SECTION.getEAllOperations().get(62));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.IMMUNIZATIONS_SECTION, CCDPackage.Literals.IMMUNIZATIONS_SECTION.getEAllOperations().get(63));
      try
      {
