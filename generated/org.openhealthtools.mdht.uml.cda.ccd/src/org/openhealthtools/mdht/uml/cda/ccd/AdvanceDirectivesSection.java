...
public interface AdvanceDirectivesSection extends Section {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.title = \'advance directives\''"
	 * @generated
	 */
	boolean validateAdvanceDirectivesSectionTitleValue(DiagnosticChain diagnostics, Map<Object, Object> context);
