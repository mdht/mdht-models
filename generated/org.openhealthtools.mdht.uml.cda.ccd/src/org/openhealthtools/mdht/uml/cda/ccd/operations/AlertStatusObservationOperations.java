...
public class AlertStatusObservationOperations extends StatusObservationOperations {
	 ...
	 * @generated
	 */
	public static boolean validateStatusObservationTemplateId(AlertStatusObservation alertStatusObservation,
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						CCDPlugin.INSTANCE.getString("AlertStatusObservationStatusObservationTemplateId"),
