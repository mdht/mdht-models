        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             CCDPlugin.INSTANCE.getString("ResultOrganizerCodeValue"),
...
"or self.reference->exists(ref : cda::Reference | ref.typeCode = vocab::x_ActRelationshipExternalReference::XCRPT)";
   ...
   */
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_SPECIMEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(resultOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             CCDPlugin.INSTANCE.getString("ResultOrganizerSpecimen"),
             new Object [] { resultOrganizer }));
      }
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CCDPackage.Literals.RESULT_ORGANIZER, CCDPackage.Literals.RESULT_ORGANIZER.getEAllOperations().get(62));
      try
      {
