 ...
 * @generated
 */
public class HearingScreeningResultsOrganizerOperations extends ResultOrganizerOperations
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public static  boolean validateResultOrganizerCodeP(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_RESULTS_ORGANIZER_COMPONENT_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningResultsOrganizerComponentResultObservation(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_RESULTS_ORGANIZER_COMPONENT_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULTS_ORGANIZER);
      try
      {
        VALIDATE_HEARING_SCREENING_RESULTS_ORGANIZER_COMPONENT_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_RESULTS_ORGANIZER_COMPONENT_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_RESULTS_ORGANIZER_COMPONENT_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningResultsOrganizerComponentResultObservation"),
             new Object [] { hearingScreeningResultsOrganizer }));
      }
  ...
  public static  boolean validateResultOrganizerTemplateId(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
  ...
  public static  boolean validateResultOrganizerClassCode(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
...
"value.code = '417491009' and value.codeSystem = '2.16.840.1.113883.6.96')";
  ...
  public static  boolean validateResultOrganizerCode(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
  ...
  public static  boolean validateResultOrganizerStatusCodeP(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultOrganizerStatusCodeP"),
             new Object [] { hearingScreeningResultsOrganizer }));
      }
...
"value.code = 'aborted' or value.code = 'active' or value.code = 'cancelled' or value.code = 'completed' or value.code = 'held' or value.code = 'suspended')";
  ...
  public static  boolean validateResultOrganizerStatusCode(HearingScreeningResultsOrganizer hearingScreeningResultsOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_ORGANIZER_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultsOrganizer))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultOrganizerStatusCode"),
             new Object [] { hearingScreeningResultsOrganizer }));
      }
