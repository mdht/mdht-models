 ...
 * @generated
 */
public class HearingPlanOfCareActivityEncounterOperations {
	/**
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateHearingPlanOfCareActivityEncounterEffectiveTimeLowHigh(HearingPlanOfCareActivityEncounter hearingPlanOfCareActivityEncounter, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityEncounter)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityEncounterHearingPlanOfCareActivityEncounterEffectiveTimeLowHigh"),
  ...
  /**
	...
	public static  boolean validateHearingPlanOfCareActivityEncounterCode(HearingPlanOfCareActivityEncounter hearingPlanOfCareActivityEncounter, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityEncounter)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityEncounterHearingPlanOfCareActivityEncounterCode"),
						 new Object [] { hearingPlanOfCareActivityEncounter }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityEncounterCodeP(HearingPlanOfCareActivityEncounter hearingPlanOfCareActivityEncounter, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityEncounter)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityEncounterHearingPlanOfCareActivityEncounterCodeP"),
						 new Object [] { hearingPlanOfCareActivityEncounter }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityEncounterStatusCode(HearingPlanOfCareActivityEncounter hearingPlanOfCareActivityEncounter, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityEncounter)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityEncounterHearingPlanOfCareActivityEncounterStatusCode"),
						 new Object [] { hearingPlanOfCareActivityEncounter }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityEncounterText(HearingPlanOfCareActivityEncounter hearingPlanOfCareActivityEncounter, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityEncounter)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityEncounterHearingPlanOfCareActivityEncounterText"),
						 new Object [] { hearingPlanOfCareActivityEncounter }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = 'IHE-TSC-7.3.1.1.2.5.5.001' or value.code = 'IHE-TSC-7.3.1.1.2.5.5.002' or value.code = 'IHE-TSC-7.3.1.1.2.5.5.003' or value.code = 'IHE-TSC-7.3.1.1.2.5.5.004' or value.code = 'IHE-TSC-7.3.1.1.2.5.5.005' or value.code = 'IHE-TSC-7.3.1.1.2.5.5.006'))";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validatePlanOfCareActivityEncounterTemplateId(HearingPlanOfCareActivityEncounter hearingPlanOfCareActivityEncounter, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_ENCOUNTER);
			try {
				VALIDATE_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_ENCOUNTER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityEncounter)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityEncounterPlanOfCareActivityEncounterTemplateId"),
						 new Object [] { hearingPlanOfCareActivityEncounter }));
			}
