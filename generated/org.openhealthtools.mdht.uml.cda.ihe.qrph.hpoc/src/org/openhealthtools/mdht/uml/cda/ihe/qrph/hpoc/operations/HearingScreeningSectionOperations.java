 ...
 * @generated
 */
public class HearingScreeningSectionOperations extends ResultsSectionOperations
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public static  boolean validateHearingScreeningSectionCode(HearingScreeningSection hearingScreeningSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_SECTION);
      try
      {
        VALIDATE_HEARING_SCREENING_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningSectionCode"),
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
...
"value.code = '30954-2-HPOC' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningSectionCodeP(HearingScreeningSection hearingScreeningSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_SECTION);
      try
      {
        VALIDATE_HEARING_SCREENING_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningSectionCodeP"),
             new Object [] { hearingScreeningSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningSectionText(HearingScreeningSection hearingScreeningSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_SECTION);
      try
      {
        VALIDATE_HEARING_SCREENING_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningSectionText"),
             new Object [] { hearingScreeningSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningSectionTitle(HearingScreeningSection hearingScreeningSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_SECTION);
      try
      {
        VALIDATE_HEARING_SCREENING_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningSectionTitle"),
             new Object [] { hearingScreeningSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningSectionEntry(HearingScreeningSection hearingScreeningSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_SECTION);
      try
      {
        VALIDATE_HEARING_SCREENING_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningSectionEntry"),
             new Object [] { hearingScreeningSection }));
      }
  ...
  public static  boolean validateResultsSectionEntriesOptionalTemplateId(HearingScreeningSection hearingScreeningSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULTS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultsSectionEntriesOptionalTemplateId"),
             new Object [] { hearingScreeningSection }));
      }
