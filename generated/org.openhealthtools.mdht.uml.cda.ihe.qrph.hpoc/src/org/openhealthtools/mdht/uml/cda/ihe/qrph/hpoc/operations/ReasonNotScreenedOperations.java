...
public class ReasonNotScreenedOperations extends ClinicalStatementOperations
{
  ...
  protected static Constraint VALIDATE_REASON_NOT_SCREENED_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateReasonNotScreenedTemplateId(ReasonNotScreened reasonNotScreened, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_REASON_NOT_SCREENED_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.REASON_NOT_SCREENED);
      try
      {
        VALIDATE_REASON_NOT_SCREENED_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_REASON_NOT_SCREENED_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_REASON_NOT_SCREENED_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(reasonNotScreened))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ReasonNotScreenedTemplateId"),
  ...
  protected static Constraint VALIDATE_REASON_NOT_SCREENED_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateReasonNotScreenedClassCode(ReasonNotScreened reasonNotScreened, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_REASON_NOT_SCREENED_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.REASON_NOT_SCREENED);
      try
      {
        VALIDATE_REASON_NOT_SCREENED_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_REASON_NOT_SCREENED_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_REASON_NOT_SCREENED_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(reasonNotScreened))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ReasonNotScreenedClassCode"),
             new Object [] { reasonNotScreened }));
      }
  ...
  protected static Constraint VALIDATE_REASON_NOT_SCREENED_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateReasonNotScreenedMoodCode(ReasonNotScreened reasonNotScreened, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_REASON_NOT_SCREENED_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.REASON_NOT_SCREENED);
      try
      {
        VALIDATE_REASON_NOT_SCREENED_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_REASON_NOT_SCREENED_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_REASON_NOT_SCREENED_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(reasonNotScreened))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ReasonNotScreenedMoodCode"),
             new Object [] { reasonNotScreened }));
      }
  ...
  protected static Constraint VALIDATE_REASON_NOT_SCREENED_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateReasonNotScreenedCodeP(ReasonNotScreened reasonNotScreened, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_REASON_NOT_SCREENED_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.REASON_NOT_SCREENED);
      try
      {
        VALIDATE_REASON_NOT_SCREENED_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_REASON_NOT_SCREENED_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_REASON_NOT_SCREENED_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(reasonNotScreened))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ReasonNotScreenedCodeP"),
             new Object [] { reasonNotScreened }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '410534003' or value.code = '183949008' or value.code = '183945002' or value.code = '183948000' or value.code = '397709008'))";
  ...
  protected static Constraint VALIDATE_REASON_NOT_SCREENED_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateReasonNotScreenedCode(ReasonNotScreened reasonNotScreened, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_REASON_NOT_SCREENED_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.REASON_NOT_SCREENED);
      try
      {
        VALIDATE_REASON_NOT_SCREENED_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_REASON_NOT_SCREENED_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_REASON_NOT_SCREENED_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(reasonNotScreened))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ReasonNotScreenedCode"),
             new Object [] { reasonNotScreened }));
      }
  ...
  protected static Constraint VALIDATE_REASON_NOT_SCREENED_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateReasonNotScreenedText(ReasonNotScreened reasonNotScreened, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_REASON_NOT_SCREENED_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.REASON_NOT_SCREENED);
      try
      {
        VALIDATE_REASON_NOT_SCREENED_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_REASON_NOT_SCREENED_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_REASON_NOT_SCREENED_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(reasonNotScreened))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ReasonNotScreenedText"),
             new Object [] { reasonNotScreened }));
      }
