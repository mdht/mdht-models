 ...
 * @generated
 */
public class ProcedureActivityActOperations extends org.openhealthtools.mdht.uml.cda.consol.operations.ProcedureActivityActOperations
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  protected static Constraint VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHPOCProcedureActivityActText(ProcedureActivityAct procedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_ACT);
      try
      {
        VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HPOCProcedureActivityActText"),
  ...
  protected static Constraint VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_ENCOUNTER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHPOCProcedureActivityActEntryRelationshipEncounter(ProcedureActivityAct procedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_ENCOUNTER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_ACT);
      try
      {
        VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_ENCOUNTER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_ENCOUNTER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_ENCOUNTER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HPOCProcedureActivityActEntryRelationshipEncounter"),
             new Object [] { procedureActivityAct }));
      }
  ...
  protected static Constraint VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INSTRUCTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHPOCProcedureActivityActEntryRelationshipInstructions(ProcedureActivityAct procedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INSTRUCTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_ACT);
      try
      {
        VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INSTRUCTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INSTRUCTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INSTRUCTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HPOCProcedureActivityActEntryRelationshipInstructions"),
             new Object [] { procedureActivityAct }));
      }
  ...
  protected static Constraint VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHPOCProcedureActivityActEntryRelationshipIndication(ProcedureActivityAct procedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_ACT);
      try
      {
        VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HPOCProcedureActivityActEntryRelationshipIndication"),
             new Object [] { procedureActivityAct }));
      }
  ...
  protected static Constraint VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHPOCProcedureActivityActEntryRelationshipMedication(ProcedureActivityAct procedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_ACT);
      try
      {
        VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HPOCProcedureActivityActEntryRelationshipMedication"),
             new Object [] { procedureActivityAct }));
      }
  ...
  protected static Constraint VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHPOCProcedureActivityActEntryRelationshipProcedure(ProcedureActivityAct procedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_ACT);
      try
      {
        VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_ACT_ENTRY_RELATIONSHIP_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(procedureActivityAct))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HPOCProcedureActivityActEntryRelationshipProcedure"),
             new Object [] { procedureActivityAct }));
      }
