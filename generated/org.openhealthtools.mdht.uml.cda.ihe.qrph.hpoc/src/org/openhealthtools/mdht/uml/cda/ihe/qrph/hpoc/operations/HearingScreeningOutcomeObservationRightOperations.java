...
public class HearingScreeningOutcomeObservationRightOperations extends ClinicalStatementOperations
{
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightTemplateId(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightTemplateId"),
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightClassCode(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightClassCode"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightMoodCode(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightMoodCode"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightNegationInd(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightNegationInd"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightId(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightId"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightCodeP(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightCodeP"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
...
"value.code = '73744-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightCode(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightCode"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightText(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightText"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
...
"value.code = 'aborted' or value.code = 'active' or value.code = 'cancelled' or value.code = 'completed' or value.code = 'held' or value.code = 'suspended')";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightStatusCode(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightStatusCode"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightStatusCodeP(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightStatusCodeP"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightEffectiveTime(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightEffectiveTime"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightValue(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightValue"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightMethodCodeP(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightMethodCodeP"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA10387-1' or value.code = 'LA10388-9' or value.code = 'LA10389-7' or value.code = 'LA10390-5' or value.code = 'LA10391-3' or value.code = 'LA12406-7')))";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightMethodCode(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightMethodCode"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightTargetSiteCodeP(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightTargetSiteCodeP"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '89644007' or value.code = '25577004')))";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightTargetSiteCode(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightTargetSiteCode"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightEntryRelationship(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightEntryRelationship"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationRightAuthor(HearingScreeningOutcomeObservationRight hearingScreeningOutcomeObservationRight, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_RIGHT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationRight))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationRightAuthor"),
             new Object [] { hearingScreeningOutcomeObservationRight }));
      }
