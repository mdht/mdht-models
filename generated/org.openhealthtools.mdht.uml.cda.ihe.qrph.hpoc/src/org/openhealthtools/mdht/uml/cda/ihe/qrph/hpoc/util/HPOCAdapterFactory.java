...
public class HPOCAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected HPOCSwitch<Adapter> modelSwitch =
    new HPOCSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseConsol_ProcedureActivityAct(org.openhealthtools.mdht.uml.cda.consol.ProcedureActivityAct object)
      {
        return createConsol_ProcedureActivityActAdapter();
      }
      @Override
   ...
   * @generated
   */
  public Adapter createConsol_ProcedureActivityActAdapter()
  {
    return null;
  }
