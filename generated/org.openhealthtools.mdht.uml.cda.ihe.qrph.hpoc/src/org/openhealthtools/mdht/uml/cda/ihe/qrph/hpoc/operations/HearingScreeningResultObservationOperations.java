 ...
 * @generated
 */
public class HearingScreeningResultObservationOperations extends ResultObservationOperations
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public static  boolean validateResultObservationCodeP(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationCodeP"),
  ...
  protected static Constraint VALIDATE_RESULT_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateResultObservationValueP(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RESULT_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULT_OBSERVATION);
      try
      {
        VALIDATE_RESULT_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RESULT_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationValueP"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  protected static Constraint VALIDATE_RESULT_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateResultObservationMethodCodeP(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RESULT_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULT_OBSERVATION);
      try
      {
        VALIDATE_RESULT_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RESULT_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationMethodCodeP"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  protected static Constraint VALIDATE_RESULT_OBSERVATION_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateResultObservationTargetSiteCodeP(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RESULT_OBSERVATION_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULT_OBSERVATION);
      try
      {
        VALIDATE_RESULT_OBSERVATION_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RESULT_OBSERVATION_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationTargetSiteCodeP"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_ENTRY_RELATIONSHIP_REASON_NOT_SCREENED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningResultObservationEntryRelationshipReasonNotScreened(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_ENTRY_RELATIONSHIP_REASON_NOT_SCREENED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULT_OBSERVATION);
      try
      {
        VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_ENTRY_RELATIONSHIP_REASON_NOT_SCREENED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_ENTRY_RELATIONSHIP_REASON_NOT_SCREENED__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_ENTRY_RELATIONSHIP_REASON_NOT_SCREENED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningResultObservationEntryRelationshipReasonNotScreened"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningResultObservationAuthor(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULT_OBSERVATION);
      try
      {
        VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningResultObservationAuthor"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningResultObservationPerformer(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_RESULT_OBSERVATION);
      try
      {
        VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_RESULT_OBSERVATION_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningResultObservationPerformer"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  public static  boolean validateResultObservationTemplateId(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationTemplateId"),
             new Object [] { hearingScreeningResultObservation }));
      }
...
"value.code = '417491009' and value.codeSystem = '2.16.840.1.113883.6.96')";
  ...
  public static  boolean validateResultObservationCode(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationCode"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  public static  boolean validateResultObservationText(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationText"),
             new Object [] { hearingScreeningResultObservation }));
      }
  ...
  public static  boolean validateResultObservationEffectiveTime(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationEffectiveTime"),
             new Object [] { hearingScreeningResultObservation }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '164059009' or value.code = '183924009' or value.code = '103709008')))";
  ...
  public static  boolean validateResultObservationValue(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationValue"),
             new Object [] { hearingScreeningResultObservation }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA10387-1' or value.code = 'LA10388-9' or value.code = 'LA10389-7' or value.code = 'LA10390-5' or value.code = 'LA10391-3' or value.code = 'LA12406-7')))";
  ...
  public static  boolean validateResultObservationMethodCode(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationMethodCode"),
             new Object [] { hearingScreeningResultObservation }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '89644007' or value.code = '25577004')))";
  ...
  public static  boolean validateResultObservationTargetSiteCode(HearingScreeningResultObservation hearingScreeningResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningResultObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("ResultObservationTargetSiteCode"),
             new Object [] { hearingScreeningResultObservation }));
      }
