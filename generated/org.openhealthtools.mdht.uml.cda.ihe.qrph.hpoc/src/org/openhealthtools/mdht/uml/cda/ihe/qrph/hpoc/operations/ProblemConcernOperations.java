 ...
 * @generated
 */
public class ProblemConcernOperations
{
  /**
  ...
  public static  boolean validateProblemConcernText(ProblemConcern problemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.PROBLEM_CONCERN);
			try {
				VALIDATE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(problemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProblemConcernProblemConcernText"),
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateProblemConcernActTemplateId(ProblemConcern problemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROBLEM_CONCERN_ACT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(problemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProblemConcernProblemConcernActTemplateId"),
						 new Object [] { problemConcern }));
			}
  ...
  public static  boolean validateProblemConcernActEffectiveTime(ProblemConcern problemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROBLEM_CONCERN_ACT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(problemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProblemConcernProblemConcernActEffectiveTime"),
						 new Object [] { problemConcern }));
			}
