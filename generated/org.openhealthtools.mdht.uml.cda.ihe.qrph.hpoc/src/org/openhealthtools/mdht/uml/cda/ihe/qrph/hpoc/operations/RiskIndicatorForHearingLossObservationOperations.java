...
public class RiskIndicatorForHearingLossObservationOperations extends ClinicalStatementOperations
{
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationTemplateId(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationTemplateId"),
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationClassCode(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationClassCode"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationMoodCode(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationMoodCode"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationCode(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationCode"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationText(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationText"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
...
"value.code = 'completed')";
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationStatusCode(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationStatusCode"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationStatusCodeP(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationStatusCodeP"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationValue(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationValue"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationId(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationId"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
  ...
  protected static Constraint VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateRiskIndicatorForHearingLossObservationEffectiveTime(RiskIndicatorForHearingLossObservation riskIndicatorForHearingLossObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION);
      try
      {
        VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_RISK_INDICATOR_FOR_HEARING_LOSS_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(riskIndicatorForHearingLossObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HPOCPlugin.INSTANCE.getString("RiskIndicatorForHearingLossObservationEffectiveTime"),
             new Object [] { riskIndicatorForHearingLossObservation }));
      }
