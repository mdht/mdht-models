 ...
 * @generated
 */
public class HearingPlanOfCareProcedureActivityActOperations
{
  /**
  ...
  public static  boolean validateHearingPlanOfCareProcedureActivityActText(HearingPlanOfCareProcedureActivityAct hearingPlanOfCareProcedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROCEDURE_ACTIVITY_ACT);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProcedureActivityAct)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProcedureActivityActHearingPlanOfCareProcedureActivityActText"),
  ...
  public static  boolean validateProcedureActivityActTemplateId(HearingPlanOfCareProcedureActivityAct hearingPlanOfCareProcedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProcedureActivityAct)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProcedureActivityActProcedureActivityActTemplateId"),
						 new Object [] { hearingPlanOfCareProcedureActivityAct }));
			}
  ...
  public static  boolean validateProcedureActivityActId(HearingPlanOfCareProcedureActivityAct hearingPlanOfCareProcedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProcedureActivityAct)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProcedureActivityActProcedureActivityActId"),
						 new Object [] { hearingPlanOfCareProcedureActivityAct }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_PROCEDURE_ACTIVITY_ACT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateProcedureActivityActCode(HearingPlanOfCareProcedureActivityAct hearingPlanOfCareProcedureActivityAct, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROCEDURE_ACTIVITY_ACT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProcedureActivityAct)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProcedureActivityActProcedureActivityActCode"),
						 new Object [] { hearingPlanOfCareProcedureActivityAct }));
			}
