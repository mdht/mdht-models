 ...
 * @generated
 */
public class HearingPlanOfCareInstructionsOperations extends InstructionsOperations
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_INSTRUCTIONS_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareInstructionsEffectiveTime(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_INSTRUCTIONS_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_INSTRUCTIONS);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_INSTRUCTIONS_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_INSTRUCTIONS_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_INSTRUCTIONS_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareInstructionsEffectiveTime"),
  ...
  public static  boolean validateInstructionsStatusCodeP(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("InstructionsStatusCodeP"),
             new Object [] { hearingPlanOfCareInstructions }));
      }
  ...
  public static  boolean validateInstructionsTemplateId(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("InstructionsTemplateId"),
             new Object [] { hearingPlanOfCareInstructions }));
      }
  ...
  public static  boolean validateInstructionsCodeP(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("InstructionsCodeP"),
             new Object [] { hearingPlanOfCareInstructions }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = 'IHE-TSC-7.3.1.1.2.5.3.001' or value.code = 'IHE-TSC-7.3.1.1.2.5.3.002' or value.code = 'IHE-TSC-7.3.1.1.2.5.3.003' or value.code = 'IHE-TSC-7.3.1.1.2.5.3.004'))";
  ...
  public static  boolean validateInstructionsCode(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("InstructionsCode"),
             new Object [] { hearingPlanOfCareInstructions }));
      }
  ...
  public static  boolean validateInstructionsText(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("InstructionsText"),
             new Object [] { hearingPlanOfCareInstructions }));
      }
...
"value.code = 'completed')";
  ...
  public static  boolean validateInstructionsStatusCode(HearingPlanOfCareInstructions hearingPlanOfCareInstructions, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareInstructions))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("InstructionsStatusCode"),
             new Object [] { hearingPlanOfCareInstructions }));
      }
