...
public class HearingScreeningOutcomeObservationLeftOperations extends ClinicalStatementOperations
{
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftTemplateId(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftTemplateId"),
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftClassCode(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftClassCode"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftMoodCode(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftMoodCode"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftNegationInd(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_NEGATION_IND__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftNegationInd"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftId(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftId"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftCodeP(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftCodeP"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
...
"value.code = '73741-1' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftCode(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftCode"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftText(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftText"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
...
"value.code = 'aborted' or value.code = 'active' or value.code = 'cancelled' or value.code = 'completed' or value.code = 'held' or value.code = 'suspended')";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftStatusCode(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftStatusCode"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftEffectiveTime(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftEffectiveTime"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '164059009' or value.code = '183924009' or value.code = '262008008')))";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftValue(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftValue"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftValueP(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftValueP"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftMethodCodeP(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftMethodCodeP"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA10387-1' or value.code = 'LA10388-9' or value.code = 'LA10389-7' or value.code = 'LA10390-5' or value.code = 'LA10391-3' or value.code = 'LA12406-7')))";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftMethodCode(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_METHOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftMethodCode"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftTargetSiteCodeP(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftTargetSiteCodeP"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = '89644007' or value.code = '25577004')))";
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftTargetSiteCode(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_TARGET_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftTargetSiteCode"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftEntryRelationship(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_ENTRY_RELATIONSHIP__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftEntryRelationship"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingScreeningOutcomeObservationLeftAuthor(HearingScreeningOutcomeObservationLeft hearingScreeningOutcomeObservationLeft, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT);
      try
      {
        VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_SCREENING_OUTCOME_OBSERVATION_LEFT_AUTHOR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingScreeningOutcomeObservationLeft))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingScreeningOutcomeObservationLeftAuthor"),
             new Object [] { hearingScreeningOutcomeObservationLeft }));
      }
