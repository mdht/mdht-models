...
public class HearingPlanOfCareDocumentOperations extends HearingPlanOfCareHeaderOperations
{
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_ROOT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentTypeIdRoot(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_ROOT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_ROOT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_ROOT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_ROOT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentTypeIdRoot"),
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_EXTENSION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentTypeIdExtension(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_EXTENSION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_EXTENSION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_EXTENSION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID_EXTENSION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentTypeIdExtension"),
             new Object [] { hearingPlanOfCareDocument }));
      }
...
"   xor (not self.setId.oclIsUndefined() and not self.versionNumber.oclIsUndefined())";
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID_AND_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentSetIdAndVersionNumber(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID_AND_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID_AND_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID_AND_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID_AND_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentSetIdAndVersionNumber"),
             new Object [] { hearingPlanOfCareDocument }));
      }
...
"value.code = 'US'))";
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentRealmCode(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentRealmCode"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentRealmCodeP(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_REALM_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentRealmCodeP"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentTypeId(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TYPE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentTypeId"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentId(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentId"),
             new Object [] { hearingPlanOfCareDocument }));
      }
...
"value.code = '34817-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentCode(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentCode"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentTitle(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentTitle"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentEffectiveTime(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentEffectiveTime"),
             new Object [] { hearingPlanOfCareDocument }));
      }
...
"value.codeSystem = '2.16.840.1.113883.5.25' and (value.code = 'N' or value.code = 'R' or value.code = 'V'))";
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CONFIDENTIALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentConfidentialityCode(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CONFIDENTIALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CONFIDENTIALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CONFIDENTIALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_CONFIDENTIALITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentConfidentialityCode"),
             new Object [] { hearingPlanOfCareDocument }));
      }
...
"not value.code.oclIsUndefined())";
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_LANGUAGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentLanguageCode(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_LANGUAGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_LANGUAGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_LANGUAGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_LANGUAGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentLanguageCode"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentSetId(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_SET_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentSetId"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentVersionNumber(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_VERSION_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentVersionNumber"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentHearingPlanOfCareSection(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_PLAN_OF_CARE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentHearingPlanOfCareSection"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_SCREENING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentHearingScreeningSection(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_SCREENING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_SCREENING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_SCREENING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_HEARING_SCREENING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentHearingScreeningSection"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentRiskIndicatorsForHearingLossSection(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentRiskIndicatorsForHearingLossSection"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROBLEMS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentProblemsSection(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROBLEMS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROBLEMS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROBLEMS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROBLEMS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentProblemsSection"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROCEDURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareDocumentProcedureSection(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROCEDURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_DOCUMENT);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROCEDURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROCEDURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_DOCUMENT_PROCEDURE_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.WARNING,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareDocumentProcedureSection"),
             new Object [] { hearingPlanOfCareDocument }));
      }
  ...
  public static  HearingPlanOfCareSection getHearingPlanOfCareSection(HearingPlanOfCareDocument hearingPlanOfCareDocument)
  {
    ...
    OCL.Query query = EOCL_ENV.createQuery(GET_HEARING_PLAN_OF_CARE_SECTION__EOCL_QRY);
  ...
  public static  HearingScreeningSection getHearingScreeningSection(HearingPlanOfCareDocument hearingPlanOfCareDocument)
  {
    ...
    OCL.Query query = EOCL_ENV.createQuery(GET_HEARING_SCREENING_SECTION__EOCL_QRY);
  ...
  public static  ProblemsSection getProblemsSection(HearingPlanOfCareDocument hearingPlanOfCareDocument)
  {
    ...
    OCL.Query query = EOCL_ENV.createQuery(GET_PROBLEMS_SECTION__EOCL_QRY);
  ...
  public static  ProcedureSection getProcedureSection(HearingPlanOfCareDocument hearingPlanOfCareDocument)
  {
    ...
    OCL.Query query = EOCL_ENV.createQuery(GET_PROCEDURE_SECTION__EOCL_QRY);
  ...
  public static  boolean validateHearingPlanOfCareHeaderTemplateId(HearingPlanOfCareDocument hearingPlanOfCareDocument, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_HEADER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareDocument))
    {
      if (diagnostics != null)
      {
        diagnostics.add
