...
public class RiskIndicatorsForHearingLossSectionOperations extends SectionOperations
{
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateRiskIndicatorsForHearingLossSectionTemplateId(RiskIndicatorsForHearingLossSection riskIndicatorsForHearingLossSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.RISK_INDICATORS_FOR_HEARING_LOSS_SECTION);
			try {
				VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(riskIndicatorsForHearingLossSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("RiskIndicatorsForHearingLossSectionRiskIndicatorsForHearingLossSectionTemplateId"),
...
"value.code = '58232-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateRiskIndicatorsForHearingLossSectionCode(RiskIndicatorsForHearingLossSection riskIndicatorsForHearingLossSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.RISK_INDICATORS_FOR_HEARING_LOSS_SECTION);
			try {
				VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(riskIndicatorsForHearingLossSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("RiskIndicatorsForHearingLossSectionRiskIndicatorsForHearingLossSectionCode"),
						 new Object [] { riskIndicatorsForHearingLossSection }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateRiskIndicatorsForHearingLossSectionCodeP(RiskIndicatorsForHearingLossSection riskIndicatorsForHearingLossSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.RISK_INDICATORS_FOR_HEARING_LOSS_SECTION);
			try {
				VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(riskIndicatorsForHearingLossSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("RiskIndicatorsForHearingLossSectionRiskIndicatorsForHearingLossSectionCodeP"),
						 new Object [] { riskIndicatorsForHearingLossSection }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateRiskIndicatorsForHearingLossSectionTitle(RiskIndicatorsForHearingLossSection riskIndicatorsForHearingLossSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.RISK_INDICATORS_FOR_HEARING_LOSS_SECTION);
			try {
				VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(riskIndicatorsForHearingLossSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("RiskIndicatorsForHearingLossSectionRiskIndicatorsForHearingLossSectionTitle"),
						 new Object [] { riskIndicatorsForHearingLossSection }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateRiskIndicatorsForHearingLossSectionText(RiskIndicatorsForHearingLossSection riskIndicatorsForHearingLossSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.RISK_INDICATORS_FOR_HEARING_LOSS_SECTION);
			try {
				VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(riskIndicatorsForHearingLossSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("RiskIndicatorsForHearingLossSectionRiskIndicatorsForHearingLossSectionText"),
						 new Object [] { riskIndicatorsForHearingLossSection }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateRiskIndicatorsForHearingLossSectionEntry(RiskIndicatorsForHearingLossSection riskIndicatorsForHearingLossSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.RISK_INDICATORS_FOR_HEARING_LOSS_SECTION);
			try {
				VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RISK_INDICATORS_FOR_HEARING_LOSS_SECTION_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(riskIndicatorsForHearingLossSection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 HPOCPlugin.INSTANCE.getString("RiskIndicatorsForHearingLossSectionRiskIndicatorsForHearingLossSectionEntry"),
						 new Object [] { riskIndicatorsForHearingLossSection }));
			}
