 ...
 * @generated
 */
public class HearingScreeningOrganizerOperations
{
  /**
  ...
  public static  boolean validateResultOrganizerCodeP(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RESULT_ORGANIZER_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerResultOrganizerCodeP"),
  ...
  public static  boolean validateHearingScreeningOrganizerComponentLeftEar(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_LEFT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_ORGANIZER);
			try {
				VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_LEFT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_LEFT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_LEFT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerHearingScreeningOrganizerComponentLeftEar"),
						 new Object [] { hearingScreeningOrganizer }));
			}
  ...
  public static  boolean validateHearingScreeningOrganizerComponentRightEar(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RIGHT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_ORGANIZER);
			try {
				VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RIGHT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RIGHT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RIGHT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerHearingScreeningOrganizerComponentRightEar"),
						 new Object [] { hearingScreeningOrganizer }));
			}
  ...
  public static  boolean validateHearingScreeningOrganizerComponentResultsOrganizer(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RESULTS_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_SCREENING_ORGANIZER);
			try {
				VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RESULTS_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RESULTS_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RESULTS_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerHearingScreeningOrganizerComponentResultsOrganizer"),
						 new Object [] { hearingScreeningOrganizer }));
			}
  ...
  public static  boolean validateResultOrganizerTemplateId(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RESULT_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerResultOrganizerTemplateId"),
						 new Object [] { hearingScreeningOrganizer }));
			}
  ...
  public static  boolean validateResultOrganizerClassCode(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RESULT_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerResultOrganizerClassCode"),
						 new Object [] { hearingScreeningOrganizer }));
			}
...
"value.code = '54111-0' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_LEFT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RIGHT_EAR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_SCREENING_ORGANIZER_COMPONENT_RESULTS_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateResultOrganizerCode(HearingScreeningOrganizer hearingScreeningOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_RESULT_ORGANIZER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingScreeningOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingScreeningOrganizerResultOrganizerCode"),
						 new Object [] { hearingScreeningOrganizer }));
			}
