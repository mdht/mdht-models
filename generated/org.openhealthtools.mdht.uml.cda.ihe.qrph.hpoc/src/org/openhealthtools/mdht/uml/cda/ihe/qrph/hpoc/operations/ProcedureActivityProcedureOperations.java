...
public class ProcedureActivityProcedureOperations
{
  ...
  public static  boolean validateHPOCProcedureActivityProcedureText(ProcedureActivityProcedure procedureActivityProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HPOC_PROCEDURE_ACTIVITY_PROCEDURE_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE);
			try {
				VALIDATE_HPOC_PROCEDURE_ACTIVITY_PROCEDURE_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HPOC_PROCEDURE_ACTIVITY_PROCEDURE_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HPOC_PROCEDURE_ACTIVITY_PROCEDURE_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(procedureActivityProcedure)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProcedureActivityProcedureHPOCProcedureActivityProcedureText"),
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HPOC_PROCEDURE_ACTIVITY_PROCEDURE_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProcedureActivityProcedureProcedureActivityProcedureTemplateId"),
						 new Object [] { procedureActivityProcedure }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProcedureActivityProcedureProcedureActivityProcedureId"),
						 new Object [] { procedureActivityProcedure }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("ProcedureActivityProcedureProcedureActivityProcedureCode"),
						 new Object [] { procedureActivityProcedure }));
			}
