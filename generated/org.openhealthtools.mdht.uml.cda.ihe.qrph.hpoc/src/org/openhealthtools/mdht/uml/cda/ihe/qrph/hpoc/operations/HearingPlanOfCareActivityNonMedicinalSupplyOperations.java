 ...
 * @generated
 */
public class HearingPlanOfCareActivityNonMedicinalSupplyOperations
{
  /**
  ...
  public static  boolean validateHearingPlanOfCareActivityNonMedicinalSupplyCode(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyHearingPlanOfCareActivityNonMedicinalSupplyCode"),
  ...
  public static  boolean validateHearingPlanOfCareActivityNonMedicinalSupplyCodeP(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyHearingPlanOfCareActivityNonMedicinalSupplyCodeP"),
						 new Object [] { hearingPlanOfCareActivityNonMedicinalSupply }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityNonMedicinalSupplyText(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyHearingPlanOfCareActivityNonMedicinalSupplyText"),
						 new Object [] { hearingPlanOfCareActivityNonMedicinalSupply }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityNonMedicinalSupplyEffectiveTime(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyHearingPlanOfCareActivityNonMedicinalSupplyEffectiveTime"),
						 new Object [] { hearingPlanOfCareActivityNonMedicinalSupply }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityNonMedicinalSupplyQuantity(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyHearingPlanOfCareActivityNonMedicinalSupplyQuantity"),
						 new Object [] { hearingPlanOfCareActivityNonMedicinalSupply }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityNonMedicinalSupplyParticipant(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyHearingPlanOfCareActivityNonMedicinalSupplyParticipant"),
						 new Object [] { hearingPlanOfCareActivityNonMedicinalSupply }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = 'IHE-TSC-7.3.1.1.2.5.9.001' or value.code = 'IHE-TSC-7.3.1.1.2.5.9.002' or value.code = 'IHE-TSC-7.3.1.1.2.5.9.003' or value.code = 'IHE-TSC-7.3.1.1.2.5.9.004'))";
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validatePlanOfCareActivitySupplyTemplateId(HearingPlanOfCareActivityNonMedicinalSupply hearingPlanOfCareActivityNonMedicinalSupply, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_PLAN_OF_CARE_ACTIVITY_SUPPLY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_NON_MEDICINAL_SUPPLY);
			try {
				VALIDATE_PLAN_OF_CARE_ACTIVITY_SUPPLY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PLAN_OF_CARE_ACTIVITY_SUPPLY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_SUPPLY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityNonMedicinalSupply)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityNonMedicinalSupplyPlanOfCareActivitySupplyTemplateId"),
						 new Object [] { hearingPlanOfCareActivityNonMedicinalSupply }));
			}
