...
public class HearingPlanOfCareProblemsSubSectionOperations extends SectionOperations
{
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareProblemsSubSectionTemplateId(HearingPlanOfCareProblemsSubSection hearingPlanOfCareProblemsSubSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareProblemsSubSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemsSubSectionTemplateId"),
...
"value.code = '11450-4-HPOC' and value.codeSystem = '2.16.840.1.113883.6.1')";
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareProblemsSubSectionCode(HearingPlanOfCareProblemsSubSection hearingPlanOfCareProblemsSubSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareProblemsSubSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemsSubSectionCode"),
             new Object [] { hearingPlanOfCareProblemsSubSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareProblemsSubSectionCodeP(HearingPlanOfCareProblemsSubSection hearingPlanOfCareProblemsSubSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareProblemsSubSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemsSubSectionCodeP"),
             new Object [] { hearingPlanOfCareProblemsSubSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareProblemsSubSectionText(HearingPlanOfCareProblemsSubSection hearingPlanOfCareProblemsSubSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareProblemsSubSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemsSubSectionText"),
             new Object [] { hearingPlanOfCareProblemsSubSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareProblemsSubSectionTitle(HearingPlanOfCareProblemsSubSection hearingPlanOfCareProblemsSubSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareProblemsSubSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemsSubSectionTitle"),
             new Object [] { hearingPlanOfCareProblemsSubSection }));
      }
  ...
  protected static Constraint VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_ENTRY_HPOC_PROBLEM_CONCERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateHearingPlanOfCareProblemsSubSectionEntryHpocProblemConcern(HearingPlanOfCareProblemsSubSection hearingPlanOfCareProblemsSubSection, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_ENTRY_HPOC_PROBLEM_CONCERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION);
      try
      {
        VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_ENTRY_HPOC_PROBLEM_CONCERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_ENTRY_HPOC_PROBLEM_CONCERN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEMS_SUB_SECTION_ENTRY_HPOC_PROBLEM_CONCERN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hearingPlanOfCareProblemsSubSection))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemsSubSectionEntryHpocProblemConcern"),
             new Object [] { hearingPlanOfCareProblemsSubSection }));
      }
