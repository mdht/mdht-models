 ...
 * @generated
 */
public class HearingPlanOfCareActivityObservationOperations {
	/**
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateHearingPlanOfCareActivityObservationEffectiveTimeLowHigh(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME_LOW_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationHearingPlanOfCareActivityObservationEffectiveTimeLowHigh"),
  ...
  public static  boolean validateHearingPlanOfCareActivityObservationCodeP(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationHearingPlanOfCareActivityObservationCodeP"),
						 new Object [] { hearingPlanOfCareActivityObservation }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityObservationCode(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationHearingPlanOfCareActivityObservationCode"),
						 new Object [] { hearingPlanOfCareActivityObservation }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityObservationEffectiveTime(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationHearingPlanOfCareActivityObservationEffectiveTime"),
						 new Object [] { hearingPlanOfCareActivityObservation }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityObservationStatusCode(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationHearingPlanOfCareActivityObservationStatusCode"),
						 new Object [] { hearingPlanOfCareActivityObservation }));
			}
  ...
  public static  boolean validateHearingPlanOfCareActivityObservationText(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationHearingPlanOfCareActivityObservationText"),
						 new Object [] { hearingPlanOfCareActivityObservation }));
			}
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
...
"value.codeSystem = '2.16.840.1.113883.6.96' and (value.code = 'IHE-TSC-7.3.1.1.2.5.6.001' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.002' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.003' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.004' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.005' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.006' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.007' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.008' or value.code = 'IHE-TSC-7.3.1.1.2.5.6.009'))";
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
   ...
   * <!-- end-user-doc -->
	...
	protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validatePlanOfCareActivityObservationTemplateId(HearingPlanOfCareActivityObservation hearingPlanOfCareActivityObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_ACTIVITY_OBSERVATION);
			try {
				VALIDATE_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PLAN_OF_CARE_ACTIVITY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareActivityObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareActivityObservationPlanOfCareActivityObservationTemplateId"),
						 new Object [] { hearingPlanOfCareActivityObservation }));
			}
