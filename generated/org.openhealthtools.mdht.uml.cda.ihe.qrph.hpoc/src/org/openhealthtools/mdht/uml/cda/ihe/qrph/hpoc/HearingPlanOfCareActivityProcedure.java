 ...
 * @generated
 */
public interface HearingPlanOfCareActivityProcedure extends EObject
{
  /**
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'1.3.6.1.4.1.19376.1.7.3.1.1.26.2.4.5\')'"
	 * @generated
	 */
