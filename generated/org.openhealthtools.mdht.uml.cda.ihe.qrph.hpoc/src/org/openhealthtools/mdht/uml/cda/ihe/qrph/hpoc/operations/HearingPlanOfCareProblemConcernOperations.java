 ...
 * @generated
 */
public class HearingPlanOfCareProblemConcernOperations
{
  /**
  ...
  public static  boolean validateHearingPlanOfCareProblemConcernText(HearingPlanOfCareProblemConcern hearingPlanOfCareProblemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_HEARING_PLAN_OF_CARE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(HPOCPackage.Literals.HEARING_PLAN_OF_CARE_PROBLEM_CONCERN);
			try {
				VALIDATE_HEARING_PLAN_OF_CARE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_HEARING_PLAN_OF_CARE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProblemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemConcernHearingPlanOfCareProblemConcernText"),
  ...
  public static  boolean validateProblemConcernActTemplateId(HearingPlanOfCareProblemConcern hearingPlanOfCareProblemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROBLEM_CONCERN_ACT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProblemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemConcernProblemConcernActTemplateId"),
						 new Object [] { hearingPlanOfCareProblemConcern }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_HEARING_PLAN_OF_CARE_PROBLEM_CONCERN_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateProblemConcernActId(HearingPlanOfCareProblemConcern hearingPlanOfCareProblemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROBLEM_CONCERN_ACT_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProblemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemConcernProblemConcernActId"),
						 new Object [] { hearingPlanOfCareProblemConcern }));
			}
  ...
  public static  boolean validateProblemConcernActEffectiveTime(HearingPlanOfCareProblemConcern hearingPlanOfCareProblemConcern, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PROBLEM_CONCERN_ACT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(hearingPlanOfCareProblemConcern)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 HPOCPlugin.INSTANCE.getString("HearingPlanOfCareProblemConcernProblemConcernActEffectiveTime"),
						 new Object [] { hearingPlanOfCareProblemConcern }));
			}
