...
public class EncountersSectionOperations
				...
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("Mu2consolEncountersSectionEncounterActivities"),
	...
	public static EList<EncounterActivities> getMu2consolEncounterActivitiess(
		...
		if (GET_MU2CONSOL_ENCOUNTER_ACTIVITIESS__EOCL_QRY == null) {
			...
			try {
				GET_MU2CONSOL_ENCOUNTER_ACTIVITIESS__EOCL_QRY = helper
						.createQuery(GET_MU2CONSOL_ENCOUNTER_ACTIVITIESS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		OCL.Query query = EOCL_ENV
				.createQuery(GET_MU2CONSOL_ENCOUNTER_ACTIVITIESS__EOCL_QRY);
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateEncountersSectionEntriesOptionalTemplateId(EncountersSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Encounters Section Entries Optional Template Id</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateEncountersSectionEntriesOptionalTemplateId(EncountersSection,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateEncountersSectionEntriesOptionalTemplateId(
		...
		if (VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.ENCOUNTERS_SECTION);
			try {
				VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_ENCOUNTERS_SECTION_ENTRIES_OPTIONAL_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(encountersSection)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
