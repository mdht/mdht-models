...
public class AssessmentSectionOperations
	 ...
	 * {@link #validateMu2consolAssessmentSectionProblemObservation(AssessmentSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Assessment Section Problem Observation</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolAssessmentSectionProblemObservation(AssessmentSection,
	...
	public static boolean validateMu2consolAssessmentSectionProblemObservation(
		...
		if (VALIDATE_MU2CONSOL_ASSESSMENT_SECTION_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_ASSESSMENT_SECTION_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_ASSESSMENT_SECTION_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_ASSESSMENT_SECTION_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(assessmentSection)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("Mu2consolAssessmentSectionProblemObservation"),
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #getProblemObservation(AssessmentSection)
	...
	public static ProblemObservation getProblemObservation(
		...
		if (GET_PROBLEM_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
					Mu2consolPackage.Literals.ASSESSMENT_SECTION,
					Mu2consolPackage.Literals.ASSESSMENT_SECTION
	 ...
	 * The cached OCL invariant for the '
	 * {@link #validateAssessmentSectionTemplateId(AssessmentSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Assessment Section Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateAssessmentSectionTemplateId(AssessmentSection,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	...
	public static boolean validateAssessmentSectionTemplateId(
		...
		if (VALIDATE_ASSESSMENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.ASSESSMENT_SECTION);
			try {
				VALIDATE_ASSESSMENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_ASSESSMENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_ASSESSMENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(assessmentSection)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								Diagnostic.ERROR,
								Mu2consolValidator.DIAGNOSTIC_SOURCE,
								Mu2consolValidator.ASSESSMENT_SECTION__ASSESSMENT_SECTION_TEMPLATE_ID,
								org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE
										.getString(
												"_UI_GenericInvariant_diagnostic",
												new Object[] {
														"AssessmentSectionTemplateId",
