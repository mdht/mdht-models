...
public class VDTAmbulatoryPatientInfoOperations extends
	 ...
	 * {@link #validateVDTAmbulatoryPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection(VDTAmbulatoryPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Ambulatory Patient Info Cannot Have Chief Complaint And Reason For Visit With Chief Complaint Section Or Reason Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTAmbulatoryPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection(VDTAmbulatoryPatientInfo,
	...
	public static boolean validateVDTAmbulatoryPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection(
		...
		if (VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CANNOT_HAVE_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_WITH_CHIEF_COMPLAINT_SECTION_OR_REASON_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CANNOT_HAVE_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_WITH_CHIEF_COMPLAINT_SECTION_OR_REASON_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CANNOT_HAVE_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_WITH_CHIEF_COMPLAINT_SECTION_OR_REASON_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				...
				.check(vdtAmbulatoryPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTAmbulatoryPatientInfoCannotHaveChiefComplaintAndReasonForVisitWithChiefComplaintSectionOrReasonSection"),
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateVDTAmbulatoryPatientInfoMu2EncounterDiagnosesRequirements(VDTAmbulatoryPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Ambulatory Patient Info Mu2 Encounter Diagnoses Requirements</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTAmbulatoryPatientInfoMu2EncounterDiagnosesRequirements(VDTAmbulatoryPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateVDTAmbulatoryPatientInfoMu2EncounterDiagnosesRequirements(
			VDTAmbulatoryPatientInfo vdtAmbulatoryPatientInfo,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.VDT_AMBULATORY_PATIENT_INFO);
			try {
				VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MU2_ENCOUNTER_DIAGNOSES_REQUIREMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(vdtAmbulatoryPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTAmbulatoryPatientInfoMu2EncounterDiagnosesRequirements"),
								new Object[] { vdtAmbulatoryPatientInfo }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateVDTAmbulatoryPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection(VDTAmbulatoryPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Ambulatory Patient Info Can Have Either Required Or Optional Vital Signs Section</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTAmbulatoryPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection(VDTAmbulatoryPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateVDTAmbulatoryPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection(
			VDTAmbulatoryPatientInfo vdtAmbulatoryPatientInfo,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.VDT_AMBULATORY_PATIENT_INFO);
			try {
				VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_VDT_AMBULATORY_PATIENT_INFO_CAN_HAVE_EITHER_REQUIRED_OR_OPTIONAL_VITAL_SIGNS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(vdtAmbulatoryPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTAmbulatoryPatientInfoCanHaveEitherRequiredOrOptionalVitalSignsSection"),
								new Object[] { vdtAmbulatoryPatientInfo }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateVDTAmbulatoryPatientInfoMedicationListConstraint(VDTAmbulatoryPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate VDT Ambulatory Patient Info Medication List Constraint</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateVDTAmbulatoryPatientInfoMedicationListConstraint(VDTAmbulatoryPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	public static boolean validateVDTAmbulatoryPatientInfoMedicationListConstraint(
			VDTAmbulatoryPatientInfo vdtAmbulatoryPatientInfo,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(Mu2consolPackage.Literals.VDT_AMBULATORY_PATIENT_INFO);
			try {
				VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_VDT_AMBULATORY_PATIENT_INFO_MEDICATION_LIST_CONSTRAINT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(vdtAmbulatoryPatientInfo)) {
			if (diagnostics != null) {
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("VDTAmbulatoryPatientInfoMedicationListConstraint"),
								new Object[] { vdtAmbulatoryPatientInfo }));
			}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateGeneralHeaderConstraintsTemplateId(VDTAmbulatoryPatientInfo, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Template Id</em>}' operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateGeneralHeaderConstraintsTemplateId(VDTAmbulatoryPatientInfo,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	 ...
	 * '2.16.840.1.113883.11.11.11.1.3')
	 * 
	 * @param vdtAmbulatoryPatientInfo
	 *            The receiving '<em><b>VDT Ambulatory Patient Info</b></em>'
	 *            model object.
