...
public class Mu2consolAdapterFactory extends AdapterFactoryImpl {
	...
	protected Mu2consolSwitch<Adapter> modelSwitch = new Mu2consolSwitch<Adapter>() {
		...
		@Override
		public Adapter caseConsol_EncounterActivities(
	 ...
	 * <em>Encounter Activities</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.openhealthtools.mdht.uml.cda.Encounter <em>Encounter</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that
	 * we can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.openhealthtools.mdht.uml.cda.consol.EncounterActivities
	 * <em>Encounter Activities</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
