...
public class ProceduresSectionOperations
	...
	public static EList<ProcedureActivityProcedure> getMu2consolProcedureActivityProcedures(
		...
		if (GET_MU2CONSOL_PROCEDURE_ACTIVITY_PROCEDURES__EOCL_QRY == null) {
			...
			helper.setOperationContext(Mu2consolPackage.Literals.PROCEDURES_SECTION, Mu2consolPackage.Literals.PROCEDURES_SECTION.getEAllOperations().get(74));
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "ProceduresSectionProceduresSectionEntriesOptionalTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(proceduresSection, context) }),
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURES_SECTION_PROCEDURE_ACTIVITY_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->exists(entry : cda::Entry | not entry.procedure.oclIsUndefined() and entry.procedure.oclIsKindOf(mu2consol::ProcedureActivityProcedure))";
	...
	public static  boolean validateProceduresSectionProcedureActivityProcedure(ProceduresSection proceduresSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
