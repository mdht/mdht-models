...
"effectiveTime.isNullFlavorUndefined()) implies (not effectiveTime.oclIsUndefined()))";
   ...
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
...
"not location.oclIsUndefined() and location.oclIsKindOf(rim::Participation)))";
   ...
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_LOCATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY);
      try
      {
...
" self.getAllSections()->one(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(consol::ChiefComplaintAndReasonForVisitSection))";
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryHospitalAdmissionDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Hospital Admission Diagnosis Entry</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryHospitalAdmissionDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryHospitalAdmissionDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Hospital Admission Diagnosis Entry</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryHospitalAdmissionDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY);
      try
      {
        OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
        VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    Object oclResult = VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(vdtInpatientSummary);		
    if (oclResult != null && oclResult instanceof Collection) {
      Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryHospitalAdmissionDiagnosisEntry"),
             new Object [] { eObject }));
        }
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryPreoperativeDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Preoperative Diagnosis Entry</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryPreoperativeDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryPreoperativeDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Preoperative Diagnosis Entry</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryPreoperativeDiagnosisEntry(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY);
      try
      {
        OCLExpression<EClassifier> oclExpression = helper.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
        VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV.createQuery(oclExpression);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    Object oclResult = VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.evaluate(vdtInpatientSummary);		
    if (oclResult != null && oclResult instanceof Collection) {
      Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryPreoperativeDiagnosisEntry"),
             new Object [] { eObject }));
        }
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryChiefComplaintSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Chief Complaint Section</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryChiefComplaintSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryChiefComplaintSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Chief Complaint Section</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryChiefComplaintSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vdtInpatientSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryChiefComplaintSection"),
             new Object [] { vdtInpatientSummary }));
      }
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Reason For Visit Section</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Reason For Visit Section</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_VDT_INPATIENT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VDT_INPATIENT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vdtInpatientSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryReasonForVisitSection"),
             new Object [] { vdtInpatientSummary }));
      }
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryChiefComplaintAndReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Chief Complaint And Reason For Visit Section</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryChiefComplaintAndReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryChiefComplaintAndReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Chief Complaint And Reason For Visit Section</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryChiefComplaintAndReasonForVisitSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_CHIEF_COMPLAINT_AND_REASON_FOR_VISIT_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vdtInpatientSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryChiefComplaintAndReasonForVisitSection"),
             new Object [] { vdtInpatientSummary }));
      }
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryHospitalDischargeMedicationsSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Hospital Discharge Medications Section</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryHospitalDischargeMedicationsSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryHospitalDischargeMedicationsSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Hospital Discharge Medications Section</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryHospitalDischargeMedicationsSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_DISCHARGE_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_DISCHARGE_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_DISCHARGE_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_DISCHARGE_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vdtInpatientSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryHospitalDischargeMedicationsSection"),
             new Object [] { vdtInpatientSummary }));
      }
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryPreoperativeDiagnosisSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Preoperative Diagnosis Section</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryPreoperativeDiagnosisSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryPreoperativeDiagnosisSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Preoperative Diagnosis Section</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryPreoperativeDiagnosisSection(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_PREOPERATIVE_DIAGNOSIS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vdtInpatientSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryPreoperativeDiagnosisSection"),
             new Object [] { vdtInpatientSummary }));
      }
	...
	/**
   * The cached OCL expression body for the '{@link #validateVDTInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Hospital Admission Medications Section Entries Optional</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
	...
	/**
   * The cached OCL invariant for the '{@link #validateVDTInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate VDT Inpatient Summary Hospital Admission Medications Section Entries Optional</em>}' invariant operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #validateVDTInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
    ...
    if (VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      ...
      try
      {
        VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VDT_INPATIENT_SUMMARY_HOSPITAL_ADMISSION_MEDICATIONS_SECTION_ENTRIES_OPTIONAL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(vdtInpatientSummary))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.INFO,
             ...
             Mu2consolPlugin.INSTANCE.getString("VDTInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional"),
             new Object [] { vdtInpatientSummary }));
      }
   ...
   */
	...
	/**
   * The cached OCL query for the '{@link #getHospitalDischargeMedicationsSection(VDTInpatientSummary) <em>Get Hospital Discharge Medications Section</em>}' query operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #getHospitalDischargeMedicationsSection(VDTInpatientSummary)
   * @generated
   * @ordered
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY, Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY.getEAllOperations().get(334));
      try
      {
    ...
    return (HospitalDischargeMedicationsSection) query.evaluate(vdtInpatientSummary);
  }
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY, Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY.getEAllOperations().get(335));
      try
      {
    ...
    return (PreoperativeDiagnosisSection) query.evaluate(vdtInpatientSummary);
  }

	/**
   * The cached OCL expression body for the '{@link #getHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary) <em>Get Hospital Admission Medications Section Entries Optional</em>}' operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   ...
   */
	...
	/**
   * The cached OCL query for the '{@link #getHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary) <em>Get Hospital Admission Medications Section Entries Optional</em>}' query operation.
   * <!-- begin-user-doc --> <!-- end-user-doc -->
   * @see #getHospitalAdmissionMedicationsSectionEntriesOptional(VDTInpatientSummary)
   * @generated
   * @ordered
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY, Mu2consolPackage.Literals.VDT_INPATIENT_SUMMARY.getEAllOperations().get(336));
      try
      {
    ...
    return (HospitalAdmissionMedicationsSectionEntriesOptional) query.evaluate(vdtInpatientSummary);
  }
