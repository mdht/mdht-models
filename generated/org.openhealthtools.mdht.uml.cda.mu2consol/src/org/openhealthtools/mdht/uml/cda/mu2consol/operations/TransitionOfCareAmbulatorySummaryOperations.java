 ...
 * <ul>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.TransitionOfCareAmbulatorySummary#validateTransitionOfCareAmbulatorySummaryProviderNameAndContactInfo(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Transition Of Care Ambulatory Summary Provider Name And Contact
 * Info</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.TransitionOfCareAmbulatorySummary#validateTransitionOfCareAmbulatorySummaryReasonForReferral(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Transition Of Care Ambulatory Summary Reason For
 * Referral</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.TransitionOfCareAmbulatorySummary#validateTransitionOfCareAmbulatorySummaryEncounterDiagnoses(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Transition Of Care Ambulatory Summary Encounter
 * Diagnoses</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.TransitionOfCareAmbulatorySummary#validateTransitionOfCareAmbulatorySummaryMedicationsSection(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate Transition Of Care Ambulatory Summary Medications
 * Section</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.TransitionOfCareAmbulatorySummary#getMedicationsSection()
...
public class TransitionOfCareAmbulatorySummaryOperations extends SummaryOfCareRecordOperations {
	 ...
	 * <em>Validate Transition Of Care Ambulatory Summary Provider Name And
	 * Contact Info</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 *
	 ...
	 * '{@link #validateTransitionOfCareAmbulatorySummaryProviderNameAndContactInfo(TransitionOfCareAmbulatorySummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Transition Of Care Ambulatory Summary Provider Name And
	 * Contact Info</em>}' invariant operation. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #validateTransitionOfCareAmbulatorySummaryProviderNameAndContactInfo(TransitionOfCareAmbulatorySummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	...
	protected static ThreadLocal<Constraint> VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_PROVIDER_NAME_AND_CONTACT_INFO__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();

	/**
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 *
	 * @param transitionOfCareAmbulatorySummary
	 *            The receiving ' <em><b>Transition Of Care Ambulatory
	 *            Summary</b></em>' model object.
	 * @param diagnostics
	...
	public static boolean validateTransitionOfCareAmbulatorySummaryProviderNameAndContactInfo(
		...
		if (VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_PROVIDER_NAME_AND_CONTACT_INFO__DIAGNOSTIC_CHAIN_MAP__EOCL_INV
				.get() == null) {
	 ...
	 * <em>Validate Transition Of Care Ambulatory Summary Reason For
	 * Referral</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * '{@link #validateTransitionOfCareAmbulatorySummaryReasonForReferral(TransitionOfCareAmbulatorySummary, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Transition Of Care Ambulatory Summary Reason For
	 * Referral</em>}' invariant operation. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #validateTransitionOfCareAmbulatorySummaryReasonForReferral(TransitionOfCareAmbulatorySummary,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	...
	protected static ThreadLocal<Constraint> VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_REASON_FOR_REFERRAL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateTransitionOfCareAmbulatorySummaryReasonForReferral(
		...
		if (VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_REASON_FOR_REFERRAL__DIAGNOSTIC_CHAIN_MAP__EOCL_INV
				.get() == null) {
	 ...
	 * <em>Validate Transition Of Care Ambulatory Summary Encounter
	 * Diagnoses</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	protected static ThreadLocal<Constraint> VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_ENCOUNTER_DIAGNOSES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateTransitionOfCareAmbulatorySummaryEncounterDiagnoses(
		...
		if (VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_ENCOUNTER_DIAGNOSES__DIAGNOSTIC_CHAIN_MAP__EOCL_INV
				.get() == null) {
	...
	protected static ThreadLocal<Constraint> VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateTransitionOfCareAmbulatorySummaryMedicationsSection(
		...
		if (VALIDATE_TRANSITION_OF_CARE_AMBULATORY_SUMMARY_MEDICATIONS_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV
				.get() == null) {
	...
	/**
	 * The cached OCL expression body for the
	 * '{@link #getMedicationsSection(TransitionOfCareAmbulatorySummary) <em>Get
	...
	public static MedicationsSection getMedicationsSection(
		...
		if (GET_MEDICATIONS_SECTION__EOCL_QRY == null) {
			...
			helper.setOperationContext(Mu2consolPackage.Literals.TRANSITION_OF_CARE_AMBULATORY_SUMMARY,
					Mu2consolPackage.Literals.TRANSITION_OF_CARE_AMBULATORY_SUMMARY.getEAllOperations().get(327));
			try {
