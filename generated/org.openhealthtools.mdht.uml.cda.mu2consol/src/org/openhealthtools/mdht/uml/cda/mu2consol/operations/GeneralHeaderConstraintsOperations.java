 ...
 * <ul>
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateMU2CONSOLGeneralHeaderConstraintsCareTeamMembers(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate MU2CONSOL General Header Constraints Care Team Members</em>}</li>
 * <li>
 ...
 * <li>
 * {@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateMU2CONSOLGeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRole(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate MU2CONSOL General Header Constraints General Header Constraints
 * Record Target Patient Role</em>}</li>
 * <li>
...
public class GeneralHeaderConstraintsOperations
	 ...
	 * {@link #validateMU2CONSOLGeneralHeaderConstraintsCareTeamMembers(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate MU2CONSOL General Header Constraints Care Team Members</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMU2CONSOLGeneralHeaderConstraintsCareTeamMembers(GeneralHeaderConstraints,
	...
	public static boolean validateMU2CONSOLGeneralHeaderConstraintsCareTeamMembers(
		...
		if (VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				...
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("MU2CONSOLGeneralHeaderConstraintsCareTeamMembers"),
				...
				for (EObject eObject : oclResultSet) {
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("GeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCodeTermCaseInsensitive"),
									new Object[] { eObject }));
				}
	...
	/**
	 * The cached OCL expression body for the '
	 * {@link #validateMU2CONSOLGeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRole(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate MU2CONSOL General Header Constraints General Header Constraints Record Target Patient Role</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMU2CONSOLGeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRole(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static boolean validateMU2CONSOLGeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRole(
			GeneralHeaderConstraints generalHeaderConstraints,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY == null) {
			...
			try {
				OCLExpression<EClassifier> oclExpression = helper
						.createQuery(VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
				VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = EOCL_ENV
						.createQuery(oclExpression);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
		...
		Object oclResult = VALIDATE_MU2CONSOL_GENERAL_HEADER_CONSTRAINTS_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.evaluate(generalHeaderConstraints);
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
				...
				for (EObject eObject : oclResultSet) {
					diagnostics
							.add(new BasicDiagnostic(
									...
									Mu2consolPlugin.INSTANCE
											.getString("MU2CONSOLGeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRole"),
									new Object[] { eObject }));
				}
