 ...
 * <ul>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsCareTeamMembers(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Care Team Members</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCodeTermCaseInsensitive(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 ...
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#retrieveHospitalAdmissionDiagnosisSection()
 * <em>Retrieve Hospital Admission Diagnosis Section</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Template Id</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTarget(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role Patient
 * Language Communication Language Code</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role Patient
 * Ethnic Group Code</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role Patient
 * Ethnic Group Code P</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role Patient
 * Race Code</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCodeP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role Patient
 * Race Code P</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role Patient
 * Language Communication</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRolePatient(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
 * <em>Validate General Header Constraints Record Target Patient Role
 * Patient</em>}</li>
 * <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.GeneralHeaderConstraints#validateGeneralHeaderConstraintsRecordTargetPatientRole(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
...
public class GeneralHeaderConstraintsOperations
		extends org.openhealthtools.mdht.uml.cda.consol.operations.GeneralHeaderConstraintsOperations {
	...
	protected static ThreadLocal<Constraint> VALIDATE_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<Constraint>();
	...
	public static boolean validateGeneralHeaderConstraintsCareTeamMembers(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		...
		if (!EOCL_ENV.get()
				.createQuery(
						VALIDATE_GENERAL_HEADER_CONSTRAINTS_CARE_TEAM_MEMBERS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get())
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCodeTermCaseInsensitive(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_LANGUAGE_COMMUNICATION_LANGUAGE_CODE_TERM_CASE_INSENSITIVE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			try {
				...
				VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_LANGUAGE_COMMUNICATION_LANGUAGE_CODE_TERM_CASE_INSENSITIVE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
						.set(EOCL_ENV.get().createQuery(oclExpression));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		Object oclResult = VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_LANGUAGE_COMMUNICATION_LANGUAGE_CODE_TERM_CASE_INSENSITIVE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get().evaluate(generalHeaderConstraints);
				...
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCodeTermCaseInsensitive"),
							new Object[] { eObject }));
				}
	...
	public static HospitalAdmissionDiagnosisSection retrieveHospitalAdmissionDiagnosisSection(
		...
		if (RETRIEVE_HOSPITAL_ADMISSION_DIAGNOSIS_SECTION__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(Mu2consolPackage.Literals.GENERAL_HEADER_CONSTRAINTS,
					Mu2consolPackage.Literals.GENERAL_HEADER_CONSTRAINTS.getEAllOperations().get(302));
			try {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(RETRIEVE_HOSPITAL_ADMISSION_DIAGNOSIS_SECTION__EOCL_QRY);
	...
	public static boolean validateGeneralHeaderConstraintsTemplateId(GeneralHeaderConstraints generalHeaderConstraints,
		...
		if (!EOCL_ENV.get()
				.createQuery(VALIDATE_GENERAL_HEADER_CONSTRAINTS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get())
				.check(generalHeaderConstraints)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateGeneralHeaderConstraintsRecordTarget(
		...
		if (!EOCL_ENV.get()
				.createQuery(VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get())
				.check(generalHeaderConstraints)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCode(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_LANGUAGE_COMMUNICATION_LANGUAGE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCode(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_ETHNIC_GROUP_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCode"),
							new Object[] { eObject }));
				}
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCodeP(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_ETHNIC_GROUP_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCodeP"),
							new Object[] { eObject }));
				}
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCode(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_RACE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCode"),
							new Object[] { eObject }));
				}
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCodeP(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_RACE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCodeP"),
							new Object[] { eObject }));
				}
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_LANGUAGE_COMMUNICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
		...
		if (oclResult != null && oclResult instanceof Collection) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, Mu2consolValidator.DIAGNOSTIC_SOURCE,
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRolePatient(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRolePatient"),
							new Object[] { eObject }));
				}
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Language Communication Language Code Term Case Insensitive</em>}'
	 * operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE_PATIENT_LANGUAGE_COMMUNICATION_LANGUAGE_CODE_TERM_CASE_INSENSITIVE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<Query<?, ?, ?>>();
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Language Communication Language Code</em>}' operation. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCode(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Language Communication Language Code</em>}' invariant operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationLanguageCode(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Ethnic Group Code</em>}' operation. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCode(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Ethnic Group Code</em>}' invariant operation. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCode(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Ethnic Group Code P</em>}' operation. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCodeP(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Ethnic Group Code P</em>}' invariant operation. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientEthnicGroupCodeP(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Race Code</em>}' operation. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCode(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Race Code</em>}' invariant operation. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCode(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Race Code P</em>}' operation. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCodeP(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Race Code P</em>}' invariant operation. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientRaceCodeP(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Language Communication</em>}' operation. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient Language Communication</em>}' invariant operation. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 ...
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient</em>}' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 ...
	 * '{@link #validateGeneralHeaderConstraintsRecordTargetPatientRolePatient(GeneralHeaderConstraints, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate General Header Constraints Record Target Patient Role
	 * Patient</em>}' invariant operation. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @see #validateGeneralHeaderConstraintsRecordTargetPatientRolePatient(GeneralHeaderConstraints,
	 *      org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	...
	public static boolean validateGeneralHeaderConstraintsRecordTargetPatientRole(
		...
		if (VALIDATE_GENERAL_HEADER_CONSTRAINTS_RECORD_TARGET_PATIENT_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY
				.get() == null) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Mu2consolValidator.DIAGNOSTIC_SOURCE,
							...
							Mu2consolPlugin.INSTANCE.getString(
									"GeneralHeaderConstraintsGeneralHeaderConstraintsRecordTargetPatientRole"),
							new Object[] { eObject }));
				}
