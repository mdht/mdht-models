 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.PlanOfCareSection#getMu2consolPlanOfCareActivityAct() <em>Get Mu2consol Plan Of Care Activity Act</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.PlanOfCareSection#getMu2consolPlanOfCareActivityEncounter() <em>Get Mu2consol Plan Of Care Activity Encounter</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.mu2consol.PlanOfCareSection#getMu2consolPlanOfCareActivityObservation() <em>Get Mu2consol Plan Of Care Activity Observation</em>}</li>
...
public class PlanOfCareSectionOperations
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MU2CONSOL_PLAN_OF_CARE_SECTION_PLAN_OF_CARE_ACTIVITY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::PlanOfCareActivityObservation))";
	...
	/**
	 * The cached OCL expression body for the '{@link #getMu2consolPlanOfCareActivityAct(PlanOfCareSection) <em>Get Mu2consol Plan Of Care Activity Act</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ACT__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PlanOfCareActivityAct))->asSequence()->any(true).oclAsType(consol::PlanOfCareActivityAct)";

	/**
	 * The cached OCL query for the '{@link #getMu2consolPlanOfCareActivityAct(PlanOfCareSection) <em>Get Mu2consol Plan Of Care Activity Act</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMu2consolPlanOfCareActivityAct(PlanOfCareSection)
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ACT__EOCL_QRY;
	...
	public static  PlanOfCareActivityAct getMu2consolPlanOfCareActivityAct(PlanOfCareSection planOfCareSection) {
		if (GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ACT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			...
			try {
				GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ACT__EOCL_QRY = helper.createQuery(GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ACT__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		OCL.Query query = EOCL_ENV.createQuery(GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ACT__EOCL_QRY);
		return (PlanOfCareActivityAct) query.evaluate(planOfCareSection);
	}

	/**
	 * The cached OCL expression body for the '{@link #getMu2consolPlanOfCareActivityEncounter(PlanOfCareSection) <em>Get Mu2consol Plan Of Care Activity Encounter</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_EXP = "self.getEncounters()->select(encounter : cda::Encounter | not encounter.oclIsUndefined() and encounter.oclIsKindOf(consol::PlanOfCareActivityEncounter))->asSequence()->any(true).oclAsType(consol::PlanOfCareActivityEncounter)";

	/**
	 * The cached OCL query for the '{@link #getMu2consolPlanOfCareActivityEncounter(PlanOfCareSection) <em>Get Mu2consol Plan Of Care Activity Encounter</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMu2consolPlanOfCareActivityEncounter(PlanOfCareSection)
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_QRY;
	...
	public static  PlanOfCareActivityEncounter getMu2consolPlanOfCareActivityEncounter(PlanOfCareSection planOfCareSection) {
		if (GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			...
			try {
				GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_QRY = helper.createQuery(GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		OCL.Query query = EOCL_ENV.createQuery(GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_QRY);
		return (PlanOfCareActivityEncounter) query.evaluate(planOfCareSection);
	}

	/**
	 * The cached OCL expression body for the '{@link #getMu2consolPlanOfCareActivityObservation(PlanOfCareSection) <em>Get Mu2consol Plan Of Care Activity Observation</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::PlanOfCareActivityObservation))->asSequence()->any(true).oclAsType(consol::PlanOfCareActivityObservation)";

	/**
	 * The cached OCL query for the '{@link #getMu2consolPlanOfCareActivityObservation(PlanOfCareSection) <em>Get Mu2consol Plan Of Care Activity Observation</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMu2consolPlanOfCareActivityObservation(PlanOfCareSection)
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_QRY;
	...
	public static  PlanOfCareActivityObservation getMu2consolPlanOfCareActivityObservation(PlanOfCareSection planOfCareSection) {
		if (GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			...
			try {
				GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_QRY = helper.createQuery(GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		OCL.Query query = EOCL_ENV.createQuery(GET_MU2CONSOL_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_QRY);
