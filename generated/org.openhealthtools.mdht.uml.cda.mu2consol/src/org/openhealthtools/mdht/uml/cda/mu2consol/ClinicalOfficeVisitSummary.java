 ...
 *        constraints.validation.error='ClinicalOfficeVisitSummaryReasonforVisit
 *        ClinicalOfficeVisitSummaryCarePlanning
 *        ClinicalOfficeVisitSummaryDateOfvisit
 *        ClinicalOfficeVisitSummaryVisitLocation
 *        ClinicalOfficeVisitSummaryProviderNameAndContactInfo
 *        ClinicalOfficeVisitSummaryVitalSigns
 *        ClinicalOfficeVisitSummaryMedicationsAdministeredSectionOrMedicationsSectionER
 *        ClinicalOfficeVisitSummaryProblemSection
 *        ClinicalOfficeVisitSummaryAllergiesSection
 *        ClinicalOfficeVisitSummaryResultsSection
 *        ClinicalOfficeVisitSummaryProceduresSection
 *        ClinicalOfficeVisitSummaryImmunizationsSection
 *        ClinicalOfficeVisitSummaryInstructionsSection
 *        ClinicalOfficeVisitSummarySocialHistorySection'"
 * @generated
 */
public interface ClinicalOfficeVisitSummary extends GeneralHeaderConstraints {
	 ...
	 *        or self.getAllSections()->one(s : cda::Section | not
	 *        s.oclIsUndefined() and s.oclIsTypeOf(consol::EncountersSection))
	 ...
	 *            -->
	 * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel
	 *        body='(self.documentationOf.oclAsType(cda::DocumentationOf).serviceEvent->notEmpty()
	 *        and
	 *        self.documentationOf.serviceEvent->forAll((effectiveTime.oclIsUndefined()
	 *        or effectiveTime.isNullFlavorUndefined()) implies not
	 *        effectiveTime.oclIsUndefined())) or
	 *        (self.componentOf.oclAsType(cda::Component1).encompassingEncounter->notEmpty()
	 *        and
	 *        self.componentOf.encompassingEncounter->forAll((effectiveTime.oclIsUndefined()
	 *        or effectiveTime.isNullFlavorUndefined()) implies not
	 *        effectiveTime.oclIsUndefined())) or (self.getAllSections()->one(s
	 *        : cda::Section | not s.oclIsUndefined() and
	 *        s.oclIsTypeOf(consol::EncountersSection)) or
	 *        \r\nself.getAllSections()->one(s : cda::Section | not
	 *        s.oclIsUndefined() and
	 *        s.oclIsTypeOf(consol::EncountersSectionEntriesOptional)))'"
	 * @generated
	 ...
	 *            -->
	 * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel
	 *        body='(self.componentOf.oclAsType(cda::Component1).encompassingEncounter->notEmpty()
	 *        and
	 *        self.componentOf.encompassingEncounter->forAll(location->notEmpty()
	 *        and location.oclIsTypeOf(cda::Location))) or
	 *        (self.getAllSections()->one(s : cda::Section | not
	 *        s.oclIsUndefined() and s.oclIsTypeOf(consol::EncountersSection))
	 *        or \r\nself.getAllSections()->one(s : cda::Section | not
	 *        s.oclIsUndefined() and
	 ...
	 *            -->
	 * @model annotation= "http://www.eclipse.org/uml2/1.1.0/GenModel
	 *        body='(self.documentationOf->excluding(null).serviceEvent->excluding(null).performer->notEmpty()
	 *        and
	 *        self.documentationOf->excluding(null).serviceEvent->excluding(null).performer->exists(assignedEntity->excluding(null).assignedPerson->excluding(null).name->notEmpty()
	 *        and assignedEntity->excluding(null).addr->notEmpty() and
	 *        assignedEntity->excluding(null).telecom->notEmpty())) or
	 *        (self.componentOf->excluding(null).encompassingEncounter->excluding(null).encounterParticipant->notEmpty()
	 *        and
	 *        self.componentOf->excluding(null).encompassingEncounter->excluding(null).encounterParticipant->exists(assignedEntity->excluding(null).assignedPerson->excluding(null).name->notEmpty()
	 *        and assignedEntity->excluding(null).addr->notEmpty() and
	 *        assignedEntity->excluding(null).telecom->notEmpty())) or
	 *        (self.componentOf->excluding(null).encompassingEncounter->excluding(null).responsibleParty->notEmpty()
	 *        and
	 *        self.componentOf->excluding(null).encompassingEncounter->excluding(null).responsibleParty->exists(assignedEntity->excluding(null).assignedPerson->excluding(null).name->notEmpty()
	 *        and assignedEntity->excluding(null).addr->notEmpty() and
	 *        assignedEntity->excluding(null).telecom->notEmpty()))'"
	 * @generated
	 */
	 ...
	 *        body='self.getAllSections()->one(section : cda::Section | not
	 *        section.oclIsUndefined() and
	 *        section.oclIsKindOf(mu2consol::MedicationsAdministeredSection)) or
	 *        self.getAllSections()->one(section : cda::Section | not
	 *        section.oclIsUndefined() and
	 ...
	 *        section.oclIsUndefined() and
	 *        section.oclIsKindOf(consol::InstructionsSection))->asSequence()->any(true).oclAsType(consol::InstructionsSection)'"
	 * @generated
	 */
	 ...
	 *        body='self.getAllSections()->select(section : cda::Section | not
	 *        section.oclIsUndefined() and
	 *        section.oclIsKindOf(consol::MedicationsAdministeredSection))->asSequence()->any(true).oclAsType(consol::MedicationsAdministeredSection)'"
	 * @generated
	 */
	 ...
	 *        body='self.getAllSections()->select(section : cda::Section | not
	 *        section.oclIsUndefined() and
	 *        section.oclIsKindOf(consol::MedicationsSection))->asSequence()->any(true).oclAsType(consol::MedicationsSection)'"
	 * @generated
	 */
	 ...
	 *        body='self.getAllSections()->select(section : cda::Section | not
	 *        section.oclIsUndefined() and
	 *        section.oclIsKindOf(mu2consol::MedicationsAdministeredSection))->asSequence()->any(true).oclAsType(mu2consol::MedicationsAdministeredSection)'"
	 * @generated
	 */
