...
public class HospitalAdmissionDiagnosisSectionOperations
	 ...
	 * {@link #validateMu2consolHospitalAdmissionDiagnosisSectionHospitalAdmissionDiagnosis(HospitalAdmissionDiagnosisSection, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * <em>Validate Mu2consol Hospital Admission Diagnosis Section Hospital Admission Diagnosis</em>}
	 * ' operation. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #validateMu2consolHospitalAdmissionDiagnosisSectionHospitalAdmissionDiagnosis(HospitalAdmissionDiagnosisSection,
	...
	public static boolean validateMu2consolHospitalAdmissionDiagnosisSectionHospitalAdmissionDiagnosis(
		...
		if (VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS_SECTION_HOSPITAL_ADMISSION_DIAGNOSIS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			try {
				VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS_SECTION_HOSPITAL_ADMISSION_DIAGNOSIS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
						.createInvariant(VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS_SECTION_HOSPITAL_ADMISSION_DIAGNOSIS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
		...
		if (!EOCL_ENV
				.createQuery(
						VALIDATE_MU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS_SECTION_HOSPITAL_ADMISSION_DIAGNOSIS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(hospitalAdmissionDiagnosisSection)) {
			if (diagnostics != null) {
				diagnostics
	 ...
	 * {@link #getmu2consolHospitalAdmissionDiagnosis(HospitalAdmissionDiagnosisSection)
	 * <em>Getmu2consol Hospital Admission Diagnosis</em>}' query operation.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getmu2consolHospitalAdmissionDiagnosis(HospitalAdmissionDiagnosisSection)
	 * @generated
	...
	public static HospitalAdmissionDiagnosis getmu2consolHospitalAdmissionDiagnosis(
		...
		if (GETMU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
					Mu2consolPackage.Literals.HOSPITAL_ADMISSION_DIAGNOSIS_SECTION,
					Mu2consolPackage.Literals.HOSPITAL_ADMISSION_DIAGNOSIS_SECTION
							.getEAllOperations().get(62));
			try {
				GETMU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS__EOCL_QRY = helper
						.createQuery(GETMU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(
						pe.getLocalizedMessage());
			}
		...
		OCL.Query query = EOCL_ENV
				.createQuery(GETMU2CONSOL_HOSPITAL_ADMISSION_DIAGNOSIS__EOCL_QRY);
		return (HospitalAdmissionDiagnosis) query
				.evaluate(hospitalAdmissionDiagnosisSection);
	}
