...
public class Mu2consolPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		smokingStatusObservationEClass.getESuperTypes().add(
				theConsolPackage.getSmokingStatusObservation());
		...
		vdtAmbulatorySummaryEClass.getESuperTypes().add(
				this.getViewDownloadTransmitSummary());
		functionalStatusSectionEClass.getESuperTypes().add(
				theConsolPackage.getFunctionalStatusSection());
		cognitiveStatusResultObservationEClass.getESuperTypes().add(
				theConsolPackage.getCognitiveStatusResultObservation());
		cognitiveStatusResultObservationEClass.getESuperTypes().add(
				this.getResultObservation());
		cognitiveStatusResultOrganizerEClass.getESuperTypes().add(
				theConsolPackage.getCognitiveStatusResultOrganizer());
		cognitiveStatusResultOrganizerEClass.getESuperTypes().add(
				this.getResultOrganizer());
		functionalStatusResultObservationEClass.getESuperTypes().add(
				theConsolPackage.getFunctionalStatusResultObservation());
		functionalStatusResultObservationEClass.getESuperTypes().add(
				this.getResultObservation());
		functionalStatusResultOrganizerEClass.getESuperTypes().add(
				theConsolPackage.getFunctionalStatusResultOrganizer());
		functionalStatusResultOrganizerEClass.getESuperTypes().add(
				this.getResultOrganizer());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordVitalSigns", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryReasonforVisit", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryDateOfvisit", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryVisitLocation", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryVitalSigns", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(transitionOfCareInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateTransitionOfCareInpatientSummaryMedications", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryCarePlanning", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryVitalSigns", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryAdmissionDate", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryDischargeDate", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryAdmissionDischargeLocation", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryMedications", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryReasonforHospitalization", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtAmbulatorySummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTAmbulatorySummaryProviderNameAndContactInfo", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtAmbulatorySummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTAmbulatorySummaryMedicationsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(vdtAmbulatorySummaryEClass,
				theConsolPackage.getMedicationsSection(),
				"getMedicationsSection", 1, 1, IS_UNIQUE, !IS_ORDERED);

		initEClass(functionalStatusSectionEClass,
				FunctionalStatusSection.class, "FunctionalStatusSection",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(functionalStatusSectionEClass,
				this.getCognitiveStatusResultObservation(),
				"getMu2consolCognitiveStatusResultObservations", 1, -1,
				IS_UNIQUE, !IS_ORDERED);

		addEOperation(functionalStatusSectionEClass,
				this.getCognitiveStatusResultOrganizer(),
				"getMu2consolCognitiveStatusResultOrganizers", 1, -1,
				IS_UNIQUE, !IS_ORDERED);

		addEOperation(functionalStatusSectionEClass,
				this.getFunctionalStatusResultObservation(),
				"getMu2consolFunctionalStatusResultObservations", 1, -1,
				IS_UNIQUE, !IS_ORDERED);

		addEOperation(functionalStatusSectionEClass,
				this.getFunctionalStatusResultOrganizer(),
				"getMu2consolFunctionalStatusResultOrganizers", 1, -1,
				IS_UNIQUE, !IS_ORDERED);

		initEClass(cognitiveStatusResultObservationEClass,
				CognitiveStatusResultObservation.class,
				"CognitiveStatusResultObservation", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(cognitiveStatusResultOrganizerEClass,
				CognitiveStatusResultOrganizer.class,
				"CognitiveStatusResultOrganizer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		addEOperation(cognitiveStatusResultOrganizerEClass,
				this.getCognitiveStatusResultObservation(),
				"getMu2consolCognitiveStatusResultObservations", 1, -1,
				IS_UNIQUE, !IS_ORDERED);

		initEClass(functionalStatusResultObservationEClass,
				FunctionalStatusResultObservation.class,
				"FunctionalStatusResultObservation", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(functionalStatusResultOrganizerEClass,
				FunctionalStatusResultOrganizer.class,
				"FunctionalStatusResultOrganizer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		addEOperation(functionalStatusResultOrganizerEClass,
				this.getFunctionalStatusResultObservation(),
				"getMu2consolFunctionalStatusResultObservations", 1, -1,
				IS_UNIQUE, !IS_ORDERED);
	...
	protected void createAnnotationAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"ResultsSectionEntriesOptionalTemplateId ResultsSectionResultOrganizer",
						"templateId.root", "2.16.840.1.113883.10.20.22.2.3.1" });
		addAnnotation(resultOrganizerEClass, source, new String[] {
				"constraints.validation.error",
				"ResultOrganizerTemplateId ResultOrganizerResultObservation",
		...
		addAnnotation(functionalStatusSectionEClass, source, new String[] {
				"constraints.validation.error",
				"FunctionalStatusSectionTemplateId", "templateId.root",
				"2.16.840.1.113883.10.20.22.2.14" });
		addAnnotation(cognitiveStatusResultObservationEClass, source,
				new String[] { "constraints.validation.error",
						"ResultObservationTemplateId", "templateId.root",
						"2.16.840.1.113883.10.20.22.4.74" });
		addAnnotation(cognitiveStatusResultOrganizerEClass, source,
				new String[] { "constraints.validation.error",
						"ResultOrganizerTemplateId", "templateId.root",
						"2.16.840.1.113883.10.20.22.4.75" });
		addAnnotation(functionalStatusResultObservationEClass, source,
				new String[] { "constraints.validation.error",
						"ResultObservationTemplateId", "templateId.root",
						"2.16.840.1.113883.10.20.22.4.67" });
		addAnnotation(functionalStatusResultOrganizerEClass, source,
				new String[] { "constraints.validation.error",
						"ResultOrganizerTemplateId", "templateId.root",
