...
public class Mu2consolPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		generalHeaderConstraintsEClass.getESuperTypes().add(
				theConsolPackage.getGeneralHeaderConstraints());
		...
		encounterActivitiesEClass.getESuperTypes().add(
		...
		socialHistorySectionEClass.getESuperTypes().add(
				theConsolPackage.getSocialHistorySection());
		smokingStatusObservationEClass.getESuperTypes().add(
				theConsolPackage.getTobaccoUse());
		resultsSectionEClass.getESuperTypes().add(
				theConsolPackage.getResultsSection());
		resultOrganizerEClass.getESuperTypes().add(
				theConsolPackage.getResultOrganizer());
		resultObservationEClass.getESuperTypes().add(
				theConsolPackage.getResultObservation());
		proceduresSectionEClass.getESuperTypes().add(
				theConsolPackage.getProceduresSection());
		procedureActivityProcedureEClass.getESuperTypes().add(
				theConsolPackage.getProcedureActivityProcedure());
		clinicalOfficeVisitSummaryEClass.getESuperTypes().add(
				this.getGeneralHeaderConstraints());
		transitionOfCareAmbulatorySummaryEClass.getESuperTypes().add(
				this.getSummaryOfCareRecord());
		transitionOfCareInpatientSummaryEClass.getESuperTypes().add(
				this.getSummaryOfCareRecord());
		viewDownloadTransmitSummaryEClass.getESuperTypes().add(
				this.getGeneralHeaderConstraints());
		vdtInpatientSummaryEClass.getESuperTypes().add(
				this.getViewDownloadTransmitSummary());
		vdtAmbulatorySummaryEClass.getESuperTypes().add(
				this.getViewDownloadTransmitSummary());
		...
		op = addEOperation(generalHeaderConstraintsEClass,
				ecorePackage.getEBoolean(),
				"validateMu2consolGeneralHeaderConstraintsDocumentationOf", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(generalHeaderConstraintsEClass,
				theConsolPackage.getHospitalAdmissionDiagnosisSection(),
				"retrieveHospitalAdmissionDiagnosisSection", 1, 1, IS_UNIQUE,
				!IS_ORDERED);
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordCarePlanning", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordEncountersSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordAssessmentAndPlanSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordAssessmentSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordPostoperativeDiagnosisSection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordAllergiesSection", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordHistoryOfPastIllnessSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordPreoperativeDiagnosisSection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordImmunizationsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordMedicationsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordVitalSignsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordPostprocedureDiagnosisSection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordFunctionalStatusSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordSocialHistorySectionTemplateId", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordPlanOfCareSectionTemplateId", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(summaryOfCareRecordEClass,
				ecorePackage.getEBoolean(),
				"validateSummaryOfCareRecordAssessmentSectionTemplateId", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(summaryOfCareRecordEClass,
				this.getSocialHistorySection(), "getSocialHistorySection", 1,
				1, IS_UNIQUE, !IS_ORDERED);

		addEOperation(summaryOfCareRecordEClass, this.getResultsSection(),
				"getResultsSection", 1, 1, IS_UNIQUE, !IS_ORDERED);

		addEOperation(summaryOfCareRecordEClass,
				theConsolPackage.getVitalSignsSection(),
				"getVitalSignsSection", 1, 1, IS_UNIQUE, !IS_ORDERED);

		addEOperation(summaryOfCareRecordEClass, this.getProceduresSection(),
		...
		addEOperation(encountersSectionEClass, this.getEncounterActivities(),
				"getMu2consolEncounterActivitiess", 1, -1, IS_UNIQUE,
				!IS_ORDERED);

		initEClass(encounterActivitiesEClass, EncounterActivities.class,
				"EncounterActivities", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(encounterActivitiesEClass,
				ecorePackage.getEBoolean(),
				"validateMu2consolEncounterActivitiesCodeValue", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(planOfCareSectionEClass,
				...
				"getMu2consolPlanOfCareActivityActs", 1, -1, IS_UNIQUE,
				!IS_ORDERED);

		addEOperation(planOfCareSectionEClass,
				theConsolPackage.getPlanOfCareActivityEncounter(),
				"getMu2consolPlanOfCareActivityEncounters", 1, -1, IS_UNIQUE,
				!IS_ORDERED);

		addEOperation(planOfCareSectionEClass,
				theConsolPackage.getPlanOfCareActivityObservation(),
				"getMu2consolPlanOfCareActivityObservations", 1, -1, IS_UNIQUE,
				!IS_ORDERED);
		...
		initEClass(socialHistorySectionEClass, SocialHistorySection.class,
		...
		initEClass(smokingStatusObservationEClass,
				SmokingStatusObservation.class, "SmokingStatusObservation",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(smokingStatusObservationEClass,
				ecorePackage.getEBoolean(),
				"validateSmokingStatusObservationValueP", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(smokingStatusObservationEClass,
				ecorePackage.getEBoolean(),
				"validateSmokingStatusObservationValue", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		initEClass(resultsSectionEClass, ResultsSection.class,
				"ResultsSection", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(resultsSectionEClass, ecorePackage.getEBoolean(),
				"validateMu2consolResultsSectionResultOrganizer", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(resultsSectionEClass, this.getResultOrganizer(),
				"getMu2consolResultOrganizers", 1, -1, IS_UNIQUE, !IS_ORDERED);

		initEClass(resultOrganizerEClass, ResultOrganizer.class,
				"ResultOrganizer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(resultOrganizerEClass, ecorePackage.getEBoolean(),
				"validateMu2consolResultOrganizerResultObservation", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(resultOrganizerEClass, this.getResultObservation(),
				"getMu2consolResultObservations", 1, -1, IS_UNIQUE, !IS_ORDERED);

		initEClass(resultObservationEClass, ResultObservation.class,
				"ResultObservation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(resultObservationEClass, ecorePackage.getEBoolean(),
		...
		op = addEOperation(resultObservationEClass, ecorePackage.getEBoolean(),
				"validateMu2consolResultObservationCode", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		initEClass(proceduresSectionEClass, ProceduresSection.class,
				"ProceduresSection", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(proceduresSectionEClass, ecorePackage.getEBoolean(),
		...
		addEOperation(proceduresSectionEClass,
				this.getProcedureActivityProcedure(),
				"getMu2consolProcedureActivityProcedures", 1, -1, IS_UNIQUE,
				!IS_ORDERED);

		initEClass(procedureActivityProcedureEClass,
				ProcedureActivityProcedure.class, "ProcedureActivityProcedure",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		op = addEOperation(procedureActivityProcedureEClass,
				ecorePackage.getEBoolean(),
				"validateMu2consolProcedureActivityProcedureCode", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryResponsibleParty", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryReasonForOfficeVisit", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryCarePlanning", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryEffectiveTime", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryLocation", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryInstructionsEntry", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryProblemSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryMedicationsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryAllergiesSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryResultsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryVitalSignsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryPlanOfCareSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryProceduresSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryImmunizationsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryReasonForVisitSection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryChiefComplaintSection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummaryInstructionsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(clinicalOfficeVisitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateClinicalOfficeVisitSummarySocialHistorySection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(clinicalOfficeVisitSummaryEClass,
				this.getPlanOfCareSection(), "retrievePlanOfCareSection", 1, 1,
				IS_UNIQUE, !IS_ORDERED);
		...
		addEOperation(clinicalOfficeVisitSummaryEClass,
				...
				"retrieveMedicationsAdministeredSection", 1, 1, IS_UNIQUE,
				!IS_ORDERED);
		...
		addEOperation(clinicalOfficeVisitSummaryEClass,
				this.getResultsSection(), "getResultsSection", 1, 1, IS_UNIQUE,
				!IS_ORDERED);
		...
		addEOperation(clinicalOfficeVisitSummaryEClass,
				this.getPlanOfCareSection(), "getPlanOfCareSection", 1, 1,
				IS_UNIQUE, !IS_ORDERED);

		addEOperation(clinicalOfficeVisitSummaryEClass,
				this.getProceduresSection(), "getProceduresSection", 1, 1,
				IS_UNIQUE, !IS_ORDERED);
		...
		initEClass(transitionOfCareAmbulatorySummaryEClass,
				TransitionOfCareAmbulatorySummary.class,
				"TransitionOfCareAmbulatorySummary", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(transitionOfCareAmbulatorySummaryEClass,
				ecorePackage.getEBoolean(),
				"validateTransitionOfCareAmbulatorySummaryResponsibleParty", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(transitionOfCareAmbulatorySummaryEClass,
				theConsolPackage.getReasonForReferralSection(),
				"getReasonForReferralSection", 1, 1, IS_UNIQUE, !IS_ORDERED);

		initEClass(transitionOfCareInpatientSummaryEClass,
				TransitionOfCareInpatientSummary.class,
				"TransitionOfCareInpatientSummary", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(viewDownloadTransmitSummaryEClass,
				ViewDownloadTransmitSummary.class,
				"ViewDownloadTransmitSummary", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryCarePlanFields", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryAllergiesSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryMedicationsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryProblemSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryProceduresSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryVitalSignsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryResultsSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummaryPlanOfCareSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(viewDownloadTransmitSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateViewDownloadTransmitSummarySocialHistorySection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(viewDownloadTransmitSummaryEClass,
				theConsolPackage.getPreoperativeDiagnosisSection(),
				"retrievePreoperativeDiagnosisSection", 1, 1, IS_UNIQUE,
				!IS_ORDERED);
		...
		initEClass(vdtInpatientSummaryEClass, VDTInpatientSummary.class,
				"VDTInpatientSummary", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryEffectiveTime", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryLocation", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryChiefComplaintOrReasonForVisit", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryPreoperativeDiagnosisEntry", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryChiefComplaintSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryReasonForVisitSection", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		op = addEOperation(vdtInpatientSummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTInpatientSummaryPreoperativeDiagnosisSection", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		addEOperation(vdtInpatientSummaryEClass,
				theConsolPackage.getHospitalDischargeInstructionsSection(),
				"getHospitalDischargeInstructionsSection", 1, 1, IS_UNIQUE,
				!IS_ORDERED);
		...
		initEClass(vdtAmbulatorySummaryEClass, VDTAmbulatorySummary.class,
				"VDTAmbulatorySummary", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = addEOperation(vdtAmbulatorySummaryEClass,
				ecorePackage.getEBoolean(),
				"validateVDTAmbulatorySummaryResponsibleParty", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0,
				1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
	...
	protected void createUmlAnnotations() {
		...
		addAnnotation(this, source, new String[] { "initializers",
				"org.openhealthtools.mdht.uml.cda.mu2consol" });
	}
	...
	protected void createAnnotationAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolEncountersSectionTemplateId Mu2consolEncountersSectionEncounterActivities",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolEncounterActivitiesTemplateId Mu2consolEncounterActivitiesCodeValue",
						"templateId.root", "2.16.840.1.113883.10.20.22.4.49" });
		addAnnotation(planOfCareSectionEClass, source, new String[] {
				"constraints.validation.error",
				"Mu2consolPlanOfCareSectionTemplateId", "templateId.root",
				"2.16.840.1.113883.10.20.22.2.10" });
		addAnnotation(assessmentAndPlanSectionEClass, source, new String[] {
				"constraints.validation.error",
				"Mu2consolAssessmentAndPlanSectionTemplateId",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolAssessmentSectionTemplateId Mu2consolAssessmentSectionProblemObservation",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolSocialHistorySectionTemplateId Mu2consolSocialHistorySectionSmokingStatusObservation",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolResultsSectionTemplateId Mu2consolResultsSectionResultOrganizer",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolResultOrganizerTemplateId Mu2consolResultOrganizerResultObservation",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Mu2consolResultObservationTemplateId Mu2consolResultObservationResultObservationCodeValue Mu2consolResultObservationCode",
						"templateId.root", "2.16.840.1.113883.10.20.22.4.2" });
		addAnnotation(proceduresSectionEClass, source, new String[] {
				"constraints.validation.error",
				"Mu2consolProceduresSectionTemplateId", "templateId.root",
				"2.16.840.1.113883.10.20.22.2.7.1",
				"constraints.validation.info",
				"Mu2consolProceduresSectionProcedureActivityProcedure" });
		addAnnotation(
				procedureActivityProcedureEClass,
				source,
				new String[] {
						"constraints.validation.error",
						"Mu2consolProcedureActivityProcedureTemplateId Mu2consolProcedureActivityProcedureCodeValue Mu2consolProcedureActivityProcedureCode",
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.query",
						"ClinicalOfficeVisitSummaryResponsibleParty ClinicalOfficeVisitSummaryEffectiveTime ClinicalOfficeVisitSummaryLocation ClinicalOfficeVisitSummaryInstructionsEntry ClinicalOfficeVisitSummaryMedicationsAdministeredEntry ClinicalOfficeVisitSummaryPlanOfCareSectionTemplateId ClinicalOfficeVisitSummaryAssessmentAndPlanSectionTemplateId ClinicalOfficeVisitSummarySocialHistorySectionTemplateId ClinicalOfficeVisitSummaryMu2consolSocialHistorySectionSmokingStatusObservation",
						"constraints.validation.error",
						"ClinicalOfficeVisitSummaryResponsibleParty ClinicalOfficeVisitSummaryReasonForOfficeVisit ClinicalOfficeVisitSummaryCarePlanning ClinicalOfficeVisitSummaryEffectiveTime ClinicalOfficeVisitSummaryLocation ClinicalOfficeVisitSummaryInstructionsEntry ClinicalOfficeVisitSummaryMedicationsAdministeredEntry ClinicalOfficeVisitSummaryProblemSection ClinicalOfficeVisitSummaryMedicationsSection ClinicalOfficeVisitSummaryAllergiesSection ClinicalOfficeVisitSummaryResultsSection ClinicalOfficeVisitSummaryVitalSignsSection ClinicalOfficeVisitSummaryProceduresSection ClinicalOfficeVisitSummaryImmunizationsSection ClinicalOfficeVisitSummaryMedicationsAdministeredSection ClinicalOfficeVisitSummaryInstructionsSection ClinicalOfficeVisitSummarySocialHistorySection ClinicalOfficeVisitSummaryPlanOfCareSectionTemplateId ClinicalOfficeVisitSummaryAssessmentAndPlanSectionTemplateId ClinicalOfficeVisitSummarySocialHistorySectionTemplateId ClinicalOfficeVisitSummaryMu2consolSocialHistorySectionSmokingStatusObservation",
						"constraints.validation.info",
						"ClinicalOfficeVisitSummaryPlanOfCareSection ClinicalOfficeVisitSummaryReasonForVisitSection ClinicalOfficeVisitSummaryChiefComplaintSection ClinicalOfficeVisitSummaryChiefComplaintAndReasonForVisitSection ClinicalOfficeVisitSummaryAssessmentAndPlanSection" });
		addAnnotation(
				transitionOfCareAmbulatorySummaryEClass,
				source,
				new String[] {
						"constraints.validation.query",
						"TransitionOfCareAmbulatorySummaryResponsibleParty",
						"constraints.validation.error",
						"TransitionOfCareAmbulatorySummaryResponsibleParty TransitionOfCareAmbulatorySummaryAmbulatoryEncounterDiagnoses TransitionOfCareAmbulatorySummaryReasonForReferralSection" });
		addAnnotation(
				transitionOfCareInpatientSummaryEClass,
				source,
				new String[] {
						"constraints.validation.error",
						"TransitionOfCareInpatientSummaryInpatientEncounterDiagnoses TransitionOfCareInpatientSummaryHospitalAdmissionDiagnosisEntry TransitionOfCareInpatientSummaryHospitalDischargeDiagnosesEntry TransitionOfCareInpatientSummaryPostoperativeDiagnosisEntry TransitionOfCareInpatientSummaryPostprocedureDiagnosisEntry TransitionOfCareInpatientSummaryHospitalDischargeInstructionsSection TransitionOfCareInpatientSummaryHospitalDischargeMedicationsSection",
						"constraints.validation.query",
						"TransitionOfCareInpatientSummaryHospitalAdmissionDiagnosisEntry TransitionOfCareInpatientSummaryHospitalDischargeDiagnosesEntry TransitionOfCareInpatientSummaryPostoperativeDiagnosisEntry TransitionOfCareInpatientSummaryPostprocedureDiagnosisEntry",
						"constraints.validation.info",
						"TransitionOfCareInpatientSummaryHospitalAdmissionDiagnosisSection TransitionOfCareInpatientSummaryHospitalDischargeDiagnosisSection TransitionOfCareInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional" });
		addAnnotation(
				viewDownloadTransmitSummaryEClass,
				source,
				new String[] {
						"constraints.validation.error",
						"ViewDownloadTransmitSummaryCarePlanFields ViewDownloadTransmitSummaryAllergiesSection ViewDownloadTransmitSummaryMedicationsSection ViewDownloadTransmitSummaryProblemSection ViewDownloadTransmitSummaryProceduresSection ViewDownloadTransmitSummaryVitalSignsSection ViewDownloadTransmitSummaryResultsSection ViewDownloadTransmitSummarySocialHistorySection ViewDownloadTransmitSummaryAssessmentAndPlanSectionTemplateId ViewDownloadTransmitSummaryPlanOfCareSectionTemplateId ViewDownloadTransmitSummarySocialHistorySectionTemplateId ViewDownloadTransmitSummaryMu2consolSocialHistorySectionSmokingStatusObservation",
						"constraints.validation.info",
						"ViewDownloadTransmitSummaryAssessmentAndPlanSection ViewDownloadTransmitSummaryPlanOfCareSection",
						"constraints.validation.query",
						"ViewDownloadTransmitSummaryAssessmentAndPlanSectionTemplateId ViewDownloadTransmitSummaryPlanOfCareSectionTemplateId ViewDownloadTransmitSummarySocialHistorySectionTemplateId ViewDownloadTransmitSummaryMu2consolSocialHistorySectionSmokingStatusObservation" });
		addAnnotation(
				vdtInpatientSummaryEClass,
				source,
				new String[] {
						"constraints.validation.query",
						"VDTInpatientSummaryEffectiveTime VDTInpatientSummaryLocation VDTInpatientSummaryHospitalAdmissionDiagnosisEntry VDTInpatientSummaryPreoperativeDiagnosisEntry",
						"constraints.validation.error",
						"VDTInpatientSummaryEffectiveTime VDTInpatientSummaryLocation VDTInpatientSummaryChiefComplaintOrReasonForVisit VDTInpatientSummaryHospitalAdmissionDiagnosisEntry VDTInpatientSummaryPreoperativeDiagnosisEntry VDTInpatientSummaryHospitalDischargeInstructionsSection VDTInpatientSummaryHospitalAdmissionDiagnosisSection VDTInpatientSummaryHospitalDischargeMedicationsSection",
						"constraints.validation.info",
						"VDTInpatientSummaryChiefComplaintSection VDTInpatientSummaryReasonForVisitSection VDTInpatientSummaryChiefComplaintAndReasonForVisitSection VDTInpatientSummaryPreoperativeDiagnosisSection VDTInpatientSummaryHospitalAdmissionMedicationsSectionEntriesOptional" });
		addAnnotation(vdtAmbulatorySummaryEClass, source, new String[] {
				"constraints.validation.query",
				"VDTAmbulatorySummaryResponsibleParty",
				"constraints.validation.error",
				"VDTAmbulatorySummaryResponsibleParty" });
	}
	...
	protected void createMu2consolGeneralHeaderConstraintsRecordTargetPatientRoleAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"PatientRolePatient PatientRolePatientLanguageCommunicationLanguageCodeP PatientRolePatientLanguageCommunicationLanguageCode PatientRolePatientEthnicGroupCode PatientRolePatientEthnicGroupCodeP PatientRolePatientRaceCode PatientRolePatientRaceCodeP PatientRolePatientLanguageCommunication",
						"constraints.validation.query",
						"PatientRolePatientLanguageCommunicationLanguageCodeP PatientRolePatientLanguageCommunicationLanguageCode PatientRolePatientEthnicGroupCode PatientRolePatientEthnicGroupCodeP PatientRolePatientRaceCode PatientRolePatientRaceCodeP PatientRolePatientLanguageCommunication",
						"constraints.validation.dependOn.PatientRolePatientLanguageCommunicationLanguageCode",
						"PatientRolePatientLanguageCommunicationLanguageCodeP" });
	}
	...
	protected void createMu2consolGeneralHeaderConstraintsRecordTargetPatientRolePatientAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						...
						"constraints.validation.error",
						"PatientEthnicGroupCode PatientEthnicGroupCodeP PatientRaceCode PatientRaceCodeP PatientLanguageCommunication PatientLanguageCommunicationLanguageCodeP PatientLanguageCommunicationLanguageCode",
						"raceCode.codeSystem",
						"2.16.840.1.113883.6.238",
						"raceCode.codeSystemName",
						"Race and Ethnicity - CDC",
						"constraints.validation.query",
						"PatientLanguageCommunicationLanguageCodeP PatientLanguageCommunicationLanguageCode",
						"constraints.validation.dependOn.PatientLanguageCommunicationLanguageCode",
	...
	protected void createMu2consolGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunicationAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"LanguageCommunicationLanguageCode LanguageCommunicationLanguageCodeP",
						"constraints.validation.dependOn.LanguageCommunicationLanguageCode",
	 ...
	 * Initializes the annotations for
	 * <b>http://www.openhealthtools.org/mdht/uml
	 * /cda/annotation/mu2consolGeneralHeaderConstraintsDocumentationOf</b>.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void createMu2consolGeneralHeaderConstraintsDocumentationOfAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"DocumentationOfServiceEvent DocumentationOfServiceEventPerformer1AssignedEntityAssignedPerson DocumentationOfServiceEventPerformer1AssignedEntity DocumentationOfServiceEventPerformer",
						"constraints.validation.query",
						"DocumentationOfServiceEventPerformer1AssignedEntityAssignedPerson DocumentationOfServiceEventPerformer1AssignedEntity DocumentationOfServiceEventPerformer" });
	}
	...
	protected void createMu2consolGeneralHeaderConstraintsDocumentationOfServiceEventAnnotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"ServiceEventPerformer ServiceEventPerformer1AssignedEntityAssignedPerson ServiceEventPerformer1AssignedEntity",
						"constraints.validation.query",
						"ServiceEventPerformer1AssignedEntityAssignedPerson ServiceEventPerformer1AssignedEntity" });
	}

	/**
	 * Initializes the annotations for
	 * <b>http://www.openhealthtools.org/mdht/uml/cda/annotation/
	 * mu2consolGeneralHeaderConstraintsDocumentationOfServiceEventPerformer1
	 * </b>. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void createMu2consolGeneralHeaderConstraintsDocumentationOfServiceEventPerformer1Annotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Performer1AssignedEntity Performer1AssignedEntityAssignedPerson",
						"constraints.validation.query",
						"Performer1AssignedEntityAssignedPerson" });
	}

	/**
	 * Initializes the annotations for
	 * <b>http://www.openhealthtools.org/mdht/uml/cda/annotation/
	 * mu2consolGeneralHeaderConstraintsDocumentationOfServiceEventPerformer1AssignedEntity
	 * </b>. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	protected void createMu2consolGeneralHeaderConstraintsComponent1Annotations() {
		...
		addAnnotation(
				...
				new String[] {
						"constraints.validation.error",
						"Component1EncompassingEncounter Component1EncompassingEncounterEncounterParticipant",
						"constraints.validation.query",
						"Component1EncompassingEncounterEncounterParticipant" });
	}

	/**
	 * Initializes the annotations for
	 * <b>http://www.openhealthtools.org/mdht/uml/cda/annotation/
	 * mu2consolGeneralHeaderConstraintsComponent1EncompassingEncounter</b>.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void createMu2consolGeneralHeaderConstraintsComponent1EncompassingEncounterAnnotations() {
		...
		addAnnotation(generalHeaderConstraintsEClass, source, new String[] {
				"constraints.validation.error",
				"EncompassingEncounterEncounterParticipant" });
	}
	...
	protected void createDuplicatesAnnotations() {
		...
		addAnnotation(encounterActivitiesEClass, source, new String[] {});
		addAnnotation(planOfCareSectionEClass, source, new String[] {});
		addAnnotation(assessmentAndPlanSectionEClass, source, new String[] {});
