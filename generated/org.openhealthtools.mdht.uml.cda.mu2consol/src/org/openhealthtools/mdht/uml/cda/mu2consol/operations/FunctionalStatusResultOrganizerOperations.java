...
public class FunctionalStatusResultOrganizerOperations
		extends
		org.openhealthtools.mdht.uml.cda.consol.operations.FunctionalStatusResultOrganizerOperations {
	/**
				...
				diagnostics
						.add(new BasicDiagnostic(
								...
								Mu2consolPlugin.INSTANCE
										.getString("FunctionalStatusResultOrganizerResultOrganizerTemplateId"),
	...
	public static EList<FunctionalStatusResultObservation> getMu2consolFunctionalStatusResultObservations(
		...
		if (GET_MU2CONSOL_FUNCTIONAL_STATUS_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
					Mu2consolPackage.Literals.FUNCTIONAL_STATUS_RESULT_ORGANIZER,
					Mu2consolPackage.Literals.FUNCTIONAL_STATUS_RESULT_ORGANIZER
