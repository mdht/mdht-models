 ...
 * @generated
 */
public class FunctionalStatusResultOrganizerOperations extends org.openhealthtools.mdht.uml.cda.consol.operations.FunctionalStatusResultOrganizerOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public static  boolean validateResultOrganizerTemplateId(FunctionalStatusResultOrganizer functionalStatusResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "FunctionalStatusResultOrganizerResultOrganizerTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(functionalStatusResultOrganizer, context) }),
	...
	/**
	 * The cached OCL expression body for the '{@link #getMu2consolFunctionalStatusResultObservations(FunctionalStatusResultOrganizer) <em>Get Mu2consol Functional Status Result Observations</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached OCL query for the '{@link #getMu2consolFunctionalStatusResultObservations(FunctionalStatusResultOrganizer) <em>Get Mu2consol Functional Status Result Observations</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMu2consolFunctionalStatusResultObservations(FunctionalStatusResultOrganizer)
	 * @generated
	...
	public static  EList<FunctionalStatusResultObservation> getMu2consolFunctionalStatusResultObservations(FunctionalStatusResultOrganizer functionalStatusResultOrganizer) {
		if (GET_MU2CONSOL_FUNCTIONAL_STATUS_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(Mu2consolPackage.Literals.FUNCTIONAL_STATUS_RESULT_ORGANIZER, Mu2consolPackage.Literals.FUNCTIONAL_STATUS_RESULT_ORGANIZER.getEAllOperations().get(67));
			try {
