...
public class ResultOrganizerOperations extends org.openhealthtools.mdht.uml.cda.ccd.operations.ResultOrganizerOperations {
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_PHMR_RESULT_ORGANIZER_NUMERIC_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validatePHMRResultOrganizerNumericObservation(ResultOrganizer resultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_PHMR_RESULT_ORGANIZER_NUMERIC_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.RESULT_ORGANIZER);
			try {
				VALIDATE_PHMR_RESULT_ORGANIZER_NUMERIC_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PHMR_RESULT_ORGANIZER_NUMERIC_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PHMR_RESULT_ORGANIZER_NUMERIC_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(resultOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 PhmrPlugin.INSTANCE.getString("ResultOrganizerPHMRResultOrganizerNumericObservation"),
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_PHMR_RESULT_ORGANIZER_WAVEFORM_SERIES_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validatePHMRResultOrganizerWaveformSeriesObservation(ResultOrganizer resultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_PHMR_RESULT_ORGANIZER_WAVEFORM_SERIES_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.RESULT_ORGANIZER);
			try {
				VALIDATE_PHMR_RESULT_ORGANIZER_WAVEFORM_SERIES_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PHMR_RESULT_ORGANIZER_WAVEFORM_SERIES_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_PHMR_RESULT_ORGANIZER_WAVEFORM_SERIES_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(resultOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 PhmrPlugin.INSTANCE.getString("ResultOrganizerPHMRResultOrganizerWaveformSeriesObservation"),
						 new Object [] { resultOrganizer }));
			}
  ...
  /**
	...
	public static  EList<NumericObservation> getNumericObservations(ResultOrganizer resultOrganizer) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_NUMERIC_OBSERVATIONS__EOCL_QRY);
	...
	public static  EList<WaveformSeriesObservation> getWaveformSeriesObservations(ResultOrganizer resultOrganizer) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_WAVEFORM_SERIES_OBSERVATIONS__EOCL_QRY);
		@SuppressWarnings("unchecked")
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("ResultOrganizerResultOrganizerTemplateId"),
						 new Object [] { resultOrganizer }));
			}
