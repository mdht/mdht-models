 ...
 * @generated
 */
public class SamplingFrequencyObservationOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateSamplingFrequencyObservationTemplateId(SamplingFrequencyObservation samplingFrequencyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.SAMPLING_FREQUENCY_OBSERVATION);
			try {
				VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(samplingFrequencyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("SamplingFrequencyObservationSamplingFrequencyObservationTemplateId"),
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateSamplingFrequencyObservationCodeP(SamplingFrequencyObservation samplingFrequencyObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.SAMPLING_FREQUENCY_OBSERVATION);
			try {
				VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(samplingFrequencyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("SamplingFrequencyObservationSamplingFrequencyObservationCodeP"),
						 new Object [] { samplingFrequencyObservation }));
			}
...
"value.code = 'MDC_ATTR_TIME_PD_SAMP' and value.codeSystem = '2.16.840.1.113883.6.24')";
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateSamplingFrequencyObservationCode(SamplingFrequencyObservation samplingFrequencyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.SAMPLING_FREQUENCY_OBSERVATION);
			try {
				VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(samplingFrequencyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("SamplingFrequencyObservationSamplingFrequencyObservationCode"),
						 new Object [] { samplingFrequencyObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateSamplingFrequencyObservationMoodCode(SamplingFrequencyObservation samplingFrequencyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.SAMPLING_FREQUENCY_OBSERVATION);
			try {
				VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(samplingFrequencyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("SamplingFrequencyObservationSamplingFrequencyObservationMoodCode"),
						 new Object [] { samplingFrequencyObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateSamplingFrequencyObservationValue(SamplingFrequencyObservation samplingFrequencyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.SAMPLING_FREQUENCY_OBSERVATION);
			try {
				VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_SAMPLING_FREQUENCY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(samplingFrequencyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("SamplingFrequencyObservationSamplingFrequencyObservationValue"),
						 new Object [] { samplingFrequencyObservation }));
			}
