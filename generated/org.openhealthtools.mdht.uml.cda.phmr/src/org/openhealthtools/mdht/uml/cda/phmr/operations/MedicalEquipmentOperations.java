...
public class MedicalEquipmentOperations extends MedicalEquipmentSectionOperations {
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_MEDICAL_EQUIPMENT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateMedicalEquipmentText(MedicalEquipment medicalEquipment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_MEDICAL_EQUIPMENT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.MEDICAL_EQUIPMENT);
			try {
				VALIDATE_MEDICAL_EQUIPMENT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_MEDICAL_EQUIPMENT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_MEDICAL_EQUIPMENT_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(medicalEquipment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("MedicalEquipmentMedicalEquipmentText"),
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_MEDICAL_EQUIPMENT_DEVICE_DEFINITION_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateMedicalEquipmentDeviceDefinitionOrganizer(MedicalEquipment medicalEquipment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_MEDICAL_EQUIPMENT_DEVICE_DEFINITION_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.MEDICAL_EQUIPMENT);
			try {
				VALIDATE_MEDICAL_EQUIPMENT_DEVICE_DEFINITION_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_MEDICAL_EQUIPMENT_DEVICE_DEFINITION_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_MEDICAL_EQUIPMENT_DEVICE_DEFINITION_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(medicalEquipment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 PhmrPlugin.INSTANCE.getString("MedicalEquipmentMedicalEquipmentDeviceDefinitionOrganizer"),
						 new Object [] { medicalEquipment }));
			}
	...
	public static  EList<DeviceDefinitionOrganizer> getDeviceDefinitionOrganizers(MedicalEquipment medicalEquipment) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_DEVICE_DEFINITION_ORGANIZERS__EOCL_QRY);
	...
	public static  boolean validateMedicalEquipmentSectionTemplateId(MedicalEquipment medicalEquipment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_MEDICAL_EQUIPMENT_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(medicalEquipment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("MedicalEquipmentMedicalEquipmentSectionTemplateId"),
						 new Object [] { medicalEquipment }));
			}
