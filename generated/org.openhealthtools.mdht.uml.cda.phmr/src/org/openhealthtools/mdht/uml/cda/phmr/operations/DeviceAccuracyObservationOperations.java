 ...
 * @generated
 */
public class DeviceAccuracyObservationOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_ACCURACY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceAccuracyObservationTemplateId(DeviceAccuracyObservation deviceAccuracyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_ACCURACY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_ACCURACY_OBSERVATION);
			try {
				VALIDATE_DEVICE_ACCURACY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_ACCURACY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_ACCURACY_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceAccuracyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceAccuracyObservationDeviceAccuracyObservationTemplateId"),
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_ACCURACY_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceAccuracyObservationClassCode(DeviceAccuracyObservation deviceAccuracyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_ACCURACY_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_ACCURACY_OBSERVATION);
			try {
				VALIDATE_DEVICE_ACCURACY_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_ACCURACY_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_ACCURACY_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceAccuracyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceAccuracyObservationDeviceAccuracyObservationClassCode"),
						 new Object [] { deviceAccuracyObservation }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateDeviceAccuracyObservationCodeP(DeviceAccuracyObservation deviceAccuracyObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_ACCURACY_OBSERVATION);
			try {
				VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceAccuracyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceAccuracyObservationDeviceAccuracyObservationCodeP"),
						 new Object [] { deviceAccuracyObservation }));
			}
...
"value.code = 'MDC_ATTR_NU_ACCUR_MSMT' and value.codeSystem = '2.16.840.1.113883.6.24')";
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceAccuracyObservationCode(DeviceAccuracyObservation deviceAccuracyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_ACCURACY_OBSERVATION);
			try {
				VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_ACCURACY_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceAccuracyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceAccuracyObservationDeviceAccuracyObservationCode"),
						 new Object [] { deviceAccuracyObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_ACCURACY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceAccuracyObservationMoodCode(DeviceAccuracyObservation deviceAccuracyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_ACCURACY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_ACCURACY_OBSERVATION);
			try {
				VALIDATE_DEVICE_ACCURACY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_ACCURACY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_ACCURACY_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceAccuracyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceAccuracyObservationDeviceAccuracyObservationMoodCode"),
						 new Object [] { deviceAccuracyObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_ACCURACY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceAccuracyObservationValue(DeviceAccuracyObservation deviceAccuracyObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_ACCURACY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_ACCURACY_OBSERVATION);
			try {
				VALIDATE_DEVICE_ACCURACY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_ACCURACY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_ACCURACY_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceAccuracyObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceAccuracyObservationDeviceAccuracyObservationValue"),
						 new Object [] { deviceAccuracyObservation }));
			}
