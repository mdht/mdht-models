 ...
 * @generated
 */
public class DeviceDefinitionOrganizerOperations extends org.eclipse.mdht.uml.cda.operations.OrganizerOperations {
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerTemplateId(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerTemplateId"),
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerClassCode(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerClassCode"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerEffectiveTime(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerEffectiveTime"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerMoodCode(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerMoodCode"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_SAMPLING_FREQUENCY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerSamplingFrequencyObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_SAMPLING_FREQUENCY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_SAMPLING_FREQUENCY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_SAMPLING_FREQUENCY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_SAMPLING_FREQUENCY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerSamplingFrequencyObservation"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_MEASUREMENT_RANGE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerDeviceMeasurementRangeObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_MEASUREMENT_RANGE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_MEASUREMENT_RANGE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_MEASUREMENT_RANGE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_MEASUREMENT_RANGE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerDeviceMeasurementRangeObservation"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_RESOLUTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerDeviceResolutionObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_RESOLUTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_RESOLUTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_RESOLUTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_RESOLUTION_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerDeviceResolutionObservation"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_ACCURACY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateDeviceDefinitionOrganizerDeviceAccuracyObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_ACCURACY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_ACCURACY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_ACCURACY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_DEVICE_ACCURACY_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerDeviceAccuracyObservation"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
  ...
  protected static ThreadLocal<  Constraint> VALIDATE_DEVICE_DEFINITION_ORGANIZER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
  ...
  public static  boolean validateDeviceDefinitionOrganizerParticipant(DeviceDefinitionOrganizer deviceDefinitionOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
		...
		if (VALIDATE_DEVICE_DEFINITION_ORGANIZER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.DEVICE_DEFINITION_ORGANIZER);
			try {
				VALIDATE_DEVICE_DEFINITION_ORGANIZER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DEVICE_DEFINITION_ORGANIZER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DEVICE_DEFINITION_ORGANIZER_PARTICIPANT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(deviceDefinitionOrganizer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("DeviceDefinitionOrganizerDeviceDefinitionOrganizerParticipant"),
						 new Object [] { deviceDefinitionOrganizer }));
			}
  ...
  /**
	...
	public static  SamplingFrequencyObservation getSamplingFrequencyObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_SAMPLING_FREQUENCY_OBSERVATION__EOCL_QRY);
	...
	public static  DeviceMeasurementRangeObservation getDeviceMeasurementRangeObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_DEVICE_MEASUREMENT_RANGE_OBSERVATION__EOCL_QRY);
	...
	public static  DeviceResolutionObservation getDeviceResolutionObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_DEVICE_RESOLUTION_OBSERVATION__EOCL_QRY);
	...
	public static  DeviceAccuracyObservation getDeviceAccuracyObservation(DeviceDefinitionOrganizer deviceDefinitionOrganizer) {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_DEVICE_ACCURACY_OBSERVATION__EOCL_QRY);
