 ...
 * @generated
 */
public class WaveformObservationOperations extends org.eclipse.mdht.uml.cda.operations.ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_WAVEFORM_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateWaveformObservationTemplateId(WaveformObservation waveformObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_WAVEFORM_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_WAVEFORM_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_WAVEFORM_OBSERVATION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(waveformObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformObservationWaveformObservationTemplateId"),
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_WAVEFORM_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateWaveformObservationClassCode(WaveformObservation waveformObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_WAVEFORM_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_WAVEFORM_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_WAVEFORM_OBSERVATION_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(waveformObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformObservationWaveformObservationClassCode"),
						 new Object [] { waveformObservation }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.96')";
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_WAVEFORM_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateWaveformObservationCode(WaveformObservation waveformObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_WAVEFORM_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_WAVEFORM_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_WAVEFORM_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(waveformObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformObservationWaveformObservationCode"),
						 new Object [] { waveformObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_WAVEFORM_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateWaveformObservationMoodCode(WaveformObservation waveformObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_WAVEFORM_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_WAVEFORM_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_WAVEFORM_OBSERVATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(waveformObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformObservationWaveformObservationMoodCode"),
						 new Object [] { waveformObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static ThreadLocal<  Constraint> VALIDATE_WAVEFORM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateWaveformObservationValue(WaveformObservation waveformObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_WAVEFORM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
		
	 
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(PhmrPackage.Literals.WAVEFORM_OBSERVATION);
			try {
				VALIDATE_WAVEFORM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_WAVEFORM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_WAVEFORM_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(waveformObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 PhmrPlugin.INSTANCE.getString("WaveformObservationWaveformObservationValue"),
						 new Object [] { waveformObservation }));
			}
