 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.AbdomenSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AbdomenSectionImpl extends EObjectImpl implements IAbdomenSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getAbdomenSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getAbdomenSection(),
				IDomainPackage.eINSTANCE.getAbdomenSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IAbdomenSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.ABDOMEN_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
