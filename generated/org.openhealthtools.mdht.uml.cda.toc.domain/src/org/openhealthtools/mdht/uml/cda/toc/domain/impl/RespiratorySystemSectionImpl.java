 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.RespiratorySystemSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RespiratorySystemSectionImpl extends EObjectImpl implements IRespiratorySystemSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getRespiratorySystemSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getRespiratorySystemSection(),
				IDomainPackage.eINSTANCE.getRespiratorySystemSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IRespiratorySystemSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.RESPIRATORY_SYSTEM_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	 ...
	 * @generated
	 */
	public IRespiratorySystemSection init() {
		CDAUtil.init(this);
		return this;
	}
