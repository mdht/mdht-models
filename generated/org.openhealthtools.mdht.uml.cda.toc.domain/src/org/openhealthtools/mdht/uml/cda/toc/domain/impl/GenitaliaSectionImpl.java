 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.GenitaliaSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GenitaliaSectionImpl extends EObjectImpl implements IGenitaliaSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getGenitaliaSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getGenitaliaSection(),
				IDomainPackage.eINSTANCE.getGenitaliaSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IGenitaliaSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.GENITALIA_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
