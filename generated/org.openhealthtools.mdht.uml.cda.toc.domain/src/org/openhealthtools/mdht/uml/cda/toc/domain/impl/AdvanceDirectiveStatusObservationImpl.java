 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.AdvanceDirectiveStatusObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdvanceDirectiveStatusObservationImpl extends StatusObservationImpl implements
	...
	public CE getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getAdvanceDirectiveStatusObservation(), IDomainPackage.eINSTANCE.getAdvanceDirectiveStatusObservation().getEAllOperations().get(0));
			try {
