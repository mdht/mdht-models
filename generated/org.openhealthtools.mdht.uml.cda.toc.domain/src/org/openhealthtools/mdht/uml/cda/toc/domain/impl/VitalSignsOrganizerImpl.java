 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.VitalSignsOrganizerImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VitalSignsOrganizerImpl extends EObjectImpl implements IVitalSignsOrganizer {
	/**
	...
	public II getId() {
		if (GET_ID__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getVitalSignsOrganizer(), IDomainPackage.eINSTANCE.getVitalSignsOrganizer().getEAllOperations().get(0));
			try {
	...
	public IVL_TS getEffectiveTime() {
		if (GET_EFFECTIVE_TIME__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getVitalSignsOrganizer(), IDomainPackage.eINSTANCE.getVitalSignsOrganizer().getEAllOperations().get(3));
			try {
	...
	public EList<Specimen> getSpecimens() {
		if (GET_SPECIMENS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getVitalSignsOrganizer(), IDomainPackage.eINSTANCE.getVitalSignsOrganizer().getEAllOperations().get(6));
			try {
	...
	public EList<IVitalSignObservation> getVitalSignObservations() {
		if (GET_VITAL_SIGN_OBSERVATIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getVitalSignsOrganizer(), IDomainPackage.eINSTANCE.getVitalSignsOrganizer().getEAllOperations().get(9));
			try {
	...
	public Author getAuthor() {
		if (GET_AUTHOR__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getVitalSignsOrganizer(), IDomainPackage.eINSTANCE.getVitalSignsOrganizer().getEAllOperations().get(12));
			try {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.VITAL_SIGNS_ORGANIZER__CDA_TYPE:
