 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.EyesSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EyesSectionImpl extends EObjectImpl implements IEyesSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getEyesSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getEyesSection(),
				IDomainPackage.eINSTANCE.getEyesSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IEyesSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.EYES_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
