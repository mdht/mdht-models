 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.IAssessmentAndPlanSection#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.openhealthtools.mdht.uml.cda.hitsp.domain.IDomainPackage#getAssessmentAndPlanSection()
 * @generated
 */
public interface IAssessmentAndPlanSection {
	 ...
	 * @see org.openhealthtools.mdht.uml.cda.hitsp.domain.IDomainPackage#getAssessmentAndPlanSection_CDAType()
	 * @generated
	 */
	Section getCDAType();

	/**
	 * Sets the value of the '{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.IAssessmentAndPlanSection#getCDAType <em>CDA Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
