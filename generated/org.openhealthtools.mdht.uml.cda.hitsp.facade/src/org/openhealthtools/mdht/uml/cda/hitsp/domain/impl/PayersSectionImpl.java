...
public class PayersSectionImpl extends EObjectImpl implements IPayersSection {
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPayersSection(), IDomainPackage.eINSTANCE.getPayersSection().getEAllOperations().get(0));
			try {
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPayersSection(), IDomainPackage.eINSTANCE.getPayersSection().getEAllOperations().get(3));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #getCoverageEntries() <em>Get Coverage Entries</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<CoverageEntry> getCoverageEntries() {
		if (GET_COVERAGE_ENTRIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPayersSection(), IDomainPackage.eINSTANCE.getPayersSection().getEAllOperations().get(6));
			try {
