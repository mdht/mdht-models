 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.MedicationTypeImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MedicationTypeImpl extends EObjectImpl implements IMedicationType {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMedicationType();
	}
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getMedicationType(), IDomainPackage.eINSTANCE.getMedicationType().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IMedicationType setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MEDICATION_TYPE__CDA_TYPE:
