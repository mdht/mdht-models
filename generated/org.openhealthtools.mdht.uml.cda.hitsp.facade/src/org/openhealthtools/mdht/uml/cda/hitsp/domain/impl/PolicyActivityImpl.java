...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.ICoveredParty;
...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.IPolicySubscriber;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.PolicyActivityImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PolicyActivityImpl extends EObjectImpl implements IPolicyActivity {
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPolicyActivity(),
				IDomainPackage.eINSTANCE.getPolicyActivity().getEAllOperations().get(0));
			try {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPolicyActivity(),
				IDomainPackage.eINSTANCE.getPolicyActivity().getEAllOperations().get(3));
			try {
	...
	public IPayerEntity getPayerEntity() {
		if (GET_PAYER_ENTITY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPolicyActivity(),
				IDomainPackage.eINSTANCE.getPolicyActivity().getEAllOperations().get(6));
			try {
	...
	public ICoveredParty getCoveredParty() {
		if (GET_COVERED_PARTY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPolicyActivity(),
				IDomainPackage.eINSTANCE.getPolicyActivity().getEAllOperations().get(9));
			try {
	...
	public IPolicySubscriber getSubscriber() {
		if (GET_SUBSCRIBER__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getPolicyActivity(),
				IDomainPackage.eINSTANCE.getPolicyActivity().getEAllOperations().get(12));
			try {
