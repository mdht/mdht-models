...
import org.openhealthtools.mdht.uml.cda.hitsp.domain.ISimpleObservation;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.SimpleObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleObservationImpl extends EObjectImpl implements ISimpleObservation {
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSimpleObservation(),
				IDomainPackage.eINSTANCE.getSimpleObservation().getEAllOperations().get(0));
			try {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getSimpleObservation(),
				IDomainPackage.eINSTANCE.getSimpleObservation().getEAllOperations().get(3));
			try {
