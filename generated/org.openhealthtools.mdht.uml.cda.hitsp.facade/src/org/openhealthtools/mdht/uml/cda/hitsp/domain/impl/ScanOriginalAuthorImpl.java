 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.ScanOriginalAuthorImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ScanOriginalAuthorImpl extends EObjectImpl implements IScanOriginalAuthor {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getScanOriginalAuthor();
	}
	...
	public TS getTime() {
		if (GET_TIME__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getScanOriginalAuthor(),
				IDomainPackage.eINSTANCE.getScanOriginalAuthor().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IScanOriginalAuthor setTime(TS value) {
		this.getCDAType().setTime(value);
		return this;
	}
	...
	public AssignedAuthor getAssignedAuthor() {
		if (GET_ASSIGNED_AUTHOR__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getScanOriginalAuthor(),
				IDomainPackage.eINSTANCE.getScanOriginalAuthor().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IScanOriginalAuthor setAssignedAuthor(AssignedAuthor value) {
		this.getCDAType().setAssignedAuthor(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.SCAN_ORIGINAL_AUTHOR__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
