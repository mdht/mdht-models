 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='CoverageActivityTemplateId CoverageActivityClassCode CoverageActivityMoodCode CoverageActivityId CoverageActivityCode CoverageActivityCodeP CoverageActivityStatusCode CoverageActivityStatusCodeP CoverageActivityPolicyActivity' templateId.root='2.16.840.1.113883.10.20.22.4.60' constraints.validation.info='CoverageActivityCoverageActivityRelationshipSequenceNumber' classCode='ACT' moodCode='EVN' code.code='48768-6' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Payment Sources' constraints.validation.dependOn.CoverageActivityCode='CoverageActivityCodeP' statusCode.code='completed' constraints.validation.dependOn.CoverageActivityStatusCode='CoverageActivityStatusCodeP'"
 * @generated
 */
public interface CoverageActivity extends Act {
	 ...
	 * @generated
	 */
	boolean validateCoverageActivityStatusCodeP(DiagnosticChain diagnostics, Map<Object, Object> context);
