...
public class VitalSignsSectionEntriesOptional2Operations extends VitalSignsSectionEntriesOptionalOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateVitalSignsSectionEntriesOptional2TemplateId(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Vital Signs Section Entries Optional2 Template Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateVitalSignsSectionEntriesOptional2TemplateId(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.2.4' and id.extension.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateVitalSignsSectionEntriesOptional2TemplateId(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Vital Signs Section Entries Optional2 Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateVitalSignsSectionEntriesOptional2TemplateId(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static boolean validateVitalSignsSectionEntriesOptional2TemplateId(
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolValidator.VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL2__VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL2_TEMPLATE_ID,
						ConsolPlugin.INSTANCE.getString(
							"VitalSignsSectionEntriesOptional2VitalSignsSectionEntriesOptional2TemplateId"),
	...
	public static EList<VitalSignsOrganizer2> getConsolVitalSignsOrganizer2s(
		...
		Collection<VitalSignsOrganizer2> result = (Collection<VitalSignsOrganizer2>) query.evaluate(
			vitalSignsSectionEntriesOptional2);
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"VitalSignsSectionEntriesOptional2VitalSignsSectionEntriesOptionalCodeP"),
						new Object[] { vitalSignsSectionEntriesOptional2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"VitalSignsSectionEntriesOptional2VitalSignsSectionEntriesOptionalCode"),
						new Object[] { vitalSignsSectionEntriesOptional2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateVitalSignsSectionEntriesOptionalVitalSignsOrganizer(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Vital Signs Section Entries Optional Vital Signs Organizer</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateVitalSignsSectionEntriesOptionalVitalSignsOrganizer(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL invariant for the '{@link #validateVitalSignsSectionEntriesOptionalVitalSignsOrganizer(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Vital Signs Section Entries Optional Vital Signs Organizer</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateVitalSignsSectionEntriesOptionalVitalSignsOrganizer(VitalSignsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolValidator.VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL2__VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL_VITAL_SIGNS_ORGANIZER,
						ConsolPlugin.INSTANCE.getString(
							"VitalSignsSectionEntriesOptional2VitalSignsSectionEntriesOptionalVitalSignsOrganizer"),
						new Object[] { vitalSignsSectionEntriesOptional2 }));
			}
