...
public class FetusSubjectContextOperations extends RoleOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateFetusSubjectContextCodeP(FetusSubjectContext, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Fetus Subject Context Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateFetusSubjectContextCodeP(FetusSubjectContext, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_FETUS_SUBJECT_CONTEXT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (true)";

	/**
	 * The cached OCL invariant for the '{@link #validateFetusSubjectContextCodeP(FetusSubjectContext, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Fetus Subject Context Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateFetusSubjectContextCodeP(FetusSubjectContext, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_FETUS_SUBJECT_CONTEXT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static boolean validateFetusSubjectContextCodeP(FetusSubjectContext fetusSubjectContext,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		if (VALIDATE_FETUS_SUBJECT_CONTEXT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(ConsolPackage.Literals.FETUS_SUBJECT_CONTEXT);
			try {
				VALIDATE_FETUS_SUBJECT_CONTEXT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_FETUS_SUBJECT_CONTEXT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_FETUS_SUBJECT_CONTEXT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			fetusSubjectContext)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.FETUS_SUBJECT_CONTEXT__FETUS_SUBJECT_CONTEXT_CODE_P,
					ConsolPlugin.INSTANCE.getString("FetusSubjectContextFetusSubjectContextCodeP"),
					new Object[] { fetusSubjectContext }));
			}
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.consol.FetusSubjectContextCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.consol.FetusSubjectContextCodeP", passToken);
				}
				passToken.add(fetusSubjectContext);
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_FETUS_SUBJECT_CONTEXT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (true)";
	...
	public static boolean validateFetusSubjectContextCode(FetusSubjectContext fetusSubjectContext,
		...
		Object passToken = (context == null)
				? null
				: context.get("org.openhealthtools.mdht.uml.cda.consol.FetusSubjectContextCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(fetusSubjectContext)) {
