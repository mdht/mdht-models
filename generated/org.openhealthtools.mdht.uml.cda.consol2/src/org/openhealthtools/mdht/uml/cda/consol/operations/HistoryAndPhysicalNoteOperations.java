...
public class HistoryAndPhysicalNoteOperations extends GeneralHeaderConstraintsOperations {
	...
	public static ReviewOfSystemsSection getReviewOfSystemsSection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		...
		if (GET_REVIEW_OF_SYSTEMS_SECTION__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(383));
			try {
	...
	public static SocialHistorySection getSocialHistorySection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		...
		if (GET_SOCIAL_HISTORY_SECTION__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(384));
			try {
	...
	public static HistoryOfPresentIllnessSection getHistoryOfPresentIllnessSection(
		...
		if (GET_HISTORY_OF_PRESENT_ILLNESS_SECTION__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(385));
			try {
	...
	public static ImmunizationsSectionEntriesOptional getImmunizationsSectionEntriesOptional(
		...
		if (GET_IMMUNIZATIONS_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(386));
			try {
	...
	public static ProblemSectionEntriesOptional getProblemSectionEntriesOptional(
		...
		if (GET_PROBLEM_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(387));
			try {
	...
	public static ProceduresSectionEntriesOptional getProceduresSectionEntriesOptional(
		...
		if (GET_PROCEDURES_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(388));
			try {
	...
	public static VitalSignsSectionEntriesOptional getVitalSignsSectionEntriesOptional(
		...
		if (GET_VITAL_SIGNS_SECTION_ENTRIES_OPTIONAL__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(389));
			try {
	...
	public static InstructionsSection getInstructionsSection(HistoryAndPhysicalNote historyAndPhysicalNote) {
		...
		if (GET_INSTRUCTIONS_SECTION__EOCL_QRY == null) {
			...
			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE, ConsolPackage.Literals.HISTORY_AND_PHYSICAL_NOTE.getEAllOperations().get(390));
			try {
