...
public class HistoryOfPresentIllnessSectionOperations extends SectionOperations {
	...
	public static boolean validateHistoryOfPresentIllnessSectionTemplateId(
		...
		DatatypesUtil.increment(
			context, "HistoryOfPresentIllnessSectionHistoryOfPresentIllnessSectionTemplateId", "ERROR");
		...
		if (VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			try {
				VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				...
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"HistoryOfPresentIllnessSectionHistoryOfPresentIllnessSectionTemplateId"),
	...
	public static boolean validateHistoryOfPresentIllnessSectionCode(
		...
		if (VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.HISTORY_OF_PRESENT_ILLNESS_SECTION);
			try {
				VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				historyOfPresentIllnessSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"HistoryOfPresentIllnessSectionHistoryOfPresentIllnessSectionCode"),
						new Object[] { historyOfPresentIllnessSection }));
			}
	...
	public static boolean validateHistoryOfPresentIllnessSectionCodeP(
		...
		if (VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.HISTORY_OF_PRESENT_ILLNESS_SECTION);
			try {
				VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				historyOfPresentIllnessSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"HistoryOfPresentIllnessSectionHistoryOfPresentIllnessSectionCodeP"),
						new Object[] { historyOfPresentIllnessSection }));
			}
	...
	public static boolean validateHistoryOfPresentIllnessSectionTitle(
		...
		if (VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.HISTORY_OF_PRESENT_ILLNESS_SECTION);
			try {
				VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				historyOfPresentIllnessSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"HistoryOfPresentIllnessSectionHistoryOfPresentIllnessSectionTitle"),
						new Object[] { historyOfPresentIllnessSection }));
			}
	...
	public static boolean validateHistoryOfPresentIllnessSectionText(
		...
		if (VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.HISTORY_OF_PRESENT_ILLNESS_SECTION);
			try {
				VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_HISTORY_OF_PRESENT_ILLNESS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				historyOfPresentIllnessSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"HistoryOfPresentIllnessSectionHistoryOfPresentIllnessSectionText"),
						new Object[] { historyOfPresentIllnessSection }));
			}
