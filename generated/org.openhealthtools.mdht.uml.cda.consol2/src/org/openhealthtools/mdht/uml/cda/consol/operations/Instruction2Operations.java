...
public class Instruction2Operations extends InstructionsOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_INSTRUCTIONS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.4.20.2')";
	...
	public static boolean validateInstructionsTemplateId(Instruction2 instruction2, DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_INSTRUCTIONS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(instruction2)) {
			if (diagnostics != null) {
