...
public interface VitalSignsOrganizer2 extends VitalSignsOrganizer {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.component->exists(component : cda::Component4 | not component.observation.oclIsUndefined() and component.observation.oclIsKindOf(consol::VitalSignObservation2))'"
	 * @generated
	 */
	boolean validateVitalSignsOrganizerVitalSignObservation2(DiagnosticChain diagnostics, Map<Object, Object> context);
