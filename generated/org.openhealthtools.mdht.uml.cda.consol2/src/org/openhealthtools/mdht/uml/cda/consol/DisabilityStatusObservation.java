...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Disability Status Observation</b></em>'.
 * <!-- end-user-doc -->
 *
 *
...
public interface DisabilityStatusObservation extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId-&gt;exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.4.505\' and id.extension = \'2023-05-01\')'"
	 * @generated
	 */
	boolean validateDisabilityStatusObservationTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateDisabilityStatusObservationCodeP(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateDisabilityStatusObservationCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateDisabilityStatusObservationEffectiveTime(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateDisabilityStatusObservationClassCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateDisabilityStatusObservationMoodCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entryRelationship-&gt;exists(entryRelationship : cda::EntryRelationship | not entryRelationship.observation.oclIsUndefined() and entryRelationship.observation.oclIsKindOf(consol::AssessmentScaleObservationV2))'"
	 * @generated
	 */
	boolean validateDisabilityStatusObservationAssessmentScaleObservationV2(DiagnosticChain diagnostics,
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()-&gt;select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::AssessmentScaleObservationV2)).oclAsType(consol::AssessmentScaleObservationV2)'"
	 * @generated
	 */
	EList<AssessmentScaleObservationV2> getAssessmentScaleObservationV2s();
