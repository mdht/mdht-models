...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Entry Reference</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.consol.ConsolPackage#getEntryReference()
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='EntryReferenceTemplateId EntryReferenceClassCode EntryReferenceMoodCode EntryReferenceId EntryReferenceCode EntryReferenceStatusCodeP EntryReferenceIINullFlavor EntryReferenceCDNullFlavor EntryReferenceCDNullFlavorP' templateId.root='2.16.840.1.113883.10.20.22.4.122' classCode='ACT' moodCode='EVN' statusCode.code='completed' constraints.validation.info='EntryReferenceStatusCode' constraints.validation.query='EntryReferenceIINullFlavor EntryReferenceCDNullFlavor EntryReferenceCDNullFlavorP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolEntryReferenceCD nullFlavor='NP' constraints.validation.error='EntryReferenceCDNullFlavor EntryReferenceCDNullFlavorP'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolEntryReferenceII constraints.validation.error='EntryReferenceIINullFlavor'"
 * @generated
 */
public interface EntryReference extends Act {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @generated
	 */
	boolean validateEntryReferenceClassCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateEntryReferenceMoodCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateEntryReferenceCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateEntryReferenceStatusCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateEntryReferenceStatusCodeP(DiagnosticChain diagnostics, Map<Object, Object> context);
