...
public interface HospitalDischargeDiagnosis2 extends HospitalDischargeDiagnosis {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId-&gt;exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.4.33\' and id.extension.oclIsUndefined())'"
	 * @generated
	 */
	boolean validateHospitalDischargeDiagnosis2TemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
