...
public interface DischargeMedicationsSectionEntriesOptional2
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.2.11\' and id.extension.oclIsUndefined())'"
	 * @generated
	 */
	boolean validateDischargeMedicationsSectionEntriesOptional2TemplateId(DiagnosticChain diagnostics,
