 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolReferralNoteParticipantCaregiverAssociatedEntityAssociatedPerson constraints.validation.error='ReferralNoteParticipantCaregiverAssociatedEntityAssociatedPersonName AssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUSRealmPersonNameMixedContent' constraints.validation.query='AssociatedPersonGeneralHeaderConstraintsUSRealmPersonNameUSRealmPersonNameMixedContent'"
...
public interface ReferralNote extends USRealmHeader2 {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.participant-&gt;excluding(null)-&gt;select(typeCode=vocab::ParticipationType::IND).associatedEntity-&gt;excluding(null).associatedPerson-&gt;excluding(null).name-&gt;excluding(null)-&gt;select(isNullFlavorUndefined())-&gt;reject((getText(true)&lt;&gt;\'\' and ( family-&gt;isEmpty() and given-&gt;isEmpty() and suffix-&gt;isEmpty() and prefix-&gt;isEmpty()   )   ) xor (getText(true)=\'\' and (not family-&gt;isEmpty() and not given-&gt;isEmpty()  )))'"
	 * @generated
	 */
