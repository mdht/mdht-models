 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ProblemSectionEntriesOptional2#validateProblemSectionEntriesOptional2TemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Entries Optional2 Template Id</em>}</li>
...
public class ProblemSectionEntriesOptional2Operations extends ProblemSectionEntriesOptionalOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemSectionEntriesOptional2TemplateId(ProblemSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Entries Optional2 Template Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSectionEntriesOptional2TemplateId(ProblemSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_SECTION_ENTRIES_OPTIONAL2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.2.5' and id.extension.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemSectionEntriesOptional2TemplateId(ProblemSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Section Entries Optional2 Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemSectionEntriesOptional2TemplateId(ProblemSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static boolean validateProblemSectionEntriesOptional2TemplateId(
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolValidator.PROBLEM_SECTION_ENTRIES_OPTIONAL2__PROBLEM_SECTION_ENTRIES_OPTIONAL2_TEMPLATE_ID,
						ConsolPlugin.INSTANCE.getString(
							"ProblemSectionEntriesOptional2ProblemSectionEntriesOptional2TemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProblemSectionEntriesOptional2ProblemSectionEntriesOptional2HealthStatusObservation2"),
						new Object[] { problemSectionEntriesOptional2 }));
			}
	...
	public static EList<ProblemConcernAct2> getConsolProblemConcernAct2s(
		...
		Collection<ProblemConcernAct2> result = (Collection<ProblemConcernAct2>) query.evaluate(
			problemSectionEntriesOptional2);
	...
	public static HealthStatusObservation2 getHealthStatusObservation2(
		...
		if (GET_HEALTH_STATUS_OBSERVATION2__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PROBLEM_SECTION_ENTRIES_OPTIONAL2,
				ConsolPackage.Literals.PROBLEM_SECTION_ENTRIES_OPTIONAL2.getEAllOperations().get(65));
			try {
		...
		OCL.Query query = EOCL_ENV.get().createQuery(GET_HEALTH_STATUS_OBSERVATION2__EOCL_QRY);
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProblemSectionEntriesOptional2ProblemSectionEntriesOptionalCodeP"),
						new Object[] { problemSectionEntriesOptional2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProblemSectionEntriesOptional2ProblemSectionEntriesOptionalCode"),
						new Object[] { problemSectionEntriesOptional2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProblemSectionEntriesOptional2ProblemSectionEntriesOptionalProblemConcern"),
						new Object[] { problemSectionEntriesOptional2 }));
			}
