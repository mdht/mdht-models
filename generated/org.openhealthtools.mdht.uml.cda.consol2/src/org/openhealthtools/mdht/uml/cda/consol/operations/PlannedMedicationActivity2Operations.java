...
public class PlannedMedicationActivity2Operations extends PlanOfCareActivitySubstanceAdministrationOperations {
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_EFFECTIVE_TIME_IVLT_SOR_TS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2EffectiveTimeIVLTSorTS(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2EffectiveTimeIVLTSorTS", "ERROR");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_EFFECTIVE_TIME_IVLTS_LOW__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2EffectiveTimeIVLTSLow(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2EffectiveTimeIVLTSLow", "WARNING");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_EFFECTIVE_TIME_IVLTS_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2EffectiveTimeIVLTSHigh(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2EffectiveTimeIVLTSHigh", "INFO");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_EFFECTIVE_TIME_IVLTS_LOW_XOR_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2EffectiveTimeIVLTSLowXorValue(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2EffectiveTimeIVLTSLowXorValue", "ERROR");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_EFFECTIVE_TIME_PIVLTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2EffectiveTimePIVLTS(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2EffectiveTimePIVLTS", "WARNING");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2TemplateId(
		...
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2);
			try {
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PLANNED_MEDICATION_ACTIVITY2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				plannedMedicationActivity2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"PlannedMedicationActivity2PlannedMedicationActivity2TemplateId"),
						new Object[] { plannedMedicationActivity2 }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_REPEAT_NUMBER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ROUTE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ROUTE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_APPROACH_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2ApproachSiteCodeP(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2ApproachSiteCodeP", "INFO");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_APPROACH_SITE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2ApproachSiteCode(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2ApproachSiteCode", "ERROR");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_DOSE_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_RATE_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_MAX_DOSE_QUANTITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ADMINISTRATION_UNIT_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2AdministrationUnitCodeP(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2AdministrationUnitCodeP", "INFO");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_ADMINISTRATION_UNIT_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2AdministrationUnitCode(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2AdministrationUnitCode", "ERROR");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2AuthorParticipation(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2AuthorParticipation", "WARNING");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRIORITY_PREFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2PriorityPreference(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2PriorityPreference", "INFO");
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INDICATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_INSTRUCTION2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CONSUMABLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRECONDITION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION_P__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2CETranslationP(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2CETranslationP", "WARNING");
		...
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION_P__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.get() == null) {
			...
			try {
				...
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION_P__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.set(
		...
		Object oclResult = VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION_P__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.get().evaluate(
			plannedMedicationActivity2);
		if (oclResult != null && oclResult instanceof Collection) {
			...
			if (diagnostics != null) {
				for (EObject eObject : oclResultSet) {
					diagnostics.add(
						new BasicDiagnostic(
							...
							ConsolPlugin.INSTANCE.getString(
								"PlannedMedicationActivity2PlannedMedicationActivity2CETranslationP"),
							new Object[] { eObject }));
				}
				...
				if (context != null) {
					// generate a pass token for my dependent constraints to short-circuit or filter results
					Collection<Object> passToken = (Collection<Object>) context.get(
						"org.openhealthtools.mdht.uml.cda.consol.PlannedMedicationActivity2CETranslationP");
					if (passToken == null) {
						// anticipate a reasonably healthy model
						passToken = new java.util.ArrayList<>(3);
						context.put(
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2CETranslation(
		...
		if (VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.get() == null) {
			...
			try {
				...
				VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.set(
					EOCL_ENV.get().createQuery(oclExpression));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		Object oclResult = VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CE_TRANSLATION__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY.get().evaluate(
			plannedMedicationActivity2);
		if (oclResult != null && oclResult instanceof Collection) {
			Collection<? extends EObject> oclResultSet = (Collection<? extends EObject>) oclResult;
			...
			Object passFilter = (context == null)
					? null
					: context.get("org.openhealthtools.mdht.uml.cda.consol.PlannedMedicationActivity2CETranslationP");
				...
				for (EObject eObject : oclResultSet) {
					diagnostics.add(
						new BasicDiagnostic(
							...
							ConsolPlugin.INSTANCE.getString(
								"PlannedMedicationActivity2PlannedMedicationActivity2CETranslation"),
							new Object[] { eObject }));
				}
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_IVLP_QDOSE_QUANTITY_UNIT__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2IVLPQdoseQuantityUnit(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2IVLPQdoseQuantityUnit", "WARNING");
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_IVLP_QRATE_QUANTITY_UNIT__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2IVLPQrateQuantityUnit(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2IVLPQrateQuantityUnit", "WARNING");
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_CONSUMABLE_MEDICATION_INFORMATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2ConsumableMedicationInformation2(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2ConsumableMedicationInformation2", "ERROR");
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRECONDITION_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static boolean validatePlannedMedicationActivity2PreconditionTypeCode(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlannedMedicationActivity2PreconditionTypeCode", "ERROR");
	...
	protected static ThreadLocal<Query<?, ?, ?>> VALIDATE_PLANNED_MEDICATION_ACTIVITY2_PRECONDITION_PRECONDITION_FOR_SUBSTANCE_ADMINISTRATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_QRY = new ThreadLocal<>();
	...
	public static EList<PriorityPreference> getPriorityPreferences(
		...
		if (GET_PRIORITY_PREFERENCES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2.getEAllOperations().get(88));
			try {
	...
	public static EList<Indication2> getIndication2s(PlannedMedicationActivity2 plannedMedicationActivity2) {
		...
		if (GET_INDICATION2S__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2,
				ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2.getEAllOperations().get(89));
			try {
	...
	public static EList<Instruction2> getInstruction2s(PlannedMedicationActivity2 plannedMedicationActivity2) {
		...
		if (GET_INSTRUCTION2S__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2,
				ConsolPackage.Literals.PLANNED_MEDICATION_ACTIVITY2.getEAllOperations().get(90));
			try {
	...
	protected static ThreadLocal<Constraint> VALIDATE_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validatePlanOfCareActivitySubstanceAdministrationMoodCode(
		...
		DatatypesUtil.increment(
			context, "PlannedMedicationActivity2PlanOfCareActivitySubstanceAdministrationMoodCode", "ERROR");
