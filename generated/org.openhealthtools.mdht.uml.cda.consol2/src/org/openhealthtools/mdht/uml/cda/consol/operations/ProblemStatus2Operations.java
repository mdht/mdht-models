...
public class ProblemStatus2Operations extends ProblemStatusOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemStatusTemplateId(ProblemStatus2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Status Template Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemStatusTemplateId(ProblemStatus2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_STATUS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.4.6' and id.extension = '2014-06-09')";

	/**
	 * The cached OCL invariant for the '{@link #validateProblemStatusTemplateId(ProblemStatus2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Status Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemStatusTemplateId(ProblemStatus2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static boolean validateProblemStatusTemplateId(ProblemStatus2 problemStatus2, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PROBLEM_STATUS_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(problemStatus2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
						ConsolValidator.PROBLEM_STATUS2__PROBLEM_STATUS_TEMPLATE_ID,
						ConsolPlugin.INSTANCE.getString("ProblemStatus2ProblemStatusTemplateId"),
						new Object[] { problemStatus2 }));
			}
