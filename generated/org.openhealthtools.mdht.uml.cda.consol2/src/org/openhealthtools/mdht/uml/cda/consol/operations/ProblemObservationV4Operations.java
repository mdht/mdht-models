...
public class ProblemObservationV4Operations extends ProblemObservation2Operations {
	...
	public static boolean validateProblemObservationV4Code(ProblemObservationV4 problemObservationV4,
		...
		DatatypesUtil.increment(context, "ProblemObservationV4ProblemObservationV4Code", "ERROR");
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROBLEM_OBSERVATION_V4_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.oclIsUndefined() or self.statusCode.isNullFlavorUndefined()) implies (not self.statusCode.oclIsUndefined())";
