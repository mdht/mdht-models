...
public interface AdmissionMedicationsSectionEntriesOptional2
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.2.44\' and id.extension.oclIsUndefined())'"
	 * @generated
	 */
	boolean validateAdmissionMedicationsSectionEntriesOptional2TemplateId(DiagnosticChain diagnostics,
