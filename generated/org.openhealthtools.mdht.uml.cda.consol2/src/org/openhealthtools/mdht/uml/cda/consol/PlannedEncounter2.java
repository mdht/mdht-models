...
public interface PlannedEncounter2 extends PlanOfCareActivityEncounter {
	 ...
	 * <!-- end-user-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(consol::ProviderPriorityPreference))->asSequence()->any(true).oclAsType(consol::ProviderPriorityPreference)'"
	 * @generated
	 */
	ProviderPriorityPreference getPriorityPreference();
