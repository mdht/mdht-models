...
public class FunctionalStatusSectionOperations extends SectionOperations {
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionTitle(FunctionalStatusSection functionalStatusSection,
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(VALIDATE_FUNCTIONAL_STATUS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_TITLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionText(FunctionalStatusSection functionalStatusSection,
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(VALIDATE_FUNCTIONAL_STATUS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_RESULT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionFunctionalStatusResultOrganizer(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionFunctionalStatusResultOrganizer", "INFO");
				...
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionFunctionalStatusResultOrganizer"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_RESULT_ORGANIZER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionCognitiveStatusResultOrganizer(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionCognitiveStatusResultOrganizer", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionCognitiveStatusResultOrganizer"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionFunctionalStatusResultObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionFunctionalStatusResultObservation", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionFunctionalStatusResultObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_RESULT_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionCognitiveStatusResultObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionCognitiveStatusResultObservation", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionCognitiveStatusResultObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionFunctionalStatusProblemObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionFunctionalStatusProblemObservation", "INFO");
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_FUNCTIONAL_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionFunctionalStatusProblemObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionCognitiveStatusProblemObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionCognitiveStatusProblemObservation", "INFO");
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_COGNITIVE_STATUS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionCognitiveStatusProblemObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_CAREGIVER_CHARACTERISTICS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionCaregiverCharacteristics(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionCaregiverCharacteristics", "INFO");
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_CAREGIVER_CHARACTERISTICS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_CAREGIVER_CHARACTERISTICS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_FUNCTIONAL_STATUS_SECTION_CAREGIVER_CHARACTERISTICS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_CAREGIVER_CHARACTERISTICS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionCaregiverCharacteristics"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_ASSESSMENT_SCALE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionAssessmentScaleObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionAssessmentScaleObservation", "INFO");
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_ASSESSMENT_SCALE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_ASSESSMENT_SCALE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_FUNCTIONAL_STATUS_SECTION_ASSESSMENT_SCALE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_ASSESSMENT_SCALE_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionAssessmentScaleObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_NON_MEDICINAL_SUPPLY_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionNonMedicinalSupplyActivity(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionNonMedicinalSupplyActivity", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionNonMedicinalSupplyActivity"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_PRESSURE_ULCER_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionPressureUlcerObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionPressureUlcerObservation", "INFO");
		...
		if (VALIDATE_FUNCTIONAL_STATUS_SECTION_PRESSURE_ULCER_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.FUNCTIONAL_STATUS_SECTION);
			try {
				VALIDATE_FUNCTIONAL_STATUS_SECTION_PRESSURE_ULCER_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_FUNCTIONAL_STATUS_SECTION_PRESSURE_ULCER_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_FUNCTIONAL_STATUS_SECTION_PRESSURE_ULCER_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				functionalStatusSection)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionPressureUlcerObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_NUMBER_OF_PRESSURE_ULCERS_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionNumberOfPressureUlcersObservation(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionNumberOfPressureUlcersObservation", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionNumberOfPressureUlcersObservation"),
						new Object[] { functionalStatusSection }));
			}
	...
	protected static ThreadLocal<Constraint> VALIDATE_FUNCTIONAL_STATUS_SECTION_HIGHEST_PRESSURE_ULCER_STAGE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static boolean validateFunctionalStatusSectionHighestPressureUlcerStage(
		...
		DatatypesUtil.increment(
			context, "FunctionalStatusSectionFunctionalStatusSectionHighestPressureUlcerStage", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"FunctionalStatusSectionFunctionalStatusSectionHighestPressureUlcerStage"),
						new Object[] { functionalStatusSection }));
			}
	...
	public static EList<FunctionalStatusResultOrganizer> getFunctionalStatusResultOrganizers(
		...
		if (GET_FUNCTIONAL_STATUS_RESULT_ORGANIZERS__EOCL_QRY == null) {
			...
			try {
				GET_FUNCTIONAL_STATUS_RESULT_ORGANIZERS__EOCL_QRY = helper.createQuery(
					GET_FUNCTIONAL_STATUS_RESULT_ORGANIZERS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		Collection<FunctionalStatusResultOrganizer> result = (Collection<FunctionalStatusResultOrganizer>) query.evaluate(
			functionalStatusSection);
	...
	public static EList<CognitiveStatusResultOrganizer> getCognitiveStatusResultOrganizers(
		...
		if (GET_COGNITIVE_STATUS_RESULT_ORGANIZERS__EOCL_QRY == null) {
			...
			try {
				GET_COGNITIVE_STATUS_RESULT_ORGANIZERS__EOCL_QRY = helper.createQuery(
					GET_COGNITIVE_STATUS_RESULT_ORGANIZERS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
	...
	public static EList<FunctionalStatusResultObservation> getFunctionalStatusResultObservations(
		...
		if (GET_FUNCTIONAL_STATUS_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			...
			try {
				GET_FUNCTIONAL_STATUS_RESULT_OBSERVATIONS__EOCL_QRY = helper.createQuery(
					GET_FUNCTIONAL_STATUS_RESULT_OBSERVATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		@SuppressWarnings("unchecked")
		Collection<FunctionalStatusResultObservation> result = (Collection<FunctionalStatusResultObservation>) query.evaluate(
			functionalStatusSection);
		return new BasicEList.UnmodifiableEList<>(result.size(), result.toArray());
	}
	...
	public static EList<CognitiveStatusResultObservation> getCognitiveStatusResultObservations(
		...
		if (GET_COGNITIVE_STATUS_RESULT_OBSERVATIONS__EOCL_QRY == null) {
			...
			try {
				GET_COGNITIVE_STATUS_RESULT_OBSERVATIONS__EOCL_QRY = helper.createQuery(
					GET_COGNITIVE_STATUS_RESULT_OBSERVATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
	...
	public static EList<FunctionalStatusProblemObservation> getFunctionalStatusProblemObservations(
		...
		if (GET_FUNCTIONAL_STATUS_PROBLEM_OBSERVATIONS__EOCL_QRY == null) {
			...
			try {
				GET_FUNCTIONAL_STATUS_PROBLEM_OBSERVATIONS__EOCL_QRY = helper.createQuery(
					GET_FUNCTIONAL_STATUS_PROBLEM_OBSERVATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		@SuppressWarnings("unchecked")
		Collection<FunctionalStatusProblemObservation> result = (Collection<FunctionalStatusProblemObservation>) query.evaluate(
			functionalStatusSection);
		return new BasicEList.UnmodifiableEList<>(result.size(), result.toArray());
	}
	...
	public static EList<CognitiveStatusProblemObservation> getCognitiveStatusProblemObservations(
		...
		if (GET_COGNITIVE_STATUS_PROBLEM_OBSERVATIONS__EOCL_QRY == null) {
			...
			try {
				GET_COGNITIVE_STATUS_PROBLEM_OBSERVATIONS__EOCL_QRY = helper.createQuery(
					GET_COGNITIVE_STATUS_PROBLEM_OBSERVATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		@SuppressWarnings("unchecked")
		Collection<CognitiveStatusProblemObservation> result = (Collection<CognitiveStatusProblemObservation>) query.evaluate(
			functionalStatusSection);
		return new BasicEList.UnmodifiableEList<>(result.size(), result.toArray());
	}
	...
	public static EList<PressureUlcerObservation> getPressureUlcerObservations(
		...
		if (GET_PRESSURE_ULCER_OBSERVATIONS__EOCL_QRY == null) {
			...
			try {
				GET_PRESSURE_ULCER_OBSERVATIONS__EOCL_QRY = helper.createQuery(
					GET_PRESSURE_ULCER_OBSERVATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
	...
	public static EList<NumberOfPressureUlcersObservation> getNumberOfPressureUlcersObservations(
		...
		if (GET_NUMBER_OF_PRESSURE_ULCERS_OBSERVATIONS__EOCL_QRY == null) {
			...
			try {
				GET_NUMBER_OF_PRESSURE_ULCERS_OBSERVATIONS__EOCL_QRY = helper.createQuery(
					GET_NUMBER_OF_PRESSURE_ULCERS_OBSERVATIONS__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
	...
	public static EList<HighestPressureUlcerStage> getHighestPressureUlcerStages(
		...
		if (GET_HIGHEST_PRESSURE_ULCER_STAGES__EOCL_QRY == null) {
			...
			try {
				GET_HIGHEST_PRESSURE_ULCER_STAGES__EOCL_QRY = helper.createQuery(
					GET_HIGHEST_PRESSURE_ULCER_STAGES__EOCL_EXP);
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
