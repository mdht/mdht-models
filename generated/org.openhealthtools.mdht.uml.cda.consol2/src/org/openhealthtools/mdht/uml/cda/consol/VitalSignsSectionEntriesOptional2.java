...
public interface VitalSignsSectionEntriesOptional2 extends VitalSignsSectionEntriesOptional {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.2.4\' and id.extension.oclIsUndefined())'"
	 * @generated
	 */
	boolean validateVitalSignsSectionEntriesOptional2TemplateId(DiagnosticChain diagnostics,
