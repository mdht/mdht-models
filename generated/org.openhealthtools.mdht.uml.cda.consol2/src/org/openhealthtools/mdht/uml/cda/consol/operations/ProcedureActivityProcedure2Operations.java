...
public class ProcedureActivityProcedure2Operations extends ProcedureActivityProcedureOperations {
	...
	public static boolean validateProcedureActivityProcedure2CodeSuggestedCodeSystems(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedure2CodeSuggestedCodeSystems", "INFO");
		...
		if (VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_CODE_SUGGESTED_CODE_SYSTEMS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			try {
				VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_CODE_SUGGESTED_CODE_SYSTEMS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_CODE_SUGGESTED_CODE_SYSTEMS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				...
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedure2CodeSuggestedCodeSystems"),
	...
	public static boolean validateProcedureActivityProcedure2TemplateId(
		...
		if (VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE2);
			try {
				VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
						VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				procedureActivityProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedure2TemplateId"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureStatusCodeP(
		...
		if (VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE2);
			try {
				VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				procedureActivityProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureStatusCodeP"),
						new Object[] { procedureActivityProcedure2 }));
			}
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get(
					"org.openhealthtools.mdht.uml.cda.consol.ProcedureActivityProcedureStatusCodeP");
				if (passToken == null) {
	...
	public static boolean validateProcedureActivityProcedure2AuthorParticipation(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedure2AuthorParticipation", "WARNING");
		...
		if (VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE2);
			try {
				VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_AUTHOR_PARTICIPATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				procedureActivityProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedure2AuthorParticipation"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedure2ReactionObservation2(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedure2ReactionObservation2", "INFO");
		...
		if (VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_REACTION_OBSERVATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE2);
			try {
				VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_REACTION_OBSERVATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_PROCEDURE_ACTIVITY_PROCEDURE2_REACTION_OBSERVATION2__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(
				procedureActivityProcedure2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedure2ReactionObservation2"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static EList<ReactionObservation2> getReactionObservation2s(
		...
		if (GET_REACTION_OBSERVATION2S__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE2,
				ConsolPackage.Literals.PROCEDURE_ACTIVITY_PROCEDURE2.getEAllOperations().get(110));
			try {
	...
	public static boolean validateProcedureActivityProcedureInstructionsInversion(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureInstructionsInversion", "ERROR");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureInstructionsInversion"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureCodeCodeSystems(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureCodeCodeSystems", "WARNING");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureCodeCodeSystems"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureServiceDeliveryLocationTypeCode(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureServiceDeliveryLocationTypeCode", "ERROR");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureServiceDeliveryLocationTypeCode"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureTargetSiteCodeP(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureTargetSiteCodeP", "WARNING");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureTargetSiteCodeP"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureTargetSiteCode(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureTargetSiteCode", "ERROR");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureTargetSiteCode"),
						new Object[] { procedureActivityProcedure2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureMoodCode"),
						new Object[] { procedureActivityProcedure2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureStatusCode"),
						new Object[] { procedureActivityProcedure2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureIndication"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureMedicationActivity(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureMedicationActivity", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureMedicationActivity"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedurePatientInstruction(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedurePatientInstruction", "INFO");
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedurePatientInstruction"),
						new Object[] { procedureActivityProcedure2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedureSpecimen"),
						new Object[] { procedureActivityProcedure2 }));
			}
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolPlugin.INSTANCE.getString(
							"ProcedureActivityProcedure2ProcedureActivityProcedurePerformer"),
						new Object[] { procedureActivityProcedure2 }));
			}
	...
	public static boolean validateProcedureActivityProcedureProcedureActivityPerformerProcedureActivityAssignedEntityAddr(
		...
		DatatypesUtil.increment(
			context,
			"ProcedureActivityProcedure2ProcedureActivityProcedureProcedureActivityPerformerProcedureActivityAssignedEntityAddr",
			"ERROR");
	...
	public static boolean validateProcedureActivityProcedureProcedureActivityPerformerProcedureActivityAssignedEntityTelecom(
		...
		DatatypesUtil.increment(
			context,
			"ProcedureActivityProcedure2ProcedureActivityProcedureProcedureActivityPerformerProcedureActivityAssignedEntityTelecom",
			"ERROR");
	...
	public static boolean validateProcedureActivityProcedureProcedureActivityPerformerAssignedEntity(
		...
		DatatypesUtil.increment(
			context, "ProcedureActivityProcedure2ProcedureActivityProcedureProcedureActivityPerformerAssignedEntity",
			"ERROR");
