 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ImmunizationsSectionEntriesOptional2TemplateId ImmunizationsSectionEntriesOptionalCode ImmunizationsSectionEntriesOptionalCodeP' templateId.root='2.16.840.1.113883.10.20.22.2.2' templateId.extension='2015-08-01' constraints.validation.dependOn.ImmunizationsSectionEntriesOptionalCode='ImmunizationsSectionEntriesOptionalCodeP' constraints.validation.warning='ImmunizationsSectionEntriesOptionalImmunizationActivity'"
 * @generated
 */
public interface ImmunizationsSectionEntriesOptional2 extends ImmunizationsSectionEntriesOptional {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.2.2\' and id.extension.oclIsUndefined())'"
	 * @generated
	 */
	boolean validateImmunizationsSectionEntriesOptional2TemplateId(DiagnosticChain diagnostics,
