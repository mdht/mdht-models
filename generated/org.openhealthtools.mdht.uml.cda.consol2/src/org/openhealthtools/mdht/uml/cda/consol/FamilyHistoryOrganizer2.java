 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='FamilyHistoryOrganizer2TemplateId FamilyHistoryOrganizer2Id FamilyHistoryOrganizerFamilyHistoryObservation' templateId.root='2.16.840.1.113883.10.20.22.4.45' templateId.extension='2015-08-01'"
 * @generated
 */
public interface FamilyHistoryOrganizer2 extends FamilyHistoryOrganizer {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.22.4.45\' and id.extension.oclIsUndefined())'"
	 * @generated
	 */
	boolean validateFamilyHistoryOrganizer2TemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
