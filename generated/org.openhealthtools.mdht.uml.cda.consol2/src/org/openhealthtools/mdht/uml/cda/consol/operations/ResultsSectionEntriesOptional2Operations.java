...
public class ResultsSectionEntriesOptional2Operations extends ResultsSectionEntriesOptionalOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateResultsSectionEntriesOptional2TemplateId(ResultsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Results Section Entries Optional2 Template Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResultsSectionEntriesOptional2TemplateId(ResultsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_RESULTS_SECTION_ENTRIES_OPTIONAL2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.2.3' and id.extension.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateResultsSectionEntriesOptional2TemplateId(ResultsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Results Section Entries Optional2 Template Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateResultsSectionEntriesOptional2TemplateId(ResultsSectionEntriesOptional2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static boolean validateResultsSectionEntriesOptional2TemplateId(
			...
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						...
						ConsolValidator.RESULTS_SECTION_ENTRIES_OPTIONAL2__RESULTS_SECTION_ENTRIES_OPTIONAL2_TEMPLATE_ID,
						ConsolPlugin.INSTANCE.getString(
							"ResultsSectionEntriesOptional2ResultsSectionEntriesOptional2TemplateId"),
	...
	public static EList<ResultOrganizer2> getConsolResultOrganizer2s(
		...
		if (GET_CONSOL_RESULT_ORGANIZER2S__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				ConsolPackage.Literals.RESULTS_SECTION_ENTRIES_OPTIONAL2.getEAllOperations().get(63));
			try {
		...
		Collection<ResultOrganizer2> result = (Collection<ResultOrganizer2>) query.evaluate(
			resultsSectionEntriesOptional2);
