...
public class CareTeamMemberActV2Operations extends ClinicalStatementOperations {
	...
	public static boolean validateCareTeamMemberActV2Id(CareTeamMemberActV2 careTeamMemberActV2,
			DiagnosticChain diagnostics, Map<Object, Object> context) {

		DatatypesUtil.increment(context, "CareTeamMemberActV2CareTeamMemberActV2Id", "ERROR");

		if (VALIDATE_CARE_TEAM_MEMBER_ACT_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {

			OCL.Helper helper = EOCL_ENV.get().createOCLHelper();
			helper.setContext(ConsolPackage.Literals.CARE_TEAM_MEMBER_ACT_V2);
			try {
				VALIDATE_CARE_TEAM_MEMBER_ACT_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(
					helper.createInvariant(VALIDATE_CARE_TEAM_MEMBER_ACT_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			} catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		...
		if (!EOCL_ENV.get().createQuery(
			VALIDATE_CARE_TEAM_MEMBER_ACT_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(careTeamMemberActV2)) {
			if (diagnostics != null) {
				diagnostics.add(
					new BasicDiagnostic(
						Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
						ConsolValidator.CARE_TEAM_MEMBER_ACT_V2__CARE_TEAM_MEMBER_ACT_V2_ID,
						ConsolPlugin.INSTANCE.getString("CareTeamMemberActV2CareTeamMemberActV2Id"),
						new Object[] { careTeamMemberActV2 }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateCareTeamMemberActV2Id(CareTeamMemberActV2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Care Team Member Act V2 Id</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCareTeamMemberActV2Id(CareTeamMemberActV2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_CARE_TEAM_MEMBER_ACT_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.id->isEmpty() or self.id->exists(element | element.isNullFlavorUndefined())) implies (self.id->size() =  1)";

	/**
	 * The cached OCL invariant for the '{@link #validateCareTeamMemberActV2Id(CareTeamMemberActV2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Care Team Member Act V2 Id</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateCareTeamMemberActV2Id(CareTeamMemberActV2, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static ThreadLocal<Constraint> VALIDATE_CARE_TEAM_MEMBER_ACT_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new ThreadLocal<>();
	...
	public static EList<NoteActivity> getNoteActivities(CareTeamMemberActV2 careTeamMemberActV2) {
		...
		if (GET_NOTE_ACTIVITIES__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.CARE_TEAM_MEMBER_ACT_V2,
				ConsolPackage.Literals.CARE_TEAM_MEMBER_ACT_V2.getEAllOperations().get(63));
			try {
