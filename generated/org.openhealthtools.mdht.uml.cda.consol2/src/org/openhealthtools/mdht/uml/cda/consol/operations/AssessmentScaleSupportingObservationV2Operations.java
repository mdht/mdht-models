...
public class AssessmentScaleSupportingObservationV2Operations extends ClinicalStatementOperations {
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2TemplateId","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2TemplateId"),
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2Id","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2Id"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
	...
	public static  boolean validateAssessmentScaleSupportingObservationV2StatusCodeP(AssessmentScaleSupportingObservationV2 assessmentScaleSupportingObservationV2, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2StatusCodeP","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2StatusCodeP"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.consol.AssessmentScaleSupportingObservationV2StatusCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.consol.AssessmentScaleSupportingObservationV2StatusCodeP", passToken);
				}
...
"value.code = 'completed')";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	public static boolean validateAssessmentScaleSupportingObservationV2StatusCode(
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.consol.AssessmentScaleSupportingObservationV2StatusCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(assessmentScaleSupportingObservationV2)) {
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2StatusCode","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2StatusCode"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2Value","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2Value"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
	...
	public static  boolean validateAssessmentScaleSupportingObservationV2CodeP(AssessmentScaleSupportingObservationV2 assessmentScaleSupportingObservationV2, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2CodeP","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2CodeP"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
			...
			if (context != null) {
				// generate a pass token for my dependent constraints to short-circuit or filter results
				@SuppressWarnings("unchecked")
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.consol.AssessmentScaleSupportingObservationV2CodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.consol.AssessmentScaleSupportingObservationV2CodeP", passToken);
				}
				passToken.add(assessmentScaleSupportingObservationV2);
			}
	...
	public static  boolean validateAssessmentScaleSupportingObservationV2Code(AssessmentScaleSupportingObservationV2 assessmentScaleSupportingObservationV2, DiagnosticChain diagnostics, Map<Object, Object> context) {
	
	
	
  	  
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.consol.AssessmentScaleSupportingObservationV2CodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(assessmentScaleSupportingObservationV2)) {
			// I have a free pass to short-circuit
			return true;
		}
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2Code","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2Code"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2ClassCode","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2ClassCode"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = new  ThreadLocal<  Constraint>();
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
...
"value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	protected static ThreadLocal<  Constraint> VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV=new  ThreadLocal<  Constraint>();
    ...
    DatatypesUtil.increment(context,"AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2MoodCode","ERROR");
		...
		if (VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get() == null) {
			...
			helper.setContext(ConsolPackage.Literals.ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2);
			try {
				VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ASSESSMENT_SCALE_SUPPORTING_OBSERVATION_V2_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(assessmentScaleSupportingObservationV2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("AssessmentScaleSupportingObservationV2AssessmentScaleSupportingObservationV2MoodCode"),
						 new Object [] { assessmentScaleSupportingObservationV2 }));
			}
