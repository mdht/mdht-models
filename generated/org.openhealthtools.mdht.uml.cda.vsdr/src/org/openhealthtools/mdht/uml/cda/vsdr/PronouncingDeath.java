...
public interface PronouncingDeath extends Observation
{
   ...
   * <!-- end-model-doc -->
   * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.113883.10.20.26.1.15\')'"
   * @generated
   */
   ...
   * @generated
   */
  boolean validatePronouncingDeathPronouncerPronouncerRoleAddr(DiagnosticChain diagnostics, Map<Object, Object> context);
