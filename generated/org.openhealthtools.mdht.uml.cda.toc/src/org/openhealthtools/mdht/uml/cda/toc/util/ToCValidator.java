...
public class ToCValidator extends EObjectValidator {
	...
	* <!-- end-user-doc -->
	...
	public boolean validateDischargeSummary(DischargeSummary dischargeSummary, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(dischargeSummary, diagnostics, context);
	...
	* <!-- end-user-doc -->
	...
	public boolean validateDischargeInstructions(DischargeInstructions dischargeInstructions,
		...
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(dischargeInstructions, diagnostics, context);
	...
	* <!-- end-user-doc -->
	...
	public boolean validateConsultationSummary(ConsultationSummary consultationSummary, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(consultationSummary, diagnostics, context);
	...
	* <!-- end-user-doc -->
	...
	public boolean validateConsultationRequest(ConsultationRequest consultationRequest, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(consultationRequest, diagnostics, context);
