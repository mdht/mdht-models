 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityHasTextReference(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Has Text Reference</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Class Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityMoodCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Mood Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityText(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Text</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityStatusCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Status Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Severity#validateSeverityValue(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Severity Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SeverityOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateSeverityHasTextReference(Severity severity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_SEVERITY_HAS_TEXT_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(TOCPackage.Literals.SEVERITY);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 TOCValidator.SEVERITY__SEVERITY_HAS_TEXT_REFERENCE,
						 TOCPlugin.INSTANCE.getString("SeverityHasTextReference"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_TEMPLATE_ID,
						 TOCPlugin.INSTANCE.getString("SeverityTemplateId"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_CLASS_CODE,
						 TOCPlugin.INSTANCE.getString("SeverityClassCode"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_MOOD_CODE,
						 TOCPlugin.INSTANCE.getString("SeverityMoodCode"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_CODE,
						 TOCPlugin.INSTANCE.getString("SeverityCode"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_TEXT,
						 TOCPlugin.INSTANCE.getString("SeverityText"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_STATUS_CODE,
						 TOCPlugin.INSTANCE.getString("SeverityStatusCode"),
						 new Object [] { severity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.SEVERITY__SEVERITY_VALUE,
						 TOCPlugin.INSTANCE.getString("SeverityValue"),
						 new Object [] { severity }));
			}
			return false;
		}
