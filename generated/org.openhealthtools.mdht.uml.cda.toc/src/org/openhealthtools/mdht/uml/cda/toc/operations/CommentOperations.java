 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentHasTextReference(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Has Text Reference</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentEffectiveTimeWhenAuthorPresent(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Effective Time When Author Present</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Class Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentMoodCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Mood Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentText(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Text</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.Comment#validateCommentStatusCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Comment Status Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommentOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateCommentHasTextReference(Comment comment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_COMMENT_HAS_TEXT_REFERENCE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(TOCPackage.Literals.COMMENT);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 TOCValidator.COMMENT__COMMENT_HAS_TEXT_REFERENCE,
						 TOCPlugin.INSTANCE.getString("CommentHasTextReference"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_EFFECTIVE_TIME_WHEN_AUTHOR_PRESENT,
						 TOCPlugin.INSTANCE.getString("CommentEffectiveTimeWhenAuthorPresent"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_TEMPLATE_ID,
						 TOCPlugin.INSTANCE.getString("CommentTemplateId"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_CLASS_CODE,
						 TOCPlugin.INSTANCE.getString("CommentClassCode"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_MOOD_CODE,
						 TOCPlugin.INSTANCE.getString("CommentMoodCode"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_CODE,
						 TOCPlugin.INSTANCE.getString("CommentCode"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_TEXT,
						 TOCPlugin.INSTANCE.getString("CommentText"),
						 new Object [] { comment }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.COMMENT__COMMENT_STATUS_CODE,
						 TOCPlugin.INSTANCE.getString("CommentStatusCode"),
						 new Object [] { comment }));
			}
			return false;
		}
