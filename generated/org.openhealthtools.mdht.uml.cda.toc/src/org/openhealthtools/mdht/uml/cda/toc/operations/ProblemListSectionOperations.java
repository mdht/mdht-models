 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.ProblemListSection#validateProblemListSectionTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem List Section Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.ProblemListSection#validateProblemListSectionCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem List Section Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.ProblemListSection#validateProblemListSectionTitle(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem List Section Title</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.ProblemListSection#validateProblemListSectionText(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem List Section Text</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.ProblemListSection#getConditions() <em>Get Conditions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProblemListSectionOperations extends SectionOperations {
	...
	public static  boolean validateProblemListSectionTemplateId(ProblemListSection problemListSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_PROBLEM_LIST_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(TOCPackage.Literals.PROBLEM_LIST_SECTION);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 TOCValidator.PROBLEM_LIST_SECTION__PROBLEM_LIST_SECTION_TEMPLATE_ID,
						 TOCPlugin.INSTANCE.getString("ProblemListSectionTemplateId"),
...
"value.code = '11450-4' and value.codeSystem = '2.16.840.1.113883.6.1'))";
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.PROBLEM_LIST_SECTION__PROBLEM_LIST_SECTION_CODE,
						 TOCPlugin.INSTANCE.getString("ProblemListSectionCode"),
						 new Object [] { problemListSection }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.PROBLEM_LIST_SECTION__PROBLEM_LIST_SECTION_TITLE,
						 TOCPlugin.INSTANCE.getString("ProblemListSectionTitle"),
						 new Object [] { problemListSection }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TOCValidator.DIAGNOSTIC_SOURCE,
						 TOCValidator.PROBLEM_LIST_SECTION__PROBLEM_LIST_SECTION_TEXT,
						 TOCPlugin.INSTANCE.getString("ProblemListSectionText"),
						 new Object [] { problemListSection }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static final String GET_CONDITIONS__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(toc::Condition)).oclAsType(toc::Condition)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(toc::Condition)).oclAsType(toc::Condition)
	 * @param problemListSection The receiving '<em><b>Problem List Section</b></em>' model object.
	 * <!-- end-model-doc -->
	 * @generated
	 */
	public static  EList<Condition> getConditions(ProblemListSection problemListSection) {
		if (GET_CONDITIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(TOCPackage.Literals.PROBLEM_LIST_SECTION, TOCPackage.Literals.PROBLEM_LIST_SECTION.getEAllOperations().get(59));
			try {
