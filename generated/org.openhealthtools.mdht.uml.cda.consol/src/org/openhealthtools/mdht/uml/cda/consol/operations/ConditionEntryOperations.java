...
"   and rel.observation.code.code = '48766-0'))";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CONDITION_ENTRY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.21.4.4')";
...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
	...
	public static  AgeObservation getAgeObservation(ConditionEntry conditionEntry) {
		if (GET_AGE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.CONDITION_ENTRY, ConsolPackage.Literals.CONDITION_ENTRY.getEAllOperations().get(69));
			try {
