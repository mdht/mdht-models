...
"value.code = '48765-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static EList<AllergyProblemAct> getAllergyProblemActs(
		...
		if (GET_ALLERGY_PROBLEM_ACTS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.ALLERGIES_SECTION_ENTRIES_OPTIONAL, ConsolPackage.Literals.ALLERGIES_SECTION_ENTRIES_OPTIONAL.getEAllOperations().get(60));
			try {
