 ...
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.consol.ConsolPackage#getPurposeSection()
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='LOINC' constraints.validation.error='PurposeSectionTemplateId PurposeSectionCode PurposeSectionTitle PurposeSectionText' templateId.root='2.16.840.1.113883.10.20.1.13' code.displayName='Summary purpose' code.codeSystem='2.16.840.1.113883.6.1' code.code='48764-5' constraints.validation.warning='PurposeSectionPurposeActivity'"
 * @generated
 */
public interface PurposeSection extends Section {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->exists(entry : cda::Entry | not entry.act.oclIsUndefined() and entry.act.oclIsKindOf(consol::PurposeActivity))'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::PurposeActivity)).oclAsType(consol::PurposeActivity)'"
	 * @generated
	 */
