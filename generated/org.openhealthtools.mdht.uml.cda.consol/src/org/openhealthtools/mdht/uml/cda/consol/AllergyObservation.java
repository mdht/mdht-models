...
public interface AllergyObservation extends Observation {
	...
	* <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * (self.value->forAll(value | value.isNullFlavorUndefined())) implies (((self.value->forAll(value | value.oclAsType(datatypes::CD).code = '419511003' or value.oclAsType(datatypes::CD).code = '416098002' or value.oclAsType(datatypes::CD).code = '59037007')) and (self.participant.participantRole.playingEntity->forAll(code.codeSystem = '2.16.840.1.113883.6.88' or code.codeSystem='2.16.840.1.113883.3.26.1.5'))) or ((self.value->forAll(value | value.oclAsType(datatypes::CD).code = '418471000' or value.oclAsType(datatypes::CD).code = '414285001' or value.oclAsType(datatypes::CD).code = '235719002')) and (self.participant.participantRole.playingEntity->forAll(code.codeSystem = '2.16.840.1.113883.4.9'))) or ((self.value->forAll(value | value.oclAsType(datatypes::CD).code = '420134006' or value.oclAsType(datatypes::CD).code = '418038007' or value.oclAsType(datatypes::CD).code = '419199007')) and (self.participant.participantRole.playingEntity->forAll(code.codeSystem = '2.16.840.1.113883.6.88' or code.codeSystem='2.16.840.1.113883.3.26.1.5' or code.codeSystem = '2.16.840.1.113883.4.9'))))
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='(self.value->forAll(value | value.isNullFlavorUndefined())) implies (((self.value->forAll(value | value.oclAsType(datatypes::CD).code = \'419511003\' or value.oclAsType(datatypes::CD).code = \'416098002\' or value.oclAsType(datatypes::CD).code = \'59037007\')) and (self.participant.participantRole.playingEntity->forAll(code.codeSystem = \'2.16.840.1.113883.6.88\' or code.codeSystem=\'2.16.840.1.113883.3.26.1.5\'))) or ((self.value->forAll(value | value.oclAsType(datatypes::CD).code = \'418471000\' or value.oclAsType(datatypes::CD).code = \'414285001\' or value.oclAsType(datatypes::CD).code = \'235719002\')) and (self.participant.participantRole.playingEntity->forAll(code.codeSystem = \'2.16.840.1.113883.4.9\'))) or ((self.value->forAll(value | value.oclAsType(datatypes::CD).code = \'420134006\' or value.oclAsType(datatypes::CD).code = \'418038007\' or value.oclAsType(datatypes::CD).code = \'419199007\')) and (self.participant.participantRole.playingEntity->forAll(code.codeSystem = \'2.16.840.1.113883.6.88\' or code.codeSystem=\'2.16.840.1.113883.3.26.1.5\' or code.codeSystem = \'2.16.840.1.113883.4.9\'))))'"
	 * @generated
	 */
