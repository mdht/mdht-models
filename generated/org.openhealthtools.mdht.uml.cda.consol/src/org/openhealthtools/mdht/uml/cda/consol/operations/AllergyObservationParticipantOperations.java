...
"value = vocab::ParticipationType::CSM";
	...
	public static  boolean validateAllergyObservationParticipantTypeCode(AllergyObservationParticipant allergyObservationParticipant, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_OBSERVATION_PARTICIPANT_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(allergyObservationParticipant)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
