...
public class AllergyProblemActOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_ALLERGY_PROBLEM_ACT_EFFECTIVE_TIME_LOW__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.code = 'active' or self.statusCode.code = 'suspended') implies not self.effectiveTime.low.oclIsUndefined()";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_ALLERGY_PROBLEM_ACT_EFFECTIVE_TIME_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.code = 'aborted' or self.statusCode.code = 'completed') implies not self.effectiveTime.high.oclIsUndefined()";
	...
	public static EList<AllergyObservation> getAllergyObservations(AllergyProblemAct allergyProblemAct) {
		if (GET_ALLERGY_OBSERVATIONS__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				...
				ConsolPackage.Literals.ALLERGY_PROBLEM_ACT.getEAllOperations().get(59));
			try {
