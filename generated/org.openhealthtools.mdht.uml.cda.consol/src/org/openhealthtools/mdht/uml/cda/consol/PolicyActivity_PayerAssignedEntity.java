...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Policy Activity Payer Assigned Entity</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.consol.ConsolPackage#getPolicyActivity_PayerAssignedEntity()
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystem='2.16.840.1.113883.5.110' constraints.validation.error='PayerAssignedEntityId PayerAssignedEntityCode' code.codeSystemName='HL7RoleClass' constraints.validation.warning='PayerAssignedEntityRepresentedOrganization' constraints.validation.info='PayerAssignedEntityAddr PayerAssignedEntityTelecom'"
 * @generated
 */
public interface PolicyActivity_PayerAssignedEntity extends AssignedEntity {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.representedOrganization->forAll(element | element.oclIsTypeOf(consol::PolicyActivity::PayerOrganization))'"
	 * @generated
	 */
	boolean validatePayerAssignedEntityRepresentedOrganization(DiagnosticChain diagnostics, Map<Object, Object> context);
...
} // PolicyActivity_PayerAssignedEntity
