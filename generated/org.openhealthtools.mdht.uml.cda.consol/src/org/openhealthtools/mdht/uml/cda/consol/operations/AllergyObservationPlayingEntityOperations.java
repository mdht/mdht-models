...
public class AllergyObservationPlayingEntityOperations extends PlayingEntityOperations {
	...
	public static boolean validateAllergyObservationPlayingEntityCodeOriginalText(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_OBSERVATION_PLAYING_ENTITY_CODE_ORIGINAL_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(allergyObservationPlayingEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
	...
	public static boolean validateAllergyObservationPlayingEntityCodeTranslation(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_OBSERVATION_PLAYING_ENTITY_CODE_TRANSLATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(allergyObservationPlayingEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
	...
	public static boolean validateAllergyObservationPlayingEntityClassCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_OBSERVATION_PLAYING_ENTITY_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(allergyObservationPlayingEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateAllergyObservationPlayingEntityCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_ALLERGY_OBSERVATION_PLAYING_ENTITY_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(allergyObservationPlayingEntity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
