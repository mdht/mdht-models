 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.SubjectiveSection#validateSubjectiveSectionHasClinicalStatements(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Subjective Section Has Clinical Statements</em>}</li>
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SUBJECTIVE_SECTION_HAS_CLINICAL_STATEMENTS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.SUBJECTIVE_SECTION__SUBJECTIVE_SECTION_HAS_CLINICAL_STATEMENTS,
					ConsolPlugin.INSTANCE.getString("SubjectiveSectionHasClinicalStatements"),
