 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystem='2.16.840.1.113883.6.1' code.displayName='CHIEF COMPLAINT' templateId.root='2.16.840.1.113883.3.88.11.83.105' constraints.validation.error='ChiefComplaintSectionTemplateId ChiefComplaintSectionCode' code.codeSystemName='LOINC' code.code='10154-3' constraints.validation.info='ChiefComplaintSectionCondition'"
 * @generated
 */
public interface ChiefComplaintSection extends Section {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->one(entry : cda::Entry | not entry.act.oclIsUndefined() and entry.act.oclIsKindOf(consol::Condition))'"
	 * @generated
	 */
	boolean validateChiefComplaintSectionCondition(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::Condition))->asSequence()->first().oclAsType(consol::Condition)'"
	 * @generated
	 */
