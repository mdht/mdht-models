...
"value.code = '46241-6' and value.codeSystem = '2.16.840.1.113883.6.1'))";
	...
	public static boolean validateHospitalAdmissionDiagnosisProblemObservation(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_HOSPITAL_ADMISSION_DIAGNOSIS_PROBLEM_OBSERVATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(hospitalAdmissionDiagnosis)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	/**
	 * The cached OCL expression body for the '{@link #getProblemObservation(HospitalAdmissionDiagnosis) <em>Get Problem Observation</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemObservation(HospitalAdmissionDiagnosis)
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached OCL query for the '{@link #getProblemObservation(HospitalAdmissionDiagnosis) <em>Get Problem Observation</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProblemObservation(HospitalAdmissionDiagnosis)
	 * @generated
	 ...
	 * @generated
	 */
	public static ProblemObservation getProblemObservation(HospitalAdmissionDiagnosis hospitalAdmissionDiagnosis) {
		if (GET_PROBLEM_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.HOSPITAL_ADMISSION_DIAGNOSIS, ConsolPackage.Literals.HOSPITAL_ADMISSION_DIAGNOSIS.getEAllOperations().get(54));
			try {
		...
		return (ProblemObservation) query.evaluate(hospitalAdmissionDiagnosis);
	}
