 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ChiefComplaintSectionProcNote#validateChiefComplaintSectionProcNoteTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Chief Complaint Section Proc Note Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.consol.ChiefComplaintSectionProcNote#validateChiefComplaintSectionProcNoteCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Chief Complaint Section Proc Note Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChiefComplaintSectionProcNoteOperations extends SectionOperations {
	...
	public static boolean validateChiefComplaintSectionProcNoteTemplateId(
		...
		if (VALIDATE_CHIEF_COMPLAINT_SECTION_PROC_NOTE_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.CHIEF_COMPLAINT_SECTION_PROC_NOTE);
			try {
		...
		if (!EOCL_ENV.createQuery(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					...
					ConsolValidator.CHIEF_COMPLAINT_SECTION_PROC_NOTE__CHIEF_COMPLAINT_SECTION_PROC_NOTE_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("ChiefComplaintSectionProcNoteTemplateId"),
	...
	public static boolean validateChiefComplaintSectionProcNoteCode(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CHIEF_COMPLAINT_SECTION_PROC_NOTE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.CHIEF_COMPLAINT_SECTION_PROC_NOTE__CHIEF_COMPLAINT_SECTION_PROC_NOTE_CODE,
					ConsolPlugin.INSTANCE.getString("ChiefComplaintSectionProcNoteCode"),
					new Object[] { chiefComplaintSectionProcNote }));
			}
			return false;
		}
