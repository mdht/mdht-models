...
public class DocumentationOf_ServiceEvent3Operations extends ServiceEventOperations {
	...
	public static boolean validateServiceEvent3EffectiveTimeLow(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT3_EFFECTIVE_TIME_LOW__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent3)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent3EffectiveTimeHigh(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT3_EFFECTIVE_TIME_HIGH__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent3)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent3ClassCode(DocumentationOf_ServiceEvent3 documentationOf_ServiceEvent3,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT3_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent3)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent3EffectiveTime(
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT3_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent3)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateServiceEvent3Performer(DocumentationOf_ServiceEvent3 documentationOf_ServiceEvent3,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_SERVICE_EVENT3_PERFORMER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(documentationOf_ServiceEvent3)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
