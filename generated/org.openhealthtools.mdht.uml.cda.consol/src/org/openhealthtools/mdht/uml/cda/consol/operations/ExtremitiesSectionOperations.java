...
"value.code = '10196-4' and value.codeSystem = '2.16.840.1.113883.6.1'))";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EXTREMITIES_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::AllergyIntolerance))";
	 ...
	 * @generated
	 */
	public static  AllergyIntolerance getProblemEntry(ExtremitiesSection extremitiesSection) {
		...
		return (AllergyIntolerance) query.evaluate(extremitiesSection);
	}
