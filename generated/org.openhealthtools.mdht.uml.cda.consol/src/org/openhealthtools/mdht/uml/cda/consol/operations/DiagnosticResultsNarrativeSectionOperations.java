...
public class DiagnosticResultsNarrativeSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_DIAGNOSTIC_RESULTS_NARRATIVE_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.2.3')";
	 ...
	 * @generated
	 */
	public static boolean validateDiagnosticResultsNarrativeSectionCode(
			DiagnosticResultsNarrativeSection diagnosticResultsNarrativeSection, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_DIAGNOSTIC_RESULTS_NARRATIVE_SECTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			diagnosticResultsNarrativeSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
