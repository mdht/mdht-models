...
public class RecordTarget_PatientRole2Operations extends PatientRoleOperations {
	...
	public static boolean validatePatientRole2Id(RecordTarget_PatientRole2 recordTarget_PatientRole2,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_ROLE2_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(recordTarget_PatientRole2)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PatientRole2Id"),
						 new Object [] { recordTarget_PatientRole2 }));
			}
			return false;
		}
		return true;
