...
public class ResultOperations extends ClinicalStatementOperations {
	 ...
	 * @generated
	 */
	public static  boolean validateResultCodeValue(Result result, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolValidator.RESULT__RESULT_CODE_VALUE,
						 ConsolPlugin.INSTANCE.getString("ResultCodeValue"),
						 new Object [] { result }));
			}
			return false;
		}
...
"   and rel.observation.code.code = '48766-0'))";
	 ...
	 * @generated
	 */
	public static  boolean validateResultTypeCodeSystem(Result result, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolPlugin.INSTANCE.getString("ResultTypeCodeSystem"),
						 new Object [] { result }));
			}
			return false;
		}
	 ...
	 * @generated
	 */
	public static  boolean validateResultLaboratoryResultsValueSet(Result result, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_LABORATORY_RESULTS_VALUE_SET__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(result)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 ConsolPlugin.INSTANCE.getString("ResultLaboratoryResultsValueSet"),
						 new Object [] { result }));
			}
			return false;
		}
