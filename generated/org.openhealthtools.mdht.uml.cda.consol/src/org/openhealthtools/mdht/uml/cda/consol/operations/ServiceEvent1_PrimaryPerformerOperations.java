 ...
 * @generated
 */
public class ServiceEvent1_PrimaryPerformerOperations extends ParticipationOperations {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ServiceEvent1_PrimaryPerformerOperations() {
		super();
	}

	/**
	 * The cached OCL expression body for the '{@link #validatePrimaryPerformerFunctionCode(ServiceEvent1_PrimaryPerformer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Primary Performer Function Code</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePrimaryPerformerFunctionCode(ServiceEvent1_PrimaryPerformer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.codeSystem = '2.16.840.1.113883.6.101' and not value.code.oclIsUndefined()))";
	...
	/**
	 * The cached OCL invariant for the '{@link #validatePrimaryPerformerFunctionCode(ServiceEvent1_PrimaryPerformer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Primary Performer Function Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validatePrimaryPerformerFunctionCode(ServiceEvent1_PrimaryPerformer, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 ...
	 * let value : datatypes::CE = self.functionCode.oclAsType(datatypes::CE) in (
	 * value.codeSystem = '2.16.840.1.113883.6.101' and not value.code.oclIsUndefined()))
	 * @param serviceEvent1_PrimaryPerformer The receiving '<em><b>Service Event1 Primary Performer</b></em>' model object.
	...
	public static boolean validatePrimaryPerformerFunctionCode(
		...
		if (VALIDATE_PRIMARY_PERFORMER_FUNCTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(ConsolPackage.Literals.SERVICE_EVENT1_PRIMARY_PERFORMER);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PRIMARY_PERFORMER_FUNCTION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(serviceEvent1_PrimaryPerformer)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ConsolValidator.DIAGNOSTIC_SOURCE,
						 ConsolValidator.SERVICE_EVENT1_PRIMARY_PERFORMER__PRIMARY_PERFORMER_FUNCTION_CODE,
						 ConsolPlugin.INSTANCE.getString("PrimaryPerformerFunctionCode"),
						 new Object [] { serviceEvent1_PrimaryPerformer }));
			}
			return false;
		}
		return true;
