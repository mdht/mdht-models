 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatient maritalStatusCode.codeSystemName='MaritalStatus' constraints.validation.error='PatientBirthTimePreciseToYear PatientBirthTime PatientName' constraints.validation.warning='PatientBirthTimePreciseToDay PatientMaritalStatusCode PatientLanguageCommunication' maritalStatusCode.codeSystem='2.16.840.1.113883.5.2' constraints.validation.info='PatientRaceCode PatientReligiousAffiliationCode PatientGuardian PatientBirthplace'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientGuardian constraints.validation.error='GuardianGuardianPerson' constraints.validation.warning='GuardianAddr' constraints.validation.info='GuardianTelecom'"
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsRecordTargetPatientRolePatientLanguageCommunication proficiencyLevelCode.codeSystem='2.16.840.1.113883.5.61' constraints.validation.error='LanguageCommunicationLanguageCode LanguageCommunicationProficiencyLevelCode LanguageCommunicationModeCode' modeCode.codeSystem='2.16.840.1.113883.5.60' proficiencyLevelCode.codeSystemName='LanguageAbilityProficiency' constraints.validation.info='LanguageCommunicationPreferenceInd' modeCode.codeSystemName='LanguageAbilityMode'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsAuthenticatorAssignedEntity constraints.validation.error='AssignedEntityHasNationalProviderIdentifier AssignedEntityAddr AssignedEntityId AssignedEntityTelecom' constraints.validation.info='AssignedEntityCode'"
 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsInformantAssignedEntity constraints.validation.error='AssignedEntityHasNationalProviderIdentifier AssignedEntityPerson' code.codeSystemName='' constraints.validation.warning='AssignedEntityAddr AssignedEntityId'"
