 ...
 *        annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation/consolGeneralHeaderConstraintsAuthor constraints.validation.error='GeneralHeaderConstraintsAuthorUSRealmDateTimeDtmPreciseToDay GeneralHeaderConstraintsAuthorTime GeneralHeaderConstraintsAuthorAssignedAuthor'"
...
public interface GeneralHeaderConstraints extends ClinicalDocument {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.author->excluding(null)->reject(time.isNullFlavorUndefined() implies (not time.value.oclIsUndefined() and time.value.size() >= 8))'"
	 * @generated
	 */
	boolean validateGeneralHeaderConstraintsAuthorUSRealmDateTimeDtmPreciseToDay(DiagnosticChain diagnostics,
			Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateGeneralHeaderConstraintsInformationRecipientIntendedRecipientReceivedOrganization(
			DiagnosticChain diagnostics, Map<Object, Object> context);
