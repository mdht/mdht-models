...
public interface GeneralHeaderConstraints extends ClinicalDocument {
	...
	* <!-- end-user-doc -->
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.author->excluding(null).assignedAuthor->excluding(null)->reject((not assignedPerson.oclIsUndefined() and id->size() >= 1) implies id->exists(id | id.isNullFlavorDefined() or id.root=\'2.16.840.1.113883.4.6\'))'"
	 * @generated
	 */
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.author->excluding(null).assignedAuthor->excluding(null)->reject(not assignedPerson.oclIsUndefined() implies id->size() <= 1)'"
	 * @generated
	 */
	boolean validateGeneralHeaderConstraintsAuthorAssignedAuthorIfHasAssignedPersonEnforceId(
			DiagnosticChain diagnostics, Map<Object, Object> context);
