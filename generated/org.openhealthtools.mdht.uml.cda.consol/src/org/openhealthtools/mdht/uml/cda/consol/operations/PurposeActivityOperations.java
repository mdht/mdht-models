				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityHasReason"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityReasonType"),
						 new Object [] { purposeActivity }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityTemplateId"),
						 new Object [] { purposeActivity }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityClassCode"),
						 new Object [] { purposeActivity }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityMoodCode"),
						 new Object [] { purposeActivity }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityCode"),
						 new Object [] { purposeActivity }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConsolPlugin.INSTANCE.getString("PurposeActivityStatusCode"),
						 new Object [] { purposeActivity }));
			}
			return false;
		}
