...
"value.codeSystem = '2.16.840.1.113883.5.112'))";
	 ...
	 * @generated
	 */
	public static  MedicationSeriesNumberObservation getMedicationSeriesNumberObservation(MedicationConditionalDose medicationConditionalDose) {
	 ...
	 * @generated
	 */
	public static  MedicationStatusObservation getMedicationStatusObservation(MedicationConditionalDose medicationConditionalDose) {
	 ...
	 * @generated
	 */
	public static  EList<ReactionObservation> getnullReactionObservations(MedicationConditionalDose medicationConditionalDose) {
	 ...
	 * @generated
	 */
	public static  boolean validateMedicationActivityTemplateId(MedicationConditionalDose medicationConditionalDose, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MEDICATION_ACTIVITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(medicationConditionalDose)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "MedicationActivityTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(medicationConditionalDose, context) }),
						 new Object [] { medicationConditionalDose }));
			}
			return false;
		}
...
"value.codeSystem = '2.16.840.1.113883.6.96'))";
	 ...
	 * @generated
	 */
	public static  boolean validateMedicationActivityCode(MedicationConditionalDose medicationConditionalDose, DiagnosticChain diagnostics, Map<Object, Object> context) {
