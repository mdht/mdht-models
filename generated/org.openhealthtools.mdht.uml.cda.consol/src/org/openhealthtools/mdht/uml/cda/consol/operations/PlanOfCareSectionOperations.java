...
public class PlanOfCareSectionOperations extends SectionOperations {
	 ...
	 * @generated
	 */
	public static boolean validatePlanOfCareSectionMedication(PlanOfCareSection planOfCareSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_SECTION_MEDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			planOfCareSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PLAN_OF_CARE_SECTION__PLAN_OF_CARE_SECTION_MEDICATION,
					ConsolPlugin.INSTANCE.getString("PlanOfCareSectionMedication"), new Object[] { planOfCareSection }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validatePlanOfCareSectionImmunization(PlanOfCareSection planOfCareSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_SECTION_IMMUNIZATION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			planOfCareSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, ConsolValidator.DIAGNOSTIC_SOURCE,
	 ...
	 * @generated
	 */
	public static boolean validatePlanOfCareSectionEncounter(PlanOfCareSection planOfCareSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_SECTION_ENCOUNTER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			planOfCareSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PLAN_OF_CARE_SECTION__PLAN_OF_CARE_SECTION_ENCOUNTER,
					ConsolPlugin.INSTANCE.getString("PlanOfCareSectionEncounter"), new Object[] { planOfCareSection }));
			}
			return false;
		}
		return true;
	 ...
	 * @generated
	 */
	public static boolean validatePlanOfCareSectionProcedure(PlanOfCareSection planOfCareSection,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PLAN_OF_CARE_SECTION_PROCEDURE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			planOfCareSection)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.INFO, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PLAN_OF_CARE_SECTION__PLAN_OF_CARE_SECTION_PROCEDURE,
					ConsolPlugin.INSTANCE.getString("PlanOfCareSectionProcedure"), new Object[] { planOfCareSection }));
			}
			return false;
		}
		return true;
	...
	public static PlanOfCareActivityEncounter getPlanOfCareActivityEncounter(PlanOfCareSection planOfCareSection) {
		if (GET_PLAN_OF_CARE_ACTIVITY_ENCOUNTER__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION,
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION.getEAllOperations().get(74));
			try {
	...
	public static PlanOfCareActivityObservation getPlanOfCareActivityObservation(PlanOfCareSection planOfCareSection) {
		if (GET_PLAN_OF_CARE_ACTIVITY_OBSERVATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION,
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION.getEAllOperations().get(75));
			try {
	...
	public static PlanOfCareActivityProcedure getPlanOfCareActivityProcedure(PlanOfCareSection planOfCareSection) {
		if (GET_PLAN_OF_CARE_ACTIVITY_PROCEDURE__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION,
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION.getEAllOperations().get(76));
			try {
	...
	public static PlanOfCareActivitySubstanceAdministration getPlanOfCareActivitySubstanceAdministration(
		...
		if (GET_PLAN_OF_CARE_ACTIVITY_SUBSTANCE_ADMINISTRATION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION,
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION.getEAllOperations().get(77));
			try {
	...
	public static PlanOfCareActivitySupply getPlanOfCareActivitySupply(PlanOfCareSection planOfCareSection) {
		if (GET_PLAN_OF_CARE_ACTIVITY_SUPPLY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION,
				ConsolPackage.Literals.PLAN_OF_CARE_SECTION.getEAllOperations().get(78));
			try {
