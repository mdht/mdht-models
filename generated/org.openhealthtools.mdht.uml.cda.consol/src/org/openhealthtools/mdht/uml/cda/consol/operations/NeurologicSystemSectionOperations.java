...
public class NeurologicSystemSectionOperations extends SectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_NEUROLOGIC_SYSTEM_SECTION_PROBLEM_ENTRY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(consol::ProblemEntryReactionObservationContainer))";
	...
	public static ProblemEntryReactionObservationContainer getProblemEntry(
			NeurologicSystemSection neurologicSystemSection) {
		...
		return (ProblemEntryReactionObservationContainer) query.evaluate(neurologicSystemSection);
	}
