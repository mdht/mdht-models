...
public interface CaregiverCharacteristics extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.value->forAll(val | val.isNullFlavorDefined() or val.oclAsType(datatypes::CD).codeSystem = \'2.16.840.1.113883.6.1\' or val.oclAsType(datatypes::CD).codeSystem = \'2.16.840.1.113883.6.96\')'"
	 * @generated
	 */
	 ...
	 * @generated
	 */
	boolean validateCaregiverCharacteristicsParticipantParticipantRoleClassCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateCaregiverCharacteristicsParticipantParticipantRole(DiagnosticChain diagnostics, Map<Object, Object> context);
