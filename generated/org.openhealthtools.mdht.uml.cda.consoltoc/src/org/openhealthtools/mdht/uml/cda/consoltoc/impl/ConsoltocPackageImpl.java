...
public class ConsoltocPackageImpl extends EPackageImpl implements ConsoltocPackage
{
  ...
  public static ConsoltocPackage init()
  {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.consoltoc", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(theConsoltocPackage);
