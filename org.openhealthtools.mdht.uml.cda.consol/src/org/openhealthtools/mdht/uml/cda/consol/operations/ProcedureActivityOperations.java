...
public class ProcedureActivityOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PROCEDURE_ACTIVITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.4.11')";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.22.4.11')
	 ...
	 * @generated
	 */
	public static boolean validateProcedureActivityTemplateId(ProcedureActivity procedureActivity,
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROCEDURE_ACTIVITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
			procedureActivity)) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(
					Diagnostic.ERROR, ConsolValidator.DIAGNOSTIC_SOURCE,
					ConsolValidator.PROCEDURE_ACTIVITY__PROCEDURE_ACTIVITY_TEMPLATE_ID,
					ConsolPlugin.INSTANCE.getString("ProcedureActivityTemplateId"), new Object[] { procedureActivity }));
			}
			return false;
		}
		return true;
