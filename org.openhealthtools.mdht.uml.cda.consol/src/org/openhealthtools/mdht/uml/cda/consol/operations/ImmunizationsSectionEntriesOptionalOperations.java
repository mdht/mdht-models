...
"value.code = '11369-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static EList<ImmunizationActivity> getImmunizationActivities(
		...
		if (GET_IMMUNIZATION_ACTIVITIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(ConsolPackage.Literals.IMMUNIZATIONS_SECTION_ENTRIES_OPTIONAL, ConsolPackage.Literals.IMMUNIZATIONS_SECTION_ENTRIES_OPTIONAL.getEAllOperations().get(60));
			try {
