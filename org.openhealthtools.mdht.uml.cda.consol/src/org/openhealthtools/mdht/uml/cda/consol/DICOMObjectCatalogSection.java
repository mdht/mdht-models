 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation code.codeSystemName='DCM' templateId.root='2.16.840.1.113883.10.20.6.1.1' constraints.validation.error='DICOMObjectCatalogSectionTemplateId DICOMObjectCatalogSectionCode DICOMObjectCatalogSectionStudyAct' code.displayName='Dicom Object Catalog' code.codeSystem='1.2.840.10008.2.16.4' code.code='121181'"
 * @generated
 */
public interface DICOMObjectCatalogSection extends Section {
	 ...
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->one(entry : cda::Entry | not entry.act.oclIsUndefined() and entry.act.oclIsKindOf(consol::StudyAct))'"
	 * @generated
	 */
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(consol::StudyAct))->asSequence()->first().oclAsType(consol::StudyAct)'"
	 * @generated
	 */
	StudyAct getStudyAct();
