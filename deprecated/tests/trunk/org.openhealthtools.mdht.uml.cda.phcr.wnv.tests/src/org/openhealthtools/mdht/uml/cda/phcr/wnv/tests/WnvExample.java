...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>wnv</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class WnvExample {
	/**
   * <!-- begin-user-doc -->
   ...
   */
    ...
    if (args.length == 0)
    {
      ...
      try
      {
        Resource resource = resourceSet.createResource(URI.createURI("http:///My.wnv"));
        WestNileVirusCaseReport root = WnvFactory.eINSTANCE.createWestNileVirusCaseReport();
