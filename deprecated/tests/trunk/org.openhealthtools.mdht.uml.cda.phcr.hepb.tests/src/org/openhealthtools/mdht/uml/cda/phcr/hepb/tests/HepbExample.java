...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>hepb</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class HepbExample {
	/**
   * <!-- begin-user-doc -->
   ...
   */
    ...
    if (args.length == 0)
    {
      ...
      try
      {
        Resource resource = resourceSet.createResource(URI.createURI("http:///My.hepb"));
        AcuteHepatitisBCaseReport root = HepbFactory.eINSTANCE.createAcuteHepatitisBCaseReport();
