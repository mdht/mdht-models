 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.hitsp.domain.impl.ChiefComplaintSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public ICondition getCondition() {
		if (GET_CONDITION__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getChiefComplaintSection(),
				IDomainPackage.eINSTANCE.getChiefComplaintSection().getEAllOperations().get(0));
			try {
