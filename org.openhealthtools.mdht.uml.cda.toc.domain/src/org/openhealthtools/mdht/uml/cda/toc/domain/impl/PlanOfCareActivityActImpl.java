 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.PlanOfCareActivityActImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlanOfCareActivityActImpl extends PlanOfCareActivityImpl implements IPlanOfCareActivityAct {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getPlanOfCareActivityAct();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPlanOfCareActivityAct(), IDomainPackage.eINSTANCE.getPlanOfCareActivityAct().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IPlanOfCareActivityAct addId(II value) {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPlanOfCareActivityAct(), IDomainPackage.eINSTANCE.getPlanOfCareActivityAct().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IPlanOfCareActivityAct setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.PLAN_OF_CARE_ACTIVITY_ACT__CDA_TYPE:
