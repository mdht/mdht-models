 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.EarsSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EarsSectionImpl extends EObjectImpl implements IEarsSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getEarsSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getEarsSection(),
				IDomainPackage.eINSTANCE.getEarsSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IEarsSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.EARS_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
