 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.GeneralAppearanceSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GeneralAppearanceSectionImpl extends EObjectImpl implements IGeneralAppearanceSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getGeneralAppearanceSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getGeneralAppearanceSection(),
				IDomainPackage.eINSTANCE.getGeneralAppearanceSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IGeneralAppearanceSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.GENERAL_APPEARANCE_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	 ...
	 * @generated
	 */
	public IGeneralAppearanceSection init() {
		CDAUtil.init(this);
		return this;
	}
