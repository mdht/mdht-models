 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.SeverityImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SeverityImpl extends EObjectImpl implements ISeverity {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getSeverity();
	}
	...
	public ED getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSeverity(), IDomainPackage.eINSTANCE.getSeverity().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public ISeverity setText(ED value) {
		this.getCDAType().setText(value);
		return this;
	}
	...
	public CD getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSeverity(), IDomainPackage.eINSTANCE.getSeverity().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public ISeverity setValue(CD value) {
		this.getCDAType().getValues().add(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.SEVERITY__CDA_TYPE:
