 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.MedicalEquipmentSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MedicalEquipmentSectionImpl extends EObjectImpl implements IMedicalEquipmentSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getMedicalEquipmentSection();
	}
	...
	public ST getTitle() {
		if (GET_TITLE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getMedicalEquipmentSection(), IDomainPackage.eINSTANCE.getMedicalEquipmentSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IMedicalEquipmentSection setTitle(ST value) {
		this.getCDAType().setTitle(value);
		return this;
	}
	...
	public StrucDocText getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getMedicalEquipmentSection(), IDomainPackage.eINSTANCE.getMedicalEquipmentSection().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IMedicalEquipmentSection setText(StrucDocText value) {
		this.getCDAType().setText(value);
		return this;
	}
	...
	public EList<ISupplyActivity> getSupplyActivities() {
		if (GET_SUPPLY_ACTIVITIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getMedicalEquipmentSection(), IDomainPackage.eINSTANCE.getMedicalEquipmentSection().getEAllOperations().get(6));
			try {
	 ...
	 * @generated
	 */
	public IMedicalEquipmentSection addSupplyActivity(ISupplyActivity value) {
	...
	public EList<IMedicationActivity> getMedicationActivities() {
		if (GET_MEDICATION_ACTIVITIES__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getMedicalEquipmentSection(), IDomainPackage.eINSTANCE.getMedicalEquipmentSection().getEAllOperations().get(9));
			try {
	...
	public IMedicationActivity addMedicationActivity() {
		org.eclipse.emf.ecore.EPackage ePackage = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage("http://www.openhealthtools.org/mdht/uml/cda/ccd");
		org.eclipse.emf.ecore.EFactory eFactory = org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEFactory("http://www.openhealthtools.org/mdht/uml/cda/ccd");
		org.eclipse.emf.ecore.EClass eClass = (org.eclipse.emf.ecore.EClass) ePackage.getEClassifier("MedicationActivity");
		org.eclipse.emf.ecore.EObject eObject = eFactory.create(eClass);
		try {
			java.lang.reflect.Method initMethod = eObject.getClass().getMethod("init", new java.lang.Class[0]);
			initMethod.invoke(eObject, new Object[0]);
		...
		org.eclipse.emf.ecore.EPackage domainPackage = this.eClass().getEPackage();
		org.eclipse.emf.ecore.EFactory domainFactory = domainPackage.getEFactoryInstance();
		org.eclipse.emf.ecore.EClass domainEClass = (org.eclipse.emf.ecore.EClass) domainPackage.getEClassifier("MedicationActivity");
		IMedicationActivity value = (IMedicationActivity)domainFactory.create(domainEClass);
	 ...
	 * @generated
	 */
	public IMedicalEquipmentSection addMedicationActivity(IMedicationActivity value) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.MEDICAL_EQUIPMENT_SECTION__CDA_TYPE:
