 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.HeartSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HeartSectionImpl extends EObjectImpl implements IHeartSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getHeartSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getHeartSection(),
				IDomainPackage.eINSTANCE.getHeartSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IHeartSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.HEART_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
