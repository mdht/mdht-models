 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.EpisodeObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EpisodeObservationImpl extends EObjectImpl implements IEpisodeObservation {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getEpisodeObservation();
	}
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getEpisodeObservation(), IDomainPackage.eINSTANCE.getEpisodeObservation().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IEpisodeObservation setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}
	...
	public CD getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getEpisodeObservation(), IDomainPackage.eINSTANCE.getEpisodeObservation().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public IEpisodeObservation setValue(CD value) {
		this.getCDAType().getValues().add(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.EPISODE_OBSERVATION__CDA_TYPE:
