 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.LymphaticSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LymphaticSectionImpl extends EObjectImpl implements ILymphaticSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getLymphaticSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getLymphaticSection(),
				IDomainPackage.eINSTANCE.getLymphaticSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public ILymphaticSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.LYMPHATIC_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
