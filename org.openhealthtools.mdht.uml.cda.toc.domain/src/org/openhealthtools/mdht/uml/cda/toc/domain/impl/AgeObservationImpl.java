 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.AgeObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AgeObservationImpl extends EObjectImpl implements IAgeObservation {
	...
	public ANY getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getAgeObservation(), IDomainPackage.eINSTANCE.getAgeObservation().getEAllOperations().get(0));
			try {
