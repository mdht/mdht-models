 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.ChestWallSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ChestWallSectionImpl extends EObjectImpl implements IChestWallSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getChestWallSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getChestWallSection(),
				IDomainPackage.eINSTANCE.getChestWallSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IChestWallSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.CHEST_WALL_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
