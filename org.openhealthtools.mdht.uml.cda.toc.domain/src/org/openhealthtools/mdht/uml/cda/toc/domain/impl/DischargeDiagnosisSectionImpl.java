 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.DischargeDiagnosisSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DischargeDiagnosisSectionImpl extends EObjectImpl implements IDischargeDiagnosisSection {
	...
	public ICondition getCondition() {
		if (GET_CONDITION__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getDischargeDiagnosisSection(), IDomainPackage.eINSTANCE.getDischargeDiagnosisSection().getEAllOperations().get(0));
			try {
