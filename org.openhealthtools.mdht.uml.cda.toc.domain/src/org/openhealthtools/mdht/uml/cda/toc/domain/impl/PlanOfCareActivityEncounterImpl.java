 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.PlanOfCareActivityEncounterImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlanOfCareActivityEncounterImpl extends PlanOfCareActivityImpl implements IPlanOfCareActivityEncounter {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getPlanOfCareActivityEncounter();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getPlanOfCareActivityEncounter(), IDomainPackage.eINSTANCE.getPlanOfCareActivityEncounter().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IPlanOfCareActivityEncounter addId(II value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.PLAN_OF_CARE_ACTIVITY_ENCOUNTER__CDA_TYPE:
