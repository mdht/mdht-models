 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.IntegumentarySystemSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntegumentarySystemSectionImpl extends EObjectImpl implements IIntegumentarySystemSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getIntegumentarySystemSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getIntegumentarySystemSection(),
				IDomainPackage.eINSTANCE.getIntegumentarySystemSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public IIntegumentarySystemSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.INTEGUMENTARY_SYSTEM_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
	 ...
	 * @generated
	 */
	public IIntegumentarySystemSection init() {
		CDAUtil.init(this);
		return this;
	}
