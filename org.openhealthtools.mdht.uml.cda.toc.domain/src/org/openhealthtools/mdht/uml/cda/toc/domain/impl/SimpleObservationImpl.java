 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.SimpleObservationImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SimpleObservationImpl extends EObjectImpl implements ISimpleObservation {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getSimpleObservation();
	}
	...
	public EList<II> getIds() {
		if (GET_IDS__EOCL_QRY == null) {
			...
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSimpleObservation(), IDomainPackage.eINSTANCE.getSimpleObservation().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public ISimpleObservation addId(II value) {
	...
	public CD getCode() {
		if (GET_CODE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(IDomainPackage.eINSTANCE.getSimpleObservation(), IDomainPackage.eINSTANCE.getSimpleObservation().getEAllOperations().get(3));
			try {
	 ...
	 * @generated
	 */
	public ISimpleObservation setCode(CD value) {
		this.getCDAType().setCode(value);
		return this;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.SIMPLE_OBSERVATION__CDA_TYPE:
	 ...
	 * @generated
	 */
	public ISimpleObservation init() {
    	CDAUtil.init(this);
    	return this;
	}
