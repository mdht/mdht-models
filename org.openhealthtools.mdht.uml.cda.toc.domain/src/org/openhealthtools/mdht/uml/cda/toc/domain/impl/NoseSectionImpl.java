 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.toc.domain.impl.NoseSectionImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NoseSectionImpl extends EObjectImpl implements INoseSection {
	/**
	...
	protected EClass eStaticClass() {
		return IDomainPackage.eINSTANCE.getNoseSection();
	}
	...
	public IProblemEntry getProblemEntry() {
		if (GET_PROBLEM_ENTRY__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				IDomainPackage.eINSTANCE.getNoseSection(),
				IDomainPackage.eINSTANCE.getNoseSection().getEAllOperations().get(0));
			try {
	 ...
	 * @generated
	 */
	public INoseSection setProblemEntry(IProblemEntry value) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDomainPackage.NOSE_SECTION__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
