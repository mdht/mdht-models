...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ISeverity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.apitest.domain.impl.ISeverityImpl#getCDAType <em>CDA Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ISeverityImpl extends EObjectImpl implements ISeverity {
	/**
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ISEVERITY;
	}
	...
	public ED getText() {
		if (GET_TEXT__EOCL_QRY == null) {
			...
			helper.setOperationContext(
				DomainPackage.Literals.ISEVERITY, DomainPackage.Literals.ISEVERITY.getEAllOperations().get(0));
			try {
	...
	public CD getValue() {
		if (GET_VALUE__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(
				DomainPackage.Literals.ISEVERITY, DomainPackage.Literals.ISEVERITY.getEAllOperations().get(3));
			try {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.ISEVERITY__CDA_TYPE:
				if (resolve) {
					return getCDAType();
				}
