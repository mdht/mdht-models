...
namespace facade.consol.generalheaderconstraints
{
    public class AuthorFacade : facade.FacadeBase
    {
		...
		*/
		...
		public List<facade.consol.generalheaderconstraints.author.AssignedAuthorFacade> assignedAuthor()
		{
			return Set(self.assignedAuthor).FindAll( x => facade.consol.generalheaderconstraints.author.AssignedAuthorFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.author.AssignedAuthorFacade(x));
		}

		public facade.consol.generalheaderconstraints.author.AssignedAuthorFacade GetOrCreateAssignedAuthor()
		{
			List<facade.consol.generalheaderconstraints.author.AssignedAuthorFacade> lastOrDefault = assignedAuthor();
			if (lastOrDefault.Count != 0)
			{
