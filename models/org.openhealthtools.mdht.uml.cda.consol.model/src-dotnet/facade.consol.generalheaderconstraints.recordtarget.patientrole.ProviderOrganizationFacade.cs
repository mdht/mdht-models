...
{
    public class ProviderOrganizationFacade : facade.FacadeBase
    {
		...
		public ProviderOrganizationFacade(POCD_MT000040Organization self)
		{
			this.self = self;
		}
		...
		*/
		...
		public List<facade.consol.generalheaderconstraints.recordtarget.patientrole.providerorganization.TELFacade> telecom()
		{
			return Set(self.telecom).FindAll( x => facade.consol.generalheaderconstraints.recordtarget.patientrole.providerorganization.TELFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.recordtarget.patientrole.providerorganization.TELFacade(x));
		}

		public facade.consol.generalheaderconstraints.recordtarget.patientrole.providerorganization.TELFacade GetOrCreateTelecom()
		{
			List<facade.consol.generalheaderconstraints.recordtarget.patientrole.providerorganization.TELFacade> lastOrDefault = telecom();
			if (lastOrDefault.Count != 0)
			{
