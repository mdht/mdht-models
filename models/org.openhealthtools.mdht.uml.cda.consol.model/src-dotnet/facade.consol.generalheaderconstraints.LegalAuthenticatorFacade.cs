...
{
    public class LegalAuthenticatorFacade : facade.FacadeBase
    {

		public POCD_MT000040LegalAuthenticator self;
		...
		{
			this.self = new POCD_MT000040LegalAuthenticator();
		}

		public LegalAuthenticatorFacade(POCD_MT000040LegalAuthenticator self)
		{
			this.self = self;
		}

		public static bool isKindOf(POCD_MT000040LegalAuthenticator self)
		{
			return true;
		}
		...
		*/
		...
		public List<facade.consol.generalheaderconstraints.legalauthenticator.AssignedEntityFacade> assignedEntity()
		{
			return Set(self.assignedEntity).FindAll( x => facade.consol.generalheaderconstraints.legalauthenticator.AssignedEntityFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.legalauthenticator.AssignedEntityFacade(x));
		}

		public facade.consol.generalheaderconstraints.legalauthenticator.AssignedEntityFacade GetOrCreateAssignedEntity()
		{
			List<facade.consol.generalheaderconstraints.legalauthenticator.AssignedEntityFacade> lastOrDefault = assignedEntity();
			if (lastOrDefault.Count != 0)
			{
