...
namespace facade.consol.generalheaderconstraints.author
{
    public class AssignedAuthorFacade : facade.FacadeBase
    {

		public POCD_MT000040AssignedAuthor self;

		public AssignedAuthorFacade()
		{
			this.self = new POCD_MT000040AssignedAuthor();
		}

		public AssignedAuthorFacade(POCD_MT000040AssignedAuthor self)
		{
			this.self = self;
		}

		public static bool isKindOf(POCD_MT000040AssignedAuthor self)
		{
			return true;
		}
		...
		*/
		...
		public List<facade.consol.generalheaderconstraints.author.assignedauthor.TELFacade> telecom()
		{
			return Set(self.telecom).FindAll( x => facade.consol.generalheaderconstraints.author.assignedauthor.TELFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.author.assignedauthor.TELFacade(x));
		}

		public facade.consol.generalheaderconstraints.author.assignedauthor.TELFacade GetOrCreateTelecom()
		{
			List<facade.consol.generalheaderconstraints.author.assignedauthor.TELFacade> lastOrDefault = telecom();
			if (lastOrDefault.Count != 0)
			{
		...
		public List<facade.consol.generalheaderconstraints.author.assignedauthor.AuthoringDeviceFacade> assignedAuthoringDevice()
		{
			return Set(self.assignedAuthoringDevice).FindAll( x => facade.consol.generalheaderconstraints.author.assignedauthor.AuthoringDeviceFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.author.assignedauthor.AuthoringDeviceFacade(x));
		}
		...
		{
			List<facade.consol.generalheaderconstraints.author.assignedauthor.AuthoringDeviceFacade> lastOrDefault = assignedAuthoringDevice();
			if (lastOrDefault.Count != 0)
			{
				MarkSpecified(self, "assignedAuthoringDevice");
				return lastOrDefault.Last();
			}
		...
		{
			POCD_MT000040AuthoringDevice element = new POCD_MT000040AuthoringDevice();
			...
			elementFacade.Init();
			self.assignedAuthoringDevice = SetOrAdd(self.assignedAuthoringDevice, element);
			return elementFacade;
		}
		...
		public List<facade.consol.generalheaderconstraints.author.assignedauthor.PersonFacade> assignedPerson()
		{
			return Set(self.assignedPerson).FindAll( x => facade.consol.generalheaderconstraints.author.assignedauthor.PersonFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.author.assignedauthor.PersonFacade(x));
		}

		public facade.consol.generalheaderconstraints.author.assignedauthor.PersonFacade GetOrCreateAssignedPerson()
		{
			List<facade.consol.generalheaderconstraints.author.assignedauthor.PersonFacade> lastOrDefault = assignedPerson();
			if (lastOrDefault.Count != 0)
			{
