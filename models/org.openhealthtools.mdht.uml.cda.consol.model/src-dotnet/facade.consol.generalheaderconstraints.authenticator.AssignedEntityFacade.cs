...
namespace facade.consol.generalheaderconstraints.authenticator
{
    public class AssignedEntityFacade : facade.FacadeBase
    {
		...
		*/
		...
		public List<facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade> telecom()
		{
			return Set(self.telecom).FindAll( x => facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade(x));
		}

		public facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade GetOrCreateTelecom()
		{
			List<facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade> lastOrDefault = telecom();
			if (lastOrDefault.Count != 0)
			{
		...
		public List<facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade> assignedPerson()
		{
			return Set(self.assignedPerson).FindAll( x => facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade(x));
		}

		public facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade GetOrCreateAssignedPerson()
		{
			List<facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade> lastOrDefault = assignedPerson();
			if (lastOrDefault.Count != 0)
			{
