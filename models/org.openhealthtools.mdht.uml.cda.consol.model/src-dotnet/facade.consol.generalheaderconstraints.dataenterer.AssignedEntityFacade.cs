...
namespace facade.consol.generalheaderconstraints.dataenterer
{
    public class AssignedEntityFacade : facade.FacadeBase
    {
		...
		*/
		...
		public List<facade.consol.generalheaderconstraints.dataenterer.assignedentity.TELFacade> telecom()
		{
			return Set(self.telecom).FindAll( x => facade.consol.generalheaderconstraints.dataenterer.assignedentity.TELFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.dataenterer.assignedentity.TELFacade(x));
		}

		public facade.consol.generalheaderconstraints.dataenterer.assignedentity.TELFacade GetOrCreateTelecom()
		{
			List<facade.consol.generalheaderconstraints.dataenterer.assignedentity.TELFacade> lastOrDefault = telecom();
			if (lastOrDefault.Count != 0)
			{
		...
		public List<facade.consol.generalheaderconstraints.dataenterer.assignedentity.PersonFacade> assignedPerson()
		{
			return Set(self.assignedPerson).FindAll( x => facade.consol.generalheaderconstraints.dataenterer.assignedentity.PersonFacade.isKindOf(x)).ConvertAll( x => new facade.consol.generalheaderconstraints.dataenterer.assignedentity.PersonFacade(x));
		}

		public facade.consol.generalheaderconstraints.dataenterer.assignedentity.PersonFacade GetOrCreateAssignedPerson()
		{
			List<facade.consol.generalheaderconstraints.dataenterer.assignedentity.PersonFacade> lastOrDefault = assignedPerson();
			if (lastOrDefault.Count != 0)
			{
