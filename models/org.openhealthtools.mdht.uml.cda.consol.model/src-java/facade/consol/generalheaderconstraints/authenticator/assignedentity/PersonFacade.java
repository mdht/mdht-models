...
public class PersonFacade extends facade.FacadeBase {
	...
	*/
	...
	{
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityPersonName(vb, del);
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity/assignedPerson
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::Person
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::Person::GeneralHeaderConstraintsAuthenticatorAssignedEntityPersonName
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityPersonName(DiagnosticChain vb, DataElementLevel del)
	{
