package facade.consol.generalheaderconstraints.authenticator;
...
public class AssignedEntityFacade extends facade.FacadeBase {
	...
	*/
	...
	{
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityHasNationalProviderIdentifier(vb, del);
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityAddr(vb, del);
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityCodeP(vb, del);
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityCode(vb, del);
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityId(vb, del);
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityTelecom(vb, del);
			ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityAssignedPerson(vb, del);
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityHasNationalProviderIdentifier
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityHasNationalProviderIdentifier(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		}
		boolean result = Set(self.getIds()).anyMatch(i2469 -> Set(i2469.getRoot()).collect(Collectors.toList()).contains("2.16.840.1.113883.4.6"));
		if (!result && vb != null)
		{
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityAddr
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityAddr(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		...
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.19.iii.a addr\n\t\tConformance: SHALL contain at least one [1..*] addr (CONF:5616)\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityCodeP
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityCodeP(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		}
		boolean result = !(!(Set(self.getCode()).count()==0) && Set(self.getCode()).anyMatch(i2489 -> i2489.isNullFlavorUndefined())) || !(Set(self.getCode()).count()==0);
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.19.iii.b code\n\t\tConformance: MAY contain zero or one [0..1] code (CONF:16825), which SHOULD be selected from ValueSet Healthcare Provider Taxonomy (NUCC - HIPAA) 2.16.840.1.114222.4.11.1066 DYNAMIC (CONF:16826)\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityCode
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityCode(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		}
		boolean result = !(!(Set(self.getCode()).count()==0) && Set(self.getCode()).anyMatch(i2501 -> i2501.isNullFlavorUndefined())) || !(Set(self.getCode()).count()==0) && true && Set(self.getCode()).filter(i2504 -> Set(i2504.getCodeSystem()).collect(Collectors.toList()).contains("2.16.840.1.113883.6.101") && !(Set(i2504.getCode()).count()==0)).count()!=0;
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.19.iii.b code\n\t\tConformance: MAY contain zero or one [0..1] code (CONF:16825), which SHOULD be selected from ValueSet Healthcare Provider Taxonomy (NUCC - HIPAA) 2.16.840.1.114222.4.11.1066 DYNAMIC (CONF:16826)\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityId
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityId(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		...
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.19.iii.c id\n\t\tConformance: SHALL contain at least one [1..*] id (CONF:5613)\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityTelecom
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityTelecom(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		...
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.19.iii.d telecom\n\t\tConformance: SHALL contain at least one [1..*] telecom (CONF:5622)\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
	 ...
	 * Context: /GeneralHeaderConstraints/authenticator/assignedEntity
	 * Context Class: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity
	 * Constraint Name: consol::GeneralHeaderConstraints::Authenticator::AssignedEntity::GeneralHeaderConstraintsAuthenticatorAssignedEntityAssignedPerson
	 */
	public boolean ValidateGeneralHeaderConstraintsAuthenticatorAssignedEntityAssignedPerson(DiagnosticChain vb, DataElementLevel del)
	{
		if (del != null && del != DataElementLevel.DEL_CDA_HEADER)
		{
			return true;
		}
		boolean result = Set(self.getAssignedPerson()).filter(i2539 -> !(Set(i2539).count()==0) && true).count()==1;
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.19.iii.e assignedPerson\n\t\tConformance: SHALL contain exactly one [1..1] assignedPerson (CONF:5624)\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
	...
	public Stream<facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade> telecom()
	{
		return Set(self.getTelecoms()).filter( x -> facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade.isKindOf(x)).map( x -> new facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade(x));
	}

	public facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade GetOrCreateTelecom()
	{
		Optional<facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade> lastOrDefault = telecom().reduce((a, b) -> b);
		if (lastOrDefault.isPresent())
		{
	...
	public facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade CreateAnotherTelecom()
	{
		TEL element = DatatypesFactory.eINSTANCE.createTEL();
		facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade elementFacade = new facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade(element);
		elementFacade.Init();
		self.getTelecoms().add(element);
		return elementFacade;
	}

	public facade.consol.generalheaderconstraints.authenticator.assignedentity.TELFacade Telecom() {
		return GetOrCreateTelecom();
	}

	public Stream<facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade> assignedPerson()
	{
		return Set(self.getAssignedPerson()).filter( x -> facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade.isKindOf(x)).map( x -> new facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade(x));
	}

	public facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade GetOrCreateAssignedPerson()
	{
		Optional<facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade> lastOrDefault = assignedPerson().reduce((a, b) -> b);
		if (lastOrDefault.isPresent())
		{
	...
	public facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade CreateAnotherAssignedPerson()
	{
		Person element = CDAFactory.eINSTANCE.createPerson();
		facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade elementFacade = new facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade(element);
		elementFacade.Init();
		self.setAssignedPerson(element);
		return elementFacade;
	}

	public facade.consol.generalheaderconstraints.authenticator.assignedentity.PersonFacade AssignedPerson() {
