package facade.consol.generalheaderconstraints.informant.assignedentity;
...
public class PersonFacade extends facade.FacadeBase {
	...
	*/
	...
	{
			ValidateGeneralHeaderConstraintsInformantAssignedEntityPersonName(vb, del);
	 ...
	 * Context: /GeneralHeaderConstraints/informant/assignedEntity/assignedPerson
	 * Context Class: consol::GeneralHeaderConstraints::Informant::AssignedEntity::Person
	 * Constraint Name: consol::GeneralHeaderConstraints::Informant::AssignedEntity::Person::GeneralHeaderConstraintsInformantAssignedEntityPersonName
	 */
	public boolean ValidateGeneralHeaderConstraintsInformantAssignedEntityPersonName(DiagnosticChain vb, DataElementLevel del)
	{
		...
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.20.i.d.1 name\n\t\tConformance: SHALL contain at least one [1..*] name\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
