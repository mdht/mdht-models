package facade.consol.generalheaderconstraints.infulfillmentof;
...
public class OrderFacade extends facade.FacadeBase {

	public Order self;

	public OrderFacade()
	{
		this.self = CDAFactory.eINSTANCE.createOrder();
	}

	public OrderFacade(Order self)
	{
		this.self = self;
	}

	public static boolean isKindOf(Order self)
	{
		return true;
	}
	...
	*/
	...
	{
			ValidateGeneralHeaderConstraintsInFulfillmentOfOrderId(vb, del);
	 ...
	 * Context: /GeneralHeaderConstraints/inFulfillmentOf/order
	 * Context Class: consol::GeneralHeaderConstraints::InFulfillmentOf::Order
	 * Constraint Name: consol::GeneralHeaderConstraints::InFulfillmentOf::Order::GeneralHeaderConstraintsInFulfillmentOfOrderId
	 */
	public boolean ValidateGeneralHeaderConstraintsInFulfillmentOfOrderId(DiagnosticChain vb, DataElementLevel del)
	{
	...
	public facade.datatypes.IIFacade GetOrCreateId()
	{
		...
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_Id());
	...
	public facade.datatypes.CSFacade GetOrCreateRealmCode()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_RealmCode());
			return lastOrDefault.get();
		}
	...
	public facade.cda.InfrastructureRootTypeIdFacade GetOrCreateTypeId()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_TypeId());
			return lastOrDefault.get();
		}
	...
	public facade.datatypes.IIFacade GetOrCreateTemplateId()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_TemplateId());
			return lastOrDefault.get();
		}
	...
	public facade.datatypes.CEFacade GetOrCreateCode()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_Code());
			return lastOrDefault.get();
		}
	...
	public facade.datatypes.CEFacade GetOrCreatePriorityCode()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_PriorityCode());
			return lastOrDefault.get();
		}
	...
	public NullFlavor GetOrCreateNullFlavor()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_NullFlavor());
			return lastOrDefault.get();
		}
	...
	public ActClassRoot GetOrCreateClassCode()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_ClassCode());
			return lastOrDefault.get();
		}
	...
	public ActMood GetOrCreateMoodCode()
	{
		...
		if (lastOrDefault.isPresent())
		{
			MarkSpecified(self, org.openhealthtools.mdht.uml.cda.CDAPackage.eINSTANCE.getOrder_MoodCode());
			return lastOrDefault.get();
		}
