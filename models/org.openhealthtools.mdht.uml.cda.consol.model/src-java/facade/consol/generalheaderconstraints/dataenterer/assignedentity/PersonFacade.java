...
public class PersonFacade extends facade.FacadeBase {
	...
	*/
	...
	{
			ValidateGeneralHeaderConstraintsDataEntererAssignedEntityPersonName(vb, del);
	 ...
	 * Context: /GeneralHeaderConstraints/dataEnterer/assignedEntity/assignedPerson
	 * Context Class: consol::GeneralHeaderConstraints::DataEnterer::AssignedEntity::Person
	 * Constraint Name: consol::GeneralHeaderConstraints::DataEnterer::AssignedEntity::Person::GeneralHeaderConstraintsDataEntererAssignedEntityPersonName
	 */
	public boolean ValidateGeneralHeaderConstraintsDataEntererAssignedEntityPersonName(DiagnosticChain vb, DataElementLevel del)
	{
		...
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.15.i.e.1 name\n\t\tConformance: SHALL contain at least one [1..*] name\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
