...
public class PersonFacade extends facade.FacadeBase {
	...
	*/
	...
	{
			ValidateGeneralHeaderConstraintsRecordTargetPatientRolePatientGuardianPersonName(vb, del);
	 ...
	 * Context: /GeneralHeaderConstraints/recordTarget/patientRole/patient/guardian/guardianPerson
	 * Context Class: consol::GeneralHeaderConstraints::RecordTarget::PatientRole::Patient::Guardian::Person
	 * Constraint Name: consol::GeneralHeaderConstraints::RecordTarget::PatientRole::Patient::Guardian::Person::GeneralHeaderConstraintsRecordTargetPatientRolePatientGuardianPersonName
	 */
	public boolean ValidateGeneralHeaderConstraintsRecordTargetPatientRolePatientGuardianPersonName(DiagnosticChain vb, DataElementLevel del)
	{
		...
		if (!result && vb != null)
		{
			vb.add(new BasicDiagnostic(Diagnostic.ERROR, null, 0, "Error: USRealmHeader - 2.5.12.i.d.9.iv.a name\n\t\tConformance: SHALL contain at least one [1..*] name\n\t\tAnalysis: n/a\n\t\tValidation message: n/a", new Object [] { self }));
		}
		return result;
	}
