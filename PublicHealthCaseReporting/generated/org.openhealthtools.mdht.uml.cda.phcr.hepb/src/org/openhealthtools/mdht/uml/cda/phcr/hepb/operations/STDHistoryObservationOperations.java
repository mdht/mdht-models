 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.hepb.STDHistoryObservation#validateProblemObservationCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Observation Code</em>}</li>
 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.hepb.STDHistoryObservation#validateProblemObservationStatusCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Observation Status Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class STDHistoryObservationOperations extends ProblemObservationOperations {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemObservationCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Observation Code</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemObservationCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.code = 'ASSERTION' and value.codeSystem = '2.16.840.1.113883.5.6'))";
	...
	/**
	 * The cached OCL invariant for the '{@link #validateProblemObservationCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Observation Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemObservationCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateProblemObservationCode(STDHistoryObservation stdHistoryObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(stdHistoryObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 HepbValidator.DIAGNOSTIC_SOURCE,
						 HepbValidator.STD_HISTORY_OBSERVATION__PROBLEM_OBSERVATION_CODE,
						 HepbPlugin.INSTANCE.getString("ProblemObservationCode"),
						 new Object [] { stdHistoryObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static final String GETHEPB_PROBLEM_STATUS__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(ccd::ProblemStatusObservation))->asSequence()->first().oclAsType(ccd::ProblemStatusObservation)";
	...
	public static  ProblemStatusObservation gethepbProblemStatus(STDHistoryObservation stdHistoryObservation) {
		if (GETHEPB_PROBLEM_STATUS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(HepbPackage.Literals.STD_HISTORY_OBSERVATION, HepbPackage.Literals.STD_HISTORY_OBSERVATION.getEAllOperations().get(69));
			try {
	...
	/**
	 * The cached OCL expression body for the '{@link #validateProblemObservationStatusCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Observation Status Code</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemObservationStatusCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.code = 'completed'))";
	...
	/**
	 * The cached OCL invariant for the '{@link #validateProblemObservationStatusCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Problem Observation Status Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateProblemObservationStatusCode(STDHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	public static  boolean validateProblemObservationStatusCode(STDHistoryObservation stdHistoryObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PROBLEM_OBSERVATION_STATUS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(stdHistoryObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 HepbValidator.DIAGNOSTIC_SOURCE,
						 HepbValidator.STD_HISTORY_OBSERVATION__PROBLEM_OBSERVATION_STATUS_CODE,
						 HepbPlugin.INSTANCE.getString("ProblemObservationStatusCode"),
						 new Object [] { stdHistoryObservation }));
			}
