...
public class HepbPackageImpl extends EPackageImpl implements HepbPackage {
	...
	public void initializePackageContents() {
		...
		op = addEOperation(viralHepatitisHistoryObservationEClass, ecorePackage.getEBoolean(), "validateProblemObservationCode", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = addEOperation(stdHistoryObservationEClass, ecorePackage.getEBoolean(), "validateProblemObservationCode", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		addAnnotation
		  (acuteHepatitisBCaseObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "AcuteHepatitisBCaseObservationTemplateId CaseObservationValue AcuteHepatitisBCaseObservationAcuteHepatitisBSignsAndSymptomsObservation",
			 "value.codeSystem", "2.16.840.1.113883.6.96"
		   });									
		addAnnotation
		  (acuteHepatitisBSignsAndSymptomsObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "AcuteHepatitisBSignsAndSymptomsObservationTemplateId SignsAndSymptomsObservationValue",
			 "value.codeSystem", "2.16.840.1.113883.6.96"
		   });			
		addAnnotation
		...
		addAnnotation
		  (viralHepatitisHistoryObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "ViralHepatitisHistoryObservationTemplateId ProblemObservationCode ViralHepatitisHistoryObservationValue",
			 "code.codeSystemName", "HL7ActCode",
			 "code.code", "ASSERTION",
		...
		addAnnotation
		  (stdHistoryObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "STDHistoryObservationTemplateId STDHistoryObservationClassCode ProblemObservationCode STDHistoryObservationMoodCode ProblemObservationStatusCode",
