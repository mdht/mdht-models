...
public class AcuteHepatitisBCDAValidate {
	...
	public static void main(String[] args) throws Exception {
		...
		HepbPackage.eINSTANCE.eClass();
		
		// 2. Load document
		String filePath = "samples";
		File fileIn = new File(filePath, "SampleHepatitisBCDA.xml");
		...
		AcuteHepatitisBCaseReport document = (AcuteHepatitisBCaseReport) CDAUtil.load(inputStream, result);
		inputStream.close();
