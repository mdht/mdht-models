...
"value.code = 'completed')";
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateAcuteHepatitisBRiskAssociatedProcedureStatusCodeP(AcuteHepatitisBRiskAssociatedProcedure, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BRisk Associated Procedure Status Code P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateAcuteHepatitisBRiskAssociatedProcedureStatusCodeP(AcuteHepatitisBRiskAssociatedProcedure, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.oclIsUndefined() or self.statusCode.isNullFlavorUndefined()) implies (not self.statusCode.oclIsUndefined())";

  /**
   * The cached OCL invariant for the '{@link #validateAcuteHepatitisBRiskAssociatedProcedureStatusCodeP(AcuteHepatitisBRiskAssociatedProcedure, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Acute Hepatitis BRisk Associated Procedure Status Code P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateAcuteHepatitisBRiskAssociatedProcedureStatusCodeP(AcuteHepatitisBRiskAssociatedProcedure, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateAcuteHepatitisBRiskAssociatedProcedureStatusCodeP(AcuteHepatitisBRiskAssociatedProcedure acuteHepatitisBRiskAssociatedProcedure, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HepbPackage.Literals.ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE);
      try
      {
        VALIDATE_ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(acuteHepatitisBRiskAssociatedProcedure))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             HepbValidator.DIAGNOSTIC_SOURCE,
             HepbValidator.ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE__ACUTE_HEPATITIS_BRISK_ASSOCIATED_PROCEDURE_STATUS_CODE_P,
             HepbPlugin.INSTANCE.getString("AcuteHepatitisBRiskAssociatedProcedureStatusCodeP"),
             new Object [] { acuteHepatitisBRiskAssociatedProcedure }));
      }
