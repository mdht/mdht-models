...
"value.codeSystem = '2.16.840.1.113883.6.96' and not value.code.oclIsUndefined()))";
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateViralHepatitisHistoryObservationValueP(ViralHepatitisHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Viral Hepatitis History Observation Value P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateViralHepatitisHistoryObservationValueP(ViralHepatitisHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->size() = 1 and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";

  /**
   * The cached OCL invariant for the '{@link #validateViralHepatitisHistoryObservationValueP(ViralHepatitisHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Viral Hepatitis History Observation Value P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateViralHepatitisHistoryObservationValueP(ViralHepatitisHistoryObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateViralHepatitisHistoryObservationValueP(ViralHepatitisHistoryObservation viralHepatitisHistoryObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
    if (VALIDATE_VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(HepbPackage.Literals.VIRAL_HEPATITIS_HISTORY_OBSERVATION);
      try
      {
        VALIDATE_VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(viralHepatitisHistoryObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             HepbValidator.DIAGNOSTIC_SOURCE,
             HepbValidator.VIRAL_HEPATITIS_HISTORY_OBSERVATION__VIRAL_HEPATITIS_HISTORY_OBSERVATION_VALUE_P,
             HepbPlugin.INSTANCE.getString("ViralHepatitisHistoryObservationValueP"),
             new Object [] { viralHepatitisHistoryObservation }));
      }
