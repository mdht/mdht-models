...
public class AcuteHepatitisBPHCRClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HepbPackage.Literals.ACUTE_HEPATITIS_BPHCR_CLINICAL_INFORMATION_SECTION, HepbPackage.Literals.ACUTE_HEPATITIS_BPHCR_CLINICAL_INFORMATION_SECTION.getEAllOperations().get(76));
      try
      {
