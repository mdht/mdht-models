...
public class AcuteHepatitisBSocialHistorySectionOperations extends PhcrSocialHistorySectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(HepbPackage.Literals.ACUTE_HEPATITIS_BSOCIAL_HISTORY_SECTION, HepbPackage.Literals.ACUTE_HEPATITIS_BSOCIAL_HISTORY_SECTION.getEAllOperations().get(88));
      try
      {
