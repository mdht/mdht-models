		...
		addAnnotation
		  (wnvCaseObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "WnvCaseObservationTemplateId",
		...
		addAnnotation
		  (wnvSignsAndSymptomsObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "WnvSignsAndSymptomsObservationTemplateId"
		   });			
		addAnnotation
		...
		addAnnotation
		  (wnvResultObservationEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "WnvResultObservationTemplateId ResultObservationCode",
			 "code.codeSystemName", ""
		   });			
		addAnnotation
		  (wnvResultOrganizerEClass, 
		   ...
		   new String[] {
			 ...
			 "constraints.validation.error", "WnvResultOrganizerTemplateId ResultOrganizerCode WnvResultOrganizerWnvResultObservation",
			 "code.codeSystemName", ""
		   });							
	}
