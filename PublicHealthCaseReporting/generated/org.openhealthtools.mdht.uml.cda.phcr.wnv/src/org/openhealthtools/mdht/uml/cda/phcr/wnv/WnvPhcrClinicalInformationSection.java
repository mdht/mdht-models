 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.15.2.45' constraints.validation.error='WnvPhcrClinicalInformationSectionTemplateId WnvPhcrClinicalInformationSectionWnvCaseObservation'"
 * @generated
 */
public interface WnvPhcrClinicalInformationSection extends PhcrClinicalInformationSection
{
  /**
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(wnv::WnvCaseObservation))->asSequence()->first().oclAsType(wnv::WnvCaseObservation)
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(wnv::WnvCaseObservation))->asSequence()->first().oclAsType(wnv::WnvCaseObservation)'"
	 * @generated
	 */
