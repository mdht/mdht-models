...
public class WnvCaseObservationOperations extends CaseObservationOperations {
   ...
   */
	...
	/**
   * The cached OCL expression body for the '{@link #validateWnvCaseObservationValue(WnvCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Wnv Case Observation Value</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateWnvCaseObservationValue(WnvCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_WNV_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (not self.value->isEmpty())";

  /**
   * The cached OCL invariant for the '{@link #validateWnvCaseObservationValue(WnvCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Wnv Case Observation Value</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateWnvCaseObservationValue(WnvCaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_WNV_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateWnvCaseObservationValue(WnvCaseObservation wnvCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (VALIDATE_WNV_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
    {
      ...
      try
      {
        VALIDATE_WNV_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_WNV_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_WNV_CASE_OBSERVATION_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(wnvCaseObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
