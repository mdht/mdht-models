...
public class WestNileVirusCaseReportOperations extends PublicHealthCaseReportOperations
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final String GET_WNV_PHCR_CLINICAL_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(wnv::WnvPhcrClinicalInformationSection))->asSequence()->first().oclAsType(wnv::WnvPhcrClinicalInformationSection)";
  ...
  public static  WnvPhcrClinicalInformationSection getWnvPhcrClinicalInformationSection(WestNileVirusCaseReport westNileVirusCaseReport)
  {
		if (GET_WNV_PHCR_CLINICAL_INFORMATION_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(WnvPackage.Literals.WEST_NILE_VIRUS_CASE_REPORT, WnvPackage.Literals.WEST_NILE_VIRUS_CASE_REPORT.getEAllOperations().get(62));
			try {
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final String GET_WNV_PHCR_RELEVANT_DX_TESTS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(wnv::WnvPhcrRelevantDxTestsSection))->asSequence()->first().oclAsType(wnv::WnvPhcrRelevantDxTestsSection)";
