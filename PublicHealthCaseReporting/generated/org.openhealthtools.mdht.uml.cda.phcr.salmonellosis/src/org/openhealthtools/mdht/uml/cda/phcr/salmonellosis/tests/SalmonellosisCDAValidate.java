...
public class SalmonellosisCDAValidate {
	...
	public static SalmonellosisFactory SALMONELLOSIS = SalmonellosisFactory.eINSTANCE;
	...
	public static void main(String[] args) throws Exception {
		...
		SalmonellosisCaseReport document = (SalmonellosisCaseReport) CDAUtil.load(inputStream, result);
		inputStream.close();
