...
public class SalmonellosisValidator extends EObjectValidator {
   ...
   * @generated
   */
  public static final int HIV_STATUS_OBSERVATION__HIV_STATUS_OBSERVATION_TEMPLATE_ID = 13;
   ...
   * @generated
   */
	public static final int SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION__SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION_SALMONELLOSIS_RESULT_ORGANIZER = 18;
   ...
   * @generated
   */
	public static final int SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION__SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION_SALMONELLOSIS_RESULT_OBSERVATION = 19;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_PHCR_RELEVANT_DX_TESTS_SECTION__RESULTS_SECTION_TEMPLATE_ID = 20;
   ...
   * @generated
   */
	public static final int SALMONELLOSIS_RESULT_ORGANIZER__SALMONELLOSIS_RESULT_ORGANIZER_SALMONELLOSIS_RESULT_OBSERVATION = 21;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_RESULT_ORGANIZER__RESULT_ORGANIZER_TEMPLATE_ID = 22;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_RESULT_OBSERVATION__RESULT_OBSERVATION_TEMPLATE_ID = 23;
   ...
   * @generated
   */
	public static final int SALMONELLOSIS_PHCR_CLINICAL_INFORMATION_SECTION__SALMONELLOSIS_PHCR_CLINICAL_INFORMATION_SECTION_SALMONELLOSIS_CASE_OBSERVATION = 24;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_PHCR_CLINICAL_INFORMATION_SECTION__PHCR_CLINICAL_INFORMATION_SECTION_TEMPLATE_ID = 25;
   ...
   * @generated
   */
	public static final int SALMONELLOSIS_CASE_OBSERVATION__SALMONELLOSIS_CASE_OBSERVATION_SALMONELLOSIS_SIGNS_AND_SYMPTOMS_OBSERVATION = 26;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_CASE_OBSERVATION__PROBLEM_OBSERVATION_TEMPLATE_ID = 27;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_SIGNS_AND_SYMPTOMS_OBSERVATION__SIGNS_AND_SYMPTOMS_OBSERVATION_TEMPLATE_ID = 28;
   ...
   * @generated
   */
  public static final int SALMONELLOSIS_POSSIBLE_EXPOSURE_LOCATION_AND_TYPE_ACT__SALMONELLOSIS_POSSIBLE_EXPOSURE_LOCATION_AND_TYPE_ACT_CLASS_CODE = 12;
   ...
   * @generated
   */
	public static final int HIV_STATUS_OBSERVATION__HIV_STATUS_OBSERVATION_CODE = 14;
   ...
   * @generated
   */
	public static final int HIV_STATUS_OBSERVATION__HIV_STATUS_OBSERVATION_STATUS_CODE = 15;
   ...
   * @generated
   */
  public static final int HIV_STATUS_OBSERVATION__HIV_STATUS_OBSERVATION_CLASS_CODE = 16;
   ...
   * @generated
   */
  public static final int HIV_STATUS_OBSERVATION__HIV_STATUS_OBSERVATION_MOOD_CODE = 17;
   ...
   */
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrSocialHistorySection_validateSocialHistorySectionCode(salmonellosisPHCRSocialHistorySection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= phcrValidator.validatePhcrRelevantDxTestsSection_validateResultsSectionCode(salmonellosisPHCRRelevantDxTestsSection, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateResultOrganizer_validateResultOrganizerStatusCode(salmonellosisResultOrganizer, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateResultObservation_validateResultObservationStatusCode(salmonellosisResultObservation, diagnostics, context);
   ...
   */
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateProblemObservationStatusCode(salmonellosisCaseObservation, diagnostics, context);
    ...
    if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateProblemObservationCode(salmonellosisCaseObservation, diagnostics, context);
