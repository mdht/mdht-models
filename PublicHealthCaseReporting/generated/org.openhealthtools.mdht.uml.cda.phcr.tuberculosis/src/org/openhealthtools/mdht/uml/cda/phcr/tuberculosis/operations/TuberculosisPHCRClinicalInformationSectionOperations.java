...
public class TuberculosisPHCRClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String GET_TUBERCULOSIS_CASE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(tuberculosis::TuberculosisCaseObservation))->asSequence()->first().oclAsType(tuberculosis::TuberculosisCaseObservation)";
