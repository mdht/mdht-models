...
public class TuberculosisCaseReportOperations extends PublicHealthCaseReportOperations {
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String GET_TUBERCULOSIS_PHCR_CLINICAL_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(tuberculosis::TuberculosisPHCRClinicalInformationSection))->asSequence()->first().oclAsType(tuberculosis::TuberculosisPHCRClinicalInformationSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_TUBERCULOSIS_PHCR_RELEVANT_DX_TESTS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(tuberculosis::TuberculosisPHCRRelevantDxTestsSection))->asSequence()->first().oclAsType(tuberculosis::TuberculosisPHCRRelevantDxTestsSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_TUBERCULOSIS_PHCR_IMMUNIZATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(tuberculosis::TuberculosisPHCRImmunizationSection))->asSequence()->first().oclAsType(tuberculosis::TuberculosisPHCRImmunizationSection)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.15.1.1')
	 * @param tuberculosisCaseReport The receiving '<em><b>Case Report</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
