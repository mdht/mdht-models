 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='TuberculosisRelevantMedicalConditionHistoryObservationTemplateId TuberculosisRelevantMedicalConditionHistoryObservationValue TuberculosisRelevantMedicalConditionHistoryObservationTuberculosisRelevantMedicalConditionProblemObservation' templateId.root='2.16.840.1.113883.10.20.15.3.107' value.code='398192003' value.codeSystem='2.16.840.1.113883.6.96' value.codeSystemName='SNOMEDCT' value.displayName='Co-morbid conditions'"
 * @generated
 */
public interface TuberculosisRelevantMedicalConditionHistoryObservation extends PhcrRelevantMedicalConditionHistoryObservation
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  boolean validateTuberculosisRelevantMedicalConditionHistoryObservationValue(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(tuberculosis::TuberculosisRelevantMedicalConditionProblemObservation))->asSequence()->any(true).oclAsType(tuberculosis::TuberculosisRelevantMedicalConditionProblemObservation)'"
	 * @generated
	 */
