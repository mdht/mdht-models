...
public class TSSCDACreateOLD2 {
	...
	public static void setCustodian(PublicHealthCaseReport document) throws Exception {
		...
		custodianOrgAddress.addStreetAddressLine("Lisa Custodian Address");
	...
	public static void setTreatmentInformationSection(PublicHealthCaseReport document) throws Exception {
			...
			if (hasTreatmentInformation) {
				...
				clindamycinTimeHigh.setValue(TIME_STAMP);
				...
				vancomycinTimeHigh.setValue(TIME_STAMP);
	...
	public static void setEncountersSection(PublicHealthCaseReport document) throws Exception {
		...
		String encounterSectionText = timeStampFormat(TIME_STAMP, TEST_DATE_FORMAT) + " at Lisa Encounter Hospital, Address line 1, City, State Zip (tel:123-456-7890)";
	...
	public static void setDxTestsSection(PublicHealthCaseReport document) throws Exception {
		...
		// Test Result: Datatypes.createCE("3092008", SNOMED_OID, SNOMED_SYSTEM_NAME, "Staphylococcus aureus");
		...
		ANY bloodTestValue = Datatypes.createCD("3092008", SNOMED_OID, SNOMED_SYSTEM_NAME, "Staphylococcus aureus");
		...
		String bloodTestLabObservationSectionText1 = bloodTestSpecimenType.getDisplayName() + " collected on " +
			timeStampFormat(TEST_TIME_STAMP, TEST_DATE_FORMAT) + ", " + bloodTestCode.getDisplayName() + " result: Staphylococcus aureus";
		String bloodTestLabObservationSectionText2 = "Lisa Laboratory name, 36 Massachusetts Avenue, MA 02813  (tel:1-617-536-9876)";
		...
		bloodTestOrganizationName.addText("Laboratory name");
		
		AD bloodTestOrganizationAddress = Datatypes.createAD();
		bloodTestOrganizationAddress.addStreetAddressLine("36 Massachusetts Avenue");
		...
		TEL bloodTestOrganizationTelecom = Datatypes.createTEL("tel:+1-617-536-9876");
	...
	private static EncountersActivity createEncountersActivity(List<II> idList, IVL_TS effectiveTime, CD encounterType) throws Exception {
		...
		performerAddress.addStreetAddressLine("Lisa Address");
