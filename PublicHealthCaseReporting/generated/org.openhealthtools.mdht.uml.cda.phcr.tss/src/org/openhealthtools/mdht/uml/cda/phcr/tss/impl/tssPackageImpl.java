...
public class tssPackageImpl extends EPackageImpl implements tssPackage {
	...
	public static tssPackage init() {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.phcr.tss", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(thetssPackage);
