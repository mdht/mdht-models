...
public class tssValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final int TSS_CASE_OBSERVATION__TSS_CASE_OBSERVATION_TSS_SIGNS_AND_SYMPTOMS_OBSERVATION = 7;
	 ...
	 * @generated
	 */
	public static final int TSS_CASE_OBSERVATION__PROBLEM_OBSERVATION_TEMPLATE_ID = 8;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Case Observation Value' of 'Tss Case Observation'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int TSS_CASE_OBSERVATION__CASE_OBSERVATION_VALUE = 9;
	 ...
	 * @generated
	 */
	public static final int TSS_SIGNS_AND_SYMPTOMS_OBSERVATION__SIGNS_AND_SYMPTOMS_OBSERVATION_TEMPLATE_ID = 10;
	 ...
	 * @generated
	 */
	public static final int TSS_PHCR_RELEVANT_DX_TESTS_SECTION__TSS_PHCR_RELEVANT_DX_TESTS_SECTION_TSS_RESULT_ORGANIZER = 11;
	 ...
	 * @generated
	 */
	public static final int TSS_PHCR_RELEVANT_DX_TESTS_SECTION__TSS_PHCR_RELEVANT_DX_TESTS_SECTION_TSS_RESULT_OBSERVATION = 12;
	 ...
	 * @generated
	 */
	public static final int TSS_PHCR_RELEVANT_DX_TESTS_SECTION__RESULTS_SECTION_TEMPLATE_ID = 13;
	 ...
	 * @generated
	 */
	public static final int TSS_RESULT_ORGANIZER__TSS_RESULT_ORGANIZER_TSS_RESULT_OBSERVATION = 14;
	 ...
	 * @generated
	 */
	public static final int TSS_RESULT_ORGANIZER__RESULT_ORGANIZER_TEMPLATE_ID = 15;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Result Organizer Code' of 'Tss Result Organizer'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int TSS_RESULT_ORGANIZER__RESULT_ORGANIZER_CODE = 16;
	 ...
	 * @generated
	 */
	public static final int TSS_RESULT_OBSERVATION__RESULT_OBSERVATION_TEMPLATE_ID = 17;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Validate Result Observation Code' of 'Tss Result Observation'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int TSS_RESULT_OBSERVATION__RESULT_OBSERVATION_CODE = 18;
	...
	public boolean validateTssCaseObservation(TssCaseObservation tssCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateProblemObservationStatusCode(tssCaseObservation, diagnostics, context);
		...
		if (result || diagnostics != null) result &= phcrValidator.validateCaseObservation_validateProblemObservationCode(tssCaseObservation, diagnostics, context);
		...
		if (result || diagnostics != null) result &= validateTssCaseObservation_validateCaseObservationValue(tssCaseObservation, diagnostics, context);
	...
	/**
	 * Validates the validateCaseObservationValue constraint of '<em>Tss Case Observation</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateTssCaseObservation_validateCaseObservationValue(TssCaseObservation tssCaseObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return tssCaseObservation.validateCaseObservationValue(diagnostics, context);
	}
	...
	public boolean validateTssPhcrRelevantDxTestsSection(TssPhcrRelevantDxTestsSection tssPhcrRelevantDxTestsSection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= phcrValidator.validatePhcrRelevantDxTestsSection_validateResultsSectionCode(tssPhcrRelevantDxTestsSection, diagnostics, context);
	...
	public boolean validateTssResultOrganizer(TssResultOrganizer tssResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateTssResultOrganizer_validateResultOrganizerCode(tssResultOrganizer, diagnostics, context);
		if (result || diagnostics != null) result &= phcrValidator.validateResultOrganizer_validateResultOrganizerStatusCode(tssResultOrganizer, diagnostics, context);
	...
	/**
	 * Validates the validateResultOrganizerCode constraint of '<em>Tss Result Organizer</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateTssResultOrganizer_validateResultOrganizerCode(TssResultOrganizer tssResultOrganizer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return tssResultOrganizer.validateResultOrganizerCode(diagnostics, context);
	}
	...
	public boolean validateTssResultObservation(TssResultObservation tssResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= phcrValidator.validateResultObservation_validateResultObservationStatusCode(tssResultObservation, diagnostics, context);
		if (result || diagnostics != null) result &= validateTssResultObservation_validateResultObservationCode(tssResultObservation, diagnostics, context);
	...
	/**
	 * Validates the validateResultObservationCode constraint of '<em>Tss Result Observation</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateTssResultObservation_validateResultObservationCode(TssResultObservation tssResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return tssResultObservation.validateResultObservationCode(diagnostics, context);
	}
