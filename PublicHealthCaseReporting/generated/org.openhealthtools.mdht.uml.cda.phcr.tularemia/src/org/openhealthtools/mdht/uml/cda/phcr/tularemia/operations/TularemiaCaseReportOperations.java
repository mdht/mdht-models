...
public class TularemiaCaseReportOperations extends PublicHealthCaseReportOperations {
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String GET_TULAREMIA_PHCR_SOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(tularemia::TularemiaPHCRSocialHistorySection))->asSequence()->first().oclAsType(tularemia::TularemiaPHCRSocialHistorySection)";
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final String GETTULAREMIA_PHCR_ENCOUNTERS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(phcr::PhcrEncountersSection))->asSequence()->first().oclAsType(phcr::PhcrEncountersSection)";
  ...
  public static  TularemiaPHCRRelevantDxTestsSection getTularemiaPHCRRelevantDxTestsSection(TularemiaCaseReport tularemiaCaseReport)
  {
		if (GET_TULAREMIA_PHCR_RELEVANT_DX_TESTS_SECTION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(TularemiaPackage.Literals.TULAREMIA_CASE_REPORT, TularemiaPackage.Literals.TULAREMIA_CASE_REPORT.getEAllOperations().get(70));
			try {
