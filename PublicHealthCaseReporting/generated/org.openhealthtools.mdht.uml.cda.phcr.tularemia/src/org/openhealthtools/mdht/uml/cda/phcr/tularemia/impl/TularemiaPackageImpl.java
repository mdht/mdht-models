...
public class TularemiaPackageImpl extends EPackageImpl implements TularemiaPackage {
	...
	public static TularemiaPackage init() {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.phcr.tularemia", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(theTularemiaPackage);
	...
	public void initializePackageContents() {
        ...
        op = addEOperation(tularemiaResultOrganizerEClass, ecorePackage.getEBoolean(), "validateTularemiaResultOrganizerCodeP", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
        ...
        op = addEOperation(tularemiaResultObservationEClass, ecorePackage.getEBoolean(), "validateTularemiaResultObservationCodeP", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
