 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultObservation#validateResultObservationCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Observation Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TularemiaResultObservationOperations extends ResultObservationOperations
{
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TULAREMIA_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";
	...
	public static  boolean validateTularemiaResultObservationCode(TularemiaResultObservation tularemiaResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_TULAREMIA_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(tularemiaResultObservation)) {
			...
			if (context != null) {
				...
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultObservationCode");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultObservationCode", passToken);
				}
  ...
  /**
	 * The cached OCL expression body for the '{@link #validateResultObservationCode(TularemiaResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Observation Code</em>}' operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #validateResultObservationCode(TularemiaResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
...
"value.codeSystem = '2.16.840.1.113883.6.1' and not value.code.oclIsUndefined())";
  ...
  /**
	 * The cached OCL invariant for the '{@link #validateResultObservationCode(TularemiaResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Result Observation Code</em>}' invariant operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #validateResultObservationCode(TularemiaResultObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static  boolean validateResultObservationCode(TularemiaResultObservation tularemiaResultObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
  	  
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.phcr.tularemia.TularemiaResultObservationCode");
		...
		if (!EOCL_ENV.createQuery(VALIDATE_RESULT_OBSERVATION_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(tularemiaResultObservation)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 TularemiaValidator.DIAGNOSTIC_SOURCE,
						 TularemiaValidator.TULAREMIA_RESULT_OBSERVATION__RESULT_OBSERVATION_CODE,
						 TularemiaPlugin.INSTANCE.getString("ResultObservationCode"),
						 new Object [] { tularemiaResultObservation }));
			}
