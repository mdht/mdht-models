...
public class PertussisCDAValidate {
	...
	public static void main(String[] args) throws Exception {
		...
		PertussisPackage.eINSTANCE.eClass();
		
		// 2. Load document
		String filePath = "samples";
		File fileIn = new File(filePath, "SamplePertussisCDA2.xml");
		...
		PertussisCaseReport document = (PertussisCaseReport) CDAUtil.load(inputStream, result);
		inputStream.close();
