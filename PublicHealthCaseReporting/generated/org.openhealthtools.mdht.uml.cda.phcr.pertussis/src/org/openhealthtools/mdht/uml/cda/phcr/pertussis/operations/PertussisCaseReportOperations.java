...
public class PertussisCaseReportOperations extends PublicHealthCaseReportOperations
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final String GET_PERTUSSIS_SOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(pertussis::PertussisSocialHistorySection))->asSequence()->first().oclAsType(pertussis::PertussisSocialHistorySection)";
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String GET_PERTUSSIS_CLINICAL_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(pertussis::PertussisClinicalInformationSection))->asSequence()->first().oclAsType(pertussis::PertussisClinicalInformationSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PERTUSSIS_RELEVANT_DX_TESTS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(pertussis::PertussisRelevantDxTestsSection))->asSequence()->first().oclAsType(pertussis::PertussisRelevantDxTestsSection)";
	 ...
	 * @ordered
	 */
	protected static final String GET_PERTUSSIS_IMMUNIZATIONS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(pertussis::PertussisImmunizationsSection))->asSequence()->first().oclAsType(pertussis::PertussisImmunizationsSection)";
