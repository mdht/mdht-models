...
public class PertussisCDACreate2 {
	...
	public static String TIME_STAMP_REPORT = "20111219080000-0500";
	...
	public static String UUID_RPLC = "ccbcad11-ac40-4948-a19b-d6bae604ae14";
...
//			}		
		...
		File fileOut = new File(filePathOut, "SamplePertussisCDA2.xml");
	...
	public static void setSocialHistorySection(PublicHealthCaseReport document) throws Exception {
		...
		// Pertussis Possible Case Contacts Location (SHOULD) 0..*
		// Transmission Setting Value Set 2.16.840.1.114222.4.11.1052
		// https://phinvads.cdc.gov/vads/ViewValueSet.action?id=89D34BBC-617F-DD11-B38D-00188B398520
		
		
		boolean hasCaseContacts = true;
		String contactStreetAddress = "12 W Main Street";
		String contactTelephone = "tel:+1-845-555-5555";
		String contactTypeCode = "264362003";
		String contactTypeDisplayName = "Home";
		String caseContactSectionText1 = "Possible Case Contact - Home Exposure, Lisa Trenton (mother)";
		String caseContactSectionText2 = "Possible Case Contact - Home Exposure, Mary Trenton (sister)";
		
		if (hasCaseContacts) {
			IVL_TS caseContactTime = Datatypes.createIVL_TS(TIME_STAMP_ENCOUNTER1);

			AD caseContactAddress = Datatypes.createAD();
			caseContactAddress.addStreetAddressLine(contactStreetAddress);
			caseContactAddress.addCity(TEST_CITY);
			caseContactAddress.addState(TEST_STATE);
			caseContactAddress.addPostalCode(TEST_POSTALCODE);

			TEL caseContactTelecom = Datatypes.createTEL(contactTelephone);

			CE caseContactTypeCode = Datatypes.createCE(contactTypeCode, SNOMED_OID, SNOMED_SYSTEM_NAME, contactTypeDisplayName);

			PertussisPossibleCaseContactLocationAct caseContactLocationAct = PERTUSSIS.createPertussisPossibleCaseContactLocationAct().init();

			CD actCode = caseContactLocationAct.getCode();
			...
			CD qualifierCode1 = Datatypes.createCD("444387000", SNOMED_OID, SNOMED_SYSTEM_NAME, "Case Contact");
			...
			actCode.getQualifiers().add(actCodeQualifier1);
			actCode.getQualifiers().add(actCodeQualifier2);
			caseContactLocationAct.setCode(actCode);

			// Case Contact Location
			Participant2 caseContactParticipant = CDA.createParticipant2();
			caseContactParticipant.setTypeCode(ParticipationType.LOC);
			ParticipantRole contactParticipantRole = CDA.createParticipantRole();
			contactParticipantRole.setClassCode(RoleClassRoot.LOCE);
			PlayingEntity contactPlayingEntity = CDA.createPlayingEntity();
			contactPlayingEntity.setClassCode(EntityClassRoot.PLC);
			contactParticipantRole.setPlayingEntity(contactPlayingEntity);
			caseContactParticipant.setParticipantRole(contactParticipantRole);
			caseContactLocationAct.getParticipants().add(caseContactParticipant);

			caseContactParticipant.setTime(caseContactTime);
			if (caseContactAddress != null) {
				contactParticipantRole.getAddrs().add(caseContactAddress);
			}
			if (caseContactTelecom != null) {
				contactParticipantRole.getTelecoms().add(caseContactTelecom);
			}
			if (caseContactTypeCode != null) {
				contactPlayingEntity.setCode(caseContactTypeCode);
			}
			
			// Exposure Contacts
			
			PN contactName1 = Datatypes.createPN();
			contactName1.addFamily("Trenton");
			contactName1.addGiven("Lisa");
			
			CE contactRelationship1 = Datatypes.createCE("MTH", "2.16.840.1.113883.5.111", "HL7 RoleCode", "Mother");
			
			Participant2 exposureParticipant1 = CDA.createParticipant2();
			exposureParticipant1.setTypeCode(ParticipationType.DIR);
			ParticipantRole exposureParticipantRole1 = CDA.createParticipantRole();
			exposureParticipantRole1.setClassCode(RoleClassRoot.EXPR);
			PlayingEntity exposurePlayingEntity1 = CDA.createPlayingEntity();
			exposurePlayingEntity1.setClassCode(EntityClassRoot.PSN);
			exposureParticipantRole1.setPlayingEntity(exposurePlayingEntity1);
			exposureParticipant1.setParticipantRole(exposureParticipantRole1);
			caseContactLocationAct.getParticipants().add(exposureParticipant1);

			exposurePlayingEntity1.getNames().add(contactName1);
			exposurePlayingEntity1.setCode(contactRelationship1);
			
			
			PN contactName2 = Datatypes.createPN();
			contactName2.addFamily("Trenton");
			contactName2.addGiven("Mary");
			
			CE contactRelationship2 = Datatypes.createCE("SIS", "2.16.840.1.113883.5.111", "HL7 RoleCode", "Sister");
			
			Participant2 exposureParticipant2 = CDA.createParticipant2();
			exposureParticipant2.setTypeCode(ParticipationType.DIR);
			ParticipantRole exposureParticipantRole2 = CDA.createParticipantRole();
			exposureParticipantRole2.setClassCode(RoleClassRoot.EXPR);
			PlayingEntity exposurePlayingEntity2 = CDA.createPlayingEntity();
			exposurePlayingEntity2.setClassCode(EntityClassRoot.PSN);
			exposureParticipantRole2.setPlayingEntity(exposurePlayingEntity2);
			exposureParticipant2.setParticipantRole(exposureParticipantRole2);
			caseContactLocationAct.getParticipants().add(exposureParticipant2);

			exposurePlayingEntity2.getNames().add(contactName2);
			exposurePlayingEntity2.setCode(contactRelationship2);

			socialHistorySection.addAct(caseContactLocationAct);
			((Entry) caseContactLocationAct.eContainer()).setTypeCode(x_ActRelationshipEntry.DRIV);
		...
		if (hasSocialHistory) {
			...
			// Pertussis possible case contact
			items.add(caseContactSectionText1);
			items.add(caseContactSectionText2);
	...
	public static void setDxTestsSection(PublicHealthCaseReport document) throws Exception {
		...
		String pcrLabObservationSectionText1 = pcrSpecimenType.getDisplayName() + " collected on " +
			timeStampFormat(TIME_STAMP_ENCOUNTER2, TEST_DATE_FORMAT) + ", " + pcrCode.getDisplayName() + " accession 11MD89206 result: Positive";
		...
		cultIdList.add(Datatypes.createII(TEST_ROOT, "11MD89206"));
		...
		ANY cultValue = Datatypes.createCD("5247005", SNOMED_OID, SNOMED_SYSTEM_NAME, "Bordetella pertussis");
		...
		String cultLabObservationSectionText1 = cultSpecimenType.getDisplayName() + " collected on " +
			timeStampFormat(TIME_STAMP_ENCOUNTER2, TEST_DATE_FORMAT) + ", " + cultCode.getDisplayName() + " accession 11MD89206 result: Bordetella pertussis";
