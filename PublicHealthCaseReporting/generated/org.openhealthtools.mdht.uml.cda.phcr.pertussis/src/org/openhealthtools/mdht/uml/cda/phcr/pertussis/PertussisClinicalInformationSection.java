 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation templateId.root='2.16.840.1.113883.10.20.15.2.25' constraints.validation.error='PertussisClinicalInformationSectionTemplateId PertussisClinicalInformationSectionPertussisCaseObservation'"
 * @generated
 */
public interface PertussisClinicalInformationSection extends PhcrClinicalInformationSection {
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(pertussis::PertussisCaseObservation))->asSequence()->first().oclAsType(pertussis::PertussisCaseObservation)'"
	 * @generated
	 */
