...
public class ChlamydiatrachomatisPublicHealthCaseReportOperations extends PublicHealthCaseReportOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(ChlamydiatrachomatisPackage.Literals.CHLAMYDIATRACHOMATIS_PUBLIC_HEALTH_CASE_REPORT, ChlamydiatrachomatisPackage.Literals.CHLAMYDIATRACHOMATIS_PUBLIC_HEALTH_CASE_REPORT.getEAllOperations().get(66));
      try
      {
