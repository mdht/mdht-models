...
public class SilicosisPHCRClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
  ...
  /**
	 ...
	 * @ordered
	 */
	protected static final String GET_SILICOSIS_CASE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(silicosis::SilicosisCaseObservation))->asSequence()->first().oclAsType(silicosis::SilicosisCaseObservation)";
	...
	public static  SilicosisCaseObservation getSilicosisCaseObservation(SilicosisPHCRClinicalInformationSection silicosisPHCRClinicalInformationSection) {
		if (GET_SILICOSIS_CASE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(SilicosisPackage.Literals.SILICOSIS_PHCR_CLINICAL_INFORMATION_SECTION, SilicosisPackage.Literals.SILICOSIS_PHCR_CLINICAL_INFORMATION_SECTION.getEAllOperations().get(68));
			try {
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  protected static final String GET_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(silicosis::SilicosisHistoryOfTuberculosisObservation))->asSequence()->first().oclAsType(silicosis::SilicosisHistoryOfTuberculosisObservation)";
  ...
  public static  SilicosisHistoryOfTuberculosisObservation getSilicosisHistoryOfTuberculosisObservation(SilicosisPHCRClinicalInformationSection silicosisPHCRClinicalInformationSection)
  {
		if (GET_SILICOSIS_HISTORY_OF_TUBERCULOSIS_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(SilicosisPackage.Literals.SILICOSIS_PHCR_CLINICAL_INFORMATION_SECTION, SilicosisPackage.Literals.SILICOSIS_PHCR_CLINICAL_INFORMATION_SECTION.getEAllOperations().get(69));
			try {
