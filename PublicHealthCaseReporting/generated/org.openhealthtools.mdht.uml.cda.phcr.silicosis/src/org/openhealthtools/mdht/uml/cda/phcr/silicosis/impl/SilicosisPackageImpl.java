...
public class SilicosisPackageImpl extends EPackageImpl implements SilicosisPackage {
  ...
  /**
	...
	public static SilicosisPackage init() {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.phcr.silicosis", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(theSilicosisPackage);
  ...
  /**
	...
	public void initializePackageContents() {
        ...
        op = addEOperation(silicosisHistoryOfTuberculosisObservationEClass, ecorePackage.getEBoolean(), "validateSilicosisHistoryOfTuberculosisObservationValueP", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
    ...
    protected void createUmlAnnotations()
    {
        ...
        addAnnotation
          (this, 
           ...
           new String[] 
           {
             "initializers", "org.openhealthtools.mdht.uml.cda.phcr.silicosis"
           });                                                                                                          
    }
	...
	protected void createAnnotationAnnotations() {
        ...
        addAnnotation
          (silicosisHistoryOfTuberculosisObservationEClass, 
           ...
           new String[] 
           {
             "constraints.validation.error", "SilicosisHistoryOfTuberculosisObservationTemplateId SilicosisHistoryOfTuberculosisObservationClassCode SilicosisHistoryOfTuberculosisObservationValue SilicosisHistoryOfTuberculosisObservationValueP",
