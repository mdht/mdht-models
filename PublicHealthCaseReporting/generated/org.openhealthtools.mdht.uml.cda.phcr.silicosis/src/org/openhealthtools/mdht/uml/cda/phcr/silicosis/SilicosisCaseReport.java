 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation title.mixed='Public Health Case Report - Silicosis' templateId.root='2.16.840.1.113883.10.20.15.1.8' constraints.validation.error='SilicosisCaseReportTemplateId SilicosisCaseReportTitle SilicosisCaseReportSilicosisPHCRClinicalInformationSection' constraints.validation.warning='SilicosisCaseReportSilicosisPHCRSocialHistorySection SilicosisCaseReportSilicosisPHCRRelevantDxTestsSection'"
 * @generated
 */
public interface SilicosisCaseReport extends PublicHealthCaseReport {
  ...
  /**
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRSocialHistorySection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRSocialHistorySection)
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRSocialHistorySection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRSocialHistorySection)'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRClinicalInformationSection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRClinicalInformationSection)
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRClinicalInformationSection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRClinicalInformationSection)'"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRRelevantDxTestsSection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRRelevantDxTestsSection)
	 * <!-- end-model-doc -->
	 * @model kind="operation" required="true" ordered="false"
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(silicosis::SilicosisPHCRRelevantDxTestsSection))->asSequence()->first().oclAsType(silicosis::SilicosisPHCRRelevantDxTestsSection)'"
	 * @generated
	 */
