...
public class AnthraxPackageImpl extends EPackageImpl implements AnthraxPackage {
	...
	public static AnthraxPackage init() {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.phcr.anthrax", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(theAnthraxPackage);
