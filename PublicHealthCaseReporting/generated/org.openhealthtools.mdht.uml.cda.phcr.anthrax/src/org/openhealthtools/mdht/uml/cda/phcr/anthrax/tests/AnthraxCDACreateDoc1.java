...
public class AnthraxCDACreateDoc1 {
	...
	public static String TIME_STAMP = "20070829100000-0400";
	...
	public static String UUID = "998613c8-6d4f-4722-b3ab-d8652daaf726";
	...
	public static void main(String[] args) throws Exception {
		...
		File fileOut = new File(filePathOut, "AnthraxCaseReport1.xml");
