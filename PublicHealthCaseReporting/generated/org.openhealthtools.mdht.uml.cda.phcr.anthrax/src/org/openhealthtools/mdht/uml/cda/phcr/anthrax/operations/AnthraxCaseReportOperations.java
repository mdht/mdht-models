...
public class AnthraxCaseReportOperations extends PublicHealthCaseReportOperations {
   ...
   * @ordered
   */
	protected static final String GET_ANTHRAX_PHCR_SOCIAL_HISTORY_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(anthrax::AnthraxPhcrSocialHistorySection))->asSequence()->any(true).oclAsType(anthrax::AnthraxPhcrSocialHistorySection)";
   ...
   * @ordered
   */
	protected static final String GET_ANTHRAX_PHCR_TREATMENT_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(anthrax::AnthraxPhcrTreatmentInformationSection))->asSequence()->any(true).oclAsType(anthrax::AnthraxPhcrTreatmentInformationSection)";
   ...
   * @ordered
   */
	protected static final String GET_ANTHRAX_PHCR_RELEVANT_DX_TESTS_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(anthrax::AnthraxPhcrRelevantDxTestsSection))->asSequence()->any(true).oclAsType(anthrax::AnthraxPhcrRelevantDxTestsSection)";
