...
public class AnthraxPhcrTreatmentInformationSectionOperations extends PhcrTreatmentInformationSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_ANTHRAX_THERAPEUTIC_REGIMEN_ACT__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(anthrax::AnthraxTherapeuticRegimenAct))->asSequence()->first().oclAsType(anthrax::AnthraxTherapeuticRegimenAct)";
