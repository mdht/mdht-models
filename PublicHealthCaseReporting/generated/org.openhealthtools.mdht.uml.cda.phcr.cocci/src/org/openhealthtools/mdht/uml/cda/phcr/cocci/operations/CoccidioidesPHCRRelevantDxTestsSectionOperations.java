...
public class CoccidioidesPHCRRelevantDxTestsSectionOperations extends PhcrRelevantDxTestsSectionOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CocciPackage.Literals.COCCIDIOIDES_PHCR_RELEVANT_DX_TESTS_SECTION, CocciPackage.Literals.COCCIDIOIDES_PHCR_RELEVANT_DX_TESTS_SECTION.getEAllOperations().get(73));
      try
      {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(CocciPackage.Literals.COCCIDIOIDES_PHCR_RELEVANT_DX_TESTS_SECTION, CocciPackage.Literals.COCCIDIOIDES_PHCR_RELEVANT_DX_TESTS_SECTION.getEAllOperations().get(74));
      try
      {
