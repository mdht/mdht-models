				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "SusceptibilityResultCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(susceptibilityResult, context) }),
						 new Object [] { susceptibilityResult }));
			}
...
"value.code = 'completed')";
	...
	/**
	 * The cached OCL expression body for the '{@link #validateSusceptibilityResultStatusCodeP(SusceptibilityResult, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Susceptibility Result Status Code P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSusceptibilityResultStatusCodeP(SusceptibilityResult, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_SUSCEPTIBILITY_RESULT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.oclIsUndefined() or self.statusCode.isNullFlavorUndefined()) implies (not self.statusCode.oclIsUndefined())";

	/**
	 * The cached OCL invariant for the '{@link #validateSusceptibilityResultStatusCodeP(SusceptibilityResult, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Susceptibility Result Status Code P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateSusceptibilityResultStatusCodeP(SusceptibilityResult, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_SUSCEPTIBILITY_RESULT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateSusceptibilityResultStatusCodeP(SusceptibilityResult susceptibilityResult, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_SUSCEPTIBILITY_RESULT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(PhcrPackage.Literals.SUSCEPTIBILITY_RESULT);
			try {
				VALIDATE_SUSCEPTIBILITY_RESULT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_SUSCEPTIBILITY_RESULT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_SUSCEPTIBILITY_RESULT_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(susceptibilityResult)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "SusceptibilityResultStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(susceptibilityResult, context) }),
						 new Object [] { susceptibilityResult }));
			}
