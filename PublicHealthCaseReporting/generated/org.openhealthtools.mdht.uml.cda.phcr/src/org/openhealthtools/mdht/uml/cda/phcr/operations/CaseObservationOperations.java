...
public class CaseObservationOperations extends ProblemObservationOperations {
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationEffectiveTimeLow", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationAuthor", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationAuthorAssignedAuthor", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationClassCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationEffectiveTime", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationValue", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationProblemStatusObservation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationSignsAndSymptomsObservation", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationMoodCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
   ...
   */
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
	...
	/**
   * The cached OCL expression body for the '{@link #validateCaseObservationCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Code P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCaseObservationCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.code.oclIsUndefined() or self.code.isNullFlavorUndefined()) implies (not self.code.oclIsUndefined())";

  /**
   * The cached OCL invariant for the '{@link #validateCaseObservationCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Code P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCaseObservationCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateCaseObservationCodeP(CaseObservation caseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(PhcrPackage.Literals.CASE_OBSERVATION);
      try
      {
        VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_CASE_OBSERVATION_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(caseObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             PhcrValidator.DIAGNOSTIC_SOURCE,
             PhcrValidator.CASE_OBSERVATION__CASE_OBSERVATION_CODE_P,
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
...
"value.code = 'ASSERTION' and value.codeSystem = '2.16.840.1.113883.5.4')";
   ...
   */
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
	...
	/**
   * The cached OCL expression body for the '{@link #validateCaseObservationStatusCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Status Code P</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCaseObservationStatusCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
   * @ordered
   */
  protected static final String VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.statusCode.oclIsUndefined() or self.statusCode.isNullFlavorUndefined()) implies (not self.statusCode.oclIsUndefined())";

  /**
   * The cached OCL invariant for the '{@link #validateCaseObservationStatusCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Case Observation Status Code P</em>}' invariant operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #validateCaseObservationStatusCodeP(CaseObservation, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
   * @generated
  ...
  protected static Constraint VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
  ...
  public static  boolean validateCaseObservationStatusCodeP(CaseObservation caseObservation, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    if (VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setContext(PhcrPackage.Literals.CASE_OBSERVATION);
      try
      {
        VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
      }
      catch (ParserException pe)
      {
        throw new UnsupportedOperationException(pe.getLocalizedMessage());
    ...
    if (!EOCL_ENV.createQuery(VALIDATE_CASE_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(caseObservation))
    {
      if (diagnostics != null)
      {
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             PhcrValidator.DIAGNOSTIC_SOURCE,
             PhcrValidator.CASE_OBSERVATION__CASE_OBSERVATION_STATUS_CODE_P,
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateCaseObservationStatusCode", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
        ...
        diagnostics.add
          (new BasicDiagnostic
            (Diagnostic.ERROR,
             ...
             org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "validateProblemObservationTemplateId", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(caseObservation, context) }),
             new Object [] { caseObservation }));
      }
      return false;
    }
