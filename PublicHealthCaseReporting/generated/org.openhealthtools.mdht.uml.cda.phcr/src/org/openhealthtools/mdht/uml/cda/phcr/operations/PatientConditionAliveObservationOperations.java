				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PatientConditionAliveObservationCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(patientConditionAliveObservation, context) }),
						 new Object [] { patientConditionAliveObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PatientConditionAliveObservationStatusCodeP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(patientConditionAliveObservation, context) }),
						 new Object [] { patientConditionAliveObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "PatientConditionAliveObservationValueP", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(patientConditionAliveObservation, context) }),
						 new Object [] { patientConditionAliveObservation }));
			}
