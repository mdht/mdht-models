...
//		setImmunizationsSection(document);
	...
	public static void setHeader(PublicHealthCaseReport document) throws Exception {
		...
		ST documentTitle = Datatypes.createST("Public Health Case Report - Influenza");
	...
	public static void setTreatmentInformationSection(PublicHealthCaseReport document) throws Exception {
		...
		CD caseCode = Datatypes.createCD("442438000", SNOMED_OID, SNOMED_SYSTEM_NAME, "Influenza due to Influenza A virus");
	...
	public static void setDxTestsSection(PublicHealthCaseReport document) throws Exception {
		...
		if (test1CollectionProcedureCode != null) test1Observation.setCode(test1CollectionProcedureCode);
		if (test1CollectionTime != null) test1Observation.setEffectiveTime(test1CollectionTime);
		if (test1CollectionTargetSiteCode != null) test1Observation.setCode(test1CollectionTargetSiteCode);
		...
		if (test2CollectionProcedureCode != null) test2Observation.setCode(test2CollectionProcedureCode);
		if (test2CollectionTime != null) test2Observation.setEffectiveTime(test2CollectionTime);
		if (test2CollectionTargetSiteCode != null) test2Observation.setCode(test2CollectionTargetSiteCode);
