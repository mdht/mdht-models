 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.warning='InfluenzaPHCRSocialHistorySectionInfluenzaEmploymentStatusObservation InfluenzaPHCRSocialHistorySectionInfluenzaPossibleExposureLocationAct' constraints.validation.error='InfluenzaPHCRSocialHistorySectionTemplateId' templateId.root='2.16.840.1.113883.10.20.15.2.49'"
 * @generated
 */
public interface InfluenzaPHCRSocialHistorySection extends PhcrSocialHistorySection {
	 ...
	 *        annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(flu::InfluenzaEmploymentStatusObservation))->asSequence()->any(true).oclAsType(flu::InfluenzaEmploymentStatusObservation)'"
	 * @generated
	 */
     ...
     * @generated
     */
    public InfluenzaPHCRSocialHistorySection init(Iterable<? extends Initializer<? extends EObject>> initializers);
