...
public interface HibPhcrClinicalInformationSection extends PhcrClinicalInformationSection {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.entry->one(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(hib::HibCaseObservation) and entry.typeCode = vocab::x_ActRelationshipEntry::DRIV)'"
	 * @generated
	 */
	boolean validateHibPhcrClinicalInformationSectionHibCaseObservation(DiagnosticChain diagnostics, Map<Object, Object> context);
