...
public class StrepPneumoPackageImpl extends EPackageImpl implements StrepPneumoPackage {
	...
	public static StrepPneumoPackage init() {
        ...
        Initializer.Registry.INSTANCE.registerFactory("org.openhealthtools.mdht.uml.cda.phcr.streppneumo", AnnotationBasedInitializer.FACTORY);
        Initializer.Registry.INSTANCE.initializeEPackage(theStrepPneumoPackage);
	...
	public void initializePackageContents() {
        ...
        op = addEOperation(strepPneumoPossibleExposureLocationActEClass, ecorePackage.getEBoolean(), "validateStrepPneumoPossibleExposureLocationActStatusCodeP", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
        g1 = createEGenericType(ecorePackage.getEMap());
        g2 = createEGenericType(ecorePackage.getEJavaObject());
        g1.getETypeArguments().add(g2);
