...
public class StrepPneumoCaseReportOperations extends PublicHealthCaseReportOperations {
   ...
   * @ordered
   */
	protected static final String GET_STREP_PNEUMO_PHCR_CLINICAL_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(streppneumo::StrepPneumoPHCRClinicalInformationSection))->asSequence()->any(true).oclAsType(streppneumo::StrepPneumoPHCRClinicalInformationSection)";
   ...
   * @ordered
   */
	protected static final String GET_STREP_PNEUMO_PHCR_TREATMENT_INFORMATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(streppneumo::StrepPneumoPHCRTreatmentInformationSection))->asSequence()->any(true).oclAsType(streppneumo::StrepPneumoPHCRTreatmentInformationSection)";
   ...
   * @ordered
   */
	protected static final String GET_STREP_PNEUMO_IMMUNIZATION_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(streppneumo::StrepPneumoImmunizationSection))->asSequence()->any(true).oclAsType(streppneumo::StrepPneumoImmunizationSection)";
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_CASE_REPORT, StrepPneumoPackage.Literals.STREP_PNEUMO_CASE_REPORT.getEAllOperations().get(70));
      try
      {
