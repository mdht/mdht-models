...
public class StrepPneumoCaseObservationOperations extends CaseObservationOperations {
   ...
   */
    ...
    {
      OCL.Helper helper = EOCL_ENV.createOCLHelper();
      helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_CASE_OBSERVATION, StrepPneumoPackage.Literals.STREP_PNEUMO_CASE_OBSERVATION.getEAllOperations().get(80));
      try
      {
