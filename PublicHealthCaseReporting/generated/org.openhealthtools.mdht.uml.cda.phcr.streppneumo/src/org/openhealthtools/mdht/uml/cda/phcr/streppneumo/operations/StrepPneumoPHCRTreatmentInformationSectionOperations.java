...
public class StrepPneumoPHCRTreatmentInformationSectionOperations extends PhcrTreatmentInformationSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_STREP_PNEUMO_THERAPEUTIC_REGIMEN_ACT__EOCL_EXP = "self.getActs()->select(act : cda::Act | not act.oclIsUndefined() and act.oclIsKindOf(streppneumo::StrepPneumoTherapeuticRegimenAct))->asSequence()->first().oclAsType(streppneumo::StrepPneumoTherapeuticRegimenAct)";
