...
public class StrepPneumoPHCRClinicalInformationSectionOperations extends PhcrClinicalInformationSectionOperations {
	 ...
	 * @ordered
	 */
	protected static final String GET_STREP_PNEUMO_CASE_OBSERVATION__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(streppneumo::StrepPneumoCaseObservation))->asSequence()->first().oclAsType(streppneumo::StrepPneumoCaseObservation)";
	...
	public static  StrepPneumoCaseObservation getStrepPneumoCaseObservation(StrepPneumoPHCRClinicalInformationSection strepPneumoPHCRClinicalInformationSection) {
		if (GET_STREP_PNEUMO_CASE_OBSERVATION__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(StrepPneumoPackage.Literals.STREP_PNEUMO_PHCR_CLINICAL_INFORMATION_SECTION, StrepPneumoPackage.Literals.STREP_PNEUMO_PHCR_CLINICAL_INFORMATION_SECTION.getEAllOperations().get(69));
			try {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.113883.10.20.15.2.55')
	 * @param strepPneumoPHCRClinicalInformationSection The receiving '<em><b>PHCR Clinical Information Section</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
