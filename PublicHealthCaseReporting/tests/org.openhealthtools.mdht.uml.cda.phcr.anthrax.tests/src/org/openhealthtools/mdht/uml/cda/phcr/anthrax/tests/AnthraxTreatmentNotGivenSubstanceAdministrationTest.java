...
public class AnthraxTreatmentNotGivenSubstanceAdministrationTest extends  CDAValidationTest {
...
public void testValidateTreatmentNotGivenSubstanceAdministrationTemplateId() {
      OperationsTestCase<AnthraxTreatmentNotGivenSubstanceAdministration> validateTreatmentNotGivenSubstanceAdministrationTemplateIdTestCase = new OperationsTestCase<AnthraxTreatmentNotGivenSubstanceAdministration>(
      ...
      @Override
      protected void updateToFail(AnthraxTreatmentNotGivenSubstanceAdministration target) {

      }

      @Override
      protected void updateToPass(AnthraxTreatmentNotGivenSubstanceAdministration target) {
        target.init();
      ...
      protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
        ...
        return AnthraxTreatmentNotGivenSubstanceAdministrationOperations.validateTreatmentNotGivenSubstanceAdministrationTemplateId(
          (AnthraxTreatmentNotGivenSubstanceAdministration) objectToTest, diagnostician, map);
      }
...
* @generated
*/
	private static class OperationsForOCL extends AnthraxTreatmentNotGivenSubstanceAdministrationOperations {
...
* @generated
*/
	private static class ObjectFactory implements TestObjectFactory<AnthraxTreatmentNotGivenSubstanceAdministration> {
		public AnthraxTreatmentNotGivenSubstanceAdministration create() {		
			return AnthraxFactory.eINSTANCE.createAnthraxTreatmentNotGivenSubstanceAdministration();
		}
	}
...
* @generated
*/	
	private static class ConstructorTestClass extends AnthraxTreatmentNotGivenSubstanceAdministrationOperations {};
