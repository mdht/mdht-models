...
public void testValidateHIVStatusObservationStatusCodeP() {
      OperationsTestCase<HIVStatusObservation> validateHIVStatusObservationStatusCodePTestCase = new OperationsTestCase<HIVStatusObservation>(
      "validateHIVStatusObservationStatusCodeP",
      operationsForOCL.getOCLValue("VALIDATE_HIV_STATUS_OBSERVATION_STATUS_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP")
      ,objectFactory) {
      ...
      protected boolean validate(EObject objectToTest, BasicDiagnostic diagnostician, Map<Object, Object> map) {
        ...
        return HIVStatusObservationOperations.validateHIVStatusObservationStatusCodeP(
          (HIVStatusObservation) objectToTest, diagnostician, map);
      }

    };

    validateHIVStatusObservationStatusCodePTestCase.doValidationTest();
}
...
*/
	private static class ObjectFactory implements TestObjectFactory<HIVStatusObservation> {
		public HIVStatusObservation create() {		
			return TuberculosisFactory.eINSTANCE.createHIVStatusObservation();
		}
	}
